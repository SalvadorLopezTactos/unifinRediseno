...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
  ...
  array (
    ...
    'CJ_Forms' => 'Smart Guide relaterade Sugar åtgärder',
  ...
  array (
    ...
    'CJ_WebHooks' => 'Sugar Automate Webhook',
    'CJ_Forms' => 'Smart Guide relaterad Sugar åtgärd',
...
Om du genomför denna åtgärd kommer du att loggas ut omedelbart och du kommer behöva autentisera dig med hjälp av autentiseringsappen nästa gång du loggar in.',
  ...
  'ERR_FILE_NOT_FOUND' => 'Fel: Kunde inte ladda file {0}. Vänligen kolla system och webserver behörigheter',
    ...
    'LBL_ACTION_CREATE_FAILURE' => "Misslyckades att spara posten': {{{reason}}}",
    'LBL_ACTION_UPDATE_FAILURE' => "Misslyckades att uppdatera posten': {{{reason}}}",
    ...
    'LBL_ERROR_FILE_UPLOAD' => "Misslyckades att ladda upp {{{fieldLabel}}}-filen '{{{fileName}}}'. {{{reason}}}",
...
2. Klicka på "Spara" för att spara den nya posten och återgå till listvyn för {{plural_module_name}}.',
    ...
    'LBL_ACTIVITY_TIMELINE_DASHLET_DESCRIPTION' => 'Tidslinje visar samtal, e-post, ' .
...
// Omnichannel
    ...
    'LBL_ACTIONBUTTON_LINK' => 'Länk',
    'LBL_ACTIONBUTTON_COPY_PARENT' => 'Kopiera överordnade värden',
    'LBL_ACTIONBUTTON_PRESET' => 'Förinställning',
    'LBL_ACTIONBUTTON_PRESET_PARENT' => 'Förinställning från överordnad',
    ...
    'LBL_ACTIONBUTTON_RECORD_VIEW' => 'Postvy',
    'LBL_ACTIONBUTTON_RECORD_VIEW_DASHLET' => 'Instrumentpanelskomponent för postvy',
    ...
    'LBL_KIOSK_MY_PROFILE_UPDATE_ERROR' => 'Fel vid uppdatering av din profil.',
    'LBL_KIOSK_MY_PROFILE_UPDATE_SUCCESS' => 'Din profil har uppdaterats.',
    'LBL_KIOSK_NAME' => 'Namn',
    ...
    'LBL_KIOSK_SERVER_ERROR' => 'Serverfel',
    ...
    'LBL_KIOSK_HOMEPAGE_WELCOME1' => 'Välkommen till Servicecenter',
    'LBL_KIOSK_HOMEPAGE_WELCOME2' => 'Få den hjälp du behöver snabbt',
    'LBL_KIOSK_HOMEPAGE_SEARCH_PLACEHOLDER' => 'Sök ärenden',
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY' => 'Min aktivitet',
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY_DESC' => 'Visa den senaste ärendeaktiviteten och ärenden som delats med dig.',
    'LBL_KIOSK_HOMEPAGE_LINK_SUBMIT' => 'Skicka in ett ärende',
    'LBL_KIOSK_HOMEPAGE_LINK_SUBMIT_DESC' => 'Lägg enkelt in en ny förfrågan för vår granskning.',
    'LBL_KIOSK_SHOW_ALL' => 'Visa alla',
    'LBL_KIOSK_NOT_FOUND' => "Vi kunde inte hitta det här.",
    'LBL_KIOSK_TENANT_NOT_FOUND' => 'Post hittades inte.',
    ...
    'LBL_CJ_FORMS_SUBPANEL_TITLE' => 'Relaterade Sugar-åtgärd',
    'LBL_CJ_FORMS' => 'Smart Guide relaterade Sugar-åtgärder',
    'LBL_CJ_FORM' => 'Smart Guide relaterad Sugar-åtgärd',
    ...
    'LBL_CUSTOMER_JOURNEY_INVALID_LICENSE' => 'Ogiltig licenstyp',
    ...
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Visar Sugar Automate \"Smart Guide Progress\". pie chart.',
    ...
    'LBL_CONFIGURE_TEMPLATE_BUTTON_TITLE' => 'Konfigurera',
    ...
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'Smart Guide Progress',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Visar Sugar Automate "Smart Guide Progress"-cirkeldiagram.',
...
$app_list_strings['moduleListSingular']['EmbeddedFiles'] = 'Inbäddad fil';
    ...
    $app_strings['LBL_SHARED_WITH_ME'] = 'Delat med mig';
    ...
    $app_strings['LBL_LARGE_FILE_UPLOAD'] = 'På grund av den stora storleken på din fil kommer uppladdningen att ta en stund. Du kommer att bli notifierad när filen är redo.';
