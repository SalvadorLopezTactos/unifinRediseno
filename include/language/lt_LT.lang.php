...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => [
        ...
        'ExternalUsers' => 'Išoriniai vartotojai',
        ...
        'CloudDrivePaths' => 'Debesų disko keliai',
        ...
        'DRI_Workflow_Task_Templates' => '„Smart Guide“ veiklos šablonai',
        'DRI_SubWorkflows' => '„Smart Guide“ etapai',
        'DRI_Workflow_Templates' => '„Smart Guide“ šablonai',
        'CJ_WebHooks' => '„Sugar Automate“ žiniatinklio gaudyklės',
        'CJ_Forms' => 'Su „Smart Guide“ susijęs „Sugar“ veiksmas',
        'DRI_SubWorkflow_Templates' => '„Smart Guide“ etapo šablonai',
        'PubSub_ModuleEvent_PushSubs' => '„Pub/Sub“ modulio įvykio „Push“ prenumeratos',
    ],
    ...
    'moduleIconList' => [
        ...
        'ForecastManagerWorksheets' => 'PVD',
        'Quotas' => 'Kvt.',
        'VisualPipeline' => 'VK',
        'ConsoleConfiguration' => 'PK',
        'SugarLive' => 'Su',
        'Teams' => 'Kom',
        'TeamNotices' => 'KP',
        'Manufacturers' => 'Gam',
        ...
        'CampaignTrackers' => 'KS',
        'Documents' => 'Dok',
        'DocumentRevisions' => 'DP',
        'Connectors' => 'Jung',
        'Notifications' => 'Pran',
        'Sync' => 'Sinch',
        'HintAccountsets' => 'UP',
        'HintNotificationTargets' => 'UPT',
        'HintNewsNotifications' => 'UNP',
        'HintEnrichFieldConfigs' => 'UPK',
        'ExternalUsers' => 'IN',
        'ReportMaker' => 'AT',
        'DataSets' => 'DR',
        'CustomQueries' => 'KU',
    ...
    'moduleListSingular' => [
        ...
        'DataArchiver' => 'Duomenų archyvavimo priemonė',
        'ArchiveRuns' => 'Archyvas veikia',
        'ExternalUsers' => 'Išorinis vartotojas',
        ...
        'DocumentMerges' => 'Dokumentų suliejimas',
        'CloudDrivePaths' => 'Debesų disko kelias',
        'WorkFlow' => 'Darbo eiga',
        ...
        'DRI_Workflow_Task_Templates' => '„Smart Guide“ veiklos šablonas',
        'DRI_SubWorkflows' => '„Smart Guide“ etapas',
        'DRI_Workflow_Templates' => '„Smart Guide“ šablonas',
        'CJ_WebHooks' => '„Sugar Automate“ žiniatinklio gaudyklė',
        'CJ_Forms' => 'Su „Smart Guide“ susiję „Sugar“ veiksmai',
        'DRI_SubWorkflow_Templates' => '„Smart Guide“ etapo šablonas',
        'PubSub_ModuleEvent_PushSubs' => '„Pub/Sub“ modulio įvykio „Push“ prenumerata',
    ],
 ...
 */
    ...
    'embed_report_dom' => [
        ...
        'Chart and Data Table' => 'Grafikas ir duomenų lentelė',
    ],
    'message_status_dom' => [
        '' => '',
        'In Progress' => 'Vykdoma',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'field_name_placement_dom' => [
        'field_on_side' => 'Šalia lauko reikšmės',
        'field_on_top' => 'Virš lauko reikšmės',
    ],
    'payment_terms' => [
        '' => '',
        'Net 15' => 'Neto 15',
...
//       it is the key for the default case_status_dom value
        ...
        'user_type_bool_dom' => [
            false => 'Įprastas vartotojas',
            true => 'Administratorius',
        ],
        'user_type_group_bool_dom' => [
            true => 'Grupės vartotojas',
        ],
        'user_type_portal_bool_dom' => [
            true => 'Portalo API vartotojas',
        ],
        'license_type_dom' => [
...
//       it is the key for the default quote_relationship_type_dom value
    ...
    /*Added entries 'Queued' and 'Sending' for 4.0 release..*/
        ...
        'dom_email_distribution' => ['' => '--Nėra--',
        'direct' => 'Priskirti tiesiogiai',
        'roundRobin' => 'Išteklių rotacija',
        'leastBusy' => 'Mažiausiai užimtas',
        ],
        'dom_email_distribution_for_auto_create' => ['roundRobin' => 'Išteklių rotacija',
        'leastBusy' => 'Mažiausiai užimtas',
        'none' => 'Nėra',
        ],
        'dom_email_errors' => [1 => 'Tiesiogiai priskirdami elementus, pasirinkite tik vieną vartotoją.',
        2 => 'Tiesiogiai priskirti galite tik pažymėtus elementus.',
        ],
        'dom_email_bool' => ['bool_true' => 'Taip',
        'bool_false' => 'Ne',
        ],
        'dom_int_bool' => [1 => 'Taip',
        0 => 'Ne',
        ],
        'dom_switch_bool' => ['on' => 'Taip',
        'off' => 'Ne',
        '' => 'Ne',],

        'dom_email_link_type' => ['sugar' => '„Sugar“ el. pašto klientas',
        'mailto' => 'Išorinis el. pašto klientas'],


        'dom_email_editor_option' => ['' => 'Numatytasis el. laiško formatas',
        'html' => 'HTML el. laiškas',
        'plain' => 'Paprastojo teksto formato el. laiškas'],

        'schedulers_times_dom' => ['not run' => 'Vykdymo laikas praėjo, neįvykdyta',
        'ready' => 'Parengta',
        'in progress' => 'Vykdoma',
        'failed' => 'Nepavyko',
        'completed' => 'Užbaigta',
...
//  'Sub-Query' => 'Sub Query',
        ...
        'wflow_fire_order_dom' => ['alerts_actions' => 'Perspėjimai, tada veiksmai',
...
//prospect list type dom
    ...
    // strings to pass to Flash charts
        ...
        'chart_types' => [
        'hBarF' => 'Horizontali juosta (sudurtinė)',
        'hGBarF' => 'Horizontali juosta (sugrupuota)',
        'vBarF' => 'Vertikali juosta (sudurtinė)',
        'vGBarF' => 'Vertikali juosta (sugrupuota)',
        'pieF' => 'Skritulinė diagrama',
        'funnelF' => 'Piltuvėlio tipo',
        'lineF' => 'Skritulinė diagrama',
        'donutF' => '„Donut“',
        'treemapF' => 'Medžių žemėlapis',
        ],
        'd3_value_placement' => [
        '0' => 'Nėra',
        '1' => 'Numatytasis',
        ...
        'metric_context_list' => [
        'service_console' => 'Priežiūros konsolė',
        'renewals_console' => 'Atnaujinimo konsolė',
        ],
    ...
    //Service Duration
        ...
        'show' => 'Rodyti potencialių gavėjų sąrašą',
        'dont_show' => 'Nerodyti potencialių gavėjų',
        ],
        'docusign_recipient_type_list' => [
        'signer' => 'Pasirašantysis',
        'carbon_copy' => 'Žiūrovas (kopija)',
        'certified_delivery' => 'Žiūrovas (sertifikuotas pristatymas)',
        ],
        ...
        'module_icons_dom' => [
        'sicon-arrow-down' => 'Rodyklė žemyn',
        'sicon-chevron-left' => 'Ševronas kairėje',
        'sicon-check' => 'Varnelė',
        'sicon-clock' => 'Laikrodis',
        'sicon-dashboard-default' => 'Numatytasis prietaisų skydelis',
        'sicon-dashboard' => 'Prietaisų skydelis',
        'sicon-edit' => 'Redaguoti',
        'sicon-caret-down' => 'Žymuo į apačią',
        'sicon-folder' => 'Aplankas',
        'sicon-info' => 'Informacija',
        'sicon-kebab' => 'Kebabas',
        'sicon-link' => 'Nuoroda',
        'sicon-list' => 'Sąrašas',
        'sicon-logout' => 'Atsijungti',
        'sicon-minus' => 'Minusas',
        'sicon-folder-open' => 'Aplankas atidarytas',
        'sicon-plus-sm' => 'Pliusas Sm',
        'sicon-refresh' => 'Atnaujinti',
        'sicon-plus' => 'Pliusas',
        'sicon-settings' => 'Nuostatos',
        'sicon-arrow-right-double' => 'Dviguba rodyklė dešinėn',
        'sicon-reports' => 'Ataskaitos',
        'sicon-user' => 'Vartotojas',
        'sicon-upload' => 'Nusiųsti',
        'sicon-user-group' => 'Vartotojų grupė',
        'sicon-arrow-left-double' => 'Dviguba rodyklė į kairę',
        'sicon-chevron-up' => 'Ševronas aukštyn',
        'sicon-caret-up' => 'Žymuo aukštyn',
        'sicon-star-fill' => 'Žvaigždžių užpildymas',
        'sicon-download' => 'Atsisiųsti',
        'sicon-close' => 'Užbaigti',
        'sicon-tile-view' => 'Plytelių rodinys',
        'sicon-list-view' => 'Sąrašo forma',
        'sicon-thumbs-down' => 'Nykščiai žemyn',
        'sicon-warning-circle' => 'Įspėjimo ratas',
        'sicon-phone' => 'Telefonas',
        'sicon-email' => 'El. paštas',
        'sicon-document' => 'Dokumentas',
        'sicon-note' => 'Pastaba',
        'sicon-preview' => 'Peržiūrėti',
        'sicon-copy' => 'Kopijuoti',
        'sicon-launch' => 'Paleisti',
        'sicon-lock' => 'Užrakinti',
        'sicon-arrow-top-right' => 'Rodyklė aukštyn į dešinę',
        'sicon-full-screen' => 'Pilnas langas',
        'sicon-full-screen-exit' => 'Išeiti iš pilno lango',
        'sicon-expand-left' => 'Išskleisti į kairę',
        'sicon-expand-right' => 'Išskleisti į dešinę',
        'sicon-focus-drawer' => '„Focus“ stalčius',
        'sicon-ban' => 'Drausti',
        'sicon-thumbs-up' => 'Nykščiai aukštyn',
        'sicon-search' => 'Ieškoti',
        'sicon-calendar' => 'Kalendorius',
        'sicon-calendar-lg' => 'Kalendorius Lg',
        'sicon-mobile-lg' => 'Mobilusis Lg',
        'sicon-star-fill-lg' => 'Žvaigždžių užpildymas Lg',
        'sicon-star-outline-lg' => 'Žvaigždžių kontūras Lg',
        'sicon-reset-lg' => 'Iš naujo nustatyti Lg',
        'sicon-exchange-lg' => 'Keisti Lg',
        'sicon-help-lg' => 'Žinynas Lg',
        'sicon-close-lg' => 'Uždaryti Lg',
        'sicon-plus-lg' => 'Pliusas LG',
        'sicon-shortcuts-lg' => 'Spartieji klavišai Lg',
        'sicon-search-lg' => 'Ieškoti Lg',
        'sicon-email-lg' => 'El. paštas Lg',
        'sicon-note-lg' => 'Pastaba Lg',
        'sicon-document-lg' => 'Dokumentas Lg',
        'sicon-add-dashlet-lg' => 'Pridėti skydelį Lg',
        'sicon-collapse-lg' => 'Sutraukti Lg',
        'sicon-hamburger-lg' => 'Hamburgeris Lg',
        'sicon-pin-fill-lg' => 'Prisegti užpildymą Lg',
        'sicon-expand-lg' => 'Išskleisti Lg',
        'sicon-copy-lg' => 'Kopijuoti Lg',
        'sicon-dashboard-lg' => 'Prietaisų skydelis Lg',
        'sicon-star-outline' => 'Žvaigždžių kontūras',
        'sicon-reset' => 'Atstatyti',
        'sicon-unlink' => 'Atsieti',
        'sicon-phone-lg' => 'Telefonas Lg',
        'sicon-attach' => 'Prisegti failą',
        'sicon-case-lg' => 'Atvejis Lg',
        'sicon-arrow-right-lg' => 'Rodyklė dešinėn Lg',
        'sicon-check-circle-lg' => 'Apskritimas su varnele Lg',
        'sicon-text-formatting' => 'Teksto formatavimas',
        'sicon-check-circle' => 'Apskritimas su varnele',
        'sicon-upload-lg' => 'Įkelti Lg',
        'sicon-flag-lg' => 'Žyma Lg',
        'sicon-studio-lg' => 'Studija Lg',
        'sicon-contact-lg' => 'Susisiekti Lg',
        'sicon-edit-lg' => 'Redaguoti Lg',
        'sicon-arrow-left' => 'Rodyklė kairėn',
        'sicon-reply-all' => 'Atsakyti visiems',
        'sicon-message-lg' => 'Pranešimas Lg',
        'sicon-info-lg' => 'Informacija Lg',
        'sicon-error-lg' => 'Klaida Lg',
        'sicon-check-circle-line-lg' => 'Apskritimas su varnele Linija Lg',
        'sicon-warning-line-lg' => 'Įspėjamoji linija Lg',
        'sicon-arrow-up' => 'Rodyklė aukštyn',
        'sicon-arrow-right' => 'Rodyklė į dešinę',
        'sicon-nodes' => 'Mazgai',
        'sicon-hide' => 'Paslėpti',
        'sicon-help' => 'Žinynas',
        'sicon-twitter' => '„Twitter“',
        'sicon-message' => 'Žinutė',
        'sicon-sugar-predict-lg' => '„Sugar Predict“ Lg',
        'sicon-sugar-predict' => '„Sugar Predict“',
        'sicon-opportunity-lg' => 'Galimybė Lg',
        'sicon-lead-lg' => 'Potencialus klientas Lg',
        'sicon-account-lg' => 'Paskyra Lg',
        'sicon-user-sm' => 'Vartotojas Sm',
        'sicon-quote-lg' => 'Pasiūlymas Lg',
        'sicon-equal' => 'Lygu',
        'sicon-slicers-xl' => 'Duomenų filtrai Xl',
        'sicon-escalation-lg' => 'Eskalavimas Lg',
        'sicon-add-circle-lg' => 'Pridėti žiedą Lg',
        'sicon-add-line-lg' => 'Pridėti liniją Lg',
        'sicon-add-target-lg' => 'Pridėti tiks Lg',
        'sicon-help-circle-lg' => 'Žinyno apskritimas Lg',
        'sicon-divide-line-lg' => 'Skirstymo linija Lg',
        'sicon-string' => 'Eilutė',
        'sicon-filter' => 'Filtruoti',
        'sicon-number' => 'Numeris',
        'sicon-format-lg' => 'Formatas Lg',
        'sicon-insights-lg' => 'Įžvalgos Lg',
        'sicon-invalid-circle-lg' => 'Neteisingas apskritimas Lg',
        'sicon-layout-xl' => 'Išdėstymas Xl',
        'sicon-layout-lg' => 'Išdėstymas Lg',
        'sicon-multiply-line-lg' => 'Padauginti eilutę Lg',
        'sicon-redo-lg' => 'Perdaryti Lg',
        'sicon-refresh-lg' => 'Atnaujinti Lg',
        'sicon-undo-lg' => 'Anuliuoti lg',
        'sicon-activity-feed-xl' => 'Veiklos kanalas Xl',
        'sicon-chevron-left-xl' => 'Ševronas kairėje XI',
        'sicon-close-xl' => 'Uždaryti Xl',
        'sicon-kebab-lg' => 'Kebabas Lg',
        'sicon-insights-xl' => 'Įžvalgos Xl',
        'sicon-hide-lg' => 'Slėpti Lg',
        'sicon-kebab-xl' => 'Kebabas XI',
        'sicon-comment-xl' => 'Komentuoti Xl',
        'sicon-share-lg' => 'Dalintis Lg',
        'sicon-trash' => 'Šiukšlės',
        'sicon-launch-lg' => 'Paleisti Lg',
        'sicon-thumbs-up-lg' => 'Nykštys aukštyn Lg',
        'sicon-thumbs-down-lg' => 'Nykštys žemyn Lg',
        'sicon-warning-lg' => 'Įspėjimas Lg',
        'sicon-wizard-circle-xl' => 'Vedlio apskritimas Xl',
        'sicon-bell-cross-lg' => 'Varpo kryžius Lg',
        'sicon-bell-lg' => 'Varpas Lg',
        'sicon-daily-lg' => 'Kasdienis Lg',
        'sicon-cloud-download-lg' => 'Atsisiųsti iš debesies Lg',
        'sicon-unlock' => 'Atrakinti',
        'sicon-news-lg' => 'Naujienos Lg',
        'sicon-weekly-lg' => 'Kassvaitinis Lg',
        'sicon-knowledgebase-xl' => 'Žinių bazė Xl',
        'sicon-remove' => 'Pašalinti',
        'sicon-chevron-down' => 'Ševronas žemyn',
        'sicon-slicers-lg' => 'Dumenų filtrai Lg',
        'sicon-save-lg' => 'Išsaugoti Lg',
        'sicon-info-circle-lg' => 'Informacinis apskritimas Lg',
        'sicon-chevron-right' => 'Ševronas į dešinę',
        'sicon-warning-circle-lg' => 'Įspėjimo ratasLg',
        'sicon-right-paren-line-lg' => 'Dešinė pagrindinė eilutė Lg',
        'sicon-comment-lg' => 'Komentaras Lg',
        'sicon-target-lg' => 'Tikslas Lg',
        'sicon-subtract-line-lg' => 'Atimties eilutė Lg',
        'sicon-settings-lg' => 'Nuostatos Lg',
        'sicon-left-paren-line-lg' => 'Kairė pagrindinė eilutė Lg',
        'sicon-preview-lg' => 'Peržiūrėti Lg',
        'sicon-thumbs-down-line-lg' => 'Nykščiai žemyn eilutė Lg',
        'sicon-thumbs-up-line-lg' => 'Nykščiai aukštyn eilutė Lg',
        'sicon-send-lg' => 'Siųsti Lg',
        'sicon-contact-xl' => 'Susisiekti Xl',
        'sicon-wizard-circle-line-xl' => 'Vedlio apskritimo linija Xl',
        'sicon-trash-lg' => 'Šiukšlės Lg',
        'sicon-pin-lg' => 'Prisegti Lg',
        'sicon-clock-lg' => 'Laikrodis Lg',
        'sicon-comment-line-xl' => 'Komentarų eilutė XI',
        'sicon-dropdown-editor' => 'Iššokančio sąrašo redaktorius',
        'sicon-amazon' => '„Amazon“',
        'sicon-bug' => 'Virusas',
        'sicon-catalog' => 'Katalogas',
        'sicon-cloud' => 'Debesys',
        'sicon-config-api' => 'Konfigūravimo API',
        'sicon-config-nav' => 'Konfigūravimo navigacija',
        'sicon-connectors' => 'Jungtys',
        'sicon-contracts' => 'Sutartys',
        'sicon-currencies' => 'Valiutos',
        'sicon-diagnostics' => 'Diagnostika',
        'sicon-sugar-club' => '„Sugar Club“',
        'sicon-email-campaign' => 'El. pašto kampanija',
        'sicon-email-inbound' => 'Įeinantis el. paštas',
        'sicon-email-queue' => 'Valdyti pašto eilę',
        'sicon-forecasts' => 'Prognozės',
        'sicon-display-modules' => 'Rodomos kortelės',
        'sicon-email-contacts' => 'El. laiško kontaktai',
        'sicon-import' => 'Importas',
        'sicon-log-viewer' => 'Žurnalų peržiūros programa',
        'sicon-lab' => 'Laboratorija',
        'sicon-map-pin' => 'Žemėlapio smeigtukas',
        'sicon-manufacturers' => 'Gamintojai',
        'sicon-update' => 'Atnaujinti',
        'sicon-content-security' => 'Turinio saugumas',
        'sicon-module-builder' => 'Modulio kūrėjas',
        'sicon-languages' => 'Kalbos',
        'sicon-module-loader' => 'Modulių įdiegėjas',
        'sicon-oauth-key' => 'Oauth raktas',
        'sicon-password-mgmt' => 'Slaptažodių vald.',
        'sicon-opportunities' => 'Galimybės',
        'sicon-upgrade' => 'Atnaujinimas',
        'sicon-portal' => 'Portalas',
        'sicon-product-types' => 'Prekės tipai',
        'sicon-quotes' => 'Pasiūlymai',
        'sicon-relate-fields' => 'Susiję laukai',
        'sicon-repair' => 'Taisyti',
        'sicon-role-mgmt' => 'Vaidmenų vald.',
        'sicon-scheduler' => 'Planuoklė',
        'sicon-shippers' => 'Vežėjas',
        'sicon-studio' => 'Studija',
        'sicon-web-logic' => 'Žiniatinklio logika',
        'sicon-sugar-u' => '„Sugar U“',
        'sicon-tax-rates' => 'Mokesčių tarifai',
        'sicon-team-mgmt' => 'Komandų vald.',
        'sicon-team-perm' => 'Komandų leid.',
        'sicon-tracker' => 'Sekimo priemonė',
        'sicon-workflow' => 'Darbo eiga',
        'sicon-mask' => 'Kaukė',
        'sicon-mask-disabled' => 'Kaukė išjungta',
        'sicon-email-archive' => 'El. pašto archyvas',
        'sicon-mobile' => 'Mobilus',
        'sicon-archive' => 'Archyvas',
        'sicon-automate-scroll' => 'Vertikalus slinkties rodinys',
        'sicon-automate-stacked' => 'Horizontalus slinkties rodinys',
        'sicon-pdf-manager' => 'PDF tvarkytuvas',
        'sicon-my-sites' => 'Mano tinklapiai',
        'sicon-cloud-insights' => 'Debesų įžvalgos',
        'sicon-sugar-logo-24' => '„Sugar“ logotipas 24',
        'sicon-sugar-logo-16' => '„Sugar“ logotipas 16',
        'sicon-task-lg' => 'Užduotis Lg',
        'sicon-web-lg' => 'Žiniatinklis Lg',
        'sicon-events-lg' => 'Įvykiai Lg',
        'sicon-sugar-logo-12' => '„Sugar“ logotipas 12',
        'sicon-tag' => 'Žymė',
        'sicon-tag-lg' => 'Žymė lg',
        'sicon-bell-lg-line' => 'Varpas Lg linija',
        'sicon-matrix-xxl' => 'Matrica Xxl',
        'sicon-advanced-filter' => 'Išplėstinis filtras',
        'sicon-rows-and-columns-xxl' => 'Lentelė Xxl',
        'sicon-summation-details-xxl' => 'Apibendrinta informacija Xxl',
        'sicon-summation-xxl' => 'Apibendrinimas Xxl',
        'sicon-lock-lg' => 'Užraktas Lg',
        'sicon-csv-file-xxl' => 'Csv failas Xxl',
        'sicon-logo-linkedin' => '„Linkedin“ logotipas',
        'sicon-briefcase' => 'Portfelis',
        'sicon-car-front' => 'Automobilio priekis',
        'sicon-airplane' => 'Lėktuvas',
        'sicon-laptop' => 'Nešiojamas kompiuteris',
        'sicon-logo-instagram' => '„Instagram“ logotipas',
        'sicon-single-bed' => 'Viengulė lova',
        'sicon-tiktok' => '„TikTok“',
        'sicon-logo-snapchat' => '„Snapchat“ logotipas',
        'sicon-video-lg' => 'Vaizdo įrašas lg',
        'sicon-reply' => 'Atsakyti',
        'sicon-subtract' => 'Atimti',
        'sicon-arrow-up-circle-line' => 'Rodyklė aukštyn apskritimo linija',
        'sicon-asterisk' => 'Žvaigždutė',
        'sicon-dot-circle-o-lg' => 'Taškuotas apskritimas O Lg',
        'sicon-forward' => 'Persiųsti',
        'sicon-video' => 'Vaizdo įrašas',
        'sicon-gavel' => 'Gavel',
        'sicon-login' => 'Prisijungimas',
        'sicon-pdf-file-xxl' => 'Pdf failas xxl',
        'sicon-login-lg' => 'Prisijungti Lg',
        'sicon-cloud-download-xl' => 'Atsisiųsti iš debesies Xl',
        'sicon-campaigns-lg' => 'Kampanijos Lg',
        'sicon-customer-journey-stages-lg' => 'Kliento kelionės etapai Lg',
        'sicon-role-mgmt-lg' => 'Vaidmenų vald. Lg',
        'sicon-default-module-lg' => 'Numatytasis modulis Lg',
        'sicon-quoted-line-items-lg' => 'Produktai Lg',
        'sicon-projects-lg' => 'Projektai Lg',
        'sicon-process-business-rules-lg' => 'Proceso verslo taisyklės Lg',
        'sicon-process-email-templates-lg' => 'Proceso el. laiškų šablonai Lg',
        'sicon-processes-lg' => 'Procesai Lg',
        'sicon-process-definitions-lg' => 'Proceso apibrėžimai Lg',
        'sicon-target-lists-lg' => 'Adresatų sąrašai Lg',
        'sicon-purchased-line-items-lg' => 'Pirkimo eilutės prekės Lg',
        'sicon-user-group-lg' => 'Vartotojų grupė Lg',
        'sicon-revenue-line-items-lg' => 'Pajamų linijos prekės Lg',
        'sicon-business-centers-lg' => 'Verslo centrai Lg',
        'sicon-logo-fb-simple' => 'Paprastas Fb logotipas',
        'sicon-forecasts-lg' => 'Prognozės Lg',
        'sicon-contracts-lg' => 'Sutartys Lg',
        'sicon-purchase-lg' => 'Pirkti Lg',
        'sicon-sugar-live-lg' => '„Sugar Live“ Lg',
        'sicon-customer-journey-lg' => 'Kliento kelionė Lg',
        'sicon-data-privacy-lg' => 'Duomenų privatumas Lg',
        'sicon-home-lg' => 'Pradžia Lg',
        'sicon-data-table' => 'Duomenų lentelė',
        'sicon-medical-clipboard-lg' => 'Vaistų iškarpinė Lg',
        'sicon-privacy-lg' => 'Privatumas Lg',
        'sicon-marketplace' => 'Rinka',
        'sicon-marketplace-lg' => 'Prekyvietė Lg',
        'sicon-blockquote-lg' => 'Citatos blokas Lg',
        'sicon-casino-lg' => 'Kazino Lg',
        'sicon-jacuzzi-lg' => 'Sūkurinė vonia Lg',
        'sicon-scissors-lg' => 'Žirklės Lg',
        'sicon-storage-lg' => 'Saugykla Lg',
        'sicon-fan-lg' => 'Ventiliatorius Lg',
        'sicon-medicine-lg' => 'Medicina Lg',
        'sicon-plant-lg' => 'Augalas Lg',
        'sicon-telescope-lg' => 'Teleskopas Lg',
        'sicon-smart-phone-lg' => 'Išmanusis telefonas Lg',
        'sicon-coffee-lg' => 'Kava Lg',
        'sicon-martini-lg' => 'Martini Lg',
        'sicon-cocktail-lg' => 'Kokteilis Lg',
        'sicon-stadium-lg' => 'Stadionas Lg',
        'sicon-fire-lg' => 'Ugnis Lg',
        'sicon-window-lg' => 'Langas Lg',
        'sicon-lotus-lg' => 'Lotusas Lg',
        'sicon-windmill-lg' => 'Vėjo malūnas Lg',
        'sicon-spades-lg' => 'Vynai Lg',
        'sicon-hearts-lg' => 'Širdys Lg',
        'sicon-diamonds-lg' => 'Deimantai Lg',
        'sicon-clubs-lg' => 'Kryžiai Lg',
        'sicon-skull-lg' => 'Kaukolė Lg',
        'sicon-send' => 'Siųsti',
        'sicon-world-lg' => 'Pasaulis Lg',
        'sicon-airplane-lg' => 'Lėktuvas Lg',
        'sicon-planet-lg' => 'Planeta Lg',
        'sicon-trainer-lg' => 'Treneris LG',
        'sicon-calculator-lg' => 'Skaičiuoklė Lg',
        'sicon-tv-lg' => 'Televizorius Lg',
        'sicon-video-player-lg' => 'Vaizdo grotuvas Lg',
        'sicon-media-player-lg' => 'Grotuvas Lg',
        'sicon-decentralize-lg' => 'Decentralizuoti Lg',
        'sicon-statistics-lg' => 'Statistika Lg',
        'sicon-virus-lg' => 'Virusas Lg',
        'sicon-shield-lg' => 'Skydas Lg',
        'sicon-plug-lg' => 'Kištukas Lg',
        'sicon-shuttle-lg' => 'Pervežimas Lg',
        'sicon-soundwave-lg' => 'Garso banga Lg',
        'sicon-graph-lg' => 'Grafikas Lg',
        'sicon-playlist-lg' => 'Grojaraštis Lg',
        'sicon-voice-recognition-lg' => 'Balso atpažinimas Lg',
        'sicon-machine-learning-lg' => 'Mašininis mokymasis Lg',
        'sicon-bed-lg' => 'Lova Lg',
        'sicon-blueprint-lg' => 'Brėžinys Lg',
        'sicon-content-delivery-lg' => 'Turinio pristatymas Lg',
        'sicon-questionnaire-lg' => 'Klausimynas Lg',
        'sicon-presentation-lg' => 'Pristatymas Lg',
        'sicon-organic-lg' => 'Ekologiškas Lg',
        'sicon-transactions-lg' => 'Operacijos Lg',
        'sicon-wand-lg' => 'Lazdelė Lg',
        'sicon-bin-lg' => 'Dėžė LG',
        'sicon-sync-lg' => 'Sinchronizuoti Lg',
        'sicon-external-authentication-lg' => 'Išorinė identifikacija Lg',
        'sicon-tracking-activity-lg' => 'Stebėjimo veikla Lg',
        'sicon-account' => 'Paskyra',
        'sicon-meetings-lg' => 'Susitikimai Lg',
        'sicon-stacked' => 'Horizontalus padalytas rodmuo',
        'sicon-sidebyside' => 'Vertikalus padalytas rodmuo',
        ],
    ...
    // Sugar Automate
        ...
        'none' => 'Joks',
        'create' => 'Skiltyje „Sukurti“',
        'stage_start' => 'Skiltyje „Etapo pradžia“',
        'previous_activity_completed' => 'Ankstesnė veikla baigta',
        ],
        'dri_workflow_templates_target_assignee_list' => [
        'current_user' => 'Esamas vartotojas',
        'parent_assignee' => 'Tėvo perėmėjas',
        ],
        'dri_workflow_task_templates_task_due_date_type_list' => [
        '' => '',
        'days_from_created' => 'Dienos nuo sukūrimo',
        'days_from_stage_started' => 'Dienos nuo etapo pradžios',
        'days_from_previous_activity_completed' => 'Dienos nuo ankstesnės užbaigtos veiklos',
        'days_from_parent_date_field' => 'Dienos nuo pirminės datos lauko',
        'days_from_specific_activity_completed' => 'Dienos nuo konkrečios veiklos pabaigos',
        ],
        'dri_workflow_task_templates_momentum_start_type_list' => [
        '' => '',
        'created' => 'Kai sukurta',
        'stage_started' => 'Kai prasidėjo etapas',
        'previous_activity_completed' => 'Kai baigta ankstesnė veikla',
        'parent_date_field' => 'Pirminės datos lauke',
        'specific_activity_completed' => 'Konkreti veikla baigta',
        ],
        ...
        '' => '',
        'customer_task' => 'Kliento užduotis',
        'milestone' => 'Etapas',
        'internal_task' => 'Vidinė užduotis',
        'agency_task' => 'Agentūros užduotis',
        'automatic_task' => 'Automatinė užduotis',
        ],
        ...
        'user' => 'Vartotojas',
        'team' => 'Komanda',
        'user_team' => 'Vartotojas ir komanda',
        ],
        ...
        'not_started' => 'Nepradėta',
        'in_progress' => 'Vykdoma',
        'not_completed' => 'Nebaigta',
        'completed' => 'Užbaigta',
        'cancelled' => 'Atšaukta',
        ],
        'dri_workflow_templates_disabled_stage_actions_list' => [
        'stage_edit_button' => 'Redaguoti etapą',
        'stage_add_task_button' => 'Sukurti užduotį',
        'stage_add_meeting_button' => 'Suplanuoti susitikimą',
        'stage_add_call_button' => 'Suplanuoti skambutį',
        'stage_delete_button' => 'Ištrinti etapą',
        ],
        'dri_workflow_templates_disabled_activity_actions_list' => [
        'activity_add_sub_task_button' => 'Pridėti užduotį',
        'activity_add_sub_meeting_button' => 'Suplanuoti susitikimą',
        'activity_add_sub_call_button' => 'Suplanuoti skambutį',
        'activity_not_applicable_button' => 'Netaikoma',
        'activity_delete_button' => 'Ištrinti',
        ],
        'dri_workflow_templates_cancel_action_list' => [
        'set_not_applicable' => 'Nustatyti netaikomą',
        'remove_open_activities' => 'Pašalinti atvirą veiklą',
        ],
        ...
        'skip_request' => 'Praleisti užklausą',
        'json' => 'JSON',
        'http_query' => 'HTTP užklausa',
        ],
        'cj_webhooks_response_format_list' => [
        'no_response' => 'Nėra atsako',
        'json' => 'JSON',
        'http_query' => 'HTTP užklausa',
        ...
        '' => '',
        'before_create' => 'Prieš „Kurti“',
        'after_create' => 'Po „Kurti“',
        'before_in_progress' => 'Prieš „Vykdoma“',
        'after_in_progress' => 'Po „Vykdoma“',
        'before_completed' => 'Prieš „Baigta“',
        'after_completed' => 'Po „Baigta“',
        'before_not_applicable' => 'Prieš „Netaikoma“',
        'after_not_applicable' => 'Po „Netaikoma“',
        'before_delete' => 'Prieš „Ištrinti“',
        'after_delete' => 'Po „Ištrinti“',
        ],
        'cj_webhooks_request_body_list' => [
        'journey_body' => 'Siųsti „Smart Guide“ informaciją',
        'custom_body' => 'Siųsti tinkintą įrašo turinį',
        ],
        ...
        'create_record' => 'Kurti įrašą',
        'update_record' => 'Atnaujinti įrašą',
        ],
        'cj_forms_action_trigger_type_list' => [
        'automatic_create' => 'Automatiškai sukurti įrašą',
        'manual_create' => 'Rankiniu būdu sukurti įrašą',
        'automatic_update' => 'Automatiškai atnaujinti įrašą',
        'manual_update' => 'Rankiniu būdu atnaujinti įrašą',
        ],
        'cj_forms_parent_type_list' => [
        '' => '',
        'DRI_Workflow_Templates' => '„Smart Guide“ šablonas',
        'DRI_SubWorkflow_Templates' => 'Etapo šablonas',
        'DRI_Workflow_Task_Templates' => 'Veiklos šablonas',
        ],
        ...
        'Tasks' => 'Dabartinė užduotis',
        'Calls' => 'Dabartinis skambutis',
        'Meetings' => 'Dabartinis susitikimas',
        ],
        'cj_select_to_options_list' => [
        '' => '',
        'specific_users' => 'Specialieji vartotojai',
        'specific_contacts' => 'Specialieji kontaktai',
        'related_parent_users' => 'Susiję tėvai vartotojai',
        'related_parent_contacts' => 'Susiję tėvai kontaktai',
        'add_all_contacts_from_parent' => 'Pridėti visus kontaktus iš tėvo',
        ],
        'cj_select_to_options_list_module_mapping' => [
        '' => '',
        'specific_users' => 'Vartotojai',
        'specific_contacts' => 'Kontaktai',
        'related_parent_users' => 'Vartotojai',
        'related_parent_contacts' => 'Kontaktai',
        'add_all_contacts_from_parent' => 'Kontaktai',
        ],
        'cj_relative_datetime_type_list' => [
        'minutes' => 'Minutė (-ės)',
        'hours' => 'Valanda (-os / -ų)',
        'days' => 'Diena (-os / -ų)',
        'months' => 'Mėnuo (-esiai / -esių)',
        ],
        ...
        '' => '',
        'users' => 'Vartotojai dabartinėje pamainoje',
        'teams' => 'Komandos',
        'roles' => 'Vaidmenys',
        ],
        'cj_forms_main_trigger_type_list' => [
        '' => '',
        'smart_guide_to_sugar_action' => 'Iš „Smart Guide“ į „Sugar“ veiksmus',
        'sugar_action_to_smart_guide' => 'Iš „Sugar“ veiksmo į „Smart Guide“',
        ],
        ...
        '' => '',
        'Smart Guide Stage' => '„Smart Guide“ etapas',
        'Smart Guide Activities' => '„Smart Guide“ veiksmai',
        ...
        'in_progress' => 'Vykdoma',
        'completed' => 'Užbaigta',
        'not_applicable' => 'Netaikomas',
        ],
        'dri_subworkflow_complete_action_list' => [
        '' => '',
        'mark_all_completed' => 'Pažymėti visas veiklas kaip užbaigtas',
        'mark_all_not_applicable' => 'Pažymėti visas nebaigtas veiklas kaip „Netaikytina“',
        ],
        'doc_merge_default_region_url' => [
        'us-west-2' => 'Jungtinės Amerikos Valstijos (Oregonas) [us-west-2]',
        'ca-central-1' => 'Kanada (Centrinė) [ca-central-1]',
        'ap-southeast-1' => 'Azijos ir Ramiojo vandenyno regionas (Singapūras) [ap-southeast-1]',
        'ap-southeast-2' => 'Azijos ir Ramiojo vandenyno regionas (Sidnėjus) [ap-southeast-2]',
        'eu-central-1' => 'Europa (Frankfurtas) [eu-central-1]',
        'eu-west-2' => 'Europa (Londonas) [eu-west-2]',
        ],
];
...
$app_strings = [
    ...
    'LBL_SIDEBAR_NAV_OPEN' => 'Atidaryti',
    'LBL_SIDEBAR_NAV_CLOSE' => 'Uždaryti',
    'LBL_SIDEBAR_NAV_ITEM_MENU' => '{{subject}} meniu',
    'LBL_GOTO_SUGARCRM_COM' => 'Eiti į SugarCRM.com',
 ...
 Prašome pakeisti reikšmes.',
    ...
    'ERR_REPORTS_DISABLED_EXPORT' => 'Ataskaitų eksportas išjungtas',
    'ERR_REPORTS_ADMIN_EXPORT_ONLY' => 'Eksportuoti gali tik administratoriaus teises turintys naudotojai',
    'ERR_REPORTS_EXPORT_NOT_ALLOWED' => 'Ataskaitoje naudojami moduliai be eksporto prieigos',
    'ERR_REPORTS_EXPORT_OWNER' => 'Ataskaitoje naudojami moduliai su savininko eksporto prieiga',
    'ERR_REPORTS_LIST_NOT_ALLOWED' => 'Ataskaitoje naudojami moduliai su ribota sąrašo prieiga',
    'ERR_REPORTS_VIEW_NOT_ALLOWED' => 'Ataskaitoje naudojami moduliai su ribota peržiūros prieiga',
    'ERR_REPORTS_ACCESS_DISABLED' => 'Ataskaitoje naudojami moduliai su ribota prieiga',
    'ERR_REPORTS_FIELDS_RESTRICTED' => 'Ataskaitoje naudojami laukai su ribota prieiga',
    ...
    'ERR_OPPORTUNITY_NAME_DUPE' => 'Galimybė su pavadinimu %s jau egzistuoja.  Toliau įveskite kitą pavadinimą.',
    ...
    'EXCEPTION_CLIENT_NOT_ALLOWED' => 'Šiam klientui neleidžiama',
    'EXCEPTION_MODULELOADER_UPLOAD' => 'Galimybė įkelti paketus neprieinama jūsų licencijos tipui',
    ...
    'EXCEPTION_CLIENT_NOT_ALLOWED_DESC' => 'Šiam klientui neleidžiama',
    ...
    'LBL_DOCUSIGN_SELECT_RECIPIENTS' => 'Pasirinkite pasirašantįjį gavėją',
    ...
    'TPL_LISTVIEW_SELECTED' => 'Rezultatų rinkinyje pasirinkote {{num}} įrašų.',
    ...
    'LBL_COUNT_MODULES' => '{{count}} moduliai',
...
Sincerely, SugarCRM',
    ...
    'LBL_METRIC_DELETE_WARNING' => 'Priėjimo taip pat neteks visi vartotojai, su kuriais buvo bendrinama ši metrikos kortelė.',
    ...
    'NTC_DELETE_SUCCESS' => 'Ištrynėte {0}.',
...
Atlikę šį veiksmą jūs iš karto atsijungsite ir kitą kartą prisijungdami turėsite iš naujo atlikti autentifikavimą naudodami autentifikavimo programą.',
    ...
    // Console Metric Tabs
    'LBL_NO_METRIC_CONFIGURED' => 'Nėra sukonfigūruotų metrikos kortelių',
    'LBL_NO_METRIC_VISIBLE' => 'Nėra matomų metrikos kortelių',
    'LBL_MAKE_METRIC_VISIBLE' => 'Pasirinkite „tvarkyti“, kad metrikos kortelės būtų matomos',
    'LBL_PLEASE_CONTACT_ADMIN' => 'Susisiekite su administratoriumi',
    ...
    'LBL_LEARNING_RESOURCES_SUGAR_OUTFITTERS_LINK' => '„SugarOutfitters“ prekyvietė',
    ...
    'LBL_PLURAL_LABEL' => 'Daugiskaita',
    'LBL_MODULE_DISPLAY' => 'Rodymas',
    'LBL_MODULE_DISPLAY_TYPE' => 'Atvaizdavimo tipas',
    'LBL_MODULE_ICON' => 'Piktograma',
    'LBL_MODULE_COLOR' => 'Modulio fono spalva',
    'LBL_LANGUAGE_SELECTOR' => 'Kalba',
    'LBL_MODULE_NAMES_AND_ICONS_SETTINGS' => 'Modulio nustatymai',
    'LBL_MODULE_NAMES_AND_ICONS_SETTINGS_SAVED' => 'Modulio nuostatos įrašytos.',
    ...
    'LBL_ADD_BUTTON_LABEL' => 'Pridėti',
    'LBL_EDIT_BUTTON_TITLE' => 'Redaguoti',
    'LBL_REFRESH_BUTTON_LABEL' => 'Atnaujinti',
    'LBL_REFRESH_BUTTON_TITLE' => 'Atnaujinti',
    'LBL_DUPLICATE_BUTTON_KEY' => 'u',
    'LBL_DUPLICATE_BUTTON_LABEL' => 'Kopijuoti',
    'LBL_DUPLICATE_BUTTON_TITLE' => 'Kopijuoti',
    'LBL_REPORT_SCHEDULES_BUTTON_LABEL' => 'Ataskaitos planai',
    'LBL_REPORT_SCHEDULES_BUTTON_TITLE' => 'Ataskaitos planai',
    'LBL_REPORT_DETAILS_BUTTON_LABEL' => 'Ataskaita išsamiau',
    'LBL_REPORT_DETAILS_BUTTON_TITLE' => 'Ataskaita išsamiau',
    ...
    'LBL_LAST_COMMIT' => 'Paskutinis įsipareigojimas:',
    ...
    'LBL_TIMEZONE_UPDATED' => '„Sugar“ atnaujino jūsų vartotojo profilio laiko juostą, kad ji atitiktų jūsų naršyklės laiko juostą',
    ...
    'LBL_YES' => 'Taip',
    'LBL_NO' => 'Ne',
    'LBL_SHOW_NUMBERING' => 'Rodyti etapo numeravimą',
    'LBL_HIDE_NUMBERING' => 'Slėpti etapo numeravimą',
    ...
    'ERR_OFFLINE_CLEAN_UP_CONFIRMATION' => 'Pritrūko vietos neprisijungusioje saugykloje. Rekomenduojama išvalyti saugyklą. Tai gali užtrukti kelias minutes.',
    ...
    'LBL_ERR_EXPORTING_CSV' => 'Eksportuoti nepavyko',
    'LBL_ERR_EXPORT_ALL' => 'Nepavyko gauti pasirinktų įrašų duomenų, bandykite dar kartą',
    'LBL_LIST_SETTINGS_RESTORE' => 'Atkurti numatytuosius nustatymus',
    'LBL_LIST_SETTINGS_RESTORE_CONFIRM' => 'Atkurti laukus?',
    'LBL_LIST_SETTINGS_TITLE' => 'Sąrašo rodinio kūrimo priemonė',
    'LBL_LIST_SETTINGS_TEXT_TITLE' => 'Galimi laukai',
    'LBL_LIST_SETTINGS_REMOVE' => 'Pašalinti',
    'LBL_LIST_SETTINGS_TEXT' => 'Vilkite laukus į sąrašo rodinio kūrimo priemonę ir pertvarkykite juos, kad sukurtumėte {{moduleName}} sąrašo rodinį.',
    'LBL_LIST_SETTINGS_ERROR_EMPTY' => 'Į maketą turi būti įtrauktas bent vienas laukas.',
    'LBL_LIST_SETTINGS_EMPTY' => 'Nėra galimų laukų',
    'LBL_LIST_SETTINGS_NO_MATCHING' => 'Atitinkančių laukų nerasta',
    'LBL_LIST_FILTER' => 'Lauko paieška',
    'LBL_MOBILE_APP_EMAIL_CLIENT' => 'Pašto klientas',
    'LBL_DEFAULT_SYSTEM_CLIENT' => 'Išorinis el. pašto klientas',
    'LBL_SUGAR_MOBILE_CLIENT' => '„Sugar“ el. pašto klientas',
    'LBL_OFFLINE_CAPABILITIES' => 'Įgalinti neprisijungus pasiekiamas galimybes',
    'LBL_OFFLINE_TRANSACTION_DELETE_ERROR' => 'Nepavyko ištrinti operacijos.',
    'LBL_OFFLINE_TRANSACTION_DELETED' => 'Operacija ištrinta.',
    'LBL_SECURE_MODE' => 'Patobulintas saugos režimas',
    'LBL_SECURE_MODE_ANDROID_TEXT' => 'Įjunkite šį nustatymą, kad paslėptumėte „Sugar Mobile“ turinį, kai programa veikia fone, ir bet kuriuo metu neleistumėte daryti programos ekrano kopijų.',
    'LBL_SECURE_MODE_IOS_TEXT' => 'Įjunkite šį nustatymą, kad paslėptumėte „Sugar Mobile“ turinį, kai programa veikia fone.',
    'LBL_ALWAYS_OFFLINE_MODE' => 'Režimas „Visada neprisijungus“',
    'LBL_ALWAYS_OFFLINE_MODE_ENABLED_PROMPT' => 'Dirbate režimu „Visada neprisijungus“. Ar norėtumėte vėl prisijungti?',
    'LBL_RECONNECT' => 'Prisijungti iš naujo',
    'LBL_STAY_OFFLINE' => 'Likti neprisijungus',
    'ERR_MOBILE_MODULE_NOT_SUPPORTED' => 'Modulis, kurį bandote pasiekti, nepasiekiamas „Sugar Mobile“.',
    'LBL_MOBILE_RELEASE_NOTE' => '„Sugar Mobile“, skirto {{platform}} laidos informacija',
    'LBL_MOBILE_USER_GUIDE' => '„Sugar Mobile“, skirto {{platform}} vartotojo vadovas',
    'LBL_OPERATOR_CONTAINING_THESE_WORDS' => 'containing these words',
    'LBL_OPERATOR_EXCLUDING_THESE_WORDS' => 'excluding these words',
    'LBL_NOTIFICATIONS_CHANNEL' => 'Naujiniai',
    'LBL_APPLY_BUTTON_LABEL' => 'Pritaikyti',
    'LBL_ACTION_CREATE_FAILURE' => "Nepavyko išsaugoti įrašo:\n {{{reason}}}",
    'LBL_ACTION_UPDATE_FAILURE' => "Nepavyko atnaujinti įrašo:\n {{{reason}}}",
    'LBL_ACTION_FIELD_CALC_ERROR' => 'Nepavyko išspręsti laukų skaičiavimo serveryje.',
    'LBL_ACTION_MODEL_VALIDATION_ERROR' => 'Šie laukai neteisingi: {{{fields}}}.',
    'LBL_ACTION_CREATE_RECORD_SUCCESS' => '<b>Pavyko.</b> Sėkmingai sukūrėte {{{module}}} <a href="#{{{recordUrl}}}">"{{{recordName}}}".</a>',
    'LBL_ACTION_UPDATE_SUCCESS' => '<b>Pavyko.</b> Sėkmingai atnaujinote įrašą',
    'LBL_ACTION_COMPOSE_FAILED_DATA_FETCH' => 'Nepavyko gauti el. pašto duomenų iš serverio.',
    'LBL_ASSIGN_SUCCESS' => '<b>Pavyko.</b> Įrašas priskirtas {{{userName}}}',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_TITLE' => 'Įrašyti šį el. laišką kaip juodraštį?',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_CONFIRM' => 'Įrašyti kaip juodraštį',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_CANCEL' => 'Atsisakyti el. laiško',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_MSG' => 'Jei neišsaugosite juodraščio, prarasite šį el. laišką.',
    'LBL_MOBILE_EMAIL_CHOOSE_SIGNATURE' => 'Pasirinkite parašą',
    'LBL_MOBILE_EMAIL_CHOOSE_TEMPLATE' => 'Pasirinkti laiško šabloną',
    'LBL_MOBILE_EMAIL_CONFIRM_TEMPLATE' => 'Šablonas perrašys visą šio el. laiško turinį. Ar tikrai norite naudoti šį šabloną ir perrašyti turinį?',
    'LBL_MOBILE_EMAIL_COMPOSE' => 'Rašyti laišką',
    'LBL_MOBILE_EMAIL_NO_RELATED_TO_WITH_TEMPLATE_SEND_ANYWAYS' => 'Jūsų el. laiške yra kintamųjų, kurie bus pakeisti įrašo „Susiję su“ reikšmėmis. Prieš siųsdami patvirtinkite, kad laukas „Susiję su“ nustatytas teisingai.',
    'LBL_ERR_NO_OUTBOUND_ACCOUNTS_AVAILABLE' => 'Siunčiamo el. laiško paskyros nerasta. Susisiekite su „Sugar“ administratoriumi.',
    'LBL_EMAIL_MORE_RECIPIENTS' => ' ir dar {{{count}}}',
    'LBL_RECEPIENTS_EMAIL_ADD' => 'Pridėti el. paštą',
    'LBL_EMAIL_RECIPIENTS_EMPTY_HINT' => 'Įveskite kontakto vardą arba el. pašto adresą',
    'LBL_EMAIL_RECIPIENT_NEW_EMAIL' => '{{{email}}} (naujas el. laiškas)',
    'LBL_TEMPLATE_HAS_VARIABLES' => 'Kintamieji',
    'LBL_FILTER_EMAIL_TYPE_TEMPLATES' => 'Laiškų šablonai',
    'LBL_FILTER_CAMPAIGN_TYPE_TEMPLATES' => 'Kampanijos šablonai',
    'LBL_FILTER_WORKFLOW_TYPE_TEMPLATES' => 'Darbo sekos šablonai',
    'LBL_FILTER_SYSTEM_TYPE_TEMPLATES' => 'Sistemos šablonai',
    'LBL_FILTER_EDIT' => 'Redaguoti filtrą',
    'LBL_FILTER_MY_FILTER' => 'Mano filtras',
    'LBL_FILTER_MY_FILTER_BY' => 'Mano filtras pagal {{{filtrus}}}',
    'LBL_FILTER_SAVE' => 'Įrašyti filtrą',
    'LBL_SELECT_PARAM' => 'Pasirinkti',
    'LBL_SELECT_MODULES' => 'Modulio parinkiklis',
    'LBL_SELECT_ADDITIONAL_PARAMS' => 'Pasirinkite papildomą parametrą',
    'LBL_FILTER_TEMPORARY' => 'Laikinas filtras',
    'LBL_ERROR_FILE_UPLOAD' => 'Nepavyko įkelti {{{fieldLabel}}} failo "{{{fileName}}}". {{{reason}}}',
    'LBL_ERROR_EDIT_FAILED_UPLOAD' => '<br/><a href="#{{{recordUrl}}}">Peržiūrėti nepavykusį įrašą</a>',
    'LBL_FILE_UPLOAD_ONE' => 'Failas saugomas...',
    'LBL_FILE_UPLOAD_MANY' => 'Išsaugomas {{{index}}} failas iš {{{total}}}...',
    'LNK_NOTIFICATIONS_SETTINGS' => 'Pranešimų nustatymai',
    'LBL_PUSH_NOTIFICATIONS_SETTINGS' => 'Tvarkykite „Push“ pranešimus',
    'LBL_PUSH_NOTIFICATIONS_SETTINGS_FOOTER' => "Valdykite, kaip bus rodomi pranešimai, naudodami įrenginio pranešimų nustatymus.",
    'LBL_NOTIFICATION_ASSIGMENTS' => 'Paskyrimai',
    'LBL_NOTIFICATION_ASSIGMENTS_DSC' => 'Gaukite pranešimus, kai jums priskiriami įrašai.',
    'LBL_NOTIFICATION_MENTIONS' => 'Paminėjimai',
    'LBL_NOTIFICATION_MENTIONS_DSC' => 'Gaukite pranešimus, kai esate paminėtas komentarų žurnalo įrašuose.',
    'LBL_NOTIFICATIONS_COMMENTLOG_MISSING' => 'Administratorius nepridėjo komentarų žurnalo lauko prie šio maketo. Susisiekite su „Sugar“ administratoriumi.',
    'ERR_NO_PERMISSION_TITLE' => 'Leiskite prieigą',
    'ERR_NO_CAMERA_PERMISSION_MSG' => '{{{brandName}}} reikalinga prieiga prie fotoaparato, kad galėtumėte pridėti nuotraukų. Leiskite pasiekti fotoaparatą sistemos nustatymuose.',
    'LBL_MOBILE_SYSTEM_SETTINGS' => 'Nustatymai',
    'LBL_ACTIVE_SUBSCRIPTIONS_FIELD_DURATION' => 'Trukmė',
    'LBL_ACTIVE_SUBSCRIPTIONS_FIELD_TIMEREMAINING' => 'Likęs laikas',
    'LBL_LIST_SUPPORT_EXPIRES' => 'Nebegalios',
    'LBL_CASCADE_RLI_EDIT' => 'Atnaujinti atvirų pajamų eilutės elementus',
    'LBL_MOBILE_CALENDAR' => 'Kalendorius',
    'LBL_MOBILE_CALENDAR_SETTINGS' => 'Kalendoriaus nustatymai',
    'LBL_MOBILE_CALENDAR_WEEK_START' => 'Savaitės pradžios diena',
    'LBL_MOBILE_CALENDAR_MODULES' => 'Rodytini įvykiai',
    'LBL_MOBILE_CALENDAR_DURATION_HR_MIN' => '{{{hours}}}val.:{{{minutes}}} min.',
    'LBL_MOBILE_CALENDAR_DURATION_HR' => '{{{hours}}} val.',
    'LBL_MOBILE_CALENDAR_DURATION_MIN' => '{{{minutes}}} min.',
    'LBL_MOBILE_CALENDAR_TODAY' => 'Šiandien',
    'LBL_MOBILE_CALENDAR_CREATE_MSG' => 'Pridėti {{{moduleName}}}',
    'LBL_MOBILE_CALENDAR_CREATE_TITLE' => 'Suplanuokite veiklą',
    'LBL_MOBILE_CALENDAR_ERROR_NO_MODULE' => 'Įjunkite bent vieną įvykio tipą.',
    'LBL_MOBILE_CALENDAR_EVENT_ALL_DAY' => 'Visa diena',
    'LBL_MOBILE_CALENDAR_INITIALIZATION_ERROR' => 'Nepavyko įkelti kalendorių.',
    'LBL_ACTIONBUTTON_NOT_SUPPORTED_ACTION' => 'Šis veiksmas nepasiekiamas „Sugar Mobile“. Ar vietoj jo norite atidaryti darbalaukio programą?',
    'LBL_DOC_MERGES_SELECT_TEMPLATE' => 'Pasirinkite šabloną',
    'LBL_DOC_MERGES_ACTION_MERGE' => 'Apjungti',
    'LBL_ERROR_IMAGE_NO_EXIF' => 'Klaida: HEIC faile trūksta EXIF duomenų',
    'LBL_ERROR_IMAGE_TOO_BIG' => 'Klaida: Vaizdo skyra per didelė',
    'LBL_ERROR_IMAGE_CANNOT_PROCESS' => 'Klaida: Nepavyko apdoroti vaizdo',
    'LBL_ERROR_IMAGE_CANVAS_FAILED' => 'Klaida: Nepavyko pateikti vaizdo į drobę',
    'LBL_ERROR_IMAGE_LOAD_FAILED' => 'Klaida: Nepavyko įkelti failo kaip vaizdo',
    'LBL_ACTIONS_SELECTION_COUNT_SINGLE' => 'Pasirinktas 1 elementas',
    'LBL_ACTIONS_SELECTION_COUNT_MULTIPLE' => 'Pasirinkta elementų: {{{count}}}',
    'LBL_ACTIONS_SELECT_ALL_TITLE' => 'Pasirinkti visus',
    'LBL_ACTIONS_SELECT_ALL_HEADER' => 'Šiame rodinyje pasirinkote {{{count}}} įrašų. Pasirinkti visus įrašus?',
    'LBL_ACTIONS_SELECT_ALL_VISIBLE' => 'Pasirinkite {{{count}}} įrašų',
    'LBL_ACTIONS_SELECT_DELETE_CONFIRM' => 'Ar tikrai norite ištrinti pasirinktą (-us) įrašą (-us)?',
    'LBL_ACTIONS_MASS_DELETE_PROGRESS' => 'Šalinama… {{{count}}} iš {{{total}}}',
    'LBL_ACTIONS_MASS_EMAIL_EMPTY' => 'Pasirinktuose įrašuose nerasta galiojančių el. pašto adresų',
    ...
    'LBL_OPERATOR_ONE_OF' => 'yra vienas iš',
    'LBL_OPERATOR_NOT_ONE_OF' => 'nėra vienas iš',
    'LBL_OPERATOR_CONTAINS' => 'yra vienas iš',
    'LBL_OPERATOR_CONTAINS_WORD' => 'turi',
    ...
    'LBL_OPERATOR_MORE_X_DAYS_AGO' => 'Daugiau nei prieš __ d.',
    'LBL_OPERATOR_LAST_X_DAYS' => 'Paskutinės __ d.',
    'LBL_OPERATOR_NEXT_X_DAYS' => 'Kitos __ d.',
    'LBL_OPERATOR_MORE_X_DAYS_AHEAD' => 'Daugiau nei __ d. į ateitį',
    ...
    'LBL_OPERATOR_AFTER_TODAY' => 'po šiandienos',
    'LBL_OPERATOR_BEFORE_TODAY' => 'prieš šiandieną',
    ...
    'LBL_AGENT_WORKBENCH' => 'Priežiūros konsolė',
    ...
    //14.0 Dashboards
    'LBL_BRD__CONSOLE' => 'BDR ataskaitų sritis',
    'LBL_SALES_MANAGER_CONSOLE' => 'Pardavimų vadovo ataskaitų sritis',
    'LBL_SALES_REP_CONSOLE' => 'Pardavimų atstovo ataskaitų sritis',
    'LBL_MARKETING_CONSOLE' => 'Rinkodaros ataskaitų sritis',
    'LBL_CUSTOMER_SUCCESS_CONSOLE' => 'Pavykusios kliento operacijos ataskaitų sritis',
    'LBL_EXECUTIVE_CONSOLE' => 'Vykdomoji ataskaitų sritis',
    ...
    'LBL_CHANGE_YOUR_PASSWORD' => 'Pakeiskite savo slpatažodį',
    'LBL_PASSWORD_REQUIREMENTS' => 'Slaptažodžio reikalavimai',
    'LBL_CURRENT_PASSWORD' => 'Senas slaptažodis',
    'LBL_NEW_PASSWORD1' => 'Naujas slaptažodis',
    'LBL_NEW_PASSWORD2' => 'Patvirtinti slaptažodį',
    'LBL_PASSWORD_CHANGED' => 'Sėkmingai pakeitėte slaptažodį',
    ...
    'LBL_NO_CHART_REPORT_AVAILABLE' => 'Nėra grafiko.',
    'LBL_NO_FILTERS_REPORT_AVAILABLE' => 'Šioje ataskaitoje nėra filtrų.',
    'LBL_NO_RUNTIME_FILTERS_REPORT_AVAILABLE' => 'Turite tik paslėptus vykdymo laiko filtrus, žr. išplėstinius filtrus.',
    'LBL_RUNTIME_FILTERS' => 'Dinaminiai filtrai',
    'LBL_RUNTIME_FILTER_DATE_PREF_MISSMATCH' => 'Data neatitinka vartotojo pageidaujamo datos formato:',
    'LBL_DASHLET_NO_RUNTIME_FILTERS' => 'Ši ataskaitų sritis neturi dinaminių filtrų',
    'LBL_DASHBOARD_FILTER_GROUP' => 'Naujas filtras',
    'LBL_RUNTIME_FILTER_LIMITATION' => 'Reikia pasirinkti bent vieną reikšmę.',
    'LBL_RESET_FILTERS_TO_DEFAULT' => 'Atstatyti numatytuosius filtrus',
    'LBL_COPY_FILTER_SUMMARY' => 'Kopijuoti filtro suvestinę',
    'LBL_APPLY_FILTERS' => 'Pritaikyti',
    'LBL_REPORTS_FILTERS' => 'Filtrai',
    'LBL_RUNTIME_FILTERS_INVALID' => 'Vykdymo laiko filtrų negalima taikyti dėl netinkamų verčių',
    'LBL_RUNTIME_FILTERS_COPIED' => 'Filtro suvestinė nukopijuota į mainų sritį.',
    'LBL_ADVANCED_FILTERS' => 'Išplėstiniai filtrai',
    'LBL_ADVANCED_OR_DESC' => 'Įtraukti, kai įvykdoma BET KOKIA sąlyga',
    'LBL_ADVANCED_AND_DESC' => 'Įtraukti, kai įvykdomos VISOS sąlygos',
    'LBL_ORIGINAL_DESIGN_FILTER' => 'Tai originalaus dizaino filtras',
    'LBL_AND_UPPERCASE' => 'IR',
    'LBL_REPORTS_PREVIEW_LIMITATION' => 'Ši funkcija negalima peržiūros režimu',
    'LBL_REPORT_DEFAULT_NAME' => 'Pranešimas be pavadinimo',
    'LBL_REPORT_QUERY' => 'Užklausa',
    'LBL_REPORTS_DASHLET_INTELLIGENT' => 'Susiję su dabartiniu įrašu',
    'LBL_REPORTS_DASHLET_RELATED_LINK' => 'Susietas laukas',
    'LBL_REPORTS_DASHLET_INVALID_LINK' => 'Susietas laukas negali būti tuščias',
    'LBL_REPORTS_DASHLET_INVALID_REPORT' => 'Nepasirinkta ataskaita.',
    'LBL_REPORTS_DASHLET_LINE_CHART_INVALID' => 'Linijinė diagrama nesuderinama su šia ataskaita',
    'LBL_REPORT_DASHLET' => 'Pranešti apie „Dashlet“',
    'LBL_REPORTS_DASHLET_DATATABLE' => 'Duomenų lentelė',
    'LBL_REPORTS_DASHLET_RUNTIME_FILTERS' => 'Dinaminiai filtrai',
    'LBL_REPORTS_DASHLET_DATATABLE_PREVIEW' => 'Duomenų lentelės peržiūra',
    'LBL_REPORTS_DASHLET_CHART' => 'Grafikas',
    'LBL_REPORTS_DASHLET_CHART_PREVIEW' => 'Grafiko peržiūra',
    'LBL_REPORTS_DASHLET_FILTER_PREVIEW' => 'Filtro peržiūra',
    'LBL_REPORTS_DASHLET_INVALID_FEATURE' => 'Pasirinkta ataskaita nepalaiko diagramos.',
    'LBL_REPORTS_DASHLET_LABELS' => 'Etiketės',
    'LBL_REPORTS_DASHLET_SHOW_COUNT' => 'Rodyti bendrą įrašų skaičių',
    'LBL_REPORTS_DASHLET_SORT_ORDER' => 'Rūšiavimo tvarka',
    'LBL_REPORTS_DASHLET_DEFAULT_VIEW' => 'Numatytasis pasirinktas rodinys',
    'LBL_REPORTS_DASHLET_PRIMARY_CHART_SORT' => 'Pirminė diagramos rūšiavimo tvarka',
    'LBL_REPORTS_DASHLET_SECONDARY_CHART_SORT' => 'Antrinė diagramos rūšiavimo tvarka',
    'LBL_REPORTS_DASHLET_NO_LINKS_SELECTED' => 'Nėra {{module}} nuorodų į pasirinktą ataskaitą',
    'LBL_REPORTS_DASHLET_NO_AVAILABLE_FOR_REPORT_TYPE' => 'Negalima šiam pranešimo tipui',
    'LBL_REPORTS_DASHLET_UNABLE_TO_DOWNLOAD_CHART_TAB' => 'Ši funkcija prieinama tik diagramos kortelėje',
    'LBL_REPORTS_CHART_TYPE' => 'Grafiko tipas',
    'LBL_REPORTS_CHART_CONFIG_VALUE_PLACEMENT' => 'Stulpelinės diagramos reikšmių išdėstymas',
    'LBL_REPORTS_CHART_CONFIG_SHOW_TOTAL' => 'Rodyti iš viso',
    'LBL_REPORTS_CHART_LEGEND_OPEN' => 'Rodyti legendą',
    'LBL_REPORTS_CHART_CONFIG_SHOW_XAXIS_LABEL' => 'Rodyti x ašies etiketę',
    'LBL_REPORTS_CHART_CONFIG_SHOW_YAXIS_LABEL' => 'Rodyti y ašies etiketę',
    'LBL_REPORTS_DASHLET_CONFIGURE_DISPLAY_ROWS' => 'Eilučių rodymo riba',
    'LBL_REPORTS_DASHLET_RUNTIME_NO_PERMISSONS' => 'Neturite leidimo naudoti šiuos paleidimo laiko filtrus.',
...
To create a new record using the values you have entered, click "Ignore Duplicate and Save" at the top right of the screen.',
    ...
    'LBL_CALENDAR_REPEAT_ON' => 'Pakartokite',
    ...
    'TPL_REPEAT_INTERVAL' => 'Kiekvieną {{repeatIntervalValue}} {{repeatTypeValue}}',
    'LBL_UNSUPPORTED_RRULE' => 'Ši serija naudoja parinktį Kartoti, kurios nėra „Sugar“, nes serija buvo sinchronizuota iš kalendoriaus kliento. Redaguokite šią seriją savo kalendoriaus kliente, jei norite nuolat kartoti konkrečią datą. Redaguojant šią seriją „Sugar“, „Repeat On“ bus nustatyta į „Nėra“.<br><br>Ar norėtumėte tęsti?',
    ...
    'LBL_CALENDAR_WEEK' => 'savaitė',
    'LBL_CALENDAR_MONTH' => 'mėnuo',
    'LBL_CALENDAR_YEAR' => 'metai',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_2'  => '2-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_3'  => '3-ioji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_4'  => '4-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_5'  => '5-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_6'  => '6-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_7'  => '7-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_8'  => '8-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_9'  => '9-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_10' => '10-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_11' => '11-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_12' => '12-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_13' => '13-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_14' => '14-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_15' => '15-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_16' => '16-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_17' => '17-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_18' => '18-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_19' => '19-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_20' => '20-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_21' => '21-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_22' => '22-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_23' => '23-ioji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_24' => '24-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_25' => '25-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_26' => '26-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_27' => '27-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_28' => '28-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_29' => '29-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_30' => '30-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_31' => '31-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_32' => '32-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_33' => '33-ioji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_34' => '34-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_35' => '35-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_36' => '36-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_37' => '37-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_38' => '38-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_39' => '39-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_40' => '40-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_41' => '41-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_42' => '42-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_43' => '43-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_44' => '44-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_45' => '45-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_46' => '46-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_47' => '47-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_48' => '48-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_49' => '49-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_50' => '50-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_51' => '51-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_52' => '52-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_53' => '53-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_54' => '54-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_55' => '55-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_56' => '56-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_57' => '57-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_58' => '58-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_59' => '59-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_60' => '60-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_61' => '61-asis',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_62' => '62-asis',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_63' => '63-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_64' => '64-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_65' => '65-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_66' => '66-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_67' => '67-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_68' => '68-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_69' => '69-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_70' => '70-asis',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_71' => '71-asis',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_72' => '72-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_73' => '73-ioji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_74' => '74-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_75' => '75-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_76' => '76-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_77' => '77-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_78' => '78-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_79' => '79-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_80' => '80-asis',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_81' => '81-asis',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_82' => '82-asis',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_83' => '83-ioji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_84' => '84-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_85' => '85-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_86' => '86-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_87' => '87-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_88' => '88-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_89' => '89-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_90' => '90-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_91' => '91-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_92' => '92-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_93' => '93-ioji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_94' => '94-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_95' => '95-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_96' => '96-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_97' => '97-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_98' => '98-oji',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_99' => '99-oji',
    ...
    'LBL_ACTIVITY_TIMELINE_DASHLET_DESCRIPTION' => 'Laiko planavimo juostoje rodomi su dabartiniu įrašu susiję įrašai ir pasirenka laukų naujinimus laikui bėgant.',
...
// Omnichannel
    ...
    'LBL_ACTIONBUTTON_DISPLAY_ON_FOCUS_DASHBOARD' => 'Rodymas „Focus“ ataskaitų srities antraštėje',
    'LBL_ACTIONBUTTON_DASHBOARD' => 'Ataskaitų sritis',
    'LBL_ACTIONBUTTON_FOCUS_DASHBOARD_HEADER' => '„Focus“ ataskaitų srities antraštė',
    ...
    'LBL_ACTIONBUTTON_LINK' => 'Sukurti santykį su pagrindiniu',
    'LBL_ACTIONBUTTON_COPY_PARENT' => 'Kopijuoti pagrindines vertes',
    'LBL_ACTIONBUTTON_PRESET' => 'Nustatyti lauko reikšmę (-es)',
    'LBL_ACTIONBUTTON_PRESET_PARENT' => 'Kopijuoti lauko reikšmę (-s) ir pagrindinio',
    ...
    'LBL_ACTIONBUTTON_RECORD_VIEW' => 'Įrašo peržiūros antraštė',
    'LBL_ACTIONBUTTON_RECORD_VIEW_DASHLET' => 'Įrašų rodymo skydelio antraštė',
    ...
    'LBL_ACTIONBUTTON_ASSIGN_CURRENT_USER' => 'Esamas vartotojas',
    ...
    'LBL_HINT_MSG_OVERWRITE_ALL' => 'Ar norėtumėte visus esamus šio įrašo duomenis perrašyti naujais duomenimis, nurodytais „Sugar Hint“?',
    'LBL_HINT_MSG_OVERWRITE_FIELD' => 'Ar norėtumėte perrašyti esamą {{fieldName}} įrašą nauju {{fieldName}}, esančiu „Sugar Hint“?',
    ...
    'LBL_HINT_ACCOUNTSETS' => '„Sugar Hint“ paskyrų rinkinių žymos',

    'LBL_HINT_LOADING' => 'Kraunama ...',
    'LBL_HINT_UNINSTALL_PROCESSING' => 'Pašalinama „Sugar Hint“, palaukite',
    ...
    'LBL_HINT_UNINSTALL_PARTIAL_DESCRIPTION' => 'Pasirinkus šią parinktį bus pašalinta „Hint MLP“ ir išjungtos visos aktyvios „Sugar Hint Insights“ prenumeratos.
    ...
    'LBL_HINT_UNINSTALL_HEADER' => 'Pašalinti „Sugar Hint“',
    ...
    'LBL_HINT_UNINSTALL_WARNING_LINK' => '„Sugar Hint“ administravimo vadovas ', // TODO: This URL needs to be changed.
    'LBL_HINT_UNINSTALL_WARNING3' => 'jei noritegauti daugiau informacijos apie pašalinimo procesą.',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE1' => 'Ar tikrai norite pašalinti tik „Sugar Hint“ paketą?',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE2' => 'Ar tikrai norite visiškai pašalinti „Sugar Hint“?',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE2_SUBTEXT' => '(PASTABA: ŠIO VEIKSMO ATŠAUKTI NEGALIMA)',

    'LBL_HINT_CONFIG_TITLE' => '„Sugar Hint“ laukai',
    ...
    'LBL_HINT_RESYNC_NOTIFICATION_DESCRIPTION' => 'Atsargiai: jūs ruošiatės sinchronizuoti su „Sugar Hint Insights“ paslauga. Visos laukiančios el. pašto suvestinės istorijos bus prarastos, o esamos naujienos bus ištrintos iš „Insights“ skydelio. Baigus sinchronizavimą, visų tipų pranešimai bus atnaujinti.',
    ...
    'LBL_HINT_HELP_MESSAGE1' => 'Pagal įvestus duomenis „Sugar Hint“ sistemoje nerado atitikmens.',
    'LBL_HINT_HELP_MESSAGE2' => 'Geriausius „Sugar Hint“ rezultatus galima rasti nurodant asmens vardą ir el. pašto adresą.',
    'LBL_HINT_HELP_MESSAGE3' => 'Geriausius „Sugar Hint“ rezultatus galima rasti naudojant įmonės interneto svetainės url adresą.',
    'LBL_HINT_HELP_DEFAULT_MESSAGE1A' => "Įveskite savo {{_moduleSingular}} įmonės pavadinimą arba svetainę ir „Sugar Hint“ ieškos papildomų duomenų.",
    'LBL_HINT_HELP_DEFAULT_MESSAGE1B' => "Įveskite savo {{currentModule}} el. pašto adresą ir „Sugar Hint“ ieškos papildomų duomenų.",
    ...
    'LBL_HINT_PREVIEW_LICENSE_EXPIRED' => 'Jūsų „Hint“ paslaugos licencijos galiojimas baigėsi. Susisiekite su savo „SugarCRM“ administratoriumi, kad atnaujintumėte licenciją.',
    'LBL_HINT_PREVIEW_QUESTION' => 'Norite sužinoti, ką „Hint“ gali padaryti jums ir jūsų įmonei? Susisiekite su savo „SugarCRM“ administratoriumi ir pridėkite „Hint“.',
    ...
    'LBL_HINT_DASHLET_ALLOWED1' => 'Turite turėti „Sugar Hint“ licenciją, kad galėtumėte peržiūrėti „Sugar Hint Insights“ informacijos rinkinį.
     Paklauskite administratoriaus, kaip gauti „Sugar Hint“ licenciją.',
    ...
    'LBL_NOTIFICATIONS_TITLE' => '„Sugar Hint Insights“ nuostatų centras',
    ...
    'LBL_NOTIFICATIONS_KEY_TITLE_DASHLET' => 'Įtraukti į „Sugar Hint Insights“ informacinį rinkinį',
    ...
    'LBL_HINT_PUSH_MESSAGES_PERMISSION' => 'Ruošiatės įgalinti „Sugar Hint Insights“ naršyklės pranešimus. Spustelėkite „Patvirtinti“, kad tęstumėte. Tada jūsų naršyklė paprašys jūsų leidimo gauti pranešimų įvykius.',
    ...
    'LBL_HINT_SOFT_DISABLE_NOTIFICATIONS_FAILURE' => 'ĮSPĖJIMAS: nepavyko išjungti pranešimų šalinant „Sugar Hint“. Norėdami išjungti pranešimus, įdiekite „Sugar Hint 5.4.0“ arba naujesnę versiją ir atlikite visišką pašalinimą naudodami „Sugar Hint“ pašalinimo programą, kurią rasite „Sugar“ administravimo skyriuje.',
    'LBL_HINT_ENRICH_ALL' => 'Praturtinti visus',
    'LBL_HINT_NO_LICENSE_ACCESS' => 'Reikalinga užuominos licencija',


    //Maps
    'LBL_MAP_CONFIG_TITLE' => 'Žemėlapių konfigūracija',
    'LBL_MAP_CONFIG_GEOCODE_LOG_VIEWER' => 'Geokodavimo priemonės žurnalo žiūryklė',
    ...
    'LBL_MAPS_SHARE_HEADER' => 'Paprašėte „Bing“ žemėlapio šiems taškams:',
    'LBL_MAPS_SHARE_OPEN_URL' => 'Šis URL atvers žemėlapį su aukščiau nurodytais „Bing Maps“ taškais:',
    'LBL_MAPS_SHARE_SHOW_MAP' => 'Rodyti žemėlapį „Bing Maps“.',
    'LBL_MAPS_MAP_ON_BING_WEB' => '„Bing Maps“',
    'LBL_MAPS_NO_VALID_ITINERARY' => 'Numatytų tarpinių taškų maršrutas nerastas.',
    'LBL_MAPS_GEOCODE_STATUS' => 'Geokodo būsena',
    'LBL_MAPS_GEOCODED' => 'Geokoduotas',
    'LBL_MAPS_NOT_GEOCODED' => 'Ne geokoduotas',
    'LBL_MAPS_NOT_FOUND' => 'Netinkamas adresas',
    'LBL_MAPS_GEOCODING_FAILED' => 'Geokodavimas nepavyko',
    'LBL_MAPS_QUEUED' => 'Eilėje',
    'LBL_MAPS_REQUEUED' => 'Iš naujo įtraukta į eilę',
    'LBL_MAPS_RELATED_RECORD' => 'Susijęs įrašas',

    //Report Dashlet
    'LBL_REPORT_DASHLET_CONFIG_VIEW_REPORT' => 'Peržiūrėti ataskaitą',
    'LBL_REPORT_DASHLET_DESC' => 'Rodyti išsaugotą ataskaitą',
    'LBL_REPORT_DASHLET_RESET_DEFAULT' => 'Atstatyti į „Dashlet“ numatytąsias nuostatas',
    'LBL_REPORT_DASHLET_RESET_REPORT_DEFAULT' => 'Atstatyti į numatytąsias nuostatas',
    'LBL_REPORT_DASHLET_REFRESH_RESULTS' => 'Atnaujinti ataskaitos rezultatus',
    'LBL_REPORT_DASHLET_COPY_CHART_CLIPBOARD' => 'Kopijuoti diagramą į iškarpinę',
    'LBL_REPORT_DASHLET_DOWNLOAD_CHART' => 'Atsisiųsti diagramą',
    'LBL_REPORT_DASHLET_REST_TO_REPORT_DEFAULTS' => 'Informacinio rinkinio {{label}} ataskaita buvo redaguota, o informacijos rinkinys buvo iš naujo nustatytas į numatytąją konfigūraciją.',

    'LBL_NO_FIELD_PERMISSION_TO_FILTER' => 'Neturite leidimo naudoti šį lauką.',
    ...
    'LBL_AI_OPP_CLOSE_WEEK_SCORES' => 'Uždaryti savaitės prognozavimo balus',
    'LBL_AI_CONV_SCORE_ABSOLUTE' => 'Prognozavimo vertė',
    'LBL_AI_CONV_BIN_ACCURACY' => 'Prognozavimo dėžės tikslumas',
    'LBL_AI_CONV_MULTIPLIER' => 'Prognozavimo daugiklis',
    'LBL_AI_ICP_FIT_SCORE_ABSOLUTE' => 'ICP vertė',
    'LBL_AI_ICP_FIT_BIN_ACCURACY' => 'ICP dėžės tikslumas',
    'LBL_AI_ICP_FIT_MULTIPLIER' => 'ICP daugiklis',
    'LBL_AI_NEW' => 'Naujas',
    'LBL_AI_ENTERED' => 'Įvesta',
    'LBL_AI_CREATED' => 'Sukurtas',
    'LBL_AI_WEEK' => 'Savaitė',
    'LBL_AI_MONTH' => 'Mėnuo',
    'LBL_AI_QUARTER' => 'Ketvirtis',
    'LBL_AI_BYWEEK' => 'pagal savaitę',
    'LBL_AI_BYMONTH' => 'pagal mėnesį',
    'LBL_AI_BYQUARTER' => 'pagal ketvirtį',
    'LBL_AI_WEEKTREND' => 'Savaitės tendencija',
    'LBL_AI_MONTHLYTREND' => 'Mėnesio tendencija',
    'LBL_AI_QUARTERTREND' => 'Ketvirčio tendencija',
    'LBL_AI_TREND' => 'Tendencija pagal',
    'LBL_AI_TRENDS' => 'Tendencijos pagal',
    'LBL_AI_VELOCITY' => 'Greitis',
    'LBL_AI_TOPX' => 'Viršus {X}',
    'LBL_AI_TIMESPAN' => 'Laiko tarpas tarp etapų -',
    'LBL_AI_BUSINESSTREND' => 'su verslo tendencijomis',
    'LBL_AI_SUGARINSIGHTINTRO' => 'Pristatome „Sugar“ įžvalgas!',
    'LBL_AI_SUGARINSIGHTSDESC' => '„Sugar Insights“ naudoja kiekybinę analizę, kad generuotų naujas įžvalgas apie jūsų „SugarCRM“ duomenis. „Sugar“ visada ieškome naujų būdų, kaip padėti jums kuo geriau išnaudoti savo duomenis ir priimti pagrįstus sprendimus, ir tai tik pradžia to, ką tikimės pasiūlyti su „Sugar Insights“.',
    'LBL_AI_SUGARINSIGHTS_DASHLET_NAME' => '„Sugar Insights“',
    'LBL_AI_SUGARINSIGHTS_DASHLET_DESC' => '„Sugar Insights“ naudoja kiekybinę analizę, kad gautų naujų įžvalgų apie jūsų „SugarCRM“ duomenis.',
    'LBL_AI_FIRMO' => 'Firmographics',
    'LBL_AI_TOTALCOUNT' => 'Bendras skaičius',
    'LBL_AI_DAYSFROMLATESTACT' => 'Dienos nuo praėjusių',
    'LBL_AI_DAYSSINCE' => 'amžius',
    'LBL_AI_FIELDISSET' => 'egzistuoja',
    'LBL_AI_CONTACTCOMPLETENESS' => 'Kontaktinės informacijos išsamumas',
    'LBL_AI_CUTDATE' => 'Prognozavimo laikotarpis',
    'LBL_AI_FROMLASTCHANGE' => 'Dienos nuo paskutinės funkcijos vertės pakeitimo',
    'LBL_AI_CALLSHELD' => 'Bendras surengtų skambučių skaičius',
    'LBL_AI_CALLSPLANNED' => 'Bendras planuojamų skambučių skaičius',
    'LBL_AI_OUTBOUNDCALLS' => 'Bendras siunčiamų skambučių skaičius',
    'LBL_AI_INBOUNDCALLS' => 'Bendras gaunamų skambučių skaičius',
    'LBL_AI_AVGCALLDURATION' => 'Vidutinė skambučių trukmė',
    'LBL_AI_EMAILSARCHIVED' => 'Bendras suarchyvuotų el. laiškų skaičius',
    'LBL_AI_EMAILSREAD' => 'Bendras perskaitytų el. laiškų skaičius',
    'LBL_AI_EMAILSSENT' => 'Bendras išsiųstų el. laiškų skaičius',
    'LBL_AI_CLOSEDATEPUSHEDBACK' => 'Bendras įrašų skaičius, kai numatoma uždarymo data pakeičiama į vėlesnę datą',
    'LBL_AI_CLOSEDATEPUSHEDFORWARD' => 'Bendras įrašų skaičius, kai numatoma uždarymo data pakeičiama į ankstesnę datą',
    'LBL_AI_AMOUNTINCREASED' => 'Iš viso galimybių, kai suma padidėjo',
    'LBL_AI_AMOUNTDECREASED' => 'Iš viso galimybių, kai suma sumažėjo',

    // User last state
    'LBL_LAST_STATE' => 'Paskutinė sūsena',
    // DocuSign
    'LBL_SEND_TO_DOCUSIGN_BUTTON_LABEL' => 'Siųsti į „DocuSign“',
    'LBL_SHORTCUT_EDIT_RECIPIENT_CANCEL' => 'Atšaukti redagavimo gavėją',
    'LBL_RECIPIENT_ROLE' => 'Gavėjo vaidmuo',
    // Base sales stages
    'LBL_OPEN' => 'Atidaryti',
    'LBL_CLOSED_WON' => 'Uždarytas laimėtas',
    'LBL_CLOSED_LOST' => 'Uždarytas pralaimėtas',
    'LBL_KIOSK_ADD_FILES' => 'Pridėti failus',
    'LBL_KIOSK_ADD_DROP_FILES' => 'Pridėti arba nuvilkti failus čia',
    'LBL_KIOSK_CANCEL' => 'Atšaukti',
    'LBL_KIOSK_EDIT' => 'Redaguoti',
    'LBL_KIOSK_EMAIL' => 'El. pašto adresas',
    'LBL_KIOSK_FILES_UPLOADING' => 'Įkeliama',
    'LBL_KIOSK_FILES_ERROR' => 'Nepavyko įkelti priedo',
    'LBL_KIOSK_FILES_ERROR_TOO_LARGE' => 'Priedas per didelis',
    'LBL_KIOSK_FILTER_SEARCH' => 'Paieška',
    'LBL_KIOSK_ID' => 'ID',
    'LBL_KIOSK_TITLE' => 'Kioskas',
    'LBL_KIOSK_LANGUAGE' => 'Kalba',
    'LBL_KIOSK_LAST_UPDATED' => 'Paskutinį kartą atnaujinta',
    'LBL_KIOSK_LIST_VIEW_SELECTION' => 'Rodyti',
    'LBL_KIOSK_MENU' => 'Meniu',
    'LBL_KIOSK_MOBILE_PHONE' => 'Mobilusis telefonas',
    'LBL_KIOSK_MY_ACTIVITIES' => 'Mano veikla',
    'LBL_KIOSK_MY_PROFILE' => 'Mano profilis',
    'LBL_KIOSK_NAME' => 'Vardas',
    'LBL_KIOSK_OFFICE_PHONE' => 'Įstaigos telefonas',
    'LBL_KIOSK_ORGANIZATION' => 'Organizacija',
    'LBL_KIOSK_PAGINATION_FOOTER' => 'Eilutės puslapyje:',
    'LBL_KIOSK_POWERED_BY_SUGARCRM' => 'Teikia „SugarCRM“',
    'LBL_KIOSK_SAVE_CHANGES' => 'Išsaugoti pakeitimus',
    'LBL_KIOSK_SHOW_HIDE' => 'Rodyti / slėpti',
    'LBL_KIOSK_SIGN_IN' => 'Prisijungti',
    'LBL_KIOSK_SIGN_OUT' => 'Atsijungti',
    'LBL_KIOSK_SORT_BY' => 'Rikiuoti',
    'LBL_KIOSK_SUBMIT' => 'Siųsti',
    'LBL_KIOSK_TIMEZONE' => 'Laiko juosta',
    'LBL_KIOSK_ACTIVITY' => 'Veikla',
    'LBL_KIOSK_NO_ACTIVITY' => 'Nėra rodytinos veiklos',
    'LBL_KIOSK_OLDEST_FIRST' => 'Pirma seniausi',
    'LBL_KIOSK_NEWEST_FIRST' => 'Pirma naujausi',
    'LBL_KIOSK_SHOW_MORE' => 'Rodyti daugiau',
    'LBL_KIOSK_ADD_A_REPLY' => 'Pridėti atsakymą',
    'LBL_KIOSK_REPLY_EMPTY' => 'Atsakymas negali būti paliktas tuščias.',
    'LBL_KIOSK_NUM_MORE' => '{{num}} daugiau',
    'LBL_KIOSK_HOMEPAGE_WELCOME1' => 'Sveiki',
    'LBL_KIOSK_HOMEPAGE_WELCOME2' => 'Greitai pasiekite savo išteklius.',
    'LBL_KIOSK_HOMEPAGE_SEARCH_PLACEHOLDER' => 'Paieškos atvejai',
    'LBL_KIOSK_SHOW_ALL' => 'Rodyti viską',
    'LBL_KIOSK_404_TITLE' => 'Nepavyko rasti šio',
    'LBL_KIOSK_TENANT_404_TITLE' => 'Nuomininkas nerastas',
    'LBL_KIOSK_404_MESSAGE' => 'Spustelėjote nuorodą, kuri buvo pašalinta, laikinai nepasiekiama arba įvedėte neteisingą URL.',
    'LBL_KIOSK_TENANT_404_MESSAGE' => 'Įsitikinkite, kad turite teisingą URL. Norėdami gauti daugiau pagalbos, susisiekite su palaikymo tarnyba.',
    'LBL_KIOSK_BACK_TO_HOME' => 'Grįžti į pradžią',
    'LBL_KIOSK_ERROR_CODE' => '{code} Klaida: ',
    'LBL_KIOSK_401_TITLE' => 'Neleistina',
    'LBL_KIOSK_401_MESSAGE' => 'Jūs neturite teisės peržiūrėti šio puslapio.',
    'LBL_KIOSK_403_TITLE' => 'Neleistina',
    'LBL_KIOSK_403_MESSAGE' => 'Neturite prieigos prie šio puslapio.',
    'LBL_KIOSK_500_TITLE' => 'Serveris neatsiliepia',
    'LBL_KIOSK_500_MESSAGE' => 'Kažkas ne taip mūsų pusėje.',
    'LBL_KIOSK_GO_BACK' => 'Atgal',
    'LBL_KIOSK_DUPLICATE_ERROR' => 'Rastas besidubliuojantis įrašas',
    'LBL_KIOSK_ACCOUNT' => 'Paskyra',
    'LBL_KIOSK_STATUS' => 'Būsena',
    'LBL_KIOSK_DEACTIVATE' => 'Išjungti',
    'LBL_KIOSK_DEACTIVATE_SUCCESS' => 'Vartotojas buvo išjungtas',
    'LBL_KIOSK_MANAGE_USERS' => 'Vartotojų valdymas',
    'LBL_KIOSK_LAST_LOGIN' => 'Paskutinis prisijungimas',
    'LBL_KIOSK_FIRST_NAME' => 'Vardas',
    'LBL_KIOSK_LAST_NAME' => 'Pavardė',
    'LBL_KIOSK_ROLE' => 'Vaidmuo',
    'LBL_KIOSK_INVITE' => 'Pakviesti',
    'LBL_KIOSK_SEND_INVITES' => 'Siųsti pakvietimą (-us)',
    'LBL_KIOSK_INVITE_USERS_SUCCESS' => 'Pakvietimas (-ai) sėkmingai išsiųstas (-i)',
    'LBL_KIOSK_INVITE_USERS_FAILURE' => 'Pakvietimas (-ai) neišsiųstas (-i)',
    'LBL_KIOSK_REACTIVATE' => 'Iš naujo įjungti',
    'LBL_KIOSK_REACTIVATE_SUCCESS' => 'Vartotojas buvo iš naujo įjungtas',
    'LBL_KIOSK_RESET_PASSWORD' => 'Atkurti slaptažodį',
    'LBL_KIOSK_RESET_PASSWORD_SUCCESS' => 'Slaptažodžio atkūrimo el. laiškas išsiųstas',
    'LBL_KIOSK_USER_PROFILE' => 'Vartotojo profilis',
    'LBL_KIOSK_401_USER_BLOCKED_MESSAGE' => 'Jūsų vartotojas buvo išjungtas. Susisiekite su savo administratoriumi.',
    'LBL_KIOSK_BACK_TO_LOGIN' => 'Grįžti į prisijungimą',
    'LBL_KIOSK_REVOKE_INVITATION' => 'Atšaukti kvietimą',
    'LBL_KIOSK_REVOKE_INVITATION_SUCCESS' => 'Kvietimas sėkmingai atšauktas',
    'LBL_KIOSK_SEARCH_AND_SELECT' => 'Ieškokite ir pasirinkite...',
    'LBL_KIOSK_NO_MATCHES' => 'Atitikmenų nerasta',
    'LBL_KIOSK_PROFILE_UPDATE_SUCCESS' => 'Profilis atnaujintas.',
    'LBL_KIOSK_PROFILE_UPDATE_ERROR' => 'Klaida atnaujinant profilį.',
    'LBL_KIOSK_NOTES_SUBJECT_TITLE' => 'DĖL: {caseSubject}',
    'LBL_KIOSK_DOCUMENTS' => 'Dokumentai',
    'LBL_KIOSK_DOCUMENTS_DESC' => 'Peržiūrėkite, ieškokite ir atsisiųskite gaunamus bendrinamus dokumentus.',
    'LBL_KIOSK_CASES' => 'Atvejai',
    'LBL_KIOSK_CASES_DESC' => 'Peržiūrėkite, ieškokite ir atsakykite į atvejus, bendrinamus su jumis.',
    'LBL_KIOSK_DOWNLOAD' => 'Atsisiųsti',
    'LBL_KIOSK_DOWNLOAD_SUCCESS' => 'Failas sėkmingai atsisiųstas',
    'LBL_KIOSK_FIRST_TIME_LOGIN_MODAL_TITLE' => 'Darbo pradžia',
    'LBL_KIOSK_FIRST_TIME_LOGIN_MODAL_DESCRIPTION' => 'Kad galėtume jums geriau padėti, pateikite mums savo vardą ir pavardę.',
    'LBL_KIOSK_SAVE' => 'Išsaugoti',
    'LBL_KIOSK_SHARED' => 'Bendras',
    'LBL_KIOSK_HOMEPAGE_WELCOME1_PERSONAL' => 'Sveiki, {firstName} {lastInitial}.',
    'LBL_KIOSK_CONFIG_BACKGROUND_COLOR' => 'Fono spalva',
    'LBL_KIOSK_CONFIG_BACKGROUND_IMG_URL' => 'Fono vaizdo URL',
    'LBL_KIOSK_CONFIG_BACKGROUND_IMG_URL_SUBTITLE' => 'Rekomenduojama pasirinkti vaizdą, kurio failo dydis yra mažesnis nei 400 K.',
    'LBL_KIOSK_CONFIG_BACKGROUND_TYPE' => 'Fono tipas',
    'LBL_KIOSK_CONFIG_HOME_TILE_TITLE' => 'Pagrindinio puslapio fonas',
    'LBL_KIOSK_CONFIG_THEME_TILE_TITLE' => 'Tema',
    'LBL_KIOSK_CONFIG_THEME_PRIMARY_COLOR' => 'Pagrindinė temos spalva',
    'LBL_KIOSK_CONFIG_APP_NAME' => 'Programėlės pavadinimas',
    'LBL_KIOSK_CONFIG_APP_NAME_SUBTITLE' => 'Tai yra jūsų paraiškos pavadinimas, kuris pateikiamas šalia jūsų logotipo.',
    'LBL_KIOSK_CONFIG_APP_LOGO_URL' => 'Programėlės logotipo URL',
    'LBL_KIOSK_CONFIG_APP_LOGO_URL_SUBTITLE' => 'Rekomenduojama rinktis logotipą, kuris geriausiai matomas mažais dydžiais (pvz., socialinių tinklų profiliuose). Taip pat rekomenduojama, kad failo dydis būtų mažesnis nei 200 K.',
    'LBL_KIOSK_CONFIG_APP_FAVICON_URL' => 'Programėlės „Favicon“ URL adresas',
    'LBL_KIOSK_CONFIG_APP_FAVICON_URL_SUBTITLE' => '„Favicon“ – tai mažas logotipas, rodomas šalia puslapio pavadinimo naršyklės skirtuke.',

    // Sugar Automate
    'LBL_UPDATE_ASSIGNEES' => 'Automatiškai iš naujo priskirti atviras veiklas',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_USER_LIMIT_REACHED' => 'Pasiektas naudotojų limitas',
    'LBL_CUSTOMER_JOURNEY_ERROR_INVALID_LICENSE_KEY' => 'Negaliojantis licencijos raktas',
    'LBL_CUSTOMER_JOURNEY_ERROR_INVALID_APPLICATION_LICENSE_KEY' => 'Negaliojanti programa',
    'LBL_CUSTOMER_JOURNEY_ERROR_MISSING_LICENSE_KEY' => 'Negaliojanti programa',
    'LBL_CUSTOMER_JOURNEY_ERROR_CORRUPT_VALIDATION_KEY' => 'Sugadintas patvirtinimo raktas',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_EXPIRED' => 'Licencija pasibaigė',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_MISSING_INFO' => 'Trūksta informacijos',
    'LBL_CUSTOMER_JOURNEY_ERROR_MISSING_VALIDATION_KEY' => 'Trūksta patvirtinimo rakto',
    'LBL_CUSTOMER_JOURNEY_ERROR_USER_MISSING_ACCESS' => 'Vartotojas neturi prieigos',
    'LBL_DRI_WORKFLOW' => '„Smart Guide“',
    'LBL_DRI_WORKFLOWS' => '„Smart Guides“',
    'LBL_DRI_SUBWORKFLOW_TEMPLATE' => '„Smart Guide“ etapo šablonas',
    'LBL_DRI_SUBWORKFLOW_TEMPLATES' => '„Smart Guide“ etapo šablonai',
    'LBL_DRI_WORKFLOW_TEMPLATE' => '„Smart Guide“ šablonas',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATE' => '„Smart Guide“ veiklos šablonas',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATES_SUBPANEL_TITLE' => 'Veiklos šablonai',
    'LBL_CJ_WEBHOOKS_SUBPANEL_TITLE' => 'Žiniatinklio gaudyklės',
    'LBL_CJ_WEBHOOKS' => '„Sugar Automate“ žiniatinklio gaudyklės',
    'LBL_CURRENT_CJ_ACTIVITY_AT' => 'Dabartinė „Smart Guide“ veikla',
    'LBL_CJ_WEBHOOKS' => '„Sugar Automate“ žiniatinklio gaudyklės',
    'LBL_CJ_WEBHOOK' => '„Sugar Automate“ žiniatinklio gaudyklė',
    'LBL_CJ_FORMS_SUBPANEL_TITLE' => '„Sugar“ veiksmai',
    'LBL_CJ_FORMS' => 'Su „Smart Guide“ susijęs „Sugar“ veiksmas',
    'LBL_CJ_FORM' => 'Su „Smart Guide“ susiję „Sugar“ veiksmai',
    'LBL_DRI_SUBWORKFLOW' => '„Smart Guide“ etapas',
    'LBL_DRI_SUBWORKFLOWS' => '„Smart Guide“ etapai',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATES' => '„Smart Guide“ veiklos šablonai',
    'LBL_DRI_WORKFLOW_TEMPLATES' => '„Smart Guide“ šablonai',
    'LBL_DRI_WORKFLOW_SORT_ORDER' => '„Smart Guide“ tvarka',
    'LBL_CJ_ACTUAL_SORT_ORDER' => '„Smart Guide“ tikrasis užsakymas',
    'LBL_CUSTOMER_JOURNEY_SCORE' => '„Smart Guide“ balas',
    'LBL_CJ_MOMENTUM_POINTS' => '„Smart Guide Momentum“ taškai',
    'LBL_CJ_MOMENTUM_SCORE' => '„Smart Guide Momentum“ balas',
    'LBL_CJ_ALLOW_ACTIVITY_BY' => '„Smart Guide“ leisti veiklą iki',
    'LBL_CUSTOMER_JOURNEY_PROGRESS' => '„Smart Guide“ eiga',
    'LBL_CJ_MOMENTUM_RATIO' => '„Smart Guide Momentum“ santykis',
    'LBL_CUSTOMER_JOURNEY_POINTS' => '„Smart Guide“ taškai',
    'LBL_CUSTOMER_JOURNEY_TYPE' => '„Smart Guide“ užduotis',
    'LBL_CJ_PARENT_ACTIVITY_TYPE' => '„Smart Guide“ tėvų veiklos tipas',
    'LBL_CUSTOMER_JOURNEY_BLOCKED_BY' => '„Smart Guide“ užblokavo',
    'LBL_CJ_BLOCKED_BY_STAGES' => '„Smart Guide“ užblokavo etapus',
    'LBL_CJ_PARENT_ACTIVITY_ID' => '„Smart Guide“ tėvų veiklos ID',
    'LBL_START_NEXT_JOURNEY_ID' => 'Pradėti kitą „Smart Guide“ ID',
    'LBL_CJ_URL' => '„Smart Guide“ URL',
    'LBL_IS_CJ_PARENT_ACTIVITY' => 'Yra „Smart Guide“ tėvų veikla',
    'LBL_CJ_MOMENTUM_START_DATE' => '„Smart Guide Momentum“ pradžios data',
    'LBL_CJ_MOMENTUM_END_DATE' => '„Smart Guide Momentum“ pabaigos data',
    'LBL_WIDGET_LAYOUT_CONFIGURATION_HEADER' => 'Valdiklio išdėstymo konfigūracija',
    'LBL_WIDGET_LAYOUT_CONFIGURATION' => 'Valdiklio išdėstymo konfigūracija',
    'CJ_SAME_JOURNEY_LIMIT_REACH_EXCEPTION' => 'Didžiausias „Smart Guide“ iš to paties šablono skaičius',
    'LBL_CUSTOMER_JOURNEY_WIDGET_ACTIVE' => 'Aktyvūs pašto klientai',
    'LBL_CUSTOMER_JOURNEY_WIDGET_ARCHIVE' => 'Archyvuota',
    'LBL_CUSTOMER_JOURNEY_STAGE_NUMBER_SHOW' => 'Rodyti',
    'LBL_CUSTOMER_JOURNEY_STAGE_NUMBER_HIDE' => 'Slėpti',
    'LBL_CJ_PRESENTATION_MODE_VERTICAL' => 'Vertikalus režimas',
    'LBL_CJ_PRESENTATION_MODE_HORIZONTAL' => 'Horizontalus režimas',
    'LBL_CUSTOMER_JOURNEY_INVALID_LICENSE' => 'Negaliojanti licencija',
    'LBL_ASSIGNMENT_NOTIFICATION_HTML' => '<div>
    <p>{{assigned_by}} priskyrė toliau nurodytą „Smart Guide“ veiklą {{assigned_user}}.</p>
    <ul>{{activities}}</ul>

    <p>Šią veiklą galite peržiūrėti adresu:<br/>
    <<a href="{{module_link}}">{{module_link}}</a>></p>
    </div>',
    'LBL_CUSTOMER_JOURNEY_INVALID_LICENSE' => 'Negaliojanti licencija',
    'LBL_CJ_REMAINING_DAYS_WHEN_USER_LIMIT_REACHED' => 'Pasiektas naudotojų limitas, turite {{gracePeriodDays}} d. atnaujinti licenciją.',
    'LBL_ASSIGNMENT_NOTIFICATION_SUBJECT' => '„SugarCRM“ – priskirta „Smart Guide“ veikla',
    'LBL_CUSTOMER_JOURNEY_USER_LIMIT_REACHED_DESCRIPTION' => 'Viršytas „Sugar Automate“ naudotojų limitas ({0})<br>
    <br>
    Susisiekite adresu <a href="mailto:customersuccess@sugarcrm.com">customersuccess@sugarcrm.com</a>, kad padidintumėte naudotojų skaičių arba sumažintumėte papildinio naudotojų skaičių.',
    'LBL_CUSTOMER_JOURNEY_USER_LIMIT_REACHED_NAME' => 'Pasiektas „Sugar Automate“ naudotojų limitas',
    'LBL_CUSTOMER_JOURNEY_LICENSE_ABOUT_TO_EXPIRE_DESCRIPTION' => 'Jūsų „Sugar Automate“ licencija nustos galioti po {0} d. <br>
    <br>
    Susisiekite su „SugarCRM“ arba savo „Sugar“ partneriu, kad atnaujintumėte paslaugą ir išvengtumėte paslaugos pertrūkių.',
    'LBL_CUSTOMER_JOURNEY_LICENSE_ABOUT_TO_EXPIRE_NAME' => 'Netrukus baigsis „Sugar Automate“ licencijos galiojimas',
    'LBL_DEFAULT_TEST_WEB_HOOK_DASHLET_TITLE' => 'Išbandyti žiniatinklio gaudyklę',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => '„Smart Guide“ eiga',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Rodoma „Sugar Automate“ „Smart Guide Progress“ skritulinė diagrama.',
    'LBL_DEFAULT_TEST_WEB_HOOK_DASHLET_DESC' => 'Rodomas žiniatinklio gaudyklės atsakymas',
    'LBL_DASHLET_SEND_LABEL' => 'Išsiųsti prašymą',
    'LBL_ASSIGN_ME_BUTTON_TITLE' => 'Paskirti mane',
    'LBL_COMPLETE_BUTTON_TITLE' => 'Užbaigtas',
    'LBL_COMPLETE_PARENT_BUTTON_TITLE' => 'Atlikti visas užduotis',
    'LBL_DELETE_STAGE_BUTTON_TITLE' => 'Ištrinti etapą',
    'LBL_START_CYCLE_BUTTON_TITLE' => 'Pradėti',
    'LBL_NOT_APPLICABLE_BUTTON_TITLE' => 'Netaikoma',
    'LBL_ADD_STAGE_BUTTON_TITLE' => 'Pridėti etapą',
    'LBL_VIEW_JOURNEY_BUTTON_TITLE' => 'Žiūrėti',
    'LBL_EDIT_JOURNEY_BUTTON_TITLE' => 'Redaguoti išmanųjį vadovą',
    'LBL_CANCEL_JOURNEY_BUTTON_TITLE' => 'Atšaukti',
    'LBL_ARCHIVE_JOURNEY_BUTTON_TITLE' => 'Archyvas',
    'LBL_UNARCHIVE_JOURNEY_BUTTON_TITLE' => 'Išarchyvuoti',
    'LBL_CONFIGURE_TEMPLATE_BUTTON_TITLE' => 'Šablono konfigūravimas',
    'LBL_ADD_CJ_SUB_TASK_BUTTON_TITLE' => 'Pridėti užduotį',
    'LBL_ADD_CJ_SUB_MEETING_BUTTON_TITLE' => 'Suplanuoti susitikimą',
    'LBL_ADD_CJ_SUB_CALL_BUTTON_TITLE' => 'Suplanuoti skambutį',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_FUTURE' => 'yra ateityje',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_OVERDUE' => 'vėluoja',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TODAY' => 'yra šiandien',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TOMORROW' => 'yra rytoj',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TEXT' => '{{fieldName}} {{status}}
    {{formatUser}} ({{fromNow}})',
    'LBL_CJ_CANCEL_CONFIRMATION' => 'Ar tikrai norite atšaukti šį „Smart Guide“?',
    'LBL_CJ_COMPLETE_ALL_TASKS_CONFIRMATION' => 'Netrukus atliksite visas užduotis. Ar tikrai norite tęsti?',
    'LBL_CJ_BLOCK_BY' => 'Turite neišspręstą priklausomą užduotį: {{Name}}. Prašome užbaigti šią užduotį prieš baigiant visas užduotis.',
    'LBL_CJ_MULTIPLE_BLOCK_BY' => 'Turite keletą neišspręstų, priklausomų užduočių. Prieš užbaigdami visas užduotis, atlikite šias užduotis.',
    'LBL_CJ_COMPLETE_ALL_TASKS_COMPLETION' => 'Sėkmingai atlikote visas užduotis',
    'LBL_CJ_ARCHIVE_CONFIRMATION' => 'Ar tikrai norite archyvuoti šį „Smart Guide“?',
    'LBL_CJ_UNARCHIVE_CONFIRMATION' => 'Ar tikrai norite išarchyvuoti šį „Smart Guide“?',
    'LBL_CJ_AS_A_DASHLET' => '„Sugar Automate“: „Smart Guide“ („Focus Drawer“ ir konsolė)',
    'LBL_CJ_AS_A_DASHLET_DESC' => 'Peržiūrėkite aktyvius „Smart Guide“ paslaugų / atnaujinimų konsolėje ir „Focus Drawer“ prietaisų skydeliuose.',
    'LBL_CJ_PROCESSING_REQUEST' => 'Vykdoma...',
    'LBL_CJ_SUCCESS' => 'Sėkmingai atlikote visas užduotis',
    'LBL_CUSTOMER_JOURNEY_MODULE_NOT_ENABLED' => 'Modulis {module} neįjungtas',
    'LBL_RECORDVIEW_DISPLAY_SETTINGS_SAVED' => 'Visi ekrano nustatymai išsaugomi.',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_MOMENTUM_DASHLET_TITLE' => '„Smart Guide Momentum“',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_MOMENTUM_DASHLET_DESC' => 'Rodoma „Sugar Automate“ matuoklio diagrama „Smart Guide Momentum“.',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => '„Smart Guide“ eiga',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Rodoma „Sugar Automate“ „Smart Guide Progress“ skritulinė diagrama.',
    'CJ_PARENT_NOT_FOUND_EXCEPTION' => 'Nepavyko rasti tėvo',
    'CJ_NOT_FOUND_EXCEPTION' => 'Nepavyko rasti {moduleName} su {data}',
    'CJ_JOURNEY_NOT_COMPLETED_EXCEPTION' => '„Smart Guide“ turi būti užbaigtas arba atšauktas prieš archyvuojant',
    'LBL_CUSTOMER_JOURNEY_LICENSE_LOAD_ERROR' => '„Sugar Automate“ neįjungtas dabartinėje „Sugar“ licencijoje',
    'LBL_ACTION_NOT_FOUND' => 'Veiksmų nerasta, kreipkitės į sistemos administratorių',
    'LBL_CJ_SELECT_FIELD' => 'Pasirinkti lauką',
    'LBL_CJ_SELECT_OPERATOR' => 'Pasirinkti operatorių',
    'LBL_CJ_SELECT_VALUE' => 'Pasirinkite reikšmę',
    'LBL_CJ_ENTER_VALUE' => 'Įveskite reikšmę',
    'LBL_CJ_FORM_BATCH_TITLE' => 'Įrašo saugojimas',
    'LBL_CJ_FORM_BATCH_ACTIVE_SMART_GUIDES_DETECTED' => 'Aptikti aktyvūs išmanieji gidai...',
    'LBL_CJ_FORM_BATCH_PROCESSING_ACTIVE_SUGAR_ACTIONS' => 'Aktyvių „Sugar“ veiksmų apdorojimas...',
    'LBL_CJ_FORM_BATCH_UPDATING_ACTIVE_SMART_GUIDES' => 'Aktyvių išmaniųjų gidų atnaujinimas...',
    'LBL_CJ_FORM_BATCH_SUCCESS' => 'Įrašas ir susiję išmanieji gidai buvo sėkmingai atnaujinti.',
    'LBL_CJ_FORM_BATCH_FAILURE' => 'Nepavyko atnaujinti susijusio išmaniojo gido. Jei tokia klaida kartosis, kreipkitės pagalbos į „Sugar“ administratorių.',
    'LBL_CJ_FORM_BATCH_FAILURE_FOR_ADMIN' => 'Nepavyko atnaujinti susijusio išmaniojo gido. Peržiūrėkite <a href="index.php?action=LogView&module=Configurator&doaction=all&filter=Sugar+Actions+:+Sugar+Action+to+Smart+Guide" target="_blank">logs</a> norėdami išspręsti šią klaidą.',
    'LBL_CJ_ACTIVITY_LINK_SUCCESS' => '<a href="#{{module}}/{{id}}">{{name}}</a> {{moduleSingularLower}} sėkmingai sujungtas.',
    'LBL_CJ_ACTIVITY_LINK_ERROR' => 'Iškilo problema sujungiant <a href="#{{module}}/{{id}}">{{name}}</a> {{moduleSingularLower}}. Jei problema išliks, kreipkitės į „Sugar“ palaikymo tarnybą.',
    'LBL_CJ_ACTIVITY_LINK_SUCCESS_PLURAL' => '{{modulePluralLower}} buvo sėkmingai sujungti.',
    'LBL_CJ_ACTIVITY_LINK_ERROR_PLURAL' => 'Sujungiant {{modulePluralLower}} iškilo problema. Jei problema išliks, kreipkitės į „Sugar“ palaikymo tarnybą.',
    'LBL_CJ_ACTIVITY_LINK_ERROR_GENERIC' => 'Iškilo problema sujungiant {{moduleSingularLower}}. Jei problema išliks, kreipkitės į „Sugar“ palaikymo tarnybą.',
    'LBL_CJ_ACTIVITY_DUPLICATE_EXISTING' => 'Jau yra {{moduleSingularLower}} pavadinimu <a href="#{{module}}/{{id}}">{{name}}</a> {{stage}} etape.',
    'LBL_CJ_ACTIVITY_DUPLICATE_SELECTED' => '{{moduleSingularLower}} pavadinimu <a href="#{{module}}/{{id}}">{{name}}</a> jau buvo pasirinktas.',
    'LBL_CJ_ARCHIVED' => 'Archyvuota',
    'LBL_SELECT_SMART_GUIDE_TEMPLATE_PLACEHOLDER' => 'Pasirinkite „Smart Guide“ šabloną...',
    'LBL_ALL_SMART_GUIDES' => 'Visi „Smart Guides“',
    'LBL_ACTIVE_SMART_GUIDES' => 'Aktyvūs „Smart Guides“',
    'LBL_ARCHIVED_SMART_GUIDES' => 'Aktyvūs „Smart Guides“',
    'LBL_VERTICAL_SCROLL_VIEW' => 'Vertikalus sudėtinis vaizdas',
    'LBL_HORIZONTAL_SCROLL_VIEW' => 'Horizontalus slinkties rodinys',
    'LBL_DRI_WORKFLOWS_FILTER' => 'Filtras',

    // more MOBILE stuff
    'LBL_MOBILE_COPIED_TO_CLIPBOARD' => 'Nukopijuota į mainų sritį.',
    'LBL_MOBILE_DELETE_ALL_OCCURRENCES' => 'Ištrinti visus pasikartojimus',
    'ERROR_RECURRENCE_EVENT_PARAMS' => 'Neteisingi pasikartojimo nustatymai',
    'ERROR_INTERVAL_INVALID' => 'Pakartojimo intervalas turi būti nuo 1 iki 99',
    'LBL_RECURRENCE_ADD' => 'Konfigūruoti',
    'LBL_REPEAT_DAYS' => 'Mėnesio diena (-os)',
    'LBL_REPEAT_END_TYPES' => 'Pakartoti',
    'LBL_MOBILE_DEFAULT_MAPS_APP' => 'Navigacijos paslaugų teikėjas',
    'LBL_MOBILE_PDF_EMAIL' => 'Siųsti el. paštu {{{pdfTemplateName}}} PDF formatu',
    'LBL_MOBILE_EMAIL_SENDING' => 'Siunčiama',
    'LBL_MOBILE_EMAIL_SENT' => 'Išsiųsta',
    'LBL_MOBILE_EMAIL_SAVED_DRAFT' => 'El. laiškas išsaugotas kaip juodraštis.',
    'LBL_MOBILE_EMAIL_CHOOSE_ATTACHMENT' => 'Pridėti priedą',
    'LBL_MOBILE_EMAIL_LOCAL_ATTACHMENT' => 'Įkelti iš savo kompiuterio',
    'LBL_MOBILE_EMAIL_SUGAR_DOCUMENT_ATTACHMENT' => '„Sugar“ dokumentas',
    'LBL_DROPDOWN_VIEW_CHANGE_INFO' => 'Pasirinkta išskleidžiamoji vertė pakeitė įrašo rodinio išdėstymą.',
    'LBL_MOBILE_RELEASE_NOTE_ALL' => '„SugarCRM“ mobiliosios programos išleidimo pastabos',
    'LBL_MOBILE_USER_GUIDE_ALL' => '„SugarCRM“ mobiliosios programėlės naudotojo vadovas',
    'ERR_MOBILE_ROOTED' => '„Sugar Mobile“ negalima naudoti įsišaknijusiame mobiliajame įrenginyje. Atidarykite programą neįsišaknijusiame įrenginyje.',
    'LBL_VO_BUILD_ROUTE' => 'Sukurti maršrutą',
    'LBL_FILTER_MY_DISTANCE_FILTER' => 'Mano atstumo filtras',
    'LBL_ACTIONBUTTON_DOC_MERGE_STARTED' => 'Dokumentas bus sukurtas fone. Atidarykite dokumento sujungimo puslapį, kad pasiektumėte failą.',
    'LBL_ACTIONBUTTON_DOC_MERGE_NO_TEMPLATE' => 'Nepavyko gauti šablono. Kreipkitės pagalbos į administratorių.',
    'LBL_MAP_ERROR_LOAD' => 'Negalima įkelti žemėlapio',
    'LBL_MAP_DISTANCE' => 'Atstumas',
    'LBL_SELECT_UNIT_TYPE' => 'Vieneto tipas',
    'LBL_MAPS_UNIT_MILES' => 'Mylios',
    'LBL_MAPS_UNIT_KILOMETERS' => 'Kilometrai',
    'LBL_RADIUS' => 'Spindulys',
    'LBL_ZIP_CODE' => 'Pašto kodas',
    'LBL_MOBILE_CHOOSE_ADDRESS' => 'Pasirinkite adresą',
    'LBL_MOBILE_ADDRESS_NOT_GEOCODED' => 'Negalima sukurti geokodo iš adreso:{{{address}}}',
    'LBL_MOBILE_GEOCODE_SAVE_ERROR' => 'Įrašas nebuvo geokoduotas.',
    'LBL_MOBILE_GEOCODE_MANUAL_CONFIRM' => 'Įraše nėra jokių adreso duomenų. Ar norite šį įrašą žemėlapyje surasti rankiniu būdu?',
    'LBL_ERR_SHOW_ON_MAP' => 'Nepavyko atidaryti pasirinktų įrašų žemėlapio.',
    'LBL_ERR_MISSING_ON_MAP' => 'Kai kuriuose įrašuose trūksta adreso duomenų, todėl jie nerodomi',
    'LBL_MAPS_ROUTE' => 'Maršrutas',
    'LBL_MAPS_PROVIDER' => '„Sugar Maps“',
    'LBL_MAPS_CURRENT_LOC_ERROR' => 'Nepavyko nustatyti dabartinės buvimo vietos.',
    'LBL_MAPS_MAX_COLLECTION_LENGTH' => 'Atvaizdavimui galima naudoti ne daugiau kaip {{{{num}}} įrašų.',
    'LBL_ALL_MODULES' => 'Visi moduliai',
    'LBL_DRIVE_SHARE_LINK' => 'Bendrinti nuorodą',
    'LBL_DRIVE_LOAD_FILES_ERROR' => 'Nepavyko įkelti failų.',
    'LBL_DRIVE_NAME_EMPTY_ERROR' => 'Pavadinimas negali būti tuščias',
    'LBL_DRIVE_FOLDER_CREATED' => 'Aplankas sukurtas.',
    'LBL_DRIVE_FOLDER_CREATE_ERROR' => 'Nepavyko sukurti aplanko.',
    'LBL_DRIVE_FILE_UPLOAD_ERROR' => 'Nepavyko įkelti failo.',
    'LBL_DRIVE_NO_ROOT_FOLDER' => 'Pirmiausia sukurkite šakninį aplanką',
    'LBL_EDIT_ALL_RECURRENCES' => 'Redaguoti visus pasikartojimus',
    'LBL_DROPBOX_FILE_NOT_AVAILABLE' => 'Failo negalima atidaryti „Dropbox“',
    'LBL_FILE_NOT_AVAILABLE' => 'Failo negalima atidaryti',
    'LBL_MAP_ROUTE_FROM_A_CURRENT_RECORD' => 'Nuorodos',
    'LBL_MAPS_ROUTE_NOT_FOUND' => 'Numatytų tarpinių taškų maršrutas nerastas',
    'LBL_MAPS_IN_RADIUS_FROM_CURRENT_LOCATION' => 'Netoliese',
    'LBL_TAGS' => 'Žymės',

    'LBL_CALLER_ID_SETTINGS' => 'Skambintojo ID nustatymai',
    'LBL_CALLER_ID_ENABLED' => 'Įjungtas skambintojo ID',
    'LBL_CALLER_ID_ENABLED_TEXT' => 'Gaunamų skambučių metu rodomas kontakto arba potencialaus kliento vardas, atitinkantis telefono numerį.',
    'LBL_CALLER_ID_SETTINGS_HINT_IOS' => 'Jei norite, kad mobilioji programėlė rodytų skambinančiojo ID, atlikite šiuos veiksmus savo prietaise:<br><br>1. Atidarykite „iOS“ nustatymaus > Telefonas > Skambučių blokavimas ir identifikavimas.<br>2. Įjunkite „{{{brandName}}}“.',
    'LBL_CALLER_ID_SETTINGS_HINT_ANDROID' => 'Norėdami leisti mobiliojoje programėlėje rodyti skambinančiojo numerį, atlikite šiuos veiksmus savo prietaise:<br>1. Atidarykite programėlės nustatymus.<br>2. Eikite į „Leidimai“.<br>3. Įjunkite „Telefono leidimas“.<br><br> Norėdami nustatyti šią programą kaip numatytąjį skambintojo ID tvarkyklę, eikite į prietaiso nustatymus.<br>1. Pereikite į „Programos“.<br>2. Pasirinkite numatytąsias programas.<br>3. Pasirinkite „Skambinančiojo ID ir nepageidaujamų laiškų programa“.<br>4. Pasirinkite šią programą kaip numatytąją parinktį.',
    'LBL_CALLER_ID_SYNC_HINT' => 'Patikrinkite, ar pasikeitė „Sugar“ įrašuose (pvz., „Contacts“, „Leads“) esanti kontaktinė informacija.',
    'LBL_CALLER_ID_GO_TO_SETTINGS' => 'Eikite į „Nustatymai“',
    'LBL_CALLER_ID_SYNC' => 'Įrašų duomenų sinchronizavimas',
    'LBL_CALLER_ID_NOT_ENABLED' => 'Prieš sinchronizuojant sistemos nustatymuose turi būti įjungta skambinančiojo Id.',
    'LBL_CALLER_ID_SETUP_ENABLE' => 'Įjungti',
    'LBL_CALLER_ID_SETUP_LATER_IN_SETTINGS' => 'Vėliau nustatymuose',
    'LBL_CALLER_ID_SETUP_HINT_ANDROID' => 'Ši programa palaiko skambintojo ID funkciją.<br> Norint, kad ši funkcija veiktų tinkamai, paspaudus įjungimo mygtuką, bus paprašyta suteikti du leidimus.<br> Kad skambintojo ID funkcija veiktų tinkamai, reikia suteikti leidimą valdyti skambučius ir pasirinkti šią programą kaip numatytąją skambintojo ID tvarkyklę.<br> Jei nesuteiksite leidimo valdyti skambučius, taip pat negalėsite registruoti skambučių iš programos.',
    'LBL_CALLER_ID_SETUP_HINT_IOS' => 'Norėdami leisti „SugarCRM“ mobiliajai programėlei rodyti skambinančiojo ID, atlikite šiuos veiksmus savo įrenginyje:<br><br>1. Atidarykite „iOS“ nustatymus > Telefonas > Skambučių blokavimas ir atpažinimas.<br>2. Įjunkite programėlę.',
    'LBL_MOBILE_LAST_SYNC' => 'Paskutinis sinchronizavimas',
    'LBL_CALLER_ID_SYNCING' => 'Sinchronizavimas su serveriu.',
    'LBL_NEVER' => 'Niekada',
    'LBL_RLI_MISSING_ERROR' => '{{{moduleName}}} negali būti tuščias.',
    'LBL_ADD_RELATED_RECORD' => 'Susijęs {{{moduleSingular}}}',
    'LBL_CALLER_ID_NO_PERMISSION' => 'Neturite reikiamų leidimų naudoti skambintojo ID. Susisiekite su savo administratoriumi.',
    'LBL_CALLER_ID_FETCHING' => 'Sinchronizuojama…',
    'LBL_CALLER_ID_FETCH_ALL' => 'Iš naujo sinchronizuoti visus įrašus',
    'LBL_CALLER_ID_FETCH_NEW' => 'Patikrinkite, ar yra įrašų naujinimų',

    'LBL_SORT_BY' => 'Rikiuoti',
    'LBL_PRIMARY_SORT' => 'Pirminis rūšiavimas',
    'LBL_SECONDARY_SORT' => 'Antrinis rūšiavimas',
    'LBL_OF' => 'iš',
    'LBL_TABLE_FREEZE_FIRST' => 'Įšaldykite pirmą stulpelį',
    'LBL_TABLE_SETTINGS_TITLE' => 'Stulpelio rodinio parinktys',
    'LBL_TABLE_SETTINGS_NO_COL' => 'Turi būti pasirinktas bent vienas stulpelis.',
    'LBL_TABLE_TOGGLER_INFO' => 'Rodyti arba slėpti stulpelius ir vilkti juos pageidaujama tvarka.',
    'LBL_RUNTIME_FILTERS_TITLE' => 'Dinaminiai filtrai',
    'LBL_FILTER_CONDITION' => 'Pasirinkite sąlygą',
    'LBL_FILTER_VALUES' => 'Reikšmės',
    'LBL_TABLE_EXPAND' => 'Išskleisti viską',
    'LBL_TABLE_COLLAPSE' => 'Sutraukti viską',
    'LBL_RUNTIME_FILTERS_DEFAULT' => 'Serverio klaida. Nepavyko įkelti atitinkamų vykdymo laiko filtrų.',

    // Pub/Sub
    'LBL_PUBSUB_MODULEEVENT_PUSHSUBS' => '„Pub/Sub“ modulio įvykio „Push“ prenumeratos',
    'LBL_PUBSUB_MODULEEVENT_PUSHSUB' => '„Pub/Sub“ modulio įvykio „Push“ prenumerata',
];

$app_list_strings['configure_record_view_display_dom'] = [
    'panel_top' => 'Skydelis – viršuje',
    'panel_bottom' => 'Skydelis – apačioje',
    'tab_first' => 'Skirtukas – pirmas',
    'tab_last' => 'Skirtukas – paskutinis',
];
...
$app_list_strings['library_type'] = ['Books' => 'Knyga', 'Music' => 'Muzika', 'DVD' => 'DVD', 'Magazines' => 'Žurnalai'];
...
$app_strings['LBL_SEND_TO_DOCUSIGN'] = 'Siųsti į „DocuSign“';
$app_strings['LBL_NO_SEND_TO_DOCUSIGN'] = '„DocuSign“ iš čia nepasiekiama.';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_WEP'] = 'Dokumentų suliejimas su „Word“ / „Excel“ / „PowerPoint“ šioje vietoje negalimas';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_DS'] = '„Doc Merge to DocuSign“ šioje vietoje nepasiekiama';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_PDF'] = '„Doc Merge to DocuSign“ šioje vietoje nepasiekiama';
$app_strings['LBL_DOCUSIGN_PERMISSIONS'] = 'Jūsų pasirašytas failas bus įkeltas čia tik tuo atveju, jei turite leidimą įkelti šioje vietoje.';
$app_strings['LBL_DOC_MERGE_TO'] = 'Sujungti dokumentus';
...
$app_strings['LBL_NEW_FOLDER'] = 'Naujas aplankas';
$app_strings['LBL_FOLDER_NAME'] = 'Aplanko pavadinimas';
$app_strings['LBL_PERMISSION_ERROR'] = 'Neturite leidimo tai daryti dabartiniame kelyje.';
$app_strings['LBL_MICROSOFT_PERMISSION_ERROR'] = 'Neturite leidimo eiti į dabartinį kelią.';
$app_strings['LBL_FILE_UPLOADED'] = 'Failas įkeltas.';
$app_strings['LBL_LARGE_FILE_UPLOAD'] = 'Įkėlimas užtruks, nes jūsų failas yra didelis.';
$app_strings['LBL_ERR_NO_FILE_ATTACHED'] = 'Prie vieno ar daugiau dokumento įrašų nėra pridėtos bylos. Pridėkite failus prie įrašų ir bandykite dar kartą arba atskirai sinchronizuokite konkrečius įrašus su failais.';
...
$app_strings['LBL_CHECK_DROPBOX_CONNECTION'] = 'Ryšys su „Dropbox“ nerastas...';
$app_strings['LBL_MICROSOFT_DELAY'] = 'Sinchronizavimas su „OneDrive“ gali šiek tiek užtrukti';
$app_strings['LBL_DRIVE_DELETE_CONFIRM'] = 'Ar tikrai norite ištrinti šį failą?';
$app_strings['LBL_MICROSOFT_UPLOAD_COMPLETE'] = '„OneDrive“ įkėlimas baigtas.';
$app_strings['LBL_MICROSOFT_UPLOAD_COMPLETE_DESCRIPTION'] = ' buvo sėkmingai įkeltas.';
$app_strings['LBL_DRIVE_LOAD_PATH_ERROR'] = 'Klaida įkeliant kelius.';
$app_strings['LBL_INVALID_DRIVE_FILE'] = 'Įvyko klaida, nes failas sugadintas.';
$app_strings['LBL_UPLOAD_AND_LINK_COMPLETE'] = 'Dokumentas <i>"{{documentName}}"</i> buvo išsaugotas jūsų debesies diske ir pridėtas prie dokumentų modulio.';
$app_strings['LBL_NO_PERMISSION_FILE_ERROR'] = 'Neturite leidimo ištrinti šį failą.';
$app_strings['LBL_NO_PERMISSION_FOLDER_ERROR'] = 'Neturite leidimo ištrinti šio aplanko.';
$app_strings['LBL_NO_PERMISSION_FILE_UPLOAD_ERROR'] = 'Neturite teisių įkelti failų į šią vietą.';
$app_strings['LBL_NO_PERMISSION_FOLDER_CREATE_ERROR'] = 'Neturite teisės kurti aplanko šioje vietoje.';
$app_strings['LBL_NO_FOLDER_CREATE'] = 'Šioje vietoje aplankų sukurti negalima.';
$app_strings['LBL_NO_FILE_UPLOAD'] = 'Failų negalima nusiųsti į šią vietą.';
$app_strings['LBL_SITES'] = 'Tinklalapiai';
$app_strings['LBL_SHARED'] = 'Bendras';
$app_strings['LBL_COPY_LINK_CONFIRMATION'] = 'Sukurta nuoroda. Spustelėkite mygtuką, kad nukopijuotumėte nuorodą į iškarpinę.';
$app_strings['LBL_COPY_CLIPBOARD_CONFIRMATION'] = 'Nukopijuoti į iškarpinę';
...
$app_list_strings['kiosk_available_language_dom'] = [['en_us', 'Anglų k. (JAV)']];
$app_list_strings['kiosk_available_timezone_dom'] = [
    ['est', 'Niujorkas (EST)'],
    ['pst', 'Los Andželas (PST)'],
];
$app_list_strings['kiosk_case_status_dom'] = [
    ['Naujas', 'Naujas'],
    ['Priskirtas', 'Priskirtas'],
    ['Uždaryta', 'Uždaryta'],
    ['Laukianti įvestis', 'Laukianti įvestis'],
    ['Atmesta', 'Atmesta'],
...
$app_list_strings['kiosk_invitations_roles_dom'] = [
    ['vartotojas', 'Vartotojas'],
    ['administratorius, vartotojas', 'Administratorius'],
    ['paskyros valdytojas, vartotojas', 'Paskyros valdytojas'],
];

$app_list_strings['kiosk_document_shared_dom'] = [
    ['last_30_days', 'Paskutinės 30 dienų'],
    ['last_90_days', 'Paskutinės 90 dienų'],
    ['this_year', 'Praėjusiais metais'],
    ['įprastas', 'Custom Range'],
    ['visi', 'Visi'],
];

$app_list_strings['kiosk_background_type_dom'] = [
    ['Numatytoji', 'Numatytoji'],
    ['Spalva', 'Vientisa spalva'],
    ['Url', 'Pasirinktinis vaizdas'],
];
