...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
  ...
  array (
    ...
    'CJ_Forms' => 'Ενέργειες Sugar σχετικά με τον Έξυπνο οδηγό',
  ...
  array (
    ...
    'CJ_Forms' => 'Ενέργεια Sugar σχετικά με τον Έξυπνο οδηγό',
...
$app_strings = array (
  ...
  'LBL_EMAIL_DATE_RECEIVED'               => 'Ημερομηνία Παραλαβής',
    ...
    'LBL_RELATED_RECORDS' => 'Σχετικό {{module}}',
...
Αν εκτελέσετε αυτήν την ενέργεια, θα αποσυνδεθείτε αμέσως και θα χρειαστεί να κάνετε ξανά έλεγχο ταυτότητας χρησιμοποιώντας την εφαρμογή ελέγχου ταυτότητας την επόμενη φορά που θα συνδεθείτε.',
  ...
  'ERR_FILE_NOT_FOUND' => 'Λάθος: Δεν μπόρεσε να φορτώσει το αρχείο {0}. Παρακαλώ ελέγξτε το σύστημα και τα δικαιώματα διαδικτύου του διακομιστή.',
    ...
    'LBL_ERROR_FILE_UPLOAD' => "Η μεταφόρτωση του αρχείου {{{fieldLabel}}} απέτυχε '{{{fileName}}}'. {{{reason}}}",
...
2. Κάντε κλικ στην επιλογή "Αποθήκευση" για να οριστικοποιήσετε τη νέα εγγραφή και να επιστρέψετε στην απεικόνιση καταλόγου {{plural_module_name}}.',
    ...
    'LBL_ACTIVITY_TIMELINE_DASHLET_DESCRIPTION' => 'Το χρονολόγιο εμφανίζει κλήσεις, email, ' .
...
// Omnichannel
    ...
    'LBL_ACTIONBUTTON_LINK' => 'Σύνδεσμος',
    'LBL_ACTIONBUTTON_COPY_PARENT' => 'Αντιγραφή γονικών τιμών',
    'LBL_ACTIONBUTTON_PRESET' => 'Προεπιλογή',
    'LBL_ACTIONBUTTON_PRESET_PARENT' => 'Προεπιλογή από γονέα',
    ...
    'LBL_ACTIONBUTTON_RECORD_VIEW' => 'Προβολή Εγγραφής',
    'LBL_ACTIONBUTTON_RECORD_VIEW_DASHLET' => 'Πίνακας Στοιχείων Προβολής Εγγραφής',
    ...
    'LBL_KIOSK_MY_PROFILE_UPDATE_ERROR' => 'Σφάλμα κατά την ενημέρωση του Προφίλ σας.',
    'LBL_KIOSK_MY_PROFILE_UPDATE_SUCCESS' => 'Το προφίλ σας έχει ενημερωθεί.',
    ...
    'LBL_KIOSK_SERVER_ERROR' => 'Σφάλμα Διακομιστή',
    ...
    'LBL_KIOSK_HOMEPAGE_WELCOME1' => 'Καλώς ήρθατε στο Κέντρο Εξυπηρέτησης',
    'LBL_KIOSK_HOMEPAGE_WELCOME2' => 'Λάβετε τη βοήθεια που χρειάζεστε γρήγορα',
    'LBL_KIOSK_HOMEPAGE_SEARCH_PLACEHOLDER' => 'Αναζήτηση περιπτώσεων',
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY' => 'Η δραστηριότητά μου',
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY_DESC' => 'Προβολή πρόσφατης δραστηριότητας υποθέσεων και υποθέσεων που κοινοποιούνται σε εσάς.',
    'LBL_KIOSK_HOMEPAGE_LINK_SUBMIT' => 'Υποβολή υπόθεσης',
    'LBL_KIOSK_HOMEPAGE_LINK_SUBMIT_DESC' => 'Δημοσιεύστε εύκολα μια νέα έρευνα για την επανεξέτασή μας.',
    'LBL_KIOSK_SHOW_ALL' => 'Εμφάνιση Όλων',
    'LBL_KIOSK_NOT_FOUND' => "Δεν μπορέσαμε να το βρούμε αυτό.",
    'LBL_KIOSK_TENANT_NOT_FOUND' => 'Δεν βρέθηκε μισθωτής.',
    'LBL_KIOSK_404_ERROR' => 'Σφάλμα 404: ',
    ...
    'LBL_CJ_FORMS_SUBPANEL_TITLE' => 'Σχετικές ενέργειες Sugar',
    'LBL_CJ_FORMS' => 'Ενέργειες Sugar σχετικά με τον Έξυπνο οδηγό',
    'LBL_CJ_FORM' => 'Ενέργεια Sugar σχετικά με τον Έξυπνο οδηγό',
    ...
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'Πρόοδος Έξυπνου οδηγού',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Εμφανίζει το γράφημα πίτας "Πρόοδος Έξυπνου Οδηγού" του Sugar Automate.',
    ...
    'LBL_CONFIGURE_TEMPLATE_BUTTON_TITLE' => 'Διαμόρφωση',
...
$app_list_strings['moduleListSingular']['EmbeddedFiles'] = 'Embedded File';
    ...
    $app_strings['LBL_LARGE_FILE_UPLOAD'] = 'Λόγω του μεγάλου μεγέθους του αρχείου σας, η μεταφόρτωση θα διαρκέσει λίγο περισσότερο. Θα ειδοποιηθείτε όταν το αρχείο είναι έτοιμο.';
