...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => [
        ...
        'Escalations' => 'Κλιμακώσεις',
        'DocumentTemplates' => 'Πρότυπα εγγράφων',
        'DocumentMerges' => 'Συγχωνεύσεις εγγράφου',
        'CloudDrivePaths' => 'Διαδρομές μονάδων cloud',
        ...
        'DocuSignEnvelopes' => 'Φάκελοι DocuSign',
        'Geocode' => 'Γεωκώδικας',
        'DRI_Workflows' => 'Έξυπνοι Οδηγοί',
        'DRI_Workflow_Task_Templates' => 'Πρότυπα δραστηριότητας Έξυπνου οδηγού',
        'DRI_SubWorkflows' => 'Στάδια Έξυπνου οδηγού',
        'DRI_Workflow_Templates' => 'Πρότυπα Έξυπνου οδηγού',
        'CJ_WebHooks' => 'Άγκιστρα ιστού Sugar Automate',
        'CJ_Forms' => 'Ενέργειες Sugar σχετικά με τον Smart Guide',
        'DRI_SubWorkflow_Templates' => 'Πρότυπα σταδίων Έξυπνου οδηγού',
        'PubSub_ModuleEvent_PushSubs' => 'Συνδρομές ειδοποιήσεων push συμβάντων μονάδας Pub/Sub',
    ],
    ...
    'moduleIconList' => [
        ...
        'ProductTemplates' => 'ΠΠ',
        'ProductBundles' => 'ΠΠ',
        'ProductBundleNotes' => 'ΠΠ',
        'Reports' => 'Αν',
        'Forecasts' => 'Πρ',
        'ForecastWorksheets' => 'ΠΦ',
        'ForecastManagerWorksheets' => 'ΔΠ',
        'Quotas' => 'Fo',
        'VisualPipeline' => 'ΠΓ',
        'ConsoleConfiguration' => 'ΔΚ',
        'SugarLive' => 'Su',
        'Teams' => 'Ομ',
        'TeamNotices' => 'ΠΟ',
        'Manufacturers' => 'Κα',
        ...
        'CampaignTrackers' => 'ΠΕ',
        'Documents' => 'Έγ',
        'DocumentRevisions' => 'ΑΕ',
        'Connectors' => 'Σύ',
        'Notifications' => 'Ει',
        'Sync' => 'Sy',
        'HintAccountsets' => 'Hi',
        'HintNotificationTargets' => 'Γεια σας',
    ...
    'moduleListSingular' => [
        ...
        'DataArchiver' => 'Αρχειοθέτης δεδομένων',
        'ArchiveRuns' => 'Εκτελέσεις αρχείων',
        'ExternalUsers' => 'Εξωτερικός Χρήστης',
        ...
        'DocumentTemplates' => 'Πρότυπο εγγράφου',
        'DocumentMerges' => 'Συγχώνευση εγγράφου',
        'CloudDrivePaths' => 'Διαδρομή μονάδας cloud',
        ...
        'HintEnrichFieldConfigs' => 'HintEnrichFieldConfigs',
        'Geocode' => 'Γεωκώδικας',
        'DRI_Workflows' => 'Έξυπνος Οδηγός',
        'DRI_Workflow_Task_Templates' => 'Πρότυπο δραστηριότητας Έξυπνου οδηγού',
        'DRI_SubWorkflows' => 'Στάδιο Έξυπνου οδηγού',
        'DRI_Workflow_Templates' => 'Πρότυπο Έξυπνου οδηγού',
        'CJ_WebHooks' => 'Άγκιστρο ιστού Sugar Automate',
        'CJ_Forms' => 'Ενέργεια Sugar σχετικά με τον Smart Guide',
        'DRI_SubWorkflow_Templates' => 'Πρότυπο σταδίων Έξυπνου οδηγού',
        'PubSub_ModuleEvent_PushSubs' => 'Συνδρομή ειδοποιήσεων push συμβάντων μονάδας Pub/Sub',
    ],
 ...
 */
    ...
    'file_type_dom' => [
        'PDF' => 'PDF',
        'CSV' => 'CSV',
        'PDF and CSV' => 'PDF και CSV',
    ],
    'embed_report_dom' => [
        '' => '',
        'Chart' => 'Γράφημα',
        'Data Table' => 'Πίνακας Δεδομένων',
        'Chart and Data Table' => 'Πίνακας διαγραμμάτων και Στοιχείων',
    ],
    'message_status_dom' => [
        '' => '',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'field_name_placement_dom' => [
        'field_on_side' => 'Δίπλα από την Τιμή Πεδίου',
        'field_on_top' => 'Επάνω από την Τιμή Πεδίου',
    ],
    'payment_terms' => [
        '' => '',
...
//       it is the key for the default record_type_module value
        ...
        'appearance_options' => [
        'system_default' => 'Χρησιμοποιήστε τη ρύθμιση συστήματος',
        'light' => 'Ανοιχτόχρωμο',
        'dark' => 'Σκουρόχρωμο',
        ],
...
//       it is the key for the default quote_relationship_type_dom value
    ...
    /*Added entries 'Queued' and 'Sending' for 4.0 release..*/
        ...
        'dom_email_distribution' => ['' => '--Κανένα--',
        'direct' => 'Απευθείας Ανάθεση',
        'roundRobin' => 'Κατόπιν Ψηφοφορίας',
        'leastBusy' => 'Λιγότερο-Απασχολημένο',
        ],
        'dom_email_distribution_for_auto_create' => ['roundRobin' => 'Κατόπιν Ψηφοφορίας',
        'leastBusy' => 'Λιγότερο-Απασχολημένο',
        'none' => 'Κανένα',
        ],
        'dom_email_errors' => [1 => 'Επιλέξτε μόνο έναν χρήστη για απευθείας ανάθεση.',
        2 => 'Μορείτε να αναθέσετε μόνο τα επιλεγμένα στοιχεία.',
        ],
        'dom_email_bool' => ['bool_true' => 'Ναι',
        'bool_false' => 'Όχι',
        ],
        'dom_int_bool' => [1 => 'Ναι',
        0 => 'Όχι',
        ],
        'dom_switch_bool' => ['on' => 'Ναι',
        'off' => 'Όχι',
        '' => 'Όχι',],

        'dom_email_link_type' => ['sugar' => 'SugarCRM',
        'mailto' => 'Εξωτερικό Email Client'],


        'dom_email_editor_option' => ['' => 'Προεπιλεγμένη Μορφή Email',
        'html' => 'Email HTML',
        'plain' => 'Απλό Κείμενο Email'],

        'schedulers_times_dom' => ['not run' => 'Δεν Εκτελέστηκε',
        'ready' => 'Έτοιμο',
        'in progress' => 'Σε Εξέλιξη',
        'failed' => 'Αποτυχημένη',
        'completed' => 'Ολοκληρωμένη',
...
//  'Sub-Query' => 'Sub Query',
        ...
        'wflow_fire_order_dom' => ['alerts_actions' => 'Ειδοποιήσεις μετά Ενέργειες',
...
//prospect list type dom
    ...
    // strings to pass to Flash charts
        ...
        'chart_types' => [
        'hBarF' => 'Οριζόντια Μπάρα (σε στοίβα)',
        'hGBarF' => 'Οριζόντια Μπάρα (σε ομάδα)',
        'vBarF' => 'Κάθετη μπάρα (σε στοίβα)',
        'vGBarF' => 'Κάθετη Μπάρα (σε ομάδα)',
        'pieF' => 'Πίτα',
        'funnelF' => 'Χωνί',
        'lineF' => 'Γραμμή',
        'donutF' => 'Ντόνατ',
        'treemapF' => 'Δενδρόχαρτος',
        ],
        'd3_value_placement' => [
        '0' => 'Κανένα',
        '1' => 'Προεπιλογή',
        ...
        'metric_context_list' => [
        'service_console' => 'Κονσόλα Υπηρεσίας',
        'renewals_console' => 'Κονσόλα Ανανεώσεων',
        ],
    ...
    //Service Duration
        ...
        'agenda' => 'Ατζέντα',
        'timeline' => 'Χρονολόγιο',
        'monthSchedule' => 'Προγραμματιστής εργασιών',
        ],
        ...
        'show' => 'Εμφάνιση λίστας πιθανών παραληπτών',
        'dont_show' => 'Να μην εμφανίζονται οι πιθανοί παραλήπτες',
        ],
        'docusign_recipient_type_list' => [
        'signer' => 'Υπογράφων',
        'carbon_copy' => 'Θεατής (αντίγραφο καρμπόν)',
        'certified_delivery' => 'Θεατής (Πιστοποιημένη Παράδοση)',
        ],
        ...
        'module_icons_dom' => [
        'sicon-arrow-down' => 'Βέλος προς τα κάτω',
        'sicon-chevron-left' => 'Εικονίδιο Chevron Left',
        'sicon-check' => 'Σημείο ελέγχου',
        'sicon-clock' => 'Ρολόι',
        'sicon-dashboard-default' => 'Προεπιλογή πίνακα εργαλείων',
        'sicon-dashboard' => 'Πίνακας Εργαλείων',
        'sicon-edit' => 'Επεξεργασία',
        'sicon-caret-down' => 'Εικονίδιο Caret Down',
        'sicon-folder' => 'Φάκελος',
        'sicon-info' => 'Πληροφορίες',
        'sicon-kebab' => 'Κεμπάπ',
        'sicon-link' => 'Σύνδεσμος',
        'sicon-list' => 'Λίστα',
        'sicon-logout' => 'Έξοδος',
        'sicon-minus' => 'Μείον',
        'sicon-folder-open' => 'Άνοιγμα φακέλου',
        'sicon-plus-sm' => 'Συν Sm',
        'sicon-refresh' => 'Ανανέωση',
        'sicon-plus' => 'Συν',
        'sicon-settings' => 'Ρυθμίσεις',
        'sicon-arrow-right-double' => 'Διπλό δεξί βέλος',
        'sicon-reports' => 'Αναφορές',
        'sicon-user' => 'Χρήστης',
        'sicon-upload' => 'Φορτώνει',
        'sicon-user-group' => 'Ομάδα χρηστών',
        'sicon-arrow-left-double' => 'Διπλό αριστερό βέλος',
        'sicon-chevron-up' => 'Εικονίδιο Chevron Up',
        'sicon-caret-up' => 'Εικονίδιο Caret Up',
        'sicon-star-fill' => 'Εικονίδιο Star Fill',
        'sicon-download' => 'Λήψη',
        'sicon-close' => 'Κλείσιμο',
        'sicon-tile-view' => 'Εμφάνιση πλακιδίου',
        'sicon-list-view' => 'Προβολή Λίστας',
        'sicon-thumbs-down' => 'Εικονίδιο Thumbs Down',
        'sicon-warning-circle' => 'Κύκλος προειδοποίησης',
        'sicon-phone' => 'Τηλέφωνο',
        'sicon-email' => 'Email',
        'sicon-document' => 'Έγγραφο',
        'sicon-note' => 'Σημείωση',
        'sicon-preview' => 'Προεπισκόπηση',
        'sicon-copy' => 'Αντίγραφο',
        'sicon-launch' => 'Εκκίνηση',
        'sicon-lock' => 'Κλείδωμα',
        'sicon-arrow-top-right' => 'Επάνω δεξί βέλος',
        'sicon-full-screen' => 'Πλήρης Οθόνη',
        'sicon-full-screen-exit' => 'Έξοδος από πλήρη οθόνη',
        'sicon-expand-left' => 'Ανάπτυξη αριστερά',
        'sicon-expand-right' => 'Ανάπτυξη δεξιά',
        'sicon-focus-drawer' => 'Συρτάρι εστίασης',
        'sicon-ban' => 'Απαγόρευση',
        'sicon-thumbs-up' => 'Εικονίδιο Thumbs Up',
        'sicon-search' => 'Αναζήτηση',
        'sicon-calendar' => 'Ημερολόγιο',
        'sicon-calendar-lg' => 'Ημερολόγιο Lg',
        'sicon-mobile-lg' => 'Κινητό Lg',
        'sicon-star-fill-lg' => 'Εικονίδιο Star Fill Lg',
        'sicon-star-outline-lg' => 'Περίγραμμα αστεριού Lg',
        'sicon-reset-lg' => 'Επαναφορά Lg',
        'sicon-exchange-lg' => 'Ανταλλαγή Lg',
        'sicon-help-lg' => 'Βοήθεια Lg',
        'sicon-close-lg' => 'Κλείσιμο Lg',
        'sicon-plus-lg' => 'Συν Lg',
        'sicon-shortcuts-lg' => 'Συντομεύσεις Lg',
        'sicon-search-lg' => 'Αναζήτηση Lg',
        'sicon-email-lg' => 'Email Lg',
        'sicon-note-lg' => 'Σημείωση Lg',
        'sicon-document-lg' => 'Έγγραφο Lg',
        'sicon-add-dashlet-lg' => 'Προσθήκη Πίνακα Στοιχείων Lg',
        'sicon-collapse-lg' => 'Σύμπτυξη Lg',
        'sicon-hamburger-lg' => 'Χάμπουργκερ Lg',
        'sicon-pin-fill-lg' => 'Πινέζα Lg',
        'sicon-expand-lg' => 'Ανάπτυξη Lg',
        'sicon-copy-lg' => 'Αντιγραφή Lg',
        'sicon-dashboard-lg' => 'Πίνακας Εργαλείων Lg',
        'sicon-star-outline' => 'Περίγραμμα αστεριού',
        'sicon-reset' => 'Επαναφορά',
        'sicon-unlink' => 'Αποσύνδεση',
        'sicon-phone-lg' => 'Τηλέφωνο Lg',
        'sicon-attach' => 'Επισύναψη',
        'sicon-case-lg' => 'Χαρτοφύλακας Lg',
        'sicon-arrow-right-lg' => 'Δεξί βέλος Lg',
        'sicon-check-circle-lg' => 'Κύκλος ελέγχου Lg',
        'sicon-text-formatting' => 'Μορφοποίηση κειμένου',
        'sicon-check-circle' => 'Κύκλος ελέγχου',
        'sicon-upload-lg' => 'Φόρτωμα Lg',
        'sicon-flag-lg' => 'Σημαία Lg',
        'sicon-studio-lg' => 'Στούντιο Lg',
        'sicon-contact-lg' => 'Επαφή Lg',
        'sicon-edit-lg' => 'Επεξεργασία Lg',
        'sicon-arrow-left' => 'Αριστερό βέλος',
        'sicon-reply-all' => 'Απάντηση σε Όλα',
        'sicon-message-lg' => 'Μήνυμα Lg',
        'sicon-info-lg' => 'Πληροφορίες Lg',
        'sicon-error-lg' => 'Σφάλμα Lg',
        'sicon-check-circle-line-lg' => 'Γραμμή κύκλου ελέγχου Lg',
        'sicon-warning-line-lg' => 'Γραμμή προειδοποίησης Lg',
        'sicon-arrow-up' => 'Επάνω βέλος',
        'sicon-arrow-right' => 'Δεξί βέλος',
        'sicon-nodes' => 'Κόμβοι',
        'sicon-hide' => 'Απόκρυψη',
        'sicon-help' => 'Βοήθεια',
        'sicon-twitter' => 'Twitter',
        'sicon-message' => 'Μήνυμα',
        'sicon-sugar-predict-lg' => 'Πρόβλεψη Sugar Lg',
        'sicon-sugar-predict' => 'Πρόβλεψη Sugar',
        'sicon-opportunity-lg' => 'Ευκαιρία Lg',
        'sicon-lead-lg' => 'Δυνητικός πελάτης Lg',
        'sicon-account-lg' => 'Λογαριασμός Lg',
        'sicon-user-sm' => 'Sm χρήστη',
        'sicon-quote-lg' => 'Εισαγωγικά Lg',
        'sicon-equal' => 'Ίσον',
        'sicon-slicers-xl' => 'Αναλυτές Xl',
        'sicon-escalation-lg' => 'Κλιμάκωση Lg',
        'sicon-add-circle-lg' => 'Προσθήκη κύκλου Lg',
        'sicon-add-line-lg' => 'Προσθήκη γραμμής Lg',
        'sicon-add-target-lg' => 'Προσθήκη στόχου Lg',
        'sicon-help-circle-lg' => 'Κύκλος βοήθειας Lg',
        'sicon-divide-line-lg' => 'Διαχωριστική γραμμή Lg',
        'sicon-string' => 'Συμβολοσειρά',
        'sicon-filter' => 'Φίλτρο',
        'sicon-number' => 'Αριθμός',
        'sicon-format-lg' => 'Μορφοποίηση Lg',
        'sicon-insights-lg' => 'Στατιστικά Lg',
        'sicon-invalid-circle-lg' => 'Κύκλος μη έγκυρου Lg',
        'sicon-layout-xl' => 'Διάταξη Xl',
        'sicon-layout-lg' => 'Διάταξη Lg',
        'sicon-multiply-line-lg' => 'Γραμμή πολλαπλασιασμού Lg',
        'sicon-redo-lg' => 'Επανάληψη Lg',
        'sicon-refresh-lg' => 'Ανανέωση Lg',
        'sicon-undo-lg' => 'Αναίρεση Lg',
        'sicon-activity-feed-xl' => 'Τροφοδοσία δραστηριότητας Xl',
        'sicon-chevron-left-xl' => 'Εικονίδιο Chevron Left Xl',
        'sicon-close-xl' => 'Κλείσιμο Xl',
        'sicon-kebab-lg' => 'Kebab Lg',
        'sicon-insights-xl' => 'Στατιστικά Xl',
        'sicon-hide-lg' => 'Απόκρυψη Lg',
        'sicon-kebab-xl' => 'Kebab Xl',
        'sicon-comment-xl' => 'Σχόλιο Xl',
        'sicon-share-lg' => 'Κοινή χρήση Lg',
        'sicon-trash' => 'Κάδος απορριμμάτων',
        'sicon-launch-lg' => 'Εκκίνηση Lg',
        'sicon-thumbs-up-lg' => 'Εικονίδιο Thumbs Up Lg',
        'sicon-thumbs-down-lg' => 'Εικονίδιο Thumbs Down Lg',
        'sicon-warning-lg' => 'Προειδοποίηση Lg',
        'sicon-wizard-circle-xl' => 'Εικονίδιο Wizard Circle Xl',
        'sicon-bell-cross-lg' => 'Καμπανάκι με διαγραφή Lg',
        'sicon-bell-lg' => 'Καμπανάκι Lg',
        'sicon-daily-lg' => 'Ημερήσια Lg',
        'sicon-cloud-download-lg' => 'Λήψη Cloud Lg',
        'sicon-unlock' => 'Ξεκλείδωμα',
        'sicon-news-lg' => 'Ειδήσεις Lg',
        'sicon-weekly-lg' => 'Εβδομαδιαία Lg',
        'sicon-knowledgebase-xl' => 'Βάση γνώσεων Xl',
        'sicon-remove' => 'Κατάργηση',
        'sicon-chevron-down' => 'Εικονίδιο Chevron Down',
        'sicon-slicers-lg' => 'Αναλυτές Lg',
        'sicon-save-lg' => 'Αποθήκευση Lg',
        'sicon-info-circle-lg' => 'Κύκλος πληροφοριών Lg',
        'sicon-chevron-right' => 'Εικονίδιο Chevron Right',
        'sicon-warning-circle-lg' => 'Κύκλος προειδοποίησης Lg',
        'sicon-right-paren-line-lg' => 'Δεξιά γραμμή Paren Lg',
        'sicon-comment-lg' => 'Σχόλιο Lg',
        'sicon-target-lg' => 'Στόχος Lg',
        'sicon-subtract-line-lg' => 'Γραμμή αφαίρεσης Lg',
        'sicon-settings-lg' => 'Ρυθμίσεις Lg',
        'sicon-left-paren-line-lg' => 'Αριστερή γραμμή Paren Lg',
        'sicon-preview-lg' => 'Προεπισκόπηση Lg',
        'sicon-thumbs-down-line-lg' => 'Γραμμή Thumbs Down Lg',
        'sicon-thumbs-up-line-lg' => 'Γραμμή Thumbs Up Lg',
        'sicon-send-lg' => 'Αποστολή Lg',
        'sicon-contact-xl' => 'Επαφή Xl',
        'sicon-wizard-circle-line-xl' => 'Γραμμή Wizard Circle Xl',
        'sicon-trash-lg' => 'Κάδος απορριμμάτων Lg',
        'sicon-pin-lg' => 'Καρφίτσωμα Lg',
        'sicon-clock-lg' => 'Ρολόι Lg',
        'sicon-comment-line-xl' => 'Γραμμή σχολίων Xl',
        'sicon-dropdown-editor' => 'Διαμόρφωση Αναδυόμενων Καταλόγων',
        'sicon-amazon' => 'Amazon',
        'sicon-bug' => 'Σφάλμα',
        'sicon-catalog' => 'Κατάλογος',
        'sicon-cloud' => 'Cloud',
        'sicon-config-api' => 'Διαμόρφωση Api',
        'sicon-config-nav' => 'Διαμόρφωση Nav',
        'sicon-connectors' => 'Σύνδεσμοι',
        'sicon-contracts' => 'Συμβάσεις',
        'sicon-currencies' => 'Νομίσματα',
        'sicon-diagnostics' => 'Διαγνωστικά',
        'sicon-sugar-club' => 'Sugar Club',
        'sicon-email-campaign' => 'Εκστρατεία Email',
        'sicon-email-inbound' => 'Εισερχόμενα μηνύματα email',
        'sicon-email-queue' => 'Ουρά αναμονής Email',
        'sicon-forecasts' => 'Προβλέψεις',
        'sicon-display-modules' => 'Εμφάνιση Ενοτήτων',
        'sicon-email-contacts' => 'Email Επαφών',
        'sicon-import' => 'Εισαγωγή',
        'sicon-log-viewer' => 'Πρόγραμμα προβολής αρχείων καταγραφής',
        'sicon-lab' => 'Εργαστήριο',
        'sicon-map-pin' => 'Καρφίτσωμα χάρτη',
        'sicon-manufacturers' => 'Κατασκευαστές',
        'sicon-update' => 'Ενημέρωση',
        'sicon-content-security' => 'Ασφάλεια περιεχομένου',
        'sicon-module-builder' => 'Ενότητα Δόμησης',
        'sicon-languages' => 'Γλώσσες',
        'sicon-module-loader' => 'Φορτωτής Ενότητας',
        'sicon-oauth-key' => 'Κλειδί ανοιχτής εξουσιοδότησης',
        'sicon-password-mgmt' => 'Κωδικός πρόσβασης Mgmt',
        'sicon-opportunities' => 'Ευκαιρίες',
        'sicon-upgrade' => 'Αναβάθμιση',
        'sicon-portal' => 'Portal',
        'sicon-product-types' => 'Τύποι Προϊόντων',
        'sicon-quotes' => 'Προσφορές',
        'sicon-relate-fields' => 'Συσχετίστε Πεδία',
        'sicon-repair' => 'Επιδιόρθωση',
        'sicon-role-mgmt' => 'Ρόλος Mgmt',
        'sicon-scheduler' => 'Προγραμματιστής εργασιών',
        'sicon-shippers' => 'Αποστολείς',
        'sicon-studio' => 'Στούντιο',
        'sicon-web-logic' => 'Λογική Ιστού',
        'sicon-sugar-u' => 'Sugar U',
        'sicon-tax-rates' => 'Φορολογικοί Συντελεστές',
        'sicon-team-mgmt' => 'Ομάδα Mgmt',
        'sicon-team-perm' => 'Άδεια ομάδας',
        'sicon-tracker' => 'Tracker',
        'sicon-workflow' => 'Ροή Εργασίας',
        'sicon-mask' => 'Μάσκα',
        'sicon-mask-disabled' => 'Απενεργοποίηση μάσκας',
        'sicon-email-archive' => 'Αρχείο email',
        'sicon-mobile' => 'Κινητό Τηλέφωνο',
        'sicon-archive' => 'Αρχειοθέτηση',
        'sicon-automate-scroll' => 'Κάθετη προβολή κύλισης',
        'sicon-automate-stacked' => 'Οριζόντια προβολή κύλισης',
        'sicon-pdf-manager' => 'Διαχειριστής Pdf',
        'sicon-my-sites' => 'Ιστοσελίδες Μου',
        'sicon-cloud-insights' => 'Στατιστικά Cloud',
        'sicon-sugar-logo-24' => 'Λογότυπο Sugar 24',
        'sicon-sugar-logo-16' => 'Λογότυπο Sugar 16',
        'sicon-task-lg' => 'Εργασία Lg',
        'sicon-web-lg' => 'Ιστός Lg',
        'sicon-events-lg' => 'Συμβάντα Lg',
        'sicon-sugar-logo-12' => 'Λογότυπο Sugar 12',
        'sicon-tag' => 'Ετικέτα',
        'sicon-tag-lg' => 'Ετικέτα Lg',
        'sicon-bell-lg-line' => 'Γραμμή για καμπανάκι Lg',
        'sicon-matrix-xxl' => 'Matrix Xxl',
        'sicon-advanced-filter' => 'Προηγμένο Φίλτρο',
        'sicon-rows-and-columns-xxl' => 'Σειρές και στήλες Xxl',
        'sicon-summation-details-xxl' => 'Λεπτομέρειες αθροίσματος Xxl',
        'sicon-summation-xxl' => 'Άθροισμα Xxl',
        'sicon-lock-lg' => 'Κλείδωμα Lg',
        'sicon-csv-file-xxl' => 'Αρχείο Csv Xxl',
        'sicon-logo-linkedin' => 'Λογότυπο Linkedin',
        'sicon-briefcase' => 'Χαρτοφύλακας',
        'sicon-car-front' => 'Πρόσοψη αυτοκινήτου',
        'sicon-airplane' => 'Αεροπλάνο',
        'sicon-laptop' => 'Φορητός υπολογιστής',
        'sicon-logo-instagram' => 'Λογότυπο Instagram',
        'sicon-single-bed' => 'Μονό Κρεβάτι',
        'sicon-tiktok' => 'Tiktok',
        'sicon-logo-snapchat' => 'Λογότυπο Snapchat',
        'sicon-video-lg' => 'Βίντεο Lg',
        'sicon-reply' => 'Απάντηση',
        'sicon-subtract' => 'Αφαίρεση',
        'sicon-arrow-up-circle-line' => 'Κύκλος Arrow Up',
        'sicon-asterisk' => 'Αστερίσκος',
        'sicon-dot-circle-o-lg' => 'Κύκλος με τελεία Lg',
        'sicon-forward' => 'Προώθηση',
        'sicon-video' => 'Βίντεο',
        'sicon-gavel' => 'Σφυρί',
        'sicon-login' => 'Σύνδεση',
        'sicon-pdf-file-xxl' => 'Αρχείο Pdf Xxl',
        'sicon-login-lg' => 'Σύνδεση Lg',
        'sicon-cloud-download-xl' => 'Λήψη Cloud Xl',
        'sicon-campaigns-lg' => 'Εκστρατείες Lg',
        'sicon-customer-journey-stages-lg' => 'Στάδια ταξιδιού πελατών Lg',
        'sicon-role-mgmt-lg' => 'Ρόλος Mgmt Lg',
        'sicon-default-module-lg' => 'Προεπιλεγμένη ενότητα Lg',
        'sicon-quoted-line-items-lg' => 'Εισηγμένα Στοιχεία Γραμμής Lg',
        'sicon-projects-lg' => 'Έργα Lg',
        'sicon-process-business-rules-lg' => 'Διεργασία Επιχειρησιακών Κανόνων Lg',
        'sicon-process-email-templates-lg' => 'Διεργασία Προτύπων Email Lg',
        'sicon-processes-lg' => 'Διαδικασίες Lg',
        'sicon-process-definitions-lg' => 'Ορισμοί διαδικασιών Lg',
        'sicon-target-lists-lg' => 'Λίστες Στόχων Lg',
        'sicon-purchased-line-items-lg' => 'Γραμμή Στοιχείων που αγοράστηκαν Lg',
        'sicon-user-group-lg' => 'Ομάδα χρηστών Lg',
        'sicon-revenue-line-items-lg' => 'Στοιχεία γραμμής εσόδων Lg',
        'sicon-business-centers-lg' => 'Επιχειρηματικά κέντρα Lg',
        'sicon-logo-fb-simple' => 'Λογότυπο Fb Απλό',
        'sicon-forecasts-lg' => 'Προβλέψεις Lg',
        'sicon-contracts-lg' => 'Επαφές Lg',
        'sicon-purchase-lg' => 'Αγορά Lg',
        'sicon-sugar-live-lg' => 'Sugar Live Lg',
        'sicon-customer-journey-lg' => 'Ταξίδι πελατών Lg',
        'sicon-data-privacy-lg' => 'Πολιτική προστασίας προσωπικών δεδομένων Lg',
        'sicon-home-lg' => 'Αρχική Lg',
        'sicon-data-table' => 'Πίνακας Δεδομένων',
        'sicon-medical-clipboard-lg' => 'Ιατρικό Πρόχειρο Lg',
        'sicon-privacy-lg' => 'Απόρρητο Lg',
        'sicon-marketplace' => 'Αγορά',
        'sicon-marketplace-lg' => 'Αγορά Lg',
        'sicon-blockquote-lg' => 'Αποκλεισμένο κείμενο Lg',
        'sicon-casino-lg' => 'Καζίνο Lg',
        'sicon-jacuzzi-lg' => 'Τζακούζι Lg',
        'sicon-scissors-lg' => 'Ψαλίδι Lg',
        'sicon-storage-lg' => 'Αποθήκευση Lg',
        'sicon-fan-lg' => 'Ανεμιστήρας Lg',
        'sicon-medicine-lg' => 'Φάρμακο Lg',
        'sicon-plant-lg' => 'Φυτό Lg',
        'sicon-telescope-lg' => 'Τηλεσκόπιο Lg',
        'sicon-smart-phone-lg' => 'Έξυπνο τηλέφωνο Lg',
        'sicon-coffee-lg' => 'Καφές Lg',
        'sicon-martini-lg' => 'Martini Lg',
        'sicon-cocktail-lg' => 'Κοκτέιλ Lg',
        'sicon-stadium-lg' => 'Στάδιο Lg',
        'sicon-fire-lg' => 'Φωτιά Lg',
        'sicon-window-lg' => 'Παράθυρο Lg',
        'sicon-lotus-lg' => 'Λωτός Lg',
        'sicon-windmill-lg' => 'Ανεμόμυλος Lg',
        'sicon-spades-lg' => 'Μπαστούνι Lg',
        'sicon-hearts-lg' => 'Κούπα Lg',
        'sicon-diamonds-lg' => 'Καρό Lg',
        'sicon-clubs-lg' => 'Σπαθί Lg',
        'sicon-skull-lg' => 'Κρανίο Lg',
        'sicon-send' => 'Αποστολή',
        'sicon-world-lg' => 'Κόσμος Lg',
        'sicon-airplane-lg' => 'Αεροπλάνο Lg',
        'sicon-planet-lg' => 'Πλανήτης Lg',
        'sicon-trainer-lg' => 'Εκπαιδευτής Lg',
        'sicon-calculator-lg' => 'Αριθμομηχανή Lg',
        'sicon-tv-lg' => 'TV Lg',
        'sicon-video-player-lg' => 'Πρόγραμμα αναπαραγωγής βίντεο Lg',
        'sicon-media-player-lg' => 'Πρόγραμμα αναπαραγωγής πολυμέσων Lg',
        'sicon-decentralize-lg' => 'Αποκέντρωση Lg',
        'sicon-statistics-lg' => 'Στατιστικά Lg',
        'sicon-virus-lg' => 'Ιός Lg',
        'sicon-shield-lg' => 'Ασπίδα Lg',
        'sicon-plug-lg' => 'Βύσμα Lg',
        'sicon-shuttle-lg' => 'Άκατος Lg',
        'sicon-soundwave-lg' => 'Ηχητικό κύμα Lg',
        'sicon-graph-lg' => 'Γράφημα Lg',
        'sicon-playlist-lg' => 'Λίστα αναπαραγωγής Lg',
        'sicon-voice-recognition-lg' => 'Αναγνώριση φωνής Lg',
        'sicon-machine-learning-lg' => 'Μηχανική Μάθηση Lg',
        'sicon-bed-lg' => 'Κρεβάτι Lg',
        'sicon-blueprint-lg' => 'Σχεδιάγραμμα Lg',
        'sicon-content-delivery-lg' => 'Παράδοση περιεχομένου Lg',
        'sicon-questionnaire-lg' => 'Ερωτηματολόγιο Lg',
        'sicon-presentation-lg' => 'Παρουσίαση Lg',
        'sicon-organic-lg' => 'Οργανικά Lg',
        'sicon-transactions-lg' => 'Συναλλαγές Lg',
        'sicon-wand-lg' => 'Ραβδί Lg',
        'sicon-bin-lg' => 'Κάδος Lg',
        'sicon-sync-lg' => 'Συγχρονισμός Lg',
        'sicon-external-authentication-lg' => 'Εξωτερική Πιστοποίηση Lg',
        'sicon-tracking-activity-lg' => 'Δραστηριότητα παρακολούθησης Lg',
        'sicon-account' => 'Λογαριασμός',
        'sicon-meetings-lg' => 'Συναντήσεις Lg',
        'sicon-stacked' => 'Οριζόντια διαιρεμένη προβολή',
        'sicon-sidebyside' => 'Κάθετη διαιρεμένη προβολή',
        ],
    ...
    // Escalations module
        ...
        'Inactivity' => 'Αδράνεια',
        'Lack of Progress' => 'Έλλειψη Προόδου',
        'Customer-Imposed Deadline' => 'Προθεσμία που Επιβλήθηκε από τον Πελάτη',
        'Account at Risk' => 'Λογαριασμός σε κίνδυνο',
        ],
        'escalation_source_dom' => [
        'Customer Requested' => 'Ζητήθηκε από τον πελάτη',
        'Internally Requested' => 'Ζητήθηκε Εσωτερικά',
        ],
    ...
    // Sentiment
        ...
        '' => '',
        '01_not_likely' => 'Δεν είναι πιθανό',
        '02_less_likely' => 'Λιγότερο πιθανό',
        '03_neutral' => 'Ουδέτερο',
        '04_more_likely' => 'Περισσότερο πιθανό',
        '05_very_likely' => 'Πολύ πιθανό',
        ],
        'ai_icp_fit_score_classification_dropdown' => [
        '' => '',
        '03_does_not_match_customers' => 'Δεν ταιριάζει με τους πελάτες',
        '02_no_match' => '',
        '01_matches_customers' => 'Ταιριάζει με τους πελάτες',
        ],
    ...
    // Sugar Automate
        ...
        'none' => 'Κανένα',
        'create' => 'Σχετικά με τη δημιουργία',
        'stage_start' => 'Σχετικά με την έναρξη σταδίου',
        'previous_activity_completed' => 'Προηγούμενη δραστηριότητα που ολοκληρώθηκε',
        ],
        'dri_workflow_templates_target_assignee_list' => [
        'current_user' => 'Υφιστάμενος Χρήστης',
        'parent_assignee' => 'Κύριος εντολοδόχος',
        ],
        'dri_workflow_task_templates_task_due_date_type_list' => [
        '' => '',
        'days_from_created' => 'Ημέρες από τη δημιουργία',
        'days_from_stage_started' => 'Ημέρες από την έναρξη σταδίου',
        'days_from_previous_activity_completed' => 'Ημέρες από προηγούμενη δραστηριότητα που ολοκληρώθηκε',
        'days_from_parent_date_field' => 'Ημέρες από πεδίο κύριας ημερομηνίας',
        'days_from_specific_activity_completed' => 'Ημέρες από συγκεκριμένη δραστηριότητα που ολοκληρώθηκε',
        ],
        'dri_workflow_task_templates_momentum_start_type_list' => [
        '' => '',
        'created' => 'Κατά τη δημιουργία',
        'stage_started' => 'Κατά την έναρξη σταδίου',
        'previous_activity_completed' => 'Κατά την ολοκλήρωση προηγούμενης δραστηριότητας',
        'parent_date_field' => 'Σχετικά με το πεδίο κύριας ημερομηνίας',
        'specific_activity_completed' => 'Συγκεκριμένη δραστηριότητα που ολοκληρώθηκε',
        ],
        ...
        '' => '',
        'customer_task' => 'Εργασία πελάτη',
        'milestone' => 'Ορόσημο',
        'internal_task' => 'Εσωτερική εργασία',
        'agency_task' => 'Εργασία φορέα',
        'automatic_task' => 'Αυτόματη εργασία',
        ],
        ...
        'stage_edit_button' => 'Επεξεργασία σταδίου',
        'stage_add_task_button' => 'Δημιουργία Εργασίας',
        'stage_add_meeting_button' => 'Προγραμματισμός Συνάντησης',
        'stage_add_call_button' => 'Προγραμματισμός Κλήσης',
        'stage_delete_button' => 'Διαγραφή σταδίου',
        ],
        'dri_workflow_templates_disabled_activity_actions_list' => [
        'activity_add_sub_task_button' => 'Προσθήκη εργασίας',
        'activity_add_sub_meeting_button' => 'Προγραμματισμός Συνάντησης',
        'activity_add_sub_call_button' => 'Προγραμματισμός Κλήσης',
        'activity_not_applicable_button' => 'Δεν ισχύει',
        'activity_delete_button' => 'Διαγραφή',
        ],
        'dri_workflow_templates_cancel_action_list' => [
        'set_not_applicable' => 'Ρύθμιση Δεν ισχύει',
        'remove_open_activities' => 'Κατάργηση ανοιχτών δραστηριοτήτων',
        ],
        ...
        'skip_request' => 'Αίτημα παράλειψης',
        'json' => 'JSON',
        'http_query' => 'Ερώτημα HTTP',
        ],
        ...
        '' => '',
        'before_create' => 'Πριν από τη δημιουργία',
        'after_create' => 'Μετά τη δημιουργία',
        'before_in_progress' => 'Πριν από την κατάσταση Σε εξέλιξη',
        'after_in_progress' => 'Μετά την κατάσταση Σε εξέλιξη',
        'before_completed' => 'Πριν από την κατάσταση Ολοκληρώθηκε',
        'after_completed' => 'Μετά την κατάσταση Ολοκληρώθηκε',
        'before_not_applicable' => 'Πριν από την κατάσταση Δεν ισχύει',
        'after_not_applicable' => 'Μετά από την κατάσταση Δεν ισχύει',
        'before_delete' => 'Πριν από τη Διαγραφή',
        'after_delete' => 'Μετά τη Διαγραφή',
        ],
        'cj_webhooks_request_body_list' => [
        'journey_body' => 'Αποστολή πληροφοριών Έξυπνου οδηγού',
        'custom_body' => 'Αποστολή προσαρμοσμένου σώματος δημοσίευσης',
        ],
        ...
        'create_record' => 'Δημιουργία Εγγραφής',
        'update_record' => 'Ενημέρωση Εγγραφής',
        ],
        'cj_forms_action_trigger_type_list' => [
        'automatic_create' => 'Αυτόματη δημιουργία εγγραφής',
        'manual_create' => 'Μη αυτόματη δημιουργία εγγραφής',
        'automatic_update' => 'Αυτόματη ενημέρωση εγγραφής',
        'manual_update' => 'Μη αυτόματη ενημέρωση εγγραφής',
        ],
        'cj_forms_parent_type_list' => [
        '' => '',
        'DRI_Workflow_Templates' => 'Πρότυπο Έξυπνου οδηγού',
        'DRI_SubWorkflow_Templates' => 'Πρότυπο σταδίου',
        'DRI_Workflow_Task_Templates' => 'Πρότυπο δραστηριότητας',
        ],
        ...
        'Tasks' => 'Τρέχουσα εργασία',
        'Calls' => 'Τρέχουσα κλήση',
        'Meetings' => 'Τρέχουσα συνάντηση',
        ],
        'cj_select_to_options_list' => [
        '' => '',
        'specific_users' => 'Συγκεκριμένοι χρήστες',
        'specific_contacts' => 'Συγκεκριμένες επαφές',
        'related_parent_users' => 'Σχετικοί γονικοί χρήστες',
        'related_parent_contacts' => 'Σχετικές γονικές επαφές',
        'add_all_contacts_from_parent' => 'Προσθήκη όλων των επαφών από γονικό στοιχείο',
        ],
        'cj_select_to_options_list_module_mapping' => [
        '' => '',
        'specific_users' => 'Χρήστες',
        'specific_contacts' => 'Επαφές',
        'related_parent_users' => 'Χρήστες',
        'related_parent_contacts' => 'Επαφές',
        'add_all_contacts_from_parent' => 'Επαφές',
        ],
        ...
        'fixed' => 'Σταθερή Ημερομηνία',
        'relative' => 'Σχετική ημερομηνία',
        ],
        'cj_blank_list' => [
        '' => '',
        ],
        ...
        '' => '',
        'smart_guide_to_sugar_action' => 'Από Smart Guide προς ενέργεια Sugar',
        'sugar_action_to_smart_guide' => 'Ενέργεια Sugar προς Smart Guide',
        ],
        ...
        '' => '',
        'Smart Guide Stage' => 'Στάδιο Smart Guide',
        'Smart Guide Activities' => 'Δραστηριότητες Smart Guide',
        ...
        '' => '',
        'mark_all_completed' => 'Επισήμανση όλων των δραστηριοτήτων ως ολοκληρωμένων',
        'mark_all_not_applicable' => 'Επισήμανση όλων των ανολοκλήρωτων δραστηριοτήτων ως μη ισχυουσών',
        ],
        'doc_merge_default_region_url' => [
        'us-west-2' => 'Ηνωμένες Πολιτείες (Όρεγκον) [us-west-2]',
        'ca-central-1' => 'Καναδάς (Κεντρικός) [ca-central-1]',
        'ap-southeast-1' => 'Ασία-Ειρηνικός (Σιγκαπούρη) [ap-southeast-1]',
        'ap-southeast-2' => 'Ασία-Ειρηνικός (Σίδνεϊ) [ap-southeast-2]',
        'eu-central-1' => 'Ευρώπη (Φρανκφούρτη) [eu-central-1]',
        'eu-west-2' => 'Ευρώπη (Λονδίνο) [eu-west-2]',
        ],
];
...
$app_strings = [
    ...
    'LBL_DROPDOWN_VIEW_CHANGE_WARNING' => 'Μια αναπτυσσόμενη τιμή που επιλέξατε άλλαξε τη διάταξη προβολής εγγραφής. ' .
        'Οι τιμές των πεδίων που είναι κρυμμένα σε αυτήν τη νέα διάταξη έχουν διαγραφεί. ',

    // Side navigation bar labels
    'LBL_SIDEBAR_NAV_OPEN' => 'Άνοιγμα',
    'LBL_SIDEBAR_NAV_CLOSE' => 'Κλείσιμο',
    'LBL_SIDEBAR_NAV_ITEM_MENU' => 'Μενού {{subject}}',
    'LBL_GOTO_SUGARCRM_COM' => 'Μεταβείτε στο SugarCRM.com',
    ...
    'LBL_START' => 'Έναρξη',
    'LBL_END' => 'Τέλος',
    'LBL_DATE_LINKED' => 'Ημερομηνία σύνδεσης',
    ...
    'ERR_REPORTS_DISABLED_EXPORT' => 'Η εξαγωγή αναφορών είναι απενεργοποιημένη',
    'ERR_REPORTS_ADMIN_EXPORT_ONLY' => 'Μόνο οι χρήστες με δικαιώματα διαχειριστή μπορούν να κάνουν εξαγωγή',
    'ERR_REPORTS_EXPORT_NOT_ALLOWED' => 'Η αναφορά χρησιμοποιεί μονάδες χωρίς πρόσβαση στην Εξαγωγή',
    'ERR_REPORTS_EXPORT_OWNER' => 'Η αναφορά χρησιμοποιεί μονάδες με πρόσβαση Κατόχου στην Εξαγωγή',
    'ERR_REPORTS_LIST_NOT_ALLOWED' => 'Η αναφορά χρησιμοποιεί μονάδες με περιορισμένη πρόσβαση Καταλόγου',
    'ERR_REPORTS_VIEW_NOT_ALLOWED' => 'Η αναφορά χρησιμοποιεί μονάδες με περιορισμένη πρόσβαση Προβολής',
    'ERR_REPORTS_ACCESS_DISABLED' => 'Η αναφορά χρησιμοποιεί μονάδες με περιορισμένη πρόσβαση',
    'ERR_REPORTS_FIELDS_RESTRICTED' => 'Η αναφορά χρησιμοποιεί πεδία με περιορισμένη πρόσβαση',
    ...
    'ERR_OPPORTUNITY_NAME_DUPE' => 'Μια Eυκαιρία με το όνομα %s υπάρχει ήδη.  Εισαγάγετε ένα άλλο όνομα παρακάτω.',
    ...
    'EXCEPTION_CLIENT_NOT_ALLOWED' => 'Αυτός ο πελάτης δεν επιτρέπεται',
    'EXCEPTION_MODULELOADER_UPLOAD' => 'Η δυνατότητα μεταφόρτωσης πακέτων δεν είναι διαθέσιμη για τον τύπο άδειας χρήσης σας',
    ...
    'EXCEPTION_CLIENT_NOT_ALLOWED_DESC' => 'Αυτός ο πελάτης δεν επιτρέπεται',
    ...
    'LBL_ESCALATIONS' => 'Κλιμακώσεις',
    'LBL_ESCALATION' => 'Κλιμάκωση',
    'LBL_DOCUSIGN_ENVELOPES' => 'Φάκελοι DocuSign',
    'LBL_DOCUSIGN_ENVELOPE' => 'Φάκελος DocuSign',
    'LBL_DOCUSIGN_SELECT_RECIPIENTS' => 'Επιλογή παραληπτών υπογράφοντος',
    ...
    'LBL_COMPOSE_EMAIL_BUTTON_LABEL2' => 'Ηλεκτρονικό ταχυδρομείο',
    ...
    'LBL_ACTIVITY_MODIFIED' => 'Τροποποιημένο',
    ...
    'LBL_FILTER_CREATE_NEW_UNSAVED' => 'Φίλτρο δημιουργίας (Μη αποθηκευμένο)',
    'LBL_FILTER_EDIT_UNSAVED_SUFFIX' => '(Μη αποθηκευμένο)',
    ...
    'LBL_LISTVIEW_FREEZE_COLUMN_1' => 'Πάγωμα στήλης 1',
    ...
    'LBL_LISTVIEW_SELECTED_CLEAR' => 'Εκκαθάριση όλων των επιλογών.',
    ...
    'TPL_LISTVIEW_SELECTED_ONE' => 'Έχετε επιλέξει 1 αρχείο στο σύνολο αποτελεσμάτων.',
    ...
    'TPL_MASSUPDATE_PROGRESS_STATUS' => 'Ενημέρωση {{num}} από {{total}}',
    ...
    'TPL_MASSDELETE_PROGRESS_STATUS' => 'Διαγραφή {{num}} από {{total}}',
    ...
    'LBL_LISTVIEW_SELECT_AND_EDIT' => 'Επιλέξτεε',
    'LBL_LISTVIEW_ACTIONS' => 'Ενέργειες',

    'LBL_LISTVIEW_SELECT_ALL_ON_PAGE' => 'Επιλέξτε όλες τις εγγραφές σε αυτήν τη σελίδα',
    'LBL_LISTVIEW_DESELECT_ALL_ON_PAGE' => 'Αποεπιλέξτε όλες τις εγγραφές σε αυτήν τη σελίδα',

    'TPL_LIST_HEADER_COUNT' => '{{num}}',
    'TPL_LIST_HEADER_COUNT_PARTIAL' => '{{num}}+',
    'TPL_LIST_HEADER_COUNT_TOTAL' => '{{num}} από {{total}}',
    'TPL_LIST_HEADER_COUNT_LOADING' => '{{num}} σε φόρτωση...',
    'TPL_LIST_HEADER_COUNT_TOOLTIP' => 'Click for total',
    // List View Pagination
    'LBL_LIST_PAGINATION_OF' => 'από',
    'LBL_GET_PAGE_COUNT_TOOLTIP' => 'Λήψη αριθμού σελίδων',
    ...
    'LBL_LOGOUT' => 'Έξοδος',
    'LBL_FINISH_IMPERSONATING' => 'Ολοκληρώστε αυτό που υποδύεστε',
    'LBL_RESET_MFA' => 'Επαναφορά εξουσιοδότησης πολλαπλών σταδίων',
    'LBL_YOU_ARE_CURRENTLY_IMPERSONATING' => '{{sudoer}}, αυτή τη στιγμή υποδύεστε {{user}}.',
    'LBL_PROFILE' => 'Προφίλ',
    'LBL_MAILMERGE_KEY' => 'M',
    'LBL_MAILMERGE' => 'Συγχώνευση Ταχυδρομείου',
    'LBL_MASS_UPDATE' => 'Μαζική Ενημέρωση',
    'LBL_MASS_UPDATE_ALL_RECORDS' => 'Επιλέξτε όλες τις εγγραφές για μαζική ενημέρωση',
    'LBL_MASS_UPDATE_SINGLE_RECORD' => 'Συμπερίληψη εγγραφής σε μαζική ενημέρωση',
    ...
    'LBL_COUNT_MODULES' => '{{count}} ενότητες',
    ...
    'LBL_RELATED_TYPE' => 'Σχετιζόμενος τύπος',
    ...
    'LBL_RELATED_RECORDS' => 'Σχετική {{module}}',
    ...
    'LBL_METRIC_DELETE_WARNING' => 'Όλοι οι χρήστες στους οποίους έχει κοινοποιηθεί αυτή η καρτέλα μέτρησης θα χάσουν επίσης την πρόσβαση.',
    ...
    'NTC_UNLINK_CASES_CONTACT_CONFIRMATION' => 'Είστε βέβαιοι ότι θέλετε να αποσυνδέσετε το {0}? Αυτό θα τους αφαιρέσει επίσης από το πεδίο Κύρια επαφή της υπόθεσης.',
    'NTC_UNLINK_CASES_CONTACT_ERROR' => 'Δεν είναι δυνατή η αποσύνδεση του {0} επειδή είναι η κύρια επαφή σε αυτήν την περίπτωση. Ενημερώστε το πεδίο Κύρια επαφή πριν αποσυνδέσετε αυτήν την εγγραφή.',
    ...
    'LBL_MFA_RESET_CONFIRMATION' => 'Είστε βέβαιοι ότι θέλετε να επαναφέρετε τον <a href="https://support.sugarcrm.com/SmartLinks/Custom/Logging_In_Using_MFA/" target="_blank"> έλεγχο ταυτότητας πολλών παραγόντων </a>; 
Αν εκτελέσετε αυτήν την ενέργεια, θα αποσυνδεθείτε αμέσως και θα χρειαστεί να κάνετε ξανά έλεγχο ταυτότητας χρησιμοποιώντας την εφαρμογή ελέγχου ταυτότητας την επόμενη φορά που θα συνδεθείτε.',
    'LBL_MFA_RESET_CONFIRMATION_BTN' => 'Επιβεβαίωση και αποσύνδεση',
    ...
    // sentiment
    'LBL_SENTIMENT_POSITIVE' => 'Θετικό',
    'LBL_SENTIMENT_NEUTRAL' => 'Ουδέτερο',
    'LBL_SENTIMENT_NEGATIVE' => 'Αρνητικό',

    // Console Metric Tabs
    'LBL_NO_METRIC_CONFIGURED' => 'Δεν Έχουν Ρυθμιστεί Καρτέλες Μέτρησης',
    'LBL_NO_METRIC_VISIBLE' => 'Δεν υπάρχουν ορατές καρτέλες μετρήσεων',
    'LBL_MAKE_METRIC_VISIBLE' => 'Επιλέξτε "οργάνωση" για να κάνετε ορατές τις καρτέλες μετρήσεων',
    'LBL_PLEASE_CONTACT_ADMIN' => 'Επικοινωνήστε με τον διαχειριστή σας',
    ...
    'LBL_DASHLET_FREEZE_FIRST_COLUMN' => 'Πάγωμα Πρώτης Στήλης',
    ...
    'LBL_RESTORE_DEFAULT_DASHLETS' => 'Επαναφορά προεπιλεγμένων ταμπλό',
    'LBL_NO_DASHBOARD_CONFIGURED' => 'Δεν Διαμορφώθηκε Πίνακας Στοιχείων',
    'LBL_CREATE_DASHBOARD_LINK' => 'Δημιουργία Πίνακα Στοιχείων',
    ...
    'LBL_DASHLET_ITERACTIONS_NAME' => 'Χρονολόγιο',
    ...
    'LBL_LEARNING_RESOURCES_SUGAR_OUTFITTERS_LINK' => 'Αγορά SugarOutfitters',
    ...
    'LBL_PLURAL_LABEL' => 'Πολλαπλή Ετικέτα',
    'LBL_MODULE_DISPLAY' => 'Εμφάνιση',
    'LBL_MODULE_DISPLAY_TYPE' => 'Τύπος Εμφάνισης',
    'LBL_MODULE_ICON' => 'Εικονίδιο',
    'LBL_MODULE_COLOR' => 'Χρώμα Φόντου Ενότητας',
    'LBL_LANGUAGE_SELECTOR' => 'Γλώσσα',
    'LBL_MODULE_NAMES_AND_ICONS_SETTINGS' => 'Ρυθμίσεις Ενότητας',
    'LBL_MODULE_NAMES_AND_ICONS_SETTINGS_SAVED' => 'Οι ρυθμίσεις ενότητας έχουν αποθηκευτεί.',
    ...
    'LBL_FILE_UPLOAD_TO_EXTERNAL_API' => 'Μεταφόρτωση σε εξωτερική πηγή',
    'LBL_FILE_LINK_FROM_EXTERNAL_API' => 'Σύνδεσμος από εξωτερική πηγή',
    ...
    'LBL_ADD_BUTTON_LABEL' => 'Προσθήκη',
    'LBL_EDIT_BUTTON_TITLE' => 'Επεξεργασία',
    'LBL_REFRESH_BUTTON_LABEL' => 'Ανανέωση',
    'LBL_REFRESH_BUTTON_TITLE' => 'Ανανέωση',
    'LBL_DUPLICATE_BUTTON_KEY' => 'u',
    'LBL_DUPLICATE_BUTTON_LABEL' => 'Αντίγραφο',
    'LBL_DUPLICATE_BUTTON_TITLE' => 'Αντίγραφο',
    'LBL_REPORT_SCHEDULES_BUTTON_LABEL' => 'Χρονοδιαγράμματα Αναφοράς',
    'LBL_REPORT_SCHEDULES_BUTTON_TITLE' => 'Χρονοδιαγράμματα Αναφοράς',
    'LBL_REPORT_DETAILS_BUTTON_LABEL' => 'Λεπτομέρειες Αναφοράς',
    'LBL_REPORT_DETAILS_BUTTON_TITLE' => 'Λεπτομέρειες Αναφοράς',
    ...
    'LBL_ESCALATE_BUTTON_LABEL' => 'Κλιμάκωση',
    ...
    'LBL_LAST_COMMIT' => 'Τελευταία Δέσμευση: ',
    ...
    'LBL_TIMEZONE_UPDATED' => 'Το Sugar έχει ενημερώσει τη ζώνη ώρας του προφίλ χρήστη σας, ώστε να ταιριάζει με τη ζώνη ώρας του προγράμματος περιήγησής σας',
    ...
    'TPL_MERGE_DUPLICATES_PROGRESS_STATUS' => 'Συγχωνευμένες: {{percent}}%',
    ...
    'LBL_UPLOADING_DOTS' => 'Μεταφόρτωση...',
    ...
    'LBL_THEME_PREVIEW' => 'Προεπισκόπηση θέματος πύλης',
    ...
    'LBL_YES' => 'Ναι',
    'LBL_NO' => 'Όχι',
    'LBL_SHOW_NUMBERING' => 'Εμφάνιση αρίθμησης σταδίων',
    'LBL_HIDE_NUMBERING' => 'Απόκρυψη αρίθμησης σταδίων',
    ...
    'LBL_ESCALATIONS' => 'Κλιμακώσεις',
    'LBL_ESCALATED' => 'Κλιμακώθηκε',
    'LBL_ESCALATIONS_SUBPANEL_TITLE' => 'Κλιμακώσεις',
    'LBL_OTHER_ESCALATIONS_SUBPANEL_TITLE' => 'Άλλες Σχετιζόμενες Κλιμακώσεις',
    'LBL_ESCALATIONS' => 'Κλιμακώσεις',
    ...
    'ERR_OFFLINE_CLEAN_UP_CONFIRMATION' => 'Έχετε εξαντλήσει τον χώρο για αποθήκευση offline. Συνιστάται εκκαθάριση του αποθηκευτικού χώρου. Μπορεί να διαρκέσει αρκετά λεπτά.',
    ...
    'LBL_ERR_EXPORTING_CSV' => 'Η εξαγωγή απέτυχε',
    'LBL_ERR_EXPORT_ALL' => 'Αποτυχία λήψης δεδομένων για επιλεγμένες εγγραφές, δοκιμάστε ξανά',
    'LBL_LIST_SETTINGS_RESTORE' => 'Επαναφέρετε τις προεπιλογές',
    'LBL_LIST_SETTINGS_RESTORE_CONFIRM' => 'Επαναφορά πεδίων;',
    'LBL_LIST_SETTINGS_TITLE' => 'Εργαλείο δημιουργίας προβολής λίστας',
    'LBL_LIST_SETTINGS_TEXT_TITLE' => 'Διαθέσιμα Πεδία',
    'LBL_LIST_SETTINGS_REMOVE' => 'Αφαίρεση',
    'LBL_LIST_SETTINGS_TEXT' => 'Σύρετε πεδία στο εργαλείο δημιουργίας προβολής λίστας και αναδιατάξτε τα εκ νέου για να σχεδιάσετε την προβολή λίστας {{moduleName}}.',
    'LBL_LIST_SETTINGS_ERROR_EMPTY' => 'Τουλάχιστον ένα πεδίο πρέπει να προστεθεί στη διάταξη.',
    'LBL_LIST_SETTINGS_EMPTY' => 'Δεν υπάρχουν διαθέσιμα πεδία',
    'LBL_LIST_SETTINGS_NO_MATCHING' => 'Δεν βρέθηκαν πεδία που να ταιριάζουν',
    'LBL_LIST_FILTER' => 'Αναζήτηση πεδίου',
    'LBL_MOBILE_APP_EMAIL_CLIENT' => 'Πελάτη email',
    'LBL_DEFAULT_SYSTEM_CLIENT' => 'Εξωτερικός πελάτης email',
    'LBL_SUGAR_MOBILE_CLIENT' => 'Πελάτης email Sugar',
    'LBL_OFFLINE_CAPABILITIES' => 'Ενεργοποίηση δυνατοτήτων εκτός σύνδεσης',
    'LBL_OFFLINE_TRANSACTION_DELETE_ERROR' => 'Η διαγραφή της συναλλαγής απέτυχε.',
    'LBL_OFFLINE_TRANSACTION_DELETED' => 'Η συναλλαγή διαγράφηκε.',
    'LBL_SECURE_MODE' => 'Ενισχυμένη λειτουργία ασφαλείας',
    'LBL_SECURE_MODE_ANDROID_TEXT' => 'Ενεργοποιήστε αυτήν τη ρύθμιση για να αποκρύψετε τα περιεχόμενα του Sugar Mobile όταν η εφαρμογή βρίσκεται στο παρασκήνιο και να αποτρέψετε την λήψη στιγμιοτύπων οθόνης της εφαρμογής οποιαδήποτε στιγμή.',
    'LBL_SECURE_MODE_IOS_TEXT' => 'Ενεργοποιήστε αυτήν τη ρύθμιση για να αποκρύψετε τα περιεχόμενα του Sugar Mobile όταν η εφαρμογή βρίσκεται στο παρασκήνιο.',
    'LBL_ALWAYS_OFFLINE_MODE' => 'Λειτουργία πάντα εκτός σύνδεσης',
    'LBL_ALWAYS_OFFLINE_MODE_ENABLED_PROMPT' => 'Εργάζεστε σε λειτουργία Πάντα εκτός σύνδεσης. Θέλετε να επανασυνδεθείτε;',
    'LBL_RECONNECT' => 'Επανασύνδεση',
    'LBL_STAY_OFFLINE' => 'Μείνετε Εκτός σύνδεσης',
    'ERR_MOBILE_MODULE_NOT_SUPPORTED' => 'Η ενότητα στην οποία προσπαθείτε να αποκτήσετε πρόσβαση δεν είναι διαθέσιμη στο Sugar Mobile.',
    'LBL_MOBILE_RELEASE_NOTE' => 'Σημειώσεις έκδοσης Sugar Mobile για {{platform}}',
    'LBL_MOBILE_USER_GUIDE' => 'Εγχειρίδιο χρήσης Sugar Mobile για {{platform}}',
    ...
    'LBL_NOTIFICATIONS_CHANNEL' => 'Ενημερώσεις',
    'LBL_APPLY_BUTTON_LABEL' => 'Υποβολή',
    'LBL_ACTION_CREATE_FAILURE' => "Αποτυχία αποθήκευσης της εγγραφής:\n {{{reason}}}",
    'LBL_ACTION_UPDATE_FAILURE' => "Αποτυχία ενημέρωσης της εγγραφής:\n {{{reason}}}",
    'LBL_ACTION_FIELD_CALC_ERROR' => 'Αποτυχία επίλυσης υπολογισμών πεδίων στον διακομιστή.',
    'LBL_ACTION_MODEL_VALIDATION_ERROR' => 'Τα ακόλουθα πεδία δεν είναι έγκυρα: {{{fields}}}.',
    'LBL_ACTION_CREATE_RECORD_SUCCESS' => '<b>Επιτυχία.</b> Δημιουργήσατε με επιτυχία το {{{module}}} <a href="#{{{recordUrl}}}">"{{{recordName}}}".</a>',
    'LBL_ACTION_UPDATE_SUCCESS' => '<b>Επιτυχία.</b> Ενημερώσατε επιτυχώς την εγγραφή',
    'LBL_ACTION_COMPOSE_FAILED_DATA_FETCH' => 'Αποτυχία λήψης δεδομένων email από τον διακομιστή.',
    'LBL_ASSIGN_SUCCESS' => '<b>Επιτυχία.</b> Η εγγραφή έχει εκχωρηθεί σε {{{userName}}}',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_TITLE' => 'Αποθήκευση αυτού του email ως προσχέδιο;',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_CONFIRM' => 'Αποθηκεύσετε ως πρόχειρο',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_CANCEL' => 'Discard email',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_MSG' => 'Εάν δεν αποθηκεύσετε το πρόχειρο, θα χάσετε αυτό το email.',
    'LBL_MOBILE_EMAIL_CHOOSE_SIGNATURE' => 'Επιλέξτε Υπογραφή',
    'LBL_MOBILE_EMAIL_CHOOSE_TEMPLATE' => 'Επιλέξτε Πρότυπο email',
    'LBL_MOBILE_EMAIL_CONFIRM_TEMPLATE' => 'Το πρότυπο θα αντικαταστήσει όλα τα περιεχόμενα σε αυτό το email. Είστε βέβαιοι ότι θέλετε να χρησιμοποιήσετε αυτό το πρότυπο και να αντικαταστήσετε το περιεχόμενο;',
    'LBL_MOBILE_EMAIL_COMPOSE' => 'Σύνταξη Email',
    'LBL_MOBILE_EMAIL_NO_RELATED_TO_WITH_TEMPLATE_SEND_ANYWAYS' => 'Το email σας περιέχει μεταβλητές που θα αντικατασταθούν χρησιμοποιώντας τιμές από την εγγραφή Σχετίζεται με. Επιβεβαιώστε ότι το πεδίο Σχετίζεται με έχει ρυθμιστεί σωστά πριν από την αποστολή.',
    'LBL_ERR_NO_OUTBOUND_ACCOUNTS_AVAILABLE' => 'Δεν βρέθηκε λογαριασμός εξερχόμενων email. Επικοινωνήστε με τον διαχειριστή του Sugar.',
    'LBL_EMAIL_MORE_RECIPIENTS' => ' και επιπλέον {{{count}}}',
    'LBL_RECEPIENTS_EMAIL_ADD' => 'Προσθέστε ένα email',
    'LBL_EMAIL_RECIPIENTS_EMPTY_HINT' => 'Πληκτρολογήστε ένα όνομα επαφής ή ένα email',
    'LBL_EMAIL_RECIPIENT_NEW_EMAIL' => '{{{email}}} (Νέο Email)',
    'LBL_TEMPLATE_HAS_VARIABLES' => 'Μεταβλητές',
    'LBL_FILTER_EMAIL_TYPE_TEMPLATES' => 'Πρότυπα Email',
    'LBL_FILTER_CAMPAIGN_TYPE_TEMPLATES' => 'Πρότυπα Καμπάνιας',
    'LBL_FILTER_WORKFLOW_TYPE_TEMPLATES' => 'Πρότυπα Ροής εργασίας',
    'LBL_FILTER_SYSTEM_TYPE_TEMPLATES' => 'Πρότυπα Συστήματος',
    'LBL_FILTER_EDIT' => 'Επεξεργασία Φίλτρων',
    'LBL_FILTER_MY_FILTER' => 'Το φίλτρο μου',
    'LBL_FILTER_MY_FILTER_BY' => 'Το φίλτρο μου από {{{filters}}}',
    'LBL_FILTER_SAVE' => 'Αποθήκευση φίλτρου',
    'LBL_SELECT_PARAM' => 'Επιλογή',
    'LBL_SELECT_MODULES' => 'Επιλογέας ενότητας',
    'LBL_SELECT_ADDITIONAL_PARAMS' => 'Επιλέξτε Πρόσθετη Παράμετρος',
    'LBL_FILTER_TEMPORARY' => 'Προσωρινό φίλτρο',
    'LBL_ERROR_FILE_UPLOAD' => 'Αποτυχία μεταφόρτωσης του {{{fieldLabel}}} αρχείου "{{{fileName}}}". {{{reason}}}',
    'LBL_ERROR_EDIT_FAILED_UPLOAD' => '<br/><a href="#{{{recordUrl}}}">Προβολή αποτυχημένης εγγραφής</a>',
    'LBL_FILE_UPLOAD_ONE' => 'Αποθήκευση αρχείου...',
    'LBL_FILE_UPLOAD_MANY' => 'Αποθήκευση αρχείου {{{index}}} από {{{total}}}...',
    'LNK_NOTIFICATIONS_SETTINGS' => 'Ρυθμίσεις Ειδοποίησης',
    'LBL_PUSH_NOTIFICATIONS_SETTINGS' => 'Διαχειριστείτε τις ειδοποιήσεις push σας',
    'LBL_PUSH_NOTIFICATIONS_SETTINGS_FOOTER' => "Ελέγξτε τον τρόπο εμφάνισης των ειδοποιήσεων χρησιμοποιώντας τις ρυθμίσεις ειδοποιήσεων της συσκευής σας.",
    'LBL_NOTIFICATION_ASSIGMENTS' => 'Αναθέσεις',
    'LBL_NOTIFICATION_ASSIGMENTS_DSC' => 'Λάβετε ειδοποιήσεις όταν σας εκχωρούνται αρχεία.',
    'LBL_NOTIFICATION_MENTIONS' => 'Αναφορές',
    'LBL_NOTIFICATION_MENTIONS_DSC' => 'Λάβετε ειδοποιήσεις όταν αναφέρεστε σε καταχωρήσεις αρχείου καταγραφής σχολίων.',
    'LBL_NOTIFICATIONS_COMMENTLOG_MISSING' => 'Το πεδίο Αρχείο καταγραφής σχολίων δεν έχει προστεθεί σε αυτήν τη διάταξη από διαχειριστή. Επικοινωνήστε με τον διαχειριστή Sugar σας.',
    'ERR_NO_PERMISSION_TITLE' => 'Παρακαλώ επιτρέψτε την πρόσβαση',
    'ERR_NO_CAMERA_PERMISSION_MSG' => 'Το {{{brandName}}} χρειάζεται πρόσβαση στην κάμερα για να μπορείτε να επισυνάψετε φωτογραφίες. Παρακαλώ επιτρέψτε την πρόσβαση της κάμερας στις ρυθμίσεις συστήματος.',
    'LBL_MOBILE_SYSTEM_SETTINGS' => 'Ρυθμίσεις',
    'LBL_ACTIVE_SUBSCRIPTIONS_FIELD_DURATION' => 'Διάρκεια',
    'LBL_ACTIVE_SUBSCRIPTIONS_FIELD_TIMEREMAINING' => 'Χρόνος που απομένει',
    'LBL_LIST_SUPPORT_EXPIRES' => 'Λήγει',
    'LBL_CASCADE_RLI_EDIT' => 'Ενημέρωση Στοιχείων Ανοιχτής Γραμμής Εσόδων',
    'LBL_MOBILE_CALENDAR' => 'Ημερολόγιο',
    'LBL_MOBILE_CALENDAR_SETTINGS' => 'Ρυθμίσεις ημερολογίου',
    'LBL_MOBILE_CALENDAR_WEEK_START' => 'Ημέρα έναρξης εβδομάδας',
    'LBL_MOBILE_CALENDAR_MODULES' => 'Συμβάντα προς εμφάνιση',
    'LBL_MOBILE_CALENDAR_DURATION_HR_MIN' => '{{{hours}}}ω:{{{minutes}}} λεπτά',
    'LBL_MOBILE_CALENDAR_DURATION_HR' => '{{{hours}}} ώρες',
    'LBL_MOBILE_CALENDAR_DURATION_MIN' => '{{{minutes}}} Λεπτά',
    'LBL_MOBILE_CALENDAR_TODAY' => 'Σήμερα',
    'LBL_MOBILE_CALENDAR_CREATE_MSG' => 'Προσθήκη {{{moduleName}}}',
    'LBL_MOBILE_CALENDAR_CREATE_TITLE' => 'Προγραμματίστε μια δραστηριότητα',
    'LBL_MOBILE_CALENDAR_ERROR_NO_MODULE' => 'Ενεργοποιήστε τουλάχιστον έναν τύπο συμβάντος.',
    'LBL_MOBILE_CALENDAR_EVENT_ALL_DAY' => 'Ολοήμερο',
    'LBL_MOBILE_CALENDAR_INITIALIZATION_ERROR' => 'Απέτυχε η φόρτωση των Ημερολογίων.',
    'LBL_ACTIONBUTTON_NOT_SUPPORTED_ACTION' => 'Αυτή η ενέργεια δεν είναι διαθέσιμη στο Sugar Mobile. Θέλετε να ανοίξετε την εφαρμογή επιφάνειας εργασίας αντ&#39;αυτού;',
    'LBL_DOC_MERGES_SELECT_TEMPLATE' => 'Επιλέξτε Πρότυπο',
    'LBL_DOC_MERGES_ACTION_MERGE' => 'Συγχώνευση',
    'LBL_ERROR_IMAGE_NO_EXIF' => 'Σφάλμα: λείπουν δεδομένα EXIF από το αρχείο HEIC',
    'LBL_ERROR_IMAGE_TOO_BIG' => 'Σφάλμα: πολύ υψηλή ανάλυση εικόνας',
    'LBL_ERROR_IMAGE_CANNOT_PROCESS' => 'Σφάλμα: δεν είναι δυνατή η επεξεργασία της εικόνας',
    'LBL_ERROR_IMAGE_CANVAS_FAILED' => 'Σφάλμα: απέτυχε η απόδοση της εικόνας στον καμβά',
    'LBL_ERROR_IMAGE_LOAD_FAILED' => 'Σφάλμα: Απέτυχε η φόρτωση του αρχείου ως εικόνα',
    'LBL_ACTIONS_SELECTION_COUNT_SINGLE' => 'Επιλέχθηκε 1 στοιχείο',
    'LBL_ACTIONS_SELECTION_COUNT_MULTIPLE' => '{{{count}}} Επιλεγμένα αντικείμενα',
    'LBL_ACTIONS_SELECT_ALL_TITLE' => 'Επιλογή όλων',
    'LBL_ACTIONS_SELECT_ALL_HEADER' => 'Έχετε επιλέξει {{{count}}} εγγραφές σε αυτήν την προβολή. Επιλογή όλων των εγγραφών;',
    'LBL_ACTIONS_SELECT_ALL_VISIBLE' => 'Επιλέξτε {{{count}}} εγγραφές',
    'LBL_ACTIONS_SELECT_DELETE_CONFIRM' => 'Είστε βέβαιοι ότι θέλετε να διαγράψετε τις επιλεγμένες εγγραφές;',
    'LBL_ACTIONS_MASS_DELETE_PROGRESS' => 'Διαγραφή… {{{count}}} από {{{total}}}',
    'LBL_ACTIONS_MASS_EMAIL_EMPTY' => 'Δεν βρέθηκε έγκυρο email στις επιλεγμένες εγγραφές',

    // Dark mode related
    'LBL_MOBILE_APP_THEME' => 'Εμφάνιση',
    'LBL_MOBILE_APP_THEME_SYSTEM' => 'Χρησιμοποιήστε τη ρύθμιση συστήματος',
    'LBL_MOBILE_APP_THEME_LIGHT' => 'Ανοιχτόχρωμη',
    'LBL_MOBILE_APP_THEME_DARK' => 'Σκουρόχρωμη',
    // Attachments related
    'LBL_ATTACHMENT_RENAME_TITLE' => 'Νέο όνομα αρχείου',
    'LBL_ATTACHMENT_RENAME_MSG' => 'Μετονομάστε το αρχείο',
    // Filters related
    'LBL_CREATED_BY_ME' => 'Δημιουργήθηκε από εμένα',
    'LBL_OPERATOR_ONE_OF' => 'είναι ένα από',
    'LBL_OPERATOR_NOT_ONE_OF' => 'δεν είναι ένα από',
    'LBL_OPERATOR_CONTAINS' => 'είναι οποιοδήποτε από',
    'LBL_OPERATOR_CONTAINS_WORD' => 'περιέχει',
    'LBL_OPERATOR_NOT_CONTAINS' => 'δεν είναι κάποιο από',
    'LBL_OPERATOR_EMPTY' => 'είναι άδειο',
    'LBL_OPERATOR_NOT_EMPTY' => 'δεν είναι άδειο',
    ...
    'LBL_OPERATOR_MORE_X_DAYS_AGO' => 'Πριν από περισσότερες από __ ημέρες',
    'LBL_OPERATOR_LAST_X_DAYS' => 'Τελευταίες __ ημέρες',
    'LBL_OPERATOR_NEXT_X_DAYS' => 'Επόμενες __ ημέρες',
    'LBL_OPERATOR_MORE_X_DAYS_AHEAD' => 'Περισσότερες από __ ημέρες στο μέλλον',
    ...
    'LBL_OPERATOR_AFTER_TODAY' => 'μετά από σήμερα',
    'LBL_OPERATOR_BEFORE_TODAY' => 'πριν από σήμερα',
    ...
    'LBL_NO_OPTIONS' => 'Δεν υπάρχουν διαθέσιμες επιλογές',
    ...
    'LBL_PORTAL_NEW_NOTE_TITLE' => 'Δημιουργία Σημείωσης ή Προσθήκη Επισύναψης',
    'LBL_PORTAL_NEW_NOTE_BTN' => 'Προσθήκη μιας Σημείωσης',
    ...
    'LBL_PORTAL_INVALID_GRANT' => 'Η συνεδρία σας έχει λήξει. Παρακαλώ συνδεθείτε ξανά.',
    'LBL_PORTAL_INVALID_GRANT_TITLE' => 'Η Συνεδρία Έληξε',
    ...
    'LBL_OMNICHANNEL_LINK_RECORD' => 'Σύνδεσμος προς {{module}}',
    ...
    'LBL_OMNICHANNEL_COMPACT_VIEW' => 'Συμπαγής προβολή',
    'LBL_OMNICHANNEL_FULL_VIEW' => 'Πλήρη προβολή',

    //14.0 Dashboards
    'LBL_BRD__CONSOLE' => 'Πίνακας εργαλείων BDR',
    'LBL_SALES_MANAGER_CONSOLE' => 'Πίνακας εργαλείων διευθυντή πωλήσεων',
    'LBL_SALES_REP_CONSOLE' => 'Πίνακας εργαλείων πωλητή',
    'LBL_MARKETING_CONSOLE' => 'Πίνακας εργαλείων μάρκετινγκ',
    'LBL_CUSTOMER_SUCCESS_CONSOLE' => 'Πίνακας εργαλείων επιτυχίας πελατών',
    'LBL_EXECUTIVE_CONSOLE' => 'Πίνακας εργαλείων στελεχών',
    ...
    'LBL_CHANGE_YOUR_PASSWORD' => 'Αλλάξτε τον κωδικό πρόσβασής σας',
    'LBL_PASSWORD_REQUIREMENTS' => 'Απαιτήσεις κωδικού πρόσβασης',
    ...
    'LBL_PASSWORD_CHANGED' => 'Αλλάξατε επιτυχώς τον κωδικό πρόσβασής σας',
    ...
    'LBL_NO_CHART_REPORT_AVAILABLE' => 'Δεν υπάρχει διαθέσιμο γράφημα.',
    'LBL_NO_FILTERS_REPORT_AVAILABLE' => 'Αυτή η αναφορά δεν περιέχει φίλτρα.',
    'LBL_NO_RUNTIME_FILTERS_REPORT_AVAILABLE' => 'Μόνο φίλτρα χρόνου εκτέλεσης έχετε κρυφά, ανατρέξτε στα σύνθετα φίλτρα.',
    'LBL_RUNTIME_FILTERS' => 'Φίλτρα χρόνου εκτέλεσης',
    'LBL_RUNTIME_FILTER_DATE_PREF_MISSMATCH' => 'Η ημερομηνία δεν αντιστοιχεί στην προτιμώμενη μορφή ημερομηνίας του χρήστη: ',
    'LBL_DASHLET_NO_RUNTIME_FILTERS' => 'Αυτό το πινακάκι δεν έχει φίλτρα χρόνου εκτέλεσης',
    'LBL_DASHBOARD_FILTER_GROUP' => 'Νέο φίλτρο',
    'LBL_RUNTIME_FILTER_LIMITATION' => 'Πρέπει να επιλέξετε τουλάχιστον μία τιμή.',
    'LBL_RESET_FILTERS_TO_DEFAULT' => 'Επαναφορά στα Προεπιλεγμένα Φίλτρα',
    'LBL_COPY_FILTER_SUMMARY' => 'Σύνοψη Φίλτρου Αντιγραφής',
    'LBL_APPLY_FILTERS' => 'Υποβολή',
    'LBL_REPORTS_FILTERS' => 'Φίλτρα',
    'LBL_RUNTIME_FILTERS_INVALID' => 'Δεν είναι δυνατή η εφαρμογή φίλτρων χρόνου εκτέλεσης λόγω μη έγκυρων τιμών',
    'LBL_RUNTIME_FILTERS_COPIED' => 'Η σύνοψη του φίλτρου έχει αντιγραφεί στο πρόχειρό σας.',
    'LBL_ADVANCED_FILTERS' => 'Προηγμένα Φίλτρα',
    'LBL_ADVANCED_OR_DESC' => 'Συμπεριλάβετε όταν ικανοποιείται ΟΠΟΙΑΔΗΠΟΤΕ προϋπόθεση',
    'LBL_ADVANCED_AND_DESC' => 'Συμπεριλάβετε όταν πληρούνται ΟΛΕΣ οι προϋποθέσεις',
    'LBL_ORIGINAL_DESIGN_FILTER' => 'Αυτό είναι ένα πρωτότυπο φίλτρο σχεδίασης',
    'LBL_AND_UPPERCASE' => 'ΚΑΙ',
    'LBL_REPORTS_PREVIEW_LIMITATION' => 'Αυτή η δυνατότητα δεν είναι διαθέσιμη στη Λειτουργία Προεπισκόπησης',
    'LBL_REPORT_DEFAULT_NAME' => 'Έκθεση χωρίς τίτλο',
    'LBL_REPORT_QUERY' => 'Ερώτημα',
    'LBL_REPORTS_DASHLET_INTELLIGENT' => 'Σχετίζεται με την τρέχουσα εγγραφή',
    'LBL_REPORTS_DASHLET_RELATED_LINK' => 'Συνδεδεμένο πεδίο',
    'LBL_REPORTS_DASHLET_INVALID_LINK' => 'Το συνδεδεμένο πεδίο δεν μπορεί να είναι κενό',
    'LBL_REPORTS_DASHLET_INVALID_REPORT' => 'Δεν επιλέχθηκε αναφορά.',
    'LBL_REPORTS_DASHLET_LINE_CHART_INVALID' => 'Το γράφημα γραμμών δεν είναι συμβατό με αυτήν την αναφορά',
    'LBL_REPORT_DASHLET' => 'Πίνακας Στοιχείων Αναφοράς',
    'LBL_REPORTS_DASHLET_DATATABLE' => 'Πίνακας Δεδομένων',
    'LBL_REPORTS_DASHLET_RUNTIME_FILTERS' => 'Φίλτρα χρόνου εκτέλεσης',
    'LBL_REPORTS_DASHLET_DATATABLE_PREVIEW' => 'Προεπισκόπηση Πίνακα Δεδομένων',
    'LBL_REPORTS_DASHLET_CHART' => 'Γράφημα',
    'LBL_REPORTS_DASHLET_CHART_PREVIEW' => 'Προεπισκόπηση Γραφήματος',
    'LBL_REPORTS_DASHLET_FILTER_PREVIEW' => 'Προεπισκόπηση Φίλτρου',
    'LBL_REPORTS_DASHLET_INVALID_FEATURE' => 'Η επιλεγμένη αναφορά δεν υποστηρίζει ένα γράφημα.',
    'LBL_REPORTS_DASHLET_LABELS' => 'Ετικέτες',
    'LBL_REPORTS_DASHLET_SHOW_COUNT' => 'Εμφάνιση συνολικού αριθμού εγγραφών',
    'LBL_REPORTS_DASHLET_SORT_ORDER' => 'Σειρά ταξινόμησης',
    'LBL_REPORTS_DASHLET_DEFAULT_VIEW' => 'Προεπιλεγμένη επιλογή προβολής',
    'LBL_REPORTS_DASHLET_PRIMARY_CHART_SORT' => 'Πρωτεύουσα Σειρά Ταξινόμησης Γραφήματος',
    'LBL_REPORTS_DASHLET_SECONDARY_CHART_SORT' => 'Δευτερεύουσα Σειρά Ταξινόμησης Γραφήματος',
    'LBL_REPORTS_DASHLET_NO_LINKS_SELECTED' => 'Δεν υάρχουν σύνδεσμοι {{module}} στην επιλεγμένη αναφορά',
    'LBL_REPORTS_DASHLET_NO_AVAILABLE_FOR_REPORT_TYPE' => 'Δεν είναι διαθέσιμο για αυτόν τον τύπο αναφοράς',
    'LBL_REPORTS_DASHLET_UNABLE_TO_DOWNLOAD_CHART_TAB' => 'Αυτή η λειτουργία είναι διαθέσιμη μόνο στην καρτέλα γραφήματος',
    'LBL_REPORTS_CHART_TYPE' => 'Τύπος Γραφήματος',
    'LBL_REPORTS_CHART_CONFIG_VALUE_PLACEMENT' => 'Τοποθέτηση τιμών γραφήματος ράβδων',
    'LBL_REPORTS_CHART_CONFIG_SHOW_TOTAL' => 'Εμφάνιση συνόλου',
    'LBL_REPORTS_CHART_LEGEND_OPEN' => 'Εμφάνιση υπομνήματος',
    'LBL_REPORTS_CHART_CONFIG_SHOW_XAXIS_LABEL' => 'Εμφάνιση x-axis ετικέτας',
    'LBL_REPORTS_CHART_CONFIG_SHOW_YAXIS_LABEL' => 'Εμφάνιση y-axis ετικέτας',
    'LBL_REPORTS_DASHLET_CONFIGURE_DISPLAY_ROWS' => 'Όριο εμφάνισης γραμμών',
    'LBL_REPORTS_DASHLET_RUNTIME_NO_PERMISSONS' => 'Δεν έχετε δικαίωμα χρήσης αυτών των φίλτρων χρόνου εκτέλεσης.',
    ...
    'LBL_WORST' => 'Χειρότερη',
    'LBL_LIKELY' => 'Πιθανή',
    'LBL_BEST_FORECAST' => 'Δέσμευση (Καλύτερη)',
    'LBL_WORST_FORECAST' => 'Δέσμευση (Χειρότερη)',
    'LBL_LIKELY_FORECAST' => 'Δέσμευση (Πιθανή)',
    'LBL_BEST_ADJUSTED' => 'Προσαρμοσμένη δέσμευση (Καλύτερη)',
    'LBL_WORST_ADJUSTED' => 'Προσαρμοσμένη Δέσμευση (Χειρότερη)',
    'LBL_LIKELY_ADJUSTED' => 'Προσαρμοσμένη δέσμευση (Πιθανή)',
    ...
    'LBL_NEED_HELP' => 'Χρειάζεστε βοήθεια με κάτι νέο;',
    'LBL_NEW_CASE' => 'Νέα Υπόθεση',
...
2. Κάντε κλικ στην επιλογή "Αποθήκευση" για να οριστικοποιήσετε τη νέα εγγραφή και να επιστρέψετε στην απεικόνιση καταλόγου {{plural_module_name}}.',
    ...
    'LBL_CALENDAR_REPEAT_ON' => 'Επαναλάβετε στις',
    ...
    'TPL_REPEAT_INTERVAL' => 'Κάθε {{repeatIntervalValue}} {{repeatTypeValue}}',
    'LBL_UNSUPPORTED_RRULE' => 'Αυτή η σειρά χρησιμοποιεί μια επιλογή Επαναλάβετε στις που δεν είναι διαθέσιμη στο Sugar, επειδή η σειρά συγχρονίστηκε από πρόγραμμα-πελάτη ημερολογίου. Επεξεργαστείτε αυτή τη σειρά στο πρόγραμμα-πελάτη ημερολογίου σας εάν θέλετε να συνεχίσει η επανάληψη σε μια συγκεκριμένη ημερομηνία. Η επεξεργασία αυτής της σειράς στο Sugar θα ρυθμίσει την επιλογή Επαναλάβετε στις σε Καμία.<br><br>Θέλετε να συνεχίσετε;',
    ...
    'LBL_CALENDAR_DASHLET_NAME' => 'Προγραμματιστής ημερολογίου',
    'LBL_CALENDAR_DEFAULT_VIEW' => 'Προεπιλεγμένη Προβολή',
    'LBL_CALENDAR_MY_CALENDARS' => 'Τα Ημερολόγια μου',
    'LBL_CALENDAR_OTHER_CALENDARS' => 'Ημερολόγια Χρήστη και Ομάδας',
    'LBL_CALENDAR' => 'Ημερολόγιο',

    'LBL_CALENDAR_DAY' => 'ημέρα',
    'LBL_CALENDAR_WEEK' => 'εβδομάδα',
    'LBL_CALENDAR_MONTH' => 'μήνας',
    'LBL_CALENDAR_YEAR' => 'έτος',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_2'  => '2η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_3'  => '3η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_4'  => '4η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_5'  => '5η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_6'  => '6η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_7'  => '7η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_8'  => '8η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_9'  => '9η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_10' => '10η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_11' => '11η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_12' => '12η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_13' => '13η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_14' => '14η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_15' => '15η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_16' => '16η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_17' => '17η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_18' => '18η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_19' => '19η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_20' => '20ή',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_21' => '21η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_22' => '22η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_23' => '23η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_24' => '24η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_25' => '25η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_26' => '26η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_27' => '27η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_28' => '28η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_29' => '29η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_30' => '30η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_31' => '31η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_32' => '32η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_33' => '33η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_34' => '34η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_35' => '35η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_36' => '36η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_37' => '37η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_38' => '38η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_39' => '39η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_40' => '40ή',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_41' => '41η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_42' => '42η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_43' => '43η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_44' => '44η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_45' => '45η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_46' => '46η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_47' => '47η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_48' => '48η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_49' => '49η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_50' => '50ή',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_51' => '51η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_52' => '52η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_53' => '53η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_54' => '54η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_55' => '55η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_56' => '56η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_57' => '57η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_58' => '58η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_59' => '59η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_60' => '60ή',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_61' => '61η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_62' => '62η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_63' => '63η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_64' => '64η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_65' => '65η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_66' => '66η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_67' => '67η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_68' => '68η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_69' => '69η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_70' => '70ή',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_71' => '71η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_72' => '72η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_73' => '73η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_74' => '74η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_75' => '75η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_76' => '76η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_77' => '77η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_78' => '78η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_79' => '79η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_80' => '80ή',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_81' => '81η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_82' => '82η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_83' => '83η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_84' => '84η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_85' => '85η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_86' => '86η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_87' => '87η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_88' => '88η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_89' => '89η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_90' => '90ή',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_91' => '91η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_92' => '92η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_93' => '93η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_94' => '94η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_95' => '95η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_96' => '96η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_97' => '97η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_98' => '98η',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_99' => '99η',
    ...
    'LBL_ACTIVITY_TIMELINE_DASHLET' => 'Χρονολόγιο',
    'LBL_NO_ACTIVITY' => 'Καμία δραστηριότητα',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => '{{moduleSingular}} Χρονολόγιο',
    'LBL_ACTIVITY_TIMELINE_SHOW_MORE' => 'Περισσότερα',
    'LBL_ACTIVITY_TIMELINE_SHOW_LESS' => 'Λιγότερο',
    'LBL_ACTIVITY_TIMELINE_DASHLET_DESCRIPTION' => 'Η γραμμή χρόνου εμφανίζει τις σχετικές εγγραφές για την τρέχουσα εγγραφή και επιλεγμένες ενημερώσεις πεδίων στην πάροδο του χρόνου.',
    ...
    'LBL_MODULE_UNAVAILABLE' => 'Η ενότητα δεν διαθέτει άδεια.',
...
// Omnichannel
    ...
    'LBL_CLOSE_FOCUS_DRAWER' => 'Κλείστε το Συρτάρι Εστίασης',
    ...
    'LBL_ENUM_DISPLAY_LABEL' => 'Εμφάνιση Ετικέτας',

    'LBL_BLANK' => '-blank-',

    'LBL_OPEN_RECORD_VIEW' => 'Άνοιγμα προβολής εγγραφής',

    // actionbutton
    'LBL_ACTIONBUTTON_ADD' => 'Προσθήκη',
    'LBL_ACTIONBUTTON_HELP_NOT_AVAILABLE' => 'Η βοήθεια δεν είναι διαθέσιμη',
    'LBL_ACTIONBUTTON_FUNCTIONS' => 'Λειτουργίες',
    'LBL_ACTIONBUTTON_FIELDS' => 'Πεδία',
    'LBL_ACTIONBUTTON_SELECT_FIELD' => 'Επιλογή Πεδίου...',
    'LBL_ACTIONBUTTON_ROLLUP' => 'Συνάθροιση',
    'LBL_ACTIONBUTTON_RELATED' => 'Σχετικά',
    'LBL_ACTIONBUTTON_SAVE' => 'Αποθήκευση',
    'LBL_ACTIONBUTTON_CANCEL' => 'Ακύρωση',
    'LBL_ACTIONBUTTON_R_MODULE' => 'Συναφή ενότητα',
    'LBL_ACTIONBUTTON_R_FIELDS' => 'Σχετικά Πεδία',
    'LBL_ACTIONBUTTON_ROLL_MODULE' => 'Συνάθροιση ενότητας',
    'LBL_ACTIONBUTTON_ROLL_FIELDS' => 'Συνάθροιση ενοτήτων',
    'LBL_ACTIONBUTTON_ROLL_TYPE' => 'Λειτουργία συνάθροισης',
    'LBL_ACTIONBUTTON_MINIMUM' => 'Ελ.',
    'LBL_ACTIONBUTTON_MAXIMUM' => 'Μέγ.',
    'LBL_ACTIONBUTTON_AVERAGE' => 'Μέσος Όρος',
    'LBL_ACTIONBUTTON_SUM' => 'Σύνολο',
    'LBL_ACTIONBUTTON_ASSIGN_RECORD' => 'Εκχώρηση εγγραφής',
    'LBL_ACTIONBUTTON_COMPOSE_EMAIL' => 'Σύνταξη Email',
    'LBL_ACTIONBUTTON_CREATE_RECORD' => 'Δημιουργία Εγγραφής',
    'LBL_ACTIONBUTTON_DOCUMENT_MERGE' => 'Συγχώνευση εγγράφου',
    'LBL_ACTIONBUTTON_OPEN_URL' => 'Άνοιγμα Url',
    'LBL_ACTIONBUTTON_RUN_REPORT' => 'Εκτέλεση Αναφοράς',
    'LBL_ACTIONBUTTON_UPDATE_RECORD' => 'Ενημέρωση Εγγραφής',
    'LBL_ACTIONBUTTON_ACTION' => 'Ενέργεια',
    'LBL_ACTIONBUTTON_ASSIGN_TO' => 'Ανατέθηκε Σε',
    'LBL_ACTIONBUTTON_EMAIL_TO' => 'Email Σε',
    'LBL_ACTIONBUTTON_USE_PMSE' => 'Χρησιμοποιήστε το PMSE',
    'LBL_ACTIONBUTTON_TEMPLATE' => 'Πρότυπο',
    'LBL_ACTIONBUTTON_MODULE' => 'Ενότητα',
    'LBL_ACTIONBUTTON_DISPLAY_SETTINGS' => 'Ρυθμίσεις Οθόνης',
    'LBL_ACTIONBUTTON_BUTTON_TYPE' => 'Τύπος',
    'LBL_ACTIONBUTTON_DROPDOWN' => 'Αναπτυσσόμενο',
    'LBL_ACTIONBUTTON_BUTTON' => 'Κουμπί',
    'LBL_ACTIONBUTTON_BUTTON_GROUP' => 'Ομάδα κουμπιών',
    'LBL_ACTIONBUTTON_SHOW_FIELD_LABEL' => 'Εμφάνιση Ετικέτας στην Εγγραφή',
    'LBL_ACTIONBUTTON_SHOW_RECORD_HEADER' => 'Εμφάνιση στην Κεφαλίδα',
    'LBL_ACTIONBUTTON_HIDE_ON_EDIT' => 'Απόκρυψη στην Επεξεργασία',
    'LBL_ACTIONBUTTON_DISPLAY_ON_FOCUS_DASHBOARD' => 'Εμφάνιση στην κεφαλίδα του πίνακα εργαλείων Focus',
    'LBL_ACTIONBUTTON_DASHBOARD' => 'Πίνακας Εργαλείων',
    'LBL_ACTIONBUTTON_FOCUS_DASHBOARD_HEADER' => 'Κεφαλίδα πίνακα εργαλείων Focus',
    'LBL_ACTIONBUTTON_SIZE' => 'Μέγεθος',
    'LBL_ACTIONBUTTON_DEFAULT' => 'Προεπιλογή',
    'LBL_ACTIONBUTTON_SMALL' => 'Μικρή',
    'LBL_ACTIONBUTTON_LARGE' => 'Μεγάλη',
    'LBL_ACTIONBUTTON_CALCULATED' => 'Υπολογίστηκε',
    'LBL_ACTIONBUTTON_DOCUMENT_CONVERT' => 'Μετατροπή σε PDF',
    'LBL_ACTIONBUTTON_DOCUMENT_MERGE' => 'Συγχώνευση εγγράφου',
    'LBL_ACTIONBUTTON_URL' => 'Διεύθυνση URL',
    'LBL_ACTIONBUTTON_PREVIEW' => 'Προεπισκόπηση',
    'LBL_ACTIONBUTTON_PROPERTIES' => 'Ιδιότητες',
    'LBL_ACTIONBUTTON_LABEL_TITLE' => 'Ετικέτα',
    'LBL_ACTIONBUTTON_DESC' => 'Επεξήγηση εργαλείου',
    'LBL_ACTIONBUTTON_SHOW_LABEL' => 'Εμφάνιση ετικέτας',
    'LBL_ACTIONBUTTON_SHOW_ICON' => 'Εμφάνιση εικονιδίου',
    'LBL_ACTIONBUTTON_SCHEME' => 'Σχέδιο χρωμάτων',
    'LBL_ACTIONBUTTON_ICON' => 'Εικονίδιο',
    'LBL_ACTIONBUTTON_IS_DEPENDENT' => 'Εξαρτώμενο',
    'LBL_ACTIONBUTTON_DESIGN' => 'Διαμόρφωση Διάταξης',
    'LBL_ACTIONBUTTON_STOP_ON_ERROR' => 'Διακοπή σε Σφάλμα',
    'LBL_ACTIONBUTTON_AUTOSAVE' => 'Αυτόματη αποθήκευση',
    'LBL_ACTIONBUTTON_CONFIG' => 'Διαμόρφωση',
    'LBL_ACTIONBUTTON_CONFIG_ERROR' => 'Διαμορφώστε το ActionButton σας πριν από την αποθήκευση.',
    'LBL_ACTIONBUTTON_CONFIG_BTN' => 'Διαμόρφωση κουμπιών',
    'LBL_ACTIONBUTTON_AUTO_CREATE' => 'Αυτόματη δημιουργία',
    'LBL_ACTIONBUTTON_LINK' => 'Δημιουργία σχέσης με γονικό στοιχείο',
    'LBL_ACTIONBUTTON_COPY_PARENT' => 'Αντιγραφή γονικών τιμών',
    'LBL_ACTIONBUTTON_PRESET' => 'Ορισμός τιμής(ών) πεδίου',
    'LBL_ACTIONBUTTON_PRESET_PARENT' => 'Αντιγραφή τιμής(ών) πεδίου από γονικό στοιχείο',
    'LBL_ACTIONBUTTON_SELECT_OPTION' => 'Επιλέξτε...',
    'LBL_ACTIONBUTTON_PARENT_FIELD' => 'Από το γονικό πεδίο ',
    'LBL_ACTIONBUTTON_DELETE_BUTTON' => 'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτό το κουμπί;',
    'LBL_ACTIONBUTTON_DELETE_ACTION' => 'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτή την ενέργεια;',
    'LBL_ACTIONBUTTON_INVALID_DATA' => 'Μη έγκυρα δεδομένα κουμπιού ενέργειας',
    'LBL_ACTIONBUTTON_SELECT_MODULE' => 'Επιλέξτε μια ενότητα πριν από την αποθήκευση.',
    'LBL_ACTIONBUTTON_SELECT_LINK' => 'Επιλέξτε έναν σύνδεσμο πριν από την αποθήκευση. Εάν δεν υπάρχει διαθέσιμος σύνδεσμος, καταργήστε την επιλογή της σύνδεσης.',
    'LBL_ACTIONBUTTON_SELECT_RECORD' => 'Επιλέξτε μια εγγραφή πριν από την αποθήκευση.',
    'LBL_ACTIONBUTTON_SELECT_TEMPLATE' => 'Παρακαλώ επιλέξτε ένα πρότυπο πριν από την αποθήκευση.',
    'LBL_ACTIONBUTTON_THEME_PRIMARY' => 'Κύριο',
    'LBL_ACTIONBUTTON_THEME_SECONDARY' => 'Δευτερεύων',
    'LBL_ACTIONBUTTON_THEME_HIGHVIZ' => 'HighViz',
    'LBL_ACTIONBUTTON_THEME_OCEAN' => 'Θαλασσί',
    'LBL_ACTIONBUTTON_THEME_PINK' => 'Ροζ',
    'LBL_ACTIONBUTTON_THEME_ARMY' => 'Καμουφλάζ',
    'LBL_ACTIONBUTTON_THEME_TEAL' => 'Κιρκίρι',
    'LBL_ACTIONBUTTON_THEME_PACIFIC' => 'Ειρηνικός',
    'LBL_ACTIONBUTTON_THEME_GREEN' => 'Πράσινο',
    'LBL_ACTIONBUTTON_THEME_YELLOW' => 'Κίτρινο',
    'LBL_ACTIONBUTTON_THEME_ORANGE' => 'Πορτοκαλί',
    'LBL_ACTIONBUTTON_THEME_RED' => 'Κόκκινο',
    'LBL_ACTIONBUTTON_THEME_CORAL' => 'Κοραλί',
    'LBL_ACTIONBUTTON_THEME_PURPLE' => 'Μωβ',
    'LBL_ACTIONBUTTON_FORMULA' => 'Υπόδειγμα',
    'LBL_ACTIONBUTTON_ACTIONS' => 'Ενέργειες',
    'LBL_ACTIONBUTTON_VALIDATION_ERROR' => 'Σφάλμα κατά την επικύρωση δεδομένων κουμπιού.',
    'LBL_ACTIONBUTTON_VALIDATION_ERROR_NEED_LABEL_OR_ICON' => 'Τα κουμπιά πρέπει να έχουν τουλάχιστον μια ετικέτα ή ένα σύνολο εικονιδίων.',
    'LBL_ACTIONBUTTON_VALIDATION_ERROR_NEED_LABEL' => 'Εισαγάγετε μια έγκυρη ετικέτα κουμπιού.',
    'LBL_ACTIONBUTTON_INVALID_FIELD_VALUES' => 'Δεν ήταν δυνατή η δημιουργία της εγγραφής λόγω ελλείψεων απαιτούμενων τιμών. Επικοινωνήστε με τον διαχειριστή σας.',
    'LBL_ACTIONBUTTON_INVALID_DROPDOWN_ERROR' => 'Πρέπει να έχετε τουλάχιστον δύο ενεργά κουμπιά για αυτόν τον τύπο κουμπιού.',
    'LBL_ACTIONBUTTON_RECORD' => 'Προβολές Εγγραφής',
    'LBL_ACTIONBUTTON_ACTION_MENU' => 'Μενού Δράσης',
    'LBL_ACTIONBUTTON_ORDER' => 'Σειρά',
    'LBL_ACTIONBUTTON_LIST_VIEW' => 'Προβολή Λίστας',
    'LBL_ACTIONBUTTON_RECORD_VIEW' => 'Κεφαλίδα προβολής εγγραφής',
    'LBL_ACTIONBUTTON_RECORD_VIEW_DASHLET' => 'Κεφαλίδα πίνακα προβολής εγγραφής',
    'LBL_ACTIONBUTTON_SUBPANELS' => 'Υποπίνακες',
    'LBL_ACTIONBUTTON_TASK_SEQUENCE_FAILED' => 'Η μηχανή εκτέλεσης ακολουθίας εργασιών απέτυχε στην εκτέλεση των ακόλουθων ενεργειών: ',
    'LBL_ACTIONBUTTON_ADD_ACTION' => 'Προσθέστε μια ενέργεια',
    'LBL_ACTIONBUTTON_REMOVE_ACTION' => 'Καταργήστε αυτήν την ενέργεια',
    'LBL_ACTIONBUTTON_ASSIGN_CURRENT_USER' => 'Υφιστάμενος Χρήστης',

    //document merging
    'LBL_MERGE_TEMPLATE_BUTTON_LABEL' => 'Συγχώνευση εγγράφου',
    'LBL_MERGE_TEMPLATE_PDF_BUTTON_LABEL' => 'Συγχώνευση εγγράφου σε PDF',

    //hint
    'LBL_HINT_COMPANY_SIZE' => 'Μέγεθος εταιρείας',
    'LBL_HINT_COMPANY_INDUSTRY' => 'Κλάδος',
    'LBL_HINT_COMPANY_INDUSTRY_TAGS' => 'Ετικέτες βιομηχανίας',
    'LBL_HINT_COMPANY_LOCATION' => 'Τοποθεσία Εταιρείας',
    'LBL_HINT_COMPANY_DESCRIPTION' => 'Περιγραφή εταιρείας',
    'LBL_HINT_COMPANY_FOUNDED_YEAR' => 'Έτος ίδρυσης',
    'LBL_HINT_COMPANY_FACEBOOK' => 'Εταιρικό Facebook',
    'LBL_HINT_COMPANY_TWITTER' => 'Εταιρικό Twitter',
    'LBL_HINT_COMPANY_PIC' => 'Λογότυπο Επιχείρησης',
    'LBL_HINT_CONTACT_PIC' => 'Φωτογραφία επικοινωνίας',
    'LBL_HINT_COMPANY_WEBSITE' => 'Εταιρικός Ιστότοπος',
    'LBL_HINT_PHOTO' => 'Σύνδεσμος φωτογραφίας',
    'LBL_HINT_JOB_2' => 'Προηγούμενες Εργασίες',
    'LBL_HINT_EDUCATION' => 'Εκπαίδευση',
    'LBL_HINT_EDUCATION_2' => 'Πρόσθετη εκπαίδευση',
    'LBL_HINT_TWITTER' => 'Σύνδεσμος Twitter',
    'LBL_HINT_FACEBOOK' => 'Σύνδεσμος Facebook',
    'LBL_HINT_COMPANY_NAICS_CODE_LABEL' => 'Κώδικας NAICS',
    'LBL_HINT_COMPANY_SIC_CODE_LABEL' => 'Κώδικας SIC',
    'LBL_HINT_COMPANY_FISCAL_YEAR_END' => 'Τέλος οικονομικού έτους',
    'LBL_HINT_COMPANY_ANNUAL_REVENUE' => 'Ετήσιος Τζίρος',
    'LBL_HINT_PHONE_1' => 'Τηλέφωνο 1',
    'LBL_HINT_PHONE_2' => 'Τηλέφωνο 2',
    'LBL_HINT_PANEL' => 'Sugar Hint',
    'LBL_HINT_JOIN_TABLE' => 'Σύνθεση πίνακα',
    'LBL_HINT_FULL_NAME' => 'Ονοματεπώνυμο',
    'LBL_HINT_JOB_TITLE' => 'Τίτλος εργασίας',
    'LBL_HINT_OFFICE_PHONE' => 'Τηλέφωνο Εργασίας',
    'LBL_HINT_MOBILE_PHONE' => 'Κινητό Τηλέφωνο',
    'LBL_HINT_OTHER_PHONE' => 'Άλλο Τηλέφωνο',
    'LBL_HINT_WEBSITE' => 'Ιστοσελίδα',
    'LBL_HINT_MSG_OVERWRITE_ALL' => 'Θέλετε να αντικαταστήσετε όλα τα υπάρχοντα δεδομένα για αυτήν την εγγραφή με τα νέα δεδομένα που βρέθηκαν στο Sugar Hint;',
    'LBL_HINT_MSG_OVERWRITE_FIELD' => 'Θέλετε να αντικαταστήσετε το υπάρχον {{fieldName}} για αυτήν την εγγραφή με το νέο {{fieldName}} που βρέθηκε στο Sugar Hint;',
    'LBL_HINT_MSG_TOTAL_OVERWRITE' => 'Όλα τα δεδομένα που σχετίζονται με τον λογαριασμό θα καταργηθούν. Είστε βέβαιοι ότι θέλετε να συνεχίσετε;',
    'LBL_HINT_COMPANY_LOGO' => 'Λογότυπο',
    'LBL_HINT_CONTACTS_AVATAR' => 'Φωτογραφία',
    'LBL_HINT_ACCOUNTSETS' => 'Ετικέτες Συνόλων λογαριασμών Sugar Hint',

    'LBL_HINT_LOADING' => 'Φορτώνει ...',
    'LBL_HINT_UNINSTALL_PROCESSING' => 'Κατάργηση εγκατάστασης του Sugar Hint, περιμένετε',
    'LBL_HINT_VALUE_ERASED' => ' Τιμή διαγράφεται ',
    'LBL_HINT_VALUE_ERASED_TOOLTIP' => 'Αυτές οι πληροφορίες διαγράφηκαν μέσω αίτησης προστασίας προσωπικών δεδομένων',

    'LBL_HINT_UNINSTALL_TITLE' => 'Επιλέξτε μία από τις επιλογές απεγκατάστασης από παρακάτω:',
    'LBL_HINT_UNINSTALL_PARTIAL' => 'Απεγκατάσταση μόνο πακέτου Hint',
    'LBL_HINT_UNINSTALL_FULL' => 'Πλήρης απεγκατάσταση Hint',
    'LBL_HINT_UNINSTALL_PARTIAL_DESCRIPTION' => 'Αυτή η επιλογή θα καταργήσει το Hint MLP και θα απενεργοποιήσει όλες τις ενεργές συνδρομές στο Hint Insights.
     Η επανεγκατάσταση του Hint θα ενεργοποιήσει ξανά αυτόματα τις συνδρομές.',
    'LBL_HINT_UNINSTALL_FULL_DESCRIPTION' => 'Αυτή η επιλογή θα πραγματοποιήσει μια πλήρη απεγκατάσταση του Hint, συμπεριλαμβανομένης της κατάργησης του MLP και της διαγραφής όλων των πληροφοριών διαμόρφωσης και συνδρομής.',
    'LBL_HINT_UNINSTALL' => 'Απεγκατάσταση',
    'LBL_HINT_UNINSTALL_HEADER' => 'Απεγκατάσταση του Sugar Hint',
    'LBL_HINT_CANCEL' => 'Ακύρωση',
    'LBL_HINT_UNINSTALL_WARNING1' => 'ΠΡΟΕΙΔΟΠΟΙΗΣΗ: Επιλέξτε αυτήν την επιλογή μόνο εάν δεν σκοπεύετε να χρησιμοποιήσετε ξανά το Hint στο μέλλον.
     Πριν πραγματοποιήσετε την απεγκατάσταση, ολοκληρώστε ένα πλήρες αντίγραφο ασφαλείας της βάσης δεδομένων Sugar και βάλτε το Sugar σε λειτουργία συντήρησης. ',
    'LBL_HINT_UNINSTALL_WARNING2' => 'Ανατρέξτε στο ',
    'LBL_HINT_UNINSTALL_WARNING_LINK' => 'Οδηγός διαχείρισης Sugar Hint ', // TODO: This URL needs to be changed.
    'LBL_HINT_UNINSTALL_WARNING3' => 'για λεπτομέρειες σχετικά με τη διαδικασία απεγκατάστασης.',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE1' => 'Είστε βέβαιοι ότι θέλετε να απεγκαταστήσετε μόνο το πακέτο Sugar Hint;',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE2' => 'Είστε βέβαιοι ότι θέλετε να απεγκαταστήσετε πλήρως το Sugar Hint;',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE2_SUBTEXT' => '(ΣΗΜΕΙΩΣΗ: ΔΕΝ ΜΠΟΡΕΙΤΕ ΝΑ ΑΝΑΙΡΕΣΕΤΕ ΑΥΤΗ ΤΗΝ ΕΝΕΡΓΕΙΑ)',

    'LBL_HINT_CONFIG_TITLE' => 'Πεδία Sugar Hint',
    'LBL_HINT_NO_RESULTS_MSG' => 'Δεν βρέθηκαν αποτελέσματα.',
    'LBL_HINT_CONFIG_BASIC_PREVIEW' => 'Βασική διάταξη πίνακα Hint',
    'LBL_HINT_CONFIG_TAB_ACCOUNTS' => 'Λογιαριασμοί',
    'LBL_HINT_CONFIG_TAB_CONTACTS' => 'Επαφές',
    'LBL_HINT_CONFIG_TAB_LEADS' => 'Δυνητικοί Πελάτες',
    'LBL_HINT_CONFIG_EXPANDED_PREVIEW' => 'Διευρυμένη διάταξη πίνακα Hint',
    'LBL_HINT_CONFIG_DIR_PAR1' => 'Αναδιατάξτε τα πεδία σύροντας και αποθέτοντας μέσα στις παραπάνω ενότητες της Διάταξης πίνακα Hint.',
    'LBL_HINT_CONFIG_DIR_PAR2' => 'Για λεπτομερείς οδηγίες και μια λίστα προεπιλεγμένων πεδίων, ανατρέξτε στο ',
    'LBL_HINT_CONFIG_RESTORE_TEXT' => ' για να επαναφέρετε τις προεπιλεγμένες ρυθμίσεις για την ',
    'LBL_HINT_CONFIG_MODULE_TEXT' => 'ενότητα.',
    'LBL_HINT_CONFIG_WARNING_MESSAGE' => 'Είστε βέβαιοι ότι θέλετε να επαναφέρετε τις προεπιλογές για την ενότητα {{module}};',
    'LBL_HINT_CONFIG_RESTORE_BUTTON' => 'Πατήστε Εδώ',
    'LBL_HINT_CONFIG_NAME' => 'Οδηγός διαχείρισης Hint.',
    'LBL_HINT_CONFIG_FIELD_SELECTOR' => 'Πεδία',
    'LBL_HINT_ENRICHED_FIELD_SUBTITLE' => 'Εμπλουτισμένα Πεδία',
    'LBL_HINT_ENRICHED_FIELD_SUBTITLE_NOTE' => 'Αυτή η ενότητα παραθέτει όλα τα πεδία Hint και τα πεδία Sugar που εμπλουτίζονται από το Hint. Τα πεδία Hint επισημαίνονται με έναν αστερίσκο (*) και μπορούν να εμφανιστούν στον πίνακα Hint μόνο εάν είναι εμπλουτισμένα.',
    'LBL_HINT_CONFIG_FIELD_NAME' => 'Όνομα Πεδίου',
    'LBL_HINT_CONFIG_ENRICH_FIELD' => 'Εμπλουτισμός Πεδίου',
    'LBL_HINT_CONFIG_FIELD_SHOW1' => 'Εμφάνιση σε Hint',
    'LBL_HINT_CONFIG_FIELD_SHOW2' => 'Εμφάνιση στον πίνακα του Hint',
    'LBL_HINT_ADDITIONAL_FIELD_SUBTITLE' => 'Πρόσθετα πεδία Sugar',
    'LBL_HINT_ADDITIONAL_FIELD_SUBTITLE_NOTE' => 'Αυτή η ενότητα παραθέτει όλα τα πεδία Sugar που δεν είναι εμπλουτισμένα από το Hint.',
    'LBL_HINT_RESYNC_NOTIFICATION_TITLE' => 'Προειδοποίηση',
    'LBL_HINT_RESYNC_NOTIFICATION_DESCRIPTION' => 'Προσοχή: Πρόκειται να συγχρονίσετε με την υπηρεσία Sugar Hint Insights. Τυχόν εκκρεμείς ιστορίες σύνοψης email θα χαθούν και οι υπάρχουσες ειδήσεις θα διαγραφούν από το dashlet Insights. Οι ειδοποιήσεις όλων των τύπων θα συνεχιστούν μετά την ολοκλήρωση του συγχρονισμού.',

    'LBL_HINT_ACCOUNT_CHANGE_TITLE' => 'Οι προτεινόμενες εταιρείες που σχετίζονται με το {{_moduleSingular}} σας παρατίθενται παρακάτω. Επιλέξτε εταιρικά δεδομένα για εμφάνιση.',
    'LBL_HINT_NO_ACCOUNT_SELECTED' => 'No account is selected',

    'LBL_HINT_EMAIL_IMPORT_TITLE' => 'Βρέθηκαν πολλά email, επιλέξτε email για εισαγωγή: ',

    'LBL_HINT_HELP_MESSAGE1' => 'Με βάση τα δεδομένα που εισήχθησαν, το Hint δεν μπόρεσε να βρει αντιστοιχία στο σύστημα.',
    'LBL_HINT_HELP_MESSAGE2' => 'Τα καλύτερα αποτελέσματα στο Hint μπορούν να βρεθούν με το όνομα και τη διεύθυνση email ενός ατόμου.',
    'LBL_HINT_HELP_MESSAGE3' => 'Τα καλύτερα αποτελέσματα στο Hint μπορούν να βρεθούν με τη διεύθυνση url του ιστότοπου της εταιρείας.',
    'LBL_HINT_HELP_DEFAULT_MESSAGE1A' => "Εισαγάγετε την επωνυμία ή τον ιστότοπο της εταιρείας σας {{_moduleSingular}} και το Hint θα αναζητήσει πρόσθετα δεδομένα.",
    'LBL_HINT_HELP_DEFAULT_MESSAGE1B' => "Εισαγάγετε τη διεύθυνση ηλεκτρονικού ταχυδρομείου του {{currentModule}} και το Hint θα αναζητήσει πρόσθετα δεδομένα.",

    'LBL_HINT_HISTORY_NONE' => 'Δεν υπάρχουν διαθέσιμα δεδομένα για ιστορική προβολή',
    'LBL_HINT_HISTORY_TITLE' => 'Ιστορικό Δραστηριότητας',

    'LBL_HINT_PREVIEW_TITLE' => 'Εμπλουτισμός δεδομένων',
    'LBL_HINT_PREVIEW_LICENSE_EXPIRED' => 'Η άδεια χρήσης για την υπηρεσία Hint σας έχει λήξει. Επικοινωνήστε με τον διαχειριστή του SugarCRM για να ανανεώσετε την άδειά σας.',
    'LBL_HINT_PREVIEW_QUESTION' => 'Θέλετε να δείτε τι μπορεί να κάνει το Hint για εσάς και την εταιρεία σας; Επικοινωνήστε με τον διαχειριστή του SugarCRM για να προσθέσετε Hint.',
    'LBL_HINT_PREVIEW_NO_ACCOUNT_INFO' => 'Τα στοιχεία λογαριασμού δεν βρέθηκαν',
    'LBL_HINT_PREVIEW_TOOLTIP_TITLE' => 'Βρέθηκαν εμπλουτισμένα δεδομένα - κάντε κλικ για να αποθηκεύσετε όλα τα εμπλουτισμένα δεδομένα στο αρχείο σας.',
    'LBL_HINT_PREVIEW_CLICK_TO_SAVE' => 'Κάντε κλικ για να αποθηκεύσετε εμπλουτισμένα δεδομένα στο αρχείο σας.',

    'LBL_HINT_CONTACTS_TITLE' => 'Σχετικές Επαφές',
    'LBL_HINT_CONTACTS_NONE' => 'Δεν υπάρχουν σχετικές επαφές',

    'LBL_HINT_NEWS' => 'Ειδήσεις',
    'LBL_HINT_GENERAL' => 'Γενικά',
    'LBL_HINT_ALL_NEWS' => 'Όλες οι Ειδήσεις',
    'LBL_HINT_FILTER_NEWS' => 'Φιλτράρισμα ειδήσεων',
    'LBL_HINT_FINANCIAL_NEWS' => 'Οικονομικές',
    'LBL_HINT_PERSONNEL_NEWS' => 'Προσωπικού',
    'LBL_HINT_PRESS_RELEASES' => 'Δελτία Τύπου',
    'LBL_HINT_OTHER_NEWS' => 'Άλλες',
    'LBL_HINT_NEWS_PLACEHOLDER' => 'Αναζήτηση άρθρων ειδήσεων',
    'LBL_HINT_NEWS_ALERT' => 'Sugar Hint Insights',
    'LBL_HINT_NEWS_NONE' => 'Δεν υπάρχουν διαθέσιμες ειδήσεις',
    'LBL_NEW_NOTIFICATIONS' => 'Νέες ειδοποιήσεις',
    'LBL_HINT_DASHLET_ALLOWED1' => 'Πρέπει να έχετε άδεια Sugar Hint για να δείτε το dashlet Sugar Hint Insights.
    Ask your administrator about getting a Sugar Hint license.',

    'LBL_HINT_FOR' => 'Για',
    'LBL_HINT_WITH' => 'με',
    'LBL_HINT_SHOW_ME' => 'Δείξτε μου: ',
    'LBL_HINT_NOTIFY_ME_BY' => 'Ειδοποιήστε με από: ',

    'LBL_NOTIFICATIONS_TITLE' => 'Κέντρο προτιμήσεων Sugar Hint Insights',
    'LBL_NOTIFICATIONS_KEY_TITLE' => 'Κλειδί επιλογής προτίμησης',
    'LBL_HINT_PREFERENCES' => 'Προτιμήσεις',
    'LBL_HINT_MINIMUM_PREFERENCES' => 'Η διαγραφή είναι απενεργοποιημένη, απαιτείται τουλάχιστον μία δήλωση προτίμησης',
    'LBL_HINT_MAXIMUM_PREFERENCES' => 'Προσθήκη απενεργοποιημένη, έχετε συμπληρώσει το μέγιστο των δηλώσεων προτίμησης',

    'LBL_NOTIFICATIONS_KEY_TITLE_DASHLET' => 'Συμπεριλάβετε στο dashlet Sugar Hint Insights',
    'LBL_NOTIFICATIONS_KEY_TITLE_BROWSER' => 'Αναδυόμενο παράθυρο ως ειδοποίηση επιφάνειας εργασίας',
    'LBL_NOTIFICATIONS_KEY_DESCR_BROWSER' => 'Οι ειδοποιήσεις πρέπει να είναι ενεργοποιημένες σε όλα τα προγράμματα περιήγησης και σε όλους τους επιτραπέζιους υπολογιστές για να λαμβάνετε αδιάλειπτα ειδοποιήσεις.',
    'LBL_NOTIFICATIONS_KEY_DESCR_BROWSER_DISABLED' => 'Ορισμένα προγράμματα περιήγησης, όπως ο Internet Explorer, δεν υποστηρίζουν ειδοποιήσεις. Οι ειδοποιήσεις δεν μπορούν να ενεργοποιηθούν όταν χρησιμοποιείτε πρόγραμμα περιήγησης που δεν υποστηρίζει ειδοποιήσεις.',
    'LBL_NOTIFICATIONS_KEY_TITLE_EMAIL' => 'Στείλτε άμεση ειδοποίηση μέσω email για κάθε ειδοποίηση',
    'LBL_NOTIFICATIONS_KEY_TITLE_DAILY' => 'Στείλτε μια καθημερινή ανασκόπηση μέσω email',
    'LBL_NOTIFICATIONS_KEY_TITLE_WEEKLY' => 'Στείλτε μια εβδομαδιαία ανασκόπηση μέσω email',

    'LBL_NOTIFICATIONS_ERROR_MESSAGE_FAILEDSYNC' => 'Δεν ήταν δυνατή η αποθήκευση των προτιμήσεων. Ελέγξτε τη σύνδεση του συστήματός σας και δοκιμάστε ξανά.',
    'LBL_NOTIFICATIONS_ERROR_MESSAGE_MISSING_REQUIRED' => 'Σε ορισμένα απαιτούμενα πεδία λείπει μια τιμή. Ελέγξτε τις προτιμήσεις σας και βεβαιωθείτε ότι είναι συμπληρωμένα όλα τα απαιτούμενα πεδία.',

    'LBL_HINT_PUSH_MESSAGES_PERMISSION' => 'Πρόκειται να ενεργοποιήσετε τις ειδοποιήσεις προγράμματος περιήγησης για το Sugar Hint Insights. Κάντε κλικ στο Επιβεβαίωση για να προχωρήσετε. Στη συνέχεια, το πρόγραμμα περιήγησής σας θα σας ζητήσει άδεια για να επιτρέψετε τη λήψη συμβάντων ειδοποιήσεων.',
    'LBL_HINT_PUSH_ERROR' => 'Η προσθήκη Push Notifications έχει εγγραφεί για το {{options.type}} χωρίς τις εξαρτήσεις του. Η προσθήκη δεν θα λειτουργήσει όπως προβλέπεται, βεβαιωθείτε ότι παρέχετε μια διαδρομή προς το αρχείο εργαζομένων και μια μέθοδο αποθήκευσης της συνδρομής στον διακομιστή.',

    'LBL_HINT_CONFIG_ENABLE_NOTIFICATIONS' => 'ΕΝΕΡΓΟΠΟΙΗΣΤΕ τις ειδοποιήσεις Hint για όλους τους χρήστες',
    'LBL_HINT_CONFIG_DISABLE_NOTIFICATIONS' => 'ΑΠΕΝΕΡΓΟΠΟΙΗΣΤΕ τις ειδοποιήσεις Hint για όλους τους χρήστες',

    'LBL_HINT_SOFT_DISABLE_NOTIFICATIONS_FAILURE' => 'ΠΡΟΕΙΔΟΠΟΙΗΣΗ: Απέτυχε η απενεργοποίηση των ειδοποιήσεων κατά την απεγκατάσταση του Sugar Hint. Για να απενεργοποιήσετε τις ειδοποιήσεις, εγκαταστήστε το Hint 5.4.0 ή νεότερο και εκτελέστε μια πλήρη απεγκατάσταση χρησιμοποιώντας το Πρόγραμμα απεγκατάστασης Hint που βρίσκεται στην ενότητα Διαχείριση του Sugar.',
    'LBL_HINT_ENRICH_ALL' => 'Εμπλουτισμός όλων',
    'LBL_HINT_NO_LICENSE_ACCESS' => 'Απαιτείται άδεια υποδείξεων',


    //Maps
    'LBL_MAP_CONFIG_TITLE' => 'Διαμόρφωση Χαρτών',
    'LBL_MAP_CONFIG_GEOCODE_LOG_VIEWER' => 'Πρόγραμμα Προβολής Αρχείων Καταγραφής Γεωκώδικα',
    'LBL_MAP_MAP' => 'Χάρτης',
    'LBL_MAP_MAPS' => 'Χάρτες',
    'LBL_MAP_GEOCODING_RECORD' => 'Γεωκώδικας',
    'LBL_MAP_GEOCODE_SUCCESS' => 'Η εγγραφή έχει γεωκωδικοποιηθεί με επιτυχία.',
    'LBL_MAP_LATITUDE' => 'Γεωγραφικό πλάτος',
    'LBL_MAP_LONGITUDE' => 'Γεωγραφικό μήκος',
    'LBL_MAP_SEARCH_BY_ADDRESS' => 'Αναζήτηση βάση διεύθυνσης...',
    'LBL_MAP_ALREADY_GEOCODED' => 'Η τρέχουσα εγγραφή είναι ήδη γεωκωδικοποιημένη. Είστε βέβαιοι ότι θέλετε να αντικαταστήσετε τη γεωκωδικοποίηση για αυτήν την εγγραφή;',
    'LBL_MAPS_MANUAL_GEOCODING' => 'Χειροκίνητη Γεωκωδικοποίηση',
    'LBL_MAP_POINT_COORDINATES' => 'Συντεταγμένες σημείων χάρτη',
    'LBL_MAP_CALCULATING_DIRECTIONS' => 'Υπολογισμός της βέλτιστης διαδρομής...',
    'LBL_MAP_DIRECTIONS' => 'Οδηγίες',
    'LBL_MAP_DIRECTIONS_FROM_USER' => 'Οδηγίες που ξεκινούν από τον Τρέχον χρήστη',
    'LBL_MAP_DIRECTIONS_FROM_RECORD' => 'Οδηγίες που ξεκινούν από αυτή την εγγραφή',
    'LBL_MAPS_RADIUS_INPUT' => 'Ακτίνα (0-250)',
    'LBL_MAPS_IN_RADIUS_FROM_ZIP' => 'σε μια ακτίνα από ταχυδρομικό κώδικα',
    'LBL_MAPS_DISTANCE' => 'Απόσταση',
    'LBL_MAPS_CENTER_ZIP_CODE' => 'Ταχυδρομικός κώδικας',
    'LBL_MAPS_CONFIG_INVALID_MODULE_TITLE' => 'Μη έγκυρη διαμόρφωση: ',
    'LBL_MAPS_CONFIG_INVALID_MODULE' => 'Οι αντιστοιχίσεις πεδίου <strong>{{module}}</strong>δεν είναι έγκυρες.',
    'LBL_MAP_DASHLET_CONFIGURE_MAP_TYPE' => 'Τύπος χάρτη',
    'LBL_MAP_DASHLET_CONFIGURE_MAP_ZOOM' => 'Επίπεδο ζουμ',
    'LBL_MAPS_DASHLET' => 'Χάρτες',
    'LBL_MAPS_DASHLET_DESCRIPTION' => 'Εμφανίζει γεωκωδικοποιημένη/γεωκωδικοποιημένες εγγραφή/εγγραφές στον χάρτη.',
    'LBL_MAPS_DASHLET_MODULE_UNAVAILABLE' => 'Το Χάρτες δεν είναι διαθέσιμο για αυτήν την ενότητα. Ενεργοποιήστε το στην κονσόλα διαχειριστή.',
    'LBL_MAP_MODULES' => 'Μονάδα',
    'LBL_MAP_FILTER_BY' => 'Φιλτράρισμα κατά',
    'LBL_MAP_UNIT_TYPE' => 'Τύπος μονάδας',
    'LBL_MAP_UNIT_TYPE_MILES' => 'Μίλια',
    'LBL_MAP_UNIT_TYPE_KM' => 'Χιλιόμετρα',
    'LBL_MAP_ADDRESS' => 'Διεύθυνση',
    'LBL_MAP_NO_STARTING_POINT' => 'Το σημείο εκκίνησης δεν είναι γεωκωδικοποιημένο.',
    'LBL_MAPS_MISSING_GEOCODING_START_POINT' => 'Η εγγραφή σημείου εκκίνησης δεν είναι γεωκωδικοποιημένη.',
    'LBL_MAPS_MISSING_GEOCODING_RECORDS' => 'Ορισμένες από τις επιλεγμένες εγγραφές δεν είναι γεωκωδικοποιημένες και δεν θα εμφανίζονται στον χάρτη.',
    'LBL_MAPS_MISSING_GEOCODING_RECORD' => 'Η/οι εγγραφή/εγγραφές δεν είναι γεωκωδικοποιημένη/γεωκωδικοποιημένες.',
    'LBL_MAPS_MODULE_FIELDS' => 'Πεδία Μονάδας',
    'LBL_MAPS_SELECT_FIELD' => 'Επιλέξτε Πεδίο',
    'LBL_MAPS_RELATE_RECORD' => 'Σχετιζόμενη εγγραφή',
    'LBL_MAPS_MAPPING_TYPE' => 'Τύπος χαρτογράφησης',
    'LBL_MAPS_NO_GEOCODED_RECORDS' => 'Δεν υπάρχουν γεωκωδικοποιημένες εγγραφές',
    'LBL_MAPS_ADDRESS' => 'Διεύθυνση',
    'LBL_MAPS_ASSIGNED_USER_NAME' => 'Ανατεθειμένος Χρήστης',
    'LBL_MAPS_STREET_VIEW_POINT_NOT_AVAILABLE' => 'Η πλάγια όψη του δρόμου δεν είναι διαθέσιμη για το συγκεκριμένο σημείο',
    'LBL_MAPS_INVALID_MODULE' => '<strong>{0}</strong> εγγραφές δεν είναι έγκυρες για χαρτογράφηση. Αφαιρέστε τη μονάδα από τη λίστα.',
    'LBL_MAPS_CLOSE_TOOLTIP' => 'Κλείσιμο',
    'LBL_MAPS_EXPAND_TOOLTIP' => 'Επέκταση',
    'LBL_MAPS_SAVE_PDF_TOOLTIP' => 'Αποθήκευση ως PDF',
    'LBL_MAPS_EMAIL_LINK' => 'Σύνδεσμος email',
    'LBL_MAPS_ONE_GEOCDED_RECORD_NEEDED' => 'Πρέπει να έχετε τουλάχιστον ένα γεωκωδικοποιημένο αρχείο.',
    'LBL_MAPS_GENERATING' => 'Δημιουργία χάρτη...',
    'LBL_MAPS_POINTS' => 'Σημεία χάρτη',
    'LBL_MAPS_POINT' => 'Σημείο',
    'LBL_MAPS_TRAVEL_DETAILS' => 'Λεπτομέρειες ταξιδιού',
    'LBL_MAPS_TOTAL_DISTANCE' => 'Συνολική απόσταση',
    'LBL_MAPS_TOTAL_DURATION' => 'Συνολική Διάρκεια',
    'LBL_MAPS_TOTAL_DURATION_WITHOUT_TRAFIC' => 'Συνολική διάρκεια χωρίς κίνηση',
    'LBL_MAPS_ITINERARY' => 'Δρομολόγιο',
    'LBL_MAPS_TRAVEL_DISTANCE' => 'Απόσταση Ταξιδίου',
    'LBL_MAPS_TRAVEL_DURATION' => 'Διάρκεια ταξιδιού',
    'LBL_MAPS_TRAVEL_STEPS' => 'Βήματα',
    'LBL_MAPS_TRAVEL_WARNINGS' => 'Προειδοποιήσεις',
    'LBL_MAPS_MAX_GEOCDED_RECORD_EXCEDED' => 'Το Χάρτες Bing υποστηρίζει έως και 10 σημεία σε έναν κοινόχρηστο χάρτη. Ελέγξτε την επιλογή σας.',
    'LBL_MAPS_NO_LICENSE_ACCESS' => 'Απαιτείται άδεια χρήσης χαρτών',
    'LBL_MAPS_SHARE_HELLO' => 'Γειά σας,',
    'LBL_MAPS_SHARE_HEADER' => 'Έχετε ζητήσει έναν χάρτη Bing για τα ακόλουθα σημεία:',
    'LBL_MAPS_SHARE_OPEN_URL' => 'Η ακόλουθη διεύθυνση URL θα ανοίξει έναν χάρτη που περιέχει τα παραπάνω σημεία στους Χάρτες Bing:',
    'LBL_MAPS_SHARE_SHOW_MAP' => 'Εμφάνιση χάρτη στους Χάρτες Bing',
    'LBL_MAPS_MAP_ON_BING_WEB' => 'Χάρτες Bing',
    'LBL_MAPS_NO_VALID_ITINERARY' => 'Δεν βρέθηκε δρομολόγιο για τα παρεχόμενα σημεία.',
    'LBL_MAPS_GEOCODE_STATUS' => 'Κατάσταση Γεωκώδικα',
    'LBL_MAPS_GEOCODED' => 'Γεωκωδικοποιημένο',
    'LBL_MAPS_NOT_GEOCODED' => 'Μη γεωκωδικοποιημένο',
    'LBL_MAPS_NOT_FOUND' => 'Μη έγκυρη διεύθυνση',
    'LBL_MAPS_GEOCODING_FAILED' => 'Η γεωκωδικοποίηση απέτυχε',
    'LBL_MAPS_QUEUED' => 'Σε ουρά',
    'LBL_MAPS_REQUEUED' => 'Εκ νέου σε ουρά',
    'LBL_MAPS_RELATED_RECORD' => 'Σχετιζόμενη εγγραφή',

    //Report Dashlet
    'LBL_REPORT_DASHLET_CONFIG_VIEW_REPORT' => 'Προβολή αναφοράς',
    'LBL_REPORT_DASHLET_DESC' => 'Εμφάνιση μιας αποθηκευμένης αναφοράς',
    'LBL_REPORT_DASHLET_RESET_DEFAULT' => 'Επαναφορά στις Προεπιλογές του Πίνακα Στοιχείων',
    'LBL_REPORT_DASHLET_RESET_REPORT_DEFAULT' => 'Επαναφορά στην Αναφορά Προεπιλογών',
    'LBL_REPORT_DASHLET_REFRESH_RESULTS' => 'Ανανέωση Αποτελεσμάτων',
    'LBL_REPORT_DASHLET_COPY_CHART_CLIPBOARD' => 'Αντιγραφή Γραφήματος στο Πρόχειρο',
    'LBL_REPORT_DASHLET_DOWNLOAD_CHART' => 'Λήψη Γραφήματος',
    'LBL_REPORT_DASHLET_REST_TO_REPORT_DEFAULTS' => 'Έγινε επεξεργασία της αναφοράς για τον πίνακα εργαλείων {{label}} και ο πίνακας εργαλείων έχει επαναφερθεί στην προεπιλεγμένη διαμόρφωση.',

    'LBL_NO_FIELD_PERMISSION_TO_FILTER' => 'Δεν έχετε δικαίωμα χρήσης αυτού του πεδίου.',

    'LBL_INVALID_FORMULA' => 'Άκυρο υπόδειγμα',
    'LBL_RETURN_TYPE_MISSMATCH' => 'Ο τύπος επιστροφής λειτουργίας δεν ταιριάζει',

    'LBL_PREDICT_TOOLTIP' => 'SugarPredict',

    'LBL_AI_CONV_SCORE_CLASSIFICATION_FIELD' => 'Πρόβλεψη',
    'LBL_AI_ICP_FIT_SCORE_CLASSIFICATION_FIELD' => 'Ιδανικό προφίλ πελάτη',
    'LBL_AI_OPP_CLOSE_WEEK_SCORES' => 'Κλείσιμο Βαθμολογιών Πρόβλεψης Εβδομάδας',
    'LBL_AI_CONV_SCORE_ABSOLUTE' => 'Τιμή Πρόβλεψης',
    'LBL_AI_CONV_BIN_ACCURACY' => 'Ακρίβεια Δοχείου Πρόβλεψης',
    'LBL_AI_CONV_MULTIPLIER' => 'Πολλαπλασιαστής Πρόβλεψης',
    'LBL_AI_ICP_FIT_SCORE_ABSOLUTE' => 'Τιμή ICP',
    'LBL_AI_ICP_FIT_BIN_ACCURACY' => 'Ακρίβεια Δοχείου ICP',
    'LBL_AI_ICP_FIT_MULTIPLIER' => 'Πολλαπλασιαστής ICP',
    'LBL_AI_NEW' => 'Νέο',
    'LBL_AI_ENTERED' => 'Καταχωρίστηκε',
    'LBL_AI_CREATED' => 'Δημιουργήθηκε',
    'LBL_AI_WEEK' => 'Εβδομάδα',
    'LBL_AI_MONTH' => 'Μήνας',
    'LBL_AI_QUARTER' => 'Τρίμηνο',
    'LBL_AI_BYWEEK' => 'ανά Εβδομάδα',
    'LBL_AI_BYMONTH' => 'ανά Μήνα',
    'LBL_AI_BYQUARTER' => 'ανά Τρίμηνο',
    'LBL_AI_WEEKTREND' => 'Εβδομαδιαία τάση',
    'LBL_AI_MONTHLYTREND' => 'Μηνιαία τάση',
    'LBL_AI_QUARTERTREND' => 'Τριμηνιαία τάση',
    'LBL_AI_TREND' => 'Τάση ανά',
    'LBL_AI_TRENDS' => 'Τάσεις ανά',
    'LBL_AI_VELOCITY' => 'Ταχύτητα',
    'LBL_AI_TOPX' => 'Κορυφαίο {X}',
    'LBL_AI_TIMESPAN' => 'Χρονικό διάστημα μεταξύ σταδίων -',
    'LBL_AI_BUSINESSTREND' => 'με τις Επιχειρηματικές Τάσεις',
    'LBL_AI_SUGARINSIGHTINTRO' => 'Παρουσίαση του Sugar Insights!',
    'LBL_AI_SUGARINSIGHTSDESC' => 'Το Sugar Insights αξιοποιεί την ποσοτική ανάλυση για να δημιουργήσει νέες πληροφορίες σχετικά με τα δεδομένα σας στο SugarCRM. Στη Sugar αναζητάμε πάντα νέους τρόπους για να σας βοηθήσουμε να αξιοποιήσετε στο έπακρο τα δεδομένα σας, να λάβετε εμπεριστατωμένες αποφάσεις, και αυτή είναι μόνο η αρχή των όσων ελπίζουμε να προσφέρουμε με το Sugar Insights.',
    'LBL_AI_SUGARINSIGHTS_DASHLET_NAME' => 'Sugar Insights',
    'LBL_AI_SUGARINSIGHTS_DASHLET_DESC' => 'Το Sugar Insights αξιοποιεί την ποσοτική ανάλυση για να δημιουργήσει νέες πληροφορίες σχετικά με τα δεδομένα σας στο SugarCRM.',
    'LBL_AI_FIRMO' => 'Firmographics',
    'LBL_AI_TOTALCOUNT' => 'Συνολικό πλήθος από',
    'LBL_AI_DAYSFROMLATESTACT' => 'Ημέρες από την τελευταία',
    'LBL_AI_DAYSSINCE' => 'ηλικία',
    'LBL_AI_FIELDISSET' => 'υπάρχει',
    'LBL_AI_CONTACTCOMPLETENESS' => 'Πληρότητα στοιχείων επικοινωνίας',
    'LBL_AI_CUTDATE' => 'Περίοδος πρόβλεψης',
    'LBL_AI_FROMLASTCHANGE' => 'Ημέρες από την τελευταία αλλαγή τιμής χαρακτηριστικού',
    'LBL_AI_CALLSHELD' => 'Συνολικός αριθμός κλήσεων που πραγματοποιήθηκαν',
    'LBL_AI_CALLSPLANNED' => 'Συνολικός αριθμός προγραμματισμένων κλήσεων',
    'LBL_AI_OUTBOUNDCALLS' => 'Συνολικός αριθμός εξερχόμενων κλήσεων',
    'LBL_AI_INBOUNDCALLS' => 'Συνολικός αριθμός εισερχόμενων κλήσεων',
    'LBL_AI_AVGCALLDURATION' => 'Μέση διάρκεια κλήσεων',
    'LBL_AI_EMAILSARCHIVED' => 'Συνολικός αριθμός αρχειοθετημένων μηνυμάτων email',
    'LBL_AI_EMAILSREAD' => 'Συνολικός αριθμός μηνυμάτων email που διαβάστηκαν',
    'LBL_AI_EMAILSSENT' => 'Συνολικός αριθμός μηνυμάτων email που στάλθηκαν',
    'LBL_AI_CLOSEDATEPUSHEDBACK' => 'Συνολικός αριθμός εγγραφών όπου η Αναμενόμενη ημερομηνία κλεισίματος αλλάζει σε μεταγενέστερη ημερομηνία',
    'LBL_AI_CLOSEDATEPUSHEDFORWARD' => 'Συνολικός αριθμός εγγραφών όπου η Αναμενόμενη ημερομηνία κλεισίματος αλλάζει σε νωρίτερη ημερομηνία',
    'LBL_AI_AMOUNTINCREASED' => 'Συνολικές ευκαιρίες σε περίπτωση αύξησης του ποσού',
    'LBL_AI_AMOUNTDECREASED' => 'Συνολικές ευκαιρίες σε περίπτωση μείωσης του ποσού',

    // User last state
    'LBL_LAST_STATE' => 'Τελευταία κατάσταση',
    // DocuSign
    'LBL_SEND_TO_DOCUSIGN_BUTTON_LABEL' => 'Αποστολή στο DocuSign',
    'LBL_SHORTCUT_EDIT_RECIPIENT_CANCEL' => 'Ακύρωση επεξεργασίας παραλήπτη',
    'LBL_RECIPIENT_ROLE' => 'Ρόλος παραλήπτη',
    // Base sales stages
    'LBL_OPEN' => 'Ανοιχτό',
    'LBL_CLOSED_WON' => 'Έκλεισε Κερδισμένο',
    'LBL_CLOSED_LOST' => 'Έκλεισε Χαμένη',
    'LBL_KIOSK_ADD_FILES' => 'Προσθήκη αρχείων',
    'LBL_KIOSK_ADD_DROP_FILES' => 'Προσθέστε ή αποθέστε αρχεία εδώ',
    'LBL_KIOSK_CANCEL' => 'Ακύρωση',
    'LBL_KIOSK_EDIT' => 'Επεξεργασία',
    'LBL_KIOSK_EMAIL' => 'Email',
    'LBL_KIOSK_FILES_UPLOADING' => 'Μεταφόρτωση',
    'LBL_KIOSK_FILES_ERROR' => 'Το Συνημμένο απέτυχε να φορτώσει',
    'LBL_KIOSK_FILES_ERROR_TOO_LARGE' => 'Το συνημμένο είναι πολύ μεγάλο',
    'LBL_KIOSK_FILTER_SEARCH' => 'Αναζήτηση',
    'LBL_KIOSK_ID' => 'Ταυτότητα',
    'LBL_KIOSK_TITLE' => 'Περίπτερο',
    'LBL_KIOSK_LANGUAGE' => 'Γλώσσα',
    'LBL_KIOSK_LAST_UPDATED' => 'Τελευταία Ενημέρωση',
    'LBL_KIOSK_LIST_VIEW_SELECTION' => 'Προβολή',
    'LBL_KIOSK_MENU' => 'Μενού',
    'LBL_KIOSK_MOBILE_PHONE' => 'Κινητό Τηλέφωνο',
    'LBL_KIOSK_MY_ACTIVITIES' => 'Οι Δραστηριότητές Μου',
    'LBL_KIOSK_MY_PROFILE' => 'Το Προφίλ Μου',
    'LBL_KIOSK_NAME' => 'Όνομα',
    'LBL_KIOSK_OFFICE_PHONE' => 'Τηλέφωνο Εργασίας',
    'LBL_KIOSK_ORGANIZATION' => 'Οργανισμός',
    'LBL_KIOSK_PAGINATION_FOOTER' => 'Σειρές ανά σελίδα:',
    'LBL_KIOSK_POWERED_BY_SUGARCRM' => 'Με την ισχύ του SugarCRM',
    'LBL_KIOSK_SAVE_CHANGES' => 'Αποθήκευση Αλλαγών',
    'LBL_KIOSK_SHOW_HIDE' => 'Εμφάνιση/Απόκρυψη',
    'LBL_KIOSK_SIGN_IN' => 'Σύνδεση',
    'LBL_KIOSK_SIGN_OUT' => 'Αποσύνδεση',
    'LBL_KIOSK_SORT_BY' => 'Ταξινόμηση κατά',
    'LBL_KIOSK_SUBMIT' => 'Υποβολή',
    'LBL_KIOSK_TIMEZONE' => 'Ζώνη Ώρας',
    'LBL_KIOSK_ACTIVITY' => 'Δραστηριότητα',
    'LBL_KIOSK_NO_ACTIVITY' => 'Δεν υπάρχει δραστηριότητα προς εμφάνιση',
    'LBL_KIOSK_OLDEST_FIRST' => 'Τα παλαιότερα πρώτα',
    'LBL_KIOSK_NEWEST_FIRST' => 'Τα νεότερα πρώτα',
    'LBL_KIOSK_SHOW_MORE' => 'Εμφάνιση περισσότερων',
    'LBL_KIOSK_ADD_A_REPLY' => 'Προσθέστε μια απάντηση',
    'LBL_KIOSK_REPLY_EMPTY' => 'Η απάντηση δεν μπορεί να μείνει κενή.',
    'LBL_KIOSK_NUM_MORE' => '{{num}} επιπλέον',
    'LBL_KIOSK_HOMEPAGE_WELCOME1' => 'Καλωσήρθατε',
    'LBL_KIOSK_HOMEPAGE_WELCOME2' => 'Αποκτήστε γρήγορη πρόσβαση στους πόρους σας.',
    'LBL_KIOSK_HOMEPAGE_SEARCH_PLACEHOLDER' => 'Αναζήτηση περιπτώσεων',
    'LBL_KIOSK_SHOW_ALL' => 'Εμφάνιση Όλων',
    'LBL_KIOSK_404_TITLE' => 'Δεν μπορέσαμε να το βρούμε αυτό',
    'LBL_KIOSK_TENANT_404_TITLE' => 'Ο μισθωτής δεν βρέθηκε',
    'LBL_KIOSK_404_MESSAGE' => 'Έχετε πατήσει έναν σύνδεσμο που έχει καταργηθεί ή δεν είναι διαθέσιμος προσωρινά, ή έχετε εισαγάγει μια μη έγκυρη διεύθυνση URL.',
    'LBL_KIOSK_TENANT_404_MESSAGE' => 'Βεβαιωθείτε ότι έχετε τη σωστή διεύθυνση URL. Για περαιτέρω βοήθεια, επικοινωνήστε με την Υποστήριξη.',
    'LBL_KIOSK_BACK_TO_HOME' => 'Επιστροφή στην αρχική',
    'LBL_KIOSK_ERROR_CODE' => '{code} Σφάλμα: ',
    'LBL_KIOSK_401_TITLE' => 'Μη Εξουσιοδοτημένο',
    'LBL_KIOSK_401_MESSAGE' => 'Δεν έχετε δικαίωμα να δείτε αυτή τη σελίδα.',
    'LBL_KIOSK_403_TITLE' => 'Μη Εξουσιοδοτημένο',
    'LBL_KIOSK_403_MESSAGE' => 'Δεν έχετε πρόσβαση για προβολή αυτής της σελίδας.',
    'LBL_KIOSK_500_TITLE' => 'Ο διακομιστής δεν ανταποκρίνεται',
    'LBL_KIOSK_500_MESSAGE' => 'Κάτι πήγε στραβά από την πλευρά μας.',
    'LBL_KIOSK_GO_BACK' => 'Πηγαίνετε πίσω',
    'LBL_KIOSK_DUPLICATE_ERROR' => 'Βρέθηκε διπλότυπη εγγραφή',
    'LBL_KIOSK_ACCOUNT' => 'Λογαριασμός',
    'LBL_KIOSK_STATUS' => 'Κατάσταση',
    'LBL_KIOSK_DEACTIVATE' => 'Απενεργοποίηση',
    'LBL_KIOSK_DEACTIVATE_SUCCESS' => 'Ο χρήστης έχει απενεργοποιηθεί',
    'LBL_KIOSK_MANAGE_USERS' => 'Διαχείριση χρηστών',
    'LBL_KIOSK_LAST_LOGIN' => 'Τελευταία σύνδεση',
    'LBL_KIOSK_FIRST_NAME' => 'Όνομα',
    'LBL_KIOSK_LAST_NAME' => 'Επώνυμο',
    'LBL_KIOSK_ROLE' => 'Ρόλος',
    'LBL_KIOSK_INVITE' => 'Πρόσκληση',
    'LBL_KIOSK_SEND_INVITES' => 'Αποστολή πρόσκλησης(εων)',
    'LBL_KIOSK_INVITE_USERS_SUCCESS' => 'Η(Οι) πρόσκληση(εις) στάλθηκε(αν) με επιτυχία',
    'LBL_KIOSK_INVITE_USERS_FAILURE' => 'Η(Οι) πρόσκληση(εις) δεν στάλθηκε(αν)',
    'LBL_KIOSK_REACTIVATE' => 'Επανενεργοποίηση',
    'LBL_KIOSK_REACTIVATE_SUCCESS' => 'Ο χρήστης επανενεργοποιήθηκε',
    'LBL_KIOSK_RESET_PASSWORD' => 'Επαναφορά Κωδικού Πρόσβασης',
    'LBL_KIOSK_RESET_PASSWORD_SUCCESS' => 'Το email επαναφοράς κωδικού πρόσβασης στάλθηκε',
    'LBL_KIOSK_USER_PROFILE' => 'Προφίλ χρήστη',
    'LBL_KIOSK_401_USER_BLOCKED_MESSAGE' => 'Ο χρήστης σας έχει απενεργοποιηθεί. Επικοινωνήστε με τον διαχειριστή σας.',
    'LBL_KIOSK_BACK_TO_LOGIN' => 'Επιστροφή στη σύνδεση',
    'LBL_KIOSK_REVOKE_INVITATION' => 'Ανάκληση πρόσκλησης',
    'LBL_KIOSK_REVOKE_INVITATION_SUCCESS' => 'Η πρόσκληση ανακλήθηκε με επιτυχία',
    'LBL_KIOSK_SEARCH_AND_SELECT' => 'Αναζήτηση και Επιλογή...',
    'LBL_KIOSK_NO_MATCHES' => 'Δεν βρέθηκαν αντιστοιχίες',
    'LBL_KIOSK_PROFILE_UPDATE_SUCCESS' => 'Το προφίλ έχει ενημερωθεί.',
    'LBL_KIOSK_PROFILE_UPDATE_ERROR' => 'Σφάλμα κατά την ενημέρωση του προφίλ.',
    'LBL_KIOSK_NOTES_SUBJECT_TITLE' => 'ΑΠ: {caseSubject}',
    'LBL_KIOSK_DOCUMENTS' => 'Έγγραφα',
    'LBL_KIOSK_DOCUMENTS_DESC' => 'Προβάλετε, αναζητήστε και κατεβάστε τα εισερχόμενα κοινόχρηστα έγγραφά σας.',
    'LBL_KIOSK_CASES' => 'Υποθέσεις',
    'LBL_KIOSK_CASES_DESC' => 'Προβάλετε, αναζητήστε και απαντήστε σε υποθέσεις που σας έχουν κοινοποιηθεί.',
    'LBL_KIOSK_DOWNLOAD' => 'Λήψη',
    'LBL_KIOSK_DOWNLOAD_SUCCESS' => 'Η λήψη του αρχείου ολοκληρώθηκε με επιτυχία',
    'LBL_KIOSK_FIRST_TIME_LOGIN_MODAL_TITLE' => 'Εισαγωγή',
    'LBL_KIOSK_FIRST_TIME_LOGIN_MODAL_DESCRIPTION' => 'Για να σας βοηθήσουμε καλύτερα, παρακαλούμε να μας δώσετε το όνομα και το επώνυμό σας.',
    'LBL_KIOSK_SAVE' => 'Αποθήκευση',
    'LBL_KIOSK_SHARED' => 'Κοινό',
    'LBL_KIOSK_HOMEPAGE_WELCOME1_PERSONAL' => 'Καλώς ήρθατε, {firstName} {lastInitial}.',
    'LBL_KIOSK_CONFIG_BACKGROUND_COLOR' => 'Χρώμα φόντου',
    'LBL_KIOSK_CONFIG_BACKGROUND_IMG_URL' => 'Διεύθυνση URL εικόνας φόντου',
    'LBL_KIOSK_CONFIG_BACKGROUND_IMG_URL_SUBTITLE' => 'Συνιστάται να επιλέξετε μια εικόνα με μέγεθος αρχείου μικρότερο από 400K.',
    'LBL_KIOSK_CONFIG_BACKGROUND_TYPE' => 'Τύπος φόντου',
    'LBL_KIOSK_CONFIG_HOME_TILE_TITLE' => 'Φόντο αρχικής σελίδας',
    'LBL_KIOSK_CONFIG_THEME_TILE_TITLE' => 'Θέμα',
    'LBL_KIOSK_CONFIG_THEME_PRIMARY_COLOR' => 'Χρώμα κύριου θέματος',
    'LBL_KIOSK_CONFIG_APP_NAME' => 'Όνομα εφαρμογής',
    'LBL_KIOSK_CONFIG_APP_NAME_SUBTITLE' => 'Αυτός είναι ο τίτλος της εφαρμογής σας και εμφανίζεται δίπλα στο λογότυπό σας.',
    'LBL_KIOSK_CONFIG_APP_LOGO_URL' => 'Διεύθυνση URL λογότυπου εφαρμογής',
    'LBL_KIOSK_CONFIG_APP_LOGO_URL_SUBTITLE' => 'Συνιστάται να επιλέξετε ένα λογότυπο που προβάλλεται καλύτερα σε μικρά μεγέθη (π.χ. προφίλ κοινωνικών μέσων). Συνιστάται επίσης να έχετε μέγεθος αρχείου μικρότερο από 200K.',
    'LBL_KIOSK_CONFIG_APP_FAVICON_URL' => 'Διεύθυνση URL favicon εφαρμογής',
    'LBL_KIOSK_CONFIG_APP_FAVICON_URL_SUBTITLE' => 'Το favicon είναι ένα μικρό λογότυπο που εμφανίζεται δίπλα στον τίτλο σελίδας σε καρτέλα του προγράμματος περιήγησης.',

    // Sugar Automate
    'LBL_UPDATE_ASSIGNEES' => 'Αυτόματη εκ νέου ανάθεση ανοιχτών δραστηριοτήτων',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_USER_LIMIT_REACHED' => 'Το όριο χρηστών επιτεύχθηκε',
    'LBL_CUSTOMER_JOURNEY_ERROR_INVALID_LICENSE_KEY' => 'Μη έγκυρο κλειδί άδειας',
    'LBL_CUSTOMER_JOURNEY_ERROR_INVALID_APPLICATION_LICENSE_KEY' => 'Μη έγκυρη εφαρμογή',
    'LBL_CUSTOMER_JOURNEY_ERROR_MISSING_LICENSE_KEY' => 'Μη έγκυρη εφαρμογή',
    'LBL_CUSTOMER_JOURNEY_ERROR_CORRUPT_VALIDATION_KEY' => 'Κατεστραμμένο κλειδί επικύρωσης',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_EXPIRED' => 'Η άδεια έληξε',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_MISSING_INFO' => 'Πληροφορίες που λείπουν',
    'LBL_CUSTOMER_JOURNEY_ERROR_MISSING_VALIDATION_KEY' => 'Κλειδί επικύρωσης που λείπει',
    'LBL_CUSTOMER_JOURNEY_ERROR_USER_MISSING_ACCESS' => 'Λείπει η πρόσβαση χρήστη',
    'LBL_DRI_WORKFLOW' => 'Έξυπνος Οδηγός',
    'LBL_DRI_WORKFLOWS' => 'Έξυπνοι Οδηγοί',
    'LBL_DRI_SUBWORKFLOW_TEMPLATE' => 'Πρότυπο σταδίων Έξυπνου οδηγού',
    'LBL_DRI_SUBWORKFLOW_TEMPLATES' => 'Πρότυπα σταδίων Έξυπνου οδηγού',
    'LBL_DRI_WORKFLOW_TEMPLATE' => 'Πρότυπο Έξυπνου οδηγού',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATE' => 'Πρότυπο δραστηριότητας Έξυπνου οδηγού',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATES_SUBPANEL_TITLE' => 'Πρότυπα Δραστηριότητας',
    'LBL_CJ_WEBHOOKS_SUBPANEL_TITLE' => 'Άγκιστρα Ιστού',
    'LBL_CJ_WEBHOOKS' => 'Άγκιστρα ιστού Sugar Automate',
    'LBL_CURRENT_CJ_ACTIVITY_AT' => 'Τρέχουσα δραστηριότητα Έξυπνου οδηγού στο',
    'LBL_CJ_WEBHOOKS' => 'Άγκιστρα ιστού Sugar Automate',
    'LBL_CJ_WEBHOOK' => 'Άγκιστρο ιστού Sugar Automate',
    'LBL_CJ_FORMS_SUBPANEL_TITLE' => 'Ενέργειες Sugar',
    'LBL_CJ_FORMS' => 'Ενέργειες Sugar σχετικά με τον Smart Guide',
    'LBL_CJ_FORM' => 'Ενέργεια Sugar σχετικά με τον Smart Guide',
    'LBL_DRI_SUBWORKFLOW' => 'Στάδιο Έξυπνου οδηγού',
    'LBL_DRI_SUBWORKFLOWS' => 'Στάδια Έξυπνου οδηγού',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATES' => 'Πρότυπα δραστηριότητας Έξυπνου οδηγού',
    'LBL_DRI_WORKFLOW_TEMPLATES' => 'Πρότυπα Έξυπνου οδηγού',
    'LBL_DRI_WORKFLOW_SORT_ORDER' => 'Σειρά Έξυπνου οδηγού',
    'LBL_CJ_ACTUAL_SORT_ORDER' => 'Πραγματική σειρά Έξυπνου οδηγού',
    'LBL_CUSTOMER_JOURNEY_SCORE' => 'Βαθμολογία Έξυπνου οδηγού',
    'LBL_CJ_MOMENTUM_POINTS' => 'Σημεία ώθησης Έξυπνου Οδηγού',
    'LBL_CJ_MOMENTUM_SCORE' => 'Βαθμολογία ώθησης Έξυπνου Οδηγού',
    'LBL_CJ_ALLOW_ACTIVITY_BY' => 'Ο Έξυπνος οδηγός επιτρέπει τη δραστηριότητα από',
    'LBL_CUSTOMER_JOURNEY_PROGRESS' => 'Πρόοδος Έξυπνου οδηγού',
    'LBL_CJ_MOMENTUM_RATIO' => 'Αναλογία ώθησης Έξυπνου Οδηγού',
    'LBL_CUSTOMER_JOURNEY_POINTS' => 'Σημεία Έξυπνου οδηγού',
    'LBL_CUSTOMER_JOURNEY_TYPE' => 'Εργασία Έξυπνου οδηγού',
    'LBL_CJ_PARENT_ACTIVITY_TYPE' => 'Τύπος γονικής δραστηριότητας Έξυπνου οδηγού',
    'LBL_CUSTOMER_JOURNEY_BLOCKED_BY' => 'Έξυπνος οδηγός αποκλεισμένος από',
    'LBL_CJ_BLOCKED_BY_STAGES' => 'Έξυπνος οδηγός αποκλεισμένος από στάδια',
    'LBL_CJ_PARENT_ACTIVITY_ID' => 'Ταυτότητα γονικής δραστηριότητας Έξυπνου οδηγού',
    'LBL_START_NEXT_JOURNEY_ID' => 'Εκκίνηση ταυτότητας επόμενου έξυπνου οδηγού',
    'LBL_CJ_URL' => 'Διεύθυνση Url Έξυπνου οδηγού',
    'LBL_IS_CJ_PARENT_ACTIVITY' => 'Είναι γονική δραστηριότητα Έξυπνου οδηγού',
    'LBL_CJ_MOMENTUM_START_DATE' => 'Ημερομηνία έναρξης ώθησης Έξυπνου οδηγού',
    'LBL_CJ_MOMENTUM_END_DATE' => 'Ημερομηνία λήξης ώθησης Έξυπνου οδηγού',
    'LBL_WIDGET_LAYOUT_CONFIGURATION_HEADER' => 'Διαμόρφωση διάταξης γραφικού στοιχείου',
    'LBL_WIDGET_LAYOUT_CONFIGURATION' => 'Διαμόρφωση διάταξης γραφικού στοιχείου',
    'CJ_SAME_JOURNEY_LIMIT_REACH_EXCEPTION' => 'Μέγιστος αριθμός Έξυπνων οδηγών από το ίδιο πρότυπο',
    'LBL_CUSTOMER_JOURNEY_WIDGET_ACTIVE' => 'Ενεργό',
    'LBL_CUSTOMER_JOURNEY_WIDGET_ARCHIVE' => 'Αρχειοθετήθηκε',
    'LBL_CUSTOMER_JOURNEY_STAGE_NUMBER_SHOW' => 'Εμφάνιση',
    'LBL_CUSTOMER_JOURNEY_STAGE_NUMBER_HIDE' => 'Απόκρυψη',
    'LBL_CJ_PRESENTATION_MODE_VERTICAL' => 'Κατακόρυφη λειτουργία',
    'LBL_CJ_PRESENTATION_MODE_HORIZONTAL' => 'Οριζόντια λειτουργία',
    'LBL_CUSTOMER_JOURNEY_INVALID_LICENSE' => 'Μη έγκυρη άδεια',
    'LBL_ASSIGNMENT_NOTIFICATION_HTML' => '<div>
    <p>{{assigned_by}} έχει αναθέσει τις ακόλουθες δραστηριότητες Έξυπνου οδηγού σε {{assigned_user}}.</p>
    <ul>{{activities}}</ul>
    
    <p>Μπορείτε να ελέγξετε αυτές τις δραστηριότητες στη διεύθυνση:<br/>
    <<a href=\"{{module_link}}\">{{module_link}}</a>></p>
    </div>',
    'LBL_CUSTOMER_JOURNEY_INVALID_LICENSE' => 'Μη έγκυρη άδεια',
    'LBL_CJ_REMAINING_DAYS_WHEN_USER_LIMIT_REACHED' => 'Το όριο χρήστη έχει επιτευχθεί, έχετε {{gracePeriodDays}} ημέρες για να αναβαθμίσετε την άδεια.',
    'LBL_ASSIGNMENT_NOTIFICATION_SUBJECT' => 'SugarCRM - Δραστηριότητες Έξυπνου οδηγού που έχουν ανατεθεί',
    'LBL_CUSTOMER_JOURNEY_USER_LIMIT_REACHED_DESCRIPTION' => 'Έχετε υπερβεί το όριο χρήστη σας {0} στο Sugar Automate<br>
    <br>
    Επικοινωνήστε με <a href=\"mailto:customersuccess@sugarcrm.com\">customersuccess@sugarcrm.com</a> για να αυξήσετε το όριο χρήστη ή να μειώσετε τον αριθμό χρηστών που χρησιμοποιούν το πρόσθετο.',
    'LBL_CUSTOMER_JOURNEY_USER_LIMIT_REACHED_NAME' => 'Το όριο χρηστών του Sugar Automate επιτεύχθηκε',
    'LBL_CUSTOMER_JOURNEY_LICENSE_ABOUT_TO_EXPIRE_DESCRIPTION' => 'Η άδεια σας για το Sugar Automate θα λήξει σε {0} ημέρες. <br>
    <br>
    Επικοινωνήστε με τη SugarCRM ή τον Συνεργάτη Sugar για να ανανεώσετε και να αποτρέψετε τη διακοπή της υπηρεσίας.',
    'LBL_CUSTOMER_JOURNEY_LICENSE_ABOUT_TO_EXPIRE_NAME' => 'Η άδεια χρήσης Sugar Automate πρόκειται να λήξει',
    'LBL_DEFAULT_TEST_WEB_HOOK_DASHLET_TITLE' => 'Δοκιμή άγκιστρου ιστού',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'Πρόοδος Smart Guide',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Εμφανίζει το γράφημα πίτας "Πρόοδος Smart Guide" του Sugar Automate.',
    'LBL_DEFAULT_TEST_WEB_HOOK_DASHLET_DESC' => 'Εμφανίζει την απόκριση άγκιστρου ιστού',
    'LBL_DASHLET_SEND_LABEL' => 'Αποστολή αιτήματος',
    'LBL_ASSIGN_ME_BUTTON_TITLE' => 'Ανάθεση σε εμένα',
    'LBL_COMPLETE_BUTTON_TITLE' => 'Ολοκληρωμένο',
    'LBL_COMPLETE_PARENT_BUTTON_TITLE' => 'Ολοκλήρωση όλων των εργασιών',
    'LBL_DELETE_STAGE_BUTTON_TITLE' => 'Διαγραφή σταδίου',
    'LBL_START_CYCLE_BUTTON_TITLE' => 'Έναρξη',
    'LBL_NOT_APPLICABLE_BUTTON_TITLE' => 'Δεν ισχύει',
    'LBL_ADD_STAGE_BUTTON_TITLE' => 'Προσθήκη σταδίου',
    'LBL_VIEW_JOURNEY_BUTTON_TITLE' => 'Προβολή',
    'LBL_EDIT_JOURNEY_BUTTON_TITLE' => 'Επεξεργασία Smart Guide',
    'LBL_CANCEL_JOURNEY_BUTTON_TITLE' => 'Ακύρωση',
    'LBL_ARCHIVE_JOURNEY_BUTTON_TITLE' => 'Αρχειοθέτηση',
    'LBL_UNARCHIVE_JOURNEY_BUTTON_TITLE' => 'Κατάργηση αρχειοθέτησης',
    'LBL_CONFIGURE_TEMPLATE_BUTTON_TITLE' => 'Διαμόρφωση προτύπου',
    'LBL_ADD_CJ_SUB_TASK_BUTTON_TITLE' => 'Προσθήκη εργασίας',
    'LBL_ADD_CJ_SUB_MEETING_BUTTON_TITLE' => 'Προγραμματισμός Συνάντησης',
    'LBL_ADD_CJ_SUB_CALL_BUTTON_TITLE' => 'Προγραμματισμός Κλήσης',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_FUTURE' => 'είναι στο μέλλον',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_OVERDUE' => 'είναι εκπρόθεσμο',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TODAY' => 'είναι σήμερα',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TOMORROW' => 'είναι αύριο',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TEXT' => '{{fieldName}} {{status}}
    {{formatUser}} ({{fromNow}})',
    'LBL_CJ_CANCEL_CONFIRMATION' => 'Είστε βέβαιοι ότι θέλετε να ακυρώσετε αυτό τον Έξυπνο Οδηγό;',
    'LBL_CJ_COMPLETE_ALL_TASKS_CONFIRMATION' => 'Πρόκειται να ολοκληρώσετε όλες τις εργασίες. Είστε βέβαιοι ότι θέλετε να προχωρήσετε;',
    'LBL_CJ_BLOCK_BY' => 'Έχετε μία μη επιλυμένη εξαρτημένη εργασία: {{Name}}. Ολοκληρώστε αυτή την εργασία πριν να Ολοκληρώσετε όλες τις εργασίες.',
    'LBL_CJ_MULTIPLE_BLOCK_BY' => 'Έχετε πολλαπλές μη επιλυμένες εξαρτημένες εργασίες. Ολοκληρώστε αυτές τις εργασίες πριν να Ολοκληρώσετε όλες τις εργασίες.',
    'LBL_CJ_COMPLETE_ALL_TASKS_COMPLETION' => 'Ολοκληρώσατε με επιτυχία όλες τις εργασίες',
    'LBL_CJ_ARCHIVE_CONFIRMATION' => 'Είστε βέβαιοι ότι θέλετε να αρχειοθετήσετε αυτό τον Έξυπνο Οδηγό;',
    'LBL_CJ_UNARCHIVE_CONFIRMATION' => 'Είστε βέβαιοι ότι θέλετε να καταργήσετε την αρχειοθέτηση αυτού του Έξυπνου Οδηγού;',
    'LBL_CJ_AS_A_DASHLET' => 'Sugar Automate: Έξυπνοι οδηγοί (συρτάρια εστίασης και κονσόλα)',
    'LBL_CJ_AS_A_DASHLET_DESC' => 'Προβολή ενεργών Έξυπνων Οδηγών στην κονσόλα υπηρεσιών/ανανεώσεων και στους πίνακες εργαλείων του συρταριού εστίασης.',
    'LBL_CJ_PROCESSING_REQUEST' => 'Επεξεργασία..',
    'LBL_CJ_SUCCESS' => 'Ολοκληρώσατε με επιτυχία όλες τις εργασίες',
    'LBL_CUSTOMER_JOURNEY_MODULE_NOT_ENABLED' => 'Η ενότητα {module} δεν είναι ενεργοποιημένη',
    'LBL_RECORDVIEW_DISPLAY_SETTINGS_SAVED' => 'Όλες οι ρυθμίσεις οθόνης αποθηκεύονται.',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_MOMENTUM_DASHLET_TITLE' => 'Ώθηση Έξυπνου Οδηγού',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_MOMENTUM_DASHLET_DESC' => 'Εμφανίζει το διάγραμμα μετρητή "Ώθηση Έξυπνου Οδηγού" του Sugar Automate.',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'Πρόοδος Smart Guide',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Εμφανίζει το γράφημα πίτας "Πρόοδος Smart Guide" του Sugar Automate.',
    'CJ_PARENT_NOT_FOUND_EXCEPTION' => 'Δεν ήταν δυνατή η εύρεση γονικού στοιχείου',
    'CJ_NOT_FOUND_EXCEPTION' => 'Δεν ήταν δυνατή η εύρεση {moduleName} με {data}',
    'CJ_JOURNEY_NOT_COMPLETED_EXCEPTION' => 'Ο Έξυπνος οδηγός πρέπει να ολοκληρωθεί ή να ακυρωθεί πριν από την αρχειοθέτηση',
    'LBL_CUSTOMER_JOURNEY_LICENSE_LOAD_ERROR' => 'Το Sugar Automate δεν είναι ενεργοποιημένο στην τρέχουσα άδεια Sugar',
    'LBL_ACTION_NOT_FOUND' => 'Δεν βρέθηκε ενέργεια, επικοινωνήστε με τον διαχειριστή συστήματος',
    'LBL_CJ_SELECT_FIELD' => 'Επιλογή Πεδίου',
    'LBL_CJ_SELECT_OPERATOR' => 'Επιλογή χειριστή',
    'LBL_CJ_SELECT_VALUE' => 'Επιλογή τιμής',
    'LBL_CJ_ENTER_VALUE' => 'Εισαγωγή τιμής',
    'LBL_CJ_FORM_BATCH_TITLE' => 'Αποθήκευση εγγραφής',
    'LBL_CJ_FORM_BATCH_ACTIVE_SMART_GUIDES_DETECTED' => 'Εντοπίστηκαν ενεργοί έξυπνοι οδηγοί...',
    'LBL_CJ_FORM_BATCH_PROCESSING_ACTIVE_SUGAR_ACTIONS' => 'Επεξεργασία ενεργών δράσεων Sugar...',
    'LBL_CJ_FORM_BATCH_UPDATING_ACTIVE_SMART_GUIDES' => 'Ενημέρωση ενεργών έξυπνων οδηγών...',
    'LBL_CJ_FORM_BATCH_SUCCESS' => 'Η εγγραφή και οι σχετικοί Smart Guides ενημερώθηκαν με επιτυχία.',
    'LBL_CJ_FORM_BATCH_FAILURE' => 'Η ενημέρωση ενός συσχετισμένου έξυπνου οδηγού απέτυχε. Εάν το σφάλμα επιμένει, επικοινωνήστε με τον διαχειριστή Sugar για βοήθεια.',
    'LBL_CJ_FORM_BATCH_FAILURE_FOR_ADMIN' => 'Η ενημέρωση ενός συσχετισμένου έξυπνου οδηγού απέτυχε. Ελέγξτε τα <a href="index.php?action=LogView&module=Configurator&doaction=all&filter=Sugar+Actions+:+Sugar+Action+to+Smart+Guide" target="_blank">αρχεία καταγραφής</a> για να αντιμετωπίσετε το σφάλμα.',
    'LBL_CJ_ACTIVITY_LINK_SUCCESS' => 'Ο <a href="#{{module}}/{{id}}">{{name}}</a> {{moduleSingularLower}} συνδέθηκε με επιτυχία.',
    'LBL_CJ_ACTIVITY_LINK_ERROR' => 'Παρουσιάστηκε πρόβλημα σύνδεσης του <a href="#{{module}}/{{id}}">{{name}}</a> {{moduleSingularLower}}. Εάν το πρόβλημα επιμένει, επικοινωνήστε με την υποστήριξη Sugar.',
    'LBL_CJ_ACTIVITY_LINK_SUCCESS_PLURAL' => 'Το {{modulePluralLower}} συνδέθηκε με επιτυχία.',
    'LBL_CJ_ACTIVITY_LINK_ERROR_PLURAL' => 'Παρουσιάστηκε πρόβλημα σύνδεσης του {{modulePluralLower}}. Εάν το πρόβλημα επιμένει, επικοινωνήστε με την υποστήριξη Sugar.',
    'LBL_CJ_ACTIVITY_LINK_ERROR_GENERIC' => 'Παρουσιάστηκε πρόβλημα σύνδεσης του {{moduleSingularLower}}. Εάν το πρόβλημα επιμένει, επικοινωνήστε με την υποστήριξη Sugar.',
    'LBL_CJ_ACTIVITY_DUPLICATE_EXISTING' => 'Υπάρχει ήδη ένα {{moduleSingularLower}} με το όνομα <a href="#{{module}}/{{id}}">{{name}}</a> στο {{stage}} στάδιο.',
    'LBL_CJ_ACTIVITY_DUPLICATE_SELECTED' => 'Ένα {{moduleSingularLower}} με το όνομα <a href="#{{module}}/{{id}}">{{name}}</a> έχει ήδη επιλεγεί.',
    'LBL_CJ_ARCHIVED' => 'Αρχειοθετήθηκε',
    'LBL_SELECT_SMART_GUIDE_TEMPLATE_PLACEHOLDER' => 'Επιλογή προτύπου Smart Guide...',
    'LBL_ALL_SMART_GUIDES' => 'Όλοι οι Smart Guides',
    'LBL_ACTIVE_SMART_GUIDES' => 'Ενεργοί Smart Guides',
    'LBL_ARCHIVED_SMART_GUIDES' => 'Αρχειοθετημένοι Smart Guides',
    'LBL_VERTICAL_SCROLL_VIEW' => 'Κάθετη προβολή σε στοίβα',
    'LBL_HORIZONTAL_SCROLL_VIEW' => 'Οριζόντια προβολή κύλισης',
    'LBL_DRI_WORKFLOWS_FILTER' => 'Φίλτρο',

    // more MOBILE stuff
    'LBL_MOBILE_COPIED_TO_CLIPBOARD' => 'Αντιγράφηκε στο πρόχειρο.',
    'LBL_MOBILE_DELETE_ALL_OCCURRENCES' => 'Διαγραφή Όλων των Επαναλαμβανόμενων',
    'ERROR_RECURRENCE_EVENT_PARAMS' => 'Μη έγκυρες ρυθμίσεις επανάληψης',
    'ERROR_INTERVAL_INVALID' => 'Το διάστημα επανάληψης πρέπει να είναι μεταξύ 1 και 99',
    'LBL_RECURRENCE_ADD' => 'Διαμόρφωση',
    'LBL_REPEAT_DAYS' => 'Ημέρα(ες) του μήνα',
    'LBL_REPEAT_END_TYPES' => 'Επανάληψη',
    'LBL_MOBILE_DEFAULT_MAPS_APP' => 'Πάροχος πλοήγησης',
    'LBL_MOBILE_PDF_EMAIL' => 'Αποστείλετε το PDF {{{pdfTemplateName}}} με email',
    'LBL_MOBILE_EMAIL_SENDING' => 'Απεσταλμένη',
    'LBL_MOBILE_EMAIL_SENT' => 'Απεσταλμένο',
    'LBL_MOBILE_EMAIL_SAVED_DRAFT' => 'Το email αποθηκεύτηκε ως πρόχειρο.',
    'LBL_MOBILE_EMAIL_CHOOSE_ATTACHMENT' => 'Προσθήκη συνημμένου',
    'LBL_MOBILE_EMAIL_LOCAL_ATTACHMENT' => 'Ανεβάσετε από Τοπικό',
    'LBL_MOBILE_EMAIL_SUGAR_DOCUMENT_ATTACHMENT' => 'Έγγραφο Sugar',
    'LBL_DROPDOWN_VIEW_CHANGE_INFO' => 'Μια επεξεργασία που κάνατε σε αυτή την εγγραφή άλλαξε την προβολή.',
    'LBL_MOBILE_RELEASE_NOTE_ALL' => 'Σημειώσεις έκδοσης εφαρμογής SugarCRM για κινητά',
    'LBL_MOBILE_USER_GUIDE_ALL' => 'Εγχειρίδιο χρήσης εφαρμογής SugarCRM για κινητά',
    'ERR_MOBILE_ROOTED' => 'Δεν είναι δυνατή η χρήση του Sugar Mobile σε κινητή συσκευή που έχει υποστεί rooting. Ανοίξτε την εφαρμογή σε συσκευή που δεν έχει υποστεί rooting.',
    'LBL_VO_BUILD_ROUTE' => 'Δημιουργία διαδρομής',
    'LBL_FILTER_MY_DISTANCE_FILTER' => 'Το φίλτρο απόστασής μου',
    'LBL_ACTIONBUTTON_DOC_MERGE_STARTED' => 'Το έγγραφο θα δημιουργηθεί στο παρασκήνιο. Ανοίξτε τη σελίδα Συγχωνεύσεις εγγράφων για να έχετε πρόσβαση στο αρχείο.',
    'LBL_ACTIONBUTTON_DOC_MERGE_NO_TEMPLATE' => 'Η λήψη Προτύπου απέτυχε. Επικοινωνήστε με τον διαχειριστή σας για βοήθεια.',
    'LBL_MAP_ERROR_LOAD' => 'Δεν είναι δυνατή η φόρτωση χάρτη',
    'LBL_MAP_DISTANCE' => 'Απόσταση',
    'LBL_SELECT_UNIT_TYPE' => 'Τύπος μονάδας',
    'LBL_MAPS_UNIT_MILES' => 'Μίλια',
    'LBL_MAPS_UNIT_KILOMETERS' => 'Χιλιόμετρα',
    'LBL_RADIUS' => 'Ακτίνα',
    'LBL_ZIP_CODE' => 'Ταχυδρομικός κώδικας',
    'LBL_MOBILE_CHOOSE_ADDRESS' => 'Επιλογή διεύθυνσης',
    'LBL_MOBILE_ADDRESS_NOT_GEOCODED' => 'Δεν είναι δυνατή η δημιουργία γεωκώδικα από διεύθυνση:{{{address}}}',
    'LBL_MOBILE_GEOCODE_SAVE_ERROR' => 'Η εγγραφή δεν είναι γεωκωδικοποιημένη.',
    'LBL_MOBILE_GEOCODE_MANUAL_CONFIRM' => 'Η εγγραφή δεν περιέχει δεδομένα διεύθυνσης. Θέλετε να εντοπίσετε αυτή την εγγραφή στον χάρτη μη αυτόματα;',
    'LBL_ERR_SHOW_ON_MAP' => 'Το άνοιγμα χάρτη για επιλεγμένες εγγραφές απέτυχε.',
    'LBL_ERR_MISSING_ON_MAP' => 'Από ορισμένες εγγραφές λείπουν δεδομένα διεύθυνσης ή δεν εμφανίζονται',
    'LBL_MAPS_ROUTE' => 'Διαδρομή',
    'LBL_MAPS_PROVIDER' => 'Χάρτες Sugar',
    'LBL_MAPS_CURRENT_LOC_ERROR' => 'Δεν ήταν δυνατός ο καθορισμός της τρέχουσας τοποθεσίας.',
    'LBL_MAPS_MAX_COLLECTION_LENGTH' => '{{{num}}} εγγραφές το μέγιστο υποστηρίζονται για χαρτογράφηση.',
    'LBL_ALL_MODULES' => 'Όλες οι Ενότητες',
    'LBL_DRIVE_SHARE_LINK' => 'Κοινή χρήση συνδέσμου',
    'LBL_DRIVE_LOAD_FILES_ERROR' => 'Απέτυχε η φόρτωση των αρχείων.',
    'LBL_DRIVE_NAME_EMPTY_ERROR' => 'Το όνομα δεν μπορεί να είναι κενό',
    'LBL_DRIVE_FOLDER_CREATED' => 'Δημιουργήθηκε φάκελος.',
    'LBL_DRIVE_FOLDER_CREATE_ERROR' => 'Απέτυχε η δημιουργία φακέλου.',
    'LBL_DRIVE_FILE_UPLOAD_ERROR' => 'Απέτυχε η φόρτωση αρχείου.',
    'LBL_DRIVE_NO_ROOT_FOLDER' => 'Δημιουργήστε ριζικό φάκελο πρώτα',
    'LBL_EDIT_ALL_RECURRENCES' => 'Επεξεργασία όλων των Επαναλαμβανόμενων',
    'LBL_DROPBOX_FILE_NOT_AVAILABLE' => 'Δεν είναι δυνατό το άνοιγμα του αρχείου στο Dropbox',
    'LBL_FILE_NOT_AVAILABLE' => 'Δεν είναι δυνατό το άνοιγμα του αρχείου',
    'LBL_MAP_ROUTE_FROM_A_CURRENT_RECORD' => 'Οδηγίες',
    'LBL_MAPS_ROUTE_NOT_FOUND' => 'Δεν βρέθηκε δρομολόγιο για τα παρεχόμενα σημεία',
    'LBL_MAPS_IN_RADIUS_FROM_CURRENT_LOCATION' => 'Γειτονικό',
    'LBL_TAGS' => 'Ετικέτες',

    'LBL_CALLER_ID_SETTINGS' => 'Ρυθμίσεις αναγνώρισης κλήσης',
    'LBL_CALLER_ID_ENABLED' => 'Η αναγνώριση κλήσης ενεργοποιήθηκε',
    'LBL_CALLER_ID_ENABLED_TEXT' => 'Στις εισερχόμενες κλήσεις, εμφανίζεται το όνομα της επαφής ή του υποψήφιου πελάτη που αντιστοιχεί στον αριθμό τηλεφώνου.',
    'LBL_CALLER_ID_SETTINGS_HINT_IOS' => 'Για να επιτρέψετε στην εφαρμογή για κινητές συσκευές να εμφανίζει αναγνώριση κλήσης, ακολουθήστε αυτά τα βήματα στη συσκευή σας:<br><br>1. Ανοίξτε τις επιλογές Ρυθμίσεις iOS > Τηλέφωνο > Αποκλεισμός και αναγνώριση κλήσεων.<br>2. Ενεργοποιήστε την επιλογή "{{{brandName}}}".',
    'LBL_CALLER_ID_SETTINGS_HINT_ANDROID' => 'Για να επιτρέψετε στην εφαρμογή για κινητές συσκευές να εμφανίζει αναγνώριση κλήσης, ακολουθήστε αυτά τα βήματα στη συσκευή σας:<br>1. Ανοίξτε τις ρυθμίσεις της εφαρμογής.<br>2. Μεταβείτε στα Δικαιώματα.<br>3. Ενεργοποιήστε την Άδεια τηλεφώνου.<br><br> Για να ορίσετε αυτή την εφαρμογή ως το προεπιλεγμένο πρόγραμμα χειρισμού της αναγνώρισης κλήσεων, μεταβείτε στις ρυθμίσεις της συσκευής σας.<br>1. Μεταβείτε στις Εφαρμογές.<br>2. Επιλέξτε προεπιλεγμένες εφαρμογές.<br>3. Επιλέξτε την εφαρμογή Αναγνώρισης κλήσης και ανεπιθύμητης αλληλογραφίας.<br>4. Ορίστε αυτή την εφαρμογή ως προεπιλεγμένη.',
    'LBL_CALLER_ID_SYNC_HINT' => 'Ελέγξτε για τυχόν αλλαγές στα στοιχεία επικοινωνίας από εγγραφές (π.χ. Επαφές, Υποψήφιοι πελάτες) στην παρουσία σας στο Sugar.',
    'LBL_CALLER_ID_GO_TO_SETTINGS' => 'Μετάβαση στις Ρυθμίσεις',
    'LBL_CALLER_ID_SYNC' => 'Συγχρονισμός δεδομένων εγγραφών',
    'LBL_CALLER_ID_NOT_ENABLED' => 'Η αναγνώριση κλήσης πρέπει να είναι ενεργοποιημένη στις ρυθμίσεις συστήματος πριν από τον συγχρονισμό.',
    'LBL_CALLER_ID_SETUP_ENABLE' => 'Ενεργοποίηση',
    'LBL_CALLER_ID_SETUP_LATER_IN_SETTINGS' => 'Πιο κάτω στις ρυθμίσεις',
    'LBL_CALLER_ID_SETUP_HINT_ANDROID' => 'Αυτή η εφαρμογή υποστηρίζει τη δυνατότητα αναγνώρισης κλήσεων.<br> Για τη σωστή λειτουργία αυτής της δυνατότητας, αφού πατήσετε το κουμπί ενεργοποίησης, θα σας ζητηθεί να εκχωρήσετε δύο άδειες.<br> Για να διασφαλίσετε ότι η δυνατότητα αναγνώρισης κλήσεων λειτουργεί σωστά, πρέπει να εκχωρήσετε δικαιώματα διαχείρισης κλήσεων και να επιλέξετε αυτή την εφαρμογή ως το προεπιλεγμένο πρόγραμμα χειρισμού αναγνώρισης κλήσεων.<br> Εάν δεν εκχωρήσετε το δικαίωμα διαχείρισης κλήσεων, δεν θα μπορείτε να καταγράψετε κλήσεις που πραγματοποιούνται από την εφαρμογή.',
    'LBL_CALLER_ID_SETUP_HINT_IOS' => 'Για να επιτρέψετε στην εφαρμογή SugarCRM για κινητές συσκευές να εμφανίζει αναγνώριση κλήσης, ακολουθήστε αυτά τα βήματα στη συσκευή σας:<br><br>1. Ανοίξτε τις επιλογές Ρυθμίσεις iOS > Τηλέφωνο > Αποκλεισμός και αναγνώριση κλήσεων.<br>2. Ενεργοποιήστε την εφαρμογή.',
    'LBL_MOBILE_LAST_SYNC' => 'Τελευταίος συγχρονισμός',
    'LBL_CALLER_ID_SYNCING' => 'Συγχρονισμός με διακομιστή.',
    'LBL_NEVER' => 'Ποτέ',
    'LBL_RLI_MISSING_ERROR' => 'Το {{{moduleName}}} δεν μπορεί να είναι κενό.',
    'LBL_ADD_RELATED_RECORD' => 'Σχετικό {{{moduleSingular}}}',
    'LBL_CALLER_ID_NO_PERMISSION' => 'Δεν έχετε τα απαιτούμενα δικαιώματα για να χρησιμοποιήσετε την αναγνώριση κλήσης. Επικοινωνήστε με τον διαχειριστή σας.',
    'LBL_CALLER_ID_FETCHING' => 'Γίνεται συγχρονισμός...',
    'LBL_CALLER_ID_FETCH_ALL' => 'Επανασυγχρονισμός όλων των εγγραφών',
    'LBL_CALLER_ID_FETCH_NEW' => 'Έλεγχος για ενημερώσεις εγγραφών',

    'LBL_SORT_BY' => 'Ταξινόμηση κατά',
    'LBL_PRIMARY_SORT' => 'Πρωτεύουσα Ταξινόμηση',
    'LBL_SECONDARY_SORT' => 'Δευτερεύουσα Ταξινόμηση',
    'LBL_OF' => 'από',
    'LBL_TABLE_FREEZE_FIRST' => 'Πάγωμα Πρώτης Στήλης',
    'LBL_TABLE_SETTINGS_TITLE' => 'Επιλογές προβολής στήλης',
    'LBL_TABLE_SETTINGS_NO_COL' => 'Πρέπει να είναι επιλεγμένη τουλάχιστον μία στήλη.',
    'LBL_TABLE_TOGGLER_INFO' => 'Εμφανίστε ή αποκρύψτε στήλες και σύρετέ τις με τη σειρά που προτιμάτε.',
    'LBL_RUNTIME_FILTERS_TITLE' => 'Φίλτρα χρόνου εκτέλεσης',
    'LBL_FILTER_CONDITION' => 'Επιλογή Συνθήκης',
    'LBL_FILTER_VALUES' => 'Τιμές',
    'LBL_TABLE_EXPAND' => 'Ανάπτυξη Όλων',
    'LBL_TABLE_COLLAPSE' => 'Σύμπτυξη Όλων',
    'LBL_RUNTIME_FILTERS_DEFAULT' => 'Σφάλμα διακομιστή. Δεν ήταν δυνατή η φόρτωση σχετικών φίλτρων χρόνου εκτέλεσης.',

    // Pub/Sub
    'LBL_PUBSUB_MODULEEVENT_PUSHSUBS' => 'Συνδρομές ειδοποιήσεων push συμβάντων μονάδας Pub/Sub',
    'LBL_PUBSUB_MODULEEVENT_PUSHSUB' => 'Συνδρομή ειδοποιήσεων push συμβάντων μονάδας Pub/Sub',
];

$app_list_strings['configure_record_view_display_dom'] = [
    'panel_top' => 'Πίνακας - Επάνω μέρος',
    'panel_bottom' => 'Πίνακας - Κάτω μέρος',
    'tab_first' => 'Καρτέλα - Πρώτη',
    'tab_last' => 'Καρτέλα - Τελευταία',
];
...
$app_list_strings['library_type'] = ['Books' => 'Βιβλίο', 'Music' => 'Μουσική', 'DVD' => 'DVD', 'Magazines' => 'Περιοδικά'];
...
$app_list_strings['merge_status_list'] = [
    ...
    'success' => 'Επιτυχής',
    'canceled' => 'Ακυρώθηκε',
    'document_load' => 'Φόρτωση Προτύπου',
    'tags_extract' => 'Εξαγωγή Ετικετών',
    'tags_validate' => 'Επικύρωση Ετικετών',
    'data_retrieving' => 'Ανάκτηση Δεδομένων',
    'serialize_document' => 'Ανασύνθεση του εγγράφου',
    'send_document' => 'Αποστολή του εγγράφου σε εσάς',
];

$app_list_strings['merge_type_list'] = [
    'merge' => 'Συγχώνευση',
    'convert' => 'Συγχώνευση PDF',
    'multimerge' => 'Πολλαπλή συγχώνευση',
    'multimerge_convert' => 'Πολλαπλή συγχώνευση PDF',
    'labelsgenerate' => 'Δημιουργία ετικετών',
    'labelsgenerate_convert' => 'Δημιουργία ετικετών PDF',
    'excel' => 'Συγχώνευση Excel',
    'excel_convert' => 'Μετατροπή συγχώνευσης Excel',
    'presentation' => 'Συγχώνευση PowerPoint',
    'presentation_convert' => 'PowerPoint συγχώνευση PDF',
];
...
$app_list_strings['stage2_preferences_type'] = [
    'owner' => 'Οι Λογαριασμοί Μου',
    'favorites' => 'Αγαπημένοι Λογαριασμοί',
    'tags' => 'Λογαριασμοί με ετικέτα',
];
...
$app_strings['LBL_OWNERS'] = 'Ιδιοκτήτες';
$app_strings['LBL_DASHLET_CLOUD_DRIVE_NAME'] = 'Μονάδα cloud';
$app_strings['LBL_DASHLET_CLOUD_DRIVE_DESCRIPTION'] = 'Dashlet ενσωμάτωσης της Μονάδας Cloud';
$app_strings['LBL_COPY_GOOGLE_DRIVE_LINK'] = 'Αντιγραφή συνδέσμου';
$app_strings['LBL_DOWNLOAD_DRIVE_FILE'] = 'Λήψη';
$app_strings['LBL_CREATE_SUGAR_DOCUMENT'] = 'Δημιουργία εγγράφου Sugar';
$app_strings['LBL_DRIVE_UNABLE_TO_DOWNLOAD'] = 'Δεν είναι δυνατή η λήψη του αρχείου';
$app_strings['LBL_DRIVE_CLOUD_DASHLET_NOT_PRESENT'] = 'Το dashlet cloud δεν υπάρχει';
$app_strings['LBL_DRIVE_DOCUMENT_CREATED'] = 'Δημιουργήθηκε το έγγραφο Sugar';
$app_strings['LBL_SEND_TO_DOCUSIGN'] = 'Αποστολή στο DocuSign';
$app_strings['LBL_NO_SEND_TO_DOCUSIGN'] = 'Το DocuSign δεν είναι διαθέσιμο από αυτή την τοποθεσία.';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_WEP'] = 'Η συγχώνευση εγγράφου σε Word/Excel/PowerPoint δεν είναι διαθέσιμη από αυτή την τοποθεσία';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_DS'] = 'Η συγχώνευση εγγράφου σε DocuSign δεν είναι διαθέσιμη από αυτή την τοποθεσία';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_PDF'] = 'Η συγχώνευση εγγράφου σε PDF δεν είναι διαθέσιμη από αυτή την τοποθεσία';
$app_strings['LBL_DOCUSIGN_PERMISSIONS'] = 'Το υπογεγραμμένο αρχείο σας θα μεταφορτωθεί εδώ μόνο εάν έχετε άδεια μεταφόρτωσης σε αυτή την τοποθεσία.';
$app_strings['LBL_DOC_MERGE_TO'] = 'Συγχώνευση Εγγράφου σε';
...
$app_string['LBL_MY_FILES'] = 'Τα αρχεία μου';
$app_strings['LBL_SHARED_WITH_ME'] = 'Μοιράστηκε μαζί μου';
$app_strings['LBL_CLOUD_PROVIDER'] = 'Πάροχος Cloud';
...
$app_strings['LBL_SHARED_WITH_ME'] = 'Μοιράστηκε μαζί μου';
$app_strings['LBL_MY_FILES'] = 'Τα αρχεία μου';
$app_strings['LBL_UPLOAD_FILE'] = 'Μεταφόρτωση αρχείου';
$app_strings['LBL_FOLDER_NOT_FOUND'] = 'Ο φάκελος δεν βρέθηκε';
$app_strings['LBL_CREATE_FOLDER'] = 'Δημιουργία Φακέλου';
$app_strings['LBL_LOAD_MORE'] = 'Φόρτωση περισσότερων...';
$app_strings['LBL_NEW_FOLDER'] = 'Νέος Φάκελος';
$app_strings['LBL_FOLDER_NAME'] = 'Ονομα φακέλου: ';
$app_strings['LBL_PERMISSION_ERROR'] = 'Δεν έχετε άδεια να το κάνετε αυτό στην τρέχουσα διαδρομή.';
$app_strings['LBL_MICROSOFT_PERMISSION_ERROR'] = 'Δεν έχετε άδεια να προχωρήσετε στην τρέχουσα διαδρομή.';
$app_strings['LBL_FILE_UPLOADED'] = 'Το αρχείο έχει μεταφορτωθεί.';
$app_strings['LBL_LARGE_FILE_UPLOAD'] = 'Λόγω του μεγάλου μεγέθους του αρχείου σας, η μεταφόρτωση θα διαρκέσει λίγο.';
$app_strings['LBL_ERR_NO_FILE_ATTACHED'] = 'Μία ή περισσότερες εγγραφές εγγράφων δεν έχουν συνημμένο αρχείο. Επισυνάψτε αρχεία στις εγγραφές και δοκιμάστε ξανά ή συγχρονίστε μεμονωμένα συγκεκριμένες εγγραφές με αρχεία.';

$app_strings['LBL_CHECK_GOOGLE_CONNECTION'] = 'Η σύνδεση με την Google δεν βρέθηκε...';
$app_strings['LBL_CHECK_MICROSOFT_CONNECTION'] = 'Η σύνδεση με την Microsoft δεν βρέθηκε...';
$app_strings['LBL_CHECK_DROPBOX_CONNECTION'] = 'Η σύνδεση με το Dropbox δεν βρέθηκε...';
$app_strings['LBL_MICROSOFT_DELAY'] = 'Ο συγχρονισμός με το OneDrive ενδέχεται να διαρκέσει λίγο';
$app_strings['LBL_DRIVE_DELETE_CONFIRM'] = 'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτόν τον φάκελο;';
$app_strings['LBL_MICROSOFT_UPLOAD_COMPLETE'] = 'Η μεταφόρτωση στο OneDrive ολοκληρώθηκε.';
$app_strings['LBL_MICROSOFT_UPLOAD_COMPLETE_DESCRIPTION'] = ' ανέβηκε με επιτυχία.';
$app_strings['LBL_DRIVE_LOAD_PATH_ERROR'] = 'Σφάλμα κατά τη φόρτωση διαδρομών.';
$app_strings['LBL_INVALID_DRIVE_FILE'] = 'Παρουσιάστηκε σφάλμα επειδή το αρχείο είναι κατεστραμμένο.';
$app_strings['LBL_UPLOAD_AND_LINK_COMPLETE'] = 'Το έγγραφο <i>"{{documentName}}"</i> έχει αποθηκευτεί στη μονάδα cloud και έχει προστεθεί στη μονάδα Έγγραφα.';
$app_strings['LBL_NO_PERMISSION_FILE_ERROR'] = 'Δεν έχετε δικαίωμα διαγραφής αυτού του αρχείου.';
$app_strings['LBL_NO_PERMISSION_FOLDER_ERROR'] = 'Δεν έχετε δικαίωμα διαγραφής αυτού του φακέλου.';
$app_strings['LBL_NO_PERMISSION_FILE_UPLOAD_ERROR'] = 'Δεν έχετε δικαίωμα μεταφόρτωσης αρχείων σε αυτή την τοποθεσία.';
$app_strings['LBL_NO_PERMISSION_FOLDER_CREATE_ERROR'] = 'Δεν έχετε δικαίωμα δημιουργίας φακέλου σε αυτή την τοποθεσία.';
$app_strings['LBL_NO_FOLDER_CREATE'] = 'Δεν είναι δυνατή η δημιουργία φακέλων σε αυτή την τοποθεσία.';
$app_strings['LBL_NO_FILE_UPLOAD'] = 'Δεν είναι δυνατή η μεταφόρτωση αρχείων σε αυτή την τοποθεσία.';
$app_strings['LBL_SITES'] = 'Τοποθεσίες';
$app_strings['LBL_SHARED'] = 'Κοινό';
$app_strings['LBL_COPY_LINK_CONFIRMATION'] = 'Ο σύνδεσμος δημιουργήθηκε. Πατήστε το κουμπί για να αντιγράψετε τον σύνδεσμο στο πρόχειρό σας.';
$app_strings['LBL_COPY_CLIPBOARD_CONFIRMATION'] = 'Αντιγραφή στο πρόχειρο';


$app_list_strings['gc_status_list'] = [
    '-blank-' => '-κενό-',
    'Exact' => 'Ακριβής',
    'Null_address_components' => 'Ένα ή πολλά στοιχεία διεύθυνσης είναι άδεια',
    'Invalid_address' => 'Μη έγκυρη διεύθυνση, ο διακομιστής επέστρεψε False',
    'Invalid_server_response_not_XML' => 'Μη έγκυρη απόκριση διακομιστή, όχι XML',
    'Invalid_address_no_location' => 'Μη έγκυρη διεύθυνση, ο διακομιστής δεν επέστρεψε καμία τοποθεσία',
    'Ambiguous_address' => 'Διφορούμενη διεύθυνση, πολλαπλές αντιστοιχίσεις',
];
...
$app_list_strings['kiosk_available_language_dom'] = [['en_us', 'Αγγλικά (ΗΠΑ)']];
$app_list_strings['kiosk_available_timezone_dom'] = [
    ['est', 'Νέα Υόρκη (EST)'],
    ['pst', 'Λος Άντζελες (PST)'],
];
$app_list_strings['kiosk_case_status_dom'] = [
    ['Νέο', 'Νέο'],
    ['Ανατέθηκε', 'Ανατέθηκε'],
    ['Κλειστό', 'Κλειστό'],
    ['Εισαγωγή Σε Εκκρεμότητα', 'Εισαγωγή Σε Εκκρεμότητα'],
...
$app_list_strings['kiosk_invitations_roles_dom'] = [
    ['χρήστης', 'Χρήστης'],
    ['διαχειριστής, χρήστης', 'Διαχειριστής'],
    ['διαχειριστής λογαριασμού, χρήστης', 'Διαχειριστής λογαριασμού'],
];

$app_list_strings['kiosk_document_shared_dom'] = [
    ['last_30_days', 'Τελευταίες 30 Ημέρες'],
    ['last_90_days', 'Τελευταίες 90 Ημέρες'],
    ['this_year', 'Τελευταίο Έτος'],
    ['προσαρμοσμένο', 'Προσαρμοσμένες Σειρές'],
    ['όλα', 'Όλα'],
];
