...
代わりに、既存のレコードの値ではなく今入力した値を使用する場合は、[元にリセット] をクリックします。入力した値は既存のレコードに適用され、さらに追加の変更を加え、既存のレコードへの変更を確定する[保存] をクリックします。入力した値を使用して新しいレコードを作成するには、画面右上の[重複を無視して保存」をクリックします。',
    ...
    'LBL_ACTIVITY_TIMELINE_DASHLET_DESCRIPTION' => 'タイムラインには通話とEメールが表示され、 ' .
...
// Omnichannel
    ...
    'LBL_ACTIONBUTTON_STOP_ON_ERROR' => 'On Errorの停止',
    ...
    'LBL_ACTIONBUTTON_LINK' => 'リンク',
    'LBL_ACTIONBUTTON_COPY_PARENT' => '親値をコピー',
    'LBL_ACTIONBUTTON_PRESET' => 'プリセット',
    'LBL_ACTIONBUTTON_PRESET_PARENT' => '親からのプリセット',
    ...
    'LBL_ACTIONBUTTON_RECORD_VIEW' => '記録ビュー',
    'LBL_ACTIONBUTTON_RECORD_VIEW_DASHLET' => '記録ビューのダッシュレット',
    ...
    'LBL_KIOSK_MY_PROFILE_UPDATE_ERROR' => 'プロフィールの更新中にエラーが発生しました。',
    'LBL_KIOSK_MY_PROFILE_UPDATE_SUCCESS' => 'プロフィールが更新されました。',
    'LBL_KIOSK_NAME' => '名前',
    ...
    'LBL_KIOSK_SERVER_ERROR' => 'サーバーエラー',
    ...
    'LBL_KIOSK_HOMEPAGE_WELCOME1' => 'サービスセンターへようこそ',
    'LBL_KIOSK_HOMEPAGE_WELCOME2' => '必要なサポートが素早く得られます',
    'LBL_KIOSK_HOMEPAGE_SEARCH_PLACEHOLDER' => '検索ケース',
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY' => 'マイアクティビティ',
    'LBL_KIOSK_HOMEPAGE_LINK_MY_ACTIVITY_DESC' => '最近のケースアクティビティと共有中のケースを表示します。',
    'LBL_KIOSK_HOMEPAGE_LINK_SUBMIT' => 'ケースを送信',
    'LBL_KIOSK_HOMEPAGE_LINK_SUBMIT_DESC' => '新規の問い合わせはお気軽に投稿していただけます。',
    'LBL_KIOSK_SHOW_ALL' => 'すべて表示',
    'LBL_KIOSK_NOT_FOUND' => "これは見つかりませんでした。",
    'LBL_KIOSK_TENANT_NOT_FOUND' => 'テナントが見つかりません。',
    'LBL_KIOSK_404_ERROR' => '404 エラー：',
    ...
    'LBL_CJ_WEBHOOKS' => 'Sugar Automate ウェブフック',
    'LBL_CURRENT_CJ_ACTIVITY_AT' => '現在のスマートガイドアクティビティ時刻',
    'LBL_CJ_WEBHOOKS' => 'Sugar Automate ウェブフック',
    'LBL_CJ_WEBHOOK' => 'Sugar Automate ウェブフック',
    'LBL_CJ_FORMS_SUBPANEL_TITLE' => '関連Sugarアクション',
    'LBL_CJ_FORMS' => 'スマートガイド関連Sugarアクション',
    'LBL_CJ_FORM' => 'スマートガイド関連Sugarアクション',
    ...
    'LBL_CUSTOMER_JOURNEY_INVALID_LICENSE' => '無効なライセンス',
    ...
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'スマートガイド進捗状況',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Sugar Automate の「スマートガイド進捗状況」の円グラフを表示します。',
    ...
    'LBL_CONFIGURE_TEMPLATE_BUTTON_TITLE' => '構成',
    ...
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'Smart Guide の進行状況',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Sugar Automate の「Smart Guide の進行状況」を、円グラフで表示します。',
...
$app_list_strings['moduleListSingular']['EmbeddedFiles'] = '埋め込みファイル';
    ...
    $app_strings['LBL_LARGE_FILE_UPLOAD'] = 'ファイルサイズが大きいため、アップロードに時間がかかります。ファイルの準備が完了すると通知されます。';
