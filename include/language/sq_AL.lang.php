...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => [
        ...
        'CloudDrivePaths' => 'Shtigjet e njësisë së diskut të resë kompjuterike',
        ...
        'Geocode' => 'Gjeokodimi',
        'DRI_Workflows' => 'Udhëzuesit inteligjentë',
        'DRI_Workflow_Task_Templates' => 'Udhëzuesi inteligjent: shabllonet e aktivitetit',
        'DRI_SubWorkflows' => 'Fazat e udhëzuesit inteligjent',
        'DRI_Workflow_Templates' => 'Shabllonet e udhëzuesit inteligjent',
        'CJ_WebHooks' => '"Webhook të "Sugar Automate"',
        'CJ_Forms' => 'Veprimet e Smart Guide në Sugar',
        'DRI_SubWorkflow_Templates' => 'Shabllonet e fazës të udhëzuesit inteligjent',
        'PubSub_ModuleEvent_PushSubs' => 'Abonimet automatike në modulin e publikimit ose nënshkrimit',
    ],
    ...
    'moduleIconList' => [
        ...
        'ProductTypes' => 'Ll. pro',
        'ProductTemplates' => 'Shpr',
        'ProductBundles' => 'Pakp',
        'ProductBundleNotes' => 'Pakp',
        'Reports' => 'Ra',
        'Forecasts' => 'Parash',
        'ForecastWorksheets' => 'Tbpa',
        'ForecastManagerWorksheets' => 'Tmpa',
        'Quotas' => 'Fo',
        'VisualPipeline' => 'Knvi',
        'ConsoleConfiguration' => 'Kkon',
        'SugarLive' => 'SuLi',
        'Teams' => 'Ekp',
        'TeamNotices' => 'NjE',
        'Manufacturers' => 'Prod',
        ...
        'Campaigns' => 'Ca',
        'CampaignLog' => 'Idf',
        'CampaignTrackers' => 'Gjfsh',
        'Documents' => 'Dok',
        'DocumentRevisions' => 'Rshd',
        'Connectors' => 'Lidh',
        'Notifications' => 'Njof',
        'Sync' => 'Sink',
        'HintAccountsets' => 'Gllh',
        'HintNotificationTargets' => 'Mnjh',
        'HintNewsNotifications' => 'Njlh',
        'HintEnrichFieldConfigs' => 'Kfph',
        'ExternalUsers' => 'PJ',
        'ReportMaker' => 'KR',
        'DataSets' => 'GDh',
        'CustomQueries' => 'PP',
    ...
    'moduleListSingular' => [
        ...
        'ConsoleConfiguration' => 'Konfigurimi i panelit',
        'MobileDevices' => 'Pajisje portative',
        'SugarLive' => 'SugarLive',
        'Contracts' => 'Kontrata',
        'Quotes' => 'Kuota',
        'Products' => 'Produkti',
        ...
        'DataArchiver' => 'Arkivuesi i të dhënave',
        'ArchiveRuns' => 'Ekzekutimet e arkivit',
        'ExternalUsers' => 'Përdoruesi i jashtëm',
        ...
        'CloudDrivePaths' => 'Shtegu i njësisë së diskut të resë kompjuterike',
        ...
        'HintEnrichFieldConfigs' => 'Konfigurimet e fushës së plotësuar Hint',
        'Geocode' => 'Gjeokodimi',
        'DRI_Workflows' => 'Udhëzuesi inteligjent',
        'DRI_Workflow_Task_Templates' => 'Shablloni i aktivitetit i udhëzuesit inteligjent',
        'DRI_SubWorkflows' => 'Faza e udhëzuesit inteligjent',
        'DRI_Workflow_Templates' => 'Shablloni i udhëzuesit inteligjent',
        'CJ_WebHooks' => '"Web hook" i "Sugar Automate"',
        'CJ_Forms' => 'Veprim i Smart Guide në Sugar',
        'DRI_SubWorkflow_Templates' => 'Shabllon i fazës i udhëzuesit inteligjent',
        'PubSub_ModuleEvent_PushSubs' => 'Abonimi automatik në modulin e publikimit ose nënshkrimit',
    ],
 ...
 */
    ...
    'embed_report_dom' => [
        ...
        'Chart and Data Table' => 'Grafiku dhe tabela e të dhënave',
    ],
    'message_status_dom' => [
        '' => '',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'field_name_placement_dom' => [
        'field_on_side' => 'Pranë vlerës së fushës',
        'field_on_top' => 'Mbi vlerën e fushës',
    ],
    'payment_terms' => [
        '' => '',
        'Net 15' => 'Net 15',
...
//       it is the key for the default case_status_dom value
        ...
        'user_type_bool_dom' => [
            false => 'Përdorues i rregullt',
            true => 'Administrator',
        ],
        'user_type_group_bool_dom' => [
            true => 'Përdorues grupi',
        ],
        'user_type_portal_bool_dom' => [
            true => 'Përdoruesi i portalit API',
        ],
        'license_type_dom' => [
...
//       it is the key for the default quote_relationship_type_dom value
    ...
    /*Added entries 'Queued' and 'Sending' for 4.0 release..*/
        ...
        'dom_email_distribution' => ['' => '-Asnjëra',
        'direct' => 'drejtim direkt',
        'roundRobin' => 'Rotull-Robin',
        'leastBusy' => 'Më pak i zënët',
        ],
        'dom_email_distribution_for_auto_create' => ['roundRobin' => 'Rotull-Robin',
        'leastBusy' => 'Më pak i zënët',
        'none' => 'Asnjë',
        ],
        'dom_email_errors' => [1 => 'Selekto vetëm një përdorues kur i dërgoni artikujt e caktuar',
        2 => 'Duhet të caktoni vetëm artikujt e kontrollluar kur i dërgoni artikujt e caktuar.',
        ],
        'dom_email_bool' => ['bool_true' => 'Po',
        'bool_false' => 'Jo',
        ],
        'dom_int_bool' => [1 => 'Po',
        0 => 'Jo',
        ],
        'dom_switch_bool' => ['on' => 'Po',
        'off' => 'Jo',
        '' => 'Jo',],

        'dom_email_link_type' => ['sugar' => 'Klienti i emailit Sugar',
        'mailto' => 'Klient i emailit të jashtëm'],


        'dom_email_editor_option' => ['' => 'Format i emailit të çaktivizuar',
        'html' => 'HTML Email',
        'plain' => 'Email me tekst të thjeshtë'],

        'schedulers_times_dom' => ['not run' => 'Koha e drejtimit të fundit, nuk u ekzekutua',
        'ready' => 'Gati',
        'in progress' => 'Në progres',
        'failed' => 'dështuar',
        'completed' => 'Ka përfunduar',
...
//  'Sub-Query' => 'Sub Query',
        ...
        'wflow_fire_order_dom' => ['alerts_actions' => 'Alarmet pastaj veprimet',
...
//prospect list type dom
    ...
    // strings to pass to Flash charts
        ...
        'chart_types' => [
        'hBarF' => 'Shiriti horizontal (Në stivë)',
        'hGBarF' => 'Shiriti horizontal (I grupuar)',
        'vBarF' => 'Shiriti vertikal (Në stivë)',
        'vGBarF' => 'Shiriti vertikal (I grupuar)',
        'pieF' => 'Rreth',
        'funnelF' => 'Hinkë',
        'lineF' => 'Me vija',
        'donutF' => 'Unazë',
        ...
        'metric_context_list' => [
        'service_console' => 'Konsola e shërbimit',
        'renewals_console' => 'Konsola e rinovimeve',
        ],
    ...
    //Service Duration
        ...
        'show' => 'Shfaq listën e marrësve të mundshëm',
        'dont_show' => 'Mos shfaq marrësit e mundshëm',
        ],
        'docusign_recipient_type_list' => [
        'signer' => 'Nënshkruesi',
        'carbon_copy' => 'Shikuesi (kopje karboni)',
        'certified_delivery' => 'Shikuesi (dorëzim i konfirmuar)',
        ],
        ...
        'module_icons_dom' => [
        'sicon-arrow-down' => 'Shigjetë poshtë',
        'sicon-chevron-left' => 'Sigjetë "Chevron" majtas',
        'sicon-check' => 'Kontrollo',
        'sicon-clock' => 'Ora',
        'sicon-dashboard-default' => 'Paneli standard',
        'sicon-dashboard' => 'Paneli',
        'sicon-edit' => 'Modifiko',
        'sicon-caret-down' => 'Shigjetë "Caret" poshtë',
        'sicon-folder' => 'Dosja',
        'sicon-info' => 'Info',
        'sicon-kebab' => '3 pika',
        'sicon-link' => 'Lidhje',
        ...
        'sicon-logout' => 'Dil',
        'sicon-minus' => 'Minus',
        'sicon-folder-open' => 'Dosja e hapur',
        'sicon-plus-sm' => 'Plus Sm',
        'sicon-refresh' => 'Fresko',
        'sicon-plus' => 'Plus',
        'sicon-settings' => 'Parametrat',
        'sicon-arrow-right-double' => 'Shigjetë e dyfishtë djathtas',
        'sicon-reports' => 'Raportet',
        'sicon-user' => 'Përdoruesi',
        'sicon-upload' => 'Ngarko',
        'sicon-user-group' => 'Grupi i përdoruesve',
        'sicon-arrow-left-double' => 'Shigjetë e dyfishtë majtas',
        'sicon-chevron-up' => 'Shigjetë "Chevron" Lart',
        'sicon-caret-up' => 'Shigjetë "Caret" Lart',
        'sicon-star-fill' => 'Mbushje ylli',
        'sicon-download' => 'Shkarko',
        'sicon-close' => 'Mbyll',
        'sicon-tile-view' => 'Pamja në kuadrate',
        'sicon-list-view' => 'Pamja e listës',
        'sicon-thumbs-down' => 'Gishtat poshtë',
        'sicon-warning-circle' => 'Rrethi paralajmërues',
        'sicon-phone' => 'Telefoni',
        'sicon-email' => 'Email',
        'sicon-document' => 'Dokument',
        'sicon-note' => 'Shënim',
        'sicon-preview' => 'Pamje paraprake',
        'sicon-copy' => 'Kopjo',
        'sicon-launch' => 'Hap',
        'sicon-lock' => 'Kyç',
        'sicon-arrow-top-right' => 'Shigjetë djathtas lart',
        'sicon-full-screen' => 'Ekran i plotë',
        'sicon-full-screen-exit' => 'Dalja nga ekrani i plotë',
        'sicon-expand-left' => 'Zgjero majtas',
        'sicon-expand-right' => 'Zgjero djathtas',
        'sicon-focus-drawer' => 'Sirtari i fokusit',
        'sicon-ban' => 'Ndalim',
        'sicon-thumbs-up' => 'Gishtat lart',
        'sicon-search' => 'Kërkim',
        'sicon-calendar' => 'Kalendari',
        'sicon-calendar-lg' => 'Kalendari: Lg',
        'sicon-mobile-lg' => 'Celulari: Lg',
        'sicon-star-fill-lg' => 'Mbushje ylli: Lg',
        'sicon-star-outline-lg' => 'Përvijim ylli: Lg',
        'sicon-reset-lg' => 'Rivendos: Lg',
        'sicon-exchange-lg' => 'Këmbim: Lg',
        'sicon-help-lg' => 'Ndihmë: Lg',
        'sicon-close-lg' => 'Mbyll: Lg',
        'sicon-plus-lg' => 'Plus: Lg',
        'sicon-shortcuts-lg' => 'Shkurtesat: Lg',
        'sicon-search-lg' => 'Kërkim: Lg',
        'sicon-email-lg' => 'Email: Lg',
        'sicon-note-lg' => 'Shënim: Lg',
        'sicon-document-lg' => 'Dokumenti: Lg',
        'sicon-add-dashlet-lg' => 'Shto nënvizim: Lg',
        'sicon-collapse-lg' => 'Palos: Lg',
        'sicon-hamburger-lg' => 'Hamburger: Lg',
        'sicon-pin-fill-lg' => 'Mbushja e pineskës: Lg',
        'sicon-expand-lg' => 'Zgjero: Lg',
        'sicon-copy-lg' => 'Kopjo: Lg',
        'sicon-dashboard-lg' => 'Paneli: Lg',
        'sicon-star-outline' => 'Përvijim ylli',
        'sicon-reset' => 'Rivendos',
        'sicon-unlink' => 'Shkëput',
        'sicon-phone-lg' => 'Telefoni: Lg',
        'sicon-attach' => 'Bashkëngjit',
        'sicon-case-lg' => 'Rasti: Lg',
        'sicon-arrow-right-lg' => 'Shigjetë Djathtas: Lg',
        'sicon-check-circle-lg' => 'Kontrollo rrethin: Lg',
        'sicon-text-formatting' => 'Formatimi i tekstit',
        'sicon-check-circle' => 'Kontrollo rrethin',
        'sicon-upload-lg' => 'Ngarko: Lg',
        'sicon-flag-lg' => 'Raporto: Lg',
        'sicon-studio-lg' => 'Studio: Lg',
        'sicon-contact-lg' => 'Kontakt: Lg',
        'sicon-edit-lg' => 'Modifiko: Lg',
        'sicon-arrow-left' => 'Shigjetë majtas',
        'sicon-reply-all' => 'Përgjigju të gjithëve',
        'sicon-message-lg' => 'Mesazhi: Lg',
        'sicon-info-lg' => 'Info: Lg',
        'sicon-error-lg' => 'Gabim: Lg',
        'sicon-check-circle-line-lg' => 'Kontrollo vijën e rrethit: Lg',
        'sicon-warning-line-lg' => 'Vija e paralajmërimit: Lg',
        'sicon-arrow-up' => 'Shigjetë lart',
        'sicon-arrow-right' => 'Shigjetë djathtas',
        'sicon-nodes' => 'Nyjat',
        'sicon-hide' => 'Fshih',
        'sicon-help' => 'Ndihmë',
        'sicon-twitter' => 'Twitter',
        'sicon-message' => 'Mesazh',
        'sicon-sugar-predict-lg' => 'Lg: Parashikimi i Sugar',
        'sicon-sugar-predict' => 'Parashikimi i Sugar',
        'sicon-opportunity-lg' => 'Lg: Mundësi',
        'sicon-lead-lg' => 'Klient potencial: Lg',
        'sicon-account-lg' => 'Lg: Llogaria',
        'sicon-user-sm' => 'Përdoruesi: Sm',
        'sicon-quote-lg' => 'Citim: Lg',
        'sicon-equal' => 'Baraz',
        'sicon-slicers-xl' => 'Copëzues: Xl',
        'sicon-escalation-lg' => 'Përshkallëzim: Lg',
        'sicon-add-circle-lg' => 'Shto rreth: Lg',
        'sicon-add-line-lg' => 'Shto vijë: Lg',
        'sicon-add-target-lg' => 'Shto objektiv: Lg',
        'sicon-help-circle-lg' => 'Rrethi i ndihmës: Lg',
        'sicon-divide-line-lg' => 'Vijë e ndarë në dysh: Lg',
        'sicon-string' => 'Vargu',
        'sicon-filter' => 'Filtri',
        'sicon-number' => 'Numri',
        'sicon-format-lg' => 'Formati: Lg',
        'sicon-insights-lg' => 'Informacione: Lg',
        'sicon-invalid-circle-lg' => 'Rreth i pavlefshëm: Lg',
        'sicon-layout-xl' => 'Formati Xl',
        'sicon-layout-lg' => 'Formati: Lg',
        'sicon-multiply-line-lg' => 'Vija e shumëfishimit: Lg',
        'sicon-redo-lg' => 'Ribëj: Lg',
        'sicon-refresh-lg' => 'Fresko: Lg',
        'sicon-undo-lg' => 'Zhbëj: Lg',
        'sicon-activity-feed-xl' => 'Furnzimi i aktivitetit: Xl',
        'sicon-chevron-left-xl' => 'Shigjetë "Chevron" majtas: Xl',
        'sicon-close-xl' => 'Mbyll: Xl',
        'sicon-kebab-lg' => '3 pika: Lg',
        'sicon-insights-xl' => 'Informacion: Xl',
        'sicon-hide-lg' => 'Fshih: Lg',
        'sicon-kebab-xl' => '3 pika: Xl',
        'sicon-comment-xl' => 'Koment: Xl',
        'sicon-share-lg' => 'Ndaj: Lg',
        'sicon-trash' => 'Mbeturina',
        'sicon-launch-lg' => 'Hap: Lg',
        'sicon-thumbs-up-lg' => 'Gishtat lart: Lg',
        'sicon-thumbs-down-lg' => 'Gishtat poshtë: Lg',
        'sicon-warning-lg' => 'Paralajmërim: Lg',
        'sicon-wizard-circle-xl' => 'Rrethi i ekspertit: Xl',
        'sicon-bell-cross-lg' => 'Kryqi i ziles: Lg',
        'sicon-bell-lg' => 'Zilja: Lg',
        'sicon-daily-lg' => 'Ditore: Lg',
        'sicon-cloud-download-lg' => 'Shkarkimi nga reja: Lg',
        'sicon-unlock' => 'Shkyç',
        'sicon-news-lg' => 'Lajmet: Lg',
        'sicon-weekly-lg' => 'Javore: Lg',
        'sicon-knowledgebase-xl' => 'Baza e njohurive: Xl',
        'sicon-remove' => 'Hiq',
        'sicon-chevron-down' => 'Shigjetë "Chevron" poshtë',
        'sicon-slicers-lg' => 'Copëzues: Lg',
        'sicon-save-lg' => 'Ruaj: Lg',
        'sicon-info-circle-lg' => 'Rrethi i informacioneve: Lg',
        'sicon-chevron-right' => 'Sigjetë "Chevron" djathtas',
        'sicon-warning-circle-lg' => 'Rrethi i paralajmërimit: Lg',
        'sicon-right-paren-line-lg' => 'Kllapa djathtas: Lg',
        'sicon-comment-lg' => 'Koment: Lg',
        'sicon-target-lg' => 'Objektivi: Lg',
        'sicon-subtract-line-lg' => 'Vija e zbritjes: Lg',
        'sicon-settings-lg' => 'Parametrat: Lg',
        'sicon-left-paren-line-lg' => 'Kllapa majtas: Lg',
        'sicon-preview-lg' => 'Pamja paraprake: Lg',
        'sicon-thumbs-down-line-lg' => 'Vija e gishtave poshtë: Lg',
        'sicon-thumbs-up-line-lg' => 'Lg: Drejtëza e gishtave lart',
        'sicon-send-lg' => 'Dërgo: Lg',
        'sicon-contact-xl' => 'Kontakt: Xl',
        'sicon-wizard-circle-line-xl' => 'Vija e rrethit të ekspertit: XI',
        'sicon-trash-lg' => 'Mbeturina: Lg',
        'sicon-pin-lg' => 'Ngulit: Lg',
        'sicon-clock-lg' => 'Ora: Lg',
        'sicon-comment-line-xl' => 'Rreshti i komenteve: Xl',
        'sicon-dropdown-editor' => 'Ndryshuesi i lëshimit psohtë',
        'sicon-amazon' => 'Amazon',
        'sicon-bug' => 'Defekt',
        'sicon-catalog' => 'Katalog',
        'sicon-cloud' => 'Re kompjuterike',
        'sicon-config-api' => 'Api e konfigurimit',
        'sicon-config-nav' => 'Nav. i konfigurimit',
        'sicon-connectors' => 'Lidhësit',
        'sicon-contracts' => 'Kontratat',
        'sicon-currencies' => 'Monedhat',
        'sicon-diagnostics' => 'Diagnostikimet',
        'sicon-sugar-club' => 'Sugar Club',
        'sicon-email-campaign' => 'Fushata nëpërmjet emailit',
        'sicon-email-inbound' => 'Emaile në hyrje',
        'sicon-email-queue' => 'Radha e emaileve',
        'sicon-forecasts' => 'Parashikimet',
        'sicon-display-modules' => 'Modulet e shfaqjes',
        'sicon-email-contacts' => 'Kontakte me email',
        'sicon-import' => 'Importo',
        'sicon-log-viewer' => 'Paraqitësi i evidencave',
        'sicon-lab' => 'Lab',
        'sicon-map-pin' => 'Pineska e hartës',
        'sicon-manufacturers' => 'Prodhuesit',
        'sicon-update' => 'Përditëso',
        'sicon-content-security' => 'Siguria e përmbajtjes',
        'sicon-module-builder' => 'Ndërtuesi i modulit',
        'sicon-languages' => 'Gjuhët',
        'sicon-module-loader' => 'Ngarkuesi i modulit',
        'sicon-oauth-key' => 'Celësi i Oauth',
        'sicon-password-mgmt' => 'Menaxhimi i fjalëkalimit',
        'sicon-opportunities' => 'Mundësitë',
        'sicon-upgrade' => 'Përmirëso',
        'sicon-portal' => 'Portali',
        'sicon-product-types' => 'Llojet e produkteve',
        'sicon-quotes' => 'Ofertat',
        'sicon-relate-fields' => 'Lidhja e fushave',
        'sicon-repair' => 'Riparo',
        'sicon-role-mgmt' => 'Menaxhimi i roleve',
        'sicon-scheduler' => 'Planifikuesi',
        'sicon-shippers' => 'Dërguesit',
        'sicon-studio' => 'Studio',
        'sicon-web-logic' => 'Web Logic',
        'sicon-sugar-u' => 'Sugar U',
        'sicon-tax-rates' => 'Normat tatimore',
        'sicon-team-mgmt' => 'Menaxhimi i ekipeve',
        'sicon-team-perm' => 'Lejet e ekipit',
        'sicon-tracker' => 'Gjurmuesi',
        'sicon-workflow' => 'Rrjedha e punës',
        'sicon-mask' => 'Maska',
        'sicon-mask-disabled' => 'Maska është çaktivizuar',
        'sicon-email-archive' => 'Arkivi i emaileve',
        'sicon-mobile' => 'Celular',
        'sicon-archive' => 'Arkivi',
        'sicon-automate-scroll' => 'Pamja e lëvizjes vertikale',
        'sicon-automate-stacked' => 'Pamja e lëvizjes horizontale',
        'sicon-pdf-manager' => 'Menaxheri i Pdf',
        'sicon-my-sites' => 'Faqet e mia',
        'sicon-cloud-insights' => 'Informacionet në renë kompjuterike',
        'sicon-sugar-logo-24' => 'Logoja Sugar 24',
        'sicon-sugar-logo-16' => 'Logoja Sugar 16',
        'sicon-task-lg' => 'Detyra: Lg',
        'sicon-web-lg' => 'Uebi: Lg',
        'sicon-events-lg' => 'Ngjarjet: Lg',
        'sicon-sugar-logo-12' => 'Logoja Sugar 12',
        'sicon-tag' => 'Etiketë',
        'sicon-tag-lg' => 'Etiketa: Lg',
        'sicon-bell-lg-line' => 'Vija e ziles: Lg',
        'sicon-matrix-xxl' => 'Matrica: Xxl',
        'sicon-advanced-filter' => 'Filtër i avancuar',
        'sicon-rows-and-columns-xxl' => 'Rreshtat dhe kolonat: Xxl',
        'sicon-summation-details-xxl' => 'Detajet e përmbledhjes: Xxl',
        'sicon-summation-xxl' => 'Përmbledhje Xxl',
        'sicon-lock-lg' => 'Kyçi: Lg',
        'sicon-csv-file-xxl' => 'Skedari Csv: Xxl',
        'sicon-logo-linkedin' => 'Logoja e "Linkedin"',
        'sicon-briefcase' => 'Valixhe',
        'sicon-car-front' => 'Pjesa e përparme e makinës',
        'sicon-airplane' => 'Avion',
        'sicon-laptop' => 'Laptop',
        'sicon-logo-instagram' => 'Logoja e "Instagram"',
        'sicon-single-bed' => 'Shtrat tek',
        'sicon-tiktok' => 'Tiktok',
        'sicon-logo-snapchat' => 'Logoja e "Snapchat"',
        'sicon-video-lg' => 'Video: Lg',
        'sicon-reply' => 'Përgjigju',
        'sicon-subtract' => 'Zbrit',
        'sicon-arrow-up-circle-line' => 'Kontur rrethor me sigjetë lart',
        'sicon-asterisk' => 'Yll',
        'sicon-dot-circle-o-lg' => 'Rreth me pika O: Lg',
        'sicon-forward' => 'Përcill',
        'sicon-video' => 'Video',
        'sicon-gavel' => 'Çekiç',
        'sicon-login' => 'Identifikimi',
        'sicon-pdf-file-xxl' => 'Skedari Pdf: Xxl',
        'sicon-login-lg' => 'Identifikimi: Lg',
        'sicon-cloud-download-xl' => 'Shkarkimi në renë kompjuterike: Xl',
        'sicon-campaigns-lg' => 'Fushatat: Lg',
        'sicon-customer-journey-stages-lg' => 'Fazat e udhëtimit të klientëve: Lg',
        'sicon-role-mgmt-lg' => 'Menaxhimi i roleve: Lg',
        'sicon-default-module-lg' => 'Moduli i parazgjedhur: Lg',
        'sicon-quoted-line-items-lg' => 'Artikujt e rreshtave të kuotuar: Lg',
        'sicon-projects-lg' => 'Projektet: Lg',
        'sicon-process-business-rules-lg' => 'Rregullat tregtare të proceseve: Lg',
        'sicon-process-email-templates-lg' => 'Shabllonet e emaileve të proceseve: Lg',
        'sicon-processes-lg' => 'Proceset: Lg',
        'sicon-process-definitions-lg' => 'Përcaktimet e proceseve: Lg',
        'sicon-target-lists-lg' => 'Listat e synuara: Lg',
        'sicon-purchased-line-items-lg' => 'Artikujt e blerë: Lg',
        'sicon-user-group-lg' => 'Grupi i përdoruesve: Lg',
        'sicon-revenue-line-items-lg' => 'Artikujt e rreshtave të të ardhurave: Lg',
        'sicon-business-centers-lg' => 'Qendrat e biznesit: Lg',
        'sicon-logo-fb-simple' => 'Logo Fb, e thjeshtë',
        'sicon-forecasts-lg' => 'Parashikimet: Lg',
        'sicon-contracts-lg' => 'Kontratat: Lg',
        'sicon-purchase-lg' => 'Blerjet: Lg',
        'sicon-sugar-live-lg' => 'Sugar Live: Lg',
        'sicon-customer-journey-lg' => 'Udhëtimi i klientit: Lg',
        'sicon-data-privacy-lg' => 'Privatësia e të dhënave: Lg',
        'sicon-home-lg' => 'Faqja kryesore: Lg',
        'sicon-data-table' => 'Tabela e të dhënave',
        'sicon-medical-clipboard-lg' => 'Kujtesa mjekësore e fragmenteve: Lg',
        'sicon-privacy-lg' => 'Privatësia: Lg',
        'sicon-marketplace' => 'Tregu',
        'sicon-marketplace-lg' => 'Tregu: Lg',
        'sicon-blockquote-lg' => 'Citat i bllokuar: Lg',
        'sicon-casino-lg' => 'Kazino: Lg',
        'sicon-jacuzzi-lg' => 'Xhakuzi: Lg',
        'sicon-scissors-lg' => 'Gërshërë: Lg',
        'sicon-storage-lg' => 'Magazinimi: Lg',
        'sicon-fan-lg' => 'Ventilator: Lg',
        'sicon-medicine-lg' => 'Medikamente: Lg',
        'sicon-plant-lg' => 'Bimë: Lg',
        'sicon-telescope-lg' => 'Teleskop: Lg',
        'sicon-smart-phone-lg' => 'Telefon inteligjent: Lg',
        'sicon-coffee-lg' => 'Kafe: Lg',
        'sicon-martini-lg' => 'Martini: Lg',
        'sicon-cocktail-lg' => 'Koktej: Lg',
        'sicon-stadium-lg' => 'Stadium: Lg',
        'sicon-fire-lg' => 'Zjarr: Lg',
        'sicon-window-lg' => 'Dritare: Lg',
        'sicon-lotus-lg' => 'Lotus: Lg',
        'sicon-windmill-lg' => 'Mulli me erë: Lg',
        'sicon-spades-lg' => 'Maç: Lg',
        'sicon-hearts-lg' => 'Zemra: Lg',
        'sicon-diamonds-lg' => 'Rombe: Lg',
        'sicon-clubs-lg' => 'Spathi: Lg',
        'sicon-skull-lg' => 'Kafkë: Lg',
        'sicon-send' => 'Dërgo',
        'sicon-world-lg' => 'Bota: Lg',
        'sicon-airplane-lg' => 'Avion: Lg',
        'sicon-planet-lg' => 'Planet: Lg',
        'sicon-trainer-lg' => 'Trajner: Lg',
        'sicon-calculator-lg' => 'Makinë llogaritëse: Lg',
        'sicon-tv-lg' => 'TV: Lg',
        'sicon-video-player-lg' => 'Luajtës i videos: Lg',
        'sicon-media-player-lg' => 'Luajtës i medias: Lg',
        'sicon-decentralize-lg' => 'Decentralizo: Lg',
        'sicon-statistics-lg' => 'Statistikat: Lg',
        'sicon-virus-lg' => 'Virus: Lg',
        'sicon-shield-lg' => 'Mburojë: Lg',
        'sicon-plug-lg' => 'Prizë: Lg',
        'sicon-shuttle-lg' => 'Transporti: Lg',
        'sicon-soundwave-lg' => 'Valë tingulli: Lg',
        'sicon-graph-lg' => 'Grafik: Lg',
        'sicon-playlist-lg' => 'Listë për luajtje: Lg',
        'sicon-voice-recognition-lg' => 'Njohje e zërit: Lg',
        'sicon-machine-learning-lg' => 'Mësim automatik: Lg',
        'sicon-bed-lg' => 'Shtrat: Lg',
        'sicon-blueprint-lg' => 'Projektplan: Lg',
        'sicon-content-delivery-lg' => 'Ofrim i përmbajtjes: Lg',
        'sicon-questionnaire-lg' => 'Pyetësor: Lg',
        'sicon-presentation-lg' => 'Paraqitja: Lg',
        'sicon-organic-lg' => 'Organike: Lg',
        'sicon-transactions-lg' => 'Transaksione: Lg',
        'sicon-wand-lg' => 'Shkop: Lg',
        'sicon-bin-lg' => 'Kosh: Lg',
        'sicon-sync-lg' => 'Sinkronizo: Lg',
        'sicon-external-authentication-lg' => 'Autentifikimi i jashtëm: Lg',
        'sicon-tracking-activity-lg' => 'Gjurmimi i aktivitetit: Lg',
        'sicon-account' => 'Llogaria',
        'sicon-meetings-lg' => 'Mbledhjet: Lg',
        'sicon-stacked' => 'Pamja e ndarë horizontalisht',
        'sicon-sidebyside' => 'Pamja e ndarë vertikalisht',
        ],
    ...
    // Sugar Automate
        ...
        'none' => 'Asnjë',
        'create' => 'Në momentin e krijimit',
        'stage_start' => 'Në fillim të fazës',
        'previous_activity_completed' => 'Aktiviteti i mëparshëm i përfunduar',
        ],
        'dri_workflow_templates_target_assignee_list' => [
        'current_user' => 'Përdoruesi aktual',
        'parent_assignee' => 'Përfitues kryesor',
        ],
        'dri_workflow_task_templates_task_due_date_type_list' => [
        '' => '',
        'days_from_created' => 'Ditë nga momenti i krijimit',
        'days_from_stage_started' => 'Ditë nga fillimi i fazës',
        'days_from_previous_activity_completed' => 'Ditë nga aktiviteti i mëparshëm i përfunduar',
        'days_from_parent_date_field' => 'Ditë nga fusha e datës kryesore',
        'days_from_specific_activity_completed' => 'Ditët nga aktiviteti specifik i përfunduar',
        ],
        'dri_workflow_task_templates_momentum_start_type_list' => [
        '' => '',
        'created' => 'Momenti i krijimit',
        'stage_started' => 'Momenti i fillimit të fazës',
        'previous_activity_completed' => 'Momenti i përfundimit të aktivitetit të mëparshëm',
        'parent_date_field' => 'Në fushën e datës kryesore',
        'specific_activity_completed' => 'Aktiviteti specifik i përfunduar',
        ],
        ...
        '' => '',
        'customer_task' => 'Detyra e klientit',
        'milestone' => 'Arritje',
        'internal_task' => 'Detyrë e brendshme',
        'agency_task' => 'Detyrë e agjencisë',
        'automatic_task' => 'Detyrë automatike',
        ],
        ...
        'none' => 'Asnjë',
        'create' => 'Në momentin e krijimit',
        'stage_start' => 'Në fillim të nisjes së fazës',
        ],
        'dri_workflow_task_templates_target_assignee_list' => [
        'inherit' => 'Trashëgo',
        'current_user' => 'Përdoruesi aktual',
        'parent_assignee' => 'Përfituesi kryesor',
        'user' => 'Përdoruesi',
        'team' => 'Ekipi',
        'user_team' => 'Përdoruesi dhe ekipi',
        ],
        'dri_workflow_task_templates_assignee_rule_list' => [
        'inherit' => 'Trashëgo',
        'none' => 'Asnjë',
        'create' => 'Në momentin e krijimit',
        'stage_start' => 'Në momentin e nisjes së fazës',
        'previous_activity_completed' => 'Aktiviteti i mëparshëm i përfunduar',
        'specific_activity_completed' => 'Aktiviteti specifik i përfunduar',
        ],
        ...
        'in_progress' => 'Në progres',
        'not_completed' => 'Pa përfunduar',
        'completed' => 'Përfunduar',
        'cancelled' => 'Anuluar',
        ],
        'dri_workflow_templates_disabled_stage_actions_list' => [
        'stage_edit_button' => 'Modifiko fazën',
        'stage_add_task_button' => 'Krijo detyrë',
        'stage_add_meeting_button' => 'Planifiko mbledhje',
        'stage_add_call_button' => 'Planifiko telefonatë',
        'stage_delete_button' => 'Fshi fazë',
        ],
        'dri_workflow_templates_disabled_activity_actions_list' => [
        'activity_add_sub_task_button' => 'Shto detyrë',
        'activity_add_sub_meeting_button' => 'Planifiko mbledhje',
        'activity_add_sub_call_button' => 'Planifiko telefonatë',
        'activity_not_applicable_button' => 'Nuk zbatohet',
        'activity_delete_button' => 'Fshi',
        ],
        'dri_workflow_templates_cancel_action_list' => [
        'set_not_applicable' => 'Set i pazbatueshëm',
        'remove_open_activities' => 'Hiq aktivitetet e hapura',
        ],
        ...
        'skip_request' => 'Anashkalo kërkesën',
        'json' => 'JSON',
        'http_query' => 'Pyetje HTTP',
        ],
        ...
        '' => '',
        'before_create' => 'Para krijimit',
        'after_create' => 'Pas krijimit',
        'before_in_progress' => 'Para statusit "Në progres"',
        'after_in_progress' => 'Pas statusit "Në progres"',
        'before_completed' => 'Para statusit "Përfunduar"',
        'after_completed' => 'Pas statusit "Përfunduar"',
        'before_not_applicable' => 'Para statusit "I pazbatueshëm"',
        'after_not_applicable' => 'Pas statusit "I pazbatueshëm"',
        'before_delete' => 'Para fshirjes',
        'after_delete' => 'Pas fshirjes',
        ],
        'cj_webhooks_request_body_list' => [
        'journey_body' => 'Dërgo informacion rreth udhëzuesit inteligjent',
        'custom_body' => 'Dërgo trupin e postimit të personalizuar',
        ],
        'cj_forms_trigger_event_list' => [
        '' => '',
        'in_progress' => 'Në progres',
        'completed' => 'Përfunduar',
        'not_applicable' => 'I pazbatueshëm',
        ],
        'cj_forms_action_type_list' => [
        '' => '',
        'view_record' => 'Shfaq regjistrimin',
        'create_record' => 'Krijo regjistrim',
        'update_record' => 'Përditëso regjistrimin',
        ],
        'cj_forms_action_trigger_type_list' => [
        'automatic_create' => 'Krijo automatikisht regjistrim',
        'manual_create' => 'Krijo manualisht regjistrim',
        'automatic_update' => 'Përditëso automatikisht regjistrimin',
        'manual_update' => 'Përditëso manualisht regjistrimin',
        ],
        'cj_forms_parent_type_list' => [
        '' => '',
        'DRI_Workflow_Templates' => 'Shablloni i udhëzuesit inteligjent',
        'DRI_SubWorkflow_Templates' => 'Shablloni i fazës',
        'DRI_Workflow_Task_Templates' => 'Shablloni i aktivitetit',
        ],
        ...
        'Tasks' => 'Detyra aktuale',
        'Calls' => 'Telefonata aktuale',
        'Meetings' => 'Mbledhja aktuale',
        ],
        'cj_select_to_options_list' => [
        '' => '',
        'specific_users' => 'Përdorues specifikë',
        'specific_contacts' => 'Kontakte specifike',
        'related_parent_users' => 'Përdorues kryesorë të lidhur',
        'related_parent_contacts' => 'Kontakte kryesore të lidhura',
        'add_all_contacts_from_parent' => 'Shto të gjitha kontaktet nga prindi',
        ],
        'cj_select_to_options_list_module_mapping' => [
        '' => '',
        'specific_users' => 'Përdoruesit',
        'specific_contacts' => 'Kontaktet',
        'related_parent_users' => 'Përdoruesit',
        'related_parent_contacts' => 'Kontaktet',
        'add_all_contacts_from_parent' => 'Kontaktet',
        ],
        ...
        '' => '',
        'smart_guide_to_sugar_action' => 'Veprim i Smart Guide në Sugar',
        'sugar_action_to_smart_guide' => 'Veprim i Sugar në Smart Guide',
        ],
        ...
        '' => '',
        'Smart Guide Stage' => 'Faza e Smart Guide',
        'Smart Guide Activities' => 'Aktivitetet e Smart Guide',
        ...
        'in_progress' => 'Në progres',
        'completed' => 'U krye',
        'not_applicable' => 'Nuk zbatohet',
        ],
        'dri_subworkflow_complete_action_list' => [
        '' => '',
        'mark_all_completed' => 'Shëno të gjitha aktivitetet si të përfunduara',
        'mark_all_not_applicable' => 'Shëno të gjitha aktivitetet e papërfunduara si "Nuk zbatohet"',
        ],
        'doc_merge_default_region_url' => [
        'us-west-2' => 'Shtetet e Bashkuara (Oregon) [us-west-2]',
        'ca-central-1' => 'Kanada (Qendrore) [ca-central-1]',
        'ap-southeast-1' => 'Azia e Paqësorit (Singapor) [ap-southeast-1]',
        'ap-southeast-2' => 'Azia e Paqësorit (Sidnei) [ap-southeast-2]',
        'eu-central-1' => 'Evropë (Frankfurt) [eu-central-1]',
        'eu-west-2' => 'Evropë (Londër) [eu-west-2]',
        ],
];
...
$app_strings = [
    ...
    'LBL_SIDEBAR_NAV_OPEN' => 'Hap',
    'LBL_SIDEBAR_NAV_CLOSE' => 'Mbyll',
    'LBL_SIDEBAR_NAV_ITEM_MENU' => 'Menyja {{subject}}',
    'LBL_GOTO_SUGARCRM_COM' => 'Shko te SugarCRM.com',
    ...
    'LBL_START' => 'Fillo',
    'LBL_END' => 'Përfundo',
    'LBL_DATE_LINKED' => 'Data e lidhjes',
 ...
 Ju lutemi ndryshoni vlerat.',
    ...
    'ERR_REPORTS_DISABLED_EXPORT' => 'Eksportimi i raporteve është i çaktivizuar',
    'ERR_REPORTS_ADMIN_EXPORT_ONLY' => 'Vetëm administratorët mund të eksportojnë',
    'ERR_REPORTS_EXPORT_NOT_ALLOWED' => 'Raporti përdor module pa akses në "Eksport"',
    'ERR_REPORTS_EXPORT_OWNER' => 'Raporti përdor module me akses në "Eksport" nga zotëruesi',
    'ERR_REPORTS_LIST_NOT_ALLOWED' => 'Raporti përdor module me akses të kufizuar në "Listë"',
    'ERR_REPORTS_VIEW_NOT_ALLOWED' => 'Raporti përdor module me akses të kufizuar në "Pamje"',
    'ERR_REPORTS_ACCESS_DISABLED' => 'Raporti përdor module me akses të kufizuar',
    'ERR_REPORTS_FIELDS_RESTRICTED' => 'Raporti përdor fusha me akses të kufizuar',
    ...
    'ERR_OPPORTUNITY_NAME_DUPE' => 'Ekziston tashmë një mundësi me emrin %s. Vendos një emër tjetër më poshtë.',
    ...
    'EXCEPTION_CLIENT_NOT_ALLOWED' => 'Ky klient nuk është i lejuar',
    'EXCEPTION_MODULELOADER_UPLOAD' => 'Funksionaliteti për të ngarkuar paketat nuk ofrohet për këtë lloj licence',
    ...
    'EXCEPTION_CLIENT_NOT_ALLOWED_DESC' => 'Ky klient nuk është i lejuar',
    ...
    'TPL_LISTVIEW_SELECTED' => 'Ju keni zgjedhur të {{num}} të dhënat në setin e rezultatit.',
    ...
    'LBL_USER' => 'Përdoruesi',
    'LBL_CURRENT_USER' => 'Përdoruesi aktual',
    ...
    'LBL_METRIC_DELETE_WARNING' => 'Përdoruesit me të cilët është ndarë skeda e metrikave do të humbasin gjithashtu të drejtën e aksesit.',
...
Kryerja e këtij veprimi do të të nxjerrë menjëherë dhe do të të duhet të vërtetosh sërish që je ti duke përdorur një aplikacion vërtetimi herën tjetër që do të identifikohesh.',
    ...
    // Console Metric Tabs
    'LBL_NO_METRIC_CONFIGURED' => 'Nuk është konfiguruar asnjë tabelë metrikash',
    'LBL_NO_METRIC_VISIBLE' => 'Asnjë tabelë metrikash e dukshme',
    'LBL_MAKE_METRIC_VISIBLE' => 'Zgjidh "organizo" për të bërë tabelat e metrikave të dukshme',
    'LBL_PLEASE_CONTACT_ADMIN' => 'Kontakto me administratorin tënd',
    ...
    'LBL_RELATED_RECORDS' => 'E lidhur {{module}}',
    ...
    'LBL_LEARNING_RESOURCES_SUGAR_OUTFITTERS_LINK' => 'Tregu i SugarOutfitters',
    ...
    'LBL_SINGULAR_LABEL' => 'Etiketim në njëjës',
    'LBL_PLURAL_LABEL' => 'Etiketim në shumës',
    'LBL_MODULE_DISPLAY' => 'Shfaq',
    'LBL_MODULE_DISPLAY_TYPE' => 'Lloji i paraqitjes',
    'LBL_MODULE_ICON' => 'Ikonë',
    'LBL_MODULE_COLOR' => 'Ngjyra e sfondit të modulit',
    'LBL_LANGUAGE_SELECTOR' => 'Gjuha',
    'LBL_MODULE_NAMES_AND_ICONS_SETTINGS' => 'Parametrat e modulit',
    'LBL_MODULE_NAMES_AND_ICONS_SETTINGS_SAVED' => 'Parametrat e modulit janë ruajtur.',
    ...
    'LBL_CCP_DIALOUT_NOT_ALLOWED' => 'Mbyll çdo sesion bisede në SugarLive përpara se të kryesh një thirrje dalëse.',
    ...
    'LBL_ADD_BUTTON_LABEL' => 'Shto',
    'LBL_EDIT_BUTTON_TITLE' => 'Ndrysho [Alt+E]',
    'LBL_REFRESH_BUTTON_LABEL' => 'Fresko',
    'LBL_REFRESH_BUTTON_TITLE' => 'Fresko',
    'LBL_DUPLICATE_BUTTON_KEY' => 'U',
    'LBL_DUPLICATE_BUTTON_LABEL' => 'Dublo',
    'LBL_DUPLICATE_BUTTON_TITLE' => 'Dublo [Alt+U]',
    'LBL_REPORT_SCHEDULES_BUTTON_LABEL' => 'Planifikimet e raportit',
    'LBL_REPORT_SCHEDULES_BUTTON_TITLE' => 'Planifikimet e raportit',
    'LBL_REPORT_DETAILS_BUTTON_LABEL' => 'Detajet e raportit',
    'LBL_REPORT_DETAILS_BUTTON_TITLE' => 'Detajet e raportit',
    ...
    'LBL_LAST_COMMIT' => 'Angazhimi i fundit: ',
    ...
    'LBL_TIMEZONE_UPDATED' => 'Sugar ka përditësuar zonën kohore të profilit tënd të përdoruesit për t&#39;u përputhur me zonën kohore të shfletuesit',
    'LBL_SUCCESS' => 'Sukses:',
    'LBL_ERROR' => 'Gabim',
    ...
    'LBL_YES' => 'Po',
    'LBL_NO' => 'Jo',
    'LBL_SHOW_NUMBERING' => 'Shfaq numërimin e fazave',
    'LBL_HIDE_NUMBERING' => 'Fshih numërimin e fazave',
    ...
    'ERR_OFFLINE_CLEAN_UP_CONFIRMATION' => 'Ka mbaruar hapësira për ruajtjen jashtë linje. Rekomandohet pastrimi i hapësirës së ruajtjes. Ky veprim mund të kërkojë disa minuta.',
    ...
    'LBL_ERR_EXPORTING_CSV' => 'Eksportimi dështoi',
    'LBL_ERR_EXPORT_ALL' => 'Nuk u arrit marrja e të dhënave për regjistrimet e zgjedhura, provo sërish',
    'LBL_LIST_SETTINGS_RESTORE' => 'Rikthe parazgjedhjet',
    'LBL_LIST_SETTINGS_RESTORE_CONFIRM' => 'Të rikthehen fushat?',
    'LBL_LIST_SETTINGS_TITLE' => 'Ndërtuesi i pamjes së listës',
    'LBL_LIST_SETTINGS_TEXT_TITLE' => 'Fushat e disponueshme',
    'LBL_LIST_SETTINGS_REMOVE' => 'Hiq',
    'LBL_LIST_SETTINGS_TEXT' => 'Tërhiq fushat në ndërtuesin e pamjes së listës dhe riorganizoji për të krijuar pamjen e listës së {{moduleName}}.',
    'LBL_LIST_SETTINGS_ERROR_EMPTY' => 'Të paktën një fushë duhet të shtohet në format.',
    'LBL_LIST_SETTINGS_EMPTY' => 'Nuk ka fusha të disponueshme',
    'LBL_LIST_SETTINGS_NO_MATCHING' => 'Nuk u gjetën fusha të përputhshme',
    'LBL_LIST_FILTER' => 'Kërkimi i fushës',
    'LBL_MOBILE_APP_EMAIL_CLIENT' => 'Klient i emailit',
    'LBL_DEFAULT_SYSTEM_CLIENT' => 'Klient i emailit të jashtëm',
    'LBL_SUGAR_MOBILE_CLIENT' => 'Klient i emailit të "Sugar"',
    'LBL_OFFLINE_CAPABILITIES' => 'Aktivizo aftësitë jashtë linje',
    'LBL_OFFLINE_TRANSACTION_DELETE_ERROR' => 'Fshirja e transaksionit nuk u krye.',
    'LBL_OFFLINE_TRANSACTION_DELETED' => 'Transaksioni u fshi.',
    'LBL_SECURE_MODE' => 'Modaliteti i përmirësuar i sigurisë',
    'LBL_SECURE_MODE_ANDROID_TEXT' => 'Aktivizo këtë parametër për të fshehur përmbajtjet e "Sugar Mobile" kur aplikacioni është në sfond dhe për të parandaluar pamjet e çastit të aplikacionit në çdo moment.',
    'LBL_SECURE_MODE_IOS_TEXT' => 'Aktivizo këtë parametër për të fshehur përmbajtjet e "Sugar Mobile" kur aplikacioni është në sfond.',
    'LBL_ALWAYS_OFFLINE_MODE' => 'Modaliteti "gjithmonë jashtë linje"',
    'LBL_ALWAYS_OFFLINE_MODE_ENABLED_PROMPT' => 'Po punon në modalitetin "gjithmonë jashtë linje". Dëshiron të rilidhesh?',
    'LBL_RECONNECT' => 'Rilidhu',
    'LBL_STAY_OFFLINE' => 'Qendro jashtë linje',
    'ERR_MOBILE_MODULE_NOT_SUPPORTED' => 'Moduli që po përpiqesh të aksesosh nuk është i disponueshëm në Sugar Mobile.',
    'LBL_MOBILE_RELEASE_NOTE' => 'Shënimet e versionit Sugar Mobile për {{platform}}',
    'LBL_MOBILE_USER_GUIDE' => 'Udhëzuesi i përdorimit të Sugar Mobile për {{platform}}',
    'LBL_OPERATOR_CONTAINING_THESE_WORDS' => 'me këto fjalë',
    'LBL_OPERATOR_EXCLUDING_THESE_WORDS' => 'pa këto fjalë',
    'LBL_NOTIFICATIONS_CHANNEL' => 'Përditësimet',
    'LBL_APPLY_BUTTON_LABEL' => 'Apliko',
    'LBL_ACTION_CREATE_FAILURE' => "Regjistri nuk u ruajt:\n {{{reason}}}",
    'LBL_ACTION_UPDATE_FAILURE' => "Regjistri nuk u përditësua:\n {{{reason}}}",
    'LBL_ACTION_FIELD_CALC_ERROR' => 'Dështoi zgjidhja e përllogaritjeve për fushat në server.',
    'LBL_ACTION_MODEL_VALIDATION_ERROR' => 'Fushat në vijim janë të pavlefshme: {{{fields}}}.',
    'LBL_ACTION_CREATE_RECORD_SUCCESS' => '<b>Sukses.</b> Krijove me sukses {{{module}}} <a href="#{{{recordUrl}}}">"{{{recordName}}}".</a>',
    'LBL_ACTION_UPDATE_SUCCESS' => '<b>Sukses.</b> Përditësove me sukses regjistrimin',
    'LBL_ACTION_COMPOSE_FAILED_DATA_FETCH' => 'Nuk u arrit marrja e të dhënave mbi emailin nga serveri.',
    'LBL_ASSIGN_SUCCESS' => '<b>Sukses.</b> Regjistrimi i është caktuar {{{userName}}}',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_TITLE' => 'Të ruhet ky email si një draft?',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_CONFIRM' => 'Ruaje si draft',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_CANCEL' => 'Anulo emailin',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_MSG' => 'Nëse nuk e ruan draftin, do e humbasësh këtë email.',
    'LBL_MOBILE_EMAIL_CHOOSE_SIGNATURE' => 'Zgjidh nënshkrimin',
    'LBL_MOBILE_EMAIL_CHOOSE_TEMPLATE' => 'Zgjidh shabllonin e emailit',
    'LBL_MOBILE_EMAIL_CONFIRM_TEMPLATE' => 'Shablloni do të mbivendosë të gjitha përmbajtjet në këtë email. Je i sigurt se dëshiron të përdorësh këtë shabllon dhe të mbivendosësh përmbajtjen?',
    'LBL_MOBILE_EMAIL_COMPOSE' => 'Harto email',
    'LBL_MOBILE_EMAIL_NO_RELATED_TO_WITH_TEMPLATE_SEND_ANYWAYS' => 'Emaili yt përmban variabla që do të zëvendësohen duke përdorur vlera nga regjistrimi "Ndërlidhur me". Konfirmo që fusha "Ndërlidhur me" është caktuar siç duhet përpara dërgimit.',
    'LBL_ERR_NO_OUTBOUND_ACCOUNTS_AVAILABLE' => 'Nuk u gjet llogari emaili dalëse. Kontakto me administratorin tënd të Sugar.',
    'LBL_EMAIL_MORE_RECIPIENTS' => ' dhe {{{count}}} më shumë',
    'LBL_RECEPIENTS_EMAIL_ADD' => 'Shto një email',
    'LBL_EMAIL_RECIPIENTS_EMPTY_HINT' => 'Shkruaj një emër ose email kontakti',
    'LBL_EMAIL_RECIPIENT_NEW_EMAIL' => '{{{email}}} (Email i ri)',
    'LBL_TEMPLATE_HAS_VARIABLES' => 'Variablat',
    'LBL_FILTER_EMAIL_TYPE_TEMPLATES' => 'Shabllonet e emailit',
    'LBL_FILTER_CAMPAIGN_TYPE_TEMPLATES' => 'Shabllonet e fushatës',
    'LBL_FILTER_WORKFLOW_TYPE_TEMPLATES' => 'Shabllonet e rrjedhës së punës',
    'LBL_FILTER_SYSTEM_TYPE_TEMPLATES' => 'Shabllonet e sistemit',
    'LBL_FILTER_EDIT' => 'Modifiko filtrin',
    'LBL_FILTER_MY_FILTER' => 'Filtri im',
    'LBL_FILTER_MY_FILTER_BY' => 'Filtri im sipas {{{filters}}}',
    'LBL_FILTER_SAVE' => 'Ruaj filtrin',
    'LBL_SELECT_PARAM' => 'Zgjidh',
    'LBL_SELECT_MODULES' => 'Përzgjedhësi i modulit',
    'LBL_SELECT_ADDITIONAL_PARAMS' => 'Zgjidh parametër shtesë',
    'LBL_FILTER_TEMPORARY' => 'Filtër i përkohshëm',
    'LBL_ERROR_FILE_UPLOAD' => 'Skedari {{{fieldLabel}}} nuk u ngarkua "{{{fileName}}}". {{{reason}}}',
    'LBL_ERROR_EDIT_FAILED_UPLOAD' => '<br/><a href="#{{{recordUrl}}}">Shiko regjistrimet e dështuara</a>',
    'LBL_FILE_UPLOAD_ONE' => 'Duke ruajtur skedarin...',
    'LBL_FILE_UPLOAD_MANY' => 'Duke ruajtur skedarin {{{index}}} nga {{{total}}}...',
    'LNK_NOTIFICATIONS_SETTINGS' => 'Parametrat e njoftimit',
    'LBL_PUSH_NOTIFICATIONS_SETTINGS' => 'Menaxho njoftimet e tua automatike',
    'LBL_PUSH_NOTIFICATIONS_SETTINGS_FOOTER' => "Kontrollo se si shfaqen njoftimet duke përdorur parametrat e njoftimit të pajisjes.",
    'LBL_NOTIFICATION_ASSIGMENTS' => 'Detyrat',
    'LBL_NOTIFICATION_ASSIGMENTS_DSC' => 'Merr njoftime në momentin që të caktohen regjistrimet.',
    'LBL_NOTIFICATION_MENTIONS' => 'Përmendjet',
    'LBL_NOTIFICATION_MENTIONS_DSC' => 'Merr njoftime kur përmendesh në evidencat e komenteve.',
    'LBL_NOTIFICATIONS_COMMENTLOG_MISSING' => 'Fusha e evidencës së komenteve nuk është shtuar në këtë format nga një administrator. Kontakto me administratorin tënd të Sugar.',
    'ERR_NO_PERMISSION_TITLE' => 'Lejo qasje',
    'ERR_NO_CAMERA_PERMISSION_MSG' => '{{{brandName}}} ka nevojë për qasje në kamera në mënyrë që të mund të bashkëngjitësh foto. Lejo qasjen në kamera në parametrat e sistemeve.',
    'LBL_MOBILE_SYSTEM_SETTINGS' => 'Parametrat',
    'LBL_ACTIVE_SUBSCRIPTIONS_FIELD_DURATION' => 'Kohëzgjatja',
    'LBL_ACTIVE_SUBSCRIPTIONS_FIELD_TIMEREMAINING' => 'Koha e mbetur',
    'LBL_LIST_SUPPORT_EXPIRES' => 'Skadon',
    'LBL_CASCADE_RLI_EDIT' => 'Përditëso artikujt në rreshtin e të ardhurave të hapura',
    'LBL_MOBILE_CALENDAR' => 'Kalendari',
    'LBL_MOBILE_CALENDAR_SETTINGS' => 'Parametrat e kalendarit',
    'LBL_MOBILE_CALENDAR_WEEK_START' => 'Dita e fillimit të javës',
    'LBL_MOBILE_CALENDAR_MODULES' => 'Ngjarjet për t&#39;u shfaqur',
    'LBL_MOBILE_CALENDAR_DURATION_HR_MIN' => '{{{hours}}}orë:{{{minutes}}} min',
    'LBL_MOBILE_CALENDAR_DURATION_HR' => '{{{hours}}} orë',
    'LBL_MOBILE_CALENDAR_DURATION_MIN' => '{{{minutes}}} minuta',
    'LBL_MOBILE_CALENDAR_TODAY' => 'Sot',
    'LBL_MOBILE_CALENDAR_CREATE_MSG' => 'Shto {{{moduleName}}}',
    'LBL_MOBILE_CALENDAR_CREATE_TITLE' => 'Planifiko një aktivitet',
    'LBL_MOBILE_CALENDAR_ERROR_NO_MODULE' => 'Aktivizo të paktën një lloj ngjarjeje.',
    'LBL_MOBILE_CALENDAR_EVENT_ALL_DAY' => 'Gjithë ditën',
    'LBL_MOBILE_CALENDAR_INITIALIZATION_ERROR' => 'Nuk u arrit ngarkimi i kalendarëve.',
    'LBL_ACTIONBUTTON_NOT_SUPPORTED_ACTION' => 'Ky veprim nuk është i disponueshëm në Sugar Mobile. Dëshiron të hapësh aplikacionin për desktop?',
    'LBL_DOC_MERGES_SELECT_TEMPLATE' => 'Zgjidh shabllonin',
    'LBL_DOC_MERGES_ACTION_MERGE' => 'Bashko',
    'LBL_ERROR_IMAGE_NO_EXIF' => 'Gabim: Mungojnë të dhënat EXIF nga skedari HEIC',
    'LBL_ERROR_IMAGE_TOO_BIG' => 'Gabim: Rezolucioni i imazhit është shumë i lartë',
    'LBL_ERROR_IMAGE_CANNOT_PROCESS' => 'Gabim: Imazhi nuk mund të përpunohet',
    'LBL_ERROR_IMAGE_CANVAS_FAILED' => 'Gabim: Nuk u arrit interpretimi i imazhit në fushën e krijimit',
    'LBL_ERROR_IMAGE_LOAD_FAILED' => 'Gabim: Nuk u arrit ngarkimi i skedarit si imazh',
    'LBL_ACTIONS_SELECTION_COUNT_SINGLE' => '1 artikull i përzgjedhur',
    'LBL_ACTIONS_SELECTION_COUNT_MULTIPLE' => '{{{count}}} artikuj të përzgjedhur',
    'LBL_ACTIONS_SELECT_ALL_TITLE' => 'Zgjidh të gjithë',
    'LBL_ACTIONS_SELECT_ALL_HEADER' => 'Ke zgjedhur {{{count}}} regjistrime në këtë pamje. Të zgjidhen të gjitha regjistrimet?',
    'LBL_ACTIONS_SELECT_ALL_VISIBLE' => 'Zgjidh {{{count}}} regjistrime',
    'LBL_ACTIONS_SELECT_DELETE_CONFIRM' => 'Je i sigurt që dëshiron të fshish regjistrimet e zgjedhura?',
    'LBL_ACTIONS_MASS_DELETE_PROGRESS' => 'Duke fshirë… {{{count}}} nga {{{total}}}',
    'LBL_ACTIONS_MASS_EMAIL_EMPTY' => 'Nuk u gjet asnjë email i vlefshëm në regjistrimet e zgjedhura',
    ...
    'LBL_OPERATOR_ONE_OF' => 'është një nga',
    'LBL_OPERATOR_NOT_ONE_OF' => 'nuk është një nga',
    'LBL_OPERATOR_CONTAINS' => 'është një prej',
    'LBL_OPERATOR_CONTAINS_WORD' => 'përmban',
    ...
    'LBL_OPERATOR_MORE_X_DAYS_AGO' => 'Më shumë se __ ditë më parë',
    'LBL_OPERATOR_LAST_X_DAYS' => '__ ditët e fundit',
    'LBL_OPERATOR_NEXT_X_DAYS' => '__ ditët e ardhshme',
    'LBL_OPERATOR_MORE_X_DAYS_AHEAD' => 'Më shumë se __ ditë në të ardhmen',
    ...
    'LBL_OPERATOR_AFTER_TODAY' => 'pas ditës së sotme',
    'LBL_OPERATOR_BEFORE_TODAY' => 'para ditës së sotme',
    ...
    'LBL_TEMPLATES' => 'Shabllone',
    'LBL_NON_TEMPLATES' => 'Jo shabllonet',
    ...
    'LBL_DISCOUNT_AMOUNT' => 'Zbritje',
    'LBL_MOBILE_CHOOSE_NAVIGATOR' => 'Zgjidh një aplikacion hartëzimi',
    'LBL_OVERWRITE_PROCESS_CLAIM_QUESTION' => '{{entityName}} i selektuar ka vlerat e lidhura: {{localizedFieldNames}}. Anulo për të mbajtur vlerat ekzistuese. Konfirmo që të shkruash vlera të reja.',
    'LBL_OFFLINE_DATA_ENCRYPTION_ENABLED' => 'Enkriptimi i të dhënave është aktivizuar.',
    'LBL_LEAD_ALREADY_CONVERTED' => 'Udhëheqësi i zgjedhur është konvertuar tashmë.',
    'LBL_OPERATION_NOT_AVAILABLE_OFFLINE' => 'Ky veprim disponohet vetëm kur pajisja është në linjë',
    'LBL_QUOTES_GENERATE_OPPORTUNITY' => 'A je i sigurt që dëshiron të krijosh një mundësi nga kuota?',
    'LBL_TAG_ADD' => 'Shto etiketë',
    'LBL_TAG_ENTER_TAG_NAME' => 'Fut etiketë',
    'LBL_TAG_OFFLINE_READ_NOT_SUPPORTED' => 'Filtrimi sipas etiketave nuk mbështetet ndërsa pajisja është jashtë linje.',
    'LBL_COMMENTLOG_SHOWCOMMENT' => 'Shfaq të gjithë komentin',
    'LBL_COMMENT_VIEW' => 'Shfaq një koment',
    'LBL_PMSE_LABEL_DUEDATE' => 'Afati',
    'LBL_PMSE_DUE' => 'Afat',
    'LBL_PMSE_DUE_ON' => 'Afati',
    'LBL_LEAD_CONVERSION_PARENT_RECORD_REQUIRED' => 'Krijo {{conversionParentModuleName}} fillimisht',
    'LBL_LEAD_CONVERSION_MISSING_REQUIRED' => 'Mungojnë regjistrimet e kërkuara: {{{missingRecords}}}',
    'LBL_IMAGE_QUALITY_SELECTOR_HINT' => 'Zgjidh cilësinë e imazhit. Imazhi do të ridimensionohet në përputhje me rrethanat, para se të ruhet në server. Vlera e zgjedhur do të përdoret si e paracaktuar për të gjitha veprimet e ngjashme në të ardhmen.',
    'LBL_IMAGE_QUALITY_SELECTOR_CALCULATING' => 'Duke vlerësuar madhësinë e skedarit...',
    'LBL_IMAGE_QUALITY_SELECTOR_CALCULATED' => 'Madhësia e vlerësuar e skedarit është',
    'LBL_IMAGE_QUALITY_SELECTOR_HEADER' => 'Cilësia e imazhit',
    'LBL_IMAGE_QUALITY_BEST' => 'Madhësia fillestare',
    'LBL_IMAGE_QUALITY_GOOD' => 'Cilësi e mirë',
    'LBL_IMAGE_QUALITY_POOR' => 'Madhësi e vogël',
    'LBL_IMAGE_QUALITY_BTN' => 'Ngjeshja: {{{rate}}}',
    'LBL_LIST_CONFIGURABLE_HEADER' => 'Rendit fushat në {{module}}',
    'LBL_LIST_RESET_FIELDS' => 'Rivendos në të paracaktuara',
    'LBL_LIST_NOT_ENOUGH' => 'Cakto të paktën 1 fushë aktive.',
    'LBL_LOGIN_PERMISSION_ABORTED' => 'Duhet të identifikohesh dhe të pranosh lejet për të punuar me instancën SugarCRM.',
    'LBL_SELECTING_EXISTING_RECORD' => 'Duke zgjedhur {{{moduleSingular}}}',
    'LBL_CREATING_NEW_RECORD' => 'Duke krijuar {{{moduleSingular}}} të ri',
    'LBL_IMAGE_QUALITY_SELECTOR_LABEL' => 'Përmasat e imazhit',
    'LBL_COPY_ADDRESS' => 'Kopjo adresën',
    'LBL_OPEN_IN' => 'Hap në',
    'LBL_MULTIATTACHMENTS_NO_FILE_SELECTED' => 'Nuk është zgjedhur skedar.',
    'LBL_ATTACHMENT_ADD' => 'Bashkëngjit',

    // Mobile cookie consent
    'LBL_USE_COOKIES_CONFIRM_TITLE' => 'Ky aplikacion përdor kuki',
    'LBL_USE_COOKIES_CONFIRM' => 'Ky aplikacion përdor kuki për të të ndihmuar të kesh një përvojë më të mirë. Duke vazhduar, ti miraton përdorimin e kukive në përputhje me politikat e privatësisë.',

    // Mobile warnings
    'WARN_SERVER_OUTDATED' => 'Po përdor një instancë Sugar që nuk do të jetë në përputhje me Sugar Mobile në një njoftim të ardhshëm celular. Kërkoji administratorit të përditësojë Sugar sa më shpejt të jetë e mundur.',
    'ERROR_TAG_NAME_INVALID' => 'Emri i etiketës nuk mund të përmbajë karaktere "{{{forbiddenChars}}}"',
    'ERROR_NO_TAGS_FOUND' => 'Asnjë etiketë e disponueshme nuk përputhet me "{{{searchQuery}}}"',
    'ERR_PA_RECORD_INVALID' => 'Regjistrimi i {{{moduleName}}} ka një ose më shumë vlera të pavlefshme dhe nuk mund të ruhet. Dëshiron të redaktosh regjistrimin në mënyrë që të kryesh veprimin {{{actionLabel}}}?',
    'ERR_MOBILE_METADATA_RELOAD' => 'Një administrator ka bërë ndryshime në konfigurimin në instancën tënde të Sugar. Shtyp OK për të sinkronizuar konfigurimin e aplikacionit me serverin.',
    ...
    'LBL_AGENT_WORKBENCH' => 'Konsola e shërbimit',
    ...
    'LBL_OMNICHANNEL_CONFIG_LAYOUT' => 'Konfiguro strukturën',
    ...
    //14.0 Dashboards
    'LBL_BRD__CONSOLE' => 'Paneli BDR',
    'LBL_SALES_MANAGER_CONSOLE' => 'Paneli i menaxherit të shitjeve',
    'LBL_SALES_REP_CONSOLE' => 'Paneli i përfaqësuesit të shitjeve',
    'LBL_MARKETING_CONSOLE' => 'Paneli i marketingut',
    'LBL_CUSTOMER_SUCCESS_CONSOLE' => 'Paneli i suksesit me klientët',
    'LBL_EXECUTIVE_CONSOLE' => 'Paneli ekzekutiv',

    // Omnichannel Console Config
    'LBL_RESTORE_TAB_DEFAULT' => 'Rikthe skedën në të paracaktuar',
    'LBL_CONFIGURE_SUMMARY_PANEL' => 'Konfiguro panelin e përmbledhjes',
    ...
    'LBL_CSP_ERROR_MESSAGE' => 'Vlera(t) që ke dhënë nuk mbështeten ose nuk janë në format të pranueshëm. Për një listë të vlerave dhe formateve të pranueshme të fushave, referoju dokumentacionit të <a href="{{linkToDocumentation}}" target="_blank">Sistemi</a>.',
    'LBL_CSP_ERROR_MESSAGE_ADMIN' => 'Kjo përmbajtje nuk është miratuar. Përditëso <a href="{{linkToDocumentation}}" target="_blank">Cilësimet e Politikës së Sigurisë së Përmbajtjes</a> të sistemit.',
    'LBL_CSP_ERROR_MESSAGE_USER' => 'Kjo përmbajtje nuk është miratuar. Kërkoji administratorit që të përditësojë <a href="{{linkToDocumentation}}" target="_blank">Cilësimet e Politikës së Sigurisë së Përmbajtjes</a> të sistemit. Pasi të jenë përditësuar cilësimet, do të duhet të rifreskosh shfletuesin që të zbatohen ndryshimet.',

    // For password related labels
    'LBL_PASSWORD' => 'Fjalëkalimi',
    'LBL_CHANGE_YOUR_PASSWORD' => 'Ndrysho fjalëkalimin',
    'LBL_PASSWORD_REQUIREMENTS' => 'Kërkesat e fjalëkalimit',
    'LBL_CURRENT_PASSWORD' => 'Fjalëkalimi aktual',
    'LBL_NEW_PASSWORD1' => 'Fjalëkalim i ri',
    'LBL_NEW_PASSWORD2' => 'Konfirmo fjalëkalimin',
    'LBL_PASSWORD_CHANGED' => 'Fjalëkalimi u ndryshua me sukses',
    ...
    'LBL_NO_CHART_REPORT_AVAILABLE' => 'Nuk ka grafik të disponueshëm.',
    'LBL_NO_FILTERS_REPORT_AVAILABLE' => 'Ky raport nuk përmban asnjë filtër.',
    'LBL_NO_RUNTIME_FILTERS_REPORT_AVAILABLE' => 'Ke fshehur vetëm filtrat e kohës së ekzekutimit, shih filtrat e avancuar.',
    'LBL_RUNTIME_FILTERS' => 'Filtrat e kohës së ekzekutimit',
    'LBL_RUNTIME_FILTER_DATE_PREF_MISSMATCH' => 'Data nuk përputhet me formatin e preferuar të datës të përdoruesit: ',
    'LBL_DASHLET_NO_RUNTIME_FILTERS' => 'Ky komponent i panelit nuk ka filtra të kohës së ekzekutimit',
    'LBL_DASHBOARD_FILTER_GROUP' => 'Filtër i ri',
    'LBL_RUNTIME_FILTER_LIMITATION' => 'Ju duhet të paktën një vlerë e zgjedhur.',
    'LBL_RESET_FILTERS_TO_DEFAULT' => 'Rivendos në filtrat e parazgjedhur',
    'LBL_COPY_FILTER_SUMMARY' => 'Kopjo përmbledhjen e filtrit',
    'LBL_APPLY_FILTERS' => 'Apliko',
    'LBL_REPORTS_FILTERS' => 'Filtrat',
    'LBL_RUNTIME_FILTERS_INVALID' => 'Filtrat e kohës së ekzekutimit nuk mund të aplikohen për shkak të vlerave të pavlefshme',
    'LBL_RUNTIME_FILTERS_COPIED' => 'Përmbledhja e filtrit është kopjuar në kujtesën e fragmenteve.',
    'LBL_ADVANCED_FILTERS' => 'Filtrat e avancuar',
    'LBL_ADVANCED_OR_DESC' => 'Përfshije kur NJË kusht të jetë përmbushur',
    'LBL_ADVANCED_AND_DESC' => 'Përfshije kur TË GJITHA kushtet të jenë përmbushur',
    'LBL_ORIGINAL_DESIGN_FILTER' => 'Ky është një filter i dizajnit origjinal',
    'LBL_AND_UPPERCASE' => 'DHE',
    'LBL_REPORTS_PREVIEW_LIMITATION' => 'Ky tipar nuk është i disponueshëm në modalitetin e pamjes paraprake',
    'LBL_REPORT_DEFAULT_NAME' => 'Raport i patitulluar',
    'LBL_REPORT_QUERY' => 'Pyetje',
    'LBL_REPORTS_DASHLET_INTELLIGENT' => 'Lidhur me regjistrin aktual',
    'LBL_REPORTS_DASHLET_RELATED_LINK' => 'Fusha e lidhur',
    'LBL_REPORTS_DASHLET_INVALID_LINK' => 'Fusha e lidhur nuk mund të jetë bosh',
    'LBL_REPORTS_DASHLET_INVALID_REPORT' => 'Nuk është zgjedhur asnjë raport.',
    'LBL_REPORTS_DASHLET_LINE_CHART_INVALID' => '"Grafiku i linjës" nuk është në përputhje me këtë raport',
    'LBL_REPORT_DASHLET' => 'Dashlet i raportit',
    'LBL_REPORTS_DASHLET_DATATABLE' => 'Tabela e të dhënave',
    'LBL_REPORTS_DASHLET_RUNTIME_FILTERS' => 'Filtrat e kohës së ekzekutimit',
    'LBL_REPORTS_DASHLET_DATATABLE_PREVIEW' => 'Pamja paraprake e tabelës së të dhënave',
    'LBL_REPORTS_DASHLET_CHART' => 'Grafik',
    'LBL_REPORTS_DASHLET_CHART_PREVIEW' => 'Pamja paraprake e grafikut',
    'LBL_REPORTS_DASHLET_FILTER_PREVIEW' => 'Pamja paraprake e filtrit',
    'LBL_REPORTS_DASHLET_INVALID_FEATURE' => 'Raporti i zgjedhur nuk e mbështet grafikun.',
    'LBL_REPORTS_DASHLET_LABELS' => 'Etiketat',
    'LBL_REPORTS_DASHLET_SHOW_COUNT' => 'Shfaq numrin total të regjistrave',
    'LBL_REPORTS_DASHLET_SORT_ORDER' => 'Rregullo renditjen',
    'LBL_REPORTS_DASHLET_DEFAULT_VIEW' => 'Pamja e zgjedhur si parazgjedhje',
    'LBL_REPORTS_DASHLET_PRIMARY_CHART_SORT' => 'Rendi parësor i renditjes së grafikut',
    'LBL_REPORTS_DASHLET_SECONDARY_CHART_SORT' => 'Rendi dytësor i renditjes së grafikut',
    'LBL_REPORTS_DASHLET_NO_LINKS_SELECTED' => 'Nuk ka lidhje {{module}} për raportin e zgjedhur',
    'LBL_REPORTS_DASHLET_NO_AVAILABLE_FOR_REPORT_TYPE' => 'Nuk ofrohet për këtë lloj raporti',
    'LBL_REPORTS_DASHLET_UNABLE_TO_DOWNLOAD_CHART_TAB' => 'Kjo veçori ofrohet vetëm në skedën e grafikut',
    'LBL_REPORTS_CHART_TYPE' => 'Lloji i diagramit',
    'LBL_REPORTS_CHART_CONFIG_VALUE_PLACEMENT' => 'Vendosja e vlerës së grafikur me shirita',
    'LBL_REPORTS_CHART_CONFIG_SHOW_TOTAL' => 'Shfaq totalin',
    'LBL_REPORTS_CHART_LEGEND_OPEN' => 'Shfaq legjendën',
    'LBL_REPORTS_CHART_CONFIG_SHOW_XAXIS_LABEL' => 'Trego etiketimin e boshtit x',
    'LBL_REPORTS_CHART_CONFIG_SHOW_YAXIS_LABEL' => 'Trego etiketimin e boshtit y',
    'LBL_REPORTS_DASHLET_CONFIGURE_DISPLAY_ROWS' => 'Kufiri i rreshtave të shfaqur',
    'LBL_REPORTS_DASHLET_RUNTIME_NO_PERMISSONS' => 'Nuk ke leje për të përdorur këto filtra të kohës së ekzekutimit.',
...
2. Kliko "Ruaj" për të finalizuar regjistrimin e ri dhe për t&#39;u kthyer në pamjen e listës {{plural_module_name}}.',
    ...
    'LBL_CALENDAR_REPEAT_ON' => 'Përsërit në',
    ...
    'TPL_REPEAT_INTERVAL' => 'Çdo {{repeatIntervalValue}} {{repeatTypeValue}}',
    'LBL_UNSUPPORTED_RRULE' => 'Seria përdor opsionin "Përsërit në" që nuk është i disponueshëm në Sugar pasi seria është sinkronizuar nga kalendari i klientit. Redakto serinë në kalendarin tënd të klientit nëse dëshiron të vazhdosh të përsërisësh në një datë të caktuar. Editimi i serisë në Sugar do të caktojë opsionin "Përsërit në" në Joaktiv.<br><br>Dëshiron të vazhdosh?',
    ...
    'LBL_CALENDAR_DAY' => 'ditë',
    'LBL_CALENDAR_WEEK' => 'javë',
    'LBL_CALENDAR_MONTH' => 'muaj',
    'LBL_CALENDAR_YEAR' => 'vit',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_2'  => 'e 2-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_3'  => 'e 3-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_4'  => 'e 4-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_5'  => 'e 5-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_6'  => 'e 6-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_7'  => 'e 7-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_8'  => 'e 8-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_9'  => 'e 9-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_10' => 'e 10-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_11' => 'e 11-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_12' => 'e 12-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_13' => 'e 13-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_14' => 'e 14-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_15' => 'e 15-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_16' => 'e 16-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_17' => 'e 17-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_18' => 'e 18-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_19' => 'e 19-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_20' => 'e 20-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_21' => 'e 21-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_22' => 'e 22-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_23' => 'e 23-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_24' => 'e 24-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_25' => 'e 25-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_26' => 'e 26-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_27' => 'e 27-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_28' => 'e 28-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_29' => 'e 29-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_30' => 'e 30-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_31' => 'e 31-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_32' => 'e 32-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_33' => 'e 33-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_34' => 'e 34-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_35' => 'e 35-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_36' => 'e 36-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_37' => 'e 37-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_38' => 'e 38-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_39' => 'e 39-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_40' => 'e 40-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_41' => 'e 41-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_42' => 'e 42-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_43' => 'e 43-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_44' => 'e 44-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_45' => 'e 45-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_46' => 'e 46-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_47' => 'e 47-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_48' => 'e 48-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_49' => 'e 49-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_50' => 'e 50-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_51' => 'e 51-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_52' => 'e 52-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_53' => 'e 53-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_54' => 'e 54-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_55' => 'e 55-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_56' => 'e 56-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_57' => 'e 57-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_58' => 'e 58-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_59' => 'e 59-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_60' => 'e 60-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_61' => 'e 61-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_62' => 'e 62-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_63' => 'e 63-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_64' => 'e 64-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_65' => 'e 65-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_66' => 'e 66-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_67' => 'e 67-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_68' => 'e 68-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_69' => 'e 69-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_70' => 'e 70-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_71' => 'e 71-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_72' => 'e 72-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_73' => 'e 73-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_74' => 'e 74-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_75' => 'e 75-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_76' => 'e 76-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_77' => 'e 77-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_78' => 'e 78-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_79' => 'e 79-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_80' => 'e 80-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_81' => 'e 81-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_82' => 'e 82-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_83' => 'e 83-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_84' => 'e 84-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_85' => 'e 85-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_86' => 'e 86-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_87' => 'e 87-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_88' => 'e 88-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_89' => 'e 89-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_90' => 'e 90-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_91' => 'e 91-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_92' => 'e 92-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_93' => 'e 93-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_94' => 'e 94-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_95' => 'e 95-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_96' => 'e 96-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_97' => 'e 97-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_98' => 'e 98-ta',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_99' => 'e 99-ta',
    ...
    'LBL_RECORD_DASHBOARD' => 'Paneli i regjistrimeve',
    ...
    'LBL_ACTIVITY_TIMELINE_DASHLET_DESCRIPTION' => 'Vija kohore shfaq të dhënat e lidhura me regjistrin aktual dhe përditësimet e fushave të zgjedhura me kalimin e kohës.',
...
// Omnichannel
    ...
    'LBL_ACTIONBUTTON_DOCUMENT_MERGE' => 'Bashkimi i dokumenteve',
    ...
    'LBL_ACTIONBUTTON_DISPLAY_ON_FOCUS_DASHBOARD' => 'Shfaq te koka e faqes së panelit të fokusit',
    'LBL_ACTIONBUTTON_DASHBOARD' => 'Paneli',
    'LBL_ACTIONBUTTON_FOCUS_DASHBOARD_HEADER' => 'Koka e faqes së panelit të fokusit',
    ...
    'LBL_ACTIONBUTTON_LINK' => 'Krijo lidhje me elementin parësor',
    'LBL_ACTIONBUTTON_COPY_PARENT' => 'Kopjo vlerat kryesore',
    'LBL_ACTIONBUTTON_PRESET' => 'Cakto vlerat e fushës',
    'LBL_ACTIONBUTTON_PRESET_PARENT' => 'Kopjo vlerat e fushës nga elementi parësor',
    ...
    'LBL_ACTIONBUTTON_RECORD_VIEW' => 'Koka e faqes së pamjes së regjistrimit',
    'LBL_ACTIONBUTTON_RECORD_VIEW_DASHLET' => 'Koka e faqes së komponentit të panelit të pamjes së regjistrimit',
    ...
    'LBL_ACTIONBUTTON_ASSIGN_CURRENT_USER' => 'Përdoruesi aktual',
    ...
    'LBL_HINT_MSG_OVERWRITE_ALL' => 'A dëshiron të mbishkruash të gjitha të dhënat ekzistuese për këtë regjistër me të dhënat e reja të zbuluara në Sugar Hint?',
    'LBL_HINT_MSG_OVERWRITE_FIELD' => 'A dëshiron të mbishkruash {{fieldName}} ekzistues për këtë regjistër me {{fieldName}} e ri të zbuluar në Sugar Hint?',
    ...
    'LBL_HINT_ACCOUNTSETS' => 'Etiketat e grupeve të llogarive të Sugar Hint',

    'LBL_HINT_LOADING' => 'Duke ngarkuar ...',
    'LBL_HINT_UNINSTALL_PROCESSING' => 'Duke çinstaluar Sugar Hint, prit',
    ...
    'LBL_HINT_UNINSTALL_PARTIAL_DESCRIPTION' => 'Ky opsion do të fshijë Hint MLP dhe do të çaktivizojë të gjitha abonimet aktive në Sugar Hint Insights.
    Riinstalimi i Hint do të riaktivizojë automatikisht abonimet.',
    ...
    'LBL_HINT_UNINSTALL_HEADER' => 'Çinstalo Sugar Hint',
    ...
    'LBL_HINT_UNINSTALL_WARNING_LINK' => 'Udhëzuesi i administrimit i Sugar Hint ', // TODO: This URL needs to be changed.
    'LBL_HINT_UNINSTALL_WARNING3' => 'për detaje lidhur me procesin e çinstalimit.',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE1' => 'Je i sigurt që dëshiron të çinstalosh vetëm paketën Sugar Hint?',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE2' => 'Je i sigurt që dëshiron të çinstalosh Sugar Hint plotësisht?',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE2_SUBTEXT' => '(SHËNIM: KY VEPRIM NUK MUND TË ZHBËHET)',

    'LBL_HINT_CONFIG_TITLE' => 'Fushat Sugar Hint',
    ...
    'LBL_HINT_RESYNC_NOTIFICATION_DESCRIPTION' => 'Kujdes: Je duke u sinkronizuar me shërbimin Sugar Hint Insights. Të gjitha përmbledhjet e emaileve të mbetura pezull do të humbasin dhe lajmet ekzistuese do të fshihen nga paneli i Insights. Njoftimet e të gjitha llojeve do të rinisin pas përfundimit të sinkronizimit.',
    ...
    'LBL_HINT_HELP_DEFAULT_MESSAGE1B' => "Vendos adresën e emailit të {{currentModule}} dhe Hint do të kërkojë për të dhëna shtesë.",
    ...
    'LBL_HINT_PREVIEW_LICENSE_EXPIRED' => 'Licenca jote për shërbimin Hint ka skaduar. Kontakto me administratorin tënd të SugarCRM për të rinovuar licencën.',
    'LBL_HINT_PREVIEW_QUESTION' => 'Dëshiron të shohësh se çfarë mund të bëjë Hint për ty dhe kompaninë tënde? Kontakto me administratorin tënd të SugarCRM për të shtuar Hint.',
    ...
    'LBL_HINT_DASHLET_ALLOWED1' => 'Duhet të kesh një licencë Sugar Hint për të parë panelin e Sugar Hint Insights.                                                                                                                                
   Pyet administratorin tënd rreth marrjes së një licence Sugar Hint.',
    ...
    'LBL_NOTIFICATIONS_TITLE' => 'Qendra e preferencave të Sugar Hint Insights',
    ...
    'LBL_NOTIFICATIONS_KEY_TITLE_DASHLET' => 'Përfshi në panelin e Sugar Hint Insights',
    ...
    'LBL_HINT_PUSH_MESSAGES_PERMISSION' => 'Je duke aktivizuar njoftimet për Sugar Hint Insights. Kliko "Konfirmo" për të vazhduar. Më pas shfletuesi yt do të të kërkojë autorizim për të lejuar marrjen e njoftimeve.',
    ...
    'LBL_HINT_SOFT_DISABLE_NOTIFICATIONS_FAILURE' => 'PARALAJMËRIM: Çaktivizimi i njoftimeve nuk u krye gjatë çinstalimit të Sugar Hint. Për të çaktivizuar njoftimet, instalo versionin Sugar Hint 5.4.0 ose më lart dhe kryej çinstalimin e plotë duke përdorur çinstaluesin e Sugar Hint që gjendet në seksion "Administrimi" të Sugar.',
    'LBL_HINT_ENRICH_ALL' => 'Plotëso të gjitha',
    'LBL_HINT_NO_LICENSE_ACCESS' => 'Kërkohet licenca "Hint"',


    //Maps
    'LBL_MAP_CONFIG_TITLE' => 'Konfigurimi i hartave',
    'LBL_MAP_CONFIG_GEOCODE_LOG_VIEWER' => 'Shikuesi i identifikimit të gjeokoderit',
    'LBL_MAP_MAP' => 'Harta',
    'LBL_MAP_MAPS' => 'Hartat',
    ...
    'LBL_MAPS_SHARE_HELLO' => 'Përshëndetje,',
    'LBL_MAPS_SHARE_HEADER' => 'Ke kërkuar një hartë Bing për pikat në vijim:',
    'LBL_MAPS_SHARE_OPEN_URL' => 'URL-ja në vijim do të hapë një hartë që përmban pikat e mësipërme në Bing Maps:',
    'LBL_MAPS_SHARE_SHOW_MAP' => 'Shfaq hartën në Bing Maps',
    'LBL_MAPS_MAP_ON_BING_WEB' => 'Bing Maps',
    'LBL_MAPS_NO_VALID_ITINERARY' => 'Nuk u gjet asnjë rrugë për pikëkalimet e dhëna.',
    'LBL_MAPS_GEOCODE_STATUS' => 'Statusi i gjeokodit',
    'LBL_MAPS_GEOCODED' => 'Gjeokoduar',
    'LBL_MAPS_NOT_GEOCODED' => 'Nuk është gjeokoduar',
    'LBL_MAPS_NOT_FOUND' => 'Adresë e pavlefshme',
    'LBL_MAPS_GEOCODING_FAILED' => 'Gjeokodimi nuk u krye',
    'LBL_MAPS_QUEUED' => 'Radhitur',
    'LBL_MAPS_REQUEUED' => 'Riradhitur',
    'LBL_MAPS_RELATED_RECORD' => 'Regjistri i lidhur',

    //Report Dashlet
    'LBL_REPORT_DASHLET_CONFIG_VIEW_REPORT' => 'Shiko raportin',
    'LBL_REPORT_DASHLET_DESC' => 'Shfaq një raport të ruajtur',
    'LBL_REPORT_DASHLET_RESET_DEFAULT' => 'Rivendos te parazgjedhjet e Dashlet',
    'LBL_REPORT_DASHLET_RESET_REPORT_DEFAULT' => 'Rivendos te parazgjedhjet e raportit',
    'LBL_REPORT_DASHLET_REFRESH_RESULTS' => 'Rifresko rezultatet',
    'LBL_REPORT_DASHLET_COPY_CHART_CLIPBOARD' => 'Kopjo tabelën në kujtesën e fragmenteve',
    'LBL_REPORT_DASHLET_DOWNLOAD_CHART' => 'Shkarko tabelën',
    'LBL_REPORT_DASHLET_REST_TO_REPORT_DEFAULTS' => 'Raporti për nënvizimin {{label}} është modifikuar dhe nënvizimi është rivendosur në konfigurimin e parazgjedhur.',

    'LBL_NO_FIELD_PERMISSION_TO_FILTER' => 'Nuk ke leje për ta përdorur këtë fushë.',
    ...
    'LBL_AI_OPP_CLOSE_WEEK_SCORES' => 'Rezultatet e parashikimit të javës së mbylljes',
    'LBL_AI_CONV_SCORE_ABSOLUTE' => 'Vlera e parashikimit',
    'LBL_AI_CONV_BIN_ACCURACY' => 'Saktësia e koshit të parashikimit',
    'LBL_AI_CONV_MULTIPLIER' => 'Shumëzuesi i parashikimit',
    'LBL_AI_ICP_FIT_SCORE_ABSOLUTE' => 'Vlera ICP',
    'LBL_AI_ICP_FIT_BIN_ACCURACY' => 'Saktësia e koshit ICP',
    'LBL_AI_ICP_FIT_MULTIPLIER' => 'Shumëzuesi ICP',
    'LBL_AI_NEW' => 'E re',
    'LBL_AI_ENTERED' => 'Vendosur',
    'LBL_AI_CREATED' => 'Krijuar',
    'LBL_AI_WEEK' => 'Java',
    'LBL_AI_MONTH' => 'Muaji',
    'LBL_AI_QUARTER' => 'Tremujori',
    'LBL_AI_BYWEEK' => 'sipas javës',
    'LBL_AI_BYMONTH' => 'sipas muajit',
    'LBL_AI_BYQUARTER' => 'sipas tremujorit',
    'LBL_AI_WEEKTREND' => 'Tendenca javore',
    'LBL_AI_MONTHLYTREND' => 'Tendenca mujore',
    'LBL_AI_QUARTERTREND' => 'Tendenca tremujore',
    'LBL_AI_TREND' => 'Tendenca sipas',
    'LBL_AI_TRENDS' => 'Tendencat sipas',
    'LBL_AI_VELOCITY' => 'Shpejtësia',
    'LBL_AI_TOPX' => '{X} kryesore',
    'LBL_AI_TIMESPAN' => 'Periudha kohore midis fazave -',
    'LBL_AI_BUSINESSTREND' => 'me tendencat e biznesit',
    'LBL_AI_SUGARINSIGHTINTRO' => 'Prezantimi i Sugar Insights!',
    'LBL_AI_SUGARINSIGHTSDESC' => '"Sugar Insights" shfrytëzon analizën sasiore për të gjeneruar informacione të reja në të dhënat tuaja SugarCRM. Në Sugar, ne jemi gjithmonë në kërkim të mënyrave të reja për t&#39;ju ndihmuar të merrni më të mirën nga të dhënat tuaja dhe të merrni vendime të informuara. Ky është vetëm fillimi i asaj që shpresojmë të ofrojmë me "Sugar Insights".',
    'LBL_AI_SUGARINSIGHTS_DASHLET_NAME' => 'Sugar Insights',
    'LBL_AI_SUGARINSIGHTS_DASHLET_DESC' => '"Sugar Insights" shfrytëzon analizën sasiore për të gjeneruar informacione të reja në të dhënat tuaja SugarCRM.',
    'LBL_AI_FIRMO' => 'Të dhënat e kompanisë',
    'LBL_AI_TOTALCOUNT' => 'Numri total i',
    'LBL_AI_DAYSFROMLATESTACT' => 'Ditë që nga',
    'LBL_AI_DAYSSINCE' => 'mosha',
    'LBL_AI_FIELDISSET' => 'ekziston',
    'LBL_AI_CONTACTCOMPLETENESS' => 'Plotësia e të dhënave të kontaktit',
    'LBL_AI_CUTDATE' => 'Periudha e parashikimit',
    'LBL_AI_FROMLASTCHANGE' => 'Ditë nga ndryshimi i fundit i vlerës së veçorisë',
    'LBL_AI_CALLSHELD' => 'Numri total i telefonatave të kryera',
    'LBL_AI_CALLSPLANNED' => 'Numri total i telefonatave të planifikuara',
    'LBL_AI_OUTBOUNDCALLS' => 'Numri total i thirrjeve dalëse',
    'LBL_AI_INBOUNDCALLS' => 'Numri total i thirrjeve hyrëse',
    'LBL_AI_AVGCALLDURATION' => 'Kohëzgjatja mesatare e telefonatave',
    'LBL_AI_EMAILSARCHIVED' => 'Numri total i emaileve të arkivuara',
    'LBL_AI_EMAILSREAD' => 'Numri total i emaileve të lexuara',
    'LBL_AI_EMAILSSENT' => 'Numri total i emaileve të dërguara',
    'LBL_AI_CLOSEDATEPUSHEDBACK' => 'Numri total i regjistrimeve në të cilat data e pritshme e mbylljes është ndryshuar në një datë të mëvonshme',
    'LBL_AI_CLOSEDATEPUSHEDFORWARD' => 'Numri total i regjistrimeve në të cilat data e pritshme e mbylljes është ndryshuar në një datë më të afërt',
    'LBL_AI_AMOUNTINCREASED' => 'Numri total i mundësive në të cilat shuma është rritur',
    'LBL_AI_AMOUNTDECREASED' => 'Numri total i mundësive në të cilat shuma është ulur',

    // User last state
    'LBL_LAST_STATE' => 'Gjendja e fundit',
    // DocuSign
    'LBL_SEND_TO_DOCUSIGN_BUTTON_LABEL' => 'Dërgo te DocuSign',
    'LBL_SHORTCUT_EDIT_RECIPIENT_CANCEL' => 'Anulo modifikimin e marrësit',
    'LBL_RECIPIENT_ROLE' => 'Roli i marrësit',
    // Base sales stages
    'LBL_OPEN' => 'Hap',
    'LBL_CLOSED_WON' => 'Mbyllur me fitim',
    'LBL_CLOSED_LOST' => 'Mbyllur me humbje',
    'LBL_KIOSK_ADD_FILES' => 'Shto skedarë',
    'LBL_KIOSK_ADD_DROP_FILES' => 'Shto ose lësho skedarë këtu',
    'LBL_KIOSK_CANCEL' => 'Anulo',
    'LBL_KIOSK_EDIT' => 'Modifiko',
    'LBL_KIOSK_EMAIL' => 'Email',
    'LBL_KIOSK_FILES_UPLOADING' => 'Duke ngarkuar',
    'LBL_KIOSK_FILES_ERROR' => 'Bashkëngjitja nuk qe e mundur të ngarkohej',
    'LBL_KIOSK_FILES_ERROR_TOO_LARGE' => 'Bashkëngjitja ka tejkaluar madhësinë',
    'LBL_KIOSK_FILTER_SEARCH' => 'Kërko',
    'LBL_KIOSK_ID' => 'ID-ja',
    'LBL_KIOSK_TITLE' => 'Kioskë',
    'LBL_KIOSK_LANGUAGE' => 'Gjuha',
    'LBL_KIOSK_LAST_UPDATED' => 'Përditësuar së fundi',
    'LBL_KIOSK_LIST_VIEW_SELECTION' => 'Shfaq',
    'LBL_KIOSK_MENU' => 'Menyja',
    'LBL_KIOSK_MOBILE_PHONE' => 'Celulari',
    'LBL_KIOSK_MY_ACTIVITIES' => 'Aktivitetet e mia',
    'LBL_KIOSK_MY_PROFILE' => 'Profili im',
    'LBL_KIOSK_NAME' => 'Emri',
    'LBL_KIOSK_OFFICE_PHONE' => 'Telefoni i zyrës',
    'LBL_KIOSK_ORGANIZATION' => 'Organizimi',
    'LBL_KIOSK_PAGINATION_FOOTER' => 'Rreshta për faqe:',
    'LBL_KIOSK_POWERED_BY_SUGARCRM' => 'Mundësuar nga SugarCRM',
    'LBL_KIOSK_SAVE_CHANGES' => 'Ruaj ndryshimet',
    'LBL_KIOSK_SHOW_HIDE' => 'Shfaq/Fshih',
    'LBL_KIOSK_SIGN_IN' => 'Identifikohu',
    'LBL_KIOSK_SIGN_OUT' => 'Dil',
    'LBL_KIOSK_SORT_BY' => 'Rendit sipas',
    'LBL_KIOSK_SUBMIT' => 'Dorëzo',
    'LBL_KIOSK_TIMEZONE' => 'Zona kohore',
    'LBL_KIOSK_ACTIVITY' => 'Aktiviteti',
    'LBL_KIOSK_NO_ACTIVITY' => 'Nuk ka aktivitet për të shfaqur',
    'LBL_KIOSK_OLDEST_FIRST' => 'Nga më të vjetrit',
    'LBL_KIOSK_NEWEST_FIRST' => 'Nga më të rinjtë',
    'LBL_KIOSK_SHOW_MORE' => 'Shfaq më shumë',
    'LBL_KIOSK_ADD_A_REPLY' => 'Shto një përgjigje',
    'LBL_KIOSK_REPLY_EMPTY' => 'Përgjigjja nuk mund të lihet bosh.',
    'LBL_KIOSK_NUM_MORE' => '{{num}} më shumë',
    'LBL_KIOSK_HOMEPAGE_WELCOME1' => 'Mirë se vini',
    'LBL_KIOSK_HOMEPAGE_WELCOME2' => 'Aksesoni burimet tuaja në mënyrë të shpejtë.',
    'LBL_KIOSK_HOMEPAGE_SEARCH_PLACEHOLDER' => 'Kërko raste',
    'LBL_KIOSK_SHOW_ALL' => 'Shfaq të gjitha',
    'LBL_KIOSK_404_TITLE' => 'Nuk u gjet',
    'LBL_KIOSK_TENANT_404_TITLE' => 'Klienti nuk u gjet',
    'LBL_KIOSK_404_MESSAGE' => 'Ke klikuar një lidhje që është hequr ose është përkohësisht e padisponueshme, ose ke dhënë një URL të pavlefshme.',
    'LBL_KIOSK_TENANT_404_MESSAGE' => 'Sigurohu që ke URL-në e saktë. Për asistencë të mëtejshme, kontakto mbështetjen.',
    'LBL_KIOSK_BACK_TO_HOME' => 'Kthehu te faqja kryesore',
    'LBL_KIOSK_ERROR_CODE' => '{code} Gabim: ',
    'LBL_KIOSK_401_TITLE' => 'I paautorizuar',
    'LBL_KIOSK_401_MESSAGE' => 'Nuk ke autorizim për ta parë këtë faqe.',
    'LBL_KIOSK_403_TITLE' => 'I paautorizuar',
    'LBL_KIOSK_403_MESSAGE' => 'Nuk ke akses për ta parë këtë faqe.',
    'LBL_KIOSK_500_TITLE' => 'Serveri nuk po përgjigjet',
    'LBL_KIOSK_500_MESSAGE' => 'Ndodhi një gabim nga ana jonë.',
    'LBL_KIOSK_GO_BACK' => 'Kthehu pas',
    'LBL_KIOSK_DUPLICATE_ERROR' => 'U gjet një regjistrim i dyfishtë',
    'LBL_KIOSK_ACCOUNT' => 'Llogaria',
    'LBL_KIOSK_STATUS' => 'Statusi',
    'LBL_KIOSK_DEACTIVATE' => 'Çaktivizo',
    'LBL_KIOSK_DEACTIVATE_SUCCESS' => 'Përdoruesi është çaktivizuar',
    'LBL_KIOSK_MANAGE_USERS' => 'Menaxho përdoruesit',
    'LBL_KIOSK_LAST_LOGIN' => 'Identifikimi i fundit',
    'LBL_KIOSK_FIRST_NAME' => 'Emri',
    'LBL_KIOSK_LAST_NAME' => 'Mbiemri',
    'LBL_KIOSK_ROLE' => 'Roli',
    'LBL_KIOSK_INVITE' => 'Fto',
    'LBL_KIOSK_SEND_INVITES' => 'Dërgo ftesë(a)',
    'LBL_KIOSK_INVITE_USERS_SUCCESS' => 'Ftesat u dërguan me sukses',
    'LBL_KIOSK_INVITE_USERS_FAILURE' => 'Ftesat nuk u dërguan',
    'LBL_KIOSK_REACTIVATE' => 'Riaktivizo',
    'LBL_KIOSK_REACTIVATE_SUCCESS' => 'Përdoruesi u riaktivizua',
    'LBL_KIOSK_RESET_PASSWORD' => 'Rivendos fjalëkalimin',
    'LBL_KIOSK_RESET_PASSWORD_SUCCESS' => 'Emaili për rivendosjen e fjalëkalimit u dërgua',
    'LBL_KIOSK_USER_PROFILE' => 'Profili i përdoruesit',
    'LBL_KIOSK_401_USER_BLOCKED_MESSAGE' => 'Përdoruesi është çaktivizuar. Kontakto administratorin.',
    'LBL_KIOSK_BACK_TO_LOGIN' => 'Kthehu te faqja e identifikimit',
    'LBL_KIOSK_REVOKE_INVITATION' => 'Anulo ftesën',
    'LBL_KIOSK_REVOKE_INVITATION_SUCCESS' => 'Ftesa u anulua me sukses',
    'LBL_KIOSK_SEARCH_AND_SELECT' => 'Kërko dhe zgjidh...',
    'LBL_KIOSK_NO_MATCHES' => 'Nuk u gjet asnjë përputhje',
    'LBL_KIOSK_PROFILE_UPDATE_SUCCESS' => 'Profili është përditësuar.',
    'LBL_KIOSK_PROFILE_UPDATE_ERROR' => 'Gabim gjatë përditësimit të profilit.',
    'LBL_KIOSK_NOTES_SUBJECT_TITLE' => 'Lënda: {caseSubject}',
    'LBL_KIOSK_DOCUMENTS' => 'Dokumentet',
    'LBL_KIOSK_DOCUMENTS_DESC' => 'Shiko, kërko dhe shkarko dokumentet e përbashkëta hyrëse.',
    'LBL_KIOSK_CASES' => 'Rastet',
    'LBL_KIOSK_CASES_DESC' => 'Shiko, kërko dhe përgjigju rasteve të ndara me ty.',
    'LBL_KIOSK_DOWNLOAD' => 'Shkarko',
    'LBL_KIOSK_DOWNLOAD_SUCCESS' => 'Dosjet u shkarkuan me sukses',
    'LBL_KIOSK_FIRST_TIME_LOGIN_MODAL_TITLE' => 'Fillimi',
    'LBL_KIOSK_FIRST_TIME_LOGIN_MODAL_DESCRIPTION' => 'Për të të ndihmuar më mirë, na nevojitet emri dhe mbiemri yt.',
    'LBL_KIOSK_SAVE' => 'Ruaj',
    'LBL_KIOSK_SHARED' => 'E ndarë',
    'LBL_KIOSK_HOMEPAGE_WELCOME1_PERSONAL' => 'Mirë se vini, {firstName} {lastInitial}.',
    'LBL_KIOSK_CONFIG_BACKGROUND_COLOR' => 'Ngjyra e sfondit',
    'LBL_KIOSK_CONFIG_BACKGROUND_IMG_URL' => 'URL e imazhit të sfondit',
    'LBL_KIOSK_CONFIG_BACKGROUND_IMG_URL_SUBTITLE' => 'Rekomandohet të zgjidhni një imazh me një madhësi skedari më të vogël se 400k.',
    'LBL_KIOSK_CONFIG_BACKGROUND_TYPE' => 'Lloji i sfondit',
    'LBL_KIOSK_CONFIG_HOME_TILE_TITLE' => 'Sfondi i ballinës',
    'LBL_KIOSK_CONFIG_THEME_TILE_TITLE' => 'Tema',
    'LBL_KIOSK_CONFIG_THEME_PRIMARY_COLOR' => 'Ngjyra kryesore e temës',
    'LBL_KIOSK_CONFIG_APP_NAME' => 'Emri i aplikacionit',
    'LBL_KIOSK_CONFIG_APP_NAME_SUBTITLE' => 'Ky është titulli i aplikacionit tuaj dhe tregohet pranë logos tuaj.',
    'LBL_KIOSK_CONFIG_APP_LOGO_URL' => 'URL e logo-s së aplikacionit',
    'LBL_KIOSK_CONFIG_APP_LOGO_URL_SUBTITLE' => 'Rekomandohet të zgjidhni një logo që duket më mirë në madhësi të vogla (p.sh., në profilet e rrjeteve sociale). Rekomandohet gjithashtu që madhësia e skedarit të jetë më pak se 200K.',
    'LBL_KIOSK_CONFIG_APP_FAVICON_URL' => 'URL Favicon e aplikacionit',
    'LBL_KIOSK_CONFIG_APP_FAVICON_URL_SUBTITLE' => 'Një favicon është një logo e vogël që shfaqet pranë titullit të faqes në një skedë të shfletuesit.',

    // Sugar Automate
    'LBL_UPDATE_ASSIGNEES' => 'Ricaktim i aktiviteteve të hapura',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_USER_LIMIT_REACHED' => 'U arrit kufiri i përdoruesve',
    'LBL_CUSTOMER_JOURNEY_ERROR_INVALID_LICENSE_KEY' => 'Çelës license i pavlefshëm',
    'LBL_CUSTOMER_JOURNEY_ERROR_INVALID_APPLICATION_LICENSE_KEY' => 'Aplikim i pavlefshëm',
    'LBL_CUSTOMER_JOURNEY_ERROR_MISSING_LICENSE_KEY' => 'Aplikim i pavlefshëm',
    'LBL_CUSTOMER_JOURNEY_ERROR_CORRUPT_VALIDATION_KEY' => 'Çelës validimi i korruptuar',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_EXPIRED' => 'Licenca ka skaduar',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_MISSING_INFO' => 'Mungon informacion',
    'LBL_CUSTOMER_JOURNEY_ERROR_MISSING_VALIDATION_KEY' => 'Mungon çelësi i validimit',
    'LBL_CUSTOMER_JOURNEY_ERROR_USER_MISSING_ACCESS' => 'Përdoruesi nuk ka qasje',
    'LBL_DRI_WORKFLOW' => 'Udhëzuesi inteligjent',
    'LBL_DRI_WORKFLOWS' => 'Udhëzuesit inteligjentë',
    'LBL_DRI_SUBWORKFLOW_TEMPLATE' => 'Shabllon i fazës i udhëzuesit inteligjent',
    'LBL_DRI_SUBWORKFLOW_TEMPLATES' => 'Shabllonet e fazës të udhëzuesit inteligjent',
    'LBL_DRI_WORKFLOW_TEMPLATE' => 'Shablloni i udhëzuesit inteligjent',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATE' => 'Shablloni i aktivitetit i udhëzuesit inteligjent',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATES_SUBPANEL_TITLE' => 'Shabllonet e aktivitetit',
    'LBL_CJ_WEBHOOKS_SUBPANEL_TITLE' => 'Webhooks',
    'LBL_CJ_WEBHOOKS' => '"Web Hooks" të Sugar Automate',
    'LBL_CURRENT_CJ_ACTIVITY_AT' => 'Aktiviteti atktual i udhëzuesit inteligjent',
    'LBL_CJ_WEBHOOKS' => '"Web Hooks" të Sugar Automate',
    'LBL_CJ_WEBHOOK' => 'Webhooks të "Sugar Automate"',
    'LBL_CJ_FORMS_SUBPANEL_TITLE' => 'Veprimet në Sugar',
    'LBL_CJ_FORMS' => 'Veprimet e Smart Guide në Sugar',
    'LBL_CJ_FORM' => 'Veprim i Smart Guide në Sugar',
    'LBL_DRI_SUBWORKFLOW' => 'Faza e udhëzuesit inteligjent',
    'LBL_DRI_SUBWORKFLOWS' => 'Fazat e udhëzuesit inteligjent',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATES' => 'Shabllonet e aktivitetit të udhëzuesit inteligjent',
    'LBL_DRI_WORKFLOW_TEMPLATES' => 'Shabllonet e udhëzuesit inteligjent',
    'LBL_DRI_WORKFLOW_SORT_ORDER' => 'Rendi i udhëzuesit inteligjent',
    'LBL_CJ_ACTUAL_SORT_ORDER' => 'Rendi aktual i udhëzuesit inteligjent',
    'LBL_CUSTOMER_JOURNEY_SCORE' => 'Vlerësimi i udhëzuesit inteligjent',
    'LBL_CJ_MOMENTUM_POINTS' => 'Pikat e shpjetësisë së udhëzuesit inteligjent',
    'LBL_CJ_MOMENTUM_SCORE' => 'Vlerësimi i shpjetësisë së udhëzuesit inteligjent',
    'LBL_CJ_ALLOW_ACTIVITY_BY' => 'Lejo ekzekutimin e aktivitetit të udhëzuesit inteligjent nga',
    'LBL_CUSTOMER_JOURNEY_PROGRESS' => 'Progresi i udhëzuesit inteligjent',
    'LBL_CJ_MOMENTUM_RATIO' => 'Raporti i shpejtësisë së udhëzuesit inteligjent',
    'LBL_CUSTOMER_JOURNEY_POINTS' => 'Pikët e udhëzuesit inteligjent',
    'LBL_CUSTOMER_JOURNEY_TYPE' => 'Detyra e udhëzuesit inteligjent',
    'LBL_CJ_PARENT_ACTIVITY_TYPE' => 'Lloji i aktivitetit prind të udhëzuesit inteligjent',
    'LBL_CUSTOMER_JOURNEY_BLOCKED_BY' => 'Udhëzuesi inteligjent është i bllokuar nga',
    'LBL_CJ_BLOCKED_BY_STAGES' => 'Fazat e "Udhëzuesi inteligjent i bllokuar nga"',
    'LBL_CJ_PARENT_ACTIVITY_ID' => 'Id-ja e aktivitetit kryesor e udhëzuesit inteligjent',
    'LBL_START_NEXT_JOURNEY_ID' => 'Nis Id-në e radhës të udhëzuesit inteligjent',
    'LBL_CJ_URL' => 'Url-ja e udhëzuesit inteligjent',
    'LBL_IS_CJ_PARENT_ACTIVITY' => 'Është aktiviteti prind i udhëzuesit inteligjent',
    'LBL_CJ_MOMENTUM_START_DATE' => 'Shpejtësia e udhëzuesit inteligjent: Data e nisjes',
    'LBL_CJ_MOMENTUM_END_DATE' => 'Shpejtësia e udhëzuesit inteligjent: Data e përfundimit',
    'LBL_WIDGET_LAYOUT_CONFIGURATION_HEADER' => 'Konfigurimi i formatit të miniaplikacionit',
    'LBL_WIDGET_LAYOUT_CONFIGURATION' => 'Konfigurimi i formatit të miniaplikacionit',
    'CJ_SAME_JOURNEY_LIMIT_REACH_EXCEPTION' => 'Numri maksimal i udhëzuesve inteligjentë nga i njëjti shabllon',
    'LBL_CUSTOMER_JOURNEY_WIDGET_ACTIVE' => 'Aktiv',
    'LBL_CUSTOMER_JOURNEY_WIDGET_ARCHIVE' => 'Arkivuar',
    'LBL_CUSTOMER_JOURNEY_STAGE_NUMBER_SHOW' => 'Shfaq',
    'LBL_CUSTOMER_JOURNEY_STAGE_NUMBER_HIDE' => 'Fshih',
    'LBL_CJ_PRESENTATION_MODE_VERTICAL' => 'Modaliteti vertikal',
    'LBL_CJ_PRESENTATION_MODE_HORIZONTAL' => 'Modaliteti horizontal',
    'LBL_CUSTOMER_JOURNEY_INVALID_LICENSE' => 'Licencë e pavlefshme',
    'LBL_ASSIGNMENT_NOTIFICATION_HTML' => '<div>
    <p>{{assigned_by}} i ka caktuar aktivitetet e mëposhtme të udhëzuesit inteligjent te {{assigned_user}}.</p>
    <ul>{{activities}}</ul>
    
    <p>Mund t&#39;i rishikosh këto aktivitete te:<br/>
    <<a href=\"{{module_link}}\">{{module_link}}</a>></p>
    </div>',
    'LBL_CUSTOMER_JOURNEY_INVALID_LICENSE' => 'Licencë e pavlefshme',
    'LBL_CJ_REMAINING_DAYS_WHEN_USER_LIMIT_REACHED' => 'Është arritur kufiri i përdoruesve. Ke {{gracePeriodDays}} ditë për të përditësuar licencën.',
    'LBL_ASSIGNMENT_NOTIFICATION_SUBJECT' => 'SugarCRM - Aktivitetet e caktuara të udhëzuesit inteligjent',
    'LBL_CUSTOMER_JOURNEY_USER_LIMIT_REACHED_DESCRIPTION' => 'Është tejkaluar kufiri i përdoruesve të "Sugar Automate" prej {0} <br>
    <br>
    Kontakto <a href=\"mailto:customersuccess@sugarcrm.com\">customersuccess@sugarcrm.com</a> për të rritur kufirin e përdoruesve ose për të ulur numrin e përdoruesve që përdorin përbërësin shtesë.',
    'LBL_CUSTOMER_JOURNEY_USER_LIMIT_REACHED_NAME' => 'Është arritur kufiri i përdoruesve të "Sugar Automate"',
    'LBL_CUSTOMER_JOURNEY_LICENSE_ABOUT_TO_EXPIRE_DESCRIPTION' => 'Licenca jote e "Sugar Automate" do të skadojë pas {0} ditësh. <br>
    <br>
    Kontakto SugarCRM ose partnerin tënd të Sugar për të rinovuar dhe parandaluar ndërprerjen e shërbimit.',
    'LBL_CUSTOMER_JOURNEY_LICENSE_ABOUT_TO_EXPIRE_NAME' => 'Licenca e "Sugar Automate" është gati të skadojë',
    'LBL_DEFAULT_TEST_WEB_HOOK_DASHLET_TITLE' => 'Testo Webhook',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'Progresi i Smart Guide',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Shfaq grafikun në formë rrethore "Progresi i Smart Guide" të Sugar Automate.',
    'LBL_DEFAULT_TEST_WEB_HOOK_DASHLET_DESC' => 'Shfaq përgjigjen e Webhook',
    'LBL_DASHLET_SEND_LABEL' => 'Dërgo kërkesë',
    'LBL_ASSIGN_ME_BUTTON_TITLE' => 'Më cakto',
    'LBL_COMPLETE_BUTTON_TITLE' => 'Përfundo',
    'LBL_COMPLETE_PARENT_BUTTON_TITLE' => 'Përfundo të gjitha detyrat',
    'LBL_DELETE_STAGE_BUTTON_TITLE' => 'Fshi fazën',
    'LBL_START_CYCLE_BUTTON_TITLE' => 'Fillo',
    'LBL_NOT_APPLICABLE_BUTTON_TITLE' => 'Nuk zbatohet',
    'LBL_ADD_STAGE_BUTTON_TITLE' => 'Shto fazë',
    'LBL_VIEW_JOURNEY_BUTTON_TITLE' => 'Shih',
    'LBL_EDIT_JOURNEY_BUTTON_TITLE' => 'Modifiko Smart Guide',
    'LBL_CANCEL_JOURNEY_BUTTON_TITLE' => 'Anulo',
    'LBL_ARCHIVE_JOURNEY_BUTTON_TITLE' => 'Arkivo',
    'LBL_UNARCHIVE_JOURNEY_BUTTON_TITLE' => 'Nxirr nga arkiva',
    'LBL_CONFIGURE_TEMPLATE_BUTTON_TITLE' => 'Konfiguro shabllonin',
    'LBL_ADD_CJ_SUB_TASK_BUTTON_TITLE' => 'Shto detyrë',
    'LBL_ADD_CJ_SUB_MEETING_BUTTON_TITLE' => 'Planifiko mbledhje',
    'LBL_ADD_CJ_SUB_CALL_BUTTON_TITLE' => 'Planifiko telefonatë',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_FUTURE' => 'është në të ardhmen',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_OVERDUE' => 'është me vonesë',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TODAY' => 'është sot',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TOMORROW' => 'është nesër',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TEXT' => '{{fieldName}} {{status}}
    {{formatUser}} ({{fromNow}})',
    'LBL_CJ_CANCEL_CONFIRMATION' => 'Je i sigurt që dëshiron ta anulosh këtë udhëzues inteligjent?',
    'LBL_CJ_COMPLETE_ALL_TASKS_CONFIRMATION' => 'Për pak përfundon të gjitha detyrat. Je i sigurt se dëshiron të vazhdosh?',
    'LBL_CJ_BLOCK_BY' => 'Ke një detyrë të pazgjidhur dhe të varur: {{Name}}. Përfundo këtë detyrë përpara përfundimit të të gjitha detyrave.',
    'LBL_CJ_MULTIPLE_BLOCK_BY' => 'Ke disa detyra të pazgjidhura dhe të varura: {}. Përfundo këto detyra përpara përfundimit të të gjitha detyrave.',
    'LBL_CJ_COMPLETE_ALL_TASKS_COMPLETION' => 'Ke përfunduar me sukses të gjitha detyrat',
    'LBL_CJ_ARCHIVE_CONFIRMATION' => 'Je i sigurt që dëshiron ta arkivosh këtë udhëzues inteligjent?',
    'LBL_CJ_UNARCHIVE_CONFIRMATION' => 'Je i sigurt që dëshiron ta nxjerrësh nga arkivi këtë udhëzues inteligjent?',
    'LBL_CJ_AS_A_DASHLET' => 'Sugar Automate: Udhëzuesit inteligjentë (Sirtarët e fokusimit dhe konsola)',
    'LBL_CJ_AS_A_DASHLET_DESC' => 'Shiko udhëzuesit inteligjentë aktivë në konsolën Shërbimi/Rinovimet dhe panelet e sirtarit të fokusit.',
    'LBL_CJ_PROCESSING_REQUEST' => 'Duke përpunuar..',
    'LBL_CJ_SUCCESS' => 'Ke përfunduar me sukses të gjitha detyrat',
    'LBL_CUSTOMER_JOURNEY_MODULE_NOT_ENABLED' => 'Moduli {module} nuk është aktivizuar',
    'LBL_RECORDVIEW_DISPLAY_SETTINGS_SAVED' => 'Të gjitha parametrat e shfaqjes janë ruajtur.',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_MOMENTUM_DASHLET_TITLE' => 'Shpejtësia e udhëzuesit inteligjent',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_MOMENTUM_DASHLET_DESC' => 'Shfaq grafikun vlerësues "Shpejtësia e udhëzuesit inteligjent" të "Sugar Automate".',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'Progresi i Smart Guide',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Shfaq grafikun në formë rrethore "Progresi i Smart Guide" të Sugar Automate.',
    'CJ_PARENT_NOT_FOUND_EXCEPTION' => 'Prindi nuk mund të gjendej',
    'CJ_NOT_FOUND_EXCEPTION' => '{moduleName} me datë {data} nuk mund të gjendej',
    'CJ_JOURNEY_NOT_COMPLETED_EXCEPTION' => 'Udhëzuesi inteligjent duhet të përfundohet ose të anulohet para se të arkivohet',
    'LBL_CUSTOMER_JOURNEY_LICENSE_LOAD_ERROR' => '"Sugar Automate" nuk është aktivizuar në licencën aktuale të "Sugar"',
    'LBL_ACTION_NOT_FOUND' => 'Veprimi nuk u gjend. Kontakto administratorin e sistemit',
    'LBL_CJ_SELECT_FIELD' => 'Zgjidh fushën',
    'LBL_CJ_SELECT_OPERATOR' => 'Zgjidh operatorin',
    'LBL_CJ_SELECT_VALUE' => 'Zgjidh vlerën',
    'LBL_CJ_ENTER_VALUE' => 'Vendos vlerën',
    'LBL_CJ_FORM_BATCH_TITLE' => 'Duke ruajtur regjistrimin',
    'LBL_CJ_FORM_BATCH_ACTIVE_SMART_GUIDES_DETECTED' => 'U zbuluan udhëzuesit inteligjentë aktivë...',
    'LBL_CJ_FORM_BATCH_PROCESSING_ACTIVE_SUGAR_ACTIONS' => 'Duke përpunuar veprimet aktive të Sugar...',
    'LBL_CJ_FORM_BATCH_UPDATING_ACTIVE_SMART_GUIDES' => 'Duke përditësuar udhëzuesit inteligjentë aktivë...',
    'LBL_CJ_FORM_BATCH_SUCCESS' => 'Regjistri dhe smart guide përkatës janë përditësuar me sukses.',
    'LBL_CJ_FORM_BATCH_FAILURE' => 'Një udhëzues inteligjent i lidhur nuk u përditësua. Nëse gabimi vazhdon, kontakto administratorin e Sugar për ndihmë.',
    'LBL_CJ_FORM_BATCH_FAILURE_FOR_ADMIN' => 'Një udhëzues inteligjent i lidhur nuk u përditësua. Rishiko <a href="index.php?action=LogView&module=Configurator&doaction=all&filter=Sugar+Actions+:+Sugar+Action+to+Smart+Guide" target="_blank">evidencat</a> për të zgjidhur problemin.',
    'LBL_CJ_ACTIVITY_LINK_SUCCESS' => '<a href="#{{module}}/{{id}}">{{name}}</a> {{moduleSingularLower}} u lidh me sukses.',
    'LBL_CJ_ACTIVITY_LINK_ERROR' => 'Pati një problem gjatë lidhjes së <a href="#{{module}}/{{id}}">{{name}}</a> {{moduleSingularLower}}. Nëse problemi vazhdon, kontakto mbështetjen e Sugar.',
    'LBL_CJ_ACTIVITY_LINK_SUCCESS_PLURAL' => '{{modulePluralLower}} janë lidhur me sukses.',
    'LBL_CJ_ACTIVITY_LINK_ERROR_PLURAL' => 'Pati një problem gjatë lidhjes së {{modulePluralLower}}. Nëse problemi vazhdon, kontakto mbështetjen e Sugar.',
    'LBL_CJ_ACTIVITY_LINK_ERROR_GENERIC' => 'Pati një problem gjatë lidhjes së {{moduleSingularLower}}. Nëse problemi vazhdon, kontakto mbështetjen e Sugar.',
    'LBL_CJ_ACTIVITY_DUPLICATE_EXISTING' => 'Ekziston një {{moduleSingularLower}} i emërtuar <a href="#{{module}}/{{id}}">{{name}}</a> në fazën {{stage}}.',
    'LBL_CJ_ACTIVITY_DUPLICATE_SELECTED' => 'Është përzgjedhur tashmë një {{moduleSingularLower}} i emërtuar <a href="#{{module}}/{{id}}">{{name}}</a>.',
    'LBL_CJ_ARCHIVED' => 'Arkivuar',
    'LBL_SELECT_SMART_GUIDE_TEMPLATE_PLACEHOLDER' => 'Zgjidh shabllonin e Smart Guide...',
    'LBL_ALL_SMART_GUIDES' => 'Të gjithë Smart Guide',
    'LBL_ACTIVE_SMART_GUIDES' => 'Smart Guide aktivë',
    'LBL_ARCHIVED_SMART_GUIDES' => 'Smart Guide të arkivuar',
    'LBL_VERTICAL_SCROLL_VIEW' => 'Pamja e grumbulluar vertikale',
    'LBL_HORIZONTAL_SCROLL_VIEW' => 'Pamja e lëvizjes horizontale',
    'LBL_DRI_WORKFLOWS_FILTER' => 'Filtri',

    // more MOBILE stuff
    'LBL_MOBILE_COPIED_TO_CLIPBOARD' => 'U kopjua në kujtesën e fragmenteve.',
    'LBL_MOBILE_DELETE_ALL_OCCURRENCES' => 'Fshi të gjitha përsëritjet',
    'ERROR_RECURRENCE_EVENT_PARAMS' => 'Cilësime të pavlefshme të përsëritjes',
    'ERROR_INTERVAL_INVALID' => 'Intervali i përsëritjes duhet të jetë mes 1 dhe 99',
    'LBL_RECURRENCE_ADD' => 'Konfiguro',
    'LBL_REPEAT_DAYS' => 'Dita/ët e muajit',
    'LBL_REPEAT_END_TYPES' => 'Përsërit',
    'LBL_MOBILE_DEFAULT_MAPS_APP' => 'Ofruesi i navigimit',
    'LBL_MOBILE_PDF_EMAIL' => 'Dërgo me email {{{pdfTemplateName}}} PDF',
    'LBL_MOBILE_EMAIL_SENDING' => 'Duke dërguar',
    'LBL_MOBILE_EMAIL_SENT' => 'U dërgua',
    'LBL_MOBILE_EMAIL_SAVED_DRAFT' => 'Emaili u ruajt si draft.',
    'LBL_MOBILE_EMAIL_CHOOSE_ATTACHMENT' => 'Shto bashkëngjitje',
    'LBL_MOBILE_EMAIL_LOCAL_ATTACHMENT' => 'Ngarko dokument lokal',
    'LBL_MOBILE_EMAIL_SUGAR_DOCUMENT_ATTACHMENT' => 'Dokumentacion i Sugar',
    'LBL_DROPDOWN_VIEW_CHANGE_INFO' => 'Kjo pamje është ndryshuar nga një modifikim që i bëre këtij regjistrimi.',
    'LBL_MOBILE_RELEASE_NOTE_ALL' => 'Shënimet e versionit të aplikacionit SugarCRM Mobile',
    'LBL_MOBILE_USER_GUIDE_ALL' => 'Udhëzuesi i përdorimit të aplikacionit SugarCRM Mobile',
    'ERR_MOBILE_ROOTED' => '"Sugar Mobile" nuk mund të përdoret në një pajisje celulare të rrënjosur. Hap aplikacionin në një pajisje të parrënjosur.',
    'LBL_VO_BUILD_ROUTE' => 'Krijo itinerar',
    'LBL_FILTER_MY_DISTANCE_FILTER' => 'Filtri i distancës sime',
    'LBL_ACTIONBUTTON_DOC_MERGE_STARTED' => 'Dokumenti do të gjenerohet në sfond. Hap faqen "Bashkimet e dokumentit" për të pasur qasje te skedari.',
    'LBL_ACTIONBUTTON_DOC_MERGE_NO_TEMPLATE' => 'Nuk u arrit marrja e një shablloni. Kontakto për ndihmë administratorin tënd.',
    'LBL_MAP_ERROR_LOAD' => 'Harta nuk mund të ngarkohet',
    'LBL_MAP_DISTANCE' => 'Distanca',
    'LBL_SELECT_UNIT_TYPE' => 'Lloji i njësisë',
    'LBL_MAPS_UNIT_MILES' => 'Milje',
    'LBL_MAPS_UNIT_KILOMETERS' => 'Kilometra',
    'LBL_RADIUS' => 'Rrezja',
    'LBL_ZIP_CODE' => 'Kodi postar',
    'LBL_MOBILE_CHOOSE_ADDRESS' => 'Zgjidh adresën',
    'LBL_MOBILE_ADDRESS_NOT_GEOCODED' => 'Nuk mund të krijohej gjeokodi nga adresa:{{{address}}}',
    'LBL_MOBILE_GEOCODE_SAVE_ERROR' => 'Regjistrimi nuk është gjeokoduar.',
    'LBL_MOBILE_GEOCODE_MANUAL_CONFIRM' => 'Regjistrimi nuk përmban asnjë të dhënë mbi adresën. Dëshiron ta vendosësh këtë regjistrim manualisht në hartë?',
    'LBL_ERR_SHOW_ON_MAP' => 'Nuk u arrit hapja e hartës për regjistrimet e zgjedhura.',
    'LBL_ERR_MISSING_ON_MAP' => 'Disa regjistrime nuk kanë të dhënat e adresës dhe nuk shfaqen',
    'LBL_MAPS_ROUTE' => 'Itinerari',
    'LBL_MAPS_PROVIDER' => 'Hartat e Sugar',
    'LBL_MAPS_CURRENT_LOC_ERROR' => 'Nuk mund të përcaktohej vendndodhja aktuale.',
    'LBL_MAPS_MAX_COLLECTION_LENGTH' => 'Maksimumi prej {{{num}}} regjistrimesh mbështetet për hartëzim.',
    'LBL_ALL_MODULES' => 'Të gjitha modulet',
    'LBL_DRIVE_SHARE_LINK' => 'Ndaj një lidhje',
    'LBL_DRIVE_LOAD_FILES_ERROR' => 'Nuk u arrit ngarkimi i skedarëve.',
    'LBL_DRIVE_NAME_EMPTY_ERROR' => 'Emri nuk mund të jetë bosh',
    'LBL_DRIVE_FOLDER_CREATED' => 'Dosja u krijua.',
    'LBL_DRIVE_FOLDER_CREATE_ERROR' => 'Nuk u arrit krijimi i një dosjeje.',
    'LBL_DRIVE_FILE_UPLOAD_ERROR' => 'Nuk u arrit ngarkimi i një skedari.',
    'LBL_DRIVE_NO_ROOT_FOLDER' => 'Krijo fillimisht një skedar rrënjë',
    'LBL_EDIT_ALL_RECURRENCES' => 'Modifiko të gjitha përsëritjet',
    'LBL_DROPBOX_FILE_NOT_AVAILABLE' => 'Skedari nuk mund të hapet në Dropbox',
    'LBL_FILE_NOT_AVAILABLE' => 'Skedari nuk mund të hapet',
    'LBL_MAP_ROUTE_FROM_A_CURRENT_RECORD' => 'Drejtime',
    'LBL_MAPS_ROUTE_NOT_FOUND' => 'Nuk u gjet asnjë rrugë për pikëkalimet e dhëna',
    'LBL_MAPS_IN_RADIUS_FROM_CURRENT_LOCATION' => 'Pranë',
    'LBL_TAGS' => 'Etiketat',

    'LBL_CALLER_ID_SETTINGS' => 'Cilësimet e identifikuesit të telefonuesit',
    'LBL_CALLER_ID_ENABLED' => 'Identifikuesi i telefonuesit u aktivizua',
    'LBL_CALLER_ID_ENABLED_TEXT' => 'Në thirrjet hyrëse shfaqet emri i kontaktit ose klientit potencial që përputhet me numrin e telefonit.',
    'LBL_CALLER_ID_SETTINGS_HINT_IOS' => 'Për të lejuar aplikacionin celular që të identifikojë telefonuesin, ndiq këto hapa:<br><br>1. Hap Cilësimet e iOS > Telefoni > Bllokimi dhe identifikimi i telefonatave.<br>2. Aktivizo "{{{brandName}}}".',
    'LBL_CALLER_ID_SETTINGS_HINT_ANDROID' => 'Për të lejuar aplikacionin celular që të identifikojë telefonuesin, ndiq këto hapa:<br>1. Hap cilësimet e aplikacionit.<br>2. Shko te Lejet.<br>3. Aktivizo lejen e Telefonit.<br><br> Për ta caktuar këtë aplikacion si identifikuesin e parazgjedhur të telefonuesit, shko te cilësimet e pajisjes.<br>1. Shko te Aplikacionet.<br>2. Zgjidh aplikacionet e parazgjedhura.<br>3. Zgjidh aplikacionin Identifikuesi i telefonuesit dhe posta e bezdisshme.<br>4. Zgjidh këtë aplikacion si opsionin e parazgjedhur.',
    'LBL_CALLER_ID_SYNC_HINT' => 'Kontrollo për ndryshime të të dhënave të kontaktit nga regjistrat (p.sh., kontaktet, klientët potencialë) në instancën Sugar.',
    'LBL_CALLER_ID_GO_TO_SETTINGS' => 'Shko te "Cilësimet"',
    'LBL_CALLER_ID_SYNC' => 'Sinkronizo të dhënat e regjistrit',
    'LBL_CALLER_ID_NOT_ENABLED' => 'Identifikuesi i telefonuesit duhet të aktivizohet te cilësimet e sistemit përpara sinkronizimit.',
    'LBL_CALLER_ID_SETUP_ENABLE' => 'Aktivizo',
    'LBL_CALLER_ID_SETUP_LATER_IN_SETTINGS' => 'Më vonë te cilësimet',
    'LBL_CALLER_ID_SETUP_HINT_ANDROID' => 'Ky aplikacion mbështet veçorinë e identifikimit të telefonuesit.<br> Për funksionimin e saktë të kësaj veçorie, pas shtypjes së butonit të aktivizimit, do të të kërkohet të japësh dy leje.<br> Për t&#39;u siguruar se veçoria e identifikimit të telefonuesit funksionin siç duhet, duhet të japësh leje për menaxhimin e telefonatave dhe ta zgjedhësh këtë aplikacion si identifikuesin e parazgjedhur të telefonuesit.<br> Nëse nuk jep leje për menaxhimin e telefonatave, nuk do të mund të mbash evidenca të telefonatave të bëra nga aplikacioni.',
    'LBL_CALLER_ID_SETUP_HINT_IOS' => 'Për të lejuar aplikacionin celular SugarCRM që të identifikojë telefonuesin, ndiq këto hapa në pajisjen tënde:<br><br>1. Hap Cilësimet e iOS > Telefoni > Bllokimi dhe identifikimi i telefonatave.<br>2. Aktivizo aplikacionin.',
    'LBL_MOBILE_LAST_SYNC' => 'Sinkronizimi i fundit',
    'LBL_CALLER_ID_SYNCING' => 'Duke sinkronizuar me serverin.',
    'LBL_NEVER' => 'Asnjëherë',
    'LBL_RLI_MISSING_ERROR' => '{{{moduleName}}} nuk mund të jetë bosh.',
    'LBL_ADD_RELATED_RECORD' => '{{{moduleSingular}}} i lidhur',
    'LBL_CALLER_ID_NO_PERMISSION' => 'Nuk ke lejet e nevojshme për të përdorur identifikuesin e telefonuesit. Kontakto administratorin.',
    'LBL_CALLER_ID_FETCHING' => 'Duke u sinkronizuar…',
    'LBL_CALLER_ID_FETCH_ALL' => 'Risinkronizo të gjithë regjistrat',
    'LBL_CALLER_ID_FETCH_NEW' => 'Kontrollo për përditësime të regjistrave',

    'LBL_SORT_BY' => 'Rendit sipas',
    'LBL_PRIMARY_SORT' => 'Renditja kryesore',
    'LBL_SECONDARY_SORT' => 'Renditja dytësore',
    'LBL_OF' => 'e',
    'LBL_TABLE_FREEZE_FIRST' => 'Ngri kolonën e parë',
    'LBL_TABLE_SETTINGS_TITLE' => 'Opsionet e pamjes së kolonës',
    'LBL_TABLE_SETTINGS_NO_COL' => 'Duhet të zgjidhet të paktën një kolonë.',
    'LBL_TABLE_TOGGLER_INFO' => 'Shfaq ose fshih kolonat dhe vendosi ato sipas rendit të preferuar.',
    'LBL_RUNTIME_FILTERS_TITLE' => 'Filtrat e kohës së ekzekutimit',
    'LBL_FILTER_CONDITION' => 'Zgjidh kushtin',
    'LBL_FILTER_VALUES' => 'Vlerat',
    'LBL_TABLE_EXPAND' => 'Zgjero të gjitha',
    'LBL_TABLE_COLLAPSE' => 'Mbyll të gjitha',
    'LBL_RUNTIME_FILTERS_DEFAULT' => 'Gabim në server. Filtrat përkatës të kohës së ekzekutimit nuk janë ngarkuar.',

    // Pub/Sub
    'LBL_PUBSUB_MODULEEVENT_PUSHSUBS' => 'Abonimet automatike në modulin e publikimit ose nënshkrimit',
    'LBL_PUBSUB_MODULEEVENT_PUSHSUB' => 'Abonimi automatik në modulin e publikimit ose nënshkrimit',
];

$app_list_strings['configure_record_view_display_dom'] = [
    'panel_top' => 'Paneli - Lart',
    'panel_bottom' => 'Paneli - Poshtë',
    'tab_first' => 'Skeda - E para',
    'tab_last' => 'Skeda - E fundit',
];
...
$app_list_strings['library_type'] = ['Books' => 'Libër', 'Music' => 'Muzik', 'DVD' => 'DVD', 'Magazines' => 'Revistat'];
...
$app_strings['LBL_SEND_TO_DOCUSIGN'] = 'Dërgo te DocuSign';
$app_strings['LBL_NO_SEND_TO_DOCUSIGN'] = 'DocuSign nuk është i disponueshëm nga kjo vendndodhje.';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_WEP'] = 'Doc Merge në Word/Excel/PowerPoint nuk është i disponueshëm nga kjo vendndodhje';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_DS'] = 'Doc Merge në DocuSign nuk është i disponueshëm nga kjo vendndodhje';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_PDF'] = 'Doc Merge në PDF nuk është i disponueshëm nga kjo vendndodhje';
$app_strings['LBL_DOCUSIGN_PERMISSIONS'] = 'Dosja e nënshkruar do të ngarkohet këtu vetëm nëse keni leje për të ngarkuar në këtë vendndodhje.';
$app_strings['LBL_DOC_MERGE_TO'] = 'Bashko dokumentin me';
...
$app_strings['LBL_NEW_FOLDER'] = 'Dosje e re';
$app_strings['LBL_FOLDER_NAME'] = 'Emri i dosjes: ';
$app_strings['LBL_PERMISSION_ERROR'] = 'Nuk ke leje për të realizuar këtë veprim në shtegun aktual.';
$app_strings['LBL_MICROSOFT_PERMISSION_ERROR'] = 'Nuk ke leje për të shkuar në shtegun aktual.';
$app_strings['LBL_FILE_UPLOADED'] = 'Skedari është ngarkuar.';
$app_strings['LBL_LARGE_FILE_UPLOAD'] = 'Për shkak të madhësisë së skedarit, ngarkimi do të kërkojë pak kohë.';
$app_strings['LBL_ERR_NO_FILE_ATTACHED'] = 'Një ose më shumë regjistrime të dokumenteve nuk kanë skedar të bashkëngjitur. Bashkëlidh skedarët me regjistrimet dhe provo sërish ose sinkronizo individualisht regjistrimet specifike me skedarët.';
...
$app_strings['LBL_CHECK_DROPBOX_CONNECTION'] = 'Nuk u gjet lidhja me Dropbox...';
$app_strings['LBL_MICROSOFT_DELAY'] = 'Sinkronizimi me OneDrive mund të zgjasë pak';
$app_strings['LBL_DRIVE_DELETE_CONFIRM'] = 'Je i sigurt se dëshiron ta fshish këtë skedar?';
$app_strings['LBL_MICROSOFT_UPLOAD_COMPLETE'] = 'Ngarkimi i OneDrive ka përfunduar.';
$app_strings['LBL_MICROSOFT_UPLOAD_COMPLETE_DESCRIPTION'] = ' është ngarkuar me sukses.';
$app_strings['LBL_DRIVE_LOAD_PATH_ERROR'] = 'Gabim gjatë ngarkimit të shtigjeve.';
$app_strings['LBL_INVALID_DRIVE_FILE'] = 'Ka ndodhur një gabim. Skedari është i dëmtuar.';
$app_strings['LBL_UPLOAD_AND_LINK_COMPLETE'] = 'Dokumenti <i>"{{documentName}}"</i> është ruajtur në diskun tënd në renë kompjuterike dhe është shtuar në modulin "Dokumentet".';
$app_strings['LBL_NO_PERMISSION_FILE_ERROR'] = 'Nuk ke leje për ta fshirë këtë skedar.';
$app_strings['LBL_NO_PERMISSION_FOLDER_ERROR'] = 'Nuk ke leje për ta fshirë këtë dosje.';
$app_strings['LBL_NO_PERMISSION_FILE_UPLOAD_ERROR'] = 'Nuk ke leje për të ngarkuar skedarë në këtë vendndodhje.';
$app_strings['LBL_NO_PERMISSION_FOLDER_CREATE_ERROR'] = 'Nuk ke leje për të krijuar një dosje në këtë vendndodhje.';
$app_strings['LBL_NO_FOLDER_CREATE'] = 'Nuk mund të krijohen dosje në këtë vendndodhje.';
$app_strings['LBL_NO_FILE_UPLOAD'] = 'Nuk mund të ngarkohen skedarë në këtë vendndodhje.';
$app_strings['LBL_SITES'] = 'Faqet';
$app_strings['LBL_SHARED'] = 'Ndarë';
$app_strings['LBL_COPY_LINK_CONFIRMATION'] = 'Lidhja u krijua. Shtyp butonin për të kopjuar lidhjen në kujtesën e fragmenteve.';
$app_strings['LBL_COPY_CLIPBOARD_CONFIRMATION'] = 'Kopjo në kujtesën e fragmenteve';
...
$app_list_strings['kiosk_available_language_dom'] = [['en_us', 'Anglisht (SHBA)']];
...
$app_list_strings['kiosk_case_status_dom'] = [
    ...
    ['Caktuar', 'Caktuar'],
    ['Mbyllur', 'Mbyllur'],
    ['Hyrje në pritje', 'Hyrje në pritje'],
    ['Refuzuar', 'Anuluar'],
    ['Dublo', 'Dublo'],
];
$app_list_strings['kiosk_case_type_dom'] = [
    ['Administrimi', 'Administrimi'],
    ['Produkti', 'Produkti'],
    ['Përdoruesi', 'Përdoruesi'],
];
...
$app_list_strings['kiosk_invitations_roles_dom'] = [
    ['përdorues', 'Përdorues'],
    ['administratori, përdoruesi', 'Administrator'],
    ['meanxher llogarie, përdorues', 'Menaxher llogarie'],
];

$app_list_strings['kiosk_document_shared_dom'] = [
    ['30_ditët_e_fundit', '30 ditët e fundit'],
    ['90_ditët_e_fundit', '90 ditët e fundit'],
    ['këtë_vit', 'Vitin e kaluar'],
    ['personalizuar', 'Gama e personalizuar'],
    ['të gjitha', 'Të gjitha'],
];

$app_list_strings['kiosk_background_type_dom'] = [
    ['Parazgjedhje', 'Parazgjedhje'],
    ['Ngjyra', 'Ngjyrë e njëtrajtshme'],
    ['Url', 'Imazh i personalizuar'],
];
