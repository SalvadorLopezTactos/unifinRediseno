...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => [
        ...
        'PushNotifications' => 'Принудительные уведомления',
        'Escalations' => 'Эскалации',
        'DocumentTemplates' => 'Шаблоны документов',
        'DocumentMerges' => 'Объединения документов',
        'CloudDrivePaths' => 'Пути к облачному хранилищу',
        ...
        'Messages' => 'Сообщения',
        'Audit' => 'Аудит',
        'RevenueLineItems' => 'Доходы по продуктам',
        'DocuSignEnvelopes' => 'Конверты DocuSign',
        'Geocode' => 'Геокод',
        'DRI_Workflows' => 'Умные руководства',
        'DRI_Workflow_Task_Templates' => 'Шаблоны мероприятий умных руководств',
        'DRI_SubWorkflows' => 'Этапы умного руководства',
        'DRI_Workflow_Templates' => 'Шаблоны умного руководства',
        'CJ_WebHooks' => 'Веб-перехватчики автоматизации Sugar',
        'CJ_Forms' => 'Действия Sugar, относящиеся к Smart Guide',
        'DRI_SubWorkflow_Templates' => 'Шаблоны стадии умного руководства',
        'PubSub_ModuleEvent_PushSubs' => 'Push-подписки на события модуля Pub/Sub',
    ],
    ...
    'moduleIconList' => [
        ...
        'ProductTemplates' => 'PC',
        'ProductBundles' => 'СП',
        'ProductBundleNotes' => 'СП',
        'Reports' => 'От',
        'Forecasts' => 'Пр',
        'ForecastWorksheets' => 'ЛП',
        'ForecastManagerWorksheets' => 'ПМ',
        'Quotas' => 'Квота',
        'VisualPipeline' => 'ВВ',
        'ConsoleConfiguration' => 'НК',
        'SugarLive' => 'Su',
        'Teams' => 'Ко',
        'TeamNotices' => 'УК',
        'Manufacturers' => 'Пр',
    ...
    'moduleListSingular' => [
        ...
        'VisualPipeline' => 'Визуальная воронка продаж',
        'ConsoleConfiguration' => 'Настройка консоли',
        'MobileDevices' => 'Мобильное устройство',
        'SugarLive' => 'SugarLive',
        'Contracts' => 'Контракт',
        ...
        'DataArchiver' => 'Архиватор данных',
        'ArchiveRuns' => 'Архив запущен',
        'ExternalUsers' => 'Внешний пользователь',
        'ReportMaker' => 'Отчеты по компании',
        ...
        'PushNotifications' => 'Принудительное уведомление',
        'Escalations' => 'Эскалация',
        'DocumentTemplates' => 'Шаблон документов',
        'DocumentMerges' => 'Объединение документов',
        'CloudDrivePaths' => 'Путь к облачному хранилищу',
        ...
        'HintEnrichFieldConfigs' => 'HintEnrichFieldConfigs',
        'Geocode' => 'Геокод',
        'DRI_Workflows' => 'Умное руководство',
        'DRI_Workflow_Task_Templates' => 'Шаблон мероприятия умного руководства',
        'DRI_SubWorkflows' => 'Этап умного руководства',
        'DRI_Workflow_Templates' => 'Шаблон умного руководства',
        'CJ_WebHooks' => 'Веб-перехватчик автоматизации Sugar',
        'CJ_Forms' => 'Действие Sugar, относящееся к Smart Guide',
        'DRI_SubWorkflow_Templates' => 'Шаблон стадии умного руководства',
        'PubSub_ModuleEvent_PushSubs' => 'Push-подписка на события модуля Pub/Sub',
    ],
 ...
 */
    ...
    'file_type_dom' => [
        'PDF' => 'PDF',
        'CSV' => 'CSV',
        'PDF and CSV' => 'PDF и CSV',
    ],
    'embed_report_dom' => [
        '' => '',
        'Chart' => 'График',
        'Data Table' => 'Таблица данных',
        'Chart and Data Table' => 'График и таблица данных',
    ],
    'message_status_dom' => [
        '' => '',
...
//       it is the key for the default case_relationship_type_dom value
    ...
    'field_name_placement_dom' => [
        'field_on_side' => 'Рядом со значением поля',
        'field_on_top' => 'Над значением поля',
    ],
    'payment_terms' => [
        '' => '',
        'Net 15' => 'Net 15',
...
//       it is the key for the default case_status_dom value
        ...
        'user_type_group_bool_dom' => [
            true => 'Групповой пользователь',
        ],
        'user_type_portal_bool_dom' => [
            true => 'Пользователь API портала',
        ],
        'license_type_dom' => [
...
//       it is the key for the default quote_relationship_type_dom value
    ...
    /*Added entries 'Queued' and 'Sending' for 4.0 release..*/
        ...
        'dom_email_server_type' => ['' => '--Не выбрано--',
        'imap' => 'IMAP',
        ],
        ...
        'dom_email_distribution' => ['' => '--Не выбрано--',
        'direct' => 'Прямое назначение',
        'roundRobin' => 'В цикле',
        'leastBusy' => 'Наименее занятой',
        ],
        'dom_email_distribution_for_auto_create' => ['roundRobin' => 'В цикле',
        'leastBusy' => 'Наименее занятой',
        'none' => 'Нет',
        ],
        'dom_email_errors' => [1 => 'Выбирайте только одного пользователя, когда напрямую работаете с назначенными записями.',
        2 => 'Вы должны назначать только выбранные записи, когда напрямую работаете с назначенными записями.',
        ],
        'dom_email_bool' => ['bool_true' => 'Да',
        'bool_false' => 'Нет',
        ],
        'dom_int_bool' => [1 => 'Да',
        0 => 'Нет',
        ],
        'dom_switch_bool' => ['on' => 'Да',
        'off' => 'Нет',
        '' => 'Нет',],

        'dom_email_link_type' => ['sugar' => 'Почтовый клиент SugarCRM',
        'mailto' => 'Внешний почтовый клиент'],


        'dom_email_editor_option' => ['' => 'Формат e-mail по умолчанию',
        'html' => 'HTML-сообщение',
        'plain' => 'Текстовое сообщение'],

        'schedulers_times_dom' => ['not run' => 'Время запуска прошло, не выполняем.',
        'ready' => 'Готово',
        'in progress' => 'В процессе',
        'failed' => 'Неудачно',
        'completed' => 'Завершено',
...
//  'Sub-Query' => 'Sub Query',
        ...
        'wflow_fire_order_dom' => ['alerts_actions' => 'Уведомления, затем действия',
...
//prospect list type dom
    ...
    // strings to pass to Flash charts
        ...
        'chart_types' => [
        'hBarF' => 'Горизонтальная линейчатая диаграмма (с накоплением)',
        'hGBarF' => 'Горизонтальная линейчатая диаграмма (сгруппированная)',
        'vBarF' => 'Вертикальная линейчатая диаграмма (с накоплением)',
        'vGBarF' => 'Вертикальная линейчатая диаграмма (сгруппированная)',
        'pieF' => 'Круговая диаграмма',
        'funnelF' => 'Воронка',
        'lineF' => 'Линия',
        'donutF' => 'Кольцевая',
        'treemapF' => 'Древовидная карта',
        ],
        'd3_value_placement' => [
        '0' => 'Не определен',
        '1' => 'По умолчанию',
        ...
        'metric_context_list' => [
        'service_console' => 'Сервисная обслуживания',
        'renewals_console' => 'Консоль продлений',
        ],
    ...
    //Service Duration
        ...
        'show' => 'Отображать список потенциальных получателей',
        'dont_show' => 'Не показывать потенциальных получателей',
        ],
        'docusign_recipient_type_list' => [
        'signer' => 'Подписавший',
        'carbon_copy' => 'Пользователь с правом просмотра (копия)',
        'certified_delivery' => 'Пользователь с правом просмотра (сертифицированная доставка)',
        ],
        ...
        'module_icons_dom' => [
        'sicon-arrow-down' => 'Стрелка вниз',
        'sicon-chevron-left' => 'Шеврон слева',
        'sicon-check' => 'Галочка',
        'sicon-clock' => 'Часы',
        'sicon-dashboard-default' => 'Информационная панель по умолчанию',
        'sicon-dashboard' => 'Информационная панель',
        'sicon-edit' => 'Правка',
        'sicon-caret-down' => 'Курсор вниз',
        'sicon-folder' => 'Папка',
        'sicon-info' => 'Информация',
        'sicon-kebab' => 'Кебаб',
        'sicon-link' => 'Ссылка',
        'sicon-list' => 'Список',
        'sicon-logout' => 'Выход',
        'sicon-minus' => 'Минус',
        'sicon-folder-open' => 'Открыть папку',
        'sicon-plus-sm' => 'Плюс (маленький)',
        'sicon-refresh' => 'Обновить',
        'sicon-plus' => 'Плюс',
        'sicon-settings' => 'Настройки',
        'sicon-arrow-right-double' => 'Стрелка вправо двойная',
        'sicon-reports' => 'Отчеты',
        'sicon-user' => 'Пользователь',
        'sicon-upload' => 'Загрузить',
        'sicon-user-group' => 'Группа пользователей',
        'sicon-arrow-left-double' => 'Стрелка влево двойная',
        'sicon-chevron-up' => 'Шеврон вверх',
        'sicon-caret-up' => 'Курсор вверх',
        'sicon-star-fill' => 'Звезда сплошная',
        'sicon-download' => 'Загрузить',
        'sicon-close' => 'Закрыть',
        'sicon-tile-view' => 'Просмотр в виде плиток',
        'sicon-list-view' => 'Представление в виде списка',
        'sicon-thumbs-down' => 'Большой палец вниз',
        'sicon-warning-circle' => 'Предупреждение в круге',
        'sicon-phone' => 'Телефон',
        'sicon-email' => 'Электронная почта',
        'sicon-document' => 'Документ',
        'sicon-note' => 'Примечание',
        'sicon-preview' => 'Предварительный просмотр',
        'sicon-copy' => 'Копировать',
        'sicon-launch' => 'Начать',
        'sicon-lock' => 'Замок',
        'sicon-arrow-top-right' => 'Стрелка вверх вправо',
        'sicon-full-screen' => 'Во весь экран',
        'sicon-full-screen-exit' => 'Выход из полноэкранного режима',
        'sicon-expand-left' => 'Развернуть влево',
        'sicon-expand-right' => 'Развернуть вправо',
        'sicon-focus-drawer' => 'Детальный вид',
        'sicon-ban' => 'Запрет',
        'sicon-thumbs-up' => 'Большой палец вверх',
        'sicon-search' => 'Поиск',
        'sicon-calendar' => 'Календарь',
        'sicon-calendar-lg' => 'Календарь (большой)',
        'sicon-mobile-lg' => 'Мобильный телефон (большой)',
        'sicon-star-fill-lg' => 'Звезда сплошная (большой)',
        'sicon-star-outline-lg' => 'Звезда контурная (большой)',
        'sicon-reset-lg' => 'Сброс (большой)',
        'sicon-exchange-lg' => 'Обмен (большой)',
        'sicon-help-lg' => 'Справка (большой)',
        'sicon-close-lg' => 'Закрыть (большой)',
        'sicon-plus-lg' => 'Плюс (большой)',
        'sicon-shortcuts-lg' => 'Ярлыки (большие)',
        'sicon-search-lg' => 'Поиск (большой)',
        'sicon-email-lg' => 'Электронная почта (большой)',
        'sicon-note-lg' => 'Примечание (большое)',
        'sicon-document-lg' => 'Документ (большой)',
        'sicon-add-dashlet-lg' => 'Добавить раздел (большой)',
        'sicon-collapse-lg' => 'Свернуть (большой)',
        'sicon-hamburger-lg' => 'Гамбургер (большой)',
        'sicon-pin-fill-lg' => 'Значок местоположения с заливкой (большой)',
        'sicon-expand-lg' => 'Развернуть (большой)',
        'sicon-copy-lg' => 'Копировать (большой)',
        'sicon-dashboard-lg' => 'Информационная панель (большой)',
        'sicon-star-outline' => 'Звезда контурная',
        'sicon-reset' => 'Сбросить',
        'sicon-unlink' => 'Разъединить',
        'sicon-phone-lg' => 'Телефон (большой)',
        'sicon-attach' => 'Вложить',
        'sicon-case-lg' => 'Обращение (большой)',
        'sicon-arrow-right-lg' => 'Стрелка вправо (большой)',
        'sicon-check-circle-lg' => 'Круг с флажком (большой)',
        'sicon-text-formatting' => 'Форматирование текста',
        'sicon-check-circle' => 'Круг с флажком',
        'sicon-upload-lg' => 'Загрузка (большой)',
        'sicon-flag-lg' => 'Флаг (большой)',
        'sicon-studio-lg' => 'Студия (большой)',
        'sicon-contact-lg' => 'Контакт (большой)',
        'sicon-edit-lg' => 'Правка (большой)',
        'sicon-arrow-left' => 'Стрелка влево',
        'sicon-reply-all' => 'Ответить всем',
        'sicon-message-lg' => 'Сообщение (большой)',
        'sicon-info-lg' => 'Информация (большой)',
        'sicon-error-lg' => 'Ошибка (большой)',
        'sicon-check-circle-line-lg' => 'Круг с флажком контурный (большой)',
        'sicon-warning-line-lg' => 'Предупреждение контурное (большой)',
        'sicon-arrow-up' => 'Стрелка вверх',
        'sicon-arrow-right' => 'Стрелка вправо',
        'sicon-nodes' => 'Узлы',
        'sicon-hide' => 'Скрыть',
        'sicon-help' => 'Справка',
        'sicon-twitter' => 'Twitter',
        'sicon-message' => 'Сообщение',
        'sicon-sugar-predict-lg' => 'Прогноз Sugar (большой)',
        'sicon-sugar-predict' => 'Прогноз Sugar',
        'sicon-opportunity-lg' => 'Сделка (большой)',
        'sicon-lead-lg' => 'Предварительный контакт (большой)',
        'sicon-account-lg' => 'Контрагент (большой)',
        'sicon-user-sm' => 'Пользователь (маленький)',
        'sicon-quote-lg' => 'Коммерческое предложение (большой)',
        'sicon-equal' => 'Равно',
        'sicon-slicers-xl' => 'Срезы (самый большой)',
        'sicon-escalation-lg' => 'Эскалация (большой)',
        'sicon-add-circle-lg' => 'Добавить круг (большой)',
        'sicon-add-line-lg' => 'Добавить линию (большой)',
        'sicon-add-target-lg' => 'Добавить цель (большой)',
        'sicon-help-circle-lg' => 'Справка в кружке (большой)',
        'sicon-divide-line-lg' => 'Разделительная линия (большой)',
        'sicon-string' => 'Строка',
        'sicon-filter' => 'Фильтр',
        'sicon-number' => 'Число',
        'sicon-format-lg' => 'Формат (большой)',
        'sicon-insights-lg' => 'Аналитика (большой)',
        'sicon-invalid-circle-lg' => 'Кружок «Недопустимо» (большой)',
        'sicon-layout-xl' => 'Макет (самый большой)',
        'sicon-layout-lg' => 'Макет (большой)',
        'sicon-multiply-line-lg' => 'Линия умножения (большой)',
        'sicon-redo-lg' => 'Повторить (большой)',
        'sicon-refresh-lg' => 'Обновить (большой)',
        'sicon-undo-lg' => 'Отменить (большой)',
        'sicon-activity-feed-xl' => 'Лента мероприятий (очень большая)',
        'sicon-chevron-left-xl' => 'Шеврон слева (очень большой)',
        'sicon-close-xl' => 'Закрыть (очень большой)',
        'sicon-kebab-lg' => 'Шашлык (большой)',
        'sicon-insights-xl' => 'Аналитика (очень большая)',
        'sicon-hide-lg' => 'Скрыть (большой)',
        'sicon-kebab-xl' => 'Шашлык (самый большой)',
        'sicon-comment-xl' => 'Комментарий (самый большой)',
        'sicon-share-lg' => 'Поделиться (большой)',
        'sicon-trash' => 'Корзина',
        'sicon-launch-lg' => 'Запустить (большой)',
        'sicon-thumbs-up-lg' => 'Большой палец вверх (большой)',
        'sicon-thumbs-down-lg' => 'Большой палец вниз (большой)',
        'sicon-warning-lg' => 'Предупреждение (большой)',
        'sicon-wizard-circle-xl' => 'Круг волшебника (большой)',
        'sicon-bell-cross-lg' => 'Колокол с крестом (большой)',
        'sicon-bell-lg' => 'Колокол (большой)',
        'sicon-daily-lg' => 'Ежедневно (большой)',
        'sicon-cloud-download-lg' => 'Облачная загрузка (большой)',
        'sicon-unlock' => 'Разблокировать',
        'sicon-news-lg' => 'Новости (большой)',
        'sicon-weekly-lg' => 'Еженедельно (большой)',
        'sicon-knowledgebase-xl' => 'База знаний (самый большой)',
        'sicon-remove' => 'Удалить',
        'sicon-chevron-down' => 'Шеврон вниз',
        'sicon-slicers-lg' => 'Срезы (большой)',
        'sicon-save-lg' => 'Сохранить (большой)',
        'sicon-info-circle-lg' => 'Информация в кружке (большой)',
        'sicon-chevron-right' => 'Шеврон справа',
        'sicon-warning-circle-lg' => 'Предупреждение в кружке (большой)',
        'sicon-right-paren-line-lg' => 'Линия правой скобки (большой)',
        'sicon-comment-lg' => 'Комментарий (большой)',
        'sicon-target-lg' => 'Цель (большой)',
        'sicon-subtract-line-lg' => 'Линия вычитания (большой)',
        'sicon-settings-lg' => 'Настройки (большой)',
        'sicon-left-paren-line-lg' => 'Линия левой скобки (большой)',
        'sicon-preview-lg' => 'Предварительный просмотр (большой)',
        'sicon-thumbs-down-line-lg' => 'Линия «Большой палец вниз» (большой)',
        'sicon-thumbs-up-line-lg' => 'Линия «Большой палец вверх» (большой)',
        'sicon-send-lg' => 'Отправка (большой)',
        'sicon-contact-xl' => 'Контакт (самый большой)',
        'sicon-wizard-circle-line-xl' => 'Линия круга волшебника (очень большая)',
        'sicon-trash-lg' => 'Корзина (большой)',
        'sicon-pin-lg' => 'Значок местоположения (большой)',
        'sicon-clock-lg' => 'Часы (большие)',
        'sicon-comment-line-xl' => 'Строка комментариев (очень большая)',
        'sicon-dropdown-editor' => 'Редактор выпадающих списков',
        'sicon-amazon' => 'Amazon',
        'sicon-bug' => 'Ошибка',
        'sicon-catalog' => 'Каталог',
        'sicon-cloud' => 'Облако',
        'sicon-config-api' => 'Конфигурация Api',
        'sicon-config-nav' => 'Конфигурация Nav',
        'sicon-connectors' => 'Подключения',
        'sicon-contracts' => 'Контракты',
        'sicon-currencies' => 'Валюты',
        'sicon-diagnostics' => 'Диагностика',
        'sicon-sugar-club' => 'Клуб Sugar',
        'sicon-email-campaign' => 'Рассылка электронной почты',
        'sicon-email-inbound' => 'Входящая электронная почта',
        'sicon-email-queue' => 'Очередь электронной почты',
        'sicon-forecasts' => 'Прогнозы',
        'sicon-display-modules' => 'Показывать модули',
        'sicon-email-contacts' => 'Контакты из электронной почты',
        'sicon-import' => 'Импорт',
        'sicon-log-viewer' => 'Средство просмотра журнала',
        'sicon-lab' => 'Лаборатория',
        'sicon-map-pin' => 'Точка на карте',
        'sicon-manufacturers' => 'Производители',
        'sicon-update' => 'Обновить',
        'sicon-content-security' => 'Безопасность содержимого',
        'sicon-module-builder' => 'Конструктор модулей',
        'sicon-languages' => 'Языки',
        'sicon-module-loader' => 'Загрузчик модулей',
        'sicon-oauth-key' => 'Ключ OAuth',
        'sicon-password-mgmt' => 'Управление паролями',
        'sicon-opportunities' => 'Сделки',
        'sicon-upgrade' => 'Обновление',
        'sicon-portal' => 'Портал',
        'sicon-product-types' => 'Типы продуктов',
        'sicon-quotes' => 'Коммерческие предложения',
        'sicon-relate-fields' => 'Связать поля',
        'sicon-repair' => 'Восстановить',
        'sicon-role-mgmt' => 'Управление ролями',
        'sicon-scheduler' => 'Планировщик',
        'sicon-shippers' => 'Службы доставки',
        'sicon-studio' => 'Студия',
        'sicon-web-logic' => 'Веб-логика',
        'sicon-sugar-u' => 'Sugar U',
        'sicon-tax-rates' => 'Налоговые ставки',
        'sicon-team-mgmt' => 'Управление командой',
        'sicon-team-perm' => 'Разрешения для команды',
        'sicon-tracker' => 'Трекер',
        'sicon-workflow' => 'Бизнес процесс',
        'sicon-mask' => 'Маска',
        'sicon-mask-disabled' => 'Маска отключена',
        'sicon-email-archive' => 'Архив электронной почты',
        'sicon-mobile' => 'Мобильный',
        'sicon-archive' => 'Архив',
        'sicon-automate-scroll' => 'Представление с вертикальной прокруткой',
        'sicon-automate-stacked' => 'Представление с горизонтальной прокруткой',
        'sicon-pdf-manager' => 'Менеджер PDF',
        'sicon-my-sites' => 'Мои сайты',
        'sicon-cloud-insights' => 'Облачная аналитика',
        'sicon-sugar-logo-24' => 'Логотип Sugar 24',
        'sicon-sugar-logo-16' => 'Логотип Sugar 16',
        'sicon-task-lg' => 'Задача (большой)',
        'sicon-web-lg' => 'Веб (большой)',
        'sicon-events-lg' => 'События (большой)',
        'sicon-sugar-logo-12' => 'Логотип Sugar 12',
        'sicon-tag' => 'Тег',
        'sicon-tag-lg' => 'Тег (большой)',
        'sicon-bell-lg-line' => 'Линия колокола (большой)',
        'sicon-matrix-xxl' => 'Матрица (самая большая)',
        'sicon-advanced-filter' => 'Расширенный фильтр',
        'sicon-rows-and-columns-xxl' => 'Строки и столбцы (самые большие)',
        'sicon-summation-details-xxl' => 'Сведения о суммировании (самый большой)',
        'sicon-summation-xxl' => 'Суммирование (самый большой)',
        'sicon-lock-lg' => 'Блокировка (большой)',
        'sicon-csv-file-xxl' => 'Файл Csv (самый большой)',
        'sicon-logo-linkedin' => 'Логотип Linkedin',
        'sicon-briefcase' => 'Портфель',
        'sicon-car-front' => 'Передняя часть автомобиля',
        'sicon-airplane' => 'Самолёт',
        'sicon-laptop' => 'Ноутбук',
        'sicon-logo-instagram' => 'Логотип Instagram',
        'sicon-single-bed' => 'Односпальная кровать',
        'sicon-tiktok' => 'Tiktok',
        'sicon-logo-snapchat' => 'Логотип Snapchat',
        'sicon-video-lg' => 'Видео (большой)',
        'sicon-reply' => 'Ответить',
        'sicon-subtract' => 'Вычесть',
        'sicon-arrow-up-circle-line' => 'Стрелка вверх в контурной окружности',
        'sicon-asterisk' => 'Звездочка',
        'sicon-dot-circle-o-lg' => 'Точка в круге (большой)',
        'sicon-forward' => 'Вперед',
        'sicon-video' => 'Видео',
        'sicon-gavel' => 'Молоток',
        'sicon-login' => 'Вход',
        'sicon-pdf-file-xxl' => 'Файл Pdf (самый большой)',
        'sicon-login-lg' => 'Вход (большой)',
        'sicon-cloud-download-xl' => 'Облачная загрузка (очень большая)',
        'sicon-campaigns-lg' => 'Кампании (большой)',
        'sicon-customer-journey-stages-lg' => 'Этапы пути клиента (большой)',
        'sicon-role-mgmt-lg' => 'Управление ролями (большой)',
        'sicon-default-module-lg' => 'Модуль по умолчанию (большой)',
        'sicon-quoted-line-items-lg' => 'Продукты коммерческого предложения (большой)',
        'sicon-projects-lg' => 'Проекты (большой)',
        'sicon-process-business-rules-lg' => 'Процесс обработки бизнес-правил (большой)',
        'sicon-process-email-templates-lg' => 'Шаблоны электронной почты процесса (большие)',
        'sicon-processes-lg' => 'Процессы (большие)',
        'sicon-process-definitions-lg' => 'Определения процесса (большие)',
        'sicon-target-lists-lg' => 'Целевые списки (большие)',
        'sicon-purchased-line-items-lg' => 'Приобретенные продукты (большой)',
        'sicon-user-group-lg' => 'Группа пользователей (большой)',
        'sicon-revenue-line-items-lg' => 'Доходные продукты (большие)',
        'sicon-business-centers-lg' => 'Бизнес-центры (большие)',
        'sicon-logo-fb-simple' => 'Логотип Fb Простой',
        'sicon-forecasts-lg' => 'Прогнозы (большие)',
        'sicon-contracts-lg' => 'Контракты (большие)',
        'sicon-purchase-lg' => 'Покупка (большой)',
        'sicon-sugar-live-lg' => 'Sugar онлайн (большой)',
        'sicon-customer-journey-lg' => 'Путь клиента (большой)',
        'sicon-data-privacy-lg' => 'Защита данных (большой)',
        'sicon-home-lg' => 'Главная (большой)',
        'sicon-data-table' => 'Таблица данных',
        'sicon-medical-clipboard-lg' => 'Медицинская папка с зажимом (большой)',
        'sicon-privacy-lg' => 'Конфиденциальность (большой)',
        'sicon-marketplace' => 'Рынок',
        'sicon-marketplace-lg' => 'Рынок (большой)',
        'sicon-blockquote-lg' => 'Блочная цитата (большой)',
        'sicon-casino-lg' => 'Казино (большой)',
        'sicon-jacuzzi-lg' => 'Джакузи (большой)',
        'sicon-scissors-lg' => 'Ножницы (большие)',
        'sicon-storage-lg' => 'Хранилище (большой)',
        'sicon-fan-lg' => 'Вентилятор (большой)',
        'sicon-medicine-lg' => 'Лекарство (большой)',
        'sicon-plant-lg' => 'Завод (большой)',
        'sicon-telescope-lg' => 'Телескоп (большой)',
        'sicon-smart-phone-lg' => 'Смартфон (большой)',
        'sicon-coffee-lg' => 'Кофе (большой)',
        'sicon-martini-lg' => 'Мартини (большой)',
        'sicon-cocktail-lg' => 'Коктейль (большой)',
        'sicon-stadium-lg' => 'Стадион (большой)',
        'sicon-fire-lg' => 'Огонь (большой)',
        'sicon-window-lg' => 'Окно (большой)',
        'sicon-lotus-lg' => 'Лотос (большой)',
        'sicon-windmill-lg' => 'Ветряная мельница (большой)',
        'sicon-spades-lg' => 'Пики (большие)',
        'sicon-hearts-lg' => 'Черви (большие)',
        'sicon-diamonds-lg' => 'Бубы (большие)',
        'sicon-clubs-lg' => 'Трефы (большие)',
        'sicon-skull-lg' => 'Череп (большой)',
        'sicon-send' => 'Отправить',
        'sicon-world-lg' => 'Мир (большой)',
        'sicon-airplane-lg' => 'Самолет (большой)',
        'sicon-planet-lg' => 'Планета (большой)',
        'sicon-trainer-lg' => 'Тренер (большой)',
        'sicon-calculator-lg' => 'Калькулятор (большой)',
        'sicon-tv-lg' => 'Телевизор (большой)',
        'sicon-video-player-lg' => 'Видеоплеер (большой)',
        'sicon-media-player-lg' => 'Медиаплеер (большой)',
        'sicon-decentralize-lg' => 'Децентрализация (большой)',
        'sicon-statistics-lg' => 'Статистика (большой)',
        'sicon-virus-lg' => 'Вирус (большой)',
        'sicon-shield-lg' => 'Щит (большой)',
        'sicon-plug-lg' => 'Вилка (большой)',
        'sicon-shuttle-lg' => 'Шаттл (большой)',
        'sicon-soundwave-lg' => 'Звуковая волна (большой)',
        'sicon-graph-lg' => 'График (большой)',
        'sicon-playlist-lg' => 'Список воспроизведения (большой)',
        'sicon-voice-recognition-lg' => 'Распознавание голоса (большой)',
        'sicon-machine-learning-lg' => 'Машинное обучение (большой)',
        'sicon-bed-lg' => 'Кровать (большой)',
        'sicon-blueprint-lg' => 'Чертеж (большой)',
        'sicon-content-delivery-lg' => 'Доставка контента (большой)',
        'sicon-questionnaire-lg' => 'Анкета (большой)',
        'sicon-presentation-lg' => 'Презентация (большой)',
        'sicon-organic-lg' => 'Органический (большой)',
        'sicon-transactions-lg' => 'Транзакции (большой)',
        'sicon-wand-lg' => 'Палочка (большой)',
        'sicon-bin-lg' => 'Корзина (большой)',
        'sicon-sync-lg' => 'Синхронизация (большой)',
        'sicon-external-authentication-lg' => 'Внешняя аутентификация (большой)',
        'sicon-tracking-activity-lg' => 'Отслеживание мероприятия (большой)',
        'sicon-account' => 'Контрагент',
        'sicon-meetings-lg' => 'Встречи (большой)',
        'sicon-stacked' => 'Представление с горизонтальным разделением',
        'sicon-sidebyside' => 'Представление с вертикальным разделением',
        ],
    ...
    // Escalations module
        ...
        'Lack of Progress' => 'Отсутствие прогресса',
        'Customer-Imposed Deadline' => 'Срок, установленный клиентом',
        'Account at Risk' => 'Контрагент в группе риска',
        ],
        'escalation_source_dom' => [
        'Customer Requested' => 'Запрос клиента',
        'Internally Requested' => 'Внутренний запрос',
        ],
    ...
    // Sentiment
        ...
        '' => '',
        '01_not_likely' => 'Маловероятно',
        '02_less_likely' => 'Менее вероятно',
        '03_neutral' => 'Нейтрально',
        '04_more_likely' => 'Более вероятно',
        '05_very_likely' => 'Весьма вероятно',
        ],
        'ai_icp_fit_score_classification_dropdown' => [
        '' => '',
        '03_does_not_match_customers' => 'Не совпадает с клиентами',
        '02_no_match' => '',
        '01_matches_customers' => 'Совпадает с клиентами',
        ],
    ...
    // Sugar Automate
        ...
        'none' => 'Нет',
        'create' => 'В момент создания',
        'stage_start' => 'В момент начала стадии',
        'previous_activity_completed' => 'Предыдущее мероприятие завершено',
        ],
        'dri_workflow_templates_target_assignee_list' => [
        'current_user' => 'Текущий пользователь',
        'parent_assignee' => 'Родительский уполномоченный',
        ],
        'dri_workflow_task_templates_task_due_date_type_list' => [
        '' => '',
        'days_from_created' => 'Дней с момента создания',
        'days_from_stage_started' => 'Дней с начала стадии',
        'days_from_previous_activity_completed' => 'Дней с завершения предыдущего мероприятия',
        'days_from_parent_date_field' => 'Дней с даты в поле родительского элемента',
        'days_from_specific_activity_completed' => 'Дней с завершения конкретного мероприятия',
        ],
        'dri_workflow_task_templates_momentum_start_type_list' => [
        '' => '',
        'created' => 'После создания',
        'stage_started' => 'После начала стадии',
        'previous_activity_completed' => 'После завершения предыдущего мероприятия',
        'parent_date_field' => 'В день с поля даты родительского элемента',
        'specific_activity_completed' => 'Конкретное мероприятие завершено',
        ],
        ...
        '' => '',
        'customer_task' => 'Задача клиента',
        'milestone' => 'Промежуточный этап разработки',
        'internal_task' => 'Внутренняя задача',
        'agency_task' => 'Задача агентства',
        'automatic_task' => 'Автоматическая задача',
        ],
        ...
        'user' => 'Пользователь',
        'team' => 'Команда',
        'user_team' => 'Пользователь и команда',
        ],
        ...
        'stage_edit_button' => 'Изменить стадию',
        'stage_add_task_button' => 'Создать задачу',
        'stage_add_meeting_button' => 'Назначить встречу',
        'stage_add_call_button' => 'Назначить звонок',
        'stage_delete_button' => 'Удалить стадию',
        ],
        'dri_workflow_templates_disabled_activity_actions_list' => [
        'activity_add_sub_task_button' => 'Добавить задачу',
        'activity_add_sub_meeting_button' => 'Запланировать встречу',
        'activity_add_sub_call_button' => 'Назначить звонок',
        'activity_not_applicable_button' => 'Не применимо',
        'activity_delete_button' => 'Удалить',
        ],
        'dri_workflow_templates_cancel_action_list' => [
        'set_not_applicable' => 'Неприменимый набор',
        'remove_open_activities' => 'Удалить открытые мероприятия',
        ],
        ...
        'skip_request' => 'Пропустить запрос',
        'json' => 'JSON',
        'http_query' => 'Запрос HTTP',
        ],
        ...
        '' => '',
        'before_create' => 'Перед созданием',
        'after_create' => 'После создания',
        'before_in_progress' => 'Перед текущим выполнением',
        'after_in_progress' => 'После текущего выполнения',
        'before_completed' => 'Перед завершением',
        'after_completed' => 'После завершения',
        'before_not_applicable' => 'Перед состоянием «неприменимо»',
        'after_not_applicable' => 'После состояния «неприменимо»',
        'before_delete' => 'Перед удалением',
        'after_delete' => 'После удаления',
        ],
        'cj_webhooks_request_body_list' => [
        'journey_body' => 'Отправить информацию об умном руководстве',
        'custom_body' => 'Отправить текст пользовательской публикации',
        ],
        ...
        'automatic_create' => 'Автоматическое создание записи',
        'manual_create' => 'Создание записи вручную',
        'automatic_update' => 'Автоматическое обновление записи',
        'manual_update' => 'Обновление записи вручную',
        ],
        'cj_forms_parent_type_list' => [
        '' => '',
        'DRI_Workflow_Templates' => 'Шаблон умного руководства',
        'DRI_SubWorkflow_Templates' => 'Шаблон стадии',
        'DRI_Workflow_Task_Templates' => 'Шаблон мероприятия',
        ],
        ...
        'Tasks' => 'Текущая задача',
        'Calls' => 'Текущий звонок',
        'Meetings' => 'Текущая встреча',
        ],
        'cj_select_to_options_list' => [
        '' => '',
        'specific_users' => 'Конкретные пользователи',
        'specific_contacts' => 'Конкретные контакты',
        'related_parent_users' => 'Связанные родительские пользователи',
        'related_parent_contacts' => 'Связанные родительские контакты',
        'add_all_contacts_from_parent' => 'Добавить все контакты от родительского элемента',
        ],
        'cj_select_to_options_list_module_mapping' => [
        '' => '',
        'specific_users' => 'Пользователи',
        'specific_contacts' => 'Контакты',
        'related_parent_users' => 'Пользователи',
        'related_parent_contacts' => 'Контакты',
        'add_all_contacts_from_parent' => 'Контакты',
        ],
        ...
        '' => '',
        'smart_guide_to_sugar_action' => 'Smart Guide относительно действия Sugar',
        'sugar_action_to_smart_guide' => 'Действие Sugar относительно Guide',
        ],
        ...
        '' => '',
        'Smart Guide Stage' => 'Стадия Smart Guide',
        'Smart Guide Activities' => 'Мероприятия Smart Guide',
        ...
        '' => '',
        'mark_all_completed' => 'Отметить все действия как завершенные',
        'mark_all_not_applicable' => 'Отметить все незавершенные действия как неприменимые',
        ],
        'doc_merge_default_region_url' => [
        'us-west-2' => 'Соединенные Штаты (Орегон) [us-west-2]',
        'ca-central-1' => 'Канада (Центральная) [ca-central-1]',
        'ap-southeast-1' => 'Азиатско-Тихоокеанский регион (Сингапур) [ap-southeast-1]',
        'ap-southeast-2' => 'Азиатско-Тихоокеанский регион (Сидней) [ap-southeast-2]',
        'eu-central-1' => 'Европа (Франкфурт) [eu-central-1]',
        'eu-west-2' => 'Европа (Лондон) [eu-west-2]',
        ],
];
...
$app_strings = [
    ...
    'LBL_DROPDOWN_VIEW_CHANGE_WARNING' => 'Выбранное значение поля выпадающего списка привело к изменению макета просмотра записи. ' .
        'Значения полей, скрытых в новом макете, были очищены. ',

    // Side navigation bar labels
    'LBL_SIDEBAR_NAV_OPEN' => 'Открыто',
    'LBL_SIDEBAR_NAV_CLOSE' => 'Закрыть',
    'LBL_SIDEBAR_NAV_ITEM_MENU' => 'Меню {{subject}}',
    'LBL_GOTO_SUGARCRM_COM' => 'Перейти к SugarCRM.com',
    ...
    'LBL_START' => 'Начало',
    'LBL_END' => 'Конец',
    'LBL_DATE_LINKED' => 'С привязкой к дате',
 ...
 Пожалуйста, измените значения.',
    ...
    'ERR_REPORTS_DISABLED_EXPORT' => 'Экспорт отчетов отключен',
    'ERR_REPORTS_ADMIN_EXPORT_ONLY' => 'Выполнять экспорт могут только пользователи с правами администратора',
    'ERR_REPORTS_EXPORT_NOT_ALLOWED' => 'В отчете используются модули без доступа к экспорту',
    'ERR_REPORTS_EXPORT_OWNER' => 'В отчете используются модули с правами доступа собственника к экспорту',
    'ERR_REPORTS_LIST_NOT_ALLOWED' => 'В отчете используются модули с ограниченным доступом к списку',
    'ERR_REPORTS_VIEW_NOT_ALLOWED' => 'В отчете используются модули с ограниченным доступом к просмотру',
    'ERR_REPORTS_ACCESS_DISABLED' => 'В отчете используются модули с ограниченным доступом',
    'ERR_REPORTS_FIELDS_RESTRICTED' => 'В отчете используются поля с ограниченным доступом',
    ...
    'EXCEPTION_CLIENT_NOT_ALLOWED' => 'Данного клиента нельзя допускать',
    'EXCEPTION_MODULELOADER_UPLOAD' => 'Возможность загрузки пакетов недоступна для вашего типа лицензии',
    ...
    'EXCEPTION_CLIENT_NOT_ALLOWED_DESC' => 'Данного клиента нельзя допускать',
    ...
    'LBL_ESCALATIONS' => 'Эскалации',
    'LBL_ESCALATION' => 'Эскалация',
    'LBL_DOCUSIGN_ENVELOPES' => 'Конверты DocuSign',
    'LBL_DOCUSIGN_ENVELOPE' => 'Конверт DocuSign',
    'LBL_DOCUSIGN_SELECT_RECIPIENTS' => 'Выберите получателей подписывающей стороны',
    ...
    'LBL_COMPOSE_EMAIL_BUTTON_LABEL2' => 'Адрес электронной почты',
    ...
    'LBL_ACTIVITY_MODIFIED' => 'Изменено',
    ...
    'LBL_FILTER_CREATE_NEW_UNSAVED' => 'Создать фильтр (несохраненный)',
    'LBL_FILTER_EDIT_UNSAVED_SUFFIX' => '(Несохраненный)',
    ...
    'LBL_LISTVIEW_FREEZE_COLUMN_1' => 'Закрепить столбец 1',
    ...
    'LBL_LISTVIEW_SELECTED_CLEAR' => 'Очистить все выбранные параметры.',
    ...
    'TPL_LISTVIEW_SELECTED' => 'Вы выбрали {{num}} записей в наборе данных.',
    'TPL_LISTVIEW_SELECTED_ONE' => 'Вы выбрали 1 запись в наборе данных.',
    ...
    'LBL_LISTVIEW_SELECT_ALL_ON_PAGE' => 'Выбрать все записи на этой странице',
    'LBL_LISTVIEW_DESELECT_ALL_ON_PAGE' => 'Отменить выбор всех записей на этой странице',

    'TPL_LIST_HEADER_COUNT' => '{{num}}',
    'TPL_LIST_HEADER_COUNT_PARTIAL' => '{{num}}+',
    'TPL_LIST_HEADER_COUNT_TOTAL' => '{{num}} из {{total}}',
    'TPL_LIST_HEADER_COUNT_LOADING' => '{{num}} загрузки...',
    'TPL_LIST_HEADER_COUNT_TOOLTIP' => 'Щелкните, чтобы получить сумму',
    // List View Pagination
    'LBL_LIST_PAGINATION_OF' => 'из',
    'LBL_GET_PAGE_COUNT_TOOLTIP' => 'Получить количество страниц',
    ...
    'LBL_FINISH_IMPERSONATING' => 'Завершить имитирование',
    'LBL_RESET_MFA' => 'Сбросить многофакторную аутентификацию',
    'LBL_YOU_ARE_CURRENTLY_IMPERSONATING' => '{{sudoer}}, в настоящее время вы работаете от имени пользователя {{user}}.',
    'LBL_PROFILE' => 'Профиль',
    'LBL_MAILMERGE_KEY' => 'M',
    'LBL_MAILMERGE' => 'Объединение почты',
    'LBL_MASS_UPDATE' => 'Групповое обновление',
    'LBL_MASS_UPDATE_ALL_RECORDS' => 'Выбрать все записи для массового обновления',
    'LBL_MASS_UPDATE_SINGLE_RECORD' => 'Включить запись в массовое обновление',
    ...
    'LBL_COUNT_MODULES' => 'Количество модулей: {{count}}',
    ...
    'LBL_RELATED_TYPE' => 'Связанный тип',
    ...
    'LBL_RELATED_RECORDS' => 'Связанный {{module}}',
    ...
    'LBL_METRIC_DELETE_WARNING' => 'Все пользователи, с которыми поделились данной вкладкой показателей, также потеряют доступ.',
    ...
    'NTC_DELETE_SUCCESS' => 'Вы удалили {0}.',
    ...
    'NTC_UNLINK_CASES_CONTACT_CONFIRMATION' => 'Действительно отменить связь с {0}? Это также удалит пользователя из поля обращения "Основное контактное лицо".',
    'NTC_UNLINK_CASES_CONTACT_ERROR' => 'Невозможно удалить связь с {0}, поскольку этот пользователь является основным контактным лицом по этому обращению. Перед отменой связи с этой записью обновите поле "Основной контакт".',
    ...
    'LBL_WARN_ACTIVE_CCP_UNSAVED_CHANGES' => 'Обновление браузера автоматически приведет к закрытию всех открытых сеансов звонков или чатов SugarLive, все несохраненные изменения будут утеряны. Желаете продолжить?',
    ...
    'LBL_MFA_RESET_CONFIRMATION' => 'Действительно сбросить <a href="https://support.sugarcrm.com/SmartLinks/Custom/Logging_In_Using_MFA/" target="_blank">многофакторную аутентификацию</a>? 
Выполнение этого действия приведет к немедленному выходу из системы, и вам нужно будет пройти проверку подлинности с помощью приложения для проверки подлинности при следующем входе в систему.',
    'LBL_MFA_RESET_CONFIRMATION_BTN' => 'Подтвердить и выйти',
    ...
    // sentiment
    'LBL_SENTIMENT_POSITIVE' => 'Положительный',
    'LBL_SENTIMENT_NEUTRAL' => 'Нейтральный',
    'LBL_SENTIMENT_NEGATIVE' => 'Отрицательный',

    // Console Metric Tabs
    'LBL_NO_METRIC_CONFIGURED' => 'Вкладки показателей не настроены',
    'LBL_NO_METRIC_VISIBLE' => 'Отсутствуют видимые вкладки показателей',
    'LBL_MAKE_METRIC_VISIBLE' => 'Выберите «Упорядочить», чтобы сделать вкладки показателей видимыми',
    'LBL_PLEASE_CONTACT_ADMIN' => 'Пожалуйста, свяжитесь с вашим администратором',
    ...
    'LBL_DASHLET_FREEZE_FIRST_COLUMN' => 'Закрепить первый столбец',
    ...
    'LBL_RESTORE_DEFAULT_DASHLETS' => 'Восстановить дашлеты по умолчанию',
    ...
    'LBL_DASHLET_ITERACTIONS_NAME' => 'Временная шкала',
    ...
    'LBL_LEARNING_RESOURCES_SUGAR_OUTFITTERS_LINK' => 'Магазин SugarOutfitters',
    ...
    'LBL_SINGULAR_LABEL' => 'Единичная метка',
    'LBL_PLURAL_LABEL' => 'Множественная метка',
    'LBL_MODULE_DISPLAY' => 'Отображение',
    'LBL_MODULE_DISPLAY_TYPE' => 'Тип отображения',
    'LBL_MODULE_ICON' => 'Значок',
    'LBL_MODULE_COLOR' => 'Цвета фона модуля',
    'LBL_LANGUAGE_SELECTOR' => 'Язык',
    'LBL_MODULE_NAMES_AND_ICONS_SETTINGS' => 'Настройки модуля',
    'LBL_MODULE_NAMES_AND_ICONS_SETTINGS_SAVED' => 'Настройки модуля сохранены.',
    ...
    'LBL_CCP_DIALOUT_NOT_ALLOWED' => 'Прежде чем осуществлять исходящий звонок, закройте все сеансы чатов в SugarLive.',
    ...
    'LBL_FILE_UPLOAD_TO_EXTERNAL_API' => 'Загрузить во внешний источник',
    'LBL_FILE_LINK_FROM_EXTERNAL_API' => 'Ссылка из внешнего источника',
    ...
    'LBL_REFRESH_BUTTON_LABEL' => 'Обновить',
    'LBL_REFRESH_BUTTON_TITLE' => 'Обновить',
    'LBL_DUPLICATE_BUTTON_KEY' => 'U',
    'LBL_DUPLICATE_BUTTON_LABEL' => 'Дублировать',
    'LBL_DUPLICATE_BUTTON_TITLE' => 'Дублировать [Alt+U]',
    'LBL_REPORT_SCHEDULES_BUTTON_LABEL' => 'Расписания отчетов',
    'LBL_REPORT_SCHEDULES_BUTTON_TITLE' => 'Расписания отчетов',
    'LBL_REPORT_DETAILS_BUTTON_LABEL' => 'Подробности отчета',
    'LBL_REPORT_DETAILS_BUTTON_TITLE' => 'Подробности отчета',
    ...
    'LBL_ESCALATE_BUTTON_LABEL' => 'Выполнить эскалацию',
    ...
    'LBL_TIMEZONE_UPDATED' => 'Система Sugar изменила часовой пояс в профиле пользователя, чтобы он соответствовал часовому поясу браузера',
    'LBL_SUCCESS' => 'Успешно',
    'LBL_ERROR' => 'Ошибка',
    ...
    'LBL_THEME_PREVIEW' => 'Предварительный просмотр темы портала',
    ...
    'LBL_YES' => 'Да',
    'LBL_NO' => 'Нет',
    'LBL_SHOW_NUMBERING' => 'Показать нумерацию стадий',
    'LBL_HIDE_NUMBERING' => 'Скрыть нумерацию стадий',
    ...
    'LBL_ESCALATIONS' => 'Эскалации',
    'LBL_ESCALATED' => 'Выполнена эскалация',
    'LBL_ESCALATIONS_SUBPANEL_TITLE' => 'Эскалации',
    'LBL_OTHER_ESCALATIONS_SUBPANEL_TITLE' => 'Другие связанные эскалации',
    'LBL_ESCALATIONS' => 'Эскалации',
    ...
    'ERR_OFFLINE_CLEAN_UP_CONFIRMATION' => 'Недостаточно свободного места для автономного хранилища. Рекомендуется очистка хранилища. Это может занять несколько минут.',
    ...
    'LBL_ERR_EXPORTING_CSV' => 'Экспорт не удался',
    'LBL_ERR_EXPORT_ALL' => 'Не удалось извлечь данные для выбранных записей. Повторите попытку',
    'LBL_LIST_SETTINGS_RESTORE' => 'Восстановить значения по умолчанию',
    'LBL_LIST_SETTINGS_RESTORE_CONFIRM' => 'Восстановить поля?',
    'LBL_LIST_SETTINGS_TITLE' => 'Конструктор представления списка',
    'LBL_LIST_SETTINGS_TEXT_TITLE' => 'Доступные поля',
    'LBL_LIST_SETTINGS_REMOVE' => 'Удалить',
    'LBL_LIST_SETTINGS_TEXT' => 'Перетащите поля в окно конструктора представления списка и упорядочите их для создания представления списка {{moduleName}}.',
    'LBL_LIST_SETTINGS_ERROR_EMPTY' => 'К макету должно быть добавлено минимум одно поле.',
    'LBL_LIST_SETTINGS_EMPTY' => 'Доступные поля',
    'LBL_LIST_SETTINGS_NO_MATCHING' => 'Соответствующих полей не найдено',
    'LBL_LIST_FILTER' => 'Поиск поля',
    'LBL_MOBILE_APP_EMAIL_CLIENT' => 'Почтовый клиент',
    'LBL_DEFAULT_SYSTEM_CLIENT' => 'Внешний почтовый клиент',
    'LBL_SUGAR_MOBILE_CLIENT' => 'Почтовый клиент Sugar',
    'LBL_OFFLINE_CAPABILITIES' => 'Включить возможности автономного режима',
    'LBL_OFFLINE_TRANSACTION_DELETE_ERROR' => 'Не удалось удалить транзакцию.',
    'LBL_OFFLINE_TRANSACTION_DELETED' => 'Транзакция удалена.',
    'LBL_SECURE_MODE' => 'Улучшенный режим безопасности',
    'LBL_SECURE_MODE_ANDROID_TEXT' => 'Включите этот параметр, чтобы скрыть содержимое Sugar Mobile, когда приложение находится в фоновом режиме, и не допускать создания скриншотов приложения в любое время.',
    'LBL_SECURE_MODE_IOS_TEXT' => 'Включите этот параметр, чтобы скрыть содержимое Sugar Mobile, когда приложение находится в фоновом режиме.',
    'LBL_ALWAYS_OFFLINE_MODE' => 'Всегда автономный режим',
    'LBL_ALWAYS_OFFLINE_MODE_ENABLED_PROMPT' => 'Вы работаете в автономном режиме. Хотите переподключиться?',
    'LBL_RECONNECT' => 'Переподключиться',
    'LBL_STAY_OFFLINE' => 'Оставаться в автономном режиме',
    'ERR_MOBILE_MODULE_NOT_SUPPORTED' => 'Модуль, к которому вы пытаетесь получить доступ, недоступен в Sugar Mobile.',
    'LBL_MOBILE_RELEASE_NOTE' => 'Sugar Mobile для заметок о версии {{platform}}',
    'LBL_MOBILE_USER_GUIDE' => 'Sugar Mobile для руководства пользователя {{platform}}',
    'LBL_OPERATOR_CONTAINING_THESE_WORDS' => 'содержит эти слова',
    'LBL_OPERATOR_EXCLUDING_THESE_WORDS' => 'исключая эти слова',
    'LBL_NOTIFICATIONS_CHANNEL' => 'Обновления',
    'LBL_APPLY_BUTTON_LABEL' => 'Применить',
    'LBL_ACTION_CREATE_FAILURE' => "Не удалось сохранить запись:\n {{{reason}}}",
    'LBL_ACTION_UPDATE_FAILURE' => "Не удалось обновить запись:\n {{{reason}}}",
    'LBL_ACTION_FIELD_CALC_ERROR' => 'Не удалось произвести подсчеты полей на сервере.',
    'LBL_ACTION_MODEL_VALIDATION_ERROR' => 'Следующие поля недействительны: {{{fields}}}.',
    'LBL_ACTION_CREATE_RECORD_SUCCESS' => '<b>Готово.</b> Вы успешно создали модуль {{{module}}} <a href="#{{{recordUrl}}}">"{{{recordName}}}".</a>',
    'LBL_ACTION_UPDATE_SUCCESS' => '<b>Готово.</b> Вы успешно обновили запись',
    'LBL_ACTION_COMPOSE_FAILED_DATA_FETCH' => 'Не удалось получить данные электронной почты с сервера.',
    'LBL_ASSIGN_SUCCESS' => '<b>Готово.</b> Запись была назначена {{{userName}}}',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_TITLE' => 'Сохранить данное письмо как черновик?',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_CONFIRM' => 'Сохранить как черновик',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_CANCEL' => 'Отменить создание письма',
    'LBL_MOBILE_EMAIL_SAVE_DRAFT_MSG' => 'Если вы не сохраните черновик, данное письмо будет утрачено.',
    'LBL_MOBILE_EMAIL_CHOOSE_SIGNATURE' => 'Выберите подпись',
    'LBL_MOBILE_EMAIL_CHOOSE_TEMPLATE' => 'Выберите шаблон письма',
    'LBL_MOBILE_EMAIL_CONFIRM_TEMPLATE' => 'Шаблон перезапишет все содержимое данного письма. Вы действительно хотите использовать этот шаблон и перезаписать содержимое?',
    'LBL_MOBILE_EMAIL_COMPOSE' => 'Написать письмо',
    'LBL_MOBILE_EMAIL_NO_RELATED_TO_WITH_TEMPLATE_SEND_ANYWAYS' => 'Ваше письмо содержит переменные, которые будут заменены значениями из записи «Связано с». Перед отправкой подтвердите, что поле «Связано с» установлено правильно.',
    'LBL_ERR_NO_OUTBOUND_ACCOUNTS_AVAILABLE' => 'Учетных записей исходящей электронной почты не найдено. Обратитесь к своему администратору Sugar.',
    'LBL_EMAIL_MORE_RECIPIENTS' => ' и еще {{{count}}}',
    'LBL_RECEPIENTS_EMAIL_ADD' => 'Добавить адрес электронной почты',
    'LBL_EMAIL_RECIPIENTS_EMPTY_HINT' => 'Введите имя контакта или адрес электронной почты',
    'LBL_EMAIL_RECIPIENT_NEW_EMAIL' => '{{{email}}} (новый адрес электронной почты)',
    'LBL_TEMPLATE_HAS_VARIABLES' => 'Переменные',
    'LBL_FILTER_EMAIL_TYPE_TEMPLATES' => 'Шаблоны сообщений',
    'LBL_FILTER_CAMPAIGN_TYPE_TEMPLATES' => 'Шаблоны кампании',
    'LBL_FILTER_WORKFLOW_TYPE_TEMPLATES' => 'Шаблоны рабочих процессов',
    'LBL_FILTER_SYSTEM_TYPE_TEMPLATES' => 'Системные шаблоны',
    'LBL_FILTER_EDIT' => 'Изменить фильтр',
    'LBL_FILTER_MY_FILTER' => 'Мой фильтр',
    'LBL_FILTER_MY_FILTER_BY' => 'Мой фильтр по {{{filters}}}',
    'LBL_FILTER_SAVE' => 'Сохранить фильтр',
    'LBL_SELECT_PARAM' => 'Выбрать',
    'LBL_SELECT_MODULES' => 'Выбор модуля',
    'LBL_SELECT_ADDITIONAL_PARAMS' => 'Выбрать дополнительный параметр',
    'LBL_FILTER_TEMPORARY' => 'Временный фильтр',
    'LBL_ERROR_FILE_UPLOAD' => 'Не удалось загрузить файл {{{fieldLabel}}} «{{{fileName}}}». {{{reason}}}',
    'LBL_ERROR_EDIT_FAILED_UPLOAD' => '<br/><a href="#{{{recordUrl}}}">Просмотреть неудавшуюся запись</a>',
    'LBL_FILE_UPLOAD_ONE' => 'Сохранение файла...',
    'LBL_FILE_UPLOAD_MANY' => 'Сохранение файла {{{index}}} из {{{total}}}...',
    'LNK_NOTIFICATIONS_SETTINGS' => 'Настройки уведомлений',
    'LBL_PUSH_NOTIFICATIONS_SETTINGS' => 'Управляйте push-уведомлениями',
    'LBL_PUSH_NOTIFICATIONS_SETTINGS_FOOTER' => "Управляйте отображением уведомлений с помощью настроек уведомлений вашего устройства.",
    'LBL_NOTIFICATION_ASSIGMENTS' => 'Назначения',
    'LBL_NOTIFICATION_ASSIGMENTS_DSC' => 'Получайте уведомления, когда записи назначаются вам.',
    'LBL_NOTIFICATION_MENTIONS' => 'Упоминания',
    'LBL_NOTIFICATION_MENTIONS_DSC' => 'Получайте уведомления, когда кто-то упоминает вас в записях журнала комментариев.',
    'LBL_NOTIFICATIONS_COMMENTLOG_MISSING' => 'Поле журнала комментариев не было добавлено администратором к данному макету. Обратитесь к своему администратору Sugar.',
    'ERR_NO_PERMISSION_TITLE' => 'Разрешите доступ',
    'ERR_NO_CAMERA_PERMISSION_MSG' => '{{{brandName}}} необходим доступ к камере, чтобы вы могли вкладывать фотографии. Разрешите доступ к камере в системных настройках.',
    'LBL_MOBILE_SYSTEM_SETTINGS' => 'Настройки',
    'LBL_ACTIVE_SUBSCRIPTIONS_FIELD_DURATION' => 'Продолжительность',
    'LBL_ACTIVE_SUBSCRIPTIONS_FIELD_TIMEREMAINING' => 'Оставшееся время',
    'LBL_LIST_SUPPORT_EXPIRES' => 'Истечение срока',
    'LBL_CASCADE_RLI_EDIT' => 'Обновить открытые позиции статьи доходов',
    'LBL_MOBILE_CALENDAR' => 'Календарь',
    'LBL_MOBILE_CALENDAR_SETTINGS' => 'Настройки календаря',
    'LBL_MOBILE_CALENDAR_WEEK_START' => 'День начала недели',
    'LBL_MOBILE_CALENDAR_MODULES' => 'События для отображения',
    'LBL_MOBILE_CALENDAR_DURATION_HR_MIN' => '{{{hours}}}ч:{{{minutes}}} мин',
    'LBL_MOBILE_CALENDAR_DURATION_HR' => '{{{hours}}} ч',
    'LBL_MOBILE_CALENDAR_DURATION_MIN' => '{{{minutes}}} мин',
    'LBL_MOBILE_CALENDAR_TODAY' => 'Сегодня',
    'LBL_MOBILE_CALENDAR_CREATE_MSG' => 'Добавить {{{moduleName}}}',
    'LBL_MOBILE_CALENDAR_CREATE_TITLE' => 'Запланировать действие',
    'LBL_MOBILE_CALENDAR_ERROR_NO_MODULE' => 'Включите минимум один тип событий.',
    'LBL_MOBILE_CALENDAR_EVENT_ALL_DAY' => 'Весь день',
    'LBL_MOBILE_CALENDAR_INITIALIZATION_ERROR' => 'Не удалось загрузить календари.',
    'LBL_ACTIONBUTTON_NOT_SUPPORTED_ACTION' => 'Данное действие недоступно в Sugar Mobile. Вместо этого вы хотите открыть классическое приложение?',
    'LBL_DOC_MERGES_SELECT_TEMPLATE' => 'Выберите шаблон',
    'LBL_DOC_MERGES_ACTION_MERGE' => 'Объединить',
    'LBL_ERROR_IMAGE_NO_EXIF' => 'Ошибка: данные EXIF отсутствуют в файле HEIC',
    'LBL_ERROR_IMAGE_TOO_BIG' => 'Ошибка: разрешение изображения слишком высокое',
    'LBL_ERROR_IMAGE_CANNOT_PROCESS' => 'Ошибка: невозможно обработать изображение',
    'LBL_ERROR_IMAGE_CANVAS_FAILED' => 'Ошибка: не удалось передать изображение на полотно',
    'LBL_ERROR_IMAGE_LOAD_FAILED' => 'Ошибка: не удалось загрузить файл как изображение',
    'LBL_ACTIONS_SELECTION_COUNT_SINGLE' => 'Выбран 1 элемент',
    'LBL_ACTIONS_SELECTION_COUNT_MULTIPLE' => 'Выбрано элементов: {{{count}}}',
    'LBL_ACTIONS_SELECT_ALL_TITLE' => 'Выбрать все',
    'LBL_ACTIONS_SELECT_ALL_HEADER' => 'Вы выбрали {{{count}}} запись(-ей) в данном представлении. Выбрать все записи?',
    'LBL_ACTIONS_SELECT_ALL_VISIBLE' => 'Выберите {{{count}}} запись(-ей)',
    'LBL_ACTIONS_SELECT_DELETE_CONFIRM' => 'Вы действительно хотите удалить выбранную(-ые) запись(-и)?',
    'LBL_ACTIONS_MASS_DELETE_PROGRESS' => 'Удаление… {{{count}}} из {{{total}}}',
    'LBL_ACTIONS_MASS_EMAIL_EMPTY' => 'В выбранных записях действительные адреса электронной почты не найдены',

    // Dark mode related
    'LBL_MOBILE_APP_THEME' => 'Оформление',
    'LBL_MOBILE_APP_THEME_SYSTEM' => 'Использовать системные настройки',
    'LBL_MOBILE_APP_THEME_LIGHT' => 'Светлый',
    'LBL_MOBILE_APP_THEME_DARK' => 'Темный',
    // Attachments related
    'LBL_ATTACHMENT_RENAME_TITLE' => 'Имя нового файла',
    'LBL_ATTACHMENT_RENAME_MSG' => 'Переименовать файл',
    // Filters related
    'LBL_CREATED_BY_ME' => 'Создано мной',
    'LBL_OPERATOR_ONE_OF' => 'один из',
    'LBL_OPERATOR_NOT_ONE_OF' => 'не один из',
    'LBL_OPERATOR_CONTAINS' => 'любой из',
    'LBL_OPERATOR_CONTAINS_WORD' => 'содержит',
    'LBL_OPERATOR_NOT_CONTAINS' => 'не любой из',
    'LBL_OPERATOR_EMPTY' => 'пустой',
    'LBL_OPERATOR_NOT_EMPTY' => 'не является пустым',
    'LBL_OPERATOR_MATCHES' => 'в точности совпадает',
    'LBL_OPERATOR_STARTS_WITH' => 'начинается с',
    'LBL_OPERATOR_EQUALS' => 'равно',
    'LBL_OPERATOR_NOT_EQUALS' => 'не равно',
    'LBL_OPERATOR_GREATER_THAN' => 'больше, чем',
    'LBL_OPERATOR_LESS_THAN' => 'меньше, чем',
    'LBL_OPERATOR_GREATER_THAN_OR_EQUALS' => 'больше, чем или равно',
    'LBL_OPERATOR_LESS_THAN_OR_EQUALS' => 'меньше, чем или равно',
    ...
    'LBL_OPERATOR_MORE_X_DAYS_AGO' => 'Более __ дней назад',
    'LBL_OPERATOR_LAST_X_DAYS' => 'Последние __ дней',
    'LBL_OPERATOR_NEXT_X_DAYS' => 'Следующие __ дней',
    'LBL_OPERATOR_MORE_X_DAYS_AHEAD' => 'Более __ дней в будущем',
    ...
    'LBL_OPERATOR_AFTER_TODAY' => 'после сегодняшнего дня',
    'LBL_OPERATOR_BEFORE_TODAY' => 'до сегодняшнего дня',
    'LBL_ERROR_FILTER_EMPTY' => 'Добавьте критерий для фильтра.',
    'LBL_ADD_FILTER' => 'Добавить критерий',
    'LBL_FILTER_NAME' => 'Название фильтра',
    'LBL_FILTER_FIELD' => 'Поле',
    'LBL_FILTER_OPERATOR' => 'Оператор',
    'LBL_FILTER_VALUE' => 'Значение',
    'LBL_FILTER_SYNC_TO_SERVER' => 'Сохранить в настольном приложении',
    'LBL_FILTER_LOCAL' => 'Локальный фильтр',
    ...
    'LBL_NO_OPTIONS' => 'Нет доступных вариантов',
    ...
    'LBL_MOBILE_CHOOSE_NAVIGATOR' => 'Выберите приложение для сопоставления',
    'LBL_OVERWRITE_PROCESS_CLAIM_QUESTION' => '{{entityName}} имеет связанные значения: {{localizedFieldNames}}. Отмените для сохранения существующих значений. Подтвердите перезапись с новыми значениями.',
    'LBL_OFFLINE_DATA_ENCRYPTION_ENABLED' => 'Шифрование данных включено.',
    'LBL_LEAD_ALREADY_CONVERTED' => 'Выбранный предварительный контакт уже конвертирован.',
    'LBL_OPERATION_NOT_AVAILABLE_OFFLINE' => 'Данное действие доступно только при условии, что устройство находится в сети',
    'LBL_QUOTES_GENERATE_OPPORTUNITY' => 'Действительно создать сделку из коммерческого предложения?',
    'LBL_TAG_ADD' => 'Добавить тег',
    'LBL_TAG_ENTER_TAG_NAME' => 'Ввести тег',
    'LBL_TAG_OFFLINE_READ_NOT_SUPPORTED' => 'Функция фильтрования по тегам не поддерживается, когда устройство находится вне сети.',
    'LBL_COMMENTLOG_SHOWCOMMENT' => 'Показать комментарий полностью',
    'LBL_COMMENT_VIEW' => 'Просмотреть комментарий',
    'LBL_PMSE_LABEL_DUEDATE' => 'Дата выполнения',
    'LBL_PMSE_DUE' => 'До',
    'LBL_PMSE_DUE_ON' => 'Выполнить до',
    'LBL_LEAD_CONVERSION_PARENT_RECORD_REQUIRED' => 'Сначала необходимо создать {{conversionParentModuleName}}',
    'LBL_LEAD_CONVERSION_MISSING_REQUIRED' => 'Отсутствуют необходимые записи: {{{missingRecords}}}',
    'LBL_IMAGE_QUALITY_SELECTOR_HINT' => 'Выберите качество изображения. Перед сохранением на сервере размер изображения будет соответственно изменен. Выбранное значение будет в будущем использоваться как значение по умолчанию для всех похожих операций.',
    'LBL_IMAGE_QUALITY_SELECTOR_CALCULATING' => 'Оценка размера файла...',
    'LBL_IMAGE_QUALITY_SELECTOR_CALCULATED' => 'Приблизительный размер файла:',
    'LBL_IMAGE_QUALITY_SELECTOR_HEADER' => 'Качество изображения',
    'LBL_IMAGE_QUALITY_BEST' => 'Исходный размер',
    'LBL_IMAGE_QUALITY_GOOD' => 'Надлежащее качество',
    'LBL_IMAGE_QUALITY_POOR' => 'Небольшой размер',
    'LBL_IMAGE_QUALITY_BTN' => 'Сжатие: {{{rate}}}',
    'LBL_LIST_CONFIGURABLE_HEADER' => 'Перечислить поля на {{module}}',
    'LBL_LIST_RESET_FIELDS' => 'Сбросить до значений по умолчанию',
    'LBL_LIST_NOT_ENOUGH' => 'Настройте как минимум 1 активное поле.',
    'LBL_LOGIN_PERMISSION_ABORTED' => 'Чтобы получить возможность работать с системой SugarCRM, необходимо выполнить вход и принять разрешения.',
    'LBL_SELECTING_EXISTING_RECORD' => 'Выбор {{{moduleSingular}}}',
    'LBL_CREATING_NEW_RECORD' => 'Создание нового {{{moduleSingular}}}',
    'LBL_IMAGE_QUALITY_SELECTOR_LABEL' => 'Размер изображения',
    'LBL_COPY_ADDRESS' => 'Копировать адрес',
    'LBL_OPEN_IN' => 'Открыть в',
    'LBL_MULTIATTACHMENTS_NO_FILE_SELECTED' => 'Файлы не выбраны.',
    'LBL_ATTACHMENT_ADD' => 'Вложить',

    // Mobile cookie consent
    'LBL_USE_COOKIES_CONFIRM_TITLE' => 'Данное приложение использует файлы cookie',
    'LBL_USE_COOKIES_CONFIRM' => 'Для оптимизации использования данное приложение использует файлы cookie. Продолжая, вы даете свое согласие на использование файлов cookie в соответствии с нашей политикой конфиденциальности.',

    // Mobile warnings
    'WARN_SERVER_OUTDATED' => 'Вы используете систему Sugar, несовместимую с будущей мобильной версией Sugar Mobile. Обратитесь к своему администратору, чтобы в кратчайшие сроки обновить Sugar.',
    'ERROR_TAG_NAME_INVALID' => 'Название тега не должно содержать символов «{{{forbiddenChars}}}»',
    'ERROR_NO_TAGS_FOUND' => 'Не найдены теги, совпадающие с «{{{searchQuery}}}»',
    'ERR_PA_RECORD_INVALID' => 'Запись {{{moduleName}}} содержит одно или несколько недопустимых значений и не может быть сохранена. Желаете изменить запись, чтобы выполнить действие {{{actionLabel}}}?',
    'ERR_MOBILE_METADATA_RELOAD' => 'Администратор внес изменения в конфигурацию вашей системы Sugar. Нажмите ОК, чтобы синхронизировать конфигурацию вашего приложения с сервером.',
    ...
    'LBL_PORTAL_CHAT_CONFIRMATION_CLOSE' => 'Действительно закрыть чат?',

    // Portal timeline view
    'LBL_PORTAL_NEW_NOTE_TITLE' => 'Создать заметку или добавить вложение',
    'LBL_PORTAL_NEW_NOTE_BTN' => 'Добавить заметку',
    ...
    'LBL_PORTAL_INVALID_GRANT' => 'Срок действия сеанса истек. Войдите в систему повторно.',
    'LBL_PORTAL_INVALID_GRANT_TITLE' => 'Срок действия сеанса истек',
    ...
    'LBL_AGENT_WORKBENCH' => 'Сервисная обслуживания',
    'LBL_AGENT_WORKBENCH_OVERVIEW' => 'Обзор',
    'LBL_CASE_OVERDUE' => 'Overdue',
    'LBL_CASE_DUE_SOON' => 'Due soon',
    'LBL_CASE_DUE_LATER' => 'Due later',

    'LBL_RESTORE_DASHBOARD_DEFAULT' => 'Восстановить информационную панель по умолчанию',
    ...
    'LBL_OMNICHANNEL_LINK_RECORD' => 'Связать с модулем {{module}}',
    ...
    'LBL_OMNICHANNEL_CONFIG_LAYOUT' => 'Настроить макет',
    'LBL_OMNICHANNEL_FINISH_CONFIGURING_BEFORE_OUTBOUND_CALL' => 'Прежде чем осуществлять исходящий вызов, завершите настройку SugarLive.',
    'LBL_OMNICHANNEL_FINISH_CONFIGURING_BEFORE_OPENING_SUGARLIVE' => 'Прежде чем открыть SugarLive, завершите настройку макета SugarLive.',
    'LBL_OMNICHANNEL_SET_OFFLINE_BEFORE_CONFIGURING' => 'Прежде чем настраивать макет SugarLive, включите режим «Автономный».',
    'LBL_OMNICHANNEL_COMPACT_VIEW' => 'Компактное представление',
    'LBL_OMNICHANNEL_FULL_VIEW' => 'Полное представление',

    //14.0 Dashboards
    'LBL_BRD__CONSOLE' => 'Информационная панель BDR',
    'LBL_SALES_MANAGER_CONSOLE' => 'Информационная панель менеджера по продажам',
    'LBL_SALES_REP_CONSOLE' => 'Информационная панель торгового представителя',
    'LBL_MARKETING_CONSOLE' => 'Информационная панель для маркетинга',
    'LBL_CUSTOMER_SUCCESS_CONSOLE' => 'Информационная панель службы заботы о клиентах',
    'LBL_EXECUTIVE_CONSOLE' => 'Информационная панель руководителя',

    // Omnichannel Console Config
    'LBL_RESTORE_TAB_DEFAULT' => 'Восстановить настройки вкладки по умолчанию',
    'LBL_CONFIGURE_SUMMARY_PANEL' => 'Настроить итоговую панель',
    ...
    'LBL_CSP_ERROR_MESSAGE' => 'Введенные вами значения не поддерживаются или не соответствуют допустимому формату. Список допустимых значений и форматов полей см. в документации <a href="{{linkToDocumentation}}" target="_blank">Система</a>.',
    'LBL_CSP_ERROR_MESSAGE_ADMIN' => 'Данное содержимое не утверждено. Обновите <a href="{{linkToDocumentation}}" target="_blank">Настройки политики защиты содержимого</a> в своей системе.',
    'LBL_CSP_ERROR_MESSAGE_USER' => 'Данное содержимое не утверждено. Обратитесь к своему администратору, чтобы обновить <a href="{{linkToDocumentation}}" target="_blank">Настройки политики защиты содержимого</a> в своей системе. После обновления настроек необходимо обновить браузер, чтобы изменения вступили в силу.',

    // For password related labels
    'LBL_PASSWORD' => 'Пароль',
    'LBL_CHANGE_YOUR_PASSWORD' => 'Измените пароль',
    'LBL_PASSWORD_REQUIREMENTS' => 'Требования к паролю',
    'LBL_CURRENT_PASSWORD' => 'Текущий пароль',
    'LBL_NEW_PASSWORD1' => 'Новый пароль',
    'LBL_NEW_PASSWORD2' => 'Подтвердить пароль',
    'LBL_PASSWORD_CHANGED' => 'Вы успешно изменили пароль',
    ...
    'LBL_NO_CHART_REPORT_AVAILABLE' => 'Нет доступных диаграмм.',
    'LBL_NO_FILTERS_REPORT_AVAILABLE' => 'Данный отчет не содержит фильтров.',
    'LBL_NO_RUNTIME_FILTERS_REPORT_AVAILABLE' => 'Вы скрыли только фильтры среды выполнения, смотрите расширенные фильтры.',
    'LBL_RUNTIME_FILTERS' => 'Фильтры среды выполнения',
    'LBL_RUNTIME_FILTER_DATE_PREF_MISSMATCH' => 'Дата не соответствует предпочтительному формату даты пользователя: ',
    'LBL_DASHLET_NO_RUNTIME_FILTERS' => 'В этом разделе отсутствуют фильтры среды выполнения',
    'LBL_DASHBOARD_FILTER_GROUP' => 'Новый фильтр',
    'LBL_RUNTIME_FILTER_LIMITATION' => 'Необходимо выбрать минимум одно значение.',
    'LBL_RESET_FILTERS_TO_DEFAULT' => 'Сбросить до стандартных фильтров',
    'LBL_COPY_FILTER_SUMMARY' => 'Копировать сводку о фильтрах',
    'LBL_APPLY_FILTERS' => 'Применить',
    'LBL_REPORTS_FILTERS' => 'Фильтры',
    'LBL_RUNTIME_FILTERS_INVALID' => 'Невозможно применить фильтр среды выполнения из-за неверных значений',
    'LBL_RUNTIME_FILTERS_COPIED' => 'Сводка о фильтрах была скопирована в буфер обмена.',
    'LBL_ADVANCED_FILTERS' => 'Расширенные фильтры',
    'LBL_ADVANCED_OR_DESC' => 'Включать, когда выполняется ЛЮБОЕ условие',
    'LBL_ADVANCED_AND_DESC' => 'Включать, когда выполняются ВСЕ условия',
    'LBL_ORIGINAL_DESIGN_FILTER' => 'Это исходный фильтр',
    'LBL_AND_UPPERCASE' => 'И',
    'LBL_REPORTS_PREVIEW_LIMITATION' => 'Данная функция недоступна в режиме предварительного просмотра',
    'LBL_REPORT_DEFAULT_NAME' => 'Отчет без названия',
    'LBL_REPORT_QUERY' => 'Запрос',
    'LBL_REPORTS_DASHLET_INTELLIGENT' => 'Связано с текущей записью',
    'LBL_REPORTS_DASHLET_RELATED_LINK' => 'Связанное поле',
    'LBL_REPORTS_DASHLET_INVALID_LINK' => 'Связанное поле не может быть пустым',
    'LBL_REPORTS_DASHLET_INVALID_REPORT' => 'Отчет не выбран.',
    'LBL_REPORTS_DASHLET_LINE_CHART_INVALID' => 'Линейная диаграмма несовместима с данным отчетом',
    'LBL_REPORT_DASHLET' => 'Дашлет отчетов',
    'LBL_REPORTS_DASHLET_DATATABLE' => 'Таблица данных',
    'LBL_REPORTS_DASHLET_RUNTIME_FILTERS' => 'Фильтры среды выполнения',
    'LBL_REPORTS_DASHLET_DATATABLE_PREVIEW' => 'Предварительный просмотр таблицы данных',
    'LBL_REPORTS_DASHLET_CHART' => 'Диаграмма',
    'LBL_REPORTS_DASHLET_CHART_PREVIEW' => 'Предварительный просмотр графика',
    'LBL_REPORTS_DASHLET_FILTER_PREVIEW' => 'Предварительный просмотр фильтра',
    'LBL_REPORTS_DASHLET_INVALID_FEATURE' => 'Выбранный отчет не поддерживает график.',
    'LBL_REPORTS_DASHLET_LABELS' => 'Ярлыки',
    'LBL_REPORTS_DASHLET_SHOW_COUNT' => 'Показать общее количество записей',
    'LBL_REPORTS_DASHLET_SORT_ORDER' => 'Порядок сортировки',
    'LBL_REPORTS_DASHLET_DEFAULT_VIEW' => 'Выбранный по умолчанию вид',
    'LBL_REPORTS_DASHLET_PRIMARY_CHART_SORT' => 'Основной порядок сортировки графика',
    'LBL_REPORTS_DASHLET_SECONDARY_CHART_SORT' => 'Дополнительный порядок сортировки графика',
    'LBL_REPORTS_DASHLET_NO_LINKS_SELECTED' => 'Нет ссылок {{module}} на выбранный отчет',
    'LBL_REPORTS_DASHLET_NO_AVAILABLE_FOR_REPORT_TYPE' => 'Недоступно для данного типа отчета',
    'LBL_REPORTS_DASHLET_UNABLE_TO_DOWNLOAD_CHART_TAB' => 'Данная функция доступна только во вкладке графика',
    'LBL_REPORTS_CHART_TYPE' => 'Тип диаграммы',
    'LBL_REPORTS_CHART_CONFIG_VALUE_PLACEMENT' => 'Размещение значения гистограммы',
    'LBL_REPORTS_CHART_CONFIG_SHOW_TOTAL' => 'Показать итог',
    'LBL_REPORTS_CHART_LEGEND_OPEN' => 'Показать условные обозначения',
    'LBL_REPORTS_CHART_CONFIG_SHOW_XAXIS_LABEL' => 'Показать метку оси x',
    'LBL_REPORTS_CHART_CONFIG_SHOW_YAXIS_LABEL' => 'Показать метку оси y',
    'LBL_REPORTS_DASHLET_CONFIGURE_DISPLAY_ROWS' => 'Ограничение числа отображаемых строк',
    'LBL_REPORTS_DASHLET_RUNTIME_NO_PERMISSONS' => 'У вас нет разрешения на использование этих фильтров среды выполнения.',
    ...
    'LBL_BEST_FORECAST' => 'Подтверждение (оптимистичный)',
    'LBL_WORST_FORECAST' => 'Подтверждение (пессимистичный)',
    'LBL_LIKELY_FORECAST' => 'Подтверждение (вероятный)',
    'LBL_BEST_ADJUSTED' => 'Скорректированное подтверждение (оптимистичный)',
    'LBL_WORST_ADJUSTED' => 'Скорректированное подтверждение (пессимистичный)',
    'LBL_LIKELY_ADJUSTED' => 'Скорректированное подтверждение (вероятный)',
    ...
    'LBL_NEED_HELP' => 'Требуется помощь с чем-то новым?',
    'LBL_NEW_CASE' => 'Новое обращение',
...
Чтобы создать новую запись, используя значения, недавно внесенные, нажмите "Игнорировать копии и сохранить" в верхнем правом углу экрана.',
    ...
    'LBL_CALENDAR_REPEAT_ON' => 'Повтор включен',
    ...
    'TPL_REPEAT_INTERVAL' => 'Каждый {{repeatIntervalValue}} {{repeatTypeValue}}',
    'LBL_UNSUPPORTED_RRULE' => 'В данной серии используется параметр «Повтор включен», который недоступен в Sugar, так как серия была синхронизирована из клиента календаря. Пожалуйста, отредактируйте данную серию в клиенте календаря, если вы хотите повторять ее в определенную дату. Редактирование данной серии в Sugar установит для параметра «Повтор включен» значение «Нет».<br><br>Хотите продолжить?',
    ...
    'LBL_CALENDAR_DASHLET_NAME' => 'Планировщик календаря',
    ...
    'LBL_CALENDAR_DAY' => 'день',
    'LBL_CALENDAR_WEEK' => 'неделя',
    'LBL_CALENDAR_MONTH' => 'месяц',
    'LBL_CALENDAR_YEAR' => 'год',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_2'  => '2-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_3'  => '3-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_4'  => '4-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_5'  => '5-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_6'  => '6-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_7'  => '7-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_8'  => '8-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_9'  => '9-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_10' => '10-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_11' => '11-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_12' => '12-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_13' => '13-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_14' => '14-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_15' => '15-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_16' => '16-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_17' => '17-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_18' => '18-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_19' => '19-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_20' => '20-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_21' => '21-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_22' => '22-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_23' => '23-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_24' => '24-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_25' => '25-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_26' => '26-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_27' => '27-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_28' => '28-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_29' => '29-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_30' => '30-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_31' => '31-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_32' => '32-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_33' => '33-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_34' => '34-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_35' => '35-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_36' => '36-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_37' => '37-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_38' => '38-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_39' => '39-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_40' => '40-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_41' => '41-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_42' => '42-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_43' => '43-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_44' => '44-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_45' => '45-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_46' => '46-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_47' => '47-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_48' => '48-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_49' => '49-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_50' => '50-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_51' => '51-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_52' => '52-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_53' => '53-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_54' => '54-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_55' => '55-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_56' => '56-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_57' => '57-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_58' => '58-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_59' => '59-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_60' => '60-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_61' => '61-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_62' => '62-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_63' => '63-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_64' => '64-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_65' => '65-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_66' => '66-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_67' => '67-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_68' => '68-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_69' => '69-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_70' => '70-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_71' => '71-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_72' => '72-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_73' => '73-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_74' => '74-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_75' => '75-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_76' => '76-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_77' => '77-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_78' => '78-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_79' => '79-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_80' => '80-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_81' => '81-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_82' => '82-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_83' => '83-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_84' => '84-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_85' => '85-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_86' => '86-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_87' => '87-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_88' => '88-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_89' => '89-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_90' => '90-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_91' => '91-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_92' => '92-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_93' => '93-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_94' => '94-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_95' => '95-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_96' => '96-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_97' => '97-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_98' => '98-й',
    'LBL_CALENDAR_REPEAT_INTERVAL_VALUE_99' => '99-й',
    ...
    'LBL_ACCEPT_STATUS' => 'Принять статус',
    ...
    'LBL_RECORD_DASHBOARD' => 'Информационная панель записей',
    ...
    'LBL_ACTIVITY_TIMELINE_DASHLET' => 'Временная шкала',
    'LBL_NO_ACTIVITY' => 'Нет действий',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Временная шкала {{moduleSingular}}',
    'LBL_ACTIVITY_TIMELINE_SHOW_MORE' => 'Больше',
    'LBL_ACTIVITY_TIMELINE_SHOW_LESS' => 'Меньше',
    'LBL_ACTIVITY_TIMELINE_DASHLET_DESCRIPTION' => 'На временной шкале отображаются записи, связанные с текущей записью, и обновления выбранных полей с течением времени.',
    ...
    'LBL_MODULE_UNAVAILABLE' => 'Модуль не лицензирован.',
...
// Omnichannel
    ...
    'LBL_CLOSE_FOCUS_DRAWER' => 'Закрыть фокусную панель',
    ...
    'LBL_ENUM_DISPLAY_LABEL' => 'Отображать ярлыки',

    'LBL_BLANK' => '-blank-',

    'LBL_OPEN_RECORD_VIEW' => 'Открыть режим просмотра записей',

    // actionbutton
    'LBL_ACTIONBUTTON_ADD' => 'Добавить',
    'LBL_ACTIONBUTTON_HELP_NOT_AVAILABLE' => 'Помощь недоступна',
    'LBL_ACTIONBUTTON_FUNCTIONS' => 'Функции',
    'LBL_ACTIONBUTTON_FIELDS' => 'Поля',
    'LBL_ACTIONBUTTON_SELECT_FIELD' => 'Выберите поле...',
    'LBL_ACTIONBUTTON_ROLLUP' => 'Свертка',
    'LBL_ACTIONBUTTON_RELATED' => 'Связанные',
    'LBL_ACTIONBUTTON_SAVE' => 'Сохранить',
    'LBL_ACTIONBUTTON_CANCEL' => 'Отмена',
    'LBL_ACTIONBUTTON_R_MODULE' => 'Связанный модуль',
    'LBL_ACTIONBUTTON_R_FIELDS' => 'Связанные поля',
    'LBL_ACTIONBUTTON_ROLL_MODULE' => 'Модуль свертки',
    'LBL_ACTIONBUTTON_ROLL_FIELDS' => 'Поля свертки',
    'LBL_ACTIONBUTTON_ROLL_TYPE' => 'Функция свертки',
    'LBL_ACTIONBUTTON_MINIMUM' => 'Мин.',
    'LBL_ACTIONBUTTON_MAXIMUM' => 'Макс.',
    'LBL_ACTIONBUTTON_AVERAGE' => 'Среднее',
    'LBL_ACTIONBUTTON_SUM' => 'Сумма',
    'LBL_ACTIONBUTTON_ASSIGN_RECORD' => 'Назначить запись',
    'LBL_ACTIONBUTTON_COMPOSE_EMAIL' => 'Написать письмо',
    'LBL_ACTIONBUTTON_CREATE_RECORD' => 'Создать запись',
    'LBL_ACTIONBUTTON_DOCUMENT_MERGE' => 'Объединение документов',
    'LBL_ACTIONBUTTON_OPEN_URL' => 'Открыть URL-адрес',
    'LBL_ACTIONBUTTON_RUN_REPORT' => 'Запустить отчет',
    'LBL_ACTIONBUTTON_UPDATE_RECORD' => 'Обновить запись',
    'LBL_ACTIONBUTTON_ACTION' => 'Действие',
    'LBL_ACTIONBUTTON_ASSIGN_TO' => 'Назначить',
    'LBL_ACTIONBUTTON_EMAIL_TO' => 'Написать пользователю',
    'LBL_ACTIONBUTTON_USE_PMSE' => 'Использовать PMSE',
    'LBL_ACTIONBUTTON_TEMPLATE' => 'Шаблон',
    'LBL_ACTIONBUTTON_MODULE' => 'Модуль',
    'LBL_ACTIONBUTTON_DISPLAY_SETTINGS' => 'Настройки отображения',
    'LBL_ACTIONBUTTON_BUTTON_TYPE' => 'Тип',
    'LBL_ACTIONBUTTON_DROPDOWN' => 'Выпадающий список',
    'LBL_ACTIONBUTTON_BUTTON' => 'Кнопка',
    'LBL_ACTIONBUTTON_BUTTON_GROUP' => 'Группа кнопок',
    'LBL_ACTIONBUTTON_SHOW_FIELD_LABEL' => 'Отображать метку в записи',
    'LBL_ACTIONBUTTON_SHOW_RECORD_HEADER' => 'Отображать в заголовке',
    'LBL_ACTIONBUTTON_HIDE_ON_EDIT' => 'Скрыть при редактировании',
    'LBL_ACTIONBUTTON_DISPLAY_ON_FOCUS_DASHBOARD' => 'Отобразить в заголовке фокусной панели',
    'LBL_ACTIONBUTTON_DASHBOARD' => 'Информационная панель',
    'LBL_ACTIONBUTTON_FOCUS_DASHBOARD_HEADER' => 'Заголовок фокусной панели',
    'LBL_ACTIONBUTTON_SIZE' => 'Размер',
    'LBL_ACTIONBUTTON_DEFAULT' => 'По умолчанию',
    'LBL_ACTIONBUTTON_SMALL' => 'Маленький',
    'LBL_ACTIONBUTTON_LARGE' => 'Большой',
    'LBL_ACTIONBUTTON_CALCULATED' => 'Рассчитано',
    'LBL_ACTIONBUTTON_DOCUMENT_CONVERT' => 'Конвертировать в PDF',
    'LBL_ACTIONBUTTON_DOCUMENT_MERGE' => 'Объединение документов',
    'LBL_ACTIONBUTTON_URL' => 'URL-адрес',
    'LBL_ACTIONBUTTON_PREVIEW' => 'Предварительный просмотр',
    'LBL_ACTIONBUTTON_PROPERTIES' => 'Свойства',
    'LBL_ACTIONBUTTON_LABEL_TITLE' => 'Надпись',
    'LBL_ACTIONBUTTON_DESC' => 'Подсказка',
    'LBL_ACTIONBUTTON_SHOW_LABEL' => 'Показать надпись',
    'LBL_ACTIONBUTTON_SHOW_ICON' => 'Показать значок',
    'LBL_ACTIONBUTTON_SCHEME' => 'Цветовая схема',
    'LBL_ACTIONBUTTON_ICON' => 'Значок',
    'LBL_ACTIONBUTTON_IS_DEPENDENT' => 'Зависимый',
    'LBL_ACTIONBUTTON_DESIGN' => 'Настройка макета',
    'LBL_ACTIONBUTTON_STOP_ON_ERROR' => 'Останавливать при ошибке',
    'LBL_ACTIONBUTTON_AUTOSAVE' => 'Автосохранение',
    'LBL_ACTIONBUTTON_CONFIG' => 'Конфигурация',
    'LBL_ACTIONBUTTON_CONFIG_ERROR' => 'Перед сохранением настройте кнопку действия.',
    'LBL_ACTIONBUTTON_CONFIG_BTN' => 'Настроить кнопки',
    'LBL_ACTIONBUTTON_AUTO_CREATE' => 'Автоматическое создание',
    'LBL_ACTIONBUTTON_LINK' => 'Создать связь с родительским элементом',
    'LBL_ACTIONBUTTON_COPY_PARENT' => 'Копировать родительские значения',
    'LBL_ACTIONBUTTON_PRESET' => 'Задать значение(-я) поля(-ей)',
    'LBL_ACTIONBUTTON_PRESET_PARENT' => 'Скопировать значение(-я) поля(-ей) из родительского элемента',
    'LBL_ACTIONBUTTON_SELECT_OPTION' => 'Выбрать...',
    'LBL_ACTIONBUTTON_PARENT_FIELD' => 'Из родительского поля ',
    'LBL_ACTIONBUTTON_DELETE_BUTTON' => 'Действительно удалить эту кнопку?',
    'LBL_ACTIONBUTTON_DELETE_ACTION' => 'Действительно удалить это действие?',
    'LBL_ACTIONBUTTON_INVALID_DATA' => 'Недействительные данные кнопки действия',
    'LBL_ACTIONBUTTON_SELECT_MODULE' => 'Выберите модуль перед сохранением.',
    'LBL_ACTIONBUTTON_SELECT_LINK' => 'Выберите ссылку перед сохранением. Если ссылка недоступна, снимите флажок с опции ссылки.',
    'LBL_ACTIONBUTTON_SELECT_RECORD' => 'Выберите запись перед сохранением.',
    'LBL_ACTIONBUTTON_SELECT_TEMPLATE' => 'Выберите шаблон перед сохранением.',
    'LBL_ACTIONBUTTON_THEME_PRIMARY' => 'Основная',
    'LBL_ACTIONBUTTON_THEME_SECONDARY' => 'Дополнительная',
    'LBL_ACTIONBUTTON_THEME_HIGHVIZ' => 'HighViz',
    'LBL_ACTIONBUTTON_THEME_OCEAN' => 'Океан',
    'LBL_ACTIONBUTTON_THEME_PINK' => 'Розовый',
    'LBL_ACTIONBUTTON_THEME_ARMY' => 'Армия',
    'LBL_ACTIONBUTTON_THEME_TEAL' => 'Сине-зеленый',
    'LBL_ACTIONBUTTON_THEME_PACIFIC' => 'Тихоокеанский',
    'LBL_ACTIONBUTTON_THEME_GREEN' => 'Зеленый',
    'LBL_ACTIONBUTTON_THEME_YELLOW' => 'Желтый',
    'LBL_ACTIONBUTTON_THEME_ORANGE' => 'Оранжевый',
    'LBL_ACTIONBUTTON_THEME_RED' => 'Красный',
    'LBL_ACTIONBUTTON_THEME_CORAL' => 'Коралловый',
    'LBL_ACTIONBUTTON_THEME_PURPLE' => 'Фиолетовый',
    'LBL_ACTIONBUTTON_FORMULA' => 'Формула',
    'LBL_ACTIONBUTTON_ACTIONS' => 'Действия',
    'LBL_ACTIONBUTTON_VALIDATION_ERROR' => 'Ошибка проверки данных кнопки.',
    'LBL_ACTIONBUTTON_VALIDATION_ERROR_NEED_LABEL_OR_ICON' => 'Кнопки должны иметь как минимум подпись или набор значков.',
    'LBL_ACTIONBUTTON_VALIDATION_ERROR_NEED_LABEL' => 'Введите допустимую подпись кнопки.',
    'LBL_ACTIONBUTTON_INVALID_FIELD_VALUES' => 'Не удалось создать запись из-за отсутствия необходимых значений. Обратитесь к администратору.',
    'LBL_ACTIONBUTTON_INVALID_DROPDOWN_ERROR' => 'Для этого типа кнопки необходимы как минимум две активные кнопки.',
    'LBL_ACTIONBUTTON_RECORD' => 'Представления записи',
    'LBL_ACTIONBUTTON_ACTION_MENU' => 'Меню действий',
    'LBL_ACTIONBUTTON_ORDER' => 'Порядок',
    'LBL_ACTIONBUTTON_LIST_VIEW' => 'Представление списка',
    'LBL_ACTIONBUTTON_RECORD_VIEW' => 'Заголовок представления записи',
    'LBL_ACTIONBUTTON_RECORD_VIEW_DASHLET' => 'Заголовок раздела представления записи',
    'LBL_ACTIONBUTTON_SUBPANELS' => 'Субпанели',
    'LBL_ACTIONBUTTON_TASK_SEQUENCE_FAILED' => 'Системе выполнения последовательности задач не удалось выполнить следующие действия: ',
    'LBL_ACTIONBUTTON_ADD_ACTION' => 'Добавить действие',
    'LBL_ACTIONBUTTON_REMOVE_ACTION' => 'Удалить действие',
    'LBL_ACTIONBUTTON_ASSIGN_CURRENT_USER' => 'Текущий пользователь',

    //document merging
    'LBL_MERGE_TEMPLATE_BUTTON_LABEL' => 'Объединение документов',
    'LBL_MERGE_TEMPLATE_PDF_BUTTON_LABEL' => 'Объединение документов в PDF-файл',

    //hint
    'LBL_HINT_COMPANY_SIZE' => 'Размер компании',
    'LBL_HINT_COMPANY_INDUSTRY' => 'Отрасль',
    'LBL_HINT_COMPANY_INDUSTRY_TAGS' => 'Отраслевые теги',
    'LBL_HINT_COMPANY_LOCATION' => 'Местонахождение компании',
    'LBL_HINT_COMPANY_DESCRIPTION' => 'Описание компании',
    'LBL_HINT_COMPANY_FOUNDED_YEAR' => 'Год основания',
    'LBL_HINT_COMPANY_FACEBOOK' => 'Facebook компании',
    'LBL_HINT_COMPANY_TWITTER' => 'Twitter компании',
    'LBL_HINT_COMPANY_PIC' => 'Логотип компании',
    'LBL_HINT_CONTACT_PIC' => 'Фотография контактного лица',
    'LBL_HINT_COMPANY_WEBSITE' => 'Вебсайт компании',
    'LBL_HINT_PHOTO' => 'Ссылка на фотографию',
    'LBL_HINT_JOB_2' => 'Предыдущие задания',
    'LBL_HINT_EDUCATION' => 'Образование',
    'LBL_HINT_EDUCATION_2' => 'Дополнительное образование',
    'LBL_HINT_TWITTER' => 'Ссылка на Twitter',
    'LBL_HINT_FACEBOOK' => 'Ссылка на Facebook',
    'LBL_HINT_COMPANY_NAICS_CODE_LABEL' => 'Код NAICS',
    'LBL_HINT_COMPANY_SIC_CODE_LABEL' => 'Код SIC',
    'LBL_HINT_COMPANY_FISCAL_YEAR_END' => 'Конец финансового года',
    'LBL_HINT_COMPANY_ANNUAL_REVENUE' => 'Годовой доход',
    'LBL_HINT_PHONE_1' => 'Телефон 1',
    'LBL_HINT_PHONE_2' => 'Телефон 2',
    'LBL_HINT_PANEL' => 'Sugar Hint',
    'LBL_HINT_JOIN_TABLE' => 'Присоединить таблицу',
    'LBL_HINT_FULL_NAME' => 'Полное имя',
    'LBL_HINT_JOB_TITLE' => 'Название должности',
    'LBL_HINT_OFFICE_PHONE' => 'Рабочий телефон',
    'LBL_HINT_MOBILE_PHONE' => 'Мобильный телефон',
    'LBL_HINT_OTHER_PHONE' => 'Другой тел.',
    'LBL_HINT_WEBSITE' => 'Сайт',
    'LBL_HINT_MSG_OVERWRITE_ALL' => 'Вы хотите перезаписать все существующие данные для этой записи новыми, найденными в Sugar Hint?',
    'LBL_HINT_MSG_OVERWRITE_FIELD' => 'Вы хотите перезаписать существующий {{fieldName}} для этой записи новым {{fieldName}}, найденным в Sugar Hint?',
    'LBL_HINT_MSG_TOTAL_OVERWRITE' => 'Все данные, связанные с учетной записью, будут удалены. Вы уверены, что хотите продолжить?',
    'LBL_HINT_COMPANY_LOGO' => 'Логотип',
    'LBL_HINT_CONTACTS_AVATAR' => 'Фотография',
    'LBL_HINT_ACCOUNTSETS' => 'Теги набора счетов Sugar Hint',

    'LBL_HINT_LOADING' => 'Загрузка ...',
    'LBL_HINT_UNINSTALL_PROCESSING' => 'Идет деинсталляция Sugar Hint, пожалуйста, подождите',
    'LBL_HINT_VALUE_ERASED' => ' Значение удалено ',
    'LBL_HINT_VALUE_ERASED_TOOLTIP' => 'Эти данные были удалены в связи с требованиями политики защиты данных',

    'LBL_HINT_UNINSTALL_TITLE' => 'Выберите один из параметров удаления ниже:',
    'LBL_HINT_UNINSTALL_PARTIAL' => 'Удалить только пакет Hint',
    'LBL_HINT_UNINSTALL_FULL' => 'Удалить Hint полностью',
    'LBL_HINT_UNINSTALL_PARTIAL_DESCRIPTION' => 'Этот параметр удалит Hint MLP и отключит все активные подписки на Sugar Hint Insights.
     Переустановка Hint автоматически активирует подписки повторно.',
    'LBL_HINT_UNINSTALL_FULL_DESCRIPTION' => 'Этот параметр выполнит полное удаление Hint, включая удаление MLP и удаление всей информации о конфигурации и подписке.',
    'LBL_HINT_UNINSTALL' => 'Деинсталляция',
    'LBL_HINT_UNINSTALL_HEADER' => 'Деинсталляция Sugar Hint',
    'LBL_HINT_CANCEL' => 'Отмена',
    'LBL_HINT_UNINSTALL_WARNING1' => 'ПРЕДУПРЕЖДЕНИЕ. Выбирайте этот параметр только в том случае, если вы не собираетесь использовать Hint в будущем.
     Перед выполнением удаления выполните полное резервное копирование базы данных Sugar и переведите Sugar в режим обслуживания. ',
    'LBL_HINT_UNINSTALL_WARNING2' => 'См. ',
    'LBL_HINT_UNINSTALL_WARNING_LINK' => 'Руководство администратора Sugar Hint ', // TODO: This URL needs to be changed.
    'LBL_HINT_UNINSTALL_WARNING3' => 'для получения сведений о процессе деинсталляции.',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE1' => 'Вы действительно хотите удалить только пакет Sugar Hint?',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE2' => 'Вы действительно хотите удалить пакет Sugar Hint полностью?',
    'LBL_HINT_UNINSTALL_WARNING_MESSAGE2_SUBTEXT' => '(ПРИМЕЧАНИЕ. ЭТО ДЕЙСТВИЕ НЕЛЬЗЯ ОТМЕНИТЬ)',

    'LBL_HINT_CONFIG_TITLE' => 'Поля Sugar Hint',
    'LBL_HINT_NO_RESULTS_MSG' => 'Ничего не было найдено.',
    'LBL_HINT_CONFIG_BASIC_PREVIEW' => 'Базовый макет панели Hint',
    'LBL_HINT_CONFIG_TAB_ACCOUNTS' => 'Контрагенты',
    'LBL_HINT_CONFIG_TAB_CONTACTS' => 'Контакты',
    'LBL_HINT_CONFIG_TAB_LEADS' => 'Предварительные контакты',
    'LBL_HINT_CONFIG_EXPANDED_PREVIEW' => 'Развернутый макет панели Hint',
    'LBL_HINT_CONFIG_DIR_PAR1' => 'Измените порядок полей, перетащив их в разделы макетов панелей Hint выше.',
    'LBL_HINT_CONFIG_DIR_PAR2' => 'Подробные указания и перечень полей по умолчанию можно просмотреть в ',
    'LBL_HINT_CONFIG_RESTORE_TEXT' => ' восстановить настройки по умолчанию для ',
    'LBL_HINT_CONFIG_MODULE_TEXT' => 'модуля.',
    'LBL_HINT_CONFIG_WARNING_MESSAGE' => 'Вы действительно хотите восстановить значения по умолчанию для модуля {{module}}?',
    'LBL_HINT_CONFIG_RESTORE_BUTTON' => 'Нажмите здесь',
    'LBL_HINT_CONFIG_NAME' => 'Руководство администратора Hint.',
    'LBL_HINT_CONFIG_FIELD_SELECTOR' => 'Поля',
    'LBL_HINT_ENRICHED_FIELD_SUBTITLE' => 'Обогащенные поля',
    'LBL_HINT_ENRICHED_FIELD_SUBTITLE_NOTE' => 'В этом разделе перечислены все поля Hint и поля Sugar, обогащенные Hint. Поля Hint помечены звездочкой (*) и могут отображаться на панели Hint только в том случае, если они обогащены.',
    'LBL_HINT_CONFIG_FIELD_NAME' => 'Имя поля',
    'LBL_HINT_CONFIG_ENRICH_FIELD' => 'Обогатить поле',
    'LBL_HINT_CONFIG_FIELD_SHOW1' => 'Показать в Hint',
    'LBL_HINT_CONFIG_FIELD_SHOW2' => 'Показать на панели Hint',
    'LBL_HINT_ADDITIONAL_FIELD_SUBTITLE' => 'Дополнительные поля Sugar',
    'LBL_HINT_ADDITIONAL_FIELD_SUBTITLE_NOTE' => 'В этом разделе перечислены все поля Sugar, которые не обогащены Hint.',
    'LBL_HINT_RESYNC_NOTIFICATION_TITLE' => 'Предупреждение',
    'LBL_HINT_RESYNC_NOTIFICATION_DESCRIPTION' => 'Внимание! Вы собираетесь выполнить синхронизацию с сервисом Sugar Hint Insights. Все ожидающие рассылки дайджестов будут потеряны, а существующие новости будут удалены из дашлета Insights. Уведомления всех типов возобновятся после завершения синхронизации.',

    'LBL_HINT_ACCOUNT_CHANGE_TITLE' => 'Предлагаемые компании, связанные с вашим {{_moduleSingular}}, перечислены ниже. Выберите данные компании для отображения.',
    'LBL_HINT_NO_ACCOUNT_SELECTED' => 'Контрагент не выбран',

    'LBL_HINT_EMAIL_IMPORT_TITLE' => 'Найдено несколько сообщений электронной почты, выберите нужные для импорта: ',

    'LBL_HINT_HELP_MESSAGE1' => 'По введенным данным Hint не удалось отыскать совпадение в системе.',
    'LBL_HINT_HELP_MESSAGE2' => 'Hint выдает наилучшие результаты в поиске по имени физического лица и адресу его электронной почты.',
    'LBL_HINT_HELP_MESSAGE3' => 'Hint выдает наилучшие результаты в поиске по URL-адресу сайта компании.',
    'LBL_HINT_HELP_DEFAULT_MESSAGE1A' => "Введите название компании или вебсайт своего {{_moduleSingular}}, и Hint выполнит поиск дополнительных данных.",
    'LBL_HINT_HELP_DEFAULT_MESSAGE1B' => "Введите адрес электронной почты своего {{currentModule}}, и Hint выполнит поиск дополнительных данных.",

    'LBL_HINT_HISTORY_NONE' => 'Данные для просмотра истории недоступны',
    'LBL_HINT_HISTORY_TITLE' => 'История действий',

    'LBL_HINT_PREVIEW_TITLE' => 'Обогащение данных',
    'LBL_HINT_PREVIEW_LICENSE_EXPIRED' => 'Срок действия лицензии на ваш сервис Hint истек. Свяжитесь с администратором SugarCRM, чтобы продлить лицензию.',
    'LBL_HINT_PREVIEW_QUESTION' => 'Хотите узнать, что Hint может сделать для вас и вашей компании? Свяжитесь с администратором SugarCRM, чтобы добавить Hint.',
    'LBL_HINT_PREVIEW_NO_ACCOUNT_INFO' => 'Информация о контрагенте не найдена',
    'LBL_HINT_PREVIEW_TOOLTIP_TITLE' => 'Обнаружены обогащенные данные – нажмите, чтобы сохранить все обогащенные данные в своей записи.',
    'LBL_HINT_PREVIEW_CLICK_TO_SAVE' => 'Нажмите, чтобы сохранить обогащенные данные в своей записи.',

    'LBL_HINT_CONTACTS_TITLE' => 'Связанные контакты',
    'LBL_HINT_CONTACTS_NONE' => 'Несвязанные контакты',

    'LBL_HINT_NEWS' => 'Новости',
    'LBL_HINT_GENERAL' => 'Общие',
    'LBL_HINT_ALL_NEWS' => 'Все новости',
    'LBL_HINT_FILTER_NEWS' => 'Фильтровать новости',
    'LBL_HINT_FINANCIAL_NEWS' => 'Финансовые',
    'LBL_HINT_PERSONNEL_NEWS' => 'Кадровые',
    'LBL_HINT_PRESS_RELEASES' => 'Пресс-релизы',
    'LBL_HINT_OTHER_NEWS' => 'Другое',
    'LBL_HINT_NEWS_PLACEHOLDER' => 'Поиск новых статей',
    'LBL_HINT_NEWS_ALERT' => 'Sugar Hint Insights',
    'LBL_HINT_NEWS_NONE' => 'Нет доступных новостей',
    'LBL_NEW_NOTIFICATIONS' => 'Нет уведомлений',
    'LBL_HINT_DASHLET_ALLOWED1' => 'Для просмотра дашлета Sugar Hint Insights у вас должна быть лицензия Sugar Hint.
     Попросите вашего администратора получить лицензию Sugar Hint.',

    'LBL_HINT_FOR' => 'Для',
    'LBL_HINT_WITH' => 'с',
    'LBL_HINT_SHOW_ME' => 'Показать мне: ',
    'LBL_HINT_NOTIFY_ME_BY' => 'Уведомить меня по: ',

    'LBL_NOTIFICATIONS_TITLE' => 'Центр настроек Sugar Hint Insights',
    'LBL_NOTIFICATIONS_KEY_TITLE' => 'Клавиша выбора настроек',
    'LBL_HINT_PREFERENCES' => 'Пользовательские настройки',
    'LBL_HINT_MINIMUM_PREFERENCES' => 'Удалить отключенные, требуется как минимум один оператор настроек',
    'LBL_HINT_MAXIMUM_PREFERENCES' => 'Добавить отключенные, достигнуто максимальное количество операторов настроек',

    'LBL_NOTIFICATIONS_KEY_TITLE_DASHLET' => 'Включить дашлет Sugar Hint Insights',
    'LBL_NOTIFICATIONS_KEY_TITLE_BROWSER' => 'Всплывающее окно как уведомление на рабочем столе',
    'LBL_NOTIFICATIONS_KEY_DESCR_BROWSER' => 'Уведомления должны быть включены во всех браузерах и на всех настольных компьютерах, чтобы постоянно получать уведомления.',
    'LBL_NOTIFICATIONS_KEY_DESCR_BROWSER_DISABLED' => 'Некоторые браузеры, например Internet Explorer, не поддерживают уведомления. Уведомления нельзя включить при использовании браузера, который не поддерживает уведомления.',
    'LBL_NOTIFICATIONS_KEY_TITLE_EMAIL' => 'Отправляйте мгновенные оповещения по электронной почте для каждого уведомления',
    'LBL_NOTIFICATIONS_KEY_TITLE_DAILY' => 'Отправляйте ежедневный дайджест по электронной почте',
    'LBL_NOTIFICATIONS_KEY_TITLE_WEEKLY' => 'Отправляйте еженедельный дайджест по электронной почте',

    'LBL_NOTIFICATIONS_ERROR_MESSAGE_FAILEDSYNC' => 'Не удалось сохранить настройки. Проверьте подключение к системе и повторите попытку.',
    'LBL_NOTIFICATIONS_ERROR_MESSAGE_MISSING_REQUIRED' => 'В некоторых обязательных полях отсутствуют значения. Проверьте настройки и убедитесь, что все обязательные поля заполнены.',

    'LBL_HINT_PUSH_MESSAGES_PERMISSION' => 'Вы собираетесь включить уведомления браузера для Sugar Hint Insights. Нажмите «Подтвердить», чтобы продолжить. Затем ваш браузер запросит у вас разрешение на получение уведомлений.',
    'LBL_HINT_PUSH_ERROR' => 'Плагин push-уведомлений зарегистрирован для {{options.type}} без зависимостей. Плагин не будет работать должным образом, убедитесь, что вы указали путь к рабочему файлу и способ сохранения подписки на сервере.',

    'LBL_HINT_CONFIG_ENABLE_NOTIFICATIONS' => 'Включить уведомления Hint для всех пользователей',
    'LBL_HINT_CONFIG_DISABLE_NOTIFICATIONS' => 'Выключить уведомления Hint для всех пользователей',

    'LBL_HINT_SOFT_DISABLE_NOTIFICATIONS_FAILURE' => 'ПРЕДУПРЕЖДЕНИЕ. Не удалось отключить уведомления во время удаления Sugar Hint. Чтобы отключить уведомления, установите версию не ниже Sugar Hint 5.4.0 и выполните полное удаление с помощью программы удаления Sugar Hint, расположенной в разделе «Администрирование» Sugar.',
    'LBL_HINT_ENRICH_ALL' => 'Обогатить все',
    'LBL_HINT_NO_LICENSE_ACCESS' => 'Требуется лицензия Hint',


    //Maps
    'LBL_MAP_CONFIG_TITLE' => 'Конфигурация карт',
    'LBL_MAP_CONFIG_GEOCODE_LOG_VIEWER' => 'Средство просмотра журналов геокодирования',
    'LBL_MAP_MAP' => 'Карта',
    'LBL_MAP_MAPS' => 'Карты',
    'LBL_MAP_GEOCODING_RECORD' => 'Геокод',
    'LBL_MAP_GEOCODE_SUCCESS' => 'Запись успешно геокодирована.',
    'LBL_MAP_LATITUDE' => 'Широта',
    'LBL_MAP_LONGITUDE' => 'Долгота',
    'LBL_MAP_SEARCH_BY_ADDRESS' => 'Поиск по адресу...',
    'LBL_MAP_ALREADY_GEOCODED' => 'Текущая запись уже геокодирована. Вы действительно хотите перезаписать геокодирование для этой записи?',
    'LBL_MAPS_MANUAL_GEOCODING' => 'Ручное геокодирование',
    'LBL_MAP_POINT_COORDINATES' => 'Координаты точки карты',
    'LBL_MAP_CALCULATING_DIRECTIONS' => 'Вычисление оптимального пути...',
    'LBL_MAP_DIRECTIONS' => 'Указания',
    'LBL_MAP_DIRECTIONS_FROM_USER' => 'Указания, начиная с текущего пользователя',
    'LBL_MAP_DIRECTIONS_FROM_RECORD' => 'Указания, начиная с этой записи',
    'LBL_MAPS_RADIUS_INPUT' => 'Радиус (0-250)',
    'LBL_MAPS_IN_RADIUS_FROM_ZIP' => 'в радиусе от почтового индекса',
    'LBL_MAPS_DISTANCE' => 'Расстояние',
    'LBL_MAPS_CENTER_ZIP_CODE' => 'Почтовый индекс',
    'LBL_MAPS_CONFIG_INVALID_MODULE_TITLE' => 'Неверная конфигурация: ',
    'LBL_MAPS_CONFIG_INVALID_MODULE' => 'Сопоставление полей <strong>{{module}}</strong> недействительно.',
    'LBL_MAP_DASHLET_CONFIGURE_MAP_TYPE' => 'Тип карты',
    'LBL_MAP_DASHLET_CONFIGURE_MAP_ZOOM' => 'Уровень масштабирования',
    'LBL_MAPS_DASHLET' => 'Карты',
    'LBL_MAPS_DASHLET_DESCRIPTION' => 'Отображает геокодированные записи на карте.',
    'LBL_MAPS_DASHLET_MODULE_UNAVAILABLE' => 'Карты недоступны для этого модуля. Включите его в консоли "Администрирование".',
    'LBL_MAP_MODULES' => 'Модуль',
    'LBL_MAP_FILTER_BY' => 'Фильтровать по',
    'LBL_MAP_UNIT_TYPE' => 'Тип единицы',
    'LBL_MAP_UNIT_TYPE_MILES' => 'Мили',
    'LBL_MAP_UNIT_TYPE_KM' => 'Километры',
    'LBL_MAP_ADDRESS' => 'Адрес',
    'LBL_MAP_NO_STARTING_POINT' => 'Начальная точка не геокодирована.',
    'LBL_MAPS_MISSING_GEOCODING_START_POINT' => 'Запись начальной точки не имеет геокодирования.',
    'LBL_MAPS_MISSING_GEOCODING_RECORDS' => 'Некоторые из выбранных записей не имеют геокодирования и не будут отображаться на карте.',
    'LBL_MAPS_MISSING_GEOCODING_RECORD' => 'Запись(-и) не имеют геокодирования.',
    'LBL_MAPS_MODULE_FIELDS' => 'Поля модуля',
    'LBL_MAPS_SELECT_FIELD' => 'Выберите поле',
    'LBL_MAPS_RELATE_RECORD' => 'Связанная запись',
    'LBL_MAPS_MAPPING_TYPE' => 'Тип сопоставления',
    'LBL_MAPS_NO_GEOCODED_RECORDS' => 'Геокодированные записи отсутствуют',
    'LBL_MAPS_ADDRESS' => 'Адрес',
    'LBL_MAPS_ASSIGNED_USER_NAME' => 'Ответственный пользователь',
    'LBL_MAPS_STREET_VIEW_POINT_NOT_AVAILABLE' => 'Вид сбоку улицы недоступен для данной точки',
    'LBL_MAPS_INVALID_MODULE' => 'Записи <strong>{0}</strong> недействительны для сопоставленя. Удалите модуль из списка.',
    'LBL_MAPS_CLOSE_TOOLTIP' => 'Закрыть',
    'LBL_MAPS_EXPAND_TOOLTIP' => 'Развернуть',
    'LBL_MAPS_SAVE_PDF_TOOLTIP' => 'Сохранить в PDF',
    'LBL_MAPS_EMAIL_LINK' => 'Ссылка на адрес электронной почты',
    'LBL_MAPS_ONE_GEOCDED_RECORD_NEEDED' => 'У вас должна быть хотя бы одна геокодированная запись.',
    'LBL_MAPS_GENERATING' => 'Создание карты...',
    'LBL_MAPS_POINTS' => 'Точки на карте',
    'LBL_MAPS_POINT' => 'Точка',
    'LBL_MAPS_TRAVEL_DETAILS' => 'Сведение о поездке',
    'LBL_MAPS_TOTAL_DISTANCE' => 'Общее расстояние',
    'LBL_MAPS_TOTAL_DURATION' => 'Общая продолжительность',
    'LBL_MAPS_TOTAL_DURATION_WITHOUT_TRAFIC' => 'Общая продолжительность без учета трафика',
    'LBL_MAPS_ITINERARY' => 'Маршрут',
    'LBL_MAPS_TRAVEL_DISTANCE' => 'Пройденное расстояние',
    'LBL_MAPS_TRAVEL_DURATION' => 'Продолжительность поездки',
    'LBL_MAPS_TRAVEL_STEPS' => 'Шаги',
    'LBL_MAPS_TRAVEL_WARNINGS' => 'Предупреждения',
    'LBL_MAPS_MAX_GEOCDED_RECORD_EXCEDED' => 'Карты Bing поддерживают не более 10 точек на общей карте. Проверьте свой выбор.',
    'LBL_MAPS_NO_LICENSE_ACCESS' => 'Необходима лицензия на карты',
    'LBL_MAPS_SHARE_HELLO' => 'Здравствуйте,',
    'LBL_MAPS_SHARE_HEADER' => 'Вы запросили карту Bing для следующих точек:',
    'LBL_MAPS_SHARE_OPEN_URL' => 'Следующий URL-адрес откроет карту, содержащую вышеуказанные точки на Картах Bing:',
    'LBL_MAPS_SHARE_SHOW_MAP' => 'Показать карту на Картах Bing',
    'LBL_MAPS_MAP_ON_BING_WEB' => 'Карты Bing',
    'LBL_MAPS_NO_VALID_ITINERARY' => 'Для указанных путевых точек маршруты не найдены.',
    'LBL_MAPS_GEOCODE_STATUS' => 'Статус геокода',
    'LBL_MAPS_GEOCODED' => 'Геокодированный',
    'LBL_MAPS_NOT_GEOCODED' => 'Не геокодированный',
    'LBL_MAPS_NOT_FOUND' => 'Недопустимый адрес',
    'LBL_MAPS_GEOCODING_FAILED' => 'Сбой геокодирования',
    'LBL_MAPS_QUEUED' => 'В очереди',
    'LBL_MAPS_REQUEUED' => 'Повторная постановка в очередь',
    'LBL_MAPS_RELATED_RECORD' => 'Связанная запись',

    //Report Dashlet
    'LBL_REPORT_DASHLET_CONFIG_VIEW_REPORT' => 'Просмотреть отчет',
    'LBL_REPORT_DASHLET_DESC' => 'Отображать сохраненный отчет',
    'LBL_REPORT_DASHLET_RESET_DEFAULT' => 'Сброс к значениям по умолчанию для дашлетов',
    'LBL_REPORT_DASHLET_RESET_REPORT_DEFAULT' => 'Сброс к значениям по умолчанию для отчетов',
    'LBL_REPORT_DASHLET_REFRESH_RESULTS' => 'Обновить результаты',
    'LBL_REPORT_DASHLET_COPY_CHART_CLIPBOARD' => 'Копировать график в буфер обмена',
    'LBL_REPORT_DASHLET_DOWNLOAD_CHART' => 'Скачать график',
    'LBL_REPORT_DASHLET_REST_TO_REPORT_DEFAULTS' => 'Отчет для раздела {{label}} был отредактирован, и был произведен сброс раздела до конфигурации по умолчанию.',

    'LBL_NO_FIELD_PERMISSION_TO_FILTER' => 'У вас нет прав на использование этого поля.',

    'LBL_INVALID_FORMULA' => 'Неверная формула',
    'LBL_RETURN_TYPE_MISSMATCH' => 'Тип возврата функции не соответствует',

    'LBL_PREDICT_TOOLTIP' => 'SugarPredict',

    'LBL_AI_CONV_SCORE_CLASSIFICATION_FIELD' => 'Прогноз',
    'LBL_AI_ICP_FIT_SCORE_CLASSIFICATION_FIELD' => 'Идеальный профиль клиента',
    'LBL_AI_OPP_CLOSE_WEEK_SCORES' => 'Закрыть результаты недельного прогноза',
    'LBL_AI_CONV_SCORE_ABSOLUTE' => 'Значение прогноза',
    'LBL_AI_CONV_BIN_ACCURACY' => 'Точность прогноза ячейки',
    'LBL_AI_CONV_MULTIPLIER' => 'Множитель прогноза',
    'LBL_AI_ICP_FIT_SCORE_ABSOLUTE' => 'Значение ICP',
    'LBL_AI_ICP_FIT_BIN_ACCURACY' => 'Точность ячейки ICP',
    'LBL_AI_ICP_FIT_MULTIPLIER' => 'Множитель ICP',
    'LBL_AI_NEW' => 'Новая',
    'LBL_AI_ENTERED' => 'Введенная',
    'LBL_AI_CREATED' => 'Созданная',
    'LBL_AI_WEEK' => 'Неделя',
    'LBL_AI_MONTH' => 'Месяц',
    'LBL_AI_QUARTER' => 'Квартал',
    'LBL_AI_BYWEEK' => 'по неделям',
    'LBL_AI_BYMONTH' => 'по месяцам',
    'LBL_AI_BYQUARTER' => 'по кварталам',
    'LBL_AI_WEEKTREND' => 'Недельный тренд',
    'LBL_AI_MONTHLYTREND' => 'Месячный тренд',
    'LBL_AI_QUARTERTREND' => 'Квартальный тренд',
    'LBL_AI_TREND' => 'Тренд по',
    'LBL_AI_TRENDS' => 'Тренды по',
    'LBL_AI_VELOCITY' => 'Скорость',
    'LBL_AI_TOPX' => 'Верхние {X}',
    'LBL_AI_TIMESPAN' => 'Промежуток времени между стадиями -',
    'LBL_AI_BUSINESSTREND' => 'с бизнес-трендами',
    'LBL_AI_SUGARINSIGHTINTRO' => 'Представляем Sugar Insights!',
    'LBL_AI_SUGARINSIGHTSDESC' => 'Sugar Insights использует количественный анализ для получения новых сведений о ваших данных SugarCRM. В Sugar мы всегда ищем новые способы, которые помогут вам получить максимальную отдачу от ваших данных, принимать обоснованные решения, и это только начало того, что мы надеемся предложить с помощью Sugar Insights.',
    'LBL_AI_SUGARINSIGHTS_DASHLET_NAME' => 'Sugar Insights',
    'LBL_AI_SUGARINSIGHTS_DASHLET_DESC' => 'Sugar Insights использует количественный анализ для получения новых сведений о ваших данных SugarCRM.',
    'LBL_AI_FIRMO' => 'Фирмографика',
    'LBL_AI_TOTALCOUNT' => 'Общее количество',
    'LBL_AI_DAYSFROMLATESTACT' => 'Дней с момента последнего',
    'LBL_AI_DAYSSINCE' => 'возраст',
    'LBL_AI_FIELDISSET' => 'существует',
    'LBL_AI_CONTACTCOMPLETENESS' => 'Полнота контактной информации',
    'LBL_AI_CUTDATE' => 'Период прогнозирования',
    'LBL_AI_FROMLASTCHANGE' => 'Дней с момента последнего изменения значения функции',
    'LBL_AI_CALLSHELD' => 'Общее количество проведенных звонков',
    'LBL_AI_CALLSPLANNED' => 'Общее количество запланированных звонков',
    'LBL_AI_OUTBOUNDCALLS' => 'Общее количество исходящих вызовов',
    'LBL_AI_INBOUNDCALLS' => 'Общее количество входящих звонков',
    'LBL_AI_AVGCALLDURATION' => 'Средняя продолжительность звонков',
    'LBL_AI_EMAILSARCHIVED' => 'Общее количество заархивированных писем электронной почты',
    'LBL_AI_EMAILSREAD' => 'Общее количество прочитанных писем',
    'LBL_AI_EMAILSSENT' => 'Общее количество отправленных писем',
    'LBL_AI_CLOSEDATEPUSHEDBACK' => 'Общее количество записей, в которых ожидаемая дата закрытия изменена на более позднюю дату',
    'LBL_AI_CLOSEDATEPUSHEDFORWARD' => 'Общее количество записей, в которых ожидаемая дата закрытия изменена на более раннюю дату',
    'LBL_AI_AMOUNTINCREASED' => 'Общее количество сделок, сумма которых увеличилась',
    'LBL_AI_AMOUNTDECREASED' => 'Общее количество сделок, сумма которых уменьшилась',

    // User last state
    'LBL_LAST_STATE' => 'Последнее состояние',
    // DocuSign
    'LBL_SEND_TO_DOCUSIGN_BUTTON_LABEL' => 'Отправить в DocuSign',
    'LBL_SHORTCUT_EDIT_RECIPIENT_CANCEL' => 'Отмена редактирования получателя',
    'LBL_RECIPIENT_ROLE' => 'Роль получателя',
    // Base sales stages
    'LBL_OPEN' => 'Открыто',
    'LBL_CLOSED_WON' => 'Успешно закрыто',
    'LBL_CLOSED_LOST' => 'Потеряно',
    'LBL_KIOSK_ADD_FILES' => 'Добавить файлы',
    'LBL_KIOSK_ADD_DROP_FILES' => 'Добавьте или переместите файлы сюда',
    'LBL_KIOSK_CANCEL' => 'Отмена',
    'LBL_KIOSK_EDIT' => 'Редактировать',
    'LBL_KIOSK_EMAIL' => 'Электронная почта',
    'LBL_KIOSK_FILES_UPLOADING' => 'Загрузка',
    'LBL_KIOSK_FILES_ERROR' => 'Не удалось загрузить вложение',
    'LBL_KIOSK_FILES_ERROR_TOO_LARGE' => 'Вложение является слишком большим',
    'LBL_KIOSK_FILTER_SEARCH' => 'Поиск',
    'LBL_KIOSK_ID' => 'Идентификатор',
    'LBL_KIOSK_TITLE' => 'Киоск',
    'LBL_KIOSK_LANGUAGE' => 'Язык',
    'LBL_KIOSK_LAST_UPDATED' => 'Последнее обновление',
    'LBL_KIOSK_LIST_VIEW_SELECTION' => 'Просмотр',
    'LBL_KIOSK_MENU' => 'Меню',
    'LBL_KIOSK_MOBILE_PHONE' => 'Мобильный телефон',
    'LBL_KIOSK_MY_ACTIVITIES' => 'Мои действия',
    'LBL_KIOSK_MY_PROFILE' => 'Мой профиль',
    'LBL_KIOSK_NAME' => 'Название',
    'LBL_KIOSK_OFFICE_PHONE' => 'Рабочий телефон',
    'LBL_KIOSK_ORGANIZATION' => 'Организация',
    'LBL_KIOSK_PAGINATION_FOOTER' => 'Строк на странице:',
    'LBL_KIOSK_POWERED_BY_SUGARCRM' => 'На платформе SugarCRM',
    'LBL_KIOSK_SAVE_CHANGES' => 'Сохранить изменения',
    'LBL_KIOSK_SHOW_HIDE' => 'Показать/скрыть',
    'LBL_KIOSK_SIGN_IN' => 'Войти',
    'LBL_KIOSK_SIGN_OUT' => 'Выйти',
    'LBL_KIOSK_SORT_BY' => 'Сортировать по',
    'LBL_KIOSK_SUBMIT' => 'Отправить',
    'LBL_KIOSK_TIMEZONE' => 'Часовой пояс',
    'LBL_KIOSK_ACTIVITY' => 'Деятельность',
    'LBL_KIOSK_NO_ACTIVITY' => 'Нет действий для отображения',
    'LBL_KIOSK_OLDEST_FIRST' => 'Сначала старые',
    'LBL_KIOSK_NEWEST_FIRST' => 'Сначала новые',
    'LBL_KIOSK_SHOW_MORE' => 'Показать больше',
    'LBL_KIOSK_ADD_A_REPLY' => 'Добавить ответ',
    'LBL_KIOSK_REPLY_EMPTY' => 'Ответ не может быть пустым.',
    'LBL_KIOSK_NUM_MORE' => 'ещё {{num}}',
    'LBL_KIOSK_HOMEPAGE_WELCOME1' => 'Добро пожаловать',
    'LBL_KIOSK_HOMEPAGE_WELCOME2' => 'Получайте быстрый доступ к ресурсам.',
    'LBL_KIOSK_HOMEPAGE_SEARCH_PLACEHOLDER' => 'Поиск обращений',
    'LBL_KIOSK_SHOW_ALL' => 'Показать все',
    'LBL_KIOSK_404_TITLE' => 'Нам не удалось это найти',
    'LBL_KIOSK_TENANT_404_TITLE' => 'Клиент не найден',
    'LBL_KIOSK_404_MESSAGE' => 'Вы щелкнули ссылку, которая была удалена и временно недоступна, или ввели недопустимый URL-адрес.',
    'LBL_KIOSK_TENANT_404_MESSAGE' => 'Пожалуйста, убедитесь, что у вас есть правильный URL. Для получения дополнительной помощи, пожалуйста, свяжитесь со службой поддержки.',
    'LBL_KIOSK_BACK_TO_HOME' => 'Вернуться на главную страницу',
    'LBL_KIOSK_ERROR_CODE' => '{code} Ошибка: ',
    'LBL_KIOSK_401_TITLE' => 'Не авторизовано',
    'LBL_KIOSK_401_MESSAGE' => 'У вас недостаточно прав для просмотра данной страницы.',
    'LBL_KIOSK_403_TITLE' => 'Не авторизовано',
    'LBL_KIOSK_403_MESSAGE' => 'У вас нет прав для доступа к этой страницы.',
    'LBL_KIOSK_500_TITLE' => 'Сервер не отвечает',
    'LBL_KIOSK_500_MESSAGE' => 'Возникла проблема с нашей стороны.',
    'LBL_KIOSK_GO_BACK' => 'Вернуться',
    'LBL_KIOSK_DUPLICATE_ERROR' => 'Найден дубликат записи',
    'LBL_KIOSK_ACCOUNT' => 'Клиент',
    'LBL_KIOSK_STATUS' => 'Статус',
    'LBL_KIOSK_DEACTIVATE' => 'Деактивировать',
    'LBL_KIOSK_DEACTIVATE_SUCCESS' => 'Пользователь был деактивирован',
    'LBL_KIOSK_MANAGE_USERS' => 'Управление пользователями',
    'LBL_KIOSK_LAST_LOGIN' => 'Последний вход в систему',
    'LBL_KIOSK_FIRST_NAME' => 'Имя',
    'LBL_KIOSK_LAST_NAME' => 'Фамилия',
    'LBL_KIOSK_ROLE' => 'Роль',
    'LBL_KIOSK_INVITE' => 'Пригласить',
    'LBL_KIOSK_SEND_INVITES' => 'Отправить приглашения (приглашения)',
    'LBL_KIOSK_INVITE_USERS_SUCCESS' => 'Приглашения успешно отправлены',
    'LBL_KIOSK_INVITE_USERS_FAILURE' => 'Приглашения не отправлены',
    'LBL_KIOSK_REACTIVATE' => 'Активировать повторно',
    'LBL_KIOSK_REACTIVATE_SUCCESS' => 'Пользователь был повторно активирован',
    'LBL_KIOSK_RESET_PASSWORD' => 'Сбросить пароль',
    'LBL_KIOSK_RESET_PASSWORD_SUCCESS' => 'Письмо о сбросе пароля отправлено по электронной почте',
    'LBL_KIOSK_USER_PROFILE' => 'Профиль пользователя',
    'LBL_KIOSK_401_USER_BLOCKED_MESSAGE' => 'Ваш пользователь был деактивирован. Обратитесь к администратору.',
    'LBL_KIOSK_BACK_TO_LOGIN' => 'Назад на страницу входа',
    'LBL_KIOSK_REVOKE_INVITATION' => 'Отозвать приглашение',
    'LBL_KIOSK_REVOKE_INVITATION_SUCCESS' => 'Приглашение успешно отозвано',
    'LBL_KIOSK_SEARCH_AND_SELECT' => 'Поиск и выбор...',
    'LBL_KIOSK_NO_MATCHES' => 'Совпадений не найдено',
    'LBL_KIOSK_PROFILE_UPDATE_SUCCESS' => 'Профиль был обновлен.',
    'LBL_KIOSK_PROFILE_UPDATE_ERROR' => 'При обновлении профиля произошла ошибка.',
    'LBL_KIOSK_NOTES_SUBJECT_TITLE' => 'Тема: {caseSubject}',
    'LBL_KIOSK_DOCUMENTS' => 'Документы',
    'LBL_KIOSK_DOCUMENTS_DESC' => 'Просматривайте, ищите и загружайте входящие совместно используемые документы.',
    'LBL_KIOSK_CASES' => 'Обращения',
    'LBL_KIOSK_CASES_DESC' => 'Просматривайте, ищите и отвечайте на обращения, которыми поделились с вами.',
    'LBL_KIOSK_DOWNLOAD' => 'Загрузить',
    'LBL_KIOSK_DOWNLOAD_SUCCESS' => 'Файл успешно загружен',
    'LBL_KIOSK_FIRST_TIME_LOGIN_MODAL_TITLE' => 'Начало работы',
    'LBL_KIOSK_FIRST_TIME_LOGIN_MODAL_DESCRIPTION' => 'Для оказания более эффективной помощи сообщите нам ваше имя и фамилию.',
    'LBL_KIOSK_SAVE' => 'Сохранить',
    'LBL_KIOSK_SHARED' => 'Совместный',
    'LBL_KIOSK_HOMEPAGE_WELCOME1_PERSONAL' => 'Добро пожаловать, {firstName} {lastInitial}.',
    'LBL_KIOSK_CONFIG_BACKGROUND_COLOR' => 'Цвет фона',
    'LBL_KIOSK_CONFIG_BACKGROUND_IMG_URL' => 'URL-адрес фонового изображения',
    'LBL_KIOSK_CONFIG_BACKGROUND_IMG_URL_SUBTITLE' => 'Рекомендуется выбирать изображения с размером файла менее 400 Кб.',
    'LBL_KIOSK_CONFIG_BACKGROUND_TYPE' => 'Тип фона',
    'LBL_KIOSK_CONFIG_HOME_TILE_TITLE' => 'Фон главной страницы',
    'LBL_KIOSK_CONFIG_THEME_TILE_TITLE' => 'Тема',
    'LBL_KIOSK_CONFIG_THEME_PRIMARY_COLOR' => 'Основной цвет темы',
    'LBL_KIOSK_CONFIG_APP_NAME' => 'Имя приложения',
    'LBL_KIOSK_CONFIG_APP_NAME_SUBTITLE' => 'Это название вашего приложения, и оно отображается рядом с вашим логотипом.',
    'LBL_KIOSK_CONFIG_APP_LOGO_URL' => 'URL-адрес логотипа приложения',
    'LBL_KIOSK_CONFIG_APP_LOGO_URL_SUBTITLE' => 'Рекомендуется выбирать логотип, который лучше всего виден на небольших размерах (например, профили в социальных сетях). Также рекомендуется, чтобы размер файла был менее 200 Кб.',
    'LBL_KIOSK_CONFIG_APP_FAVICON_URL' => 'URL-адрес иконки приложения',
    'LBL_KIOSK_CONFIG_APP_FAVICON_URL_SUBTITLE' => 'Иконка сайта – это небольшой логотип, который находится рядом с названием страницы во вкладке браузера.',

    // Sugar Automate
    'LBL_UPDATE_ASSIGNEES' => 'Автоматическое переназначение открытых мероприятий',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_USER_LIMIT_REACHED' => 'Достигнуто ограничение пользователей',
    'LBL_CUSTOMER_JOURNEY_ERROR_INVALID_LICENSE_KEY' => 'Недопустимый лицензионный ключ',
    'LBL_CUSTOMER_JOURNEY_ERROR_INVALID_APPLICATION_LICENSE_KEY' => 'Недопустимое приложение',
    'LBL_CUSTOMER_JOURNEY_ERROR_MISSING_LICENSE_KEY' => 'Недопустимое приложение',
    'LBL_CUSTOMER_JOURNEY_ERROR_CORRUPT_VALIDATION_KEY' => 'Поврежденный ключ проверки',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_EXPIRED' => 'Срок действия лицензии истек',
    'LBL_CUSTOMER_JOURNEY_ERROR_LICENSE_KEY_MISSING_INFO' => 'Отсутствующая информация',
    'LBL_CUSTOMER_JOURNEY_ERROR_MISSING_VALIDATION_KEY' => 'Отсутствует ключ проверки',
    'LBL_CUSTOMER_JOURNEY_ERROR_USER_MISSING_ACCESS' => 'Пользователь не имеет доступа',
    'LBL_DRI_WORKFLOW' => 'Умное руководство',
    'LBL_DRI_WORKFLOWS' => 'Умные руководства',
    'LBL_DRI_SUBWORKFLOW_TEMPLATE' => 'Шаблон стадии умного руководства',
    'LBL_DRI_SUBWORKFLOW_TEMPLATES' => 'Шаблоны стадии умного руководства',
    'LBL_DRI_WORKFLOW_TEMPLATE' => 'Шаблон умного руководства',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATE' => 'Шаблон мероприятия умного руководства',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATES_SUBPANEL_TITLE' => 'Шаблоны мероприятия',
    'LBL_CJ_WEBHOOKS_SUBPANEL_TITLE' => 'Веб-перехватчики',
    'LBL_CJ_WEBHOOKS' => 'Веб-перехватчики Sugar Automate',
    'LBL_CURRENT_CJ_ACTIVITY_AT' => 'Текущее мероприятие умного руководства в',
    'LBL_CJ_WEBHOOKS' => 'Веб-перехватчики Sugar Automate',
    'LBL_CJ_WEBHOOK' => 'Веб-перехватчик автоматизации Sugar',
    'LBL_CJ_FORMS_SUBPANEL_TITLE' => 'Действия Sugar',
    'LBL_CJ_FORMS' => 'Действия Sugar, относящиеся к Smart Guide',
    'LBL_CJ_FORM' => 'Действие Sugar, относящееся к Smart Guide',
    'LBL_DRI_SUBWORKFLOW' => 'Стадия умного руководства',
    'LBL_DRI_SUBWORKFLOWS' => 'Стадии умного руководства',
    'LBL_DRI_WORKFLOW_TASK_TEMPLATES' => 'Шаблоны мероприятия умного руководства',
    'LBL_DRI_WORKFLOW_TEMPLATES' => 'Шаблоны умного руководства',
    'LBL_DRI_WORKFLOW_SORT_ORDER' => 'Порядок умного руководства',
    'LBL_CJ_ACTUAL_SORT_ORDER' => 'Фактический порядок умного руководства',
    'LBL_CUSTOMER_JOURNEY_SCORE' => 'Оценка умного руководства',
    'LBL_CJ_MOMENTUM_POINTS' => 'Пункты импульса умного руководства',
    'LBL_CJ_MOMENTUM_SCORE' => 'Оценка импульса умного руководства',
    'LBL_CJ_ALLOW_ACTIVITY_BY' => 'Разрешить выполнение мероприятия умного руководства исполнителем',
    'LBL_CUSTOMER_JOURNEY_PROGRESS' => 'Ход выполнения умного руководства',
    'LBL_CJ_MOMENTUM_RATIO' => 'Коэффициент импульса умного руководства',
    'LBL_CUSTOMER_JOURNEY_POINTS' => 'Пункты умного руководства',
    'LBL_CUSTOMER_JOURNEY_TYPE' => 'Задача умного руководства',
    'LBL_CJ_PARENT_ACTIVITY_TYPE' => 'Тип родительского мероприятия умного руководства',
    'LBL_CUSTOMER_JOURNEY_BLOCKED_BY' => 'Умное руководство заблокировано пользователем',
    'LBL_CJ_BLOCKED_BY_STAGES' => 'Умное руководство заблокировано стадиями',
    'LBL_CJ_PARENT_ACTIVITY_ID' => 'Идентификатор родительского мероприятия умного руководства',
    'LBL_START_NEXT_JOURNEY_ID' => 'Начать следующий идентификатор умного руководства',
    'LBL_CJ_URL' => 'URL умного руководства',
    'LBL_IS_CJ_PARENT_ACTIVITY' => 'Является родительским мероприятием умного руководства',
    'LBL_CJ_MOMENTUM_START_DATE' => 'Дата начала импульса умного руководства',
    'LBL_CJ_MOMENTUM_END_DATE' => 'Дата окончания импульса умного руководства',
    'LBL_WIDGET_LAYOUT_CONFIGURATION_HEADER' => 'Конфигурация макета виджета',
    'LBL_WIDGET_LAYOUT_CONFIGURATION' => 'Конфигурация макета виджета',
    'CJ_SAME_JOURNEY_LIMIT_REACH_EXCEPTION' => 'Максимальное количество умных руководств из одного и того же шаблона',
    'LBL_CUSTOMER_JOURNEY_WIDGET_ACTIVE' => 'Активен',
    'LBL_CUSTOMER_JOURNEY_WIDGET_ARCHIVE' => 'Заархивирован',
    'LBL_CUSTOMER_JOURNEY_STAGE_NUMBER_SHOW' => 'Показать',
    'LBL_CUSTOMER_JOURNEY_STAGE_NUMBER_HIDE' => 'Скрыть',
    'LBL_CJ_PRESENTATION_MODE_VERTICAL' => 'Вертикальный режим',
    'LBL_CJ_PRESENTATION_MODE_HORIZONTAL' => 'Горизонтальный режим',
    'LBL_CUSTOMER_JOURNEY_INVALID_LICENSE' => 'Недействительная лицензия',
    'LBL_ASSIGNMENT_NOTIFICATION_HTML' => '<div>
    <p>{{assigned_by}} назначил следующие мероприятия умного руководства пользователю {{assigned_user}}.</p>
    <ul>{{activities}}</ul>
    
    <p>Вы можете просмотреть эти мероприятия по ссылке:<br/>
    <<a href=\"{{module_link}}\">{{module_link}}</a>></p>
    </div>',
    'LBL_CUSTOMER_JOURNEY_INVALID_LICENSE' => 'Недействительная лицензия',
    'LBL_CJ_REMAINING_DAYS_WHEN_USER_LIMIT_REACHED' => 'Достигнут лимит пользователей; у вас есть {{gracePeriodDays}} дней на обновление лицензии.',
    'LBL_ASSIGNMENT_NOTIFICATION_SUBJECT' => 'SugarCRM - Назначенные мероприятия умного руководства',
    'LBL_CUSTOMER_JOURNEY_USER_LIMIT_REACHED_DESCRIPTION' => 'Ваш лимит пользователей Sugar Automate {0} был превышен<br>
    <br>
    Пожалуйста, обратитесь по адресу <a href=\"mailto:customersuccess@sugarcrm.com\">customersuccess@sugarcrm.com</a> , чтобы увеличить лимит пользователей или уменьшить количество пользователей, использующих этот плагин.',
    'LBL_CUSTOMER_JOURNEY_USER_LIMIT_REACHED_NAME' => 'Достигнут лимит пользователей Sugar Automate',
    'LBL_CUSTOMER_JOURNEY_LICENSE_ABOUT_TO_EXPIRE_DESCRIPTION' => 'Срок действия лицензии Sugar Automate истекает через {0} дня (дней). <br>
    <br>
    Пожалуйста, свяжитесь с SugarCRM или вашим партнером Sugar, чтобы возобновить лицензию и предотвратить прерывание обслуживания.',
    'LBL_CUSTOMER_JOURNEY_LICENSE_ABOUT_TO_EXPIRE_NAME' => 'Срок действия лицензии Sugar Automate скоро истекает',
    'LBL_DEFAULT_TEST_WEB_HOOK_DASHLET_TITLE' => 'Тестовый веб-перехватчик',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'Ход выполнения Smart Guide',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Отображает круговую диаграмму «Ход выполнения Smart Guide» Sugar Automate.',
    'LBL_DEFAULT_TEST_WEB_HOOK_DASHLET_DESC' => 'Отображает ответ Веб-перехватчика',
    'LBL_DASHLET_SEND_LABEL' => 'Отправить запрос',
    'LBL_ASSIGN_ME_BUTTON_TITLE' => 'Назначить меня',
    'LBL_COMPLETE_BUTTON_TITLE' => 'Завершить',
    'LBL_COMPLETE_PARENT_BUTTON_TITLE' => 'Завершить все задачи',
    'LBL_DELETE_STAGE_BUTTON_TITLE' => 'Удалить стадию',
    'LBL_START_CYCLE_BUTTON_TITLE' => 'Начать',
    'LBL_NOT_APPLICABLE_BUTTON_TITLE' => 'Не применимо',
    'LBL_ADD_STAGE_BUTTON_TITLE' => 'Добавить стадию',
    'LBL_VIEW_JOURNEY_BUTTON_TITLE' => 'Обзор',
    'LBL_EDIT_JOURNEY_BUTTON_TITLE' => 'Изменить Smart Guide',
    'LBL_CANCEL_JOURNEY_BUTTON_TITLE' => 'Отмена',
    'LBL_ARCHIVE_JOURNEY_BUTTON_TITLE' => 'Архивировать',
    'LBL_UNARCHIVE_JOURNEY_BUTTON_TITLE' => 'Разархивировать',
    'LBL_CONFIGURE_TEMPLATE_BUTTON_TITLE' => 'Настройка шаблона',
    'LBL_ADD_CJ_SUB_TASK_BUTTON_TITLE' => 'Добавить задачу',
    'LBL_ADD_CJ_SUB_MEETING_BUTTON_TITLE' => 'Запланировать встречу',
    'LBL_ADD_CJ_SUB_CALL_BUTTON_TITLE' => 'Назначить звонок',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_FUTURE' => 'находится в будущем',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_OVERDUE' => 'просрочено',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TODAY' => 'сегодня',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TOMORROW' => 'завтра',
    'LBL_CUSTOMER_JOURNEY_ACTIVITY_DUE_DATE_TEXT' => '{{fieldName}} {{status}}
    {{formatUser}} ({{fromNow}})',
    'LBL_CJ_CANCEL_CONFIRMATION' => 'Вы уверены, что хотите отменить это умное руководство?',
    'LBL_CJ_COMPLETE_ALL_TASKS_CONFIRMATION' => 'Вы собираетесь завершить все задачи. Уверены, что хотите продолжить?',
    'LBL_CJ_BLOCK_BY' => 'У вас имеется нерешенная зависимая задача: {{Name}}. Пожалуйста, завершите данную задачу, прежде чем выбирать «Завершение всех задач».',
    'LBL_CJ_MULTIPLE_BLOCK_BY' => 'У вас имеется несколько нерешенных зависимых задач. Пожалуйста, завершите данные задачи, прежде чем выбирать «Завершение всех задач».',
    'LBL_CJ_COMPLETE_ALL_TASKS_COMPLETION' => 'Вы успешно завершили все задачи',
    'LBL_CJ_ARCHIVE_CONFIRMATION' => 'Вы уверены, что хотите заархивировать это умное руководство?',
    'LBL_CJ_UNARCHIVE_CONFIRMATION' => 'Вы уверены, что хотите разархивировать это умное руководство?',
    'LBL_CJ_AS_A_DASHLET' => 'Sugar Automate: Умные руководства (детальные отображения и консоль)',
    'LBL_CJ_AS_A_DASHLET_DESC' => 'Просмотр активных умных руководств на консоли обслуживания/продления и панелях детального вида.',
    'LBL_CJ_PROCESSING_REQUEST' => 'Обработка..',
    'LBL_CJ_SUCCESS' => 'Вы успешно завершили все задачи',
    'LBL_CUSTOMER_JOURNEY_MODULE_NOT_ENABLED' => 'модуль {module} не включен',
    'LBL_RECORDVIEW_DISPLAY_SETTINGS_SAVED' => 'Все настройки отображения сохранены.',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_MOMENTUM_DASHLET_TITLE' => 'Импульс умного руководства',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_MOMENTUM_DASHLET_DESC' => 'Отображает круговую диаграмму Sugar Automate «Импульс умного руководства».',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_TITLE' => 'Ход выполнения Smart Guide',
    'LBL_DEFAULT_DRI_CUSTOMER_JOURNEY_DASHLET_DESC' => 'Отображает круговую диаграмму «Ход выполнения Smart Guide» Sugar Automate.',
    'CJ_PARENT_NOT_FOUND_EXCEPTION' => 'Не удалось найти родительский элемент',
    'CJ_NOT_FOUND_EXCEPTION' => 'Не удалось найти {moduleName} с {data}',
    'CJ_JOURNEY_NOT_COMPLETED_EXCEPTION' => 'Умное руководство должно быть заполнено или отменено перед архивацией',
    'LBL_CUSTOMER_JOURNEY_LICENSE_LOAD_ERROR' => 'Sugar Automate не включен в текущую лицензию Sugar',
    'LBL_ACTION_NOT_FOUND' => 'Действие не найдено, обратитесь к системному администратору',
    'LBL_CJ_SELECT_FIELD' => 'Выберите поле',
    'LBL_CJ_SELECT_OPERATOR' => 'Выберите оператор',
    'LBL_CJ_SELECT_VALUE' => 'Выберите значение',
    'LBL_CJ_ENTER_VALUE' => 'Введите значение',
    'LBL_CJ_FORM_BATCH_TITLE' => 'Сохранение записи',
    'LBL_CJ_FORM_BATCH_ACTIVE_SMART_GUIDES_DETECTED' => 'Обнаружены активные умные руководства...',
    'LBL_CJ_FORM_BATCH_PROCESSING_ACTIVE_SUGAR_ACTIONS' => 'Обработка активных действий Sugar...',
    'LBL_CJ_FORM_BATCH_UPDATING_ACTIVE_SMART_GUIDES' => 'Обновление активных умных руководств...',
    'LBL_CJ_FORM_BATCH_SUCCESS' => 'Эта запись и связанные с ней smart guide были успешно обновлены.',
    'LBL_CJ_FORM_BATCH_FAILURE' => 'Не удалось обновить связанное умное руководство. Если эта ошибка будет возникать и далее, обратитесь за помощью к администратору Sugar.',
    'LBL_CJ_FORM_BATCH_FAILURE_FOR_ADMIN' => 'Не удалось обновить связанное умное руководство. Чтобы устранить эту ошибку, просмотрите <a href="index.php?action=LogView&module=Configurator&doaction=all&filter=Sugar+Actions+:+Sugar+Action+to+Smart+Guide" target="_blank">журналы</a>.',
    'LBL_CJ_ACTIVITY_LINK_SUCCESS' => 'Модуль <a href="#{{module}}/{{id}}">{{name}}</a> {{moduleSingularLower}} был успешно связан.',
    'LBL_CJ_ACTIVITY_LINK_ERROR' => 'Возникла проблема со ссылкой на <a href="#{{module}}/{{id}}">{{name}}</a> {{moduleSingularLower}}. Если проблема не устранена, обратитесь в службу поддержки Sugar.',
    'LBL_CJ_ACTIVITY_LINK_SUCCESS_PLURAL' => 'Модуль {{modulePluralLower}} был успешно связан.',
    'LBL_CJ_ACTIVITY_LINK_ERROR_PLURAL' => 'Возникла проблема со ссылкой на {{modulePluralLower}}. Если проблема не устранена, обратитесь в службу поддержки Sugar.',
    'LBL_CJ_ACTIVITY_LINK_ERROR_GENERIC' => 'Возникла проблема со ссылкой на {{moduleSingularLower}}. Если проблема не устранена, обратитесь в службу поддержки Sugar.',
    'LBL_CJ_ACTIVITY_DUPLICATE_EXISTING' => 'Уже существует {{moduleSingularLower}} с именем <a href="#{{module}}/{{id}}">{{name}}</a> на стадии {{stage}}.',
    'LBL_CJ_ACTIVITY_DUPLICATE_SELECTED' => 'Модуль {{moduleSingularLower}} с именем <a href="#{{module}}/{{id}}">{{name}}</a> уже был выбран.',
    'LBL_CJ_ARCHIVED' => 'Заархивировано',
    'LBL_SELECT_SMART_GUIDE_TEMPLATE_PLACEHOLDER' => 'Выберите шаблон Smart Guide...',
    'LBL_ALL_SMART_GUIDES' => 'Все Smart Guide',
    'LBL_ACTIVE_SMART_GUIDES' => 'Активные Smart Guide',
    'LBL_ARCHIVED_SMART_GUIDES' => 'Архивные Smart Guide',
    'LBL_VERTICAL_SCROLL_VIEW' => 'Представление в виде вертикального стека',
    'LBL_HORIZONTAL_SCROLL_VIEW' => 'Представление с горизонтальной прокруткой',
    'LBL_DRI_WORKFLOWS_FILTER' => 'Фильтр',

    // more MOBILE stuff
    'LBL_MOBILE_COPIED_TO_CLIPBOARD' => 'Скопировано в буфер обмена.',
    'LBL_MOBILE_DELETE_ALL_OCCURRENCES' => 'Удалить все повторения',
    'ERROR_RECURRENCE_EVENT_PARAMS' => 'Недействительные настройки повторений',
    'ERROR_INTERVAL_INVALID' => 'Интервал повторения должен быть от 1 до 99',
    'LBL_RECURRENCE_ADD' => 'Настроить',
    'LBL_REPEAT_DAYS' => 'День (дни) месяца',
    'LBL_REPEAT_END_TYPES' => 'Повторить',
    'LBL_MOBILE_DEFAULT_MAPS_APP' => 'Поставщик услуг навигации',
    'LBL_MOBILE_PDF_EMAIL' => 'Отправить PDF {{{pdfTemplateName}}} по электронной почте',
    'LBL_MOBILE_EMAIL_SENDING' => 'Отправка',
    'LBL_MOBILE_EMAIL_SENT' => 'Отправлено',
    'LBL_MOBILE_EMAIL_SAVED_DRAFT' => 'Электронное письмо сохранено как черновик.',
    'LBL_MOBILE_EMAIL_CHOOSE_ATTACHMENT' => 'Добавить вложение',
    'LBL_MOBILE_EMAIL_LOCAL_ATTACHMENT' => 'Загрузить с локальной',
    'LBL_MOBILE_EMAIL_SUGAR_DOCUMENT_ATTACHMENT' => 'Документ Sugar',
    'LBL_DROPDOWN_VIEW_CHANGE_INFO' => 'Внесение правки в данную запись привело к изменению данного представления.',
    'LBL_MOBILE_RELEASE_NOTE_ALL' => 'Заметки о выпуске мобильного приложения SugarCRM',
    'LBL_MOBILE_USER_GUIDE_ALL' => 'Руководство пользователя мобильного приложения SugarCRM',
    'ERR_MOBILE_ROOTED' => 'Sugar Mobile не может использоваться на мобильном устройстве со снятой защитой или с административным доступом. Пожалуйста, откройте приложение на устройстве без снятой защиты или административного доступа.',
    'LBL_VO_BUILD_ROUTE' => 'Построить маршрут',
    'LBL_FILTER_MY_DISTANCE_FILTER' => 'Мой фильтр расстояния',
    'LBL_ACTIONBUTTON_DOC_MERGE_STARTED' => 'Документ будет создан в фоновом режиме. Откройте страницу «Объединение документов» для получения доступа к файлу.',
    'LBL_ACTIONBUTTON_DOC_MERGE_NO_TEMPLATE' => 'Не удалось получить шаблон. Обратитесь за помощью к администратору.',
    'LBL_MAP_ERROR_LOAD' => 'Не удалось загрузить карту',
    'LBL_MAP_DISTANCE' => 'Расстояние',
    'LBL_SELECT_UNIT_TYPE' => 'Тип единицы',
    'LBL_MAPS_UNIT_MILES' => 'Мили',
    'LBL_MAPS_UNIT_KILOMETERS' => 'Километры',
    'LBL_RADIUS' => 'Радиус',
    'LBL_ZIP_CODE' => 'Почтовый индекс',
    'LBL_MOBILE_CHOOSE_ADDRESS' => 'Выберите адрес',
    'LBL_MOBILE_ADDRESS_NOT_GEOCODED' => 'Невозможно создать геокод из адреса:{{{address}}}',
    'LBL_MOBILE_GEOCODE_SAVE_ERROR' => 'Геокодирование записи не выполнено.',
    'LBL_MOBILE_GEOCODE_MANUAL_CONFIRM' => 'Запись не содержит адресных данных. Вы хотите определить местонахождение данной записи на карте вручную?',
    'LBL_ERR_SHOW_ON_MAP' => 'Не удалось открыть карту для выбранных записей.',
    'LBL_ERR_MISSING_ON_MAP' => 'Некоторые записи не имеют адресных данных и не показаны',
    'LBL_MAPS_ROUTE' => 'Маршрут',
    'LBL_MAPS_PROVIDER' => 'Карты Sugar',
    'LBL_MAPS_CURRENT_LOC_ERROR' => 'Не удалось определить текущее местоположение.',
    'LBL_MAPS_MAX_COLLECTION_LENGTH' => 'Для сопоставления поддерживается максимум {{{num}}} записей.',
    'LBL_ALL_MODULES' => 'Все модули',
    'LBL_DRIVE_SHARE_LINK' => 'Поделиться ссылкой',
    'LBL_DRIVE_LOAD_FILES_ERROR' => 'Не удалось загрузить файлы.',
    'LBL_DRIVE_NAME_EMPTY_ERROR' => 'Имя не может быть пустым',
    'LBL_DRIVE_FOLDER_CREATED' => 'Папка создана.',
    'LBL_DRIVE_FOLDER_CREATE_ERROR' => 'Не удалось создать папку.',
    'LBL_DRIVE_FILE_UPLOAD_ERROR' => 'Не удалось загрузить файл.',
    'LBL_DRIVE_NO_ROOT_FOLDER' => 'Сначала создайте корневую папку',
    'LBL_EDIT_ALL_RECURRENCES' => 'Редактировать все повторения',
    'LBL_DROPBOX_FILE_NOT_AVAILABLE' => 'Файл невозможно открыть в Dropbox',
    'LBL_FILE_NOT_AVAILABLE' => 'Файл невозможно открыть',
    'LBL_MAP_ROUTE_FROM_A_CURRENT_RECORD' => 'Направления',
    'LBL_MAPS_ROUTE_NOT_FOUND' => 'Для указанных путевых точек маршруты не найдены',
    'LBL_MAPS_IN_RADIUS_FROM_CURRENT_LOCATION' => 'Поблизости',
    'LBL_TAGS' => 'Теги',

    'LBL_CALLER_ID_SETTINGS' => 'Настройки идентификатора вызывающего абонента',
    'LBL_CALLER_ID_ENABLED' => 'Включен идентификатор вызывающего абонента',
    'LBL_CALLER_ID_ENABLED_TEXT' => 'При входящих вызовах отображается имя контакта или предварительного контакта, соответствующее данному номеру телефона.',
    'LBL_CALLER_ID_SETTINGS_HINT_IOS' => 'Чтобы разрешить мобильному приложению отображать идентификаторы вызывающего абонента, выполните следующие действия на своем устройстве:<br><br>1. Откройте «Настройки iOS» > «Телефон > блокировка и идентификация вызовов».<br>2. Включите «{{{brandName}}}».',
    'LBL_CALLER_ID_SETTINGS_HINT_ANDROID' => 'Чтобы разрешить мобильному приложению отображать идентификаторы вызывающего абонента, выполните следующие действия на своем устройстве:<br>1. Откройте настройки приложения.<br>2. Перейдите в раздел «Права доступа».<br>3. Включите право доступа «Телефон».<br><br> Чтобы установить это приложение в качестве обработчика идентификатора вызывающего абонента по умолчанию, перейдите в настройки вашего устройства.<br>1. Перейдите к Приложениям.<br>2. Выберите приложения по умолчанию.<br>3. Выберите приложение для идентификатора вызывающего абонента и спама.<br>4. Выберите это приложение в качестве варианта по умолчанию.',
    'LBL_CALLER_ID_SYNC_HINT' => 'Проверьте, нет ли изменений в контактной информации из записей (например, «Контакты», «Предварительные контакты») в вашем экземпляре Sugar.',
    'LBL_CALLER_ID_GO_TO_SETTINGS' => 'Перейдите в раздел Настройки',
    'LBL_CALLER_ID_SYNC' => 'Синхронизация данных записи',
    'LBL_CALLER_ID_NOT_ENABLED' => 'Перед выполнением синхронизации в настройках системы должен быть включен идентификатор вызывающего абонента.',
    'LBL_CALLER_ID_SETUP_ENABLE' => 'Включить',
    'LBL_CALLER_ID_SETUP_LATER_IN_SETTINGS' => 'Позже в настройках',
    'LBL_CALLER_ID_SETUP_HINT_ANDROID' => 'Это приложение поддерживает функцию идентификации вызывающего абонента.<br> Для корректной работы этой функции после нажатия кнопки включения вам будет предложено предоставить два права доступа.<br> Чтобы убедиться, что функция идентификации вызывающего абонента работает правильно, необходимо предоставить право доступа к управлению вызовами и выбрать это приложение в качестве обработчика идентификатора вызывающего абонента по умолчанию.<br> Если вы не предоставите право доступа к управлению вызовами, вы также не сможете регистрировать вызовы, сделанные из приложения.',
    'LBL_CALLER_ID_SETUP_HINT_IOS' => 'Чтобы разрешить мобильному приложению SugarCRM отображать идентификаторы вызывающих абонентов, выполните следующие действия на своем устройстве:<br><br>1. Откройте «Настройки iOS» > «Телефон» > «Блокировка и идентификация вызовов».<br>2. Включите приложение.',
    'LBL_MOBILE_LAST_SYNC' => 'Последняя синхронизация',
    'LBL_CALLER_ID_SYNCING' => 'Синхронизация с сервером.',
    'LBL_NEVER' => 'Никогда',
    'LBL_RLI_MISSING_ERROR' => '{{{moduleName}}} не может быть пустым.',
    'LBL_ADD_RELATED_RECORD' => 'Связанный {{{moduleSingular}}}',
    'LBL_CALLER_ID_NO_PERMISSION' => 'У вас нет необходимых прав доступа для использования идентификатора вызывающего абонента. Обратитесь к администратору.',
    'LBL_CALLER_ID_FETCHING' => 'Синхронизация…',
    'LBL_CALLER_ID_FETCH_ALL' => 'Повторная синхронизация всех записей',
    'LBL_CALLER_ID_FETCH_NEW' => 'Проверка наличия обновлений записей',

    'LBL_SORT_BY' => 'Сортировать по',
    'LBL_PRIMARY_SORT' => 'Основная сортировка',
    'LBL_SECONDARY_SORT' => 'Дополнительная сортировка',
    'LBL_OF' => 'из',
    'LBL_TABLE_FREEZE_FIRST' => 'Закрепить первый столбец',
    'LBL_TABLE_SETTINGS_TITLE' => 'Параметры представления столбцов',
    'LBL_TABLE_SETTINGS_NO_COL' => 'Необходимо выбрать минимум один столбец.',
    'LBL_TABLE_TOGGLER_INFO' => 'Отобразите или скройте столбцы и перетащите их в нужном порядке.',
    'LBL_RUNTIME_FILTERS_TITLE' => 'Фильтры среды выполнения',
    'LBL_FILTER_CONDITION' => 'Выберите условие',
    'LBL_FILTER_VALUES' => 'Значения',
    'LBL_TABLE_EXPAND' => 'Развернуть все',
    'LBL_TABLE_COLLAPSE' => 'Свернуть все',
    'LBL_RUNTIME_FILTERS_DEFAULT' => 'Ошибка сервера. Не удалось загрузить соответствующие фильтры среды выполнения.',

    // Pub/Sub
    'LBL_PUBSUB_MODULEEVENT_PUSHSUBS' => 'Push-подписки на события модуля Pub/Sub',
    'LBL_PUBSUB_MODULEEVENT_PUSHSUB' => 'Push-подписка на события модуля Pub/Sub',
];

$app_list_strings['configure_record_view_display_dom'] = [
    'panel_top' => 'Панель - Верхняя',
    'panel_bottom' => 'Панель - Нижняя',
    'tab_first' => 'Вкладка - Первая',
    'tab_last' => 'Вкладка - Последняя',
];
...
$app_list_strings['library_type'] = ['Books' => 'Книга', 'Music' => 'Музыка', 'DVD' => 'DVD', 'Magazines' => 'Журналы'];
...
$app_list_strings['merge_status_list'] = [
    ...
    'success' => 'Успешно',
    'canceled' => 'Отменено',
    'document_load' => 'Загрузка шаблона',
    'tags_extract' => 'Извлечение тегов',
    'tags_validate' => 'Проверка тегов',
    'data_retrieving' => 'Извлечение данных',
    'serialize_document' => 'Обратное составление документа',
    'send_document' => 'Отправка документа вам',
];

$app_list_strings['merge_type_list'] = [
    'merge' => 'Объединить',
    'convert' => 'Объединение PDF-файлов',
    'multimerge' => 'Массовое объединение',
    'multimerge_convert' => 'Массовое объединение PDF-файлов',
    'labelsgenerate' => 'Создать метки',
    'labelsgenerate_convert' => 'Создать метки в формате PDF',
    'excel' => 'Объединение файлов Excel',
    'excel_convert' => 'Преобразование объединения файлов Excel',
    'presentation' => 'Объединение файлов PowerPoint',
    'presentation_convert' => 'Объединение PDF-файлов в PowerPoint',
];
...
$app_list_strings['stage2_preferences_type'] = [
    'owner' => 'Мои контрагенты',
    'favorites' => 'Избранные контрагенты',
    'tags' => 'Контрагенты с тегом',
];
...
$app_strings['LBL_OWNERS'] = 'Владельцы';
$app_strings['LBL_DASHLET_CLOUD_DRIVE_NAME'] = 'Облачное хранилище';
$app_strings['LBL_DASHLET_CLOUD_DRIVE_DESCRIPTION'] = 'Дашлет интеграции с облачным хранилищем';
$app_strings['LBL_COPY_GOOGLE_DRIVE_LINK'] = 'Копировать ссылку';
$app_strings['LBL_DOWNLOAD_DRIVE_FILE'] = 'Загрузить';
$app_strings['LBL_CREATE_SUGAR_DOCUMENT'] = 'Создать документ Sugar';
$app_strings['LBL_DRIVE_UNABLE_TO_DOWNLOAD'] = 'Не удается загрузить этот файл';
$app_strings['LBL_DRIVE_CLOUD_DASHLET_NOT_PRESENT'] = 'Дашлет облака отсутствует';
$app_strings['LBL_DRIVE_DOCUMENT_CREATED'] = 'Создан документ Sugar';
$app_strings['LBL_SEND_TO_DOCUSIGN'] = 'Отправить в DocuSign';
$app_strings['LBL_NO_SEND_TO_DOCUSIGN'] = 'DocuSign недоступен из этого расположения.';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_WEP'] = 'Объединение документов в Word/Excel/PowerPoint недоступно из этого расположения';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_DS'] = 'Объединение документов в DocuSign недоступно из этого расположения';
$app_strings['LBL_NO_SEND_TO_DOCMERGE_PDF'] = 'Объединение документов в PDF-файл недоступно из этого расположения';
$app_strings['LBL_DOCUSIGN_PERMISSIONS'] = 'Ваш подписанный файл будет загружен сюда только в случае наличия разрешения на загрузку в данное место.';
$app_strings['LBL_DOC_MERGE_TO'] = 'Объединение документов в';
...
$app_string['LBL_MY_FILES'] = 'Мои файлы';
$app_strings['LBL_SHARED_WITH_ME'] = 'Мне предоставлен доступ';
$app_strings['LBL_CLOUD_PROVIDER'] = 'Поставщик облачных услуг';

$app_list_strings['drive_types'] = [
    'google' => 'Google Диск',
    'onedrive' => 'Microsoft OneDrive',
    'dropbox' => 'Диск Dropbox',
    'sharepoint' => 'Microsoft SharePoint',
];
$app_strings['LBL_SHARED_WITH_ME'] = 'Мне предоставлен доступ';
$app_strings['LBL_MY_FILES'] = 'Мои файлы';
$app_strings['LBL_UPLOAD_FILE'] = 'Загрузить файл';
$app_strings['LBL_FOLDER_NOT_FOUND'] = 'Папка не найдена';
$app_strings['LBL_CREATE_FOLDER'] = 'Создать папку';
$app_strings['LBL_LOAD_MORE'] = 'Загрузить больше...';
$app_strings['LBL_NEW_FOLDER'] = 'Новая папка';
$app_strings['LBL_FOLDER_NAME'] = 'Имя папки: ';
$app_strings['LBL_PERMISSION_ERROR'] = 'У вас нет прав на выполнение данного действия на текущем пути.';
$app_strings['LBL_MICROSOFT_PERMISSION_ERROR'] = 'У вас нет прав на переход на текущий путь.';
$app_strings['LBL_FILE_UPLOADED'] = 'Файл был загружен.';
$app_strings['LBL_LARGE_FILE_UPLOAD'] = 'Из-за большого размера вашего файла загрузка займет некоторое время.';
$app_strings['LBL_ERR_NO_FILE_ATTACHED'] = 'У одной или более записей документов отсутствует вложенный файл. Добавьте файлы к записям и повторите попытку или синхронизуйте конкретные записи с файлами.';

$app_strings['LBL_CHECK_GOOGLE_CONNECTION'] = 'Соединение с Google не найдено...';
$app_strings['LBL_CHECK_MICROSOFT_CONNECTION'] = 'Соединение с Microsoft не найдено...';
$app_strings['LBL_CHECK_DROPBOX_CONNECTION'] = 'Соединение с Dropbox не найдено...';
$app_strings['LBL_MICROSOFT_DELAY'] = 'Синхронизация с OneDrive может занять некоторое время';
$app_strings['LBL_DRIVE_DELETE_CONFIRM'] = 'Вы уверены, что хотите удалить этот файл?';
$app_strings['LBL_MICROSOFT_UPLOAD_COMPLETE'] = 'Загрузка OneDrive была завершена.';
$app_strings['LBL_MICROSOFT_UPLOAD_COMPLETE_DESCRIPTION'] = ' успешно загружен.';
$app_strings['LBL_DRIVE_LOAD_PATH_ERROR'] = 'Ошибка при загрузке путей.';
$app_strings['LBL_INVALID_DRIVE_FILE'] = 'Произошла ошибка, поскольку файл поврежден.';
$app_strings['LBL_UPLOAD_AND_LINK_COMPLETE'] = 'Документ <i>"{{documentName}}"</i> сохранен на вашем облачном диске и добавлен в модуль «Документы».';
$app_strings['LBL_NO_PERMISSION_FILE_ERROR'] = 'У вас нет прав на удаление этого файла.';
$app_strings['LBL_NO_PERMISSION_FOLDER_ERROR'] = 'У вас нет прав на удаление этой папки.';
$app_strings['LBL_NO_PERMISSION_FILE_UPLOAD_ERROR'] = 'У вас нет прав отправки файлов в это расположение.';
$app_strings['LBL_NO_PERMISSION_FOLDER_CREATE_ERROR'] = 'У вас нет прав создания папки в этом расположении.';
$app_strings['LBL_NO_FOLDER_CREATE'] = 'Невозможно создать папку в этом расположении.';
$app_strings['LBL_NO_FILE_UPLOAD'] = 'Невозможно загрузить файлы в это расположение.';
$app_strings['LBL_SITES'] = 'Сайты';
$app_strings['LBL_SHARED'] = 'С совместным доступом';
$app_strings['LBL_COPY_LINK_CONFIRMATION'] = 'Ссылка создана. Нажмите кнопку, чтобы скопировать ссылку в буфер обмена.';
$app_strings['LBL_COPY_CLIPBOARD_CONFIRMATION'] = 'Копировать в буфер обмена';


$app_list_strings['gc_status_list'] = [
    '-blank-' => '-пусто-',
    'Exact' => 'Точно',
    'Null_address_components' => 'Один или несколько компонентов адреса пусты',
    'Invalid_address' => 'Неверный адрес, сервер вернул значение "Неверно"',
    'Invalid_server_response_not_XML' => 'Недопустимый ответ сервера, а не XML',
    'Invalid_address_no_location' => 'Неверный адрес, сервер не вернул расположение',
    'Ambiguous_address' => 'Неоднозначный адрес, несколько совпадений',
];
...
$app_list_strings['kiosk_available_language_dom'] = [['en_us', 'Английский (США)']];
$app_list_strings['kiosk_available_timezone_dom'] = [
    ['est', 'Нью-Йорк (EST)'],
    ['pst', 'Лос-Анджелес (PST)'],
];
$app_list_strings['kiosk_case_status_dom'] = [
    ['Новый', 'Новый'],
    ['Назначено', 'Назначено'],
    ['Закрыто', 'Закрыто'],
    ['Ожидание ввода', 'Ожидание ввода'],
    ['Отклонено', 'Отклонено'],
    ['Дубликат', 'Дубликат'],
];
...
$app_list_strings['kiosk_invitations_roles_dom'] = [
    ...
    ['пользователь с правами управления учетными записями, пользователь', 'Пользователь с правами управления учетными записями'],
];

$app_list_strings['kiosk_document_shared_dom'] = [
    ['last_30_days', 'Последние 30 дней'],
    ['last_90_days', 'Последние 90 дней'],
    ['this_year', 'Прошлый год'],
    ['пользовательский', 'Пользовательский диапазон'],
    ['все', 'Все'],
];
...
$app_list_strings['kiosk_background_type_dom'] = [
    ...
    ['Цвет', 'Сплошной цвет'],
    ['Url-адрес', 'Пользовательское изображение'],
];
