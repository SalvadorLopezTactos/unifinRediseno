    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'Oblast <b>Rasporeda</b> sadrži polja koja su trenutno prikazana u okviru <b>QuickCreate</b>.<br><br>Obrazac QuickCreate će se pojaviti u podpanelima za modul kada se klikne na dugme Kreiraj.<br/><br/> <b>Set alata</b> sadrži <b>Korpu za otpatke</b> i polja i elemente rasporeda koji se mogu dodati rasporedu.<br><br>Menjte raspored prevlačenjem i otpuštanjem elemenata i polja između <b>Seta alata</b> i <b>Rasporeda</b> i unutar samog rasporeda.<br><br>Da biste uklonili polje iz rasporeda, prevucite polje u polje u <b>Korpu za otpatke</b>. Polje će zatim biti dostupno u Setu alata za dodavanje rasporedu.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označava zavisno polje koje može ili ne mora da bude vidljivo na osnovu vrednosti formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označava obračunato polje čija vrednost može automatski da se utvrdi na osnovu formule.'
            ,
            //this defualt will be used for edit view
            'default' => 'Oblast <b>Rasporeda</b> sadrži polja koja su trenutno prikazana u <b>EditView</b>. <br/><br/>Set alata</b> sadrži <b>Korpu za otpatke</b> i polja i elemente rasporeda koji se mogu dodati rasporedu.<br><br>Menjajte raspored prevlačenjem i otpuštanjem elemenata i polja između <b>Seta alata</b> i <b>Rasporeda</b> i unutar samog rasporeda.<br><br>Da biste uklonili polje iz rasporeda, prevucite polje u polje u <b>Korpu za otpatke</b>. Polje će zatim biti dostupno u Setu alata za dodavanje rasporedu.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označava zavisno polje koje može ili ne mora da bude vidljivo na osnovu vrednosti formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označava obračunato polje čija vrednost može automatski da se utvrdi na osnovu formule.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Prilagodite podešavanja <b>Vremenske linije</b> za određeni modul. Omogućite ili onemogućite koji moduli se prikazuju.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Da li ste sigurni da želite da obrišete ovaj odnos?<br>Napomena: Ova radnja će možda trajati nekoliko minuta.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Kreirajte formulu kojom se utvrđuje vrednost u ovom polju.<br>'
        . 'Definicije radnog toka koje sadrže radnju koja je podešena da ažurira ovo polje više neće izvršavati radnju.<br>'
        . 'Polja koja koriste formule neće biti obračunata u realnom vremenu u '
        . 'Sugar Self-Service portalu ili '
        . 'Mobile EditView rasporedima.',

    'LBL_POPHELP_DEPENDENT' => 'Kreirajte formulu kojom se utvrđuje da li je ovo polje vidljivo u rasporedima.<br/>'
        . 'Zavisna polja će pratiti formulu zavisnosti u mobilnom prikazu zasnovanom na pregledaču, <br/>'
        . 'ali neće pratiti formulu u izvornim aplikacijama, kao što su Sugar Mobile za iPhone.<br/>'
        . 'Neće pratiti formulu na Sugar Self-Service portalu.',
    'LBL_POPHELP_REQUIRED' => 'Kreirajte formulu kojom se utvrđuje da li je ovo polje obavezno u rasporedima.<br/>'
        . 'Polja koja su obavezna će pratiti formulu u mobilnom prikazu zasnovanom na pregledaču,<br/>'
        . 'ali neće pratiti formulu u izvornim aplikacijama, kao što su Sugar Mobile za iPhone.<br/>'
        . 'Neće pratiti formulu na Sugar Self-Service portalu.',
    ...
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Izaberite da biste koristili ovo polje kada pretražujete zapise pomoću Globalne pretrage u ovom modulu.',
