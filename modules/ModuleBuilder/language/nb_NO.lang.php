    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'Området <b>Oppsett</b> -inneholder feltene som for øyeblikket vises i <b>Hurtigoppretting</b>-skjemaet.<br><br>QuickCreate-skjemaet vises i underpanelene for modulen når du klikker på Opprett-knappen.<br/><br/> <b>Verktøykasse</b> inneholder <b>Papirkurv</b> og feltene og oppsettelementene som kan legges til i oppsettet.<br><br>Foreta endringer i oppsettet ved å dra og slippe elementer og felt mellom <b>Verktøykasse</b> og <b>Oppsett</b> og innenfor selve oppsettet.<br><br>Hvis du vil fjerne et felt fra oppsettet, drar du feltet til <b>Papirkurv</b>. Feltet vil da være tilgjengelig i verktøykassen for å legge det til i oppsettet.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indikerer et avhengig felt som kanskje vil være synlig basert på verdien til en formel.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indikerer et beregnet felt hvis verdi automatisk vil bli fastslått basert på en formel.'
            ,
            //this defualt will be used for edit view
            'default' => 'Området <b>Oppsett</b> -området inneholder feltene som for øyeblikket vises i <b>EditView</b>.<br/><br/> <b>Verktøykasse</b> inneholder <b>Papirkurv</b> og feltene og oppsettelementene som kan legges til i oppsettet.<br><br>Foreta endringer i oppsettet ved å dra og slippe elementer og felt mellom <b>Verktøykasse</b> og <b>Oppsett</b> og innenfor selve oppsettet.<br><br>Hvis du vil fjerne et felt fra oppsettet, drar du feltet til <b>Papirkurv</b>. Feltet vil da være tilgjengelig i verktøykassen for å legge det til i oppsettet.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indikerer et avhengig felt som kanskje ikke er synlig basert på verdien i en formel.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indikerer et beregnet felt der verdien bestemmes automatisk basert på en formel.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Tilpass <b>Tidslinjeinnstillinger</b> for denne spesifikke modulen. Aktiver eller deaktiver hvilke moduler som vises.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Er du sikker på at du ønsker å slette denne relasjonen?<br>Merk: Denne operasjonen fullføres kanskje ikke på flere minutter.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Opprett en formel for å bestemme verdien i dette feltet.<br>'
        . 'Arbeidsflytdefinisjoner som inneholder en handling som er angitt for å oppdatere dette feltet, vil ikke lenger utføre handlingen.<br>'
        . 'Felt som bruker formler, beregnes ikke i sanntid i '
        . 'Sugar-selvbetjeningsportalen eller '
        . 'Mobile EditView-oppsett.',

    'LBL_POPHELP_DEPENDENT' => 'Opprett en formel for å fastslå om dette feltet er synlig i oppsett.<br/>'
        . 'Avhengige felt vil følge formelen i den nettleserbaserte mobilvisningen, <br/>'
    ...
    'LBL_POPHELP_REQUIRED' => 'Opprett en formel for å fastslå om dette feltet er påkrevd i oppsett.<br/>'
    ...
    'LBL_POPHELP_READONLY' => 'Opprett en formel for å fastslå om dette feltet er skrivebeskyttet i oppsett.<br/>'
        ...
        . 'men vil ikke følge formelen i de innebygde applikasjonene, som Sugar Mobile for iPhone. <br/>'
        . 'De vil ikke følge formelen i Sugars selvbetjeningsportal.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Velg dette feltet når du søker etter poster ved hjelp av Globalt søk i denne modulen.',
