    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => '<b>レイアウト</b>エリアには、<b>QuickCreate</b>フォーム内に現在表示されているフィールドが含まれます。<br><br>[作成]ボタンをクリックすると、モジュールのサブパネルにQuickCreateフォームが表示されます。<br/><br/><b>ツールボックス</b>には、<b>ごみ箱</b>とレイアウトに追加できるフィールドとレイアウト要素が含まれます。<br><br><b>ツールボックス</b>と<b>レイアウト</b>の間、およびレイアウト自体の中で要素やフィールドをドラッグアンドドロップすると、レイアウトに変更を加えられます。<br><br>レイアウトからフィールドを削除するには、フィールドを<b>ごみ箱</b>にドラッグします。その後、フィールドはツールボックスでレイアウトに追加できるようになります。'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>数式の値に基づいて表示されたり表示されなかったりする依存フィールドを示します。<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> 数式に基づいて値が自動的に決定される計算フィールドを示します。'
            ,
            //this defualt will be used for edit view
            'default' => '<b>レイアウト</b>エリアには、<b>編集ビュー</b>内に現在表示されているフィールドが含まれます。<br/><br/><b>ツールボックス</b>には、<b>ごみ箱</b>とレイアウトに追加できるフィールドとレイアウト要素が含まれます。<br><br><b>ツールボックス</b>と<b>レイアウト</b>の間、およびレイアウト自体の中で要素やフィールドをドラッグアンドドロップすると、レイアウトに変更を加えられます。<br><br>レイアウトからフィールドを削除するには、フィールドを<b>ごみ箱</b>にドラッグします。その後、フィールドはツールボックスでレイアウトに追加できるようになります。'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>数式の値に基づいて表示されたり表示されなかったりする依存フィールドを示します。<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> 数式に基づいて値が自動的に決定される計算フィールドを示します。'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => '特定のモジュールの<b>タイムライン</b>の設定をカスタマイズできます。表示されるモジュールを有効または無効にします。',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'この関係を削除してもよろしいですか？<br>注：この操作は数分間完了しない場合があります。',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'このフィールドの値を決定する数式を作成できます。<br>'
        . 'このフィールドを更新するように設定されたアクションを含むワークフロー定義は、アクションを実行しなくなります。<br>'
        . '数式を使用するフィールドは、'
        . 'Sugarセルフサービスポータルまたは'
        . 'モバイル編集ビューレイアウトでは、リアルタイムに計算されません。',

    'LBL_POPHELP_DEPENDENT' => 'レイアウトでこのフィールドを表示可能にするかどうかを決定する数式を作成できます。<br/>'
        . '依存フィールドは、ブラウザベースのモバイルビューの依存数式に従いますが、<br/>'
        . 'Sugar Mobile for iPhoneなどのネイティブアプリケーション内の数式には従いません。<br/>'
        . 'Sugarセルフサービスポータル内の数式にも従いません。',
    'LBL_POPHELP_REQUIRED' => 'レイアウトでこのフィールドを必須にするかどうかを決定する数式を作成できます。<br/>'
    ...
    'LBL_POPHELP_GLOBAL_SEARCH' => 'このモジュールのグローバル検索を使用してレコードを検索するときに、このフィールドの使用を選択できます。',
