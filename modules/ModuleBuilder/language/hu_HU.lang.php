    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'A <b>Elrendezés</b> terület tartalmazza azokat a mezőket, amelyek jelenleg megjelennek a <b>Gyors létrehozás</b> űrlapon.<br><br>A Gyors létrehozás űrlap megjelenik a modul alpaneljein, amikor a Létrehozás gombra kattint.<br/><br/>A <b>Szerszámosláda</b> tartalmazza a <b>Lomtárat</b> valamint az elrendezéshez hozzáadható mezőket és elrendezési elemeket.<br><br>Módosítsa az elrendezést úgy, hogy elemeket és mezőket húz a <b>Szerszámosláda</b> és a <b>Elrendezés</b> között, valamint magán az elrendezésen belül.<br><br>Ha el szeretne távolítani egy mezőt az elrendezésből, húzza a mezőt a <b>Lomtárba</b>. A mező ezután elérhető lesz az Eszközkészletben, és hozzáadhatja az elrendezéshez.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Olyan függő mezőt jelöl, amely a képlet értéke alapján látható vagy nem látható.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Olyan számított mezőt jelöl, amelynek értéke automatikusan meghatározásra kerül egy képlet alapján.'
            ,
            //this defualt will be used for edit view
            'default' => 'A <b>Elrendezés</b> terület tartalmazza azokat a mezőket, amelyek jelenleg megjelennek a <b>Nézet szerkesztése</b> űrlapon.<br><br>A <b>Szerszámosláda</b> tartalmazza a <b>Lomtárat</b> valamint az elrendezéshez hozzáadható mezőket és elrendezési elemeket.<br><br>Módosítsa az elrendezést úgy, hogy elemeket és mezőket húz a <b>Szerszámosláda</b> és a <b>Elrendezés</b> között, valamint magán az elrendezésen belül.<br><br>Ha el szeretne távolítani egy mezőt az elrendezésből, húzza a mezőt a <b>Lomtárba</b>. A mező ezután elérhető lesz az Eszközkészletben, és hozzáadhatja az elrendezéshez.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Olyan függő mezőt jelöl, amely a képlet értéke alapján látható vagy nem látható.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Olyan számított mezőt jelöl, amelynek értéke automatikusan meghatározásra kerül egy képlet alapján.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Testreszabja az <b>Idővonal</b> beállításaitaz adott modulra vonatkozóan. A megjelenített modulok engedélyezése vagy letiltása.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Biztosan törölni szeretné ezt a kapcsolatot?<br>Megjegyzés: előfordulhat, hogy ez a művelet több percig nem fejeződik be.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Hozzon létre egy képletet a mező értékének meghatározásához.<br>'
        . 'Azok a műveleteket tartalmazó munkafolyamat-definíciók, amelyek a mező frissítésére vannak beállítva, a továbbiakban nem hajtják végre a műveletet.<br>'
        . 'A képleteket használó mezők kiszámítása nem történik valós időben '
        . 'a Sugar Self Service Portal vagy '
        . 'Mobil EditView elrendezések.',

    'LBL_POPHELP_DEPENDENT' => 'Hozzon létre képletet annak meghatározására, hogy a mező látható-e az elrendezésekben.<br/>'
        . 'A függő mezők követik a függőképletet a böngészőalapú mobilnézetben, <br/>'
        . 'de nem követik a képletet a natív alkalmazásokban, így például a Sugar Mobile for iPhone alkalmazásban. <br/>'
        . 'Nem követik a Sugar Self-Service Portal képletét.',
    'LBL_POPHELP_REQUIRED' => 'Hozzon létre képletet annak meghatározására, hogy a mező kötelező-e az elrendezésekben.<br/>'
    ...
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Válassza ezt a mezőt, ha bejegyzéseket keres a modul globális keresésével.',
