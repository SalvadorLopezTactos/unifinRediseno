    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => '<b>레이아웃</b> 영역에는 현재 <b>빠른 생성</b> 내에 표시된 필드가 포함되어 있습니다.<br><br>생성 버튼을 클릭하면 빠른 생성 양식이 모듈의 하위 패널에 나타납니다.<br/><br/><b>도구 상자</b>에는 <b>휴지통</b>과 레이아웃에 추가할 수 있는 필드 및 레이아웃 요소가 들어 있습니다.<br><br><b>도구 상자</b>와 <b>레이아웃</b> 사이 및 레이아웃 안에서 요소와 필드를 드래그 앤 드롭하여 변경합니다.<br><br>레이아웃에서 필드를 제거하려면 필드를 <b>휴지통</b>으로 드래그하십시오. 그러면 도구 상자에서 필드를 레이아웃에 추가할 수 있게 됩니다.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>수식 값에 따라 표시되거나 표시되지 않을 수 있는 종속 필드를 나타냅니다.<br/><!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_calculated.png" /> 수식을 기반으로 값이 자동으로 결정되는 계산된 필드를 나타냅니다.'
            ,
            //this defualt will be used for edit view
            'default' => '<b>레이아웃</b> 영역에는 현재 <b>편집 보기</b> 내에 표시된 필드가 포함되어 있습니다.<br/><br/><b>도구 상자</b>에는 <b>휴지통</b>과 레이아웃에 추가할 수 있는 필드 및 레이아웃 요소가 들어 있습니다.<br><br><b>도구 상자</b>와 <b>레이아웃</b> 사이 및 레이아웃 안에서 요소와 필드를 드래그 앤 드롭하여 변경합니다.<br><br>레이아웃에서 필드를 제거하려면 필드를 <b>휴지통</b>으로 드래그하십시오. 그러면 도구 상자에서 필드를 레이아웃에 추가할 수 있게 됩니다.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>수식 값에 따라 표시되거나 표시되지 않을 수 있는 종속 필드를 나타냅니다.<br/><!--not_in_theme!--> <img src="themes/default/images/SugarLogic/icon_calculated.png" /> 수식을 기반으로 값이 자동으로 결정되는 계산된 필드를 나타냅니다.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => '이 특정 모듈의 <b>타임라인</b> 설정을 사용자 지정합니다. 표시될 모듈을 활성화 또는 비활성화합니다.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => '이 관계를 삭제하시겠습니까?<br>참고: 이 작업은 몇 분 동안 완료되지 않을 수 있습니다.',
...
//POPUP HELP
    ...
    'LBL_POPHELP_DEPENDENT' => '이 필드가 레이아웃에서 표시되는지 결정하는 공식을 생성합니다.<br/>'
