    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'Zona <b>Aspect</b> conține câmpurile care sunt afișate în prezent în formularul <b>Creare rapidă</b>.<br><br>Formularul Creare rapidă apare în subpanourile modulului atunci când se face clic pe butonul Creare.<br/><br/> <b>Caseta de instrumente</b> conține <b>Coșul de reciclare</b> și câmpurile și elementele de aspect care pot fi adăugate la aspect.<br><br>Efectuați modificări în aspect glisând și fixând elemente și câmpuri între <b>Caseta de instrumente</b> și <b>Aspect</b> și în cadrul aspectului.<br><br>Pentru a elimina un câmp din aspect, glisați câmpul în <b>Coșul de reciclare</b>. Câmpul va fi apoi disponibil în Caseta de instrumente pentru a-l adăuga la aspect.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indică un câmp Dependent care poate fi vizibil sau nu pe baza valorii unei formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indică un câmp Calculat a cărui valoare va fi determinată automat pe baza unei formule.'
            ,
            //this defualt will be used for edit view
            'default' => 'Zona <b>Aspect</b> conține câmpurile care sunt afișate în prezent în <b>Vizualizare editare</b>.<br/><br/> <b>Caseta de instrumente</b> conține <b>Coșul de reciclare</b> și câmpurile și elementele de aspect care pot fi adăugate la aspect.<br><br>Efectuați modificări în aspect glisând și fixând elemente și câmpuri între <b>Caseta de instrumente</b> și <b>Aspect</b> și în cadrul aspectului.<br><br>Pentru a elimina un câmp din aspect, glisați câmpul în <b>Coșul de reciclare</b>. Câmpul va fi apoi disponibil în Caseta de instrumente pentru a-l adăuga la aspect.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indică un câmp Dependent care poate fi vizibil sau nu pe baza valorii unei formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indică un câmp Calculat a cărui valoare va fi determinată automat pe baza unei formule.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Personalizați setările <b>Cronologie</b> pentru acest modul specific. Activați sau dezactivați modulele afișate.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Sunteți sigur că doriți să ștergeți această relație?<br>Notă: Este posibil ca această operație să nu se finalizeze timp de câteva minute.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Creați o formulă pentru a determina valoarea din acest câmp.<br>'
        . 'Definițiile fluxului de lucru care conțin o acțiune setată să actualizeze acest câmp nu vor mai executa acțiunea.<br>'
        . 'Câmpurile care utilizează formule nu vor fi calculate în timp real în '
        . 'portalul de autoservire Sugar sau '
        . 'aspectele Vizualizare editare mobilă.',

    'LBL_POPHELP_DEPENDENT' => 'Creați o formulă pentru a determina dacă acest câmp este vizibil în aspecte.<br/>'
        . 'Câmpurile dependente vor respecta formula de dependență din vizualizarea mobilă bazată pe browser, <br/>'
        . 'dar nu vor respecta formula în aplicațiile native, cum ar fi Sugar Mobile pentru iPhone. <br/>'
        . 'Acestea nu vor respecta formula din Portalul de autoservire Sugar.',
    'LBL_POPHELP_REQUIRED' => 'Creați o formulă pentru a determina dacă acest câmp este obligatoriu în aspecte.<br/>'
        . 'Câmpurile obligatorii vor respecta formula din vizualizarea mobilă bazată pe browser, <br/>'
        . 'dar nu vor respecta formula în aplicațiile native, cum ar fi Sugar Mobile pentru iPhone. <br/>'
        . 'Acestea nu vor respecta formula din Portalul de autoservire Sugar.',
    'LBL_POPHELP_READONLY' => 'Creați o formulă pentru a determina dacă acest câmp este de tip „doar citire” în machete.<br/>'
        ...
        . 'Acestea nu vor respecta formula din Portalul de autoservire Sugar.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Selectați pentru a utiliza acest câmp atunci când căutați înregistrări utilizând Căutarea globală din acest modul.',
