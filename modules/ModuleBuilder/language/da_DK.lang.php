    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'Området <b>Layout</b> indeholder de felter, der aktuelt vises i formularen <b>QuickCreate</b>.<br><br>Formularen QuickCreate vises i underpanelerne for modulet, når der klikkes på knappen Opret.<br/><br/><b>Værktøjskasse</b> indeholder <b>Papirkurv</b> og de felter og layoutelementer, der kan føjes til layoutet.<br><br>Du kan foretage ændringer på layoutet ved at trække og slippe elementer og felter mellem <b>Værktøjskasse</b> og <b>Layout</b> og inden for selve layoutet.<br><br>For at fjerne et felt fra layoutet skal du trække feltet til <b>Papirkurve</b>. Feltet bliver så tilgængeligt i Værktøjskasse, så det kan føjes til layoutet.'
                . '<br/><br/><!--ikke_i_tema!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Angiver et felt for Afhængig, der kan være synligt baseret på værdien i en formel.<br/><!--ikke_i_tema!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Angiver et felt for Beregnet, hvis værdi bestemmes automatisk baseret på en formel.'
            ,
            //this defualt will be used for edit view
            'default' => 'Området <b>Layout</b> indeholder de felter, der aktuelt vises i <b>EditView</b>.<br/><br/><b>Værktøjskasse</b> indeholder <b>Papirkurve</b> og de felter og layoutelementer, der kan føjes til layoutet.<br><br>Du kan foretage ændringer på layoutet ved at trække og slippe elementer og felter mellem <b>Værktøjskasse</b> og <b>Layout</b> og inden for selve layoutet.<br><br>For at fjerne et felt fra layoutet skal du trække feltet til <b>Papirkurve</b>. Feltet bliver så tilgængeligt i Værktøjskasse, så det kan føjes til layoutet.'
                . '<br/><br/><!--ikke_i_tema!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Angiver et felt for Afhængig, der kan være synligt baseret på værdien i en formel.<br/><!--ikke_i_tema!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Angiver et felt for Beregnet, hvis værdi bestemmes automatisk baseret på en formel.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Tilpas indstillinger for <b>Tidslinje</b> for dette bestemte modul. Aktivér eller deaktivér de moduler, der skal vises.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Vil du slette denne relation?<br>Bemærk: Denne handling gennemføres muligvis ikke i flere minutter.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Opret en formel til at bestemme værdien i dette felt.<br>'
        . 'Arbejdsgangdefinitioner indeholdende en handling, der er indstillet til at opdatere dette felt, udfører ikke længere denne handling.<br>'
        . 'Felter, der bruger formler, bliver ikke beregnet i realtid i '
        . 'Sugar Self-Service-portal eller '
        . 'Mobile EditView-layouts.',

    'LBL_POPHELP_DEPENDENT' => 'Opret en formel til at bestemme, om dette felt er synligt i layouts.<br/>'
        . 'Afhængige felter følger afhængighedsformlen i den browserbaserede mobilvisning, <br/>'
        . 'men vil ikke følge formlen i de indfødte programmer, som f.eks. Sugar Mobile til iPhone.<br/>'
        . 'De vil ikke følge formlen i Sugar Self-Service-portalen.',
    'LBL_POPHELP_REQUIRED' => 'Opret en formel for at afgøre, om dette felt er påkrævet i layouts.<br/>'
        . 'Påkrævede felter vil følge formlen i den browser-baserede mobilvisning, <br/>'
        . 'men vil ikke følge formlen i de indbyggede programmer, som f. eks. Sugar Mobile til iPhone.<br/>'
        . 'De vil ikke følge formlen i Sugar-selvbetjeningsportalen.',
    'LBL_POPHELP_READONLY' => 'Opret en formel til at bestemme, om dette felt er skrivebeskyttet i layouts.<br/>'
        ...
        . 'De vil ikke følge formlen i Sugar Self-Service-portalen.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Vælg at bruge dette felt, når du søger efter poster med Global søgning i dette modul.',
