    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'Het gebied <b>Indeling</b> bevat de velden die momenteel worden weergegeven in het formulier <b>Snel maken</b>.<br><br>Het formulier Snel maken wordt weergegeven in de subvensters voor de module wanneer op de knop Maken wordt geklikt.<br/><br/>De <b>Gereedschapskist</b> bevat de <b>Prullenbak</b> en de velden en lay-outelementen die aan de lay-out kunnen worden toegevoegd.<br><br>Breng wijzigingen aan in de lay-out door elementen en velden te slepen en neer te zetten tussen de <b>Gereedschapskist</b> en de <b>Indeling</b>, en binnen de lay-out zelf.<br><br>Als u een veld uit de lay-out wilt verwijderen, sleept u het veld naar de <b>Prullenbak</b>. Het veld is dan beschikbaar in de Gereedschapskist om toe te voegen aan de lay-out.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Hiermee wordt een afhankelijk veld aangegeven dat al dan niet zichtbaar is op basis van de waarde van een formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Hiermee wordt een berekend veld aangegeven waarvan de waarde automatisch wordt bepaald op basis van een formule.'
            ,
            //this defualt will be used for edit view
            'default' => 'Het gebied <b>Indeling</b> bevat de velden die momenteel worden weergegeven in de <b>Bewerkingsweergave</b>.<br/><br/>De <b>Gereedschapskist</b> bevat de <b>Prullenbak</b> en de velden en lay-outelementen die aan de lay-out kunnen worden toegevoegd.<br><br>Breng wijzigingen aan in de lay-out door elementen en velden te slepen en neer te zetten tussen de <b>Gereedschapskist</b> en de <b>Indeling</b>, en binnen de lay-out zelf.<br><br>Als u een veld uit de lay-out wilt verwijderen, sleept u het veld naar de <b>Prullenbak</b>. Het veld is dan beschikbaar in de Gereedschapskist om toe te voegen aan de lay-out.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Hiermee wordt een afhankelijk veld aangegeven dat al dan niet zichtbaar is op basis van de waarde van een formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Hiermee wordt een berekend veld aangegeven waarvan de waarde automatisch wordt bepaald op basis van een formule.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => '<b>Tijdlijn</b> instellingen aanpassen voor deze specifieke module. Schakel in of uit welke modules worden weergegeven.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Weet u zeker dat u deze relatie wilt verwijderen?<br>Opmerking: het kan enkele minuten duren voordat deze bewerking is voltooid.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Maak een formule om de waarde in dit veld te bepalen.<br>'
        . 'Workflowdefinities die een actie bevatten en die zijn ingesteld om dit veld bij te werken, voeren de actie niet meer uit.<br>'
        . 'Velden met formules worden niet in realtime berekend in '
        . 'het Sugar Self-Service Portal of '
        . 'Indelingen mobiele bewerkingsweergave.',

    'LBL_POPHELP_DEPENDENT' => 'Maak een formule om te bepalen of dit veld zichtbaar is in layouts.<br/>'
        . 'Afhankelijk velden volgen de afhankelijkheidsformule in de op de browser gebaseerde mobiele weergave,<br/>'
    ...
    'LBL_POPHELP_READONLY' => 'Maak een formule om te bepalen of dit veld Alleen lezen is in layouts.<br/>'
        ...
        . 'maar volgen niet de formule in de oorspronkelijke applicaties, zoals Sugar Mobile voor iPhone. <br/>'
        . 'Deze volgen de formule in het Sugar-zelfbedieningsportaal niet.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Selecteer deze optie om dit veld te gebruiken bij het zoeken naar records met behulp van de algemene zoekfunctie in deze module.',
