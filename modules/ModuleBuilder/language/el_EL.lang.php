    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'Η περιοχή <b>Διάταξη</b> περιέχει τα πεδία που εμφανίζονται αυτή τη στιγμή μέσα στη φόρμα <b>Γρήγορη δημιουργία</b> .<br><br>Η φόρμα Γρήγορη δημιουργία εμφανίζεται στους υποπίνακες της ενότητας όταν κάνετε κλικ στο κουμπί Δημιουργία.<br/><br/>Η <b>Εργαλειοθήκη</b> περιέχει τον <b>Κάδο ανακύκλωσης</b> και τα πεδία και τα στοιχεία διάταξης που μπορούν να προστεθούν στη διάταξη.<br><br>Κάντε αλλαγές στη διάταξη με μεταφορά και απόθεση στοιχείων και πεδίων μεταξύ της <b>Εργαλειοθήκης</b> και της <b>Διάταξης</b> και μέσα στην ίδια τη διάταξη.<br><br>Για να καταργήσετε ένα πεδίο από τη διάταξη, σύρετε το πεδίο στον <b>Κάδο ανακύκλωσης</b>. Στη συνέχεια, το πεδίο θα είναι διαθέσιμο στην Εργαλειοθήκη για προσθήκη στη διάταξη.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Υποδεικνύει ένα Εξαρτημένο πεδίο που μπορεί να είναι ή να μην είναι ορατό με βάση την τιμή ενός τύπου.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Υποδεικνύει ένα Υπολογισμένο πεδίο, η τιμή του οποίου θα προσδιορίζεται αυτόματα με βάση έναν τύπο.'
            ,
            //this defualt will be used for edit view
            'default' => 'Η περιοχή <b>Διάταξη</b> περιέχει τα πεδία που εμφανίζονται αυτή τη στιγμή μέσα στην <b>Προβολή επεξεργασίας</b> .<br><br>Η <b>Εργαλειοθήκη</b> περιέχει τον <b>Κάδο ανακύκλωσης</b> και τα πεδία και τα στοιχεία διάταξης που μπορούν να προστεθούν στη διάταξη.<br><br>Κάντε αλλαγές στη διάταξη με μεταφορά και απόθεση στοιχείων και πεδίων μεταξύ της <b>Εργαλειοθήκης</b> και της <b>Διάταξης</b> και μέσα στην ίδια τη διάταξη.<br><br>Για να καταργήσετε ένα πεδίο από τη διάταξη, σύρετε το πεδίο στον <b>Κάδο ανακύκλωσης</b>. Στη συνέχεια, το πεδίο θα είναι διαθέσιμο στην Εργαλειοθήκη για προσθήκη στη διάταξη.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Υποδεικνύει ένα Εξαρτημένο πεδίο που μπορεί να είναι ή να μην είναι ορατό με βάση την τιμή ενός τύπου.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Υποδεικνύει ένα Υπολογισμένο πεδίο, η τιμή του οποίου θα προσδιορίζεται αυτόματα με βάση έναν τύπο.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Προσαρμόστε τις ρυθμίσεις του <b>Χρονολόγιου</b> για τη συγκεκριμένη ενότητα. Ενεργοποιήστε ή απενεργοποιήστε τις ενότητες που εμφανίζονται.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Είστε βέβαιοι ότι θέλετε να διαγράψετε αυτή τη σχέση;<br>Σημείωση: Αυτή η λειτουργία ενδέχεται να διαρκέσει αρκετά λεπτά.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Δημιουργήστε έναν τύπο για να προσδιορίσετε την τιμή σε αυτό το πεδίο.<br>'
        . 'Οι ορισμοί ροής εργασίας που περιέχουν μια ενέργεια και έχουν οριστεί για την ενημέρωση αυτού του πεδίου δεν θα εκτελούν πλέον την ενέργεια.<br>'
        . 'Τα πεδία που χρησιμοποιούν τύπους δεν θα υπολογίζονται σε πραγματικό χρόνο '
        . 'στο Portal Sugar Self-Service ή '
        . 'στις διατάξεις Mobile EditView.',

    'LBL_POPHELP_DEPENDENT' => 'Δημιουργήστε έναν τύπο για να προσδιορίσετε εάν αυτό το πεδίο είναι ορατό σε διατάξεις.<br/>'
        . 'Τα εξαρτημένα πεδία θα ακολουθήσουν τον τύπο εξάρτησης στην προβολή κινητού που βασίζεται στο πρόγραμμα περιήγησης, <br/>'
    ...
    'LBL_POPHELP_READONLY' => 'Δημιουργήστε έναν τύπο για να προσδιορίσετε εάν αυτό το πεδίο είναι μόνο για ανάγνωση σε διατάξεις.<br/>'
        ...
        . 'αλλά δεν θα εφαρμόζουν τον τύπο στις εγγενείς εφαρμογές, όπως το Sugar Mobile για iPhone. <br/>'
        . 'Δεν θα εφαρμόζουν τον τύπο στο Portal Sugar Self-Service.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Επιλέξτε να χρησιμοποιείται αυτό το πεδίο κατά την αναζήτηση εγγραφών με την Καθολική αναζήτηση σε αυτή την ενότητα.',
