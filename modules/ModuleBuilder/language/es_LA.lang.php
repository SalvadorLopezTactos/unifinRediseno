...
$mod_strings = [
    ...
    'layoutDeterminedBy' => [
        'std' => 'Diseño Estándar',
        'role' => 'Rol',
        'dropdown' => 'Campo Desplegable',
    ],
    'LBL_DELETE_CUSTOM_LAYOUTS' => 'Todos los diseños personalizados se eliminarán. ¿Está seguro que desea cambiar las definiciones del diseño actual?',
    'help' => [
        'package' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'El área <b>Diseño</b> contiene los campos que se muestran actualmente en el formulario <b>QuickCreate</b>.<br><br>El formulario QuickCreate aparece en los subpaneles del módulo cuando se pulsa el botón Crear.<br/><br/>La <b>caja de herramientas</b> contiene la <b>papelera de reciclaje</b> y los campos y elementos de diseño que pueden añadirse.<br><br>Realice cambios en el diseño arrastrando y soltando elementos y campos entre la <b>caja de herramientas</b> y el <b>diseño</b> y dentro del propio diseño.<br><br>Para eliminar un campo de diseño, arrástrelo a la <b>papelera de reciclaje</b>. El campo estará disponible en la caja de herramientas para añadirlo al diseño.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica un campo dependiente que puede ser visible o no en función del valor de una fórmula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indica un campo calculado cuyo valor se determinará automáticamente basándose en una fórmula.'
            ,
            //this defualt will be used for edit view
            'default' => 'El área de <b>Diseño</b> contiene los campos que se muestran actualmente en la <b>vista de edición</b>.<br/><br/>La <b>caja de herramientas</b> contiene la <b>papelera de reciclaje</b> y los campos y elementos de diseño que pueden añadirse.<br><br>Realice cambios en el diseño arrastrando y soltando elementos y campos entre la <b>caja de herramientas</b> y el <b>diseño</b> y dentro del propio diseño.<br><br>Para eliminar un campo de diseño, arrástrelo a la <b>papelera de reciclaje</b>. El campo estará disponible en la caja de herramientas para añadirlo al diseño.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica un campo dependiente que puede ser visible o no en función del valor de una fórmula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indica un campo calculado cuyo valor se determinará automáticamente basándose en una fórmula.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Personalice la configuración de la <b>línea de tiempo</b> para este módulo específico. Active o desactive qué módulos se muestran.',
...
//BUTTONS
    ...
    'LBL_BTN_RESTORE_BASE_LAYOUT' => 'Restaurar Diseño Base',
//TABS
...
//ERRORS
    ...
    'ERROR_DATABASE_ROW_SIZE_LIMIT' => 'El campo no se puede crear. Alcanzó el límite del tamaño de filas de esta tabla en su base de datos. <a href="https://support.sugarcrm.com/SmartLinks/Custom/MySQL_Row_Size_Limit/" target="_blank">Más información</a>.',
...
//SUGAR PORTAL
    ...
    'LBL_PORTAL_SHOW_KB_NOTES' => 'Habilitar notas en el módulo Base de Conocimientos',
    ...
    'LBL_PORTAL_USER_PERMISSIONS' => 'Permisos de Usuario',
    ...
    'LBL_CASE_VISIBILITY_HELP' => 'Defina qué usuarios del portal pueden ver un caso.',
    'LBL_EMAIL_VISIBILITY_HELP' => 'Defina qué usuarios del portal pueden ver correos electrónicos relacionados con un caso. Los contactos participantes son aquellos en los campos Para, De, CC y CCO.',
    'LBL_MESSAGE_VISIBILITY_HELP' => 'Defina qué usuarios del portal pueden ver mensajes relacionados con un caso. Los contactos participantes son aquellos en el campo Invitados.',
    'CASE_VISIBILITY_OPTIONS' => [
        'all' => 'Todos los contactos relacionados con la cuenta',
        'related_contacts' => 'Solo el contacto principal y los contactos relacionados con el caso',
    ],
    'EMAIL_VISIBILITY_OPTIONS' => [
        'related_contacts' => 'Solo los contactos participantes',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => '¿Desea eliminar esta relación?<br>Nota: esta operación puede tardar varios minutos en completarse.',
...
//POPUP HELP
    ...
    'LBL_POPHELP_CALCULATED' => 'Cree una fórmula para determinar el valor de este campo.<br>'
        . 'Las definiciones de flujo de trabajo que contengan una acción configurada para actualizar este campo ya no ejecutarán la acción.<br>'
        . 'Los campos que utilicen fórmulas no se calcularán en tiempo real en '
        . 'el portal de autoservicio de Sugar o '
        . 'Los diseños de vista de edición para móviles.',

    'LBL_POPHELP_DEPENDENT' => 'Cree una fórmula para determinar si este campo es visible en los diseños.<br/>'
        . 'Los campos dependientes seguirán la fórmula de dependencia en la vista móvil basada en navegador, <br/>'
        . 'pero no seguirán la fórmula en las aplicaciones nativas, como Sugar Mobile para iPhone. <br/>'
        . 'No seguirán la fórmula del portal de autoservicio de Sugar.',
    'LBL_POPHELP_REQUIRED' => 'Cree una fórmula para determinar si este campo es obligatorio en los diseños.<br/>'
        . 'Los campos requeridos seguirán la fórmula en la vista móvil a través del navegador, <br/>'
        . 'pero no seguirán la fórmula en las aplicaciones nativas, como Sugar Mobile para iPhone. <br/>'
        . 'No seguirán la fórmula del portal de autoservicio de Sugar.',
    ...
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Seleccione esta opción para utilizar este campo al buscar registros mediante la Búsqueda Global en este módulo.',
...
// Edit Labels
    ...
    'LBL_LABEL_NOT_TRANSLATED' => 'Esta etiqueta no se puede traducir',
];
