    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => '<b>版面配置</b>區域包含當前顯示在 <b>QuickCreate</b> 表單中的欄位。<br><br>當點擊「建立」按鈕時，QuickCreate 表單將顯示在模組的子面板中。<br/><br/><b>工具箱</b>包含<b>資源回收筒</b>以及可新增至版面配置的欄位和版面配置元素。<br><br>透過在<b>工具箱</b>和<b>版面配置</b>之間以及版面配置內部拖放元素，可對版面配置進行變更。<br><br>要從版面配置中移除欄位，請將該欄位拖曳到<b>資源回收筒</b>。然後，該欄位將出現在工具箱中，並可新增至版面配置。'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>表示根據公式的值而可見或不可見的相依欄位。<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> 表示其值將根據公式自動確定的計算欄位。'
            ,
            //this defualt will be used for edit view
            'default' => '<b>版面配置</b>區域包含當前顯示在 <b>EditView</b> 中的欄位。<br/><br/><b>工具箱</b>包含<b>資源回收筒</b>以及可新增至版面配置的欄位和版面配置元素。<br><br>透過在<b>工具箱</b>和<b>版面配置</b>之間以及版面配置內部拖放元素，可對版面配置進行變更。<br><br>要從版面配置中移除欄位，請將該欄位拖曳到<b>資源回收筒</b>。然後，該欄位將出現在工具箱中，並可新增至版面配置。'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>表示根據公式的值而可見或不可見的相依欄位。<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> 表示其值將根據公式自動確定的計算欄位。'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => '為此特定模組自訂<b>時間軸</b>設定。啟用或停用顯示的模組。',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => '是否確定要刪除此關係？<br>注意：此操作可能無法在幾分鐘內完成。',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => '建立一個公式來確定此欄位中的值。<br>'
        . '包含設定為更新此欄位的動作的工作流程定義將不再執行該動作。<br>'
        . '使用公式的欄位在以下位置中將不會即時計算：'
        . 'Sugar 自助服務入口網站或 '
        . 'Mobile EditView 版面配置。',

    'LBL_POPHELP_DEPENDENT' => '建立公式以確定該欄位在版面配置中是否可見。<br/>'
        . '相依欄位將遵循基於瀏覽器的行動檢視中的相依性公式，<br/>'
        . '但不會遵循原生應用程式中的公式，比如 iPhone 版 Sugar Mobile。 <br/>'
        . '它們不會遵循 Sugar 自助服務入口網站中的公式。',
    'LBL_POPHELP_REQUIRED' => '建立公式以確定該欄位在版面配置中是否為必填。<br/>'
        . '必填欄位將遵循基於瀏覽器的行動檢視中的公式，<br/>'
        . '但不會遵循原生應用程式中的公式，比如 iPhone 版 Sugar Mobile。 <br/>'
        . '它們不會遵循 Sugar 自助服務入口網站中的公式。',
    'LBL_POPHELP_READONLY' => '建立公式以確定這個欄位在版面配置中是否為唯讀。<br/>'
        ...
        . '它們不會遵循 Sugar 自助服務入口網站中的公式。',
    'LBL_POPHELP_GLOBAL_SEARCH' => '選擇在此模組上使用「全域搜尋」搜尋記錄時使用此欄位。',
