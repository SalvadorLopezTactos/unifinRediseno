    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => '<b>Yerleşim</b> alanı, şu anda <b>Hızlı Oluştur</b> formu içerisinde gösterilen alanları içeriyor.<br><br>Oluştur düğmesine tıklandığında modülün alt panellerinde Hızlı Oluştur formu görüntülenir.<br/><br/><b>Araç Kutusu</b> <b>Çöp Kutusu</b>, alanlar ve yerleşime eklenebilen yerleşim ögelerini içerir.<br><br><b>Araç Kutusu</b> ile <b>Yerleşim</b> arasında ve yerleşimin kendi içerisinde ögeleri ve alanları sürükleyip bırakarak yerleşimde değişiklikler yapın<br><br>Bir alanı yerleşimden kaldırmak için alanı <b>Çöp Kutusuna</b> sürükleyin. Alan, daha sonra Araç Kutusunda yerleşime eklenmek üzere kullanılabilir olacaktır.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Bir formülün değerine bağlı olarak görülebilen veya görülemeyen bir Bağımlı alanı belirtir.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Değeri bir formüle göre otomatik olarak belirlenecek Hesaplanan bir alanı belirtir.'
            ,
            //this defualt will be used for edit view
            'default' => '<b>Yerleşim</b> alanı, <b>Değişiklik Görünümü</b> içinde o anda görüntülenmekte olan alanları içerir.<br/><br/><b>Araç Kutusu</b> <b>Geri Dönüşüm Kutusu</b> ve yerleşime eklenebilecek alanları ve yerleşim ögelerini içerir.<br><br><b>Araç Kutusu</b> ile <b>Yerleşim</b> arasında ve düzenin kendi içinde ögeleri ve alanları sürükleyip bırakarak yerleşimde değişiklikler yapın.<br><br>Bir alanı yerleşimden kaldırmak için alanı <b>Geri Dönüşüm Kutusu</b>&#39;na sürükleyin.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Bir formülün değerine bağlı olarak görülebilen veya görülemeyen bir Bağımlı alanı belirtir.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Değeri bir formüle göre otomatik olarak belirlenecek Hesaplanan bir alanı belirtir.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Bu belirli modül için <b>Zaman Çizelgesi</b> ayarlarını özelleştirin. Hangi modüllerin gösterileceğini etkinleştirin veya devre dışı bırakın.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Bu ilişkiyi silmek istediğinizden emin misiniz?<br>Not: Bu işlem birkaç dakika boyunca tamamlanmayabilir.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Bu alandaki değeri belirlemek için bir formül oluşturun.<br>'
        . 'Bu alanı güncellemek üzere ayarlanmış bir eylem içeren iş akışı tanımları artık eylemi yürütmeyecek.<br>'
        . 'Formül kullanan alanlar Sugar Self-Service Portal veya Mobil  '
        . 'Değişiklik Görünümü yerleşimlerinde '
        . 'gerçek zamanlı olarak hesaplanmayacak.',

    'LBL_POPHELP_DEPENDENT' => 'Bu alanın, yerleşim planlarında görünür olup olmadığını belirlemek için bir formül oluşturun.<br/>'
        . 'Bağımlı alanlar tarayıcı tabanlı mobil görünümde bağımlılık formülüne uyacak <br/>'
    ...
    'LBL_POPHELP_READONLY' => 'Bu alanın, yerleşim planlarında salt okunur olup olmadığını belirlemek için bir formül oluşturun.<br/>'
        ...
        . 'ancak iPhone için Sugar Mobile gibi bağımsız uygulamalardaki formüle uymayacaktır. <br/>'
        . 'Sugar Self-Service Portalındaki formüle uymayacaklar.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Bu modülde Genel Arama&#39;yı kullanarak kayıtları ararken bu alanı kullanmak için seçin.',
