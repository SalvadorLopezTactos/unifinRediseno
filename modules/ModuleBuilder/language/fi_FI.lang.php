    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => '<b>Asettelu</b>-alue sisältää kentät, jotka tällä hetkellä näytetään <b>Pikaluonti</b>-lomakkeessa.<br><br>Pikaluonti-lomake näkyy moduulin alapalkeissa, kun Luo-painiketta napsautetaan.<br/><br/><b>Työkalut</b> sisältää <b>Roskakorin</b> ja kentät ja asetteluelementit, jotka voidaan lisätä asetteluun.<br><br>Tee muutoksia asetteluun vetämällä ja pudottamalla elementtejä ja kenttiä <b>Työkalut</b>- ja <b>Asettelu</b>-osioiden välillä ja itse asettelussa.<br><br>Voit poistaa kentän asettelusta vetämällä kentän <b>Roskakoriin</b>. Kenttä tulee sitten saataville Työkalut-osioon, josta se voidaan lisätä asetteluun.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Näyttää riippuvaisen kentän, joka joko on tai ei ole näkyvissä kaavan arvon perusteella.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Näyttää laskentakentän, jonka arvo määritetään automaattisesti kaavan pohjalta.'
            ,
            //this defualt will be used for edit view
            'default' => '<b>Asettelu</b>-alue sisältää kentät, jotka tällä hetkellä näytetään <b>Muokkausnäkymässä</b>.<br/><br/><b>Työkalut</b> sisältää <b>Roskakorin</b> ja kentät ja asetteluelementit, jotka voidaan lisätä asetteluun.<br><br>Tee muutoksia asetteluun vetämällä ja pudottamalla elementtejä ja kenttiä <b>Työkalut</b>- ja <b>Asettelu</b>-osioiden välillä ja itse asettelussa.<br><br>Voit poistaa kentän asettelusta vetämällä kentän <b>Roskakoriin</b>. Kenttä tulee sitten saataville Työkalut-osioon, josta se voidaan lisätä asetteluun.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Näyttää riippuvaisen kentän, joka joko on tai ei ole näkyvissä kaavan arvon perusteella.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Näyttää laskentakentän, jonka arvo määritetään automaattisesti kaavan pohjalta.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Mukauta <b>Aikajana</b>-asetuksia tälle tietylle moduulille. Näytä tai piilota tiettyjä moduuleja.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Haluatko varmasti poistaa tämän suhteen?<br>Huomautus: Tätä toimintoa ei ehkä suoriteta loppuun useisiin minuutteihin.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Luo kaava tämän kentän arvon määrittämiseksi.<br>'
        . 'Työnkulkumääritykset, jotka sisältävät toiminnon, joka on määritetty päivittämään tämä kenttä, eivät enää suorita toimintoa.<br>'
        . 'Kaavoja käyttäviä kenttiä ei lasketa reaaliajassa '
        . 'Sugarin itsepalveluportaali tai '
        . 'Muokkausnäkymän mobiiliasettelut.',

    'LBL_POPHELP_DEPENDENT' => 'Luo kaava, joka määrittää, näkyykö tämä kenttä asetteluissa.<br/>'
        . 'Riippuvaiset kentät noudattavat riippuvuuskaavaa selainpohjaisessa mobiilinäkymässä, <br/>'
    ...
    'LBL_POPHELP_REQUIRED' => 'Luo kaava, joka määrittää, vaaditaanko tämä kenttä asetteluissa.<br/>'
        . 'Pakolliset kentät noudattavat kaavaa selainpohjaisessa mobiilinäkymässä, <br/>'
        . 'mutta ne eivät noudata alkuperäisissä sovelluksissa, kuten Sugar Mobile iPhone-laitteille, olevaa mallia.<br/>'
        . 'Ne eivät noudata Sugarin itsepalveluportaalissa olevaa mallia.',
    'LBL_POPHELP_READONLY' => 'Luo kaava, joka määrittää, onko tämä kenttä vain luku -muotoinen asetteluissa.<br/>'
        ...
        . 'mutta ne eivät noudata alkuperäisissä sovelluksissa, kuten Sugar Mobile iPhone-laitteille, olevaa mallia.<br/>'
        . 'Ne eivät noudata Sugarin itsepalveluportaalissa olevaa mallia.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Valitse tämä, jos haluat käyttää tätä kenttää, kun etsit tietueita tämän moduulin yleisen haun avulla.',
