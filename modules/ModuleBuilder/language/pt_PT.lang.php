...
$mod_strings = [
    ...
    'LBL_ROLE' => 'Função',
    'LBL_BASE_LAYOUT' => 'Layout base',
    'LBL_FIELD_NAME' => 'Nome de Campo',
    'LBL_FIELD_VALUE' => 'Valor',
    'LBL_LAYOUT_DETERMINED_BY' => 'Layout determinado por:',
    'layoutDeterminedBy' => [
        'std' => 'Layout Standard',
        'role' => 'Função',
        'dropdown' => 'Campo da lista dropdown',
    ],
    'LBL_DELETE_CUSTOM_LAYOUTS' => 'Todos os layouts personalizados serão removidos. Tem a certeza de que deseja alterar as suas definições de layout actuais?',
    'help' => [
        'package' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'A área de <b>Layout</b> contém os campos que são exibidos actualmente no formulário <b>QuickCreate</b>.<br><br>O formulário QuickCreate aparece nos subpainéis do módulo quando clicar no botão Criar.<br/><br/>A <b>Caixa de Ferramentas</b> contém a <b>Reciclagem</b> e os campos e elementos de layout que podem ser adicionados ao layout.<br><br>Faça alterações no layout arrastando e soltando elementos e campos entre a <b>Caixa de Ferramentas</b> e o <b>Layout</b> e dentro do próprio layout.<br><br>Para remover um campo do layout, arraste-o para a <b>Reciclagem</b>. O campo estará disponível na Caixa de Ferramentas para adicionar ao layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica um campo Dependente que pode ou não ser visível em função do valor de uma fórmula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indica um campo Calculado cujo valor será automaticamente determinado com base numa fórmula.'
            ,
            //this defualt will be used for edit view
            'default' => 'A área de <b>Layout</b> contém os campos que são exibidos actualmente no formulário <b>EditView</b>.<br/><br/>A <b>Caixa de Ferramentas</b> contém a <b>Reciclagem</b> e os campos e elementos de layout que podem ser adicionados ao layout.<br><br>Faça alterações no layout arrastando e soltando elementos e campos entre a <b>Caixa de Ferramentas</b> e o <b>Layout</b> e dentro do próprio layout.<br><br>Para remover um campo do layout, arraste-o para a <b>Reciclagem</b>. O campo estará disponível na Caixa de Ferramentas para adicionar ao layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica um campo Dependente que pode ou não ser visível em função do valor de uma fórmula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indica um campo Calculado cujo valor será automaticamente determinado com base numa fórmula.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Personalize as definições da <b>Timeline</b> para este módulo específico. Active ou desactive quais os módulos que são mostrados.',
...
//BUTTONS
    ...
    'LBL_BTN_RESTORE_BASE_LAYOUT' => 'Restaurar o Layout base',
//TABS
...
//ERRORS
    ...
    'ERROR_DATABASE_ROW_SIZE_LIMIT' => 'Não é possível criar o campo. Alcançou o limite do tamanho de filas desta tabela na sua base de dados. <a href="https://support.sugarcrm.com/SmartLinks/Custom/MySQL_Row_Size_Limit/" target="_blank">Más información</a>.',
...
//SUGAR PORTAL
    ...
    'LBL_PORTAL_SHOW_KB_NOTES' => 'Activar notas no módulo Base de Conhecimentos',
    'LBL_PORTAL_ALLOW_CLOSE_CASE' => 'Permitir que utilizadores do portal fechem o caso',
    'LBL_PORTAL_ENABLE_SELF_SIGN_UP' => 'Permitir que se registem novos utilizadores',
    'LBL_PORTAL_USER_PERMISSIONS' => 'Permissões de Utilizador',
    ...
    'LBL_CONFIG_VISIBILITY' => 'Visibilidade',
    'LBL_CASE_VISIBILITY_HELP' => 'Defina em que portal os utilizadores podem ver uma ocorrência.',
    'LBL_EMAIL_VISIBILITY_HELP' => 'Defina em que portal os utilizadores podem ver e-mails relacionados com a ocorrência. Os contactos participantes são os dos campos Para, De, CC e BCC.',
    'LBL_MESSAGE_VISIBILITY_HELP' => 'Defina em que portal os utilizadores podem ver mensagens relacionadas com a ocorrência. Os contactos participantes são os do campo de Convidados.',
    'CASE_VISIBILITY_OPTIONS' => [
        'all' => 'Todos os contactos relacionados com a conta',
        'related_contacts' => 'Apenas o contacto principal e os contactos relacionados com a ocorrência',
    ],
    'EMAIL_VISIBILITY_OPTIONS' => [
        'related_contacts' => 'Apenas os contactos participantes',
        'all' => 'Todos os contactos que podem ver a ocorrência',
    ],
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Tem certeza de que deseja eliminar este relacionamento?<br>Nota: Esta operação pode não ser concluída durante vários minutos.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Crie uma fórmula para determinar o valor neste campo.<br>'
        . 'As definições do fluxo de trabalho que contêm uma acção definida para actualizar este campo já não irão executar a acção.<br>'
        . 'Os campos que usam fórmulas não serão calculados em tempo real em '
        . 'o Portal de Self-Service do Sugar ou '
        . 'Layouts de EditView móvel.',

    'LBL_POPHELP_DEPENDENT' => 'Criar uma fórmula para determinar se este campo é visível em layouts.<br/>'
        . 'Os campos Dependentes irão seguir a fórmula de depnedência na visualização móvel baseada em navegador, <br/>'
        . 'mas não irão seguir a fórmula nas aplicações nativas, como o Sugar Mobile para iPhone. <br/>'
        . 'Não irão seguir a fórmula no Portal de Self-Service do Sugar.',
    'LBL_POPHELP_REQUIRED' => 'Crie uma fórmula para determinar se este campo é obrigatório em layouts.<br/>'
        . 'Os campos obrigatórios irão seguir a fórmula na visualização móvel baseada em navegador, <br/>'
        . 'mas não irão seguir a fórmula nas aplicações nativas, como o Sugar Mobile para iPhone. <br/>'
        . 'Não irão seguir a fórmula no Portal de Self-Service do Sugar.',
    ...
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Seleccione para usar este campo ao pesquisar registos utilizando a Pesquisa Global neste módulo.',
...
// Edit Labels
    'LBL_COMPARISON_LANGUAGE' => 'Idioma de comparação',
    'LBL_LABEL_NOT_TRANSLATED' => 'Este rótulo não deve ser traduzido',
];
