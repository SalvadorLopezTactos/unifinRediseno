    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'Ala <b>Paigutus</b> sisaldab välju, mida kuvatakse praegu <b>Detailvaates</b>.<br/><br/><b>Tööriistakast</b> sisaldab suvandit <b>Prügikast</b> ning välju ja paigutuselemente, mida saab paigutusse lisada.<br><br>Muutke paigutust, pukseerides elemente ja välju suvandite <b>Tööriistakast</b> ja <b>Paigutus</b> vahel ning paigutuses endas.<br><br>Välja eemaldamiseks paigutusest lohistage väli kohta <b>Prügikast</b>. Väli on seejärel suvandis Tööriistakast paigutusse lisamiseks saadaval.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.'
            ,
            'defaultquickcreate' => 'See on <b>Paigutus</b> ala sisaldab välju, mis kuvatakse praegu vormis <b>QuickCreate</b>.<br><br>Vorm QuickCreate kuvatakse mooduli alampaneelides, kui klõpsatakse nuppu Loo.<br/><br/><b>Tööriistakast</b> sisaldab <b>Prügikasti</b> ning välju ja paigutuselemente, mida saab paigutusele lisada.<br><br>Paigutuse muutmiseks lohistage elemente ja välju <b>Tööriistakasti</b> ja <b>Paigutuse</b> vahel ning paigutuse enda sees.<br><br>Välja eemaldamiseks paigutusest lohistage väli <b>Prügikasti</b>. Seejärel on väli saadaval Tööriistakastis paigutusele lisamiseks.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Tähistab sõltuvat välja, mis võib valemi väärtuse põhjal olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Tähistab arvutatud välja, mille väärtus määratakse valemi põhjal automaatselt.'
            ,
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Kohandage <b>Ajaskaala</b> seadeid sellele konkreetsele moodulile. Lubage või keelake, milliseid mooduleid näidatakse.',
...
//CONFIRM
    'LBL_CONFIRM_FIELD_DELETE' => 'Selle kohandatud välja kustutamine kustutab nii kohandatud välja kui ka kõik andmebaasis kohandatud väljaga seotud andmed. Välja ei kuvata enam üheski mooduli paigutuses.'
        ...
        . '\n\nKas soovite jätkata?',
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Kas olete kindel, et soovite selle suhte kustutada?<br>Märkus: see toiming ei pruugi mitu minutit lõppeda.',
...
//POPUP HELP
    ...
    'LBL_POPHELP_CALCULATED' => 'Looge valem selle välja väärtuse määramiseks.<br>'
        . 'Töövoo määratlused, mis sisaldavad toimingut, mis on seatud seda välja värskendama, ei käivita enam toimingut.<br>'
        . 'Valemitega välju ei arvutata reaalajas '
    ...
    'LBL_POPHELP_REQUIRED' => 'Looge valem, et määratleda, kas see väli on paigutustes kohustuslik.<br/>'
        . 'Kohustuslikud väljad järgivad valemit brauseripõhises mobiilivaates, <br/>'
        . 'kuid ei järgi valemit loomulikes rakendustes, nagu Sugar Mobile for iPhone. <br/>'
        . 'Nad ei järgi valemit Sugari iseteenindusportaalis.',
    'LBL_POPHELP_READONLY' => 'Looge valem, et määratleda, kas see väli on paigutustes kirjutuskaitstud.<br/>'
        ...
        . 'kuid ei järgi valemit loomulikes rakendustes, nagu Sugar Mobile for iPhone. <br/>'
        . 'Nad ei järgi valemit Sugari iseteenindusportaalis.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Valige selle välja kasutamine kirjete otsimisel selle mooduli üldotsingu abil.',
