    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => '<b>布局</b>区域包含当前显示在 <b>QuickCreate</b> 表单中的字段。<br><br>点击“创建”按钮后，QuickCreate 表单会出现在模块的子面板中。<br/><br/><b>工具箱</b> 包含<b>回收站</b> 以及可添加到布局中的字段和布局元素。<br><br>通过在<b>工具箱</b>和 <b>布局</b>之间以及布局本身内部拖放元素和字段来更改布局。<br><br>要从布局中删除字段，请将该字段拖到 <b>回收站</b>。然后，该字段就可以在工具箱中添加到布局中。'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>表示根据公式值可能可见或不可见的从属字段。<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" />表示计算字段，其值将根据公式自动确定。'
            ,
            //this defualt will be used for edit view
            'default' => '<b>布局</b>区域包含当前在 <b>EditView</b> 中显示的字段。<br/><br/> <b>工具箱</b> 包含 <b>回收站</b>以及可添加到布局中的字段和布局元素。<br><br>通过在 <b>工具箱</b>和<b>布局</b>之间以及布局本身内部拖放元素和字段来更改布局。<br><br>要从布局中删除字段，请将该字段拖到<b>回收站</b>。然后，该字段就可以在工具箱中添加到布局中。'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>表示根据公式值可能可见或不可见的从属字段。<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" />表示计算字段，其值将根据公式自动确定。'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => '自定义此特定模块的 <b>时间轴</b> 设置。启用或禁用显示的模块。',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => '确定要删除此关系吗？<br>注意：此操作可能需要几分钟才能完成。',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => '创建公式来确定该字段中的值。<br>'
        . '包含操作的工作流程定义如果被设置为更新此字段，将不再执行该操作。<br>'
        . '使用公式的字段将不会在 中实时计算'
        . 'Sugar 自助服务门户网站或 '
        . '移动 EditView 布局。',

    'LBL_POPHELP_DEPENDENT' => '创建公式来确定该字段在布局中是否可见。.<br/>'
        . '在基于浏览器的移动视图中，从属字段将遵循从属公式，<br/>'
        . '但在本地应用程序（如 iPhone 版 Sugar Mobile）中则不遵循公式。<br/>'
        . '它们不会遵循 Sugar 自助服务门户网站中的公式。',
    'LBL_POPHELP_REQUIRED' => '创建公式来确定该字段在布局中是否为必填。<br/>'
        . '必填字段将遵循基于浏览器的移动视图中的公式，<br/>'
        . '但在本地应用程序（如 iPhone 版 Sugar Mobile）中则不遵循公式。<br/>'
        . '它们不会遵循 Sugar 自助服务门户网站中的公式。',
    ...
    'LBL_POPHELP_GLOBAL_SEARCH' => '使用本模块的“全局搜索”搜索记录时，选择使用此字段。',
