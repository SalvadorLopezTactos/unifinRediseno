    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'Hapësira <b>Faqosja</b> përmban fushat e shfaqura aktualisht brenda formularit <b>Krijim i shpejtë</b>.<br><br>Formulari i krijimit të shpejtë shfaqet në nënpanelet e modulit kur klikohet butoni "Krijo".<br/><br/> <b>Kutia e veglave</b> përmban <b>Koshin e mbeturinave</b>, si dhe fushat dhe elementet e faqosjes që mund t&#39;i shtohen faqosjes.<br><br>Bëj ndryshime të faqosjes duke tërhequr dhe lëshuar elementet dhe fushat midis <b>Kutia e veglave</b> dhe <b>Faqosja</b>, si dhe brenda vetë faqosjes.<br><br>Për të hequr një fushë nga faqosja, tërhiq fushën në <b>Koshi i mbeturinave</b>. Më pas, fusha do të jetë e disponueshme në Kutinë e veglave për t&#39;u shtuar në faqosje.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Tregon një fushë të Vvarur që mund të jetë e dukshme ose jo në bazë të vlerës së një formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Tregon një fushë të Lllogaritur, vlera e së cilës do të përcaktohet automatikisht në bazë të një formule.'
            ,
            //this defualt will be used for edit view
            'default' => 'Hapësira <b>Faqosja</b> përmban fushat e shfaqura aktualisht brenda <b>EditView</b>.<br/><br/><b>Kutia e veglave</b> përmban <b>Koshin e mbeturinave</b>, si dhe fushat dhe elementet e faqosjes që mund t&#39;i shtohen faqosjes.<br><br>Bëj ndryshime të faqosjes duke tërhequr dhe lëshuar elementet dhe fushat midis <b>Kutia e veglave</b> dhe <b>Faqosja</b>, si dhe brenda vetë faqosjes.<br><br>Për të hequr një fushë nga faqosja, tërhiq fushën në <b>Koshi i mbeturinave</b>. Më pas, fusha do të jetë e disponueshme në Kutinë e veglave për t&#39;u shtuar në faqosje.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Tregon një fushë të Varur që mund të jetë e dukshme ose jo në bazë të vlerës së një formule.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Tregon një fushë të Llogaritur, vlera e së cilës do të përcaktohet automatikisht në bazë të një formule.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Personalizo cilësimet e <b>Vija kohore</b> për këtë modul specifik. Aktivizo ose çaktivizo modulet që shfaqen.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Je i sigurt që dëshiron të fshish këtë lidhje?<br>Shënim: Mund të nevojiten disa minuta që të përfundojë ky veprim.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Krijo një formulë për të përcaktuar vlerën në këtë fushë.<br>'
        . 'Përcaktimet e rrjedhës së punës që përfshijnë një veprim dhe që janë caktuar për të përditësuar këtë fushë, nuk do ta ekzekutojnë më veprimin.<br>'
        . 'Fushat që përdorin formula nuk do të llogaritën në kohë reale në '
        . 'portalin e vetë-shërbimit të Sugar ose '
        . 'në faqosjet Mobile EditView.',

    'LBL_POPHELP_DEPENDENT' => 'Krijo një formulë për të përcaktuar nëse kjo fushë do të shfaqet në faqosje.<br/>'
        . 'Fushat e varura do të ndjekin formulën e varësisë në pamjen celulare të bazuar në shfletues, <br/>'
        . 'por nuk do të ndjekin formulën në aplikacionet e brendshme, si "Sugar Mobile" për iPhone. <br/>'
        . 'Ato nuk do të ndjekin formulën në portalin e vetëshërbimit të Sugar.',
    'LBL_POPHELP_REQUIRED' => 'Krijo një formulë për të përcaktuar nëse kjo fushë kërkohet në faqosje.<br/>'
    ...
    'LBL_POPHELP_READONLY' => 'Krijo një formulë për të përcaktuar nëse kjo fushë është vetëm për lexim në formate.<br/>'
        ...
        . 'Ato nuk do të ndjekin formulën në portalin e vetëshërbimit të Sugar.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Zgjidh të përdorësh këtë fushë kur kërkon regjistra duke përdorur "Kërkim global" në këtë modul.',
