    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'Oblast <b>Rozvržení</b> obsahuje pole, která jsou aktuálně zobrazena v rámci formuláře <b>Rychlé vytvoření</b>.<br><br>Formulář Rychlé vytvoření se zobrazí v podoknech modulu po kliknutí na tlačítko Vytvořit.<br/><br/>Oblast <b>Panel nástrojů</b> obsahuje <b>Koš</b> a pole a prvky rozvržení, které lze do rozvrženípřidat. <br><br>Změny v rozvržení provedete přetažením prvků a polí mezi <b>Panelem nástrojů</b> a <b>Rozvržením</b> a v samotném rozvržení.<br><br>Chcete-li pole z rozvržení odstranit, přetáhněte je do <b>Koše</b>. Pole pak bude k dispozici v Panelu nástrojů, odkud jej můžete přidat do rozvržení.'
                . '<br/><br/><!--ne_v_motivu!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označuje závislé pole, které může nebo nemusí být viditelné na základě hodnoty vzorce.<br/><!--ne_v_motivu!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočtené pole, jehož hodnota bude automaticky určena na základě vzorce.'
            ,
            //this defualt will be used for edit view
            'default' => 'Oblast <b>Rozvržení</b> obsahuje pole, která jsou aktuálně zobrazena v <b>Zobrazení úprav</b>.<br/><br/>Oblast <b>Panel nástrojů</b> obsahuje <b>Koš</b> a pole a prvky rozvržení, které lze do rozvrženípřidat. <br><br>Změny v rozvržení provedete přetažením prvků a polí mezi <b>Panelem nástrojů</b> a <b>Rozvržením</b> a v samotném rozvržení.<br><br>Chcete-li pole z rozvržení odstranit, přetáhněte je do <b>Koše</b>. Pole pak bude k dispozici v Panelu nástrojů, odkud jej můžete přidat do rozvržení.'
                . '<br/><br/><!--ne_v_motivu!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Označuje závislé pole, které může nebo nemusí být viditelné na základě hodnoty vzorce.<br/><!--ne_v_motivu!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Označuje vypočtené pole, jehož hodnota bude automaticky určena na základě vzorce.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Přizpůsobte nastavení <b>časové osy</b> pro tento konkrétní modul. Povolte nebo zakažte, které moduly se mají zobrazovat.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Opravdu si přejete tento vztah odstranit?<br>Poznámka: Tato operace může trvat několik minut.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Vytvořte vzorec pro určení hodnoty v tomto poli.<br>'
        . 'Definice pracovních postupů obsahujících akci, které jsou nastaveny na aktualizaci tohoto pole, již tuto akci neprovedou.<br>'
        . 'Pole používající vzorce nebudou počítána v reálném čase '
        . 'v samoobslužném portálu Sugar ani '
        . 'v rozvrženích Mobile EditView.',

    'LBL_POPHELP_DEPENDENT' => 'Vytvoří vzorec pro určení, zda je toto pole viditelné v rozvrženích.<br/>'
        . 'Závislá pole se v mobilním zobrazení prohlížeče řídí vzorcem závislosti, <br/>'
        . 'ale nebudou se řídit vzorcem v nativních aplikacích, jako je Sugar Mobile pro iPhone. <br/>'
        . 'Nebudou se řídit vzorcem v samoobslužném portálu Sugar.',
    'LBL_POPHELP_REQUIRED' => 'Vytvořte vzorec pro určení, zda je toto pole v rozvrženích povinné.<br/>'
        . 'Požadovaná pole se v mobilním zobrazení v prohlížeči řídí vzorcem,<br/>'
        . 'ale nebudou se řídit vzorcem v nativních aplikacích, jako je Sugar Mobile pro iPhone. <br/>'
        . 'Nebudou se řídit vzorcem v samoobslužném portálu Sugar.',
    'LBL_POPHELP_READONLY' => 'Vytvořte vzorec pro určení, zda je toto pole v rozvržení určeno pouze pro čtení.<br/>'
        ...
        . 'Nebudou se řídit vzorcem v samoobslužném portálu Sugar.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Vyberte, zda chcete toto pole použít při vyhledávání záznamů pomocí globálního vyhledávání v tomto modulu.',
