    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'האזור <b>תצורה</b> (Layout) מכיל את השדות המופיעים בטופס <b>QuickCreate</b>.<br><br>הטופס QuickCreate מופיע בפאנלי המשנה של המודול בעת לחיצה על לחצן היצירה.<br/><br/>באזור <b>ארגז הכלים</b> (Toolbox) נמצאים <b>סל המיחזור</b> והשדות ורכיבי התצורה שאפשר להוסיף לתצורה.<br><br>כדי לערוך שינויים בתצורה, אפשר לגרור ולשחרר רכיבים ושדות בין האזורים של <b>ארגז הכלים</b> וה<b>תצורה</b> ובתוך התצורה עצמה.<br><br>כדי להסיר שדה מהתצורה, יש לגרור את השדה אל <b>סל המיחזור</b>. לאחר מכן, השדה יהיה זמין בארגז הכלים להוספה לתצורה.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>מציין שדה &#39;תלוי&#39;, אשר גלוי או אינו גלוי, לפי הערך בנוסחה.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> מציין שדה &#39;מחושב&#39;, שערכו ייקבע באופן אוטומטי לפי נוסחה.'
            ,
            //this defualt will be used for edit view
            'default' => 'האזור <b>תצורה</b> (Layout) מכיל את השדות המופיעים בטופס <b>EditView</b>.<br/><br/>באזור <b>ארגז הכלים</b> (Toolbox) נמצאים <b>סל המיחזור</b> והשדות ורכיבי התצורה שאפשר להוסיף לתצורה.<br><br>כדי לערוך שינויים בתצורה, אפשר לגרור ולשחרר רכיבים ושדות בין האזורים של <b>ארגז הכלים</b> וה<b>תצורה</b> ובתוך התצורה עצמה.<br><br>כדי להסיר שדה מהתצורה, יש לגרור את השדה אל <b>סל המיחזור</b>. לאחר מכן, השדה יהיה זמין בארגז הכלים להוספה לתצורה.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>מציין שדה &#39;תלוי&#39;, אשר גלוי או אינו גלוי, לפי הערך בנוסחה.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> מציין שדה &#39;מחושב&#39;, שערכו ייקבע באופן אוטומטי לפי נוסחה.'
            ,
            //this defualt will be used for edit view
...
משתמשים יכולים להזין ערך חדש בשדה או להשתמש בערך ברירת מחדל.<br><br> סמן את תיבת הסימון של <b>עדכון המוני</b> על מנת שתוכל להשתמש בתכונה עדכון המוני עבור השדה.<br><br> ערך <b>הגודל המרבי</b> קובע את מספר התווים המרבי שניתן להזין בשדה. <br><br> סמן את תיבת הסימון של <b>שדה נדרש</b> על מנת להפוך את השדה לשדה חובה. יש להזין ערך עבור השדה כדי לשמור רישום שמכיל אותו.<br><br> סמן את תיבת הסימן של <b>ניתן לדיווח</b> על מנת לאפשר לשדה שימוש במסננים ועבור הצגת נתונים בדו"חות.<br><br> סמן את תיבת הסימון של <b>ביקורת</b> כדי שתוכל לעקוב אחר שינויים בשדה בתיעוד השינויים.<br><br>בחר אפשרות בשדה <b>ניתן לייבוא</b> כדי לאפשר, לדחות או לדרוש את הייבוא של השדה לתוך אשף הייבוא.<br><br>בחר אפשרות בשדה <b>שכפל מיזוג</b> כדי להפעיל או להשבית את התכונות מזג שכפולים ומצא שכפולים.<br><br>ניתן להגדיר ערכים נוספים עבור סוגי נתונים מסוימים.',
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'כאן אפשר להתאים אישית הגדרות <b>ציר זמן</b> למודול ספציפי זה. אפשר להפעיל או להשבית הצגה של מודולים מסוימים.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'בטוח שרוצה למחוק קשר זה?<br>הערה: ייתכן שיידרשו כמה דקות להשלמת הפעולה.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'כאן אפשר ליצור נוסחה כדי לקבוע את הערך בשדה זה.<br>'
        . 'הגדרות זרימת עבודה המכילות פעולה, המוגדרות לעדכן שדה זה, לא יבצעו יותר את הפעולה.<br>'
        . 'שדות המשתמשים בנוסחאות לא יחושבו בזמן אמת ב '
        . 'פורטל השירות העצמי של Sugar או '
        . 'תצורות EditView לנייד.',

    'LBL_POPHELP_DEPENDENT' => 'יש ליצור נוסחה כדי לקבוע אם שדה זה גלוי בתצורות.<br/>'
        . 'שדות תלויים יפעלו לפי הנוסחה של התלות בתצוגת הדפדפן לנייד, <br/>'
        . 'אבל לא לפי הנוסחה באפליקציות המקוריות, למשל Sugar Mobile ל-iPhone. <br/>'
        . 'הם לא יפעלו לפי הנוסחה בפורטל השירות העצמי של Sugar.',
    'LBL_POPHELP_REQUIRED' => 'צור נוסחה כדי לקבוע אם שדה זה הוא שדה חובה בתצורות.<br/>'
        . 'שדות חובה יפעלו לפי הנוסחה בתצוגת הדפדפן בנייד, <br/>'
        . 'אבל לא לפי הנוסחה באפליקציות המקוריות, למשל Sugar Mobile ל-iPhone. <br/>'
        . 'הם לא יפעלו לפי הנוסחה בפורטל השירות העצמי של Sugar.',
    'LBL_POPHELP_READONLY' => 'צור נוסחה כדי לקבוע אם שדה זה מיועד לקריאה בלבד בתצורות.<br/>'
        ...
        . 'אבל לא לפי הנוסחה באפליקציות המקוריות, למשל Sugar Mobile ל-iPhone. <br/>'
        . 'הם לא יפעלו לפי הנוסחה בפורטל השירות העצמי של Sugar.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'אפשר לבחור שדה זה לחיפוש רשומות באמצעות החיפוש הגלובלי במודול זה.',
