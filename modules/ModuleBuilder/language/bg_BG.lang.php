    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'Областта <b>Оформление</b> съдържа полетата, които в момента се показват във формуляра <b>Бързо създаване</b>.<br><br>Формулярът Бързо създаване се появява в подпанелите за модула, когато се натисне бутонът Създаване.<br/><br/><b>Инструменти</b> съдържа <b>Кошче</b> и полетата и елементите на оформлението, които могат да се добавят към оформлението.<br><br>Направете промени в оформлението чрез плъзгане и пускане на елементи и полета между <b>Инструменти</b> и <b>Оформление</b> и в рамките на самото оформление.<br><br>За да премахнете поле от оформлението, плъзнете полето в <b>Кошче</b>. След това полето ще бъде налично в кутията с инструменти, за да се добави към оформлението.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Показва поле Зависимост, което може или не може да бъде видимо въз основа на стойността на формула.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Показва поле Изчислено, чиято стойност ще бъде автоматично определена на базата на формула.'
            ,
            //this defualt will be used for edit view
            'default' => 'Областта <b>Оформление</b> съдържа полетата, които в момента се показват във <b>Редактиране на изглед</b>. <br/><br/><b>Инструменти</b> съдържа <b>Кошче</b> и полетата и елементите на оформлението, които могат да се добавят към оформлението.<br><br>Направете промени в оформлението чрез плъзгане и пускане на елементи и полета между <b>Инструменти</b> и <b>Оформление</b> и в рамките на самото оформление.<br><br>За да премахнете поле от оформлението, плъзнете полето в <b>Кошче</b>. След това полето ще бъде налично в кутията с инструменти, за да се добави към оформлението.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Показва поле Зависимост, което може или не може да бъде видимо въз основа на стойността на формула.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Показва поле Изчислено, чиято стойност ще бъде автоматично определена на базата на формула.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Персонализирате настройките <b>Хронология</b> за този конкретен модул. Разрешете или забранете показваните модули.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Сигурни ли сте, че искате да изтриете тази връзка?<br>Забележка: Това действие може да не завършо за няколко минути.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Създайте формула, за да определите стойността в това поле.<br>'
        . 'Дефинициите на работния поток, съдържащи действие, които са настроени да актуализират това поле, вече няма да изпълняват действието.<br>'
        . 'Полетата, използващи формули, няма да се изчисляват в реално време в '
        . 'портала за самообслъжване наSugar или '
        . 'оформленията Mobile EditView.',

    'LBL_POPHELP_DEPENDENT' => 'Създайте формула, за да определите дали това поле е видимо в оформления.<br/>'
        . 'Полетата Зависимост ще бъдат след формулата в мобилния изглед, базиран на браузър,<br/>'
    ...
    'LBL_POPHELP_REQUIRED' => 'Създайте формула, за да определите дали това поле е задължително в оформленията.<br/>'
        . 'Задължителните полета ще следват формулата в мобилния изглед, базиран на браузър, <br/>'
        . 'но няма да бъдат след формулата в основните приложения като Sugar Mobile за iPhone. <br/>'
        . 'Те няма да бъдат след формулата в портала за самообслужване на Sugar.',
