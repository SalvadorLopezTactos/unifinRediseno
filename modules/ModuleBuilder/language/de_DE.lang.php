    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'Der Bereich <b>Layout</b> enthält die Felder, die aktuell im Formular <b>Schnellerstellung</b> angezeigt werden.<br><br>Das Formular „Schnellerstellung“ wird beim Klicken auf die Schaltfläche „Erstellen“ in den Unterbereichen für das Modul angezeigt.<br/><br/>Die <b>Toolbox</b> enthält den <b>Papierkorb</b> und die Felder und Layoutelemente, die dem Layout hinzugefügt werden können.<br><br>Nehmen Sie Änderungen am Layout vor, indem Sie Elemente und Felder per Drag & Drop zwischen der <b>Toolbox</b> und dem <b>Layout</b> und innerhalb des Layouts selbst verschieben.<br><br>Um ein Feld aus dem Layout zu entfernen, ziehen Sie das Feld auf das Symbol <b>Papierkorb</b>. Das Feld steht dann wieder in der Toolbox zur Verfügung, um es dem Layout hinzuzufügen.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Gibt ein abhängiges Feld an, das basierend auf dem Wert einer Formel sichtbar sein kann oder nicht.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Gibt ein berechnetes Feld an, dessen Wert automatisch auf der Grundlage einer Formel bestimmt wird.'
            ,
            //this defualt will be used for edit view
            'default' => 'Der Bereich <b>Layout</b> enthält die Felder, die aktuell in der <b>Bearbeitungsansicht</b> angezeigt werden.<br/><br/>Die <b>Toolbox</b> enthält den <b>Papierkorb</b> und die Felder und Layoutelemente, die dem Layout hinzugefügt werden können.<br><br>Nehmen Sie Änderungen am Layout vor, indem Sie Elemente und Felder per Drag & Drop zwischen der <b>Toolbox</b> und dem <b>Layout</b> und innerhalb des Layouts selbst verschieben.<br><br>Um ein Feld aus dem Layout zu entfernen, ziehen Sie das Feld auf das Symbol <b>Papierkorb</b>. Das Feld steht dann wieder in der Toolbox zur Verfügung, um es dem Layout hinzuzufügen.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Gibt ein abhängiges Feld an, das basierend auf dem Wert einer Formel sichtbar sein kann oder nicht.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Gibt ein berechnetes Feld an, dessen Wert automatisch auf der Grundlage einer Formel bestimmt wird.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Passen Sie die Einstellungen der <b>Zeitleiste</b> für dieses Modul an. Aktivieren oder deaktivieren Sie, welche Module angezeigt werden.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Möchten Sie diese Beziehung wirklich löschen?<br>Hinweis: Dieser Vorgang kann einige Minuten lang nicht abgeschlossen werden.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Erstellen Sie eine Formel, um den Wert in diesem Feld zu bestimmen.<br>'
        . 'Workflow-Definitionen, die eine Aktion zum Aktualisieren dieses Feld enthalten, führen die Aktion nicht mehr aus.<br>'
        . 'Felder, die Formeln verwenden, werden nicht in Echtzeit im '
        . 'Sugar Self-Service Portal oder in '
        . 'in mobilen Layouts für Bearbeitungsansichten berechnet.',

    'LBL_POPHELP_DEPENDENT' => 'Erstellen Sie eine Formel, um zu bestimmen, ob dieses Feld in Layouts sichtbar ist.<br/>'
        . 'Abhängige Felder folgen zwar der Abhängigkeitsformel in der browserbasierten mobilen Ansicht, <br/>'
    ...
    'LBL_POPHELP_REQUIRED' => 'Erstellen Sie eine Formel, um zu bestimmen, ob dieses Feld in Layouts erforderlich ist.<br/>'
    ...
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Verwenden Sie dieses Feld, wenn Sie mithilfe der globalen Suche in diesem Modul nach Datensätzen suchen.',
