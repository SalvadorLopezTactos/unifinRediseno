    ...
    'help' => [
        ...
        'layoutEditor' => [
            ...
            'defaultquickcreate' => 'L&#39;area <b>Layout</b> contiene i campi attualmente visualizzati all&#39;interno del modulo <b>QuickCreate</b>.<br><br>Il modulo QuickCreate viene visualizzato nei sottopannelli del modulo quando si fa clic sul pulsante Crea.<br/><br/>La <b>casella degli strumenti</b> contiene il <b>cestino</b>, i campi e gli elementi di layout che è possibile aggiungere al layout.<br><br>Effettuare le modifiche al layout trascinando la selezione degli elementi e dei campi tra la <b>casella degli strumenti</b> e il <b>layout</b> e all&#39;interno del layout stesso.<br><br>Per rimuovere un campo dal layout, trascinarlo nel <b>cestino</b>. Il campo sarà quindi disponibile nella casella degli strumenti e potrà essere aggiunto al layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica un campo Dipendente che può essere visibile o meno in base al valore di una formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indica un campo Calcolato il cui valore sarà determinato automaticamente in base a una formula.'
            ,
            //this defualt will be used for edit view
            'default' => 'L&#39;area <b>Layout</b> contiene i campi attualmente visualizzati all&#39;interno di <b>EditView</b>.<br/><br/>La <b>casella degli attrezzi</b> contiene il <b>cestino</b>, i campi e gli elementi di layout che è possibile aggiungere al layout.<br><br>Effettuare le modifiche al layout trascinando la selezione degli elementi e dei campi tra la <b>casella degli strumenti</b> e il <b>layout</b> e all&#39;interno del layout stesso.<br><br>Per rimuovere un campo dal layout, trascinarlo nel <b>cestino</b>. Il campo sarà quindi disponibile nella casella degli strumenti e potrà essere aggiunto al layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica un campo Dipendente che può essere visibile o meno in base al valore di una formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indica un campo Calcolato il cui valore sarà determinato automaticamente in base a una formula.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Personalizzare le impostazioni della <b>sequenza temporale</b> per questo specifico modulo. Abilitare o disabilitare i moduli visualizzati.',
...
//STUDIO2
    ...
    'LBL_TIMELINE' => 'Sequenza temporale',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Eliminare questa relazione?<br>Nota: questa operazione potrebbe completarsi in diversi minuti.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Creare una formula per determinare il valore in questo campo.<br>'
        . 'Le definizioni di flusso di lavoro contenenti un&#39;azione e che sono impostate per aggiornare questo campo non eseguiranno più l&#39;azione.<br>'
        . 'I campi che utilizzano le formule non verranno calcolati in tempo reale nei '
        . 'layout del portale Self-Service Sugar o '
        . 'di Mobile EditView.',

    'LBL_POPHELP_DEPENDENT' => 'Creare una formula per determinare se questo campo è visibile nei layout.<br/>'
        . 'I campi dipendenti seguiranno la formula della dipendenza nella vista mobile basata su browser,<br/>'
    ...
    'LBL_POPHELP_REQUIRED' => 'Creare una formula per determinare se questo campo è obbligatorio nei layout.<br/>'
        . 'I campi obbligatori seguiranno la formula nella vista mobile basata sul browser,<br/>'
        . 'ma non la seguiranno nelle applicazioni native, come Sugar Mobile per iPhone.<br/>'
        . 'Non seguiranno la formula nel portale Sugar Self-Service.',
    'LBL_POPHELP_READONLY' => 'Creare una formula per determinare se questo campo è di sola lettura nei layout.<br/>'
        ...
        . 'ma non la seguiranno nelle applicazioni native, come Sugar Mobile per iPhone.<br/>'
        . 'Non seguiranno la formula nel portale Sugar Self-Service.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Selezionare di usare questo campo durante la ricerca di record utilizzando la ricerca globale in questo modulo.',
