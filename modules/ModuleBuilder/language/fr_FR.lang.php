    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'La zone de <b>mise en page</b> contient les champs qui sont affichés actuellement dans le formulaire de <b>Création rapide</b>.<br><br>Le formulaire de Création rapide apparait dans les sous-panneaux du module lors d&#39;un clic sur le bouton Créer.<br/><br/>La <b>boîte à outils</b> contient la <b>poubelle</b> et les champs et éléments de mise en page pouvant etre ajoutés à la mise en page.<br><br>Apportez des modifications à la mise en page en glissant et déposant des éléments et champs entre la <b>boîte à outils</b> et la <b>mise en page</b> et dans la mise en page elle-même..<br><br>Pour supprimer un champ de la mise en page, glissez le champ dans la <b>poubelle</b>. Le champ sera alors disponible dans la boîte à outils pour être ajouté à la mise en page.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>indique un champ dépendant qui peut être ou ne pas être visible en fonction de la valeur d&#39;une formule .<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> indique un champ calculé dont la valeur sera déterminée automatiquement sur la base d&#39;une formule.'
            ,
            //this defualt will be used for edit view
            'default' => 'La zone de <b>mise en page</b> contient les champs qui sont affichés actuellement dans le <b>EditView</b>.<br/><br/>La <b>boîte à outils</b> contient la <b>poubelle</b> et les champs et éléments de mise en page pouvant etre ajoutés à la mise en page.<br><br>Apportez des modifications à la mise en page en glissant et déposant des éléments et champs entre la <b>boîte à outils</b> et la <b>mise en page</b> et dans la mise en page elle-même.<br><br>Pour supprimer un champ de la mise en page, glissez le champ dans la <b>poubelle</b>. Le champ sera alors disponible dans la boîte à outils pour être ajouté à la mise en page.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>indique un champ dépendant qui peut être ou ne pas être visible en fonction de la valeur d&#39;une formule .<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> indique un champ calculé dont la valeur sera déterminée automatiquement sur la base d&#39;une formule.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Personnaliser les paramètres de la <b>Chronologie</b> pour ce module spécifique. Activer ou désactiver les modules à afficher.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Êtes-vous sûr de vouloir supprimer cette relation ?<br>Remarque : Cette opération peut ne pas se terminer avant plusieurs minutes.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Créer une formule pour dans la valeur dans ce champ.<br>'
        . 'Les définitions de workflow contenant une action qui sont définies pour mettre à jour ce champ n&#39;exécuteront plus l’action.<br>'
        . 'Les champs contenant des formules ne seront pas calculés en temps réel dans  '
        . 'le portail de libre-service de Sugar ou  '
        . 'des mises en page EditView mobiles.',

    'LBL_POPHELP_DEPENDENT' => 'Créer une formule pour déterminer si ce champ est visible dans les mises en page.<br/>'
        . 'Les champs dépendants suivront la formule de dépendance dans la vue mobile basée sur le navigateur,<br/>'
        . 'mais ne suivront pas la formule dans les applications natives, telles que Sugar Mobile pour iPhone.<br/>'
        . 'Ils ne suivront pas la formule dans le portail de libre-service de Sugar.',
    'LBL_POPHELP_REQUIRED' => 'Créer une formule pour déterminer si ce champ est nécessaire dans les mises en page.<br/>'
        . 'Les champs nécessaires suivront la formule de l&#39;affichage mobile du navigateur, <br/>'
        . 'mais ne suivront pas la formule dans les applications natives, telles que Sugar Mobile pour iPhone.<br/>'
        . 'Ils ne suivront pas la formule dans le portail de libre-service de Sugar.',
    ...
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Sélectionnez utiliser ce champ lors de recherches d&#39;enregistrements utilisant la recherche globale dans ce module.',
