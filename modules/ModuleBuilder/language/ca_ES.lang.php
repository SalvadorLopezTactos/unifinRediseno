    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'L&#39;àrea <b>de maquetació</b> conté els camps que es mostren actualment dins del formulari de <b>QuickCreate</b>.<br><br>El formulari QuickCreate apareix als subpanells del mòdul quan es fa clic al botó Crear.<br/><br/>La <b>caixa d&#39;eines</b> conté la <b>paperera de reciclatge</b> i els camps i elements que es poden afegir al disseny.<br><br>Feu canvis a la maquetació arrossegant i deixant anar elements i camps entre les <b>caixes d&#39;eines</b> i el <b>disseny</b> i dins de la maquetació mateixa. Per eliminar unn camp, arrossegueu el camp al botó <b>paperera de reciclatge</b>. El camp estarà disponible a la caixa d&#39;eines per afegir-lo al disseny.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica un camp dependent que es pot mostrar o no en el valor d&#39;una fórmula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indica un camp calculat el alor del qual estarà automàticament determinat segons unas fórmula.'
            ,
            //this defualt will be used for edit view
            'default' => 'L&#39;àrea <b>de maquetació</b> conté els camps que es mostren actualment dins de <b>EditView</b>.<br/><br/>La <b>caixa d&#39;eines</b> conté la <b>paperera de reciclatge</b> i els camps i elements que es poden afegir al disseny.<br><br>Feu canvis a la maquetació arrossegant i deixant anar elements i camps entre les <b>caixes d&#39;eines</b> i el <b>disseny</b> i dins de la maquetació mateixa<br><br>. Per eliminar un camp, arrossegueu el camp al botó <b>paperera de reciclatge</b>. El camp estarà disponible a la caixa d&#39;eines per afegir-lo al disseny.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica un camp dependent que pot ser visible o no en funció del valor d&#39;una fórmula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indica un camp calculat el valor del qual es determinarà automàticament en funció d&#39;una fórmula.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Personalitzar la configuració de la <b>cronologia</b> d&#39;aquest mòdul específic. Activeu o desactiveu quins mòduls es mostren.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Esteu segurs que vols eliminar aquesta relació?<br>Nota: és possible que aquesta operació no es completi fins d&#39;aquí a uns quants minuts.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Creeu una fórmula per determinar el valor d&#39;aquest camp.<br>'
        . 'Les definicions del flux de treball que continguin una acció definida per actualitzar aquest camp ja no executaran l&#39;acció.<br>'
        . 'Els camps que utilitzen fórmules no es calcularan en temps real a '
        . 'el portal d&#39;autoservei de Sugar o '
        . 'Dissenys mòbils d&#39;EditView.',

    'LBL_POPHELP_DEPENDENT' => 'Creeu una fórmula per determinar si aquest camp és visible al disseny.<br/>'
        . 'Els camps dependents seguiran la fórmula de dependència a la visualització mòbil basada en navegador, <br/>'
        . 'però no seguiran la fórmula a les aplicacions natives, com ara Sugar Mobile per a iPhone.<br/>'
        . 'No seguiran la fórmula al portal d&#39;autoservei de Sugar.',
    'LBL_POPHELP_REQUIRED' => 'Creeu una fórmula per determinar si aquest camp és obligatori als dissenys.<br/>'
    ...
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Seleccioneu aquesta opció per utilitzar aquest camp quan cerqueu registres mitjançant la cerca global d&#39;aquest mòdul.',
