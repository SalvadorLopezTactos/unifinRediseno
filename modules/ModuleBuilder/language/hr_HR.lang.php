...
'LBL_CONFIRM_FIELD_DELETE'=>'Brisanjem ovog prilagođenog polja izbrisat će se prilagođeno polje i svi podaci povezani s prilagođenim poljem u bazi podataka. Polje se više neće pojavljivati u izgledima modula.'
        ...
        . '\n\nŽelite li nastaviti?',
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Jeste li sigurni da želite izbrisati ovaj odnos?<br>Napomena: ova operacija možda neće završiti nekoliko minuta.',
...
'LBL_POPHELP_CALCULATED'=>"Stvorite formulu za određivanje vrijednosti u ovom polju.<br>"
   . "Definicije tijeka rada koje sadrže radnju koje su postavljene za ažuriranje ovog polja više neće izvršavati radnju.<br>"
   . "Polja koja koriste formule neće se izračunavati u stvarnom vremenu na "
   . "samoposlužnom Sugar Portalu ili "
   . "mobilnim izgledima prikaza za uređivanje.",

'LBL_POPHELP_DEPENDENT'=>"Stvorite formulu za određivanje je li ovo polje vidljivo u izgledima.<br/>"
        . "Zavisna polja slijedit će formulu zavisnosti u mobilnom prikazu temeljenom na pregledniku, <br/>"
    ...
    'LBL_POPHELP_REQUIRED'=>'Polja koja su uvjetno obavezna nisu dostupna za korištenje u sljedećim vrstama radnji SugarBPM: Dodaj povezani zapis, Promijeni polje. Uklonite tekst "Potrebno ako" da biste upotrijebili ovo polje u ovim radnjama definicije procesa',
...
'LBL_POPHELP_GLOBAL_SEARCH'=>'Odberite ovo polje kada tražite zapise pomoću globalnog pretraživanja na ovom modulu.',
