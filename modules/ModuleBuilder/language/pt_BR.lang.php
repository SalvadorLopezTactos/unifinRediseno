    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'A área <b>Layout</b> contém os campos que são exibidos atualmente no formulário de <b>Criação rápida</b>.<br><br>O formulário de Criação rápida aparece nos subpainéis do módulo quando o botão Criar é clicado.<br/><br/>A <b>Caixa de ferramentas</b> contém a <b>Lixeira</b> e os campos e elementos de layout que podem ser adicionados ao layout.<br><br>Faça alterações no layout arrastando e soltando elementos e campos entre a <b>Caixa de ferramentas</b> e o <b>Layout</b> e dentro do próprio layout.<br><br>Para remover um campo do layout, arraste-o para a <b>Lixeira</b>. O campo será disponibilizado na Caixa de ferramentas para adicionar ao layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica um campo dependente que pode ou não estar visível com base no valor de uma fórmula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indica um campo Calculado cujo valor será determinado automaticamente com base em uma fórmula.'
            ,
            //this defualt will be used for edit view
            'default' => 'A área <b>Layout</b> contém os campos que são exibidos atualmente no formulário de <b>Visualização de edição</b>.<br/><br/>A <b>Caixa de ferramentas</b> contém a <b>Lixeira</b> e os campos e elementos de layout que podem ser adicionados ao layout.<br><br>Faça alterações no layout arrastando e soltando elementos e campos entre a <b>Caixa de ferramentas</b> e o <b>Layout</b> e dentro do próprio layout.<br><br>Para remover um campo do layout, arraste-o para a <b>Lixeira</b>. O campo será disponibilizado na Caixa de ferramentas para adicionar ao layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indica um campo dependente que pode ou não estar visível com base no valor de uma fórmula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indica um campo Calculado cujo valor será determinado automaticamente com base em uma fórmula.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Personalizar configurações de <b>linha do tempo</b> para este módulo específico. Ative e desativos quais módulos serão exibidos.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Tem certeza de que deseja excluir essa relação?<br>Nota: esta operação pode levar vários minutos para ser concluída.',
...
//POPUP HELP
    ...
    'LBL_POPHELP_CALCULATED' => 'Crie uma fórmula para determinar o valor neste campo.<br>'
        . 'As definições de fluxo de trabalho que contêm uma ação definida para atualizar esse campo não executarão mais a ação.<br>'
        . 'Os campos que usam fórmulas não serão calculados em tempo real no '
        . 'Portal de Self-Service da Sugar ou '
        . 'Layouts de visualização de edição móvel.',

    'LBL_POPHELP_DEPENDENT' => 'Criar uma fórmula para determinar se este campo é visível em layouts.<br/>'
        . 'Os campos dependentes seguirão a fórmula de dependência na visualização móvel baseada em navegador, <br/>'
