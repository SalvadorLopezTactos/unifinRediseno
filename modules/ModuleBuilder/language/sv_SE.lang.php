    ...
    'help' => [
        ...
        'layoutEditor' => [
            'defaultdetailview' => 'The <b>Layout</b> area contains the fields that are currently displayed within the <b>DetailView</b>.<br/><br/>The <b>Toolbox</b> contains the <b>Recycle Bin</b> and the fields and layout elements that can be added to the layout.<br><br>Make changes to the layout by dragging and dropping elements and fields between the <b>Toolbox</b> and the <b>Layout</b> and within the layout itself.<br><br>To remove a field from the layout, drag the field to the <b>Recycle Bin</b>. The field will then be available in the Toolbox to add to the layout.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indicates a Dependent field that may or may not be visible based on the value of a formula.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Indicates a Calculated field whose value will be automatically determined based on a formula.'
            ,
            'defaultquickcreate' => 'Området <b>Layout</b> innehåller de fält som för närvarande visas i formuläret <b>QuickCreate</b>.<br><br>Formuläret QuickCreate visas i modulens subpaneler när du klickar på knappen Skapa.<br/><br/><b>Verktygslådan</b> innehåller <b>Papperskorgen</b> samt de fält och layoutelement som kan läggas till i layouten.<br><br>Gör ändringar i layouten genom att dra och släppa element och fält mellan <b>Verktygslådan</b> och <b>Layouten</b> samt i själva layouten.<br><br>Om du vill ta bort ett fält från layouten drar du fältet till <b>Papperskorgen</b>. Då kommer fältet att vara tillgängligt i Verktygslådan och kan läggas till i layouten.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indikerar ett Beroendefält som är eller inte är synligt beroende på värdet i en formel.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" />Indikerar ett Beräkningsfält vars värde bestäms automatiskt baserat på en formel.'
            ,
            //this defualt will be used for edit view
            'default' => 'Området <b>Layout</b> innehåller de fält som för närvarande visas i formuläret <b>EditView</b>.<br/><br/><b>Verktygslådan</b> innehåller <b>Papperskorgen</b> samt de fält och layoutelement som kan läggas till i layouten.<br><br>Gör ändringar i layouten genom att dra och släppa element och fält mellan <b>Verktygslådan</b> och <b>Layouten</b> samt i själva layouten.<br><br>Om du vill ta bort ett fält från layouten drar du fältet till <b>Papperskorgen</b>. Då kommer fältet att vara tillgängligt i Verktygslådan och kan läggas till i layouten.'
                . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Indikerar ett Beroendefält som är eller inte är synligt beroende på värdet i en formel.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" />Indikerar ett Beräkningsfält vars värde bestäms automatiskt baserat på en formel.'
            ,
            //this defualt will be used for edit view
        ...
        'studioWizard' => [
            ...
            'timelineBtn' => 'Anpassa <b>Tidslinjens</b> inställningar för denna specifika modul. Aktivera eller inaktivera vilka moduler som visas.',
...
//CONFIRM
    ...
    'LBL_CONFIRM_RELATIONSHIP_DELETE' => 'Är du säker på att du vill radera denna relation?<br>OBS! Denna åtgärd kan ta flera minuter att slutföra.',
...
//POPUP HELP
    ...
    ,
    'LBL_POPHELP_CALCULATED' => 'Skapa en formel för att bestämma värdet i detta fält.<br>'
        . 'Arbetsflödesdefinitioner som innehåller en åtgärd som ställts in till att uppdatera detta fält kommer inte längre utföra åtgärden.<br>'
        . 'Fält som använder formler kommer inte att beräknas i realtid i '
        . 'Sugar Self-Service-portalen eller '
        . 'mobila EditView-layouter.',

    'LBL_POPHELP_DEPENDENT' => 'Skapa en formel för att avgöra om detta fält är synligt i layouter.<br/>'
        . 'Beroendefält kommer att följa beroendeformeln i den webbläsarbaserade mobila vyn, <br/>'
        . 'men kommer inte att följa formeln i lokala program, såsom Sugar Mobile for iPhone. <br/>'
        . 'De kommer inte att följa formeln i Sugar Self-Service-portalen.',
    ...
    'LBL_POPHELP_READONLY' => 'Skapa en formel för att avgöra om detta fält är skrivskyddat i layouter.<br/>'
        ...
        . 'men kommer inte att följa formeln i lokala applikationer, såsom Sugar Mobile för iPhone. <br/>'
        . 'De kommer inte att följa formeln på Sugar Self-Service-portalen.',
    'LBL_POPHELP_GLOBAL_SEARCH' => 'Välj att använda detta fält när du söker efter poster med hjälp av global sökning i denna modul.',
