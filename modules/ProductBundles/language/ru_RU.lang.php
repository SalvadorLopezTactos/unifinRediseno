...
$mod_strings = array (
    ...
    'LBL_QUOTE_DATA_GROUP_FOOTER' => 'Конец группы',
    ...
    'LBL_EDIT_BUNDLE_BUTTON_TOOLTIP' => 'Изменить имя группы',
    'LBL_DELETE_BUNDLE_BUTTON_TOOLTIP' => 'Удалить группу',
    'LBL_DELETE_GROUP_BUTTON' => 'Удалить Группу',
    'LBL_QUOTE_DATA_EMPTY_ROW_WITH_GROUP' => 'Используйте меню создания со знаком «+», чтобы добавить продукт или комментарий к данной группе.',
    'LBL_QUOTE_DATA_EMPTY_ROW_DEFAULT_GROUP' => 'Используйте меню создания со знаком «+», чтобы добавить продукт, комментарий или группу к данному '
