...
$mod_strings = [
    ...
    'LBL_QUOTE_DATA_GROUP_FOOTER' => 'כותרת תחתונה לקבוצה',
    'LBL_CREATE_QLI_BUTTON_LABEL' => 'הצעת מחיר לשורת פריט',
    ...
    'LBL_EDIT_BUNDLE_BUTTON_TOOLTIP' => 'ערוך את שם הקבוצה',
    'LBL_DELETE_BUNDLE_BUTTON_TOOLTIP' => 'מחק את הקבוצה',
    'LBL_DELETE_GROUP_BUTTON' => 'מחק קבוצה',
    'LBL_QUOTE_DATA_EMPTY_ROW_WITH_GROUP' => 'השתמש בלחצן "+" כדי ליצור שורת פריט או תגובה לקבוצה זו.',
    'LBL_QUOTE_DATA_EMPTY_ROW_DEFAULT_GROUP' => 'השתמש בלחצן "+" כדי ליצור שורת פריט, תגובה או קבוצה להצעת '
        . 'מחיר זו.',
