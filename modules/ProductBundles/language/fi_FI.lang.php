...
$mod_strings = [
    ...
    'LBL_QUOTE_DATA_GROUP_FOOTER' => 'Ryhmän alatunniste',
    ...
    'LBL_EDIT_BUNDLE_BUTTON_TOOLTIP' => 'Muokkaa ryhmän nimeä',
    'LBL_DELETE_BUNDLE_BUTTON_TOOLTIP' => 'Poista ryhmä',
    'LBL_DELETE_GROUP_BUTTON' => 'Poista ryhmä',
    'LBL_QUOTE_DATA_EMPTY_ROW_WITH_GROUP' => 'Lisää tuoterivi tai kommentti tähän ryhmään käyttämällä + luo -valikkoa.',
    'LBL_QUOTE_DATA_EMPTY_ROW_DEFAULT_GROUP' => 'Käytä + luo valikko lisätäksesi tuoterivin, kommentin tai ryhmän tähän '
        . 'Tarjous.',
