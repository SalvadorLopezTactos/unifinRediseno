...
$mod_strings = [
    ...
    'LBL_QUOTE_DATA_GROUP_FOOTER' => 'Gruppfot',
    ...
    'LBL_EDIT_BUNDLE_BUTTON_TOOLTIP' => 'Redigera gruppens namn',
    'LBL_DELETE_BUNDLE_BUTTON_TOOLTIP' => 'Ta bort gruppen',
    'LBL_DELETE_GROUP_BUTTON' => 'Radera grupp',
    'LBL_QUOTE_DATA_EMPTY_ROW_WITH_GROUP' => 'Använd + skapa-menyn för att skapa en radartikel eller en kommentar i den här gruppen.',
    'LBL_QUOTE_DATA_EMPTY_ROW_DEFAULT_GROUP' => 'Använd + skapa-menyn för att skapa en radartikel, kommentar eller grupp i denna '
        . 'Offert.',
