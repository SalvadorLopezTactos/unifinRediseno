...
$mod_strings = [
    ...
    'LBL_QUOTE_DATA_GROUP_FOOTER' => 'Υποσέλιδο Ομάδας',
    ...
    'LBL_EDIT_BUNDLE_BUTTON_TOOLTIP' => 'Επεξεργασία του ονόματος ομάδας',
    'LBL_DELETE_BUNDLE_BUTTON_TOOLTIP' => 'Διαγραφή ομάδας',
    'LBL_DELETE_GROUP_BUTTON' => 'Διαγραφή Ομάδας',
    'LBL_QUOTE_DATA_EMPTY_ROW_WITH_GROUP' => 'Χρήση του + δημιουργία μενού για προσθήκη ενός στοιχείου γραμμής ή σχολίου για αυτήν την ομάδα.',
    'LBL_QUOTE_DATA_EMPTY_ROW_DEFAULT_GROUP' => 'Χρήση του + δημιουργία μενού για προσθήκη ενός στοιχείου γραμμής ή σχολίου ή Χρήση του + δημιουργία μενού για προσθήκη ενός στοιχείου γραμμής, σχολίου ή ομάδας σε αυτή '
        . 'Προσφορά.',
