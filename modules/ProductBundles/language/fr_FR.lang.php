...
$mod_strings = [
    ...
    'LBL_QUOTE_DATA_GROUP_FOOTER' => 'Bas de groupe',
    'LBL_CREATE_QLI_BUTTON_LABEL' => 'Ligne de devis',
    'LBL_CREATE_QLI_BUTTON_TOOLTIP' => 'Créer une ligne de devis',
    'LBL_CREATE_COMMENT_BUTTON_LABEL' => 'Commentaire',
    'LBL_CREATE_COMMENT_BUTTON_TOOLTIP' => 'Créer un commentaire',
    'LBL_EDIT_BUNDLE_BUTTON_TOOLTIP' => 'Éditer le nom du groupe',
    'LBL_DELETE_BUNDLE_BUTTON_TOOLTIP' => 'Supprimer le groupe',
    'LBL_DELETE_GROUP_BUTTON' => 'Supprimer groupe',
    'LBL_QUOTE_DATA_EMPTY_ROW_WITH_GROUP' => 'Utilisez le bouton « + » pour ajouter une ligne de devis ou un commentaire à ce groupe.',
    'LBL_QUOTE_DATA_EMPTY_ROW_DEFAULT_GROUP' => 'Utilisez le menu créer + pour ajouter à ceci une ligne de devis, un commentaire ou un groupe '
        . 'Devis.',
