...
$mod_strings = [
    ...
    'LBL_IMPORT_TEMPLATES_SUCCESS_MESSAGE' => 'Se han importado las plantillas.',
    ...
    'LBL_CUSTOMER_JOURNEY_TEMPLATE_IMPORT_UPDATE_SUCCESS' => 'La plantilla <a href="#{{buildRoute model=this module="DRI_Workflow_Templates"}}">{{name}}</a> se ha actualizado correctamente.',
    'LBL_CUSTOMER_JOURNEY_TEMPLATE_IMPORT_DUPLICATE_NAME_ERROR' => 'Error en la importación. Ya existe una plantilla llamada "<a href="#{{buildRoute model=this module="DRI_Workflow_Templates"}}">{{name}}</a>". Cambie el nombre del registro importado y vuelva a intentarlo, o utilice "Copia" para crear un duplicado de la plantilla de la guía inteligente.',
