...
$mod_strings = [
    ...
    'LBL_TASKS_RECORD_DASHBOARD' => 'Информационная панель записей заданий',
    'LBL_TASKS_FOCUS_DRAWER_DASHBOARD' => 'Фокусная панель для задач',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Временная шкала задачи',
...
2. Нажмите "Сохранить", чтобы завершить создание новой записи и вернуться на предыдущую страницу.',
    ...
    // Sugar Automate
    'LBL_CUSTOMER_JOURNEY_TYPE' => 'Задача умного руководства',
    'LBL_IS_CUSTOMER_JOURNEY_ACTIVITY' => 'Является задачей умного руководства',
    'LBL_CJ_ACTIVITY_START_DATE' => 'Дата начала мероприятия умного руководства',
    'LBL_CJ_ACTIVITY_COMPLETION_DATE' => 'Дата окончания мероприятия умного руководства',
    'LBL_CJ_DAYS_TO_COMPLETE' => 'Умное руководство - Время для завершения в днях',
    'LBL_PARENT_TASK_OF_MEETING_REL' => 'Дочерние встречи',
    'LBL_PARENT_TASK_OF_CALL_REL' => 'Дочерние звонки',
    'LBL_PARENT_TASK_OF_TASK_REL' => 'Дочерние задачи',
    'LBL_AVAILABLE_TASKS' => 'Доступные задачи',
    'LBL_DASHLET_MY_TASKS' => 'Дашлет: мои задачи',
];
