...
$mod_strings = [
    ...
    'LBL_TASKS_RECORD_DASHBOARD' => 'Електронно табло със запис на задачите',
    'LBL_TASKS_FOCUS_DRAWER_DASHBOARD' => 'Чекмедже Фокус на задачи',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Хронология на задачи',
...
2. Натиснете "Съхрани", за да запазите новия запис и да се върнете на предходната страница.',
    ...
    // Sugar Automate
    'LBL_CUSTOMER_JOURNEY_TYPE' => 'Задача на интелигентно ръководство',
    'LBL_IS_CUSTOMER_JOURNEY_ACTIVITY' => 'Е задача на интелигентно ръководство',
    'LBL_CJ_ACTIVITY_START_DATE' => 'Начална дата на активност на интелигентно ръководство',
    'LBL_CJ_ACTIVITY_COMPLETION_DATE' => 'Крайна дата на активност на интелигентно ръководство',
    'LBL_CJ_DAYS_TO_COMPLETE' => 'Интелигентно ръководство - дни до приключване',
    'LBL_PARENT_TASK_OF_MEETING_REL' => 'Срещи на деца',
    'LBL_PARENT_TASK_OF_CALL_REL' => 'Повиквания на деца',
    'LBL_PARENT_TASK_OF_TASK_REL' => 'Задачи на деца',
    'LBL_AVAILABLE_TASKS' => 'Налични задачи',
    'LBL_DASHLET_MY_TASKS' => 'Компонент от таблото: Моите задачи',
];
