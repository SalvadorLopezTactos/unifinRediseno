...
$mod_strings = [
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Χρονολόγιο εργασιών',
...
2. Κάντε κλικ στην επιλογή "Αποθήκευση" για να οριστικοποιήσετε τη νέα εγγραφή και να επιστρέψετε στην προηγούμενη σελίδα.',
    ...
    // Sugar Automate
    'LBL_CUSTOMER_JOURNEY_TYPE' => 'Εργασία Έξυπνου οδηγού',
    'LBL_IS_CUSTOMER_JOURNEY_ACTIVITY' => 'Είναι εργασία Έξυπνου οδηγού',
    'LBL_CJ_ACTIVITY_START_DATE' => 'Ημερομηνία έναρξης δραστηριότητας Έξυπνου οδηγού',
    'LBL_CJ_ACTIVITY_COMPLETION_DATE' => 'Ημερομηνία ολοκλήρωσης δραστηριότητας Έξυπνου οδηγού',
    'LBL_CJ_DAYS_TO_COMPLETE' => 'Έξυπνος οδηγός - Ημέρες για ολοκλήρωση',
    'LBL_PARENT_TASK_OF_MEETING_REL' => 'Θυγατρικές συναντήσεις',
    'LBL_PARENT_TASK_OF_CALL_REL' => 'Θυγατρικές κλήσεις',
    'LBL_PARENT_TASK_OF_TASK_REL' => 'Θυγατρικές εργασίες',
    'LBL_AVAILABLE_TASKS' => 'Διαθέσιμες εργασίες',
    'LBL_DASHLET_MY_TASKS' => 'Πίνακας στοιχείων: Οι εργασίες μου',
];
