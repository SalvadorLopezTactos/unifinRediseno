...
$mod_strings = array (
  ...
  'LBL_ASSIGNED_USER' => 'アサイン先',
    ...
    'LBL_HELP_RECORD' => 'このレコードビューは、個々のレコードだけでなく、それにリンクされたレコードのいくつかの詳細についての十分な情報を提供しています。 - 個々のフィールドまたは「編集」ボタンをクリックして、このレコードのフィールドを編集します。 - 左下のペインに「データビュー」をトグルしてサブパネル内の他のレコードへのリンクを表示または変更してください。 - 左下のペインに「アクティビティストリーム」をトグルすることによってレコードの変更履歴を表示したりユーザコメントを作成してください。 - レコード名の右にあるアイコンを使用して、このレコードをフォローするかお気に入りにしてください。 - 追加のアクションは、「編集」ボタンの右にあるドロップダウンの「操作」メニューにあります。',
