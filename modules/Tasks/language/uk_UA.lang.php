...
$mod_strings = [
    ...
    'LBL_TASKS_RECORD_DASHBOARD' => 'Інформаційна панель записів про задачі',
    'LBL_TASKS_FOCUS_DRAWER_DASHBOARD' => 'Фокусна панель завдань',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Часова шкала задач',
...
2. Натисніть кнопку "Зберегти", щоб завершити створення нового запису й повернутися до попередньої сторінки.',
    ...
    'LBL_AVAILABLE_TASKS' => 'Доступні задачі',
    'LBL_DASHLET_MY_TASKS' => 'Розділ: Мої задачі',
];
