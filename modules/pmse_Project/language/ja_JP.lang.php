...
$mod_strings = array (
  ...
  'LBL_PMSE_BUTTON_OK' => 'OK',
    ...
    'LBL_PMSE_ALL_PROCESS_DEFINITIONS' => 'すべてのプロセス定義',
...
//    'LBL_PMSE_LABEL_DELETED_RECORD'=>'The records related to this Process has been removed',
    ...
    'LBL_PMSE_ADAM_DESIGNER_EXCLUSIVE' => '排他ゲートウェイ',
...
//    'LBL_PMSE_ADAM_DESIGNER_BOUNDARY_EVENT' => 'Boundary Event',
    'LBL_PMSE_ADAM_DESIGNER_EXCLUSIVE_GATEWAY' => '排他ゲートウェイ',
    ...
    'LBL_PMSE_CONTEXT_MENU_USERS' => 'ユーザ',
    ...
    'LBL_PMSE_CONTEXT_MENU_ASSIGN_USER' => 'ユーザをアサイン',
    ...
    'LBL_PMSE_FORM_LABEL_REASSIGN' => '新しいプロセスユーザを選択',

    'LBL_PMSE_FORM_TITLE_USER_DEFINITION' => 'ユーザ定義',
    ...
    'LBL_PMSE_FORM_OPTION_STATIC_ASSIGNMENT' => '静的アサイン',
    'LBL_PMSE_FORM_LABEL_ASSIGN_TO_TEAM' => 'チームへアサイン',
    'LBL_PMSE_FORM_LABEL_ASSIGN_TO_USER' => 'ユーザへアサイン',
    'LBL_PA_FORM_COMBO_ASSIGN_TO_USER_HELP_TEXT' => '選択',
    'LBL_PA_FORM_COMBO_NO_MATCHES_FOUND' => '一致するものが見つかりません',
    'LBL_PA_FORM_LABEL_ASSIGN_TO_TEAM' => 'チームからプロセス ユーザを選択します',
    'LBL_PA_FORM_LABEL_ASSIGN_TO_USER' => 'プロセス ユーザの選択',
    ...
    'LBL_PMSE_FORM_OPTION_CREATED_BY_USER' => 'ユーザにより作成',
    'LBL_PMSE_FORM_OPTION_LAST_MODIFIED_USER' => '最後に変更したユーザ',
    'LBL_PMSE_FORM_OPTION_SYSTEM_EMAIL' => 'システムEメール',

    'LBL_PMSE_FORM_TITLE_BUSINESS_RULE' => 'ビジネスルール',
    'LBL_PMSE_LABEL_RULE' => 'ルール',

    'LBL_PMSE_FORM_TITLE_ASSIGN_USER' => 'ユーザをアサイン',
    ...
    'LBL_PMSE_CONTEXT_MENU_EXCLUSIVE_GATEWAY' => '排他ゲートウェイ',
    'LBL_PMSE_CONTEXT_MENU_PARELLEL_GATEWAY' => '並列ゲートウェイ',
    'LBL_PMSE_CONTEXT_MENU_INCLUSIVE_GATEWAY' => '包括ゲートウェイ',
    ...
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_TITLE' => 'ユーザ評価',
    ...
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_USER' => 'は、ユーザの',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_USER_FULL' => '%TARGET% は、ユーザの %VALUE% です',
    ...
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_USER' => 'は、ユーザの次ではありません',
    'LBL_PMSE_EXPCONTROL_USER_EVALUATION_IS_NOT_USER_FULL' => '%TARGET% は、ユーザの %VALUE% ではありません',
    ...
    'LBL_PMSE_EMAILPICKER_USER_CREATED' => '%MODULE%を作成したユーザ',
    'LBL_PMSE_EMAILPICKER_USER_LAST_MODIFIED' => '%MODULE%を最後に変更したユーザ',
    'LBL_PMSE_EMAILPICKER_USER_IS_ASSIGNED' => '%MODULE%にアサインされているユーザ',
    'LBL_PMSE_EMAILPICKER_USER_WAS_ASSIGNED' => '%MODULE%にアサインされていたユーザ',
    'LBL_PMSE_EMAILPICKER_MANAGER_CREATED' => '%MODULE%を作成したマネージャ',
    'LBL_PMSE_EMAILPICKER_MANAGER_LAST_MODIFIED' => '%MODULE%を最後に変更したマネージャ',
    'LBL_PMSE_EMAILPICKER_MANAGER_IS_ASSIGNED' => '%MODULE%にアサインされているマネージャ',
    'LBL_PMSE_EMAILPICKER_MANAGER_WAS_ASSIGNED' => '%MODULE%にアサインされていたマネージャ',
    ...
    'LBL_PMSE_ERROR_DATA_NOT_FOUND_INFO' => 'この要素の設定は、データベースに存在しないデータの特定の部分を参照します。要素の設定をチェックして、参照されているすべてのデータ (すなわち特定のユーザ、モジュール フィールド、チームなど) が存在することを確認します。',
