...
if (ACLController::checkAccess('Contracts', 'edit', true)) {
    $module_menu[] = ['index.php?module=Contracts&action=EditView&return_module=Contracts&return_action=DetailView', $mod_strings['LNK_NEW_CONTRACT'], 'CreateContracts'];
}

if (ACLController::checkAccess('Contracts', 'list', true)) {
    $module_menu[] = ['index.php?module=Contracts&action=index', $mod_strings['LNK_CONTRACT_LIST'], 'Contracts'];
}
