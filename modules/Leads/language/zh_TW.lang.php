...
在確定每個必要和必須的模組後，按一下頂部的「儲存並轉換」按鈕，完成轉換。',
    ...
    'LBL_AI_CONVRATE' => '轉化率',
    'LBL_AI_CONVLEADS' => '已轉化潛在客戶',
    'LBL_AI_LEADVELOCITY' => '轉化時間（潛在客戶更迭速度）',
    'LBL_AI_LEADTIMESPAN' => '潛在客戶建立和轉化之間的時間',
    ...
    //Filters 14.0
    'LBL_LIST_MQL_LEADS' => 'MQL 線索客戶',
    'LBL_LIST_NEW_MQL_LEADS' => '新 MQL 線索客戶',
    'LBL_LIST_SQL_LEADS' => 'SQL 線索客戶',
    'LBL_LIST_TODAY_LEADS' => '今天的新線索客戶',
];
