...
След като потвърдите създаване на всеки от модулите, които да бъдат създадени, натиснете бутона „Запази и преобразувай“, за да приключите процеса на преобразуване.',
    ...
    'LBL_AI_CONVRATE' => 'Степен на преобразуване',
    'LBL_AI_CONVLEADS' => 'Преобразувани потенциални клиенти',
    'LBL_AI_LEADVELOCITY' => 'Време на преобразуване (скорост на потенциални клиенти)',
    'LBL_AI_LEADTIMESPAN' => 'Време между създаването и преобразуването на потенциални клиенти',
    ...
    //Filters 14.0
    'LBL_LIST_MQL_LEADS' => 'MQL потенциални клиенти',
    'LBL_LIST_NEW_MQL_LEADS' => 'Нови MQL потенциални клиенти',
    'LBL_LIST_SQL_LEADS' => 'SQL потенциални клиенти',
    'LBL_LIST_TODAY_LEADS' => 'Днешните нови потенциални клиенти',
];
