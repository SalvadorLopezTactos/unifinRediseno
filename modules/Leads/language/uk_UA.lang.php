...
Після затвердження обов&#39;язкового і бажаного модуля, натисніть Зберегти і Конвертувати, щоб завершити перетворення.',
    ...
    'LBL_AI_CONVRATE' => 'Конверсійна ставка',
    'LBL_AI_CONVLEADS' => 'Конвертовані попередні контакти',
    'LBL_AI_LEADVELOCITY' => 'Час конверсії (швидкість попереднього контакту)',
    'LBL_AI_LEADTIMESPAN' => 'Час між створенням і конверсією попередніх контактів',
    ...
    //Filters 14.0
    'LBL_LIST_MQL_LEADS' => 'Інтереси кваліфікованих потенційних клієнтів (MQL)',
    'LBL_LIST_NEW_MQL_LEADS' => 'Нові інтереси MQL',
    'LBL_LIST_SQL_LEADS' => 'Інтереси перспективних клієнтів для прямого продажу (SQL)',
    'LBL_LIST_TODAY_LEADS' => 'Нові інтереси за сьогоднішній день',
];
