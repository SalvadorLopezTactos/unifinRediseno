...
После утверждения обязательного и желаемого модуля, нажмите Сохранить и Конвертировать, чтобы завершить преобразование.',
    ...
    'LBL_AI_CONVRATE' => 'Курс обмена',
    'LBL_AI_CONVLEADS' => 'Сконвертированные предварительные контакты',
    'LBL_AI_LEADVELOCITY' => 'Время конверсии (скорость предварительного контакта)',
    'LBL_AI_LEADTIMESPAN' => 'Время между созданием предварительного контакта и его конверсией',
    ...
    //Filters 14.0
    'LBL_LIST_MQL_LEADS' => 'Потенциальные клиенты MQL',
    'LBL_LIST_NEW_MQL_LEADS' => 'Новые потенциальные клиенты MQL',
    'LBL_LIST_SQL_LEADS' => 'Потенциальные клиенты SQL',
    'LBL_LIST_TODAY_LEADS' => 'Сегодняшние новые предварительные контакты',
];
