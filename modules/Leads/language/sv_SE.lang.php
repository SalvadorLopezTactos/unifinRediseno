...
$mod_strings = [
    ...
    'LBL_MARKET_INTEREST_PREDICTION' => 'Prognos marknadsränta',
    'LBL_MARKET_SCORE' => 'Marknadspoäng',
...
2. Klicka på "Spara" för att spara den nya posten och återgå till föregående sida.',
    ...
    'LBL_AI_CONVRATE' => 'Konverteringstakt',
    'LBL_AI_CONVLEADS' => 'Konverterade lead',
    'LBL_AI_LEADVELOCITY' => 'Konverteringstid (lead-hastighet)',
    'LBL_AI_LEADTIMESPAN' => 'Tid mellan skapande och konvertering av lead',

    // Admin convert lead layout
    'LBL_ENABLE_RLIS' => 'Aktivera intäktsposter',
    'LBL_REQUIRE_RLIS' => 'Kräv intäktsposter när en ny möjlighet skapas',
    'LBL_COPY_DATA_RLIS' => 'Kopiera Leaduppgifter till Intäktsposterna när en ny Möjlighet skapas',

    //Filters 14.0
    'LBL_LIST_MQL_LEADS' => 'MQL-leads',
    'LBL_LIST_NEW_MQL_LEADS' => 'Nya MQL-leads',
    'LBL_LIST_SQL_LEADS' => 'SQL-leads',
    'LBL_LIST_TODAY_LEADS' => 'Dagens nya leads',
];
