...
必要なモジュールを確認した後、上部にある [保存して変換] ボタンをクリックし、変換を確定します。',
    ...
    'LBL_AI_CONVRATE' => 'コンバージョン率',
    'LBL_AI_CONVLEADS' => 'コンバート済みリード',
    'LBL_AI_LEADVELOCITY' => 'コンバージョン時間（リードの速度）',
    'LBL_AI_LEADTIMESPAN' => 'リードの作成からコンバージョンまでの時間',
    ...
    //Filters 14.0
    'LBL_LIST_MQL_LEADS' => 'MQLリード',
    'LBL_LIST_NEW_MQL_LEADS' => '新しいMQLリード',
    'LBL_LIST_SQL_LEADS' => 'SQLリード',
    'LBL_LIST_TODAY_LEADS' => '今日の新しいリード',
];
