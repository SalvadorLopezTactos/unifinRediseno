...
$mod_strings = [
    ...
    'LBL_MARKET_SCORE' => 'Puntuación del mercado',
...
Tras confirmar cada módulo necesario y deseado, haga clic en el botón Guardar y Convertir en la parte superior para finalizar la conversión.',
    ...
    // AI Predict
    'LBL_AI_LEADS_CONVERSION_PREDICTION_NAME' => 'Predicción de conversión del cliente potencial',
    'LBL_AI_LEADS_CONVERSION_PREDICTION_DESC' => 'Ver los detalles de la predicción para un cliente potencial específico',
    'LBL_AI_CONVRATE' => 'Cambio',
    'LBL_AI_CONVLEADS' => 'Clientes potenciales convertidos',
    'LBL_AI_LEADVELOCITY' => 'Tiempo de conversión (velocidad de clientes)',
    'LBL_AI_LEADTIMESPAN' => 'Tiempo entre la creación y la conversión de clientes potenciales',

    // Admin convert lead layout
    'LBL_ENABLE_RLIS' => 'Habilitar partidas de ingresos',
    'LBL_REQUIRE_RLIS' => 'Se requieren las partidas de ingresos al crear una nueva oportunidad',
    'LBL_COPY_DATA_RLIS' => 'Copiar los datos del cliente potencial en las partidas de ingresos al crear una nueva oportunidad',

    //Filters 14.0
    'LBL_LIST_MQL_LEADS' => 'Clientes potenciales de MQL',
    'LBL_LIST_NEW_MQL_LEADS' => 'Nuevos clientes potenciales de MQL',
    'LBL_LIST_SQL_LEADS' => 'Clientes potenciales de SQL',
    'LBL_LIST_TODAY_LEADS' => 'Nuevos clientes potenciales de hoy',
];
