...
$mod_strings = array (
    ...
    'EXCEPTION_QUOTE_ALREADY_CONVERTED' => '既に商談に変更された見積',
    'LBL_QUOTE_HEADER_TOTALS' => '見積ヘッダ合計',
    'LBL_QUOTE_DATA_GRAND_TOTALS_HEADER' => '見積データ総合計ヘッダ',
    'LBL_QUOTE_DATA_GRAND_TOTALS_FOOTER' => '見積データ総合計フッタ',
    'LBL_CREATE_QLI_BUTTON_LABEL' => '見積品目',
    'LBL_CREATE_QLI_BUTTON_TOOLTIP' => '見積済み商品の作成',
    ...
    'LBL_COPY_LINE_ITEMS' => 'この見積をコピーする前に、各商品の隣のチェックマークをクリックすることにより、アクティブな商品を保存してください。',
    'LBL_SEARCH_CATALOG_PLACEHOLDER' => '製品カタログを検索',
    'LBL_NO_PRODUCT_CATALOG_RESULTS' => '利用可能なデータがありません',
    'LBL_QUOTE_COPY_ALERT_MESSAGE' => '見積品目を新しい見積にコピー中です。',
    'LBL_QUOTE_COPY_ALERT_MESSAGE_LONG_TIME' => '見積品目を新しい見積にコピー中です。この処理には時間がかかることがあります。',
    'LBL_QUOTE_CONFIG_COLUMNS_TITLE' => 'Worksheet Columns',
    'LBL_QUOTE_CONFIG_SUMMARY_TITLE' => 'サマリバーのヘッダ',
    'LBL_QUOTE_CONFIG_FOOTER_TITLE' => '総計のフッタ',
    ...
    'LBL_CONFIG_SUMMARY_COLUMNS_DIRECTIONS_1' => 'デフォルトでは、サマリバーのヘッダに次のフィールドが表示されます：',
    ...
    'LBL_CONFIG_LEGEND_HELP_TEXT' => '関連するフィールドはページの他のフィールドによって使用されており、ユーザに表示されません。' .
        '表示される計算後のフィールドについては、フィールドが数式に含まれている場合、関連しているフィールドとして自動的にマークされます。' .
        'ボックスにチェックを入れれば関連するフィールドをユーザが利用できるようにすることができますが、それを使用するフィールドを削除しない限り、関連するフィールドを削除することができません。',
    'LBL_CONFIG_' => '',
    'LBL_CONFIG_TOOLTIP_FIELD_REQUIRED_BY' => 'This field is required by:',
    'LBL_SUMMARY_WORKSHEET_COLUMNS_PREVIEW' =>'サマリバーのヘッダのプレビュー',
    'LBL_SUMMARY_WORKSHEET_COLUMNS_MAX_WARNING' =>'サマリバーには6件のフィールドしか表示できません。一部のフィールドを削除してから追加してください。',

    'LBL_CONFIG_GRAND_TOTAL_FOOTER_PREVIEW' =>'総計のフッタのプレビュー',
    'LBL_CONFIG_GRAND_TOTAL_FOOTER_DIRECTIONS_1' => 'デフォルトでは、総計のフッタに次のフィールドが表示されます：',
