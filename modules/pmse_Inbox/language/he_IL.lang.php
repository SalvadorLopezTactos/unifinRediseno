...
$mod_strings = [
    ...
    'LBL_PMSE_HISTORY_LOG_NOTFOUND_USER' => "לא ידוע (לפי מזהה משתמש:'%s')",
    ...
    'LBL_PMSE_ACTIVITY_STREAM_REJECT' => '&0 ב-<strong>%s</strong> נדחה ',
    'LBL_PMSE_ACTIVITY_STREAM_ROUTE' => '&0 ב-<strong>%s</strong> מנותב ',
    'LBL_PMSE_ACTIVITY_STREAM_CLAIM' => '&0 ב-<strong>%s</strong> נדרש ',
    'LBL_PMSE_ACTIVITY_STREAM_REASSIGN' => '&0 ב-<strong>%s</strong> הוקצה למשתמש &1 ',
