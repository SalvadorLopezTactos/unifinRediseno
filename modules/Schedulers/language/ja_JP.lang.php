...
'LBL_OOTB_KBSCONTENT_EXPIRE' => '承認された記事を公開し、記事を期限切れにします。',
'LBL_OOTB_PROCESS_AUTHOR_JOB' => ' スケジュール済みジョブ',
'LBL_OOTB_TEAM_SECURITY_DENORM_REBUILD' => '非正規チームのセキュリティ データを再構築',
'LBL_OOTB_ACTIVITY_STREAM_PURGER' => 'アクティビティストリームパージャー',
...
'LBL_WARN_CURL' => '警告:',
'LBL_WARN_NO_CURL' => 'このシステムはcURLライブラリが有効になっていないか、PHPモジュールにコンパイルされていません(--with-curl=/path/to/curl_library)。この問題を解決するためにはシステム管理者にお問い合わせください。cURLライブラリがないとスケジューラーはジョブを実行できません。',
...
'LBL_SUGARJOBKBCONTENTUPDATEARTICLES' => '承認された記事を公開し、記事を期限切れにします。',
'LBL__SUGARCRM_SUGARCRM_ELASTICSEARCH_QUEUE_SCHEDULER' => 'Elasticsearch キュー スケジューラー',
...
'LBL_ASYNCMASSUPDATE' => '非同期一括更新を実行',
