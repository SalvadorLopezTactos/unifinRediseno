...
// OOTB Scheduler Job Names:
    ...
    'LBL_OOTB_LICENSE_INSTALLER' => 'Применить права на использование подписки после их изменения',
...
// Labels
    ...
    'LBL_UPDATEMOMENTUMCJ' => 'Обновить импульс выполняемых умных руководств',
// Links
