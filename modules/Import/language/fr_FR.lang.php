...
$mod_strings = [
    ...
    'LBL_SYNC_KEY_EXISTS_ALREADY' => 'SYNC_KEY existe déjà dans cette table',
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => 'Enregistrement non ajouté. Les nouveaux utilisateurs doivent être ajoutés dans les paramètres du SugarCloud',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => 'Pour créer de nouveaux enregistrements, accédez aux <a href="{0}" target="_blank">Paramètres du SugarCloud</a>.',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => 'Pour mettre à jour les enregistrements existants, sélectionnez un fichier sur votre ordinateur qui contient les données que vous souhaitez importer.',
