...
$mod_strings = [
    ...
    'LBL_SYNC_KEY_EXISTS_ALREADY' => 'SYNC_KEY existiert bereits in der Tabelle',
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => 'Datensatz nicht hinzugefügt. Neue Benutzer müssen in den SugarCloud-Einstellungen hinzugefügt werden',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => 'Um neue Datensätze zu erstellen, gehen Sie zu den <a href="{0}" target="_blank">SugarCloud-Einstellungen</a>.',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => 'Um vorhandene Datensätze zu aktualisieren, wählen Sie auf Ihrem Computer eine Datei aus, die die Daten enthält, die Sie importieren möchten.',
