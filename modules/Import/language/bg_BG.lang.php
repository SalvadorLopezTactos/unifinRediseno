...
$mod_strings = [
    ...
    'LBL_SYNC_KEY_EXISTS_ALREADY' => 'SYNC_KEY вече съществува в тази таблица',
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => 'Записът не е добавен. Нови потребители трябва да се добавят в настройките на SugarCloud',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => 'За да създавате нови записи, отидете на <a href="{0}" target="_blank">Настройки на SugarCloud</a>.',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => 'За да актуализирате съществуващи записи, изберете файл на компютъра си, който съдържа данните, които бихте желали да импортирате.',
