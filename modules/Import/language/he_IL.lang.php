...
$mod_strings = [
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => 'הרשומה לא נוספה. יש להוסיף משתמשים חדשים בהגדרות SugarCloud',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => 'כדי ליצור רשומות חדשות, גש אל <a href="{0}" target="_blank">הגדרות SugarCloud</a>.',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => 'כדי לעדכן רשומות קיימות, בחר קובץ במחשב שכולל את הנתונים שברצונך לייבא.',
