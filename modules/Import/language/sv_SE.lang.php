...
$mod_strings = [
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => 'Posten har inte lagts till. Nya användare måste läggas till i Inställningar för SugarCloud',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => 'För att skapa nya poster ska du öppna <a href="{0}" target="_blank">Inställningar för SugarCloud</a>.',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => 'För att uppdatera befintliga poster ska du markera en fil på datorn som innehåller data som du vill importera.',
