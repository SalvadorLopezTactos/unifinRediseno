...
$mod_strings = [
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => 'Nie dodano rekordu. Nowych użytkowników należy dodawać w obszarze Ustawienia SugarCloud',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => 'Aby utworzyć nowe rekordy, uzyskaj dostęp do obszaru <a href="{0}" target="_blank">Ustawienia SugarCloud</a>.',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => 'Aby zaktualizować istniejące rekordy, na komputerze wybierz plik zawierający dane do zaimportowania.',
