...
$mod_strings = [
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => 'レコードは追加されていません。新規ユーザーをSugarCloud設定内に追加する必要があります',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => '新規レコードを作成するには、<a href="{0}" target="_blank">SugarCloud設定</a>にアクセスしてください。',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => '既存のレコードを更新するには、インポートしたいデータを含んでいるお使いのコンピュータ上のファイルを選択します。',
