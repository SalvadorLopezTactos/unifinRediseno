...
$mod_strings = array (
    ...
    'LBL_MY_SAVED_ADMIN_HELP' => 'インポートプロパティ、マッピング、重複チェックを含むプリセットのインポート設定をこのインポートに適用する場合はこのオプションを使用してください。<br><br>他のユーザがこのマッピングを利用できるようにするには<b>公開</b>をクリックしてください。<br>他のユーザがこのマッピングを利用できないようにするには<b>非公開</b> をクリックしてください。<br>すべてのユーザからマッピングを削除するには<b>削除</b>をクリックしてください。',
    ...
    'LBL_RECORD_CANNOT_BE_UPDATED' => '権限がないため、レコードを更新できません。',
