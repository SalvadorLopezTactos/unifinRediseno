...
$mod_strings = [
    ...
    'LBL_SYNC_KEY_EXISTS_ALREADY' => 'Το SYNC_KEY υπάρχει ήδη σε συτόν τον πίνακα',
    ...
    'LBL_IMPORT_MODULE_ERROR_LARGE_FILE_END' => 'Bytes. Αλλαγή $sugar_config[&#39;upload_maxsize&#39;] στο config.php',
    ...
    'LBL_DUPLICATE_CHECK_OPERATOR' => 'Ελέγξτε για διπλότυπα χρησιμοποιώντας τον τελεστή:',
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => 'Η εγγραφή δεν προστέθηκε. Οι νέοι χρήστες πρέπει να προστεθούν στις ρυθμίσεις SugarCloud',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => 'Για να δημιουργήσετε νέες εγγραφές, μπείτε στο <a href="{0}" target="_blank">Ρυθμίσεις SugarCloud</a>.',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => 'Για να ενημερώσετε τις υπάρχουσες εγγραφές, επιλέξτε ένα αρχείο στον υπολογιστή σας που περιέχει τα δεδομένα που θέλετε να εισαγάγετε.',
