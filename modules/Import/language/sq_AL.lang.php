...
$mod_strings = [
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => 'Regjistrimi nuk u shtua. Përdoruesit e rinj duhet të shtohen te "Cilësimet e SugarCloud"',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => 'Për të krijuar regjistrime të reja, hap <a href="{0}" target="_blank">Cilësimet e SugarCloud</a>.',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => 'Për të përditësuar regjistrimet ekzistuese, zgjidh një skedar në kompjuterin tënd që përmban të dhënat që dëshiron të importosh.',
