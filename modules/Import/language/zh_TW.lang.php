...
$mod_strings = [
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => '未添加紀錄。必須在 SugarCloud設置中添加新用戶',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => '要建立新紀錄，請訪問 <a href="{0}" target="_blank">SugarCloud 設置</a>.',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => '要更新現有紀錄，請在您的電腦上選擇一個包含要導入數據的文件。',
