...
$mod_strings = [
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => 'Tietuetta ei lisätty. Uudet käyttäjät täytyy lisätä SugarCloud-asetuksista.',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => 'Jos haluat luoda uusia tietueita, siirry <a href="{0}" target="_blank">SugarCloud-asetuksiin</a>.',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => 'Jos haluat päivittää nykyisiä tietueita, valitse tiedosto tietokoneeltasi, joka sisältää tuotavat tiedot.',
