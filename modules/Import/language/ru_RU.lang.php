...
$mod_strings = [
    ...
    'LBL_SYNC_KEY_EXISTS_ALREADY' => 'SYNC_KEY уже присутствует в этой таблице',
    ...
    'LBL_DUPLICATE_CHECK_OPERATOR' => 'Проверить на наличие дубликатов с помощью оператора:',
    ...
    'LBL_IDM_RECORD_CANNOT_BE_CREATED' => 'Запись не добавлена. Новых пользователей нужно добавлять в Настройках SugarCloud',
    ...
    'LBL_SELECT_IDM_CREATE_INSTRUCTION' => 'Чтобы создать новые записи, перейдите в <a href="{0}" target="_blank">Наcтройки SugarCloud</a>.',
    'LBL_SELECT_IDM_UPLOAD_INSTRUCTION' => 'Чтобы обновить имеющиеся записи, выберите на компьютере файл с данными, которые нужно импортировать.',
