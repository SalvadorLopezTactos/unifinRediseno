...
$mod_strings = [
    ...
    'LBL_FILTER_DOMAINS_DESC' => '자동 회신 이메일이 전송되지 않을 도메인을 쉼표로 구분한 목록입니다.',
    ...
    'LBL_FILTER_DOMAINS' => '이 도메인에 자동 답장기능이 없습니다.',
    ...
    'LBL_DELETED_FOLDERS_LIST' => '다음 폴더 %s이(가) 존재하지 않거나 서버에서 삭제되었습니다.',
    'LBL_PORT' => '메일 서버포트',
    'LBL_QUEUE' => '대기중 메일 계정',
