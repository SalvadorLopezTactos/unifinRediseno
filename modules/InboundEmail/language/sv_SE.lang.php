...
$mod_strings = [
    ...
    'LBL_FILTER_DOMAINS_DESC' => 'Kommaseparerad lista över de domäner till vilka autosvarsmeddelanden inte kommer att skickas.',
    ...
    'LBL_FILTER_DOMAINS' => 'Inget autosvar på den här domänen',
