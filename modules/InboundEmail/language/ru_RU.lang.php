...
$mod_strings = [
    ...
    'LBL_FILTER_DOMAINS_DESC' => 'Разделенный запятыми список доменов, в которые не будут отправляться электронные письма с автоматическим ответом.',
    ...
    'LBL_FILTER_DOMAINS' => 'Не отправлять автоматический ответ на этот домен',
