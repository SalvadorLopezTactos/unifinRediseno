...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'Nevar pieprasīt paroles atiestatīšanu lietotājam, IDM licencēšanas režīms ir iespējots',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'Nevar pieprasīt paroles atiestatīšanu Lietotājam, sistēmas e-pasta konts nav konfigurēts',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'Nevar pieprasīt paroles atiestatīšanu lietotājam, nederīgs e-pasta veidnes ID',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'Nevar pieprasīt paroles atiestatīšanu lietotājam, lietotāja primārā e-pasta adrese nav derīga',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'Nevar pieprasīt paroles atiestatīšanu lietotājam, nepieciešama administratora piekļuve lietotāju modulim',
    'ERR_PASSWORD_RESET_NO_USER' => 'Nevar pieprasīt paroles atiestatīšanu neeksistējošam Lietotājam',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'Nevar pieprasīt paroles atiestatīšanu grupas vai portāla API tipa lietotājiem',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'Mainīt paroli',
    ...
    'LBL_HIDDEN_MODULES' => 'Slēptie moduļi',
    ...
    'LBL_PASSWORD_USER_RESET' => 'Atiestatīt lietotāja paroli',
    'LBL_RESET_PASSWORD_WARNING_USER' => 'Vai tiešām vēlaties atiestatīt paroli šim lietotājam?',
    'LBL_NEW_USER_PASSWORD_RESET' => 'E-pasts ar saiti uz paroles atiestatīšanu ir nosūtīts lietotājam.',
    ...
    'LBL_BESIDE_FIELD_VALUE' => 'Blakus lauka vērtībai',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'Šī lietotāja preferences tika veiksmīgi atiestatītas.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'Atlasītais fonts tiks piemērots PDF dokumenta galvenes un pamatteksta tekstam <br /> <br /> Ja rodas problēmas ar rakstzīmju atveidošanu noteiktās valodās, apsveriet iespēju mainīt fontu. Skatiet <a href="%s" target="_blank">Darba sākšana</a> dokumentāciju, lai iegūtu vairāk informācijas.',
    'LBL_PDF_FONT_SIZE_MAIN' => 'Pamata fonta izmērs',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'Kājenes fonts',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'Atlasītais fonts tiks piemērots PDF dokumenta kājenes tekstam <br /> <br /> Ja rodas problēmas ar rakstzīmju atveidošanu noteiktās valodās, apsveriet iespēju mainīt fontu. Skatiet <a href="%s" target="_blank">Darba sākšana</a> dokumentāciju, lai iegūtu vairāk informācijas.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'E-pasta akreditācijas dati',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        'Šis lietotājs ir izveidots kā darbnieks. Lai veiktu izmaiņas, dodieties uz Darbinieka moduli.',

    'LBL_SYNC_KEY' => 'Integrācijas sinhronizācijas ID',

    'LBL_APPEARANCE' => 'Izskats',
    'LBL_APPEARANCE_DESC' => 'Izvēlieties, kāds jums būs Sugar izskats. Pielāgojiet ierīces iestatījumus vai vienmēr izmantojiet gaišo vai tumšo režīmu.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'Kopēt saturu',
    'LNK_COPY_USER_SETTINGS' => 'Kopēt lietotāja iestatījumus',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'Kopēt preferences un saturu',
    'LBL_CLEAR' => 'Notīrīt',
    'LBL_COPY' => 'Kopēt',
    'LBL_COPY_ITEM' => 'Kopēt vienumu:',
    'LBL_USER_PREFENRECES' => 'Lietotāja preferences',
    'LBL_FILTERS' => 'Filtrs(i)',
    'LBL_DASHBOARDS_UTILS' => 'Informācijas panelis(i)',
    'LBL_DEFAULT_TEAMS' => 'Noklusējuma darba grupa',
    'LBL_FAVORITE_REPORTS' => 'Favorītatskaites',
    'LBL_NAVBAR_SELECTION' => 'Navigācijas joslas moduļa atlasīšana',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'Informēt par piešķīrumiem',
    'LBL_REMINDER_OPTIONS' => 'Atgādinājuma opcijas',
    'LBL_SCHEDULED_REPORTING' => 'Ieplānotie pārskati',
    'LBL_SUGAR_EMAIL_CLIENT' => 'SugarCRM E-pasta klients',
    'LBL_EXISTING_DASHBOARD' => 'Esošais informācijas panelis(i)',
    'LBL_FROM_MODULES' => 'No moduļiem',
    'LBL_SELECT_MODULES' => 'Atlasiet moduli(us)',
    'LBL_USER_UTILS_DATA_ERROR' => 'Nevarēja izgūt datus',
    'LBL_FROM_USERS' => 'No lietotāja',
    'LBL_SELECT_DASHBOARDS' => 'Atlasītais informācijas panelis(i)',
    'LBL_SELECT_FILTERS' => 'Atlasiet filtru(s)',
    'LBL_EXISTING_FILTERS' => 'Esošais filtrs(i)',
    'LBL_SELECT_DESTINATION_USERS' => 'Atlasiet gala lietotāju(s)',
    'LBL_SELECT_DESTINATION_ROLES' => 'Atlasiet gala lomu(as)',
    'LBL_SELECT_DESTINATION_TEAMS' => 'Atlasiet gala darba grupu(as)',
    'LBL_ITEMS_TO_REASSIGN' => 'Atkārtoti piešķiramie vienumi',
    'LBL_PROMPT_TIMEZONE_ON' => 'Iesl.',
    'LBL_PROMPT_TIMEZONE_OFF' => 'Izsl.',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'Lokālo iestatījumu atjaunināšana',
    'LBL_TO_TEAMS' => 'Darba grupai(ām)',
    'LBL_TO_USERS' => 'Lietotājam(iem)',
    'LBL_TO_ROLES' => 'Lomai(ām)',
    'LBL_IN_PROGRESS' => 'Procesā...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> tika atkārtoti piešķirtas {{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' - <b>{{commands}} ({{count}})</b> tika atkārtoti piešķirtas {{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> tika klonētas modulī(os): {{moduleList}} uz {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'Atlasiet lietotājus, komandas vai lomas, kuras vēlaties piešķirt.',
    'LBL_NO_DASHBOARD' => 'Atlasiet informācijas paneļus, kurus vēlaties piešķirt.',
    'LBL_NO_MODULES' => 'Atlasiet moduļus klonēšanai.',
    'LBL_NO_FILTERS' => 'Atlasiet filtrus, kurus vēlaties piešķirt.',
    'LBL_NO_USER_PREFERENCES' => 'Atlasiet lietotāja preferences, kuras vēlaties piešķirt.',
    'LBL_NO_USER_SETTINGS' => 'Atlasiet lietotāja iestatījumus, kurus vēlaties piešķirt.',
    'LBL_DATA_NOT_RETRIEVED' => 'Dati nav izgūti',
    'LBL_UTILS_USER_TEAMS_ROLES' => 'lietotāji/darba grupas/lomas',
    'LBL_LOADING_ITEMS' => 'Ielādē datus...',
    // END USER UTILS STRINGS
    'LBL_ACTIVE_USERS' => 'Aktīvie lietotāji',
    'LBL_GROUP_USERS' => 'Grupas lietotāji',
    'LBL_USERS_LIST_DASHBOARD' => 'Lietotāju saraksta instrumentu panelis',
