...
$mod_strings = array (
	...
	'ERR_IE_MISSING_REQUIRED'			=> "インバウンドメール設定に必要な情報が不足しています。<br />設定を確認して再実行してください。<br /><br />インバウンドEメールを設定していない場合は、このセクションのすべてのフィールドをクリアしてください。",
	...
	'ERR_REPORT_LOOP'					=> 'システムは報告ルートがループしていることを検出しました。ユーザは自身を報告先にすることはできません。また、上司がユーザを報告先にすることもできません。',
	'ERR_RULES_NOT_MET'                 => '指定されたパスワードは必要条件に合いません。再度試みてください。',
	'ERR_USER_INFO_NOT_FOUND'			=> 'ユーザ情報が見つかりません',
    'ERR_USER_NAME_EXISTS'              => 'ユーザ名 {0} は既に存在します。重複するユーザ名は使用できません。一意のユーザ名に変更してください。',
	...
	'ERR_SERVER_SMTP_EMPTY'				=> 'システムはユーザにEメールを送信することができません。<a href="index.php?module=EmailMan&amp;amp;action=config">システムメール設定</a>で送信用の設定を確認してください。',
    ...
    'LBL_CURRENCY_SHOW_PREFERRED'       => 'ユーザ指定通貨の表示',
    'LBL_CURRENCY_SHOW_PREFERRED_TEXT'  => 'リストおよびレコードビューで基本通貨をユーザが指定した通貨に変換します。',
    'LBL_CURRENCY_CREATE_IN_PREFERRED' => '設定された通貨の単位で商談品目を作成します',
    'LBL_CURRENCY_CREATE_IN_PREFERRED_TEXT' => '商品カタログで使用されている通貨とユーザが設定した通貨が異なる場合、商品カタログから商談に追加された商談品目は、ユーザが設定した通貨に換算されます。',
    ...
    'LBL_EMAIL_NOT_SENT'                => 'システムは処理を継続することができません。システム管理者にお問い合わせください。',
	...
	'LBL_ERROR'							=> 'エラー',
	'LBL_EXPORT_CHARSET'				=> 'インポート/エクスポート時の文字コード',
    ...
    'LBL_FORGOTPASSORD_NOT_ENABLED' 	=> 'これは現在使用不可です。管理者にお問い合わせください。',
...
// MASS REASSIGNMENT SCRIPT STRINGS
	...
	'LBL_REASS_DESC_PART1'				=> 'ユーザにアサインされたすべてのレコードを選択されたモジュールの中で探し、それらを別のユーザに再アサインすることができます。',
...
// END INBOUND EMAIL STRINGS
	'LBL_LDAP_ERROR' => 'LDAPエラー: システム管理者にお問い合わせください。',
...
// PROJECT RESOURCES STRINGS
	...
	'LBL_SMTP_SERVER_HELP' => 'SMTP サーバは送信用に利用されます。メールサービスを利用するためにユーザ名とパスワードを指定してください。',
    ...
    'LBL_FILTER_USERS_REPORTS' => 'ユーザレポート',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_REGULAR_USER' =>
        '読み取り専用フィールドを変更したい場合は、Sugar管理者にお問い合わせください。',
