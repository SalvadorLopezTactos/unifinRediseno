...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'ユーザーのパスワードリセットをリクエストできません。IDMライセンスモードが有効になっています',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'ユーザーのパスワードリセットをリクエストできません。システムのメールアカウントが構成されていません',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'ユーザーのパスワードリセットをリクエストできません。メールテンプレートIDが無効です',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'ユーザーのパスワードリセットをリクエストできません。ユーザーのプライマリメールアドレスが無効です',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'ユーザーのパスワードリセットをリクエストできません。ユーザーモジュールへの管理者アクセス権が必要です',
    'ERR_PASSWORD_RESET_NO_USER' => '存在しないユーザーのパスワードリセットをリクエストできません',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'グループまたはポータルAPIタイプのユーザーのパスワードリセットをリクエストできません',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'パスワード変更',
    ...
    'LBL_PASSWORD_USER_RESET' => 'ユーザーパスワードをリセット',
    'LBL_RESET_PASSWORD_WARNING_USER' => 'このユーザーのパスワードをリセットしてもよろしいですか？',
    'LBL_NEW_USER_PASSWORD_RESET' => 'パスワードをリセットするためのリンクが記載されたメールがユーザーに送信されました。',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'このユーザーの基本設定は正常にリセットされました。',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => '選択したフォントは、PDFドキュメントのヘッダーと本文のテキストに適用されます <br /><br />特定の言語の文字のレンダリングに問題がある場合は、フォントの変更を検討してください。詳細については、<a href="%s" target="_blank">開始する</a>ドキュメントを参照してください。',
    'LBL_PDF_FONT_SIZE_MAIN' => 'メインフォントサイズ',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'フッタ用フォント',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => '選択したフォントは、PDFドキュメントのフッターのテキストに適用されます <br /><br />特定の言語の文字のレンダリングに問題がある場合は、フォントの変更を検討してください。詳細については、<a href="%s" target="_blank">開始する</a>ドキュメントを参照してください。',
    ...
    'LBL_MAIL_CREDENTIALS' => 'Eメールの資格情報',
...
アクセスしたください。',
    ...
    'LBL_ACTIVE_USERS' => 'アクティブユーザー',
    'LBL_GROUP_USERS' => 'グループユーザー',
    'LBL_USERS_LIST_DASHBOARD' => 'ユーザーリストのダッシュ ボード',
