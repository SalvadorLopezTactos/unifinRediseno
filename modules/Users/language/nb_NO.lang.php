...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'Kan ikke be om tilbakestilling av passord for bruker, IDM-lisensieringsmodus er aktivert',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'Kan ikke be om tilbakestilling av passord for bruker, system-e-postkonto er ikke konfigurert',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'Kan ikke be om tilbakestilling av passord for bruker, ugyldig e-postmal-ID',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'Kan ikke be om tilbakestilling av passord for bruker, brukerens primære e-postadresse er ugyldig',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'Kan ikke be om tilbakestilling av passord for bruker, må ha administratortilgang til brukermodulen',
    'ERR_PASSWORD_RESET_NO_USER' => 'Kan ikke be om tilbakestilling av passord for ikke-eksisterende bruker',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'Kan ikke be om tilbakestilling av passord for brukere av gruppe- eller portal-API-typen',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'Endre passord',
    ...
    'LBL_PASSWORD_USER_RESET' => 'Tilbakestill brukerpassord',
    'LBL_RESET_PASSWORD_WARNING_USER' => 'Er du sikker på at du vil tilbakestille passordet for denne brukeren?',
    'LBL_NEW_USER_PASSWORD_RESET' => 'En e-post ble sendt til brukeren med en lenke for å tilbakestille passordet.',
    ...
    'LBL_BESIDE_FIELD_VALUE' => 'Ved siden av feltverdi',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'Innstillingene for denne brukeren ble tilbakestilt.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'Den valgte skriften vil bli brukt på teksten i overskriften og brødteksten i PDF-dokumentet <br /> <br /> Hvis du har problemer med å gjengi tegn for bestemte språk, bør du vurdere å endre skriften. Se <a href="%s" target="_blank">Komme i gang</a>-dokumentasjon for mer informasjon.',
    'LBL_PDF_FONT_SIZE_MAIN' => 'Hoved Skriftstørrelse',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'Skrift for bunntekst',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'Den valgte skriften vil bli brukt på teksten i bunnteksten i PDF-dokumentet <br /> <br /> Hvis du har problemer med å gjengi tegn for bestemte språk, bør du vurdere å endre skriften. Se <a href="%s" target="_blank">Komme i gang</a>-dokumentasjon for mer informasjon.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'E-postlegitimasjon',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        'Denne brukeren opprettet som en medarbeider. Gå til Medarbeider-modulen for å gjøre endringer.',

    'LBL_SYNC_KEY' => 'Integrasjonssynkroniserings-ID',

    'LBL_APPEARANCE' => 'Utseende',
    'LBL_APPEARANCE_DESC' => 'Velg hvordan Sugar ser ut for deg. Følg enhetens innstillinger, eller velg å alltid bruk lys eller mørk modus.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'Kopier innhold',
    'LNK_COPY_USER_SETTINGS' => 'Kopier brukerinnstillinger',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'Kopier preferanser og innhold',
    'LBL_CLEAR' => 'Fjern',
    'LBL_COPY' => 'Kopier',
    'LBL_COPY_ITEM' => 'Kopier element:',
    'LBL_USER_PREFENRECES' => 'Brukerpreferanser',
    'LBL_FILTERS' => 'Filter/filtre',
    'LBL_DASHBOARDS_UTILS' => 'Instrumentpanel(er)',
    'LBL_DEFAULT_TEAMS' => 'Standardteam',
    'LBL_FAVORITE_REPORTS' => 'Favorittrapporter',
    'LBL_NAVBAR_SELECTION' => 'Modulvalg for navigasjonslinje',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'Gi beskjed ved tildeling',
    'LBL_REMINDER_OPTIONS' => 'Alternativer for påminnelse',
    'LBL_SCHEDULED_REPORTING' => 'Planlagt rapportering',
    'LBL_SUGAR_EMAIL_CLIENT' => 'Sugar e-postklient',
    'LBL_EXISTING_DASHBOARD' => 'Eksisterende instrumentpanel(er)',
    'LBL_FROM_MODULES' => 'Fra moduler',
    'LBL_SELECT_MODULES' => 'Velg modul(er)',
    'LBL_USER_UTILS_DATA_ERROR' => 'Kan ikke hente data',
    'LBL_FROM_USERS' => 'Fra bruker',
    'LBL_SELECT_DASHBOARDS' => 'Velg instrumentpanel(er)',
    'LBL_SELECT_FILTERS' => 'Velg filter/filtre',
    'LBL_EXISTING_FILTERS' => 'Eksisterende filter/filtre',
    'LBL_SELECT_DESTINATION_USERS' => 'Velg destinasjonsbruker(e)',
    'LBL_SELECT_DESTINATION_ROLES' => 'Velg destinasjonsrolle(r)',
    'LBL_SELECT_DESTINATION_TEAMS' => 'Velg destinasjonsteam',
    'LBL_ITEMS_TO_REASSIGN' => 'Elementer å tildele på nytt',
    'LBL_PROMPT_TIMEZONE_ON' => 'På',
    'LBL_PROMPT_TIMEZONE_OFF' => 'Av',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'Oppdatering av stedinnstillinger',
    'LBL_TO_TEAMS' => 'Til team',
    'LBL_TO_USERS' => 'Til bruker(e)',
    'LBL_TO_ROLES' => 'Til rolle(r)',
    'LBL_IN_PROGRESS' => 'Under utførelse...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> ble tildelt på nytt til {{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' - <b>{{commands}} ({{count}})</b> ble tildelt på nytt til {{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> ble klonet på modul(er): {{moduleList}} til {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'Velg brukere, team eller roller du vil tildele til.',
    'LBL_NO_DASHBOARD' => 'Velg instrumentpanelene du vil tildele.',
    'LBL_NO_MODULES' => 'Velg moduler for kloning.',
    'LBL_NO_FILTERS' => 'Velg filtre du vil tildele.',
    'LBL_NO_USER_PREFERENCES' => 'Velg brukerpreferanser du vil tildele.',
    'LBL_NO_USER_SETTINGS' => 'Velg brukerinnstillingene du vil tildele.',
    ...
    'LBL_ACTIVE_USERS' => 'Aktive brukere',
    'LBL_GROUP_USERS' => 'Gruppebrukere',
    'LBL_USERS_LIST_DASHBOARD' => 'Dashbord for brukerliste',
