...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => '사용자에 대한 암호 재설정을 요청할 수 없습니다. IDM 라이선스 모드가 활성화되었습니다.',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => '사용자의 암호 재설정을 요청할 수 없습니다. 시스템 전자 메일 계정이 구성되지 않았습니다.',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => '사용자에 대한 암호 재설정을 요청할 수 없습니다. 이메일 템플릿 ID가 잘못되었습니다.',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => '사용자의 암호 재설정을 요청할 수 없습니다. 사용자의 기본 이메일 주소가 잘못되었습니다.',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => '사용자에 대한 암호 재설정을 요청할 수 없습니다. 사용자 모듈에 대한 관리자 액세스 권한이 있어야 합니다.',
    'ERR_PASSWORD_RESET_NO_USER' => '존재하지 않는 사용자의 암호 재설정을 요청할 수 없습니다.',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => '그룹 또는 포털 API 유형 사용자의 비밀번호 재설정을 요청할 수 없습니다.',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => '비밀번호 변경하기',
    ...
    'LBL_RESET_PASSWORD_WARNING_USER' => '이 사용자의 암호를 재설정하시겠습니까?',
    'LBL_NEW_USER_PASSWORD_RESET' => '암호 재설정 링크를 포함한 이메일이 사용자에게 발송되었습니다.',
    ...
    'LBL_BESIDE_FIELD_VALUE' => '필드 값 이하',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => '이 사용자의 환경설정이 재설정되었습니다.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => '선택한 글꼴이 PDF 문서의 머리글과 본문에 있는 텍스트에 적용됩니다.<br /> <br />특정 언어의 문자를 렌더링하는 데 문제가 있는 경우 글꼴을 변경해 보십시오. 자세한 내용은 <a href="%s" target="_blank">시작하기</a> 설명서를 참조하십시오.',
    'LBL_PDF_FONT_SIZE_MAIN' => '주 글자크기',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => '바닥글 글자체',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => '선택한 글꼴이 PDF 문서의 바닥글에 있는 텍스트에 적용됩니다.<br /> <br />특정 언어의 문자를 렌더링하는 데 문제가 있는 경우 글꼴을 변경해 보십시오. 자세한 내용은 <a href="%s" target="_blank">시작하기</a> 설명서를 참조하십시오.',
    ...
    'LBL_MAIL_CREDENTIALS' => '이메일 자격 증명',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        '이 사용자는 직원으로 생성됐습니다. 변경을 위해 직원 모듈로 이동하십시오.',

    'LBL_SYNC_KEY' => '통합 동기화 ID',

    'LBL_APPEARANCE' => '외관',
    'LBL_APPEARANCE_DESC' => 'Sugar의 외관을 설정합니다. 장치 설정을 따르거나 항상 라이트 모드 또는 다크 모드를 사용하도록 선택합니다.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => '콘텐츠 복사',
    'LNK_COPY_USER_SETTINGS' => '사용자 설정 복사',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => '설명 및 콘텐츠 복사',
    'LBL_CLEAR' => '지우기',
    'LBL_COPY' => '복사',
    'LBL_COPY_ITEM' => '항목 복사:',
    'LBL_USER_PREFENRECES' => '사용자 설정',
    'LBL_FILTERS' => '필터',
    'LBL_DASHBOARDS_UTILS' => '대시보드',
    'LBL_DEFAULT_TEAMS' => '초기설정 팀',
    'LBL_FAVORITE_REPORTS' => '즐겨찾기 보고서',
    'LBL_NAVBAR_SELECTION' => '탐색 바 모듈 선택',
    'LBL_NOTIFY_ON_ASSIGNMENT' => '배정시 알림여부',
    'LBL_REMINDER_OPTIONS' => '알림 옵션',
    'LBL_SCHEDULED_REPORTING' => '보고 일정:',
    'LBL_SUGAR_EMAIL_CLIENT' => 'Sugar 이메일 고객',
    'LBL_EXISTING_DASHBOARD' => '기존 대시보드',
    'LBL_FROM_MODULES' => '모듈에서',
    'LBL_SELECT_MODULES' => '모듈 선택',
    'LBL_USER_UTILS_DATA_ERROR' => '데이터 검색 불가',
    'LBL_FROM_USERS' => '사용자에서',
    'LBL_SELECT_DASHBOARDS' => '대시보드 선택',
    'LBL_SELECT_FILTERS' => '필터 선택',
    'LBL_EXISTING_FILTERS' => '기존 필터',
    'LBL_SELECT_DESTINATION_USERS' => '목표 사용자 선택',
    'LBL_SELECT_DESTINATION_ROLES' => '목표 역할 선택',
    'LBL_SELECT_DESTINATION_TEAMS' => '목표 담당부서 선택',
    'LBL_ITEMS_TO_REASSIGN' => '항목 다시 지정',
    'LBL_PROMPT_TIMEZONE_ON' => '켜기',
    'LBL_PROMPT_TIMEZONE_OFF' => '끄기',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => '위치 설정 업데이트',
    'LBL_TO_TEAMS' => '담당부서에',
    'LBL_TO_USERS' => '사용자에',
    'LBL_TO_ROLES' => '역할에',
    'LBL_IN_PROGRESS' => '진행 중...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b>은(는) {{destinationList}}에 다시 지정되었습니다.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => '- <b>{{commands}}({{count}})</b>은(는) {{destinationList}}에 다시 지정되었습니다.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        '- <b>{{commands}}</b>은(는) {{destinationList}}에 대한 {{moduleList}}에 복제되었습니다.',
    'LBL_NO_DESTINATION' => '할당하고자 하는 사용자, 담당부서, 역할을 선택하십시오.',
    'LBL_NO_DASHBOARD' => '할당하고자 하는 대시보드를 선택하십시오.',
    'LBL_NO_MODULES' => '복제할 모듈을 선택하십시오.',
    'LBL_NO_FILTERS' => '할당하고자 하는 필터를 선택하십시오.',
    'LBL_NO_USER_PREFERENCES' => '할당하고자 하는 사용자 지정 설정을 선택하십시오.',
    'LBL_NO_USER_SETTINGS' => '할당하고자 하는 사용자 설정을 선택하십시오.',
    'LBL_DATA_NOT_RETRIEVED' => '데이터 검색되지 않음',
    'LBL_UTILS_USER_TEAMS_ROLES' => '사용자/팀/역할',
    'LBL_LOADING_ITEMS' => '데이터 불러오는 중...',
    // END USER UTILS STRINGS
    'LBL_ACTIVE_USERS' => '활성 사용자',
    'LBL_GROUP_USERS' => '그룹 사용자',
    'LBL_USERS_LIST_DASHBOARD' => '사용자 목록 대시보드',
