...
$mod_strings = [
    ...
    'ERR_USER_MISSING_LICENSE_TYPE' => '[{0}] licence must be assigned with a CRM product licence',
    ...
    'LBL_COUNTRY' => 'Country',
    'LBL_CURRENCY_TEXT' => 'This is the currency used in the list and record views if Show Preferred Currency is enabled. This is also your default currency for new records.',
    ...
    'LBL_CURRENCY_SHOW_PREFERRED_TEXT' => 'Convert base currency to the user preferred one in list and record views',
    ...
    'LBL_EMAIL_TEMPLATE_MISSING' => 'No email template has been selected for the email containing the password that will be sent to the user.  Please select an email template in the Password Management page.',
    ...
    'LBL_RESET_PASSWORD_WARNING_USER' => 'Are you sure you want to reset the password for this user?',
    ...
    'LBL_RESET_PREFERENCES_WARNING' => 'Are you sure you want to reset all of your user preferences? Warning: This will also log you out of the application.',
...
// MASS REASSIGNMENT SCRIPT STRINGS
    ...
    'LBL_REASS_DESC_PART2' => 'Select which modules workflows will be run against, send assignment notifications and do auditing tracking during reassignment. Click Next to continue and reassign records. Click Restart to start over.',
    ...
    'LBL_REASS_NOTES_TWO' => 'Even though you did not select to do audit tracking, the Date Modified and Modified By field in the records will still be updated accordingly.',
...
// INBOUND EMAIL STRINGS
    ...
    'LBL_MAILBOX_SSL_DESC' => 'Use SSL when connecting. If this does not work, check that your PHP installation is included "--with-imap-ssl" in the configuration.',
...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Sugar Community to discuss topics of interest with each other and with SugarCRM Developers</td></tr>
    ...
    'LBL_FAVORITE_REPORTS' => 'Favourite Reports',
