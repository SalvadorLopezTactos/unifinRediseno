...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'Não é possível solicitar a redefinição de senha para o usuário, o modo de licenciamento do IDM está habilitado',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'Não é possível solicitar a redefinição de senha para o usuário, a conta de e-mail do sistema não está configurada',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'Não é possível solicitar a redefinição de senha para o usuário, o ID do modelo de e-mail é inválido',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'Não é possível solicitar a redefinição de senha para o usuário, o endereço de e-mail principal do usuário é inválido',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'Não é possível solicitar a redefinição de senha para o usuário, é necessário ter acesso de administrador ao módulo Usuários',
    'ERR_PASSWORD_RESET_NO_USER' => 'Não é possível solicitar a redefinição de senha para um usuário não existente',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'Não é possível solicitar a redefinição de senha para usuários do tipo API de portal ou grupo',
    ...
    'ERR_USER_MISSING_LICENSE_TYPE' => 'A licença do "Sugar Hint" license deve ser salva com um tipo de licença compatível adicional',
    'ERR_USER_LICENSE_TYPE_OFFERRED_IN_BUNDLES' => 'Esta capacidade já está incluída no Sugar Sell Premier.',
    ...
    'ERR_CREATE_USER_FOR_IDM_MODE' => 'Novos usuários precisam ser criados em <a href="{0}" target="_blank">Configurações do SugarCloud</a>.',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'Alterar senha',
    ...
    'LBL_CHOOSE_WHICH' => 'Selecione os módulos que são acessados ​​dentro da barra de navegação lateral. Designar a ordem em que você gostaria que os módulos aparecessem.',
    'LBL_NUMBER_PINNED_MODULES' => 'Número de módulos fixados',
    'LBL_NUMBER_PINNED_MODULES_DESC' => 'Escreva o número de módulos disponíveis para fixar quando a barra de navegação estiver recolhida (por exemplo, se o número 5 for inserido, os primeiros cinco módulos da sua lista serão fixados). Recomendamos um número que represente os módulos usados com mais frequência. Valores acima de 100 não serão respeitados.',
    'LBL_CITY' => 'Cidade',
    ...
    'LBL_HIDDEN_MODULES' => 'Módulos ocultos',
    ...
    'LBL_PASSWORD_USER_RESET' => 'Redefinir senha de usuário',
    'LBL_RESET_PASSWORD_WARNING_USER' => 'Você tem certeza que deseja redefinir a senha deste usuário?',
    'LBL_NEW_USER_PASSWORD_RESET' => 'Um e-mail foi enviado ao usuário contendo um link para redefinir a senha.',
    ...
    'LBL_SHIFTS' => 'Turnos',
    'LBL_SHIFT_EXCEPTIONS' => 'Exceções de turno',

    'LBL_RECEIVE_NOTIFICATIONS_TEXT' => 'Receba uma notificação por e-mail quando um registro é atribuído a você.',
    'LBL_RECEIVE_NOTIFICATIONS' => 'E-mail sobre a atribuição',
    'LBL_SEND_EMAIL_ON_MENTION_TEXT' => 'Receba uma notificação por e-mail quando alguém mencionar você em uma entrada no registro de comentários.',
    'LBL_SEND_EMAIL_ON_MENTION' => 'E-mail sobre menção',
    'LBL_FIELD_NAME_PLACEMENT_TEXT' => 'Selecione a forma como os nomes dos campos devem ser exibidos nas visualizações de registos. Escolha "Ao lado do valor do campo" para uma visualização de registo mais compacta.',
    'LBL_FIELD_NAME_PLACEMENT' => 'Posicionamento do nome do campo',
    'LBL_ABOVE_FIELD_VALUE' => 'Acima do valor do campo',
    'LBL_BESIDE_FIELD_VALUE' => 'Ao lado do nome do campo',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'As preferências desse usuário foram redefinidas com sucesso.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'A fonte selecionada será aplicada ao texto no cabeçalho e no corpo do documento PDF <br /> <br /> Se você tiver problemas para renderizar caracteres para determinados idiomas, considere alterar a fonte. Para mais informações, consulte a documentação de <a href="%s" target="_blank">Primeiros passos</a>.',
    'LBL_PDF_FONT_SIZE_MAIN' => 'Tamanho de Fonte Principal',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'Fonte para o Rodapé',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'A fonte selecionada será aplicada ao texto no rodapé do documento PDF <br /> <br /> Se você tiver problemas para renderizar caracteres para determinados idiomas, considere alterar a fonte. Para mais informações, consulte a documentação de <a href="%s" target="_blank">Primeiros passos</a>.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'Credenciais de e-mail',
    ...
    'LBL_MAIL_AUTHORIZED_ACCOUNT' => 'Conta de e-mail autorizada',
    'LBL_MAIL_AUTHORIZE' => 'Autorizar',
...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Fóruns</b></a><br>Fóruns dedicados à Comunidade Sugar para discussão de tópicos de interesse entre os usuários e os Desenvolvedores do SugarCRM</td></tr>
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_ADMIN_USER' =>
        'Acesse as <a href="%s" target="_blank">Configurações do SugarCloud</a> para fazer alterações nos campos apenas de leitura.',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        'Este usuário foi criado como funcionário. Acesse o módulo de Funcionário para realizar alterações.',

    'LBL_SYNC_KEY' => 'ID de sincronização de integração',

    'LBL_APPEARANCE' => 'Aparência',
    'LBL_APPEARANCE_DESC' => 'Escolha a aparência do Sugar. Siga as configurações do seu dispositivo ou escolha sempre usar o modo claro ou escuro.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'Copiar conteúdo',
    'LNK_COPY_USER_SETTINGS' => 'Copiar configurações de usuários',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'Copiar preferências e conteúdo',
    'LBL_CLEAR' => 'Limpar',
    'LBL_COPY' => 'Copiar',
    'LBL_COPY_ITEM' => 'Copiar item:',
    'LBL_USER_PREFENRECES' => 'Preferências do usuário',
    'LBL_FILTERS' => 'Filtro(s)',
    'LBL_DASHBOARDS_UTILS' => 'Painel(éis)',
    'LBL_DEFAULT_TEAMS' => 'Equipes padrão',
    'LBL_FAVORITE_REPORTS' => 'Relatórios favoritos',
    'LBL_NAVBAR_SELECTION' => 'Seleção de módulo da barra de navegação',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'Notificar na atribuição',
    'LBL_REMINDER_OPTIONS' => 'Opções de lembrete',
    'LBL_SCHEDULED_REPORTING' => 'Relatórios agendados',
    'LBL_SUGAR_EMAIL_CLIENT' => 'Cliente de e-mail Sugar',
    'LBL_EXISTING_DASHBOARD' => 'Painel(éis) existente(s)',
    'LBL_FROM_MODULES' => 'De módulos',
    'LBL_SELECT_MODULES' => 'Selecionar módulo(s)',
    'LBL_USER_UTILS_DATA_ERROR' => 'Não é possível recuperar dados',
    'LBL_FROM_USERS' => 'Do usuário',
    'LBL_SELECT_DASHBOARDS' => 'Selecionar painel(éis)',
    'LBL_SELECT_FILTERS' => 'Selecionar filtro(s)',
    'LBL_EXISTING_FILTERS' => 'Filtro(s) existente(s)',
    'LBL_SELECT_DESTINATION_USERS' => 'Selecionar usuário(s) alvo',
    'LBL_SELECT_DESTINATION_ROLES' => 'Selecionar função(óes) alvo',
    'LBL_SELECT_DESTINATION_TEAMS' => 'Selecionar equipe(s) alvo',
    'LBL_ITEMS_TO_REASSIGN' => 'Itens a reatribuir',
    'LBL_PROMPT_TIMEZONE_ON' => 'Ligado',
    'LBL_PROMPT_TIMEZONE_OFF' => 'Desligado',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'Atualização de configurações de local',
    'LBL_TO_TEAMS' => 'Para equipe(s)',
    'LBL_TO_USERS' => 'Para usuário(s)',
    'LBL_TO_ROLES' => 'Para função(ões)',
    'LBL_IN_PROGRESS' => 'Em andamento...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> foram reatribuídos a {{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' - <b>{{commands}} ({{count}})</b> foram reatribuídos a {{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> foram clonados no(s) módulo(s): {{moduleList}} para {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'Selecione os usuários, equipes ou funções às quais deseja atribuir.',
    'LBL_NO_DASHBOARD' => 'Selecione os painéis que deseja atribuir.',
    'LBL_NO_MODULES' => 'Selecione os módulos para clonar.',
    'LBL_NO_FILTERS' => 'Selecione os filtros que deseja atribuir.',
    'LBL_NO_USER_PREFERENCES' => 'Selecione as preferências de usuário que deseja atribuir.',
    'LBL_NO_USER_SETTINGS' => 'Selecione as configurações do usuário que deseja atribuir.',
    'LBL_DATA_NOT_RETRIEVED' => 'Dados não recuperados',
    'LBL_UTILS_USER_TEAMS_ROLES' => 'usuários/equipes/funções',
    'LBL_LOADING_ITEMS' => 'Carregando dados...',
    // END USER UTILS STRINGS
    'LBL_ACTIVE_USERS' => 'Usuários ativos',
    'LBL_GROUP_USERS' => 'Usuários do grupo',
    'LBL_USERS_LIST_DASHBOARD' => 'Painel de lista de usuários',

    // Sugar Automate
    'LBL_CUSTOMER_JOURNEY_ACCESS' => 'Acesso ao guia inteligente',
    'LBL_CUSTOMER_JOURNEY_LAST_ACTIVE' => 'Último guia inteligente ativo',
    'LBL_FILTER_MISSING_CUSTOMER_JOURNEY_ACCESS' => 'Acesso ao guia inteligente ausente',
]; // END STRINGS DEFS
