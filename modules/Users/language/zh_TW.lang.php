...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => '無法為使用者請求密碼重設，IDM 授權模式已啟用',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => '無法為使用者請求密碼重設，系統電子郵件帳戶未設定',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => '無法為使用者請求密碼重設，電子郵件範本 ID 無效',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => '無法為使用者請求密碼重設，使用者的主要電子郵件地址無效',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => '無法為使用者請求密碼重設，必須具有對使用者模組的管理員存取權限',
    'ERR_PASSWORD_RESET_NO_USER' => '無法為不存在的使用者請求密碼重設',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => '無法為「群組」或「入口網站 API」類型的使用者請求密碼重設',
    ...
    'ERR_CREATE_USER_FOR_IDM_MODE' => '必須在 <a href="{0}" target="_blank">SugarCloud 設置</a>中建立用戶。',
    ...
    'LBL_PASSWORD_USER_RESET' => '重設使用者密碼',
    'LBL_RESET_PASSWORD_WARNING_USER' => '確定要為該使用者重設密碼嗎？',
    'LBL_NEW_USER_PASSWORD_RESET' => '已向使用者傳送包含密碼重設連結的電子郵件。',
    ...
    'LBL_CALENDARS' => '行事曆',
    'LBL_SHIFTS' => '班表',
    'LBL_SHIFT_EXCEPTIONS' => '班表的例外',

    'LBL_RECEIVE_NOTIFICATIONS_TEXT' => '向您指派記錄時，收到電子郵件通知。',
    'LBL_RECEIVE_NOTIFICATIONS' => '指派時的電子郵件',
    'LBL_SEND_EMAIL_ON_MENTION_TEXT' => '當有人在評論日誌條目中提及您時，您會收到一封電子郵件通知。',
    'LBL_SEND_EMAIL_ON_MENTION' => '被提及時以電子郵件通知',
    'LBL_FIELD_NAME_PLACEMENT_TEXT' => '選擇字段名稱在紀錄視圖中的顯示方式。選擇“字段值旁邊”以獲得更緊湊的記錄視圖。',
    'LBL_FIELD_NAME_PLACEMENT' => '字段名稱布置',
    'LBL_ABOVE_FIELD_VALUE' => '字段值上方',
    'LBL_BESIDE_FIELD_VALUE' => '字段值旁邊',
    'LBL_REGISTER' => '新使用者？請註冊',
    'LBL_REGULAR_USER' => '常規使用者',
    'LBL_LICENSE_TYPE' => '授權類型',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => '該使用者的偏好設定已成功重設。',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => '所選字型將套用至 PDF 文件的頁首和正文中的文字 <br /> <br /> 如果在呈現某些語言的字元時遇到問題，請考慮變更字型。請參閱<a href="%s" target="_blank">入門</a> 文件以獲取更多資訊。',
    'LBL_PDF_FONT_SIZE_MAIN' => '主要字型大小',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => '頁尾字型',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => '所選字型將套用至 PDF 文件頁尾中的文字 <br /> <br /> 如果在呈現某些語言的字元時遇到問題，請考慮變更字型。請參閱<a href="%s" target="_blank">入門</a> 文件以獲取更多資訊。',
...
SugarCRM 支援部提供的有關在 Sugar 中執行常見工作和流程的提示',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_ADMIN_USER' =>
        '請訪問 <a href="%s" target="_blank">SugarCloud 設置</a> 對唯獨字段進行變更。',
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_REGULAR_USER' =>
        '如果要更改唯讀欄位, 請與您的Sugar管理員聯繫。',
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        '此用戶以建立為員工。請轉到"員工"模塊以進行更改。',

    'LBL_SYNC_KEY' => '集成同步 ID',

    'LBL_APPEARANCE' => '外觀',
    'LBL_APPEARANCE_DESC' => '選擇 Sugar 在您眼中的樣子。按照您的設備設置或選擇始終使用白天或夜間模式。',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => '複製內容',
    'LNK_COPY_USER_SETTINGS' => '複製用戶設置',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => '複製首選項和內容',
    'LBL_CLEAR' => '清除',
    'LBL_COPY' => '複製',
    'LBL_COPY_ITEM' => '複製項目：',
    'LBL_USER_PREFENRECES' => '用戶首選項',
    'LBL_FILTERS' => '過濾器',
    'LBL_DASHBOARDS_UTILS' => '儀表板',
    'LBL_DEFAULT_TEAMS' => '默認團隊',
    'LBL_FAVORITE_REPORTS' => '收藏夾報表',
    'LBL_NAVBAR_SELECTION' => '導航欄模塊選擇',
    'LBL_NOTIFY_ON_ASSIGNMENT' => '分配时通知',
    'LBL_REMINDER_OPTIONS' => '提醒選項',
    'LBL_SCHEDULED_REPORTING' => '已安排報告',
    'LBL_SUGAR_EMAIL_CLIENT' => 'Sugar 郵件客戶端',
    'LBL_EXISTING_DASHBOARD' => '現有儀表板',
    'LBL_FROM_MODULES' => '來自模塊',
    'LBL_SELECT_MODULES' => '選擇模塊',
    'LBL_USER_UTILS_DATA_ERROR' => '無法檢索數據',
    'LBL_FROM_USERS' => '來自用戶',
    'LBL_SELECT_DASHBOARDS' => '選擇儀表板',
    'LBL_SELECT_FILTERS' => '選擇篩選器',
    'LBL_EXISTING_FILTERS' => '現有篩選器',
    'LBL_SELECT_DESTINATION_USERS' => '選擇目標用戶',
    'LBL_SELECT_DESTINATION_ROLES' => '選擇目標角色',
    'LBL_SELECT_DESTINATION_TEAMS' => '選擇目標團隊',
    'LBL_ITEMS_TO_REASSIGN' => '要重新分配的項目',
    'LBL_PROMPT_TIMEZONE_ON' => '開啟',
    'LBL_PROMPT_TIMEZONE_OFF' => '關閉',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => '區域設置更新',
    'LBL_TO_TEAMS' => '給團隊',
    'LBL_TO_USERS' => '給用戶',
    'LBL_TO_ROLES' => '給角色',
    'LBL_IN_PROGRESS' => '正在進行...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> 已重新分配到 {{destinationList}}。',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' - <b>{{commands}} ({{count}})</b>已重新分配到 {{destinationList}}。',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> 已在模塊上複製： {{moduleList}} 到 {{destinationList}}。',
    'LBL_NO_DESTINATION' => '請選擇要分配給的用戶、團隊或角色。',
    'LBL_NO_DASHBOARD' => '請選擇要分配的儀表板。',
    'LBL_NO_MODULES' => '請選擇要複製的模塊。',
    'LBL_NO_FILTERS' => '請選擇要分配的篩選器。',
    'LBL_NO_USER_PREFERENCES' => '請選擇要分配的用戶首選項。',
    'LBL_NO_USER_SETTINGS' => '請選擇要分配的用戶設置。',
    'LBL_DATA_NOT_RETRIEVED' => '未檢索到數據',
    'LBL_UTILS_USER_TEAMS_ROLES' => '使用者/團隊/角色',
    'LBL_LOADING_ITEMS' => '正在載入......',
    // END USER UTILS STRINGS
    'LBL_ACTIVE_USERS' => '作用中使用者',
    'LBL_GROUP_USERS' => '群組使用者',
    'LBL_USERS_LIST_DASHBOARD' => '使用者清單儀表板',
