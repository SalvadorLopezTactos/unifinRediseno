...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'تعذر طلب إعادة تعيين كلمة المرور للمستخدم، تم تمكين وضع ترخيص IDM',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'تعذر طلب إعادة تعيين كلمة المرور للمستخدم، لم يتم تكوين حساب البريد الإلكتروني للنظام',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'تعذر طلب إعادة تعيين كلمة المرور للمستخدم، معرّف قالب بريد إلكتروني غير صالح',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'تعذر طلب إعادة تعيين كلمة المرور للمستخدم، عنوان البريد الإلكتروني الأساسي للمستخدم غير صالح',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'تعذر طلب إعادة تعيين كلمة المرور للمستخدم، يجب الحصول على إذن وصول إداري إلى وحدة المستخدمين',
    'ERR_PASSWORD_RESET_NO_USER' => 'تعذر طلب إعادة تعيين كلمة المرور للمستخدم لأن المستخدم غير موجود',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'تعذر طلب إعادة تعيين كلمة المرور لمستخدمين مدخل واجهة برمجة تطبيقات المدخل أو المجموعة',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'تغيير كلمة المرور',
    ...
    'LBL_CURRENCY_CREATE_IN_PREFERRED' => 'إنشاء بنود الإيرادات بالعملة المفضلة',
    'LBL_CURRENCY_CREATE_IN_PREFERRED_TEXT' => 'سيتم تحويل بنود الإيرادات المضافة إلى فرصة من "كتالوج المنتجات" إلى العملة المفضلة للمستخدم إذا كانت تختلف عن العملة المستخدمة في البند "كتالوج المنتج".',
    ...
    'LBL_HIDDEN_MODULES' => 'الوحدات المخفية',
    ...
    'LBL_PASSWORD_USER_RESET' => 'إعادة تعيين كلمة مرور المستخدم',
    'LBL_RESET_PASSWORD_WARNING_USER' => 'هل تريد بالتأكيد إعادة تعيين كلمة المرور لهذا المستخدم؟',
    'LBL_NEW_USER_PASSWORD_RESET' => 'تم إرسال بريد إلكتروني للمستخدم يحتوي على رابط لإعادة تعيين كلمة المرور.',
    ...
    'LBL_SITE_USER_ID' => 'تجزئة site_url و user_id',
    'LBL_COOKIE_CONSENT' => 'الموافقة على ملفات تعريف الارتباط',
    'LBL_COOKIE_CONSENT_RECEIVED_ON' => 'تم تلقي الموافقة على ملفات تعريف الارتباط في',
    ...
    'LBL_BESIDE_FIELD_VALUE' => 'بجانب قيمة الحقل',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'تمت إعادة ضبط تفضيلات هذا المستخدم بنجاح.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'سيتم تطبيق الخط المحدد على النص الموجود في رأس ونص مستند PDF <br /> <br /> إذا كنت تواجه مشكلات في عرض الأحرف للغات معينة، ففكر في تغيير الخط. ارجع إلى <a href="%s" target="_blank">البدء</a> لمزيد من المعلومات.',
    'LBL_PDF_FONT_SIZE_MAIN' => 'حجم الخط الرئيسي',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'خط التذييل',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'سيتم تطبيق الخط المحدد على النص الموجود في تذييل مستند PDF <br /> <br /> إذا كنت تواجه مشكلات في عرض الأحرف للغات معينة، ففكر في تغيير الخط. ارجع إلى <a href="%s" target="_blank">البدء</a> لمزيد من المعلومات.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'بيانات اعتماد البريد الإلكتروني',
...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>المنتديات</b></a><br>المنتديات المخصصة لمجتمع Sugar لمناقشة الموضوعات ذات الاهتمام المشترك مع بعضنا البعض ومع مطوري SugarCRM </td></tr>
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        'تم إنشاء هذا المستخدم كموظف. الرجاء الانتقال إلى وحدة "الموظف" لإجراء التغييرات.',

    'LBL_SYNC_KEY' => 'معرف مزامنة التكامل',

    'LBL_APPEARANCE' => 'المظهر',
    'LBL_APPEARANCE_DESC' => 'اختر الطريقة التي سيبدو بها Sugar بالنسبة لك. اتبع إعدادات جهازك أو اختر لاستخدام الوضع الفاتح أو الداكن على الدوام.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'نسخ المحتوى',
    'LNK_COPY_USER_SETTINGS' => 'نسخ إعدادات المستخدم',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'نسخ التفضيلات والمحتوى',
    'LBL_CLEAR' => 'مسح',
    'LBL_COPY' => 'نسخ',
    'LBL_COPY_ITEM' => 'نسخ البند:',
    'LBL_USER_PREFENRECES' => 'تفضيلات المستخدم',
    'LBL_FILTERS' => 'عامل التصفية',
    'LBL_DASHBOARDS_UTILS' => 'لوحة المعلومات',
    'LBL_DEFAULT_TEAMS' => 'الفرق الافتراضية',
    'LBL_FAVORITE_REPORTS' => 'التقارير المفضلة',
    'LBL_NAVBAR_SELECTION' => 'تحديد وحدة شريط التنقل',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'الإعلام عند التعيين',
    'LBL_REMINDER_OPTIONS' => 'خيارات التذكير',
    'LBL_SCHEDULED_REPORTING' => 'التقرير المجدول',
    'LBL_SUGAR_EMAIL_CLIENT' => 'عميل البريد الإلكتروني لـ Sugar',
    'LBL_EXISTING_DASHBOARD' => 'لوحة المعلومات الموجودة',
    'LBL_FROM_MODULES' => 'من الوحدات',
    'LBL_SELECT_MODULES' => 'تحديد الوحدة',
    'LBL_USER_UTILS_DATA_ERROR' => 'تتعذر استعادة البيانات',
    'LBL_FROM_USERS' => 'من المستخدم',
    'LBL_SELECT_DASHBOARDS' => 'تحديد لوحة المعلومات',
    'LBL_SELECT_FILTERS' => 'تحديد عامل التصفية',
    'LBL_EXISTING_FILTERS' => 'عامل التصفية الموجود',
    'LBL_SELECT_DESTINATION_USERS' => 'تحديد مستخدم الوجهة',
    'LBL_SELECT_DESTINATION_ROLES' => 'تحديد دور الوجهة',
    'LBL_SELECT_DESTINATION_TEAMS' => 'تحديد فريق الوجهة',
    'LBL_ITEMS_TO_REASSIGN' => 'بنود إعادة التعيين',
    'LBL_PROMPT_TIMEZONE_ON' => 'تشغيل',
    'LBL_PROMPT_TIMEZONE_OFF' => 'إيقاف',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'تحديث الإعدادات المحلية',
    'LBL_TO_TEAMS' => 'إلى الفريق',
    'LBL_TO_USERS' => 'إلى المستخدم',
    'LBL_TO_ROLES' => 'إلى الدور',
    'LBL_IN_PROGRESS' => 'قيد التقدم...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> أُعيد تعيينها إلى {{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' - <b>{{commands}} ({{count}})</b> أُعيد تعيينها إلى {{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> نُسخت في الوحدة: {{moduleList}} إلى {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'الرجاء تحديد المستخدمين أو الفرق أو الأدوار التي تريد التعيين إليها.',
    'LBL_NO_DASHBOARD' => 'الرجاء تحديد لوحات المعلومات التي تريد تعيينها.',
    'LBL_NO_MODULES' => 'الرجاء تحديد الوحدات للنسخ.',
    'LBL_NO_FILTERS' => 'الرجاء تحديد عوامل التصفية التي تريد تعيينها.',
    'LBL_NO_USER_PREFERENCES' => 'الرجاء تحديد تفضيلات المستخدم التي تريد تعيينها.',
    'LBL_NO_USER_SETTINGS' => 'الرجاء تحديد إعدادات المستخدم التي تريد تعيينها.',
    'LBL_DATA_NOT_RETRIEVED' => 'لم يتم استرداد البيانات',
    'LBL_UTILS_USER_TEAMS_ROLES' => 'المستخدمون/الفرق/الأدوار',
    'LBL_LOADING_ITEMS' => 'يتم الآن تحميل البيانات...',
    // END USER UTILS STRINGS
    'LBL_ACTIVE_USERS' => 'مستخدمون نشطون',
    'LBL_GROUP_USERS' => 'مستخدمين المجموعة',
    'LBL_USERS_LIST_DASHBOARD' => 'لوحة معلومات قائمة المستخدمين',
