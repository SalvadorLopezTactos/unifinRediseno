...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'Det går inte att begära lösenordsåterställning för användaren på grund av att IDM-licensieringsläget är aktiverat',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'Det går inte att begära lösenordsåterställning för användaren på grund av att system-e-postkontot inte är konfigurerat',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'Det går inte att begära lösenordsåterställning för användaren på grund av ogiltigt ID för e-postmallen',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'Det går inte att begära lösenordsåterställning för användaren på grund av att dess primära e-postadress är ogiltig',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'Det går inte att begära lösenordsåterställning för användaren på grund av att användaren måste ha administratörsåtkomst till modulen Användare',
    'ERR_PASSWORD_RESET_NO_USER' => 'Det går inte att begära lösenordsåterställning för obefintliga användare',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'Det går inte att begära lösenordsåterställning för användare av API-typen grupp eller portal',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'Ändra lösenord',
    ...
    'LBL_HIDDEN_MODULES' => 'Dolda moduler',
    ...
    'LBL_RESET_PASSWORD_WARNING_USER' => 'Är du säker på att du vill återställa lösenordet för den här användaren?',
    'LBL_NEW_USER_PASSWORD_RESET' => 'Ett e-postmeddelande med en lösenordsåterställningslänk har skickats till användaren.',
    ...
    'LBL_COOKIE_CONSENT' => 'Medgivande för cookie',
    'LBL_COOKIE_CONSENT_RECEIVED_ON' => 'Cookiemedgivande mottaget den',
    'LBL_QUOTAS' => 'Offerter',
    ...
    'LBL_BESIDE_FIELD_VALUE' => 'Bredvid fältvärde',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'Inställningarna för den här användaren har återställts.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'Det valda typsnittet kommer att tillämpas till texten i rubriken och brödtexten i PDF-dokumentet <br /> <br /> Om du får problem med att återge tecken för vissa språk kan du överväga att ändra typsnittet. Se dokumentet <a href="%s" target="_blank">Komma igång</a> för mer information.',
    'LBL_PDF_FONT_SIZE_MAIN' => 'Huvud font storlek',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'Font för sidfoten',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'Det valda typsnittet kommer att tillämpas till texten i sidfoten i PDF-dokumentet <br /> <br /> Om du får problem med att återge tecken för vissa språk kan du överväga att ändra typsnittet. Se dokumentet <a href="%s" target="_blank">Komma igång</a> för mer information.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'Inloggningsuppgifter för e-post',
    ...
    'LBL_MAIL_AUTHORIZE' => 'Auktorisera',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        'Denna användare skapades som en anställd. Var god gå till modulen Anställda för att föra ändringar.',

    'LBL_SYNC_KEY' => 'Integrationssynk-ID',

    'LBL_APPEARANCE' => 'Utseende',
    'LBL_APPEARANCE_DESC' => 'Välj hur Sugar ska se ut för dig. Följ inställningarna på din enhet eller välj att alltid använda ljust eller mörkt läge.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'Kopiera innehåll',
    'LNK_COPY_USER_SETTINGS' => 'Kopiera användarinställningar',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'Kopiera inställningar och innehåll',
    'LBL_CLEAR' => 'Rensa',
    'LBL_COPY' => 'Kopiera',
    'LBL_COPY_ITEM' => 'Kopiera post:',
    'LBL_USER_PREFENRECES' => 'Användarinställningar',
    'LBL_FILTERS' => 'Filter',
    'LBL_DASHBOARDS_UTILS' => 'Panel(er)',
    'LBL_DEFAULT_TEAMS' => 'Standardteam',
    'LBL_FAVORITE_REPORTS' => 'Favoritrapporter',
    'LBL_NAVBAR_SELECTION' => 'Val av navigeringsfältsmodul',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'Meddela vid tilldelning',
    'LBL_REMINDER_OPTIONS' => 'Påminnelsealternativ',
    'LBL_SCHEDULED_REPORTING' => 'Schemalagd rapportering',
    'LBL_SUGAR_EMAIL_CLIENT' => 'E-postklient för Sugar',
    'LBL_EXISTING_DASHBOARD' => 'Befintlig(a) panel(er)',
    'LBL_FROM_MODULES' => 'Från moduler',
    'LBL_SELECT_MODULES' => 'Välj modul(er)',
    'LBL_USER_UTILS_DATA_ERROR' => 'Kunde inte hämta data',
    'LBL_FROM_USERS' => 'Från användare',
    'LBL_SELECT_DASHBOARDS' => 'Välj panel(er)',
    'LBL_SELECT_FILTERS' => 'Välj filter',
    'LBL_EXISTING_FILTERS' => 'Befintligt/befintliga filter',
    'LBL_SELECT_DESTINATION_USERS' => 'Välj målanvändare',
    'LBL_SELECT_DESTINATION_ROLES' => 'Välj målroll(er)',
    'LBL_SELECT_DESTINATION_TEAMS' => 'Välj målteam',
    'LBL_ITEMS_TO_REASSIGN' => 'Poster att omplacera',
    'LBL_PROMPT_TIMEZONE_ON' => 'På',
    'LBL_PROMPT_TIMEZONE_OFF' => 'Av',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'Uppdatering av språkinställningar',
    'LBL_TO_TEAMS' => 'Till team',
    'LBL_TO_USERS' => 'Till användare',
    'LBL_TO_ROLES' => 'Till roll(er)',
    'LBL_IN_PROGRESS' => 'Pågår...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> omplacerades till {{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' - <b>{{commands}} ({{count}})</b> omplacerades till {{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> klonades på modul(er): {{moduleList}} till {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'Välj de användare, team eller roller som du vill tilldela till.',
    'LBL_NO_DASHBOARD' => 'Välj de paneler du vill tilldela.',
    'LBL_NO_MODULES' => 'Välj de moduler som ska klonas.',
    'LBL_NO_FILTERS' => 'Välj de filter du vill tilldela.',
    'LBL_NO_USER_PREFERENCES' => 'Välj de användarpreferenser du vill tilldela.',
    'LBL_NO_USER_SETTINGS' => 'Välj de användarinställningar du vill tilldela.',
    'LBL_DATA_NOT_RETRIEVED' => 'Data hämtades inte',
    ...
    'LBL_GROUP_USERS' => 'Gruppanvändare',
    'LBL_USERS_LIST_DASHBOARD' => 'Kontrollpanel för användarlistor',
