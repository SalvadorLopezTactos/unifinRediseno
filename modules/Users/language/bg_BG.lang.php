...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'Не може да се поиска нулиране на паролата за потребителя, режимът на лицензиране на IDM е разрешен',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'Не може да се поиска нулиране на паролата за потребителя, системният имейл акаунт не е конфигуриран',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'Не може да се поиска нулиране на паролата за потребител, невалиден ИД на шаблон за имейл',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'Не може да се поиска нулиране на паролата за потребителя, основният имейл адрес на потребителя е невалиден',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'Не може да се поиска нулиране на паролата за потребителя, трябва да има администраторски достъп до модула „Потребители"',
    'ERR_PASSWORD_RESET_NO_USER' => 'Не може да се поиска нулиране на паролата за несъществуващ потребител',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'Не може да се поиска нулиране на паролата за потребители от тип а API на група или портал',
    ...
    'ERR_USER_LICENSE_TYPE_OFFERRED_IN_BUNDLES' => 'Тази способност вече е включена в Sugar Sell Premier.',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'Смяна на парола',
    ...
    'LBL_CHOOSE_WHICH' => 'Изберете кои модули да са достъпни в страничната лента за навигация. Определете реда, в който желаете да се показват модулите.',
    'LBL_NUMBER_PINNED_MODULES' => 'Брой фиксирани модули',
    'LBL_NUMBER_PINNED_MODULES_DESC' => 'Въведете броя на наличните модули, които да се фиксират, когато лентата за навигация е свита (напр. ако въведете 5, първите пет модула от вашия списък ще бъдат фиксирани). Препоръчваме ви да посочите стойност, която съответства на броя на най-често използваните модули. Стойности, по-големи от 100, няма да бъдат спазени.',
    'LBL_CITY' => 'Град',
    ...
    'LBL_HIDDEN_MODULES' => 'Скрити модули',
    ...
    'LBL_PASSWORD_USER_RESET' => 'Нулиране на потребителска парола',
    'LBL_RESET_PASSWORD_WARNING_USER' => 'Наистина ли искате да нулирате паролата за този потребител?',
    'LBL_NEW_USER_PASSWORD_RESET' => 'На потребителя е изпратен имейл, съдържащ линк за нулиране на паролата му.',
    ...
    'LBL_COOKIE_CONSENT' => 'Одобрение на "бисквитките"',
    'LBL_COOKIE_CONSENT_RECEIVED_ON' => 'Одобрението на "бисквитките" е получено на',
    'LBL_QUOTAS' => 'Квоти',
    ...
    'LBL_BESIDE_FIELD_VALUE' => 'До стойност на поле',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'Предпочитанията за този потребител бяха нулирани успешно.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'Избраният шрифт ще бъде приложен към текста в горния колонтитул и тялото на PDF документа <br /> <br /> Ако имате проблеми с изобразяването на знаци за определени езици, помислете за промяна на шрифта. Обърнете се към документацията <a href="%s" target="_blank">Първи стъпки</a> за повече информация.',
    'LBL_PDF_FONT_SIZE_MAIN' => 'Размер на основен шрифт',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'Врифт за "Footer"',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'Избраният шрифт ще бъде приложен към текста в долния колонтитул на PDF документа <br /> <br /> Ако имате проблеми с изобразяването на знаци за определени езици, помислете за промяна на шрифта. Обърнете се към документацията <a href="%s" target="_blank">Първи стъпки</a> за повече информация.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'Идентификационни данни за електронан поща',
    ...
    'LBL_MAIL_AUTHORIZED_ACCOUNT' => 'Оторизиран имейл акаунт',
    'LBL_MAIL_AUTHORIZE' => 'Оторизиране',
...
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Sugar Community to discuss topics of interest with each other and with SugarCRM Developers</td></tr>
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        'Този потребител е създал служител. Отидете в модула "Служител", за да направите промени.',

    'LBL_SYNC_KEY' => 'ИД на синхронизация на интеграция',

    'LBL_APPEARANCE' => 'Външен вид',
    'LBL_APPEARANCE_DESC' => 'Изберете как да виждате Sugar. Следвайте настройките на вашето устройство или изберете винаги да използвате светъл или тъмен режим.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'Копиране на съдържание',
    'LNK_COPY_USER_SETTINGS' => 'Копиране на потребителски настройки',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'Копиране на предпочитания и съдържание',
    'LBL_CLEAR' => 'Изчисти',
    'LBL_COPY' => 'Копирай',
    'LBL_COPY_ITEM' => 'Копиране на позиция:',
    'LBL_USER_PREFENRECES' => 'Потребителски предпочитания',
    'LBL_FILTERS' => 'Филтър(и)',
    'LBL_DASHBOARDS_UTILS' => 'Електронно табло(а)',
    'LBL_DEFAULT_TEAMS' => 'Екипи по подразбиране',
    'LBL_FAVORITE_REPORTS' => 'Предпочитани справки',
    'LBL_NAVBAR_SELECTION' => 'Избор на модул от лента за навигация',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'Уведомление при задание',
    'LBL_REMINDER_OPTIONS' => 'Опции за напомняне',
    'LBL_SCHEDULED_REPORTING' => 'Насрочено отчитане',
    'LBL_SUGAR_EMAIL_CLIENT' => 'Клиент на Sugar Email',
    'LBL_EXISTING_DASHBOARD' => 'Съществуващо електронно табло(а)',
    'LBL_FROM_MODULES' => 'От модули',
    'LBL_SELECT_MODULES' => 'Изберете модул(и)',
    'LBL_USER_UTILS_DATA_ERROR' => 'Не могат да се извлекат данни',
    'LBL_FROM_USERS' => 'От потребител',
    'LBL_SELECT_DASHBOARDS' => 'Избери електронно(и) табло(а)',
    'LBL_SELECT_FILTERS' => 'Избери филтър(и)',
    'LBL_EXISTING_FILTERS' => 'Съществуващ филтър (и)',
    'LBL_SELECT_DESTINATION_USERS' => 'Избери потребител(и) на дестинация',
    'LBL_SELECT_DESTINATION_ROLES' => 'Избери роля(и) на дестинация',
    'LBL_SELECT_DESTINATION_TEAMS' => 'Избери екип(и) на дестинация',
    'LBL_ITEMS_TO_REASSIGN' => 'Позиции към Преназначаване',
    'LBL_PROMPT_TIMEZONE_ON' => 'Вкл.',
    'LBL_PROMPT_TIMEZONE_OFF' => 'Изкл.',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'Актуализиране на регионални настройки',
    'LBL_TO_TEAMS' => 'До екип(и)',
    'LBL_TO_USERS' => 'Към потребител(и)',
    'LBL_TO_ROLES' => 'Към роля(и)',
    'LBL_IN_PROGRESS' => 'В процес на изпълнение...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> беше преназначен към {{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' - <b>{{commands}} ({{count}})</b> беше преназначен към {{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> беше клониран на модул(и): {{moduleList}} до {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'Моля, изберете потребителите, екипити или ролите, към които искате да назначите.',
    'LBL_NO_DASHBOARD' => 'Моля, изберете електронните табла, които искате да назначите.',
    'LBL_NO_MODULES' => 'Моля, изберете модулите за клониране.',
    'LBL_NO_FILTERS' => 'Моля, изберете филтрите, които искате да назначите.',
    'LBL_NO_USER_PREFERENCES' => 'Моля, изберете потребителските предпочитания, които искате да назначите.',
    'LBL_NO_USER_SETTINGS' => 'Моля, изберете потребителските настройки, които искате да назначите.',
    'LBL_DATA_NOT_RETRIEVED' => 'Не са извлечени данни',
    'LBL_UTILS_USER_TEAMS_ROLES' => 'потребители/екипи/роли',
    'LBL_LOADING_ITEMS' => 'Зареждане на данни...',
    // END USER UTILS STRINGS
    'LBL_ACTIVE_USERS' => 'Активни потребители',
    'LBL_GROUP_USERS' => 'Група потребители',
    'LBL_USERS_LIST_DASHBOARD' => 'Табло на списък с потребители',

    // Sugar Automate
    'LBL_CUSTOMER_JOURNEY_ACCESS' => 'Достъп до интелигентното ръководство',
    'LBL_CUSTOMER_JOURNEY_LAST_ACTIVE' => 'Последно активно интелигентно ръководство',
    'LBL_FILTER_MISSING_CUSTOMER_JOURNEY_ACCESS' => 'Липсващ достъп до интелигентното ръководство',
]; // END STRINGS DEFS
