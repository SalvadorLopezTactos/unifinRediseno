...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'Nem lehet jelszó-visszaállítást kérni a felhasználónak, az IDM-licencmód engedélyezve van',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'Nem lehet jelszó-visszaállítást kérni a felhasználónak, a rendszer e-mail-fiókja nincs beállítva',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'Nem lehet visszaállítani a felhasználó jelszavát, érvénytelen e-mail-sablon azonosító',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'Nem lehet jelszó-visszaállítást kérni a felhasználónak, a felhasználó elsődleges e-mail-címe érvénytelen',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'Nem lehet jelszó-visszaállítást kérni a felhasználónak, rendszergazdai jogosultsággal kell rendelkeznie a Felhasználók modulhoz',
    'ERR_PASSWORD_RESET_NO_USER' => 'Nem lehet jelszó-visszaállítást kérni egy nem létező felhasználóra',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'Nem lehet jelszó-visszaállítást kérni a csoport vagy Portal API felhasználótípusnak',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'Jelszó megváltoztatása',
    ...
    'LBL_POPUP_REMINDER_TIME' => 'Felugró emlékeztető időpontja',
    ...
    'LBL_HIDDEN_MODULES' => 'Elrejtett modulok',
    ...
    'LBL_PASSWORD_USER_RESET' => 'Felhasználó jelszavának visszaállítása',
    'LBL_RESET_PASSWORD_WARNING_USER' => 'Biztosan vissza szeretné állítani ennek a felhasználónak a jelszavát?',
    'LBL_NEW_USER_PASSWORD_RESET' => 'A felhasználó emailben fogja megkapni a jelszó visszaállításához szükséges hivatkozást.',
    ...
    'LBL_BESIDE_FIELD_VALUE' => 'Mezőérték mellett',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'A felhasználó beállításai sikeresen alaphelyzetbe lettek állítva.',
    ...
    'LBL_MY_ACCESS' => 'SAJÁT HOZZÁFÉRÉS',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'A kiválasztott betűtípus a PDF-dokumentum fejlécében és törzsében lévő szövegre lesz alkalmazva <br /> <br /> Ha problémái vannak a karakterek megjelenítésével bizonyos nyelvek esetében, fontolja meg a betűtípus módosítását. Lásd a <a href="%s" target="_blank">Kezdetekhez</a> dokumentációt további információkért.',
    'LBL_PDF_FONT_SIZE_MAIN' => 'Elsődleges betűméret',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'Lábléc betűtípusa',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'A kiválasztott betűtípus a PDF-dokumentum láblécében lévő szövegre lesz alkalmazva <br /> <br /> Ha problémái vannak a karakterek megjelenítésével bizonyos nyelvek esetében, fontolja meg a betűtípus módosítását. Lásd a <a href="%s" target="_blank">Kezdetekhez</a> dokumentációt további információkért.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'E-mail azonosítók',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        'Ez a felhasználó munkavállalóként lett létrehozva. Lépjen a Munkavállaló modulhoz, ha módosítani szeretné.',

    'LBL_SYNC_KEY' => 'Integrálási szinkronizálás azonosító',

    'LBL_APPEARANCE' => 'Külső',
    'LBL_APPEARANCE_DESC' => 'Válassza ki, hogy milyen külsővel szeretné használni a Sugart. Kövesse az eszköze beállításait vagy válassza ki, hogy mindig a világos vagy sötét üzemmódot használja.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'Tartalom másolása',
    'LNK_COPY_USER_SETTINGS' => 'Felhasználói beállítások másolása',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'Beállítások és tartalom másolása',
    'LBL_CLEAR' => 'Töröl',
    'LBL_COPY' => 'Másolás',
    'LBL_COPY_ITEM' => 'Tétel másolása:',
    'LBL_USER_PREFENRECES' => 'Felhasználói beállítások',
    'LBL_FILTERS' => 'Szűrő(k)',
    'LBL_DASHBOARDS_UTILS' => 'Műszerfal(ak)',
    'LBL_DEFAULT_TEAMS' => 'Alapértelmezett csoportok',
    'LBL_FAVORITE_REPORTS' => 'Kedvenc jelentéseim',
    'LBL_NAVBAR_SELECTION' => 'Navigációs sáv moduljának kiválasztása',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'A feladatot vette',
    'LBL_REMINDER_OPTIONS' => 'Emlékeztető beállítása',
    'LBL_SCHEDULED_REPORTING' => 'Beütemezett jelentéstétel',
    'LBL_SUGAR_EMAIL_CLIENT' => 'SugarCRM mail-kliens',
    'LBL_EXISTING_DASHBOARD' => 'Létező műszerfal(ak)',
    'LBL_FROM_MODULES' => 'Modulokból',
    'LBL_SELECT_MODULES' => 'Modul(ok) kiválasztása',
    'LBL_USER_UTILS_DATA_ERROR' => 'Nem sikerült lekérni az adatokat',
    'LBL_FROM_USERS' => 'Felhasználótól',
    'LBL_SELECT_DASHBOARDS' => 'Műszerfal(ak) kiválasztása',
    'LBL_SELECT_FILTERS' => 'Szűrő(k) kiválasztása',
    'LBL_EXISTING_FILTERS' => 'Létező szűrő(k)',
    'LBL_SELECT_DESTINATION_USERS' => 'Célfelhasználó(k) kiválasztása',
    'LBL_SELECT_DESTINATION_ROLES' => 'Célszerepkör(ök) kiválasztása',
    'LBL_SELECT_DESTINATION_TEAMS' => 'Célcsapat(ok) kiválasztása',
    'LBL_ITEMS_TO_REASSIGN' => 'Újra hozzárendelendő tételek',
    'LBL_PROMPT_TIMEZONE_ON' => 'Be',
    'LBL_PROMPT_TIMEZONE_OFF' => 'Ki',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'Helyi beállítások frissítése',
    'LBL_TO_TEAMS' => 'Csoport(ok)nak',
    'LBL_TO_USERS' => 'Felhasználó(k)nak',
    'LBL_TO_ROLES' => 'Szerepkör(ök)nek',
    'LBL_IN_PROGRESS' => 'Folyamatban...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> átütemezésre kerültek ide: {{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => '- <b>{{commands}} ({{count}})</b> átütemezésre kerültek ide: {{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> klónozva lettek a következő modul(ok) on: {{moduleList}} erre: {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'Kérjük, válassza ki azokat a felhasználókat, csapatokat vagy szerepköröket, amelyekhez hozzá szeretne rendelni.',
    'LBL_NO_DASHBOARD' => 'Válassza ki a hozzárendelni kívánt műszerfalakat.',
    'LBL_NO_MODULES' => 'Kérjük, válassza ki a klónozni kívánt modulokat.',
    'LBL_NO_FILTERS' => 'Válassza ki a hozzárendelni kívánt szűrőket.',
    'LBL_NO_USER_PREFERENCES' => 'Válassza ki a hozzárendelni kívánt felhasználói beállításokat.',
    'LBL_NO_USER_SETTINGS' => 'Válassza ki a hozzárendelni kívánt felhasználói beállításokat.',
    'LBL_DATA_NOT_RETRIEVED' => 'Az adatot nem sikerült beszerezni',
    ...
    'LBL_GROUP_USERS' => 'Felhasználócsoportok',
    'LBL_USERS_LIST_DASHBOARD' => 'Felhasználólista-műszerfal',
