...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'Nu se poate solicita resetarea parolei pentru Utilizator, este activat modul de licențiere IDM',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'Nu se poate solicita resetarea parolei pentru Utilizator, contul de e-mail de sistem nu este configurat',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'Nu se poate solicita resetarea parolei pentru Utilizator, ID-ul șablonului de e-mail nu este valid',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'Nu se poate solicita resetarea parolei pentru Utilizator, adresa de e-mail principală a Utilizatorului nu este validă',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'Nu se poate solicita resetarea parolei pentru Utilizator, este necesar accesul de administrator la modulul Utilizatori',
    'ERR_PASSWORD_RESET_NO_USER' => 'Nu se poate solicita resetarea parolei pentru un Utilizator inexistent',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'Nu se poate solicita resetarea parolei pentru utilizatorii de tip grup sau portal API',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'Modifcare parolă',
    ...
    'LBL_CITY' => 'Oraş',
    'LBL_EMAIL_REMINDER_TIME' => 'Oră memento prin e-mail',
    ...
    'LBL_HIDDEN_MODULES' => 'Module ascunse',
    ...
    'LBL_PASSWORD_USER_RESET' => 'Resetați parola Utilizatorului',
    'LBL_RESET_PASSWORD_WARNING_USER' => 'Sigur doriți să resetați parola pentru acest utilizator?',
    'LBL_NEW_USER_PASSWORD_RESET' => 'Un e-mail a fost trimis către utilizator, cu un link pentru resetarea parolei.',
    ...
    'LBL_COOKIE_CONSENT' => 'Consimțământ module cookie',
    'LBL_COOKIE_CONSENT_RECEIVED_ON' => 'Consimțământ module cookie primit la',
    ...
    'LBL_BESIDE_FIELD_VALUE' => 'Lângă valoarea câmpului',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'Preferințele pentru acest utilizator au fost resetate cu succes.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'Fontul selectat va fi aplicat textului din antet și corpului documentului PDF <br /> <br /> Dacă aveți probleme la redarea caracterelor pentru anumite limbi, luați în considerare modificarea fontului. Consultați <a href="%s" target="_blank">Introducere</a> documentația pentru mai multe informații.',
    'LBL_PDF_FONT_SIZE_MAIN' => 'Dimensiune font Principal',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'Font pentru subsol',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'Fontul selectat va fi aplicat textului din subsolul documentului PDF <br /> <br /> Dacă aveți probleme la redarea caracterelor pentru anumite limbi, luați în considerare modificarea fontului. Consultați <a href="%s" target="_blank">Introducere</a> documentația pentru mai multe informații.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'Acreditări de e-mail',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        'Acest utilizator este creat ca angajat. Mergeți la modulul Angajat pentru a face modificări.',

    'LBL_SYNC_KEY' => 'ID sincronizare integrare',

    'LBL_APPEARANCE' => 'Aspect',
    'LBL_APPEARANCE_DESC' => 'Alegeți felul în care este afișat Sugar. Aplicați setările pe dispozitivul dumneavoastră sau alegeți să folosiți permament modul deschis sau modul întunecat.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'Copiere conținut',
    'LNK_COPY_USER_SETTINGS' => 'Copiere setări utilizator',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'Copiere preferințe și conținut',
    'LBL_CLEAR' => 'Ștergere',
    'LBL_COPY' => 'Copiere',
    'LBL_COPY_ITEM' => 'Copiere element:',
    'LBL_USER_PREFENRECES' => 'Preferinţe utilizator',
    'LBL_FILTERS' => 'Filtru (filtre)',
    'LBL_DASHBOARDS_UTILS' => 'Tablou (tablouri) de bord',
    'LBL_DEFAULT_TEAMS' => 'Echipe implicite',
    'LBL_FAVORITE_REPORTS' => 'Rapoarte favorite',
    'LBL_NAVBAR_SELECTION' => 'Selectarea modulelor din bara de navigare',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'Notificare la atribuire',
    'LBL_REMINDER_OPTIONS' => 'Opțiuni de memento',
    'LBL_SCHEDULED_REPORTING' => 'Raportare programată',
    'LBL_SUGAR_EMAIL_CLIENT' => 'Client e-mail Sugar',
    'LBL_EXISTING_DASHBOARD' => 'Tablou (tablouri) de bord existent (existente)',
    'LBL_FROM_MODULES' => 'Din module',
    'LBL_SELECT_MODULES' => 'Selectați modulul (modulele)',
    'LBL_USER_UTILS_DATA_ERROR' => 'Nu se pot regăsi datele',
    'LBL_FROM_USERS' => 'De la utilizator',
    'LBL_SELECT_DASHBOARDS' => 'Selectați tabloul (tablourile) de bord',
    'LBL_SELECT_FILTERS' => 'Selectați filtrul (filtrele)',
    'LBL_EXISTING_FILTERS' => 'Filtru (filtre) existent (existente)',
    'LBL_SELECT_DESTINATION_USERS' => 'Selectați utilizatorul (utilizatorii) de destinație',
    'LBL_SELECT_DESTINATION_ROLES' => 'Selectați rolul (rolurile) de destinație',
    'LBL_SELECT_DESTINATION_TEAMS' => 'Selectați echipa (echipele) de destinație',
    'LBL_ITEMS_TO_REASSIGN' => 'Elemente de reatribuit',
    'LBL_PROMPT_TIMEZONE_ON' => 'Pornit',
    'LBL_PROMPT_TIMEZONE_OFF' => 'Oprit',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'Actualizare setări locale',
    'LBL_TO_TEAMS' => 'Către echipă (echipe)',
    'LBL_TO_USERS' => 'Către utilizator (utilizatori)',
    'LBL_TO_ROLES' => 'Către rol (roluri)',
    'LBL_IN_PROGRESS' => 'În curs...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> au fost reatribuite către {{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' - <b>{{commands}} ({{count}})</b> au fost reatribuite către {{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> au fost clonate pe modulul (modulele): {{moduleList}} to {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'Selectați utilizatorii, echipele sau rolurile cărora doriți să le atribuiți.',
    'LBL_NO_DASHBOARD' => 'Selectați tablourile de bord pe care doriți să le atribuiți.',
    'LBL_NO_MODULES' => 'Selectați modulele pentru clonare.',
    'LBL_NO_FILTERS' => 'Selectați filtrele pe care doriți să le atribuiți.',
    'LBL_NO_USER_PREFERENCES' => 'Selectați preferințele de utilizator pe care doriți să le atribuiți.',
    'LBL_NO_USER_SETTINGS' => 'Selectați setările de utilizator pe care doriți să le atribuiți.',
    'LBL_DATA_NOT_RETRIEVED' => 'Datele nu au fost preluate',
    ...
    'LBL_GROUP_USERS' => 'Utilizatori de grup',
    'LBL_USERS_LIST_DASHBOARD' => 'Tabloul de bord listă utilizatori',
