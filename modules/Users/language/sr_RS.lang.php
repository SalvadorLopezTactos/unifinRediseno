...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'Nije moguće zahtevati resetovanje lozinke za korisnika, omogućen je režim licenciranja IDM',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'Nije moguće zahtevati resetovanje lozinke za korisnika, sistemski imejl nalog nije konfigurisan',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'Nije moguće zahtevati resetovanje lozinke za korisnika, nevažeći ID šablona imejla',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'Nije moguće zahtevati resetovanje lozinke za korisnika, primarna imejl adresa korisnika je nevažeća',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'Nije moguće zahtevati resetovanje lozinke za korisnika, morate da imate administratorski pristup modulima korisnika',
    'ERR_PASSWORD_RESET_NO_USER' => 'Nije moguće zahtevati resetovanje lozinke za nepostojećeg korisnika',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'Nije moguće zahtevati resetovanje lozinke za grupu ili korisnike vrste API Portal',
    ...
    'ERR_USER_LICENSE_TYPE_OFFERRED_IN_BUNDLES' => 'Ova mogućnost je već uključena u Sugar Sell Premier.',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'Promena lozinke',
    ...
    'LBL_CHOOSE_WHICH' => 'Izaberite koji moduli su dostupni pomoću bočne trake za navigaciju. Odredite redosled prikazivanja modula.',
    'LBL_NUMBER_PINNED_MODULES' => 'Broj zakačenih modula',
    'LBL_NUMBER_PINNED_MODULES_DESC' => 'Upišite broj modula koji su dostupni za kačenje kada se traka za navigaciju spusti (npr. ako je uneto 5, prvih pet modula na listi će biti zakačeni). Preporučujemo broj koji predstavlja module koji se najviše koriste. Vrednosti preko 100 neće biti uzete u obzir.',
    'LBL_CITY' => 'Grad',
    'LBL_EMAIL_REMINDER_TIME' => 'Vreme imejl podsetnika',
    'LBL_POPUP_REMINDER_TIME' => 'Vreme podsetnika sa iskačućim prozorom',
    ...
    'LBL_PASSWORD_USER_RESET' => 'Resetuj lozinku korisnika',
    'LBL_RESET_PASSWORD_WARNING_USER' => 'Da li ste sigurni da želite da resetujete lozinku za ovog korisnika?',
    'LBL_NEW_USER_PASSWORD_RESET' => 'Korisniku je poslat imejl sa linkom za resetovanje lozinke.',
    ...
    'LBL_BESIDE_FIELD_VALUE' => 'Pored vrednosti polja',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'Željene postavke za ovog korisnika su uspešno resetovane.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'Izabrani font će biti primenjen na tekst u zaglavlju i telu PDF dokumenta <br /> <br /> Ako imate problema sa prikazivanjem znakova za određene jezike, razmislite o promeni fonta. Pogledajte dokumentaciju <a href="%s" target="_blank">Početni koraci</a> za više informacija.',
    'LBL_PDF_FONT_SIZE_MAIN' => 'Veličina Glavnog Fonta',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'Font za donje zaglavlje',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'Izabrani font će biti primenjen na tekst u podnožju stranice i telu PDF dokumenta <br /> <br /> Ako imate problema sa prikazivanjem znakova za određene jezike, razmislite o promeni fonta. Pogledajte dokumentaciju <a href="%s" target="_blank">Početni koraci</a> za više informacija.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'Imejl akreditivi',
    ...
    'LBL_MAIL_AUTHORIZED_ACCOUNT' => 'Autorizovani imejl nalog',
    'LBL_MAIL_AUTHORIZE' => 'Autorizuj',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        'Ovaj korisnik je kreiran kao zaposleni. Da biste uneli izmene idite na modul za zaposlene.',

    'LBL_SYNC_KEY' => 'Integracija ID sinhronizacije',

    'LBL_APPEARANCE' => 'Izgled',
    'LBL_APPEARANCE_DESC' => 'Izaberite kako će Sugar izgledati. Pratite podešavanja na uređaju ili izaberite da uvek koristite svetli ili tamni režim.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'Kopiraj sadržaj',
    'LNK_COPY_USER_SETTINGS' => 'Kopiraj podešavanja korisnika',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'Kopiraj željena podešavanja i sadržaj',
    'LBL_CLEAR' => 'Obriši',
    'LBL_COPY' => 'Kopiraj',
    'LBL_COPY_ITEM' => 'Kopiraj stavku:',
    'LBL_USER_PREFENRECES' => 'Podešavanja korisnika',
    'LBL_FILTERS' => 'Filter(i)',
    'LBL_DASHBOARDS_UTILS' => 'Kontrolna(e) tabla(e)',
    'LBL_DEFAULT_TEAMS' => 'Podrazumevani timovi',
    'LBL_FAVORITE_REPORTS' => 'Omiljeni izveštaji',
    'LBL_NAVBAR_SELECTION' => 'Odabir modula na traci za navigaciju',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'Obaveštavanje pri dodeli',
    'LBL_REMINDER_OPTIONS' => 'Opcije podsetnika',
    'LBL_SCHEDULED_REPORTING' => 'Zakazano izveštavanje',
    'LBL_SUGAR_EMAIL_CLIENT' => 'Sugar klijent za e-poštu',
    'LBL_EXISTING_DASHBOARD' => 'Postojeće kontrolne table',
    'LBL_FROM_MODULES' => 'Iz modula',
    'LBL_SELECT_MODULES' => 'Izaberi modul(e)',
    'LBL_USER_UTILS_DATA_ERROR' => 'Preuzimanje podataka nije moguće',
    'LBL_FROM_USERS' => 'Od korisnika',
    'LBL_SELECT_DASHBOARDS' => 'Izaberi kontrolnu(e) tablu(e)',
    'LBL_SELECT_FILTERS' => 'Izaberi filter(e)',
    'LBL_EXISTING_FILTERS' => 'Postojeći filter(i)',
    'LBL_SELECT_DESTINATION_USERS' => 'Izaberi ciljnog korisnika ili korisnike',
    'LBL_SELECT_DESTINATION_ROLES' => 'Izaberi ciljnu ulogu ili uloge',
    'LBL_SELECT_DESTINATION_TEAMS' => 'Izaberi ciljni tim ili timove',
    'LBL_ITEMS_TO_REASSIGN' => 'Stavke za ponovnu dodelu',
    'LBL_PROMPT_TIMEZONE_ON' => 'Uklj.',
    'LBL_PROMPT_TIMEZONE_OFF' => 'Isklj.',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'Ažuriranje podešavanja za lokalitet',
    'LBL_TO_TEAMS' => 'Za tim(ove)',
    'LBL_TO_USERS' => 'Za korisnike',
    'LBL_TO_ROLES' => 'Za ulogu(e)',
    'LBL_IN_PROGRESS' => 'U toku...',
    'LBL_COPY_CONTENT_SUCCESS' => ' – Komande <b>{{commands}}</b> su ponovo dodeljene na {{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' – Komande <b>{{commands}} ({{count}})</b> su ponovo dodeljene na {{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' – Komande <b>{{commands}}</b> su klonirane na modulima: {{moduleList}} na {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'Izaberite korisnike, timove ili uloge kojima želite da ih dodelite.',
    'LBL_NO_DASHBOARD' => 'Izaberite kontrolne table koje želite da dodelite.',
    'LBL_NO_MODULES' => 'Izaberite module koje želite da klonirate.',
    'LBL_NO_FILTERS' => 'Izaberite filtere koje želite da dodelite.',
    'LBL_NO_USER_PREFERENCES' => 'Izaberite željena podešavanja korisnika koja želite da dodelite.',
    'LBL_NO_USER_SETTINGS' => 'Izaberite korisnička podešavanja koja želite da dodelite.',
    'LBL_DATA_NOT_RETRIEVED' => 'Podaci nisu preuzeti',
    ...
    'LBL_GROUP_USERS' => 'Grupni korisnici',
    'LBL_USERS_LIST_DASHBOARD' => 'Kontrolna tabla liste korisnika',

    // Sugar Automate
    'LBL_CUSTOMER_JOURNEY_ACCESS' => 'Smart Guide pristup',
    'LBL_CUSTOMER_JOURNEY_LAST_ACTIVE' => 'Smart Guide poslednja aktivnost',
    'LBL_FILTER_MISSING_CUSTOMER_JOURNEY_ACCESS' => 'Smart Guide pristup nedostaje',
]; // END STRINGS DEFS
