...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'Impossibile richiedere la reimpostazione della password per l&#39;utente. È abilitata la modalità di gestione delle licenze IDM',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'Impossibile richiedere la reimpostazione della password per l&#39;utente. L&#39;account e-mail del sistema non è configurato',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'Impossibile richiedere la reimpostazione della password per l&#39;utente. L&#39;ID del modello di e-mail non è valido',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'Impossibile richiedere la reimpostazione della password per l&#39;utente. L&#39;indirizzo e-mail principale dell&#39;utente non è valido',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'Impossibile richiedere la reimpostazione della password per l&#39;utente. È necessario disporre dell&#39;accesso come amministratore al modulo Utenti',
    'ERR_PASSWORD_RESET_NO_USER' => 'Impossibile richiedere la reimpostazione della password per un utente non esistente',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'Impossibile richiedere la reimpostazione della password per gli utenti di tipo Gruppo o API portale',
    ...
    'ERR_USER_LICENSE_TYPE_OFFERRED_IN_BUNDLES' => 'Questa funzionalità è già inclusa in Sugar Sell Premier.',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'Cambia password',
    ...
    'LBL_CHOOSE_WHICH' => 'Scegliere i moduli accessibili dalla barra di navigazione laterale. Stabilire l&#39;ordine in cui si desidera compaiano i moduli.',
    'LBL_NUMBER_PINNED_MODULES' => 'Numero di moduli bloccati',
    'LBL_NUMBER_PINNED_MODULES_DESC' => 'Scrivere il numero di moduli disponibili da lasciare bloccati quando si comprime la barra di navigazione (es., se si immette 5 vengono bloccati i primi cinque moduli dell&#39;elenco). È consigliabile un numero che rappresenti i moduli usati più di frequente. I valori superiori a 100 non saranno applicati.',
    'LBL_CITY' => 'Comune',
    'LBL_EMAIL_REMINDER_TIME' => 'Orario promemoria email',
    ...
    'LBL_HIDDEN_MODULES' => 'Moduli nascosti',
    ...
    'LBL_RESET_PASSWORD_WARNING_USER' => 'Reimpostare la password per questo utente?',
    'LBL_NEW_USER_PASSWORD_RESET' => 'All&#39;utente è stata inviata un&#39;email contenente un collegamento per reimpostare la password.',
    ...
    'LBL_BESIDE_FIELD_VALUE' => 'Accanto al valore campo',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'Le preferenze per questo utente sono state reimpostate correttamente.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'Il carattere selezionato verrà applicato al testo nell&#39;intestazione e nel corpo del documento PDF <br /> <br /> Se riscontri problemi nel rendering dei caratteri per determinate lingue, valuta la possibilità di cambiare il carattere. Per ulteriori informazioni, fai riferimento alla documentazione <a href="%s" target="_blank">Per iniziare</a>.',
    ...
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'Il carattere selezionato verrà applicato al testo nel piè di pagina del documento PDF <br /> <br /> Se riscontri problemi nel rendering dei caratteri per determinate lingue, valuta la possibilità di cambiare il carattere. Per ulteriori informazioni, fai riferimento alla documentazione <a href="%s" target="_blank">Per iniziare</a>.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'Credenziali email',
    ...
    'LBL_MAIL_AUTHORIZED_ACCOUNT' => 'Account e-mail autorizzato',
    'LBL_MAIL_AUTHORIZE' => 'Autorizza',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        'Questo utente è stato creato come dipendente. Andare al modulo Dipendente per effettuare modifiche.',

    'LBL_SYNC_KEY' => 'ID sincronizzazione integrazione',

    'LBL_APPEARANCE' => 'Aspetto',
    'LBL_APPEARANCE_DESC' => 'Scegli l&#39;aspetto di Sugar. Segui le impostazioni del tuo dispositivo o scegli di utilizzare sempre la modalità chiara o scura.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'Copia contenuto',
    'LNK_COPY_USER_SETTINGS' => 'Copia Impostazioni Utente',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'Copia Preferenze e Contenuto',
    'LBL_CLEAR' => 'Azzera',
    'LBL_COPY' => 'Copia',
    'LBL_COPY_ITEM' => 'Copia elemento:',
    'LBL_USER_PREFENRECES' => 'Preferenze Utente',
    'LBL_FILTERS' => 'Filtri',
    'LBL_DASHBOARDS_UTILS' => 'Dashboard',
    'LBL_DEFAULT_TEAMS' => 'Team predefiniti',
    'LBL_FAVORITE_REPORTS' => 'Report preferiti',
    'LBL_NAVBAR_SELECTION' => 'Selezione del modulo della barra di navigazione',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'Notifica di Assegnazione',
    'LBL_REMINDER_OPTIONS' => 'Opzioni di promemoria',
    'LBL_SCHEDULED_REPORTING' => 'Report pianificato',
    'LBL_SUGAR_EMAIL_CLIENT' => 'Client email di Sugar',
    'LBL_EXISTING_DASHBOARD' => 'Dashboard esistenti',
    'LBL_FROM_MODULES' => 'Da moduli',
    'LBL_SELECT_MODULES' => 'Selezionare Modulo',
    'LBL_USER_UTILS_DATA_ERROR' => 'Impossibile Recuperare i dati',
    'LBL_FROM_USERS' => 'Da Utente',
    'LBL_SELECT_DASHBOARDS' => 'Seleziona Dashboard selezionato',
    'LBL_SELECT_FILTERS' => 'Seleziona filtro/i',
    'LBL_EXISTING_FILTERS' => 'Filtro/i esistente/i',
    'LBL_SELECT_DESTINATION_USERS' => 'Seleziona utente/i di destinazione',
    'LBL_SELECT_DESTINATION_ROLES' => 'Seleziona ruolo/i di destinazione',
    'LBL_SELECT_DESTINATION_TEAMS' => 'Seleziona team di destinazione',
    'LBL_ITEMS_TO_REASSIGN' => 'Elementi da riassegnare',
    'LBL_PROMPT_TIMEZONE_ON' => 'Attivo',
    'LBL_PROMPT_TIMEZONE_OFF' => 'Disattivo',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'Aggiornamento impostazioni internazionali',
    'LBL_TO_TEAMS' => 'Ai Team',
    'LBL_TO_USERS' => 'Agli utenti',
    'LBL_TO_ROLES' => 'Ai ruoli',
    'LBL_IN_PROGRESS' => 'In Corso...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> sono stati riassegnati a {{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' - <b>{{comandi}} ({{count}})</b> sono stati riassegnati a {{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> sono stati clonati sui moduli: {{moduleList}} in {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'Seleziona gli utenti, i team o i ruoli a cui vuoi assegnare.',
    'LBL_NO_DASHBOARD' => 'Seleziona le dashboard che desideri assegnare.',
    'LBL_NO_MODULES' => 'Seleziona i moduli per la clonazione.',
    'LBL_NO_FILTERS' => 'Seleziona i filtri che desideri assegnare.',
    'LBL_NO_USER_PREFERENCES' => 'Seleziona le preferenze dell&#39;utente che desideri assegnare.',
    'LBL_NO_USER_SETTINGS' => 'Seleziona le impostazioni utente che desideri assegnare.',
    'LBL_DATA_NOT_RETRIEVED' => 'Dati non recuperati',
    'LBL_UTILS_USER_TEAMS_ROLES' => 'utenti/gruppi/ruoli',
    'LBL_LOADING_ITEMS' => 'Caricamento dati...',
    // END USER UTILS STRINGS
    'LBL_ACTIVE_USERS' => 'Utenti attivi',
    'LBL_GROUP_USERS' => 'Utenti di gruppo',
    'LBL_USERS_LIST_DASHBOARD' => 'Dashboard elenco utenti',

    // Sugar Automate
    'LBL_CUSTOMER_JOURNEY_ACCESS' => 'Accesso alla Guida Intelligente',
    'LBL_CUSTOMER_JOURNEY_LAST_ACTIVE' => 'Ultima attività della Guida Intelligente',
    'LBL_FILTER_MISSING_CUSTOMER_JOURNEY_ACCESS' => 'Accesso alla Guida Intelligente mancante',
]; // END STRINGS DEFS
