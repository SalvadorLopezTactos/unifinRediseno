...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'Kan ikke anmode om nulstilling af adgangskode for bruger, IDM-licenstilstand er aktiveret',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'Kan ikke anmode om nulstilling af adgangskode for bruger, systemets e-mail-konto er ikke konfigureret',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'Kan ikke anmode om nulstilling af adgangskode for bruger, ugyldigt e-mail-skabelon-id',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'Kan ikke anmode om nulstilling af adgangskode for brugeren, brugerens primære e-mailadresse er ugyldig',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'Kan ikke anmode om nulstilling af adgangskode for bruger, administratoradgang til modulet Brugere er påkrævet',
    'ERR_PASSWORD_RESET_NO_USER' => 'Kan ikke anmode om nulstilling af adgangskode for ikke-eksisterende bruger',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'Kan ikke anmode om nulstilling af adgangskode for brugere af gruppe- eller portal-API-typen',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'Skift adgangskode',
    ...
    'LBL_POPUP_REMINDER_TIME' => 'Tidspunkt for popup påmindelse',
    ...
    'LBL_HIDDEN_MODULES' => 'Skjulte moduler',
    ...
    'LBL_PASSWORD_USER_RESET' => 'Nulstil bruger-adgangskode',
    'LBL_RESET_PASSWORD_WARNING_USER' => 'Er du sikker på, at du vil nulstille adgangskoden for denne bruger?',
    'LBL_NEW_USER_PASSWORD_RESET' => 'Der blev sendt en e-mail til brugeren med et link til nulstilling af deres adgangskode.',
    ...
    'LBL_COOKIE_CONSENT' => 'Samtykke til cookies',
    'LBL_COOKIE_CONSENT_RECEIVED_ON' => 'Samtykke til cookies blev modtaget den',
    'LBL_QUOTAS' => 'Kvoter',
    ...
    'LBL_BESIDE_FIELD_VALUE' => 'Ud for feltværdi',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'Præferencer for denne bruger blev.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'Den valgte skrifttype vil blive anvendt på teksten i PDF-dokumentets header og sidefod <br /> <br /> Hvis du har problemer med at gengive tegn på visse sprog, kan du overveje at ændre skrifttypen. Se dokumentationen om at <a href="%s" target="_blank">komme i gang</a> for at få flere oplysninger.',
    'LBL_PDF_FONT_SIZE_MAIN' => 'Hovedskriftstørrelse',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'Skrifttype til sidefod',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'Den valgte skrifttype vil blive anvendt på teksten i PDF-dokumentets sidefod <br /> <br /> Hvis du har problemer med at gengive tegn på visse sprog, kan du overveje at ændre skrifttypen. Se dokumentationen om at <a href="%s" target="_blank">komme i gang</a> for at få flere oplysninger.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'E-mail-logitimationsoplysninger',
...
<tr><td><!--ikke_i_tema!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.sugarcrm.com/forums" target="_blank"><b>Fora</b></a><br>Fora dedikeret til Sugar Fællesskabet for at drøfte emner af interesse med hinanden og med SugarCRM Udviklere</td></tr>
    ...
    'LBL_SYNC_KEY' => 'Integration Synk ID',

    'LBL_APPEARANCE' => 'Udseende',
    'LBL_APPEARANCE_DESC' => 'Vælg, hvordan Sugar skal se ud for dig. Følg din enheds indstillinger, eller vælg altid at bruge lys eller mørk tilstand.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'Kopiér indhold',
    'LNK_COPY_USER_SETTINGS' => 'Kopiér brugerindstillinger',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'Kopiér præferencer og indhold',
    'LBL_CLEAR' => 'Ryd',
    'LBL_COPY' => 'Kopiér',
    'LBL_COPY_ITEM' => 'Kopiér element:',
    'LBL_USER_PREFENRECES' => 'Brugepræferencer',
    'LBL_FILTERS' => 'Filtre',
    'LBL_DASHBOARDS_UTILS' => 'Betjeningspaneler',
    'LBL_DEFAULT_TEAMS' => 'Standardteams',
    'LBL_FAVORITE_REPORTS' => 'Favoritrapporter',
    'LBL_NAVBAR_SELECTION' => 'Valg af modul til navigationsbjælke',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'Giv besked om tildeling',
    'LBL_REMINDER_OPTIONS' => 'Valgmuligheder for påmindelse',
    'LBL_SCHEDULED_REPORTING' => 'Planlagt rapportering',
    'LBL_SUGAR_EMAIL_CLIENT' => 'Sugar-e-mailklient',
    'LBL_EXISTING_DASHBOARD' => 'Eksisterende betjeningspaneler',
    'LBL_FROM_MODULES' => 'Fra moduler',
    'LBL_SELECT_MODULES' => 'Vælg moduler',
    'LBL_USER_UTILS_DATA_ERROR' => 'Hentning af data mislykkedes',
    'LBL_FROM_USERS' => 'Fra bruger',
    'LBL_SELECT_DASHBOARDS' => 'Valgte betjeningspaneler',
    'LBL_SELECT_FILTERS' => 'Vælg filtre',
    'LBL_EXISTING_FILTERS' => 'Eksisterende filtre',
    'LBL_SELECT_DESTINATION_USERS' => 'Vælg destinationsbrugere',
    'LBL_SELECT_DESTINATION_ROLES' => 'Vælg destinationsroller',
    'LBL_SELECT_DESTINATION_TEAMS' => 'Vælg destinationsteams',
    'LBL_ITEMS_TO_REASSIGN' => 'Elementer, der skal omfordeles',
    'LBL_PROMPT_TIMEZONE_ON' => 'Til',
    'LBL_PROMPT_TIMEZONE_OFF' => 'Fra',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'Find opdatering til indstillinger',
    'LBL_TO_TEAMS' => 'Til teams',
    'LBL_TO_USERS' => 'Til brugere',
    'LBL_TO_ROLES' => 'Til roller',
    'LBL_IN_PROGRESS' => 'I gang...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> blev omfordelt til {{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' - <b>{{commands}} ({{count}})</b> blev omfordelt til {{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> blev klonet på moduler: {{moduleList}} til {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'Vælg de brugere, teams eller roller, som du vil tildele.',
    'LBL_NO_DASHBOARD' => 'Vælg de betjeningspaneler, som du vil tildele.',
    'LBL_NO_MODULES' => 'Vælg modulerne til kloning.',
    'LBL_NO_FILTERS' => 'Vælg de filtre, som du vil tildele.',
    'LBL_NO_USER_PREFERENCES' => 'Vælg de brugerpræferencer, som du vil tildele.',
    'LBL_NO_USER_SETTINGS' => 'Vælg de brugerindstillinger, som du vil tildele.',
    'LBL_DATA_NOT_RETRIEVED' => 'Data ikke hentet',
    'LBL_UTILS_USER_TEAMS_ROLES' => 'brugere/team/roller',
    'LBL_LOADING_ITEMS' => 'Indlæser data ...',
    // END USER UTILS STRINGS
    'LBL_ACTIVE_USERS' => 'Aktive brugere',
    'LBL_GROUP_USERS' => 'Gruppe af brugere',
    'LBL_USERS_LIST_DASHBOARD' => 'Dashboard for brugerliste',
