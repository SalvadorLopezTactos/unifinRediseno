...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => '无法为用户请求密码重置，IDM 许可模式已启用',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => '无法为用户请求密码重置，系统电子邮件帐户未配置',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => '无法为用户请求密码重置，电子邮件模板 ID 无效',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => '无法为用户请求密码重置，用户的主要电子邮件地址无效',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => '无法为用户请求密码重置，必须具有对用户模块的管理员访问权限',
    'ERR_PASSWORD_RESET_NO_USER' => '无法为不存在的用户请求密码重置',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => '无法为组或门户 API 类型用户请求密码重置',
    ...
    'LBL_PASSWORD_USER_RESET' => '重置用户密码',
    'LBL_RESET_PASSWORD_WARNING_USER' => '确定要为该用户重置密码吗？',
    'LBL_NEW_USER_PASSWORD_RESET' => '已向该用户发送包含密码重置链接的电子邮件。',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => '此用户的首选项已成功重置。',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => '所选字体将应用于 PDF 文档的页眉和正文中的文本 <br /> <br /> 如果在呈现某些语言的字符时遇到问题，请考虑更改字体。请参阅 <a href="%s" target="_blank">开始</a> 文档以获取更多信息。',
    'LBL_PDF_FONT_SIZE_MAIN' => '主字体大小',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => '页脚字体',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => '所选字体将应用于 PDF 文档的页眉和正文中的文本 <br /> <br /> 如果在呈现某些语言的字符时遇到问题，请考虑更改字体。请参阅 <a href="%s" target="_blank">入门</a> 文档以获取更多信息。',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        '此用户已创建为员工。请转到“员工”模块以进行更改。',

    'LBL_SYNC_KEY' => '集成同步 ID',

    'LBL_APPEARANCE' => '外观',
    'LBL_APPEARANCE_DESC' => '选择 Sugar 在您眼中的样子。按照您的设备设置或选择始终使用白天或夜间模式。',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => '复制内容',
    'LNK_COPY_USER_SETTINGS' => '复制用户设置',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => '复制首选项和内容',
    'LBL_CLEAR' => '清除',
    'LBL_COPY' => '复制',
    'LBL_COPY_ITEM' => '复制项目：',
    'LBL_USER_PREFENRECES' => '用户首选项',
    'LBL_FILTERS' => '过滤器',
    'LBL_DASHBOARDS_UTILS' => '仪表板',
    'LBL_DEFAULT_TEAMS' => '默认团队',
    'LBL_FAVORITE_REPORTS' => '收藏夹报表',
    'LBL_NAVBAR_SELECTION' => '导航栏模块选择',
    'LBL_NOTIFY_ON_ASSIGNMENT' => '分配时通知',
    'LBL_REMINDER_OPTIONS' => '提醒选项',
    'LBL_SCHEDULED_REPORTING' => '已安排报告',
    'LBL_SUGAR_EMAIL_CLIENT' => 'Sugar 邮件客户端',
    'LBL_EXISTING_DASHBOARD' => '现有仪表板',
    'LBL_FROM_MODULES' => '来自模块',
    'LBL_SELECT_MODULES' => '选择模块',
    'LBL_USER_UTILS_DATA_ERROR' => '无法检索数据',
    'LBL_FROM_USERS' => '来自用户',
    'LBL_SELECT_DASHBOARDS' => '选择仪表板',
    'LBL_SELECT_FILTERS' => '选择筛选器',
    'LBL_EXISTING_FILTERS' => '现有筛选器',
    'LBL_SELECT_DESTINATION_USERS' => '选择目标用户',
    'LBL_SELECT_DESTINATION_ROLES' => '选择目标角色',
    'LBL_SELECT_DESTINATION_TEAMS' => '选择目标团队',
    'LBL_ITEMS_TO_REASSIGN' => '要重新分配的项目',
    'LBL_PROMPT_TIMEZONE_ON' => '开启',
    'LBL_PROMPT_TIMEZONE_OFF' => '关闭',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => '区域设置更新',
    'LBL_TO_TEAMS' => '给团队',
    'LBL_TO_USERS' => '给用户',
    'LBL_TO_ROLES' => '给角色',
    'LBL_IN_PROGRESS' => '正在进行......',
    ...
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> 已在模块上克隆： {{moduleList}} 到 {{destinationList}}。',
    'LBL_NO_DESTINATION' => '请选择要分配给的用户、团队或角色。',
    'LBL_NO_DASHBOARD' => '请选择要分配的仪表板。',
    'LBL_NO_MODULES' => '请选择要克隆的模块。',
    'LBL_NO_FILTERS' => '请选择要分配的筛选器。',
    'LBL_NO_USER_PREFERENCES' => '请选择要分配的用户首选项。',
    'LBL_NO_USER_SETTINGS' => '请选择要分配的用户设置。',
    'LBL_DATA_NOT_RETRIEVED' => '未检索到数据',
    'LBL_UTILS_USER_TEAMS_ROLES' => '用户/团队/角色',
    'LBL_LOADING_ITEMS' => '加载数据...',
    // END USER UTILS STRINGS
    'LBL_ACTIVE_USERS' => '活跃用户',
    'LBL_GROUP_USERS' => '组用户',
    'LBL_USERS_LIST_DASHBOARD' => '用户列表仪表板',
