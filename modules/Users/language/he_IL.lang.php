...
$mod_strings = [
    ...
    'ERR_PASSWORD_RESET_IDM_LICENSING_MODE' => 'לא ניתן לבקש איפוס סיסמה עבור המשתמש, מצב רישוי IDM מופעל',
    'ERR_PASSWORD_RESET_INVALID_SYSTEM_EMAIL' => 'לא ניתן לבקש איפוס סיסמה עבור המשתמש, לא מוגדר חשבון דוא"ל של המערכת',
    'ERR_PASSWORD_RESET_INVALID_EMAIL_TEMPLATE' => 'לא ניתן לבקש איפוס סיסמה עבור המשתמש, מזהה תבנית הדוא"ל אינו תקף',
    'ERR_PASSWORD_RESET_INVALID_EMAIL' => 'לא ניתן לבקש איפוס סיסמה עבור המשתמש, כתובת הדוא"ל הראשית של המשתמש אינה תקפה',
    'ERR_PASSWORD_RESET_NOT_ADMIN' => 'לא ניתן לבקש איפוס סיסמה עבור המשתמש, נדרשת גישת מנהל מערכת אל מודול ה&#39;משתמשים&#39;',
    'ERR_PASSWORD_RESET_NO_USER' => 'לא ניתן לבקש איפוס סיסמה עבור משתמש שאינו קיים',
    'ERR_PASSWORD_RESET_GROUP_PORTAL' => 'לא ניתן לבקש איפוס סיסמה עבור משתמשי קבוצה או משתמשים מסוג API של פורטל',
    ...
    'LBL_CHANGE_SMTP_PASSWORD' => 'שינוי סיסמה',
    ...
    'LBL_HIDDEN_MODULES' => 'מודולים מוסתרים',
    ...
    'LBL_PASSWORD_USER_RESET' => 'איפוס סיסמת משתמש',
    'LBL_RESET_PASSWORD_WARNING_USER' => 'בטוח שרוצה לאפס סיסמה של משתמש זה?',
    'LBL_NEW_USER_PASSWORD_RESET' => 'הודעת דוא"ל שמכילה קישור לאיפוס הסיסמה נשלחה אל המשתמש.',
    ...
    'LBL_BESIDE_FIELD_VALUE' => 'לצד ערך השדה',
    ...
    'LBL_RESET_PREFERENCES_SUCCESS_USER' => 'הושלם איפוס ההעדפות של משתמש זה.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_PDF_FONT_NAME_MAIN_TEXT' => 'הגופן שנבחר יחול על הטקסט בכותרת העליונה ובגוף מסמך ה-PDF <br /> <br /> לכל בעיה בעיבוד התווים של שפות מסוימות, כדאי אולי לשנות את הגופן. אפשר למצוא מידע נוסף בתיעוד של <a href="%s" target="_blank">תחילת העבודה</a>.',
    'LBL_PDF_FONT_SIZE_MAIN' => 'גודל גופן ראשי',
    'LBL_PDF_FONT_SIZE_MAIN_TEXT' => '',
    'LBL_PDF_FONT_NAME_DATA' => 'גופן עבור כותרת תחתונה',
    'LBL_PDF_FONT_NAME_DATA_TEXT' => 'הגופן הנבחר יחול על הטקסט בכותרת התחתונה של מסמך ה-PDF <br /> <br /> לכל בעיה בעיבוד התווים של שפות מסוימות, אולי כדאי לשנות את הגופן. אפשר למצוא מידע נוסף בתיעוד של <a href="%s" target="_blank">תחילת העבודה</a>.',
    ...
    'LBL_MAIL_CREDENTIALS' => 'אישורי דוא"ל',
    ...
    'LBL_IDM_MODE_NON_EDITABLE_FIELDS_FOR_EMPLOYEE_ONLY' =>
        'משתמש זה נוצר כעובד. עבור למודול &#39;עובד&#39; כדי לבצע שינויים.',

    'LBL_SYNC_KEY' => 'מזהה סנכרון השילוב',

    'LBL_APPEARANCE' => 'מראה',
    'LBL_APPEARANCE_DESC' => 'בחר איך Sugar ייראה. הפעל את הגדרות המכשיר או בחר להשתמש תמיד במצב בהיר או במצב כהה.',

    // START USER UTILS STRINGS
    'LNK_COPY_CONTENT' => 'העתק תוכן',
    'LNK_COPY_USER_SETTINGS' => 'העתק הגדרות משתמש',
    'LBL_CONFIG_TITLE_COPY_CONTENT' => 'העתק העדפות ותוכן',
    'LBL_CLEAR' => 'נקה',
    'LBL_COPY' => 'העתק',
    'LBL_COPY_ITEM' => 'העתק פריט:',
    'LBL_USER_PREFENRECES' => 'העדפות משתמש',
    'LBL_FILTERS' => 'מסנן(ים)',
    'LBL_DASHBOARDS_UTILS' => 'לוח(ות) מחוונים',
    'LBL_DEFAULT_TEAMS' => 'צוותי ברירת מחדל',
    'LBL_FAVORITE_REPORTS' => 'דוחות מועדפים',
    'LBL_NAVBAR_SELECTION' => 'בחירת מודול בסרגל הניווט',
    'LBL_NOTIFY_ON_ASSIGNMENT' => 'שלח התראה על הקצאה',
    'LBL_REMINDER_OPTIONS' => 'אפשרויות תזכורת',
    'LBL_SCHEDULED_REPORTING' => 'דיווח מתוזמן',
    'LBL_SUGAR_EMAIL_CLIENT' => 'לקוח דואר של Sugar',
    'LBL_EXISTING_DASHBOARD' => 'לוח(ות) מחוונים קיים(ים)',
    'LBL_FROM_MODULES' => 'ממודולים',
    'LBL_SELECT_MODULES' => 'בחר מודול(ים)',
    'LBL_USER_UTILS_DATA_ERROR' => 'לא ניתן לאחזר נתונים',
    'LBL_FROM_USERS' => 'מהמשתמש',
    'LBL_SELECT_DASHBOARDS' => 'בחר לוח(ות) מחוונים',
    'LBL_SELECT_FILTERS' => 'בחר מסנן(ים)',
    'LBL_EXISTING_FILTERS' => 'מסננים קיימים',
    'LBL_SELECT_DESTINATION_USERS' => 'בחר משתמש(י) יעד',
    'LBL_SELECT_DESTINATION_ROLES' => 'בחר תפקיד(י) יעד',
    'LBL_SELECT_DESTINATION_TEAMS' => 'בחר צוות(י) יעד',
    'LBL_ITEMS_TO_REASSIGN' => 'פריטים להקצאה מחדש',
    'LBL_PROMPT_TIMEZONE_ON' => 'פעיל',
    'LBL_PROMPT_TIMEZONE_OFF' => 'לא פעיל',
    'LBL_CONFIG_TITLE_COPY_USER_SETTINGS' => 'עדכון הגדרות אזור',
    'LBL_TO_TEAMS' => 'לצוות(ים)',
    'LBL_TO_USERS' => 'למשתמש(ים)',
    'LBL_TO_ROLES' => 'לתפקיד(ים)',
    'LBL_IN_PROGRESS' => 'בביצוע...',
    'LBL_COPY_CONTENT_SUCCESS' => ' - <b>{{commands}}</b> הוקצו מחדש ל{{destinationList}}.',
    'LBL_COPY_CONTENT_COUNT_SUCCESS' => ' - <b>{{commands}} ({{count}})</b> הוקצו מחדש ל{{destinationList}}.',
    'LBL_COPY_CONTENT_CLONE_MODULES_SUCCESS' =>
        ' - <b>{{commands}}</b> שוכפלו במודול(ים): {{moduleList}} עד {{destinationList}}.',
    'LBL_NO_DESTINATION' => 'בחר את המשתמשים, הצוותים או התפקידים להם ברצונך להקצות.',
    'LBL_NO_DASHBOARD' => 'בחר את לוחות המחוונים שברצונך להקצות.',
    'LBL_NO_MODULES' => 'בחר את המודולים לשכפול.',
    'LBL_NO_FILTERS' => 'בחר את המסננים שברצונך להקצות.',
    'LBL_NO_USER_PREFERENCES' => 'בחר את העדפות המשתמש שברצונך להקצות.',
    'LBL_NO_USER_SETTINGS' => 'בחר את הגדרות המשתמש שברצונך להקצות.',
    'LBL_DATA_NOT_RETRIEVED' => 'הנתונים לא אוחזרו',
    ...
    'LBL_GROUP_USERS' => 'משתמשי קבוצה',
    'LBL_USERS_LIST_DASHBOARD' => 'לוח מחוונים של רשימת משתמשים',
