...
$mod_strings = [
    ...
    'LBL_REVENUELINEITEMS' => 'Řádkové položky výnosů',
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Obnovit výsledky sestavy',
    ...
    'LBL_COPY_AS' => 'Kopírovat jako',
    'LBL_CURRENT_REPORT_TYPE' => 'Aktuální typ sestavy',
// report_name
    ...
    'LBL_HORIZ_BAR' => 'Vodorovný pruh (sbalený)',
    'LBL_VERT_BAR' => 'Svislý pruh (sbalený)',
    'LBL_PIE' => 'Koláč',
    'LBL_DONUT' => 'Prstenec',
    'LBL_TREEMAP' => 'Stromová mapa',
    'LBL_LINE' => 'Linka',
    'LBL_FUNNEL' => 'Trychtýř',
    'LBL_HORIZ_GBAR' => 'Vodorovný pruh (seskupený)',
    'LBL_VERT_GBAR' => 'Svislý pruh (seskupený)',
    ...
    'LBL_SERVER_ERROR' => 'Z důvodu chyby serveru nemáte přístup k této sestavě.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Naplánované sestavy "{0} (ID: {1})" byly neočekávaně deaktivovány. Obraťte se s dotazem na svého správce.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Šablony',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Bez šablon',
    ...
    'LBL_REPORT_TABLE' => 'Tabulka',
    'LBL_REPORT_FILTERS' => 'Filtry',
    'LBL_REPORT_DATA_TABLE' => 'Datová tabulka',
    'LBL_REPORT_MINIMIZE' => 'Rozbalit/Minimalizovat',
    'LBL_REPORT_EXPAND' => 'Rozšířit',
    'LBL_EXPORT_AS' => 'Exportovat jako',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Tento typ souboru je optimalizován pro tisk a sdílení a nelze ho jednoduše upravovat. Grafy a tabulky sestavy jsou zahrnuty.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Tento typ souboru obsahuje data oddělená čárkou a lze ho otevřít v tabulkovém procesoru. Obsahuje nezpracovaný data, ale neobsahuje grafy a tabulky sestavy.',
    'LBL_EXPORT_PDF' => 'Generování PDF',
    'LBL_EXPORT_CSV' => 'Generování CSV',
    'LBL_EXPORT_PDF_SUCCESS' => 'Soubor PDF byl úspěšně vygenerován!',
    'LBL_EXPORT_CSV_SUCCESS' => 'Soubor CSV byl úspěšně vygenerován!',
    'LBL_DATA_TABLE' => 'Datová tabulka',
    'LBL_COLLAPSE_ALL' => 'Sbalit vše',
    'LBL_EXPAND_ALL' => 'Rozbalit vše',
    'LBL_TOTAL_COUNT' => 'Celkový počet',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Nemáte oprávnění k zobrazení jednoho nebo více filtrů runtime',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Tato sestava byla od poslední aktualizace upravena.',
    'LBL_EXPORT_FAILED' => 'Sestava je příliš velká na to, aby ji bylo možné exportovat. Chcete-li zmenšit velikost sestavy, omezte údaje ze souvisejících modulů nebo použijte filtry pro zúžení výsledků.',
    'LBL_SELECT_ALL' => 'Vybrat vše',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Tabulka dat je příliš velká pro načtení.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Upravte filtry pro omezení výsledků nebo exportujte aktuální výsledky jako soubor CSV.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Velká tabulka dat. Upravte filtry pro omezení výsledků nebo vyberte některou z níže uvedených možností.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Úplnou sadu výsledků můžete uložit jako soubor CSV nebo zobrazit v tomto panelu jako zjednodušenou tabulku.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Zobrazit zjednodušenou tabulku',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Upravte filtry pro omezení výsledků.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Velká tabulka dat. Upravte filtry pro omezení výsledků nebo vyberte některou z níže uvedených možností.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Úplnou sadu výsledků můžete zobrazit v tomto panelu jako zjednodušenou tabulku.',
    'LBL_EXPORT_AS_CSV' => 'Exportovat jako CSV',
    'LBL_FILTER_VIEW' => 'Zobrazení filtru',
    'LBL_TABLE_VIEW' => 'Zobrazení tabulky',
    'LBL_CHART_VIEW' => 'Zobrazení grafu',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Svisle rozdělené zobrazení',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Vodorovně rozdělené zobrazení',
    'LBL_SHOWING' => 'Zobrazuje se',
    'LBL_ONE_VIEW_REQUIRED' => 'Je třeba vybrat alespoň jedno zobrazení',
    'LBL_RC_NO_CHART' => 'Sestavy řádků a sloupců nepodporují grafy',
    'LBL_LINE_CHART_INVALID' => 'Spojnicový graf vyžaduje dvě pole seskupení. Definujte další pole seskupení nebo použijte jiný typ grafu.',

    'LBL_TEMPLATE' => 'Šablona',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Váš výběr obsahuje šablony sestav, které nelze hromadně odstranit. Chcete-li pokračovat, zrušte výběr šablon.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Váš výběr obsahuje šablony sestav, které nelze hromadně aktualizovat. Chcete-li pokračovat, zrušte výběr šablon.',
];
