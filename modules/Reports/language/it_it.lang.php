...
$mod_strings = [
    ...
    'LBL_REVENUELINEITEMS' => 'Elementi ricavi',
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Aggiorna risultati report',
    ...
    'LBL_COPY_AS' => 'Copia come',
    'LBL_CURRENT_REPORT_TYPE' => 'Tipo di reporto corrente',
// report_name
    ...
    'LBL_HORIZ_BAR' => 'Barra orizzontale (In pila)',
    'LBL_VERT_BAR' => 'Barra verticale (In pila)',
    'LBL_PIE' => 'Torta',
    'LBL_DONUT' => 'Ciambella',
    'LBL_TREEMAP' => 'Mappa ad albero',
    'LBL_LINE' => 'Linee',
    'LBL_FUNNEL' => 'Imbuto',
    'LBL_HORIZ_GBAR' => 'Barra orizzontale (Raggruppamento)',
    'LBL_VERT_GBAR' => 'Barra verticale (Raggruppamento)',
    ...
    'LBL_SERVER_ERROR' => 'Impossibile accedere a questo report a causa di un errore del server.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Il report pianificato "{0} (ID: {1})" è stato disattivato inaspettatamente. Per ulteriori informazioni, contattare l&#39;amministratore.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Modelli',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Non modelli',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Grafico',
    'LBL_REPORT_TABLE' => 'Tabella',
    'LBL_REPORT_FILTERS' => 'Filtri',
    'LBL_REPORT_DATA_TABLE' => 'Tabella dati',
    'LBL_REPORT_MINIMIZE' => 'Espandi/riduci',
    'LBL_REPORT_EXPAND' => 'Espandi',
    'LBL_EXPORT_AS' => 'Esporta come',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Questo tipo di file è ottimizzato per la stampa e la condivisione e non può essere modificato facilmente. Sono inclusi grafici e tabelle dei report.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Questo tipo di file contiene dati separati da virgole e può essere aperto in un&#39;applicazione per fogli di calcolo. Contiene dati grezzi ma esclude grafici e tabelle di report.',
    'LBL_EXPORT_PDF' => 'Generazione PDF in corso',
    'LBL_EXPORT_CSV' => 'Generazione CSV in corso',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF generato con successo!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV generato con successo!',
    'LBL_DATA_TABLE' => 'Tabella dati',
    'LBL_COLLAPSE_ALL' => 'Riduci Tutto',
    'LBL_EXPAND_ALL' => 'Espandi Tutto',
    'LBL_TOTAL_COUNT' => 'Conteggio totale',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Non disponi delle autorizzazioni per visualizzare uno o più filtri di runtime',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Il report è stato modificato dall´ultima esecuzione.',
    'LBL_EXPORT_FAILED' => 'Report troppo grande per l&#39;esportazione. Per ridurne le dimensioni, limitare i dati provenienti dai moduli correlati oppure usare i filtri per rifinire i risultati.',
    'LBL_SELECT_ALL' => 'Seleziona tutto',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Tabella dati troppo grande per il caricamento.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Regolare i filtri per ridurre i risultati oppure esportare i risultati correnti come file CSV.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Tabella dati troppo grande. Regolare i filtri per ridurre i risultati oppure scegliere un&#39;opzione qui sotto.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'È possibile salvare l&#39;intera serie di risultati come file CSV oppure visualizzarla in questo pannello come tabella semplificata.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Visualizza tabella semplificata',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Regolare i filtri per ridurre i risultati.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Tabella dati troppo grande. Regolare i filtri per ridurre i risultati oppure scegliere l&#39;opzione sotto.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'È possibile visualizzare l&#39;intero set di risultati in questo pannello come tabella semplificata.',
    'LBL_EXPORT_AS_CSV' => 'Esporta come CSV',
    'LBL_FILTER_VIEW' => 'Vista filtro',
    'LBL_TABLE_VIEW' => 'Vista tabella',
    'LBL_CHART_VIEW' => 'Vista grafico',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Vista doppia visualizzazione verticale',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Vista doppia visualizzazione orizzontale',
    'LBL_SHOWING' => 'Mostrante',
    'LBL_ONE_VIEW_REQUIRED' => 'È necessario selezionare almeno una visualizzazione',
    'LBL_RC_NO_CHART' => 'I report a righe e colonne non supportano i grafici',
    'LBL_LINE_CHART_INVALID' => 'Un grafico a linee richiede due campi di raggruppamento. Definire un altro campo di raggruppamento o utilizzare un tipo di grafico diverso.',

    'LBL_TEMPLATE' => 'Modello',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'La selezione contiene dei modelli di report, che non possono essere eliminati in blocco. Deselezionare i modelli per continuare.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'La selezione contiene dei modelli di report, che non possono essere aggiornati in blocco. Deselezionare i modelli per continuare.',
];
