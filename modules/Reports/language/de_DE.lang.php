...
$mod_strings = [
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Berichtsergebnisse aktualisieren',
    ...
    'LBL_COPY_AS' => 'Kopieren als',
    'LBL_CURRENT_REPORT_TYPE' => 'Aktueller Berichtstyp',
// report_name
    ...
    'LBL_HORIZ_BAR' => 'Waagrechter Balken (gestapelt)',
    'LBL_VERT_BAR' => 'Senkrechter Balken (gestapelt)',
    'LBL_PIE' => 'Tortenstück',
    'LBL_DONUT' => 'Donut',
    'LBL_TREEMAP' => 'Kachel',
    'LBL_LINE' => 'Linie',
    'LBL_FUNNEL' => 'Trichter',
    'LBL_HORIZ_GBAR' => 'Waagrechter Balken (gruppiert)',
    'LBL_VERT_GBAR' => 'Senkrechter Balken (gruppiert)',
    ...
    'LBL_SERVER_ERROR' => 'Sie können aufgrund eines Serverfehlers nicht auf diesen Bericht zugreifen.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Der geplante Bericht "{0} (ID: {1})" wurde überraschend deaktiviert. Bitte kontaktieren Sie Ihren Administrator für weitere Informationen.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Vorlagen',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Nicht-Vorlagen',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Diagramm',
    'LBL_REPORT_TABLE' => 'Tabelle',
    'LBL_REPORT_FILTERS' => 'Filter',
    'LBL_REPORT_DATA_TABLE' => 'Datentabelle',
    'LBL_REPORT_MINIMIZE' => 'Erweitern/Minimieren',
    'LBL_REPORT_EXPAND' => 'Erweitern',
    'LBL_EXPORT_AS' => 'Exportieren als',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Dieser Dateityp ist für das Drucken und die Weitergabe optimiert und kann nicht einfach bearbeitet werden. Berichtsdiagramme und Tabellen sind enthalten.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Dieser Dateityp enthält kommagetrennte Daten und kann in einer Tabellenkalkulationsanwendung geöffnet werden. Er enthält Rohdaten, aber keine Berichtsdiagramme und Tabellen.',
    'LBL_EXPORT_PDF' => 'PDF generieren',
    'LBL_EXPORT_CSV' => 'CSV generieren',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF wurde erfolgreich generiert!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV wurde erfolgreich generiert!',
    'LBL_DATA_TABLE' => 'Datentabelle',
    'LBL_COLLAPSE_ALL' => 'Alle verstecken',
    'LBL_EXPAND_ALL' => 'Alle erweitern',
    'LBL_TOTAL_COUNT' => 'Gesamtzahl',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Sie verfügen nicht über Berechtigungen zum Anzeigen eines oder mehrerer Laufzeitfilter',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Dieser Bericht ist seit der letzte Aktualisierung verändert worden.',
    'LBL_EXPORT_FAILED' => 'Der Bericht ist zu groß zum Exportieren. Um die Größe des Berichts zu reduzieren, beschränken Sie bitte die Daten aus zugehörigen Modulen oder verwenden Sie Filter, um die Ergebnisse einzugrenzen.',
    'LBL_SELECT_ALL' => 'Alle auswählen',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Datentabelle ist zu groß zum Laden.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Passen Sie die Filter an, um die Ergebnisse zu reduzieren oder exportieren Sie die aktuellen Ergebnisse als CSV-Datei.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Große Datentabelle. Passen Sie die Filter an, um die Ergebnisse zu reduzieren, oder wählen Sie eine Option unten.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Sie können die gesamte Ergebnismenge als CSV-Datei speichern oder in diesem Bereich als vereinfachte Tabelle einsehen.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Vereinfachte Tabelle anzeigen',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Passen Sie die Filter an, um die Ergebnisse zu reduzieren.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Große Datentabelle. Passen Sie die Filter an, um die Ergebnisse zu reduzieren, oder wählen Sie die Option unten aus.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Sie können die vollständige Ergebnismenge in diesem Bereich als vereinfachte Tabelle anzeigen.',
    'LBL_EXPORT_AS_CSV' => 'Als CSV exportieren',
    'LBL_FILTER_VIEW' => 'Filteransicht',
    'LBL_TABLE_VIEW' => 'Tabellenansicht',
    'LBL_CHART_VIEW' => 'Diagrammansicht',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Vertikal geteilte Ansicht',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Horizontal geteilte Ansicht',
    'LBL_SHOWING' => 'Anzeigen',
    'LBL_ONE_VIEW_REQUIRED' => 'Bitte mindestens eine Ansicht auswählen',
    'LBL_RC_NO_CHART' => 'Zeilen- und Spaltenberichte unterstützen keine Diagramme',
    'LBL_LINE_CHART_INVALID' => 'Für ein Liniendiagramm sind zwei Gruppierungsfelder erforderlich. Definieren Sie ein weiteres Gruppierungsfeld oder verwenden Sie einen anderen Diagrammtyp.',

    'LBL_TEMPLATE' => 'Vorlage',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Ihre Auswahl enthält Berichtsvorlagen, die nicht als Mehrfachauswahl gelöscht werden können. Deaktivieren Sie bitte Vorlagen, um fortzufahren.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Ihre Auswahl enthält Berichtsvorlagen, die nicht als Mehrfachauswahl aktualisiert werden können. Deaktivieren Sie bitte Vorlagen, um fortzufahren.',
];
