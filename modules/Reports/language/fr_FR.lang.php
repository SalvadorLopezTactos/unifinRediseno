...
$mod_strings = [
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Rafraîchir les résultats du rapport',
    ...
    'LBL_COPY_AS' => 'Copier en tant que',
    'LBL_CURRENT_REPORT_TYPE' => 'Type de rapport actuel',
// report_name
    ...
    'LBL_HORIZ_BAR' => 'Barre horizontale (empilée)',
    'LBL_VERT_BAR' => 'Barre verticale (empilée)',
    'LBL_PIE' => 'Camembert',
    'LBL_DONUT' => 'Bouée',
    'LBL_TREEMAP' => 'Compartimentage',
    'LBL_LINE' => 'Courbe',
    'LBL_FUNNEL' => 'Entonnoir',
    'LBL_HORIZ_GBAR' => 'Barre horizontale (groupée)',
    'LBL_VERT_GBAR' => 'Barre verticale (groupée)',
    ...
    'LBL_SERVER_ERROR' => 'Vous ne pouvez pas accéder à ce rapport dû à une erreur de serveur.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Le rapport planifié "{0} (ID: {1})" a été désactivé de manière inattendue. Veuillez contacter votre administrateur pour plus d&#39;informations.',
    ...
    'LBL_LESS_THAN_EQUAL' => 'Inférieur à égal à',
    'LBL_GREATER_THAN_EQUAL' => 'Supérieur à égal à',

    'LBL_FILTER_BY_MODULE' => 'Par module',
    'LBL_FILTER_WITH_CHARTS' => 'Avec des graphiques',
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Modèles',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Non modèles',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Graphique',
    'LBL_REPORT_TABLE' => 'Table',
    'LBL_REPORT_FILTERS' => 'Filtres',
    'LBL_REPORT_DATA_TABLE' => 'Tableau de données',
    'LBL_REPORT_MINIMIZE' => 'Développer/Minimiser',
    'LBL_REPORT_EXPAND' => 'Étendre',
    'LBL_EXPORT_AS' => 'Exporter en tant que',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Ce type de fichier est optimisé pour l&#39;impression et le partage, et il ne peut pas être facilement modifié. Les graphiques et les tableaux du rapport sont inclus.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Ce type de fichier contient des données séparées par des virgules et peut être ouvert dans un tableur. Il contient des données brutes mais exclut les graphiques et les tableaux du rapport.',
    'LBL_EXPORT_PDF' => 'Génération du PDF',
    'LBL_EXPORT_CSV' => 'Génération du CSV',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF généré avec succès !',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV généré avec succès !',
    'LBL_DATA_TABLE' => 'Tableau de données',
    'LBL_COLLAPSE_ALL' => 'Tout réduire',
    'LBL_EXPAND_ALL' => 'Tout développer',
    'LBL_TOTAL_COUNT' => 'Nombre total',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Vous n&#39;avez pas les autorisations nécessaires pour afficher un ou plusieurs filtres d&#39;exécution',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Ce rapport a été modifié depuis la dernière actualisation.',
    'LBL_EXPORT_FAILED' => 'Le rapport est trop volumineux pour être exporté. Pour réduire la taille du rapport, veuillez limiter les données des modules associés ou utiliser des filtres pour restreindre les résultats.',
    'LBL_SELECT_ALL' => 'Sélectionner tout',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Le tableau de données est trop volumineux pour être chargé.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Ajustez les filtres pour réduire les résultats ou exportez les résultats actuels sous forme de fichier CSV.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Tableau de données volumineux. Ajustez les filtres pour réduire les résultats ou choisissez une option ci-dessous.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Vous pouvez enregistrer l&#39;ensemble des résultats sous forme de fichier CSV ou les afficher dans ce panneau sous forme de tableau simplifié.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Voir le tableau simplifié',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Ajustez les filtres pour réduire les résultats.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Table de données volumineuse. Ajustez les filtres pour réduire les résultats ou choisissez l’option ci-dessous.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Vous pouvez visualiser l&#39;ensemble des résultats dans ce panneau sous la forme d&#39;un tableau simplifié.',
    'LBL_EXPORT_AS_CSV' => 'Exporter en tant que CSV',
    'LBL_FILTER_VIEW' => 'Filtrer la vue',
    'LBL_TABLE_VIEW' => 'Vue en tableau',
    'LBL_CHART_VIEW' => 'Vue graphique',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Vue en coupe verticale',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Vue en coupe horizontale',
    'LBL_SHOWING' => 'Affichage',
    'LBL_ONE_VIEW_REQUIRED' => 'Doit sélectionner au moins une vue',
    'LBL_RC_NO_CHART' => 'Les rapports de lignes et de colonnes ne prennent pas en charge les graphiques',
    'LBL_LINE_CHART_INVALID' => 'Un graphique en courbes nécessite deux champs de groupement. Définissez un autre champ de groupement ou utilisez un autre type de graphique.',

    'LBL_TEMPLATE' => 'Modèle',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Votre sélection contient des modèles de rapport, qui ne peuvent pas être supprimés en masse. Veuillez désélectionner les modèles pour continuer.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Votre sélection contient des modèles de rapport, qui ne peuvent pas être mis à jour en masse. Veuillez désélectionner les modèles pour continuer.',
];
