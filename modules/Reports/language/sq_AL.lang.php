...
$mod_strings = [
    ...
    'LBL_REVENUELINEITEMS' => 'Artikujt e linjës së të ardhurave',
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Rifresko rezultatet e raportit',
    ...
    'LBL_COPY_AS' => 'Kopjo si',
    'LBL_CURRENT_REPORT_TYPE' => 'Lloji i raportit aktual',
// report_name
    ...
    'LBL_HORIZ_BAR' => 'Shiriti horizontal (Pirg)',
    'LBL_VERT_BAR' => 'Shiriti vertikal (Pirg)',
    'LBL_PIE' => 'Rreth',
    'LBL_DONUT' => 'Unazë (donut)',
    'LBL_TREEMAP' => 'Hierarkik',
    'LBL_LINE' => 'Drejtëzë',
    'LBL_FUNNEL' => 'Drejtoj',
    'LBL_HORIZ_GBAR' => 'Shiriti horizontal (I grupuar)',
    'LBL_VERT_GBAR' => 'Shiriti vertikal (I grupuar)',
    ...
    'LBL_SERVER_ERROR' => 'Nuk mund ta aksesosh këtë raport për shkak të një problemi në server.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Raporti i planifikuar "{0} (ID: {1})" është çaktivizuar papritur. Kontaktoni administratorin për më shumë informacion.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Shabllonet',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Jo shabllonet',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Grafik',
    'LBL_REPORT_TABLE' => 'Tabela',
    'LBL_REPORT_FILTERS' => 'Filtrat',
    'LBL_REPORT_DATA_TABLE' => 'Tabela e të dhënave',
    'LBL_REPORT_MINIMIZE' => 'Zgjero/Minimizo',
    'LBL_REPORT_EXPAND' => 'Zgjero',
    'LBL_EXPORT_AS' => 'Eksporto si',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Ky lloj skedari është optimizuar për printim dhe shpërndarje, dhe nuk mund të modifikohet lehtë. Grafikët dhe tabelat e raportit janë të përfshira.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Ky lloj skedari përmban të dhëna të ndara me presje dhe mund të hapet në një aplikacion me fletë elektronike. Ai përmban të dhëna të papërpunuara por përjashton grafikët dhe tabelat e raportit.',
    'LBL_EXPORT_PDF' => 'Duke gjeneruar PDF-në',
    'LBL_EXPORT_CSV' => 'Duke gjeneruar CSV-në',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF u gjenerua me sukses!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV u gjenerua me sukses!',
    'LBL_DATA_TABLE' => 'Tabela e të dhënave',
    'LBL_COLLAPSE_ALL' => 'Palos të gjitha',
    'LBL_EXPAND_ALL' => 'Zgjero të gjitha',
    'LBL_TOTAL_COUNT' => 'Numri total',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Nuk ke leje për të parë një ose më shumë filtra të kohës së ekzekutimit',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Ky raport është modifikuar që nga freskimi i fundit.',
    'LBL_EXPORT_FAILED' => 'Raporti është shumë i madh për t&#39;u eksportuar. Për të zvogëluar madhësinë e raportit, kufizo të dhënat nga modulet përkatëse ose përdor filtra për të ngushtuar rezultatet.',
    'LBL_SELECT_ALL' => 'Zgjidh të gjitha',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Tabela e të dhënave është shumë e madhe për t&#39;u ngarkuar.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Rregullo filtrat për të reduktuar rezultatet ose për të eksportuar rezultatet aktuale si një skedar CSV.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Tabelë e madhe e të dhënave. Rregullo filtrat për të reduktuar rezultatet ose zgjidh një opsion më poshtë.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Mund ta ruash grupin e plotë të rezultateve si një skedar CSV ose të shikosh grupin e plotë të rezultateve në këtë panel si tabelë të thjeshtuar.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Shiko tabelën e thjeshtësuar',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Rregullo filtrat për të reduktuar rezultatet.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Tabelë e madhe e të dhënave. Rregullo filtrat për të reduktuar rezultatet ose zgjidh opsionin e mëposhtëm.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Mund të shikosh grupin e plotë të rezultateve në këtë panel si një tabelë të thjeshtuar.',
    'LBL_EXPORT_AS_CSV' => 'Eksporto si CSV',
    'LBL_FILTER_VIEW' => 'Pamja e filtrit',
    'LBL_TABLE_VIEW' => 'Pamja tabelë',
    'LBL_CHART_VIEW' => 'Pamja grafik',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Pamja e ndarë vertikalisht',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Pamja e ndarë horizontalisht',
    'LBL_SHOWING' => 'Duke u shfaqur',
    'LBL_ONE_VIEW_REQUIRED' => 'Duhet zgjedhur të paktën një pamje',
    'LBL_RC_NO_CHART' => 'Raportet e rreshtave dhe kolonave nuk mbështesin grafikët',
    'LBL_LINE_CHART_INVALID' => 'Grafiku me vija kërkon dy fusha grupimi. Cakto një fushë tjetër grupimi ose përdor një lloj tjetër grafiku.',

    'LBL_TEMPLATE' => 'Shabllon',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Përzgjedhja juaj përmban shabllone raportesh, që nuk mund të fshihen në masë. Hiqni shabllonet nga përzgjedhja për të vazhduar.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Përzgjedhja juaj përmban shabllone raportesh, që nuk mund të përditësohen në masë. Hiqni shabllonet nga përzgjedhja për të vazhduar.',
];
