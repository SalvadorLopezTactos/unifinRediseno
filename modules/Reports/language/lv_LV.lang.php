...
$mod_strings = [
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Atsvaidzināt atskaites rezultātus',
    ...
    'LBL_COPY_AS' => 'Kopēt kā',
    'LBL_CURRENT_REPORT_TYPE' => 'Pašreizējais atskaites veids',
// report_name
    ...
    'LBL_DUPLICATE_BUTTON_LABEL' => 'Dublēt',
    ...
    'LBL_HORIZ_BAR' => 'Horizontāla josla (grēdota)',
    'LBL_VERT_BAR' => 'Vertikāla josla (grēdota)',
    'LBL_PIE' => 'Sektoru',
    'LBL_DONUT' => 'Gredzenveida',
    'LBL_TREEMAP' => 'Kokveida karte',
    'LBL_LINE' => 'Līnija',
    'LBL_FUNNEL' => 'Piltuve',
    'LBL_HORIZ_GBAR' => 'Horizontāla josla (grupēta)',
    'LBL_VERT_GBAR' => 'Vertikāla josla (grupēta)',
    ...
    'LBL_SERVER_ERROR' => 'Jums nav tiesību piekļūt šai atskaitei servera kļūdas dēļ.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Ieplānotā atskaite "{0} (ID: {1})" tika negaidīti deaktivizēta. Lūdzu, sazinieties ar administratoru, lai saņemtu plašāku informāciju.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Veidnes',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Nav veidnes',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Diagramma',
    'LBL_REPORT_TABLE' => 'Tabula',
    'LBL_REPORT_FILTERS' => 'Filtri',
    'LBL_REPORT_DATA_TABLE' => 'Datu tabula',
    'LBL_REPORT_MINIMIZE' => 'Izvērst/Minimizēt',
    'LBL_REPORT_EXPAND' => 'Izvērst',
    'LBL_EXPORT_AS' => 'Eksportēt kā',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Šis faila tips ir optimizēts drukāšanai un koplietošanai, un to nevar viegli rediģēt. Ir iekļautas atskaišu diagrammas un tabulas.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Šis faila tips satur ar komatu atdalītus datus, un to var atvērt izklājlapu lietotnē. Tas satur neapstrādātus datus, bet neietver atskaišu diagrammas un tabulas.',
    'LBL_EXPORT_PDF' => 'Ģenerē PDF',
    'LBL_EXPORT_CSV' => 'Ģenerē CSV',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF veiksmīgi ģenerēts!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV veiksmīgi ģenerēts!',
    'LBL_DATA_TABLE' => 'Datu tabula',
    'LBL_COLLAPSE_ALL' => 'Savērst visus',
    'LBL_EXPAND_ALL' => 'Izvērst visus',
    'LBL_TOTAL_COUNT' => 'Kopējais skaits',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Jums nav atļauju skatīt vienu vai vairākus izpildlaika filtrus',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Šis pārskats ir izmainīts kopš pēdējās atjaunošanas reizes.',
    'LBL_EXPORT_FAILED' => 'Atskaite ir pārāk liela eksportēšanai. Lai samazinātu atskaites izmēru, ierobežojiet datus no saistītajiem moduļiem vai izmantojiet filtrus, lai sašaurinātu rezultātus.',
    'LBL_SELECT_ALL' => 'Atlasīt visu',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Datu tabula ir pārāk liela ielādēšanai.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Pielāgojiet filtrus, lai samazinātu rezultātus, vai eksportējiet pašreizējos rezultātus kā CSV failu.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Liela datu tabula. Pielāgojiet filtrus, lai samazinātu rezultātus, vai izvēlieties kādu no tālāk norādītajām opcijām.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Varat saglabāt visu rezultātu kopu kā CSV failu vai skatīt pilnu rezultātu kopu šajā panelī kā vienkāršotu tabulu.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Skatīt vienkāršotu tabulu',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Pielāgojiet filtrus, lai samazinātu rezultātus.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Liela datu tabula. Pielāgojiet filtrus, lai samazinātu rezultātus, vai izvēlieties kādu no tālāk norādītajām opcijām.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Šajā panelī varat apskatīt pilnu rezultātu kopu kā vienkāršotu tabulu.',
    'LBL_EXPORT_AS_CSV' => 'Eksportēt kā CSV',
    'LBL_FILTER_VIEW' => 'Filtra skats',
    'LBL_TABLE_VIEW' => 'Tabulas skats',
    'LBL_CHART_VIEW' => 'Diagrammas skats',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Vertikāli sadalīts skats',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Horizontāli sadalīts skats',
    'LBL_SHOWING' => 'Rāda',
    'LBL_ONE_VIEW_REQUIRED' => 'Jāatlasa vismaz viens skats',
    'LBL_RC_NO_CHART' => 'Rindu un kolonnu atskaites neatbalsta diagrammas',
    'LBL_LINE_CHART_INVALID' => 'Līniju diagrammai ir nepieciešami divi lauki pēc grupas. Definējiet citu lauku pēc grupas vai izmantojiet citu diagrammas tipu.',

    'LBL_TEMPLATE' => 'Veidne',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Jūsu atlasē ir atskaites veidnes, kuras nevar masveidā izdzēst. Lūdzu, noņemiet atlasi veidnēm, lai turpinātu.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Jūsu atlasē ir atskaites veidnes, kuras nevar masveidā atjaunināt. Lūdzu, noņemiet atlasi veidnēm, lai turpinātu.',
];
