...
$mod_strings = [
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Uppdatera rapportresultat',
    ...
    'LBL_COPY_AS' => 'Kopiera som',
    'LBL_CURRENT_REPORT_TYPE' => 'Nuvarande rapporttyp',
// report_name
    ...
    'LBL_DUPLICATE_BUTTON_LABEL' => 'Duplicerad',
    ...
    'LBL_HORIZ_BAR' => 'Horisontellt fält (staplat)',
    'LBL_VERT_BAR' => 'Vertikalt fält (staplat)',
    'LBL_PIE' => 'Paj',
    'LBL_DONUT' => 'Ring',
    'LBL_TREEMAP' => 'Treemap',
    'LBL_LINE' => 'Linje',
    'LBL_FUNNEL' => 'Tratt',
    'LBL_HORIZ_GBAR' => 'Horisontellt fält (grupperat)',
    'LBL_VERT_GBAR' => 'Vertikalt fält (grupperat)',
    ...
    'LBL_SERVER_ERROR' => 'Du kommer inte åt denna rapport på grund av ett serverfel.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Schemalagd rapport ”{0} (ID: {1})” har oväntat inaktiverats. Kontakta administratören för mer information.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Mallar',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Icke mallar',
    ...
    'LBL_REPORTS_FOCUS_DRAWER_DASHBOARD' => 'Fokuslåda för rapporter',
    ...
    'LBL_REPORT_MINIMIZE' => 'Expandera/Minimera',
    'LBL_REPORT_EXPAND' => 'Expandera',
    'LBL_EXPORT_AS' => 'Exportera som',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Denna filtyp är optimerad för utskrift och delning och det är inte lätt att redigera den. Rapportdiagram och tabeller är inkluderade.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Denna filtyp innehåller kommatecken-separerad data och kan öppnas i en kalkylbladsapplikation. Den innehåller rå data men exkluderar rapportdiagram och tabeller.',
    'LBL_EXPORT_PDF' => 'Genererar PDF',
    'LBL_EXPORT_CSV' => 'Genererar CSV',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF skapades!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV skapades!',
    'LBL_DATA_TABLE' => 'Datatabell',
    'LBL_COLLAPSE_ALL' => 'Dra ihop alla',
    'LBL_EXPAND_ALL' => 'Utöka alla',
    'LBL_TOTAL_COUNT' => 'Totalsumma',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Du har inte behörighet att visa ett eller flera körningsfilter',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Den här rapporten har ändrats sedan den senaste uppdateringen.',
    'LBL_EXPORT_FAILED' => 'Rapporten är för stor för att exportera. För att minska rapportens storlek, begränsa data från relaterade moduler eller använd filter för att avgränsa resultaten.',
    'LBL_SELECT_ALL' => 'Välj alla',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Datatabellen är för stor för att läsas in.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Justera filtren för att minska antalet resultat eller exportera aktuella resultat som en CSV-fil.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Stor datatabell. Justera filtren för att minska antalet resultat eller välj ett alternativ nedan.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Du kan spara alla resultat som en CSV-fil eller visa alla resultat i denna panel som en förenklad tabell.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Visa förenklad tabell',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Justera filtren för att minska antalet resultat.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Stor datatabell. Justera filtren för att minska antalet resultat eller välj alternativet nedan.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Du kan se hela resultatuppsättningen i denna panel som en förenklad tabell.',
    'LBL_EXPORT_AS_CSV' => 'Exportera som CSV',
    'LBL_FILTER_VIEW' => 'Filtrera vy',
    'LBL_TABLE_VIEW' => 'Tabellvy',
    'LBL_CHART_VIEW' => 'Diagramvy',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Vertikalt delad vy',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Horisontellt delad vy',
    'LBL_SHOWING' => 'Visar',
    'LBL_ONE_VIEW_REQUIRED' => 'Minst en vy måste väljas',
    'LBL_RC_NO_CHART' => 'Rad- och kolumnrapporter stöder inte diagram',
    'LBL_LINE_CHART_INVALID' => 'Ett linjediagram kräver två fält att gruppera efter. Ange ett till fält att gruppera efter eller välj en annan diagramtyp.',

    'LBL_TEMPLATE' => 'Mall',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Ditt val innehåller rapportmallar, som inte går att massradera. Avmarkera mallar för att fortsätta.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Ditt val innehåller rapportmallar, som inte går att massuppdatera. Avmarkera mallar för att fortsätta.',
];
