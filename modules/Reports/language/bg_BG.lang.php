...
$mod_strings = [
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Обновяване на резултати от справката',
    ...
    'LBL_COPY_AS' => 'Копирай като',
    'LBL_CURRENT_REPORT_TYPE' => 'Текущ вид на справката',
// report_name
    ...
    'LBL_HORIZ_BAR' => 'Хоризонтална лента (подредени)',
    'LBL_VERT_BAR' => 'Вертикална лента (подредени)',
    'LBL_PIE' => 'Диаграма тип "Pie"',
    'LBL_DONUT' => 'Кръгова диаграма',
    'LBL_TREEMAP' => 'Диаграма с йерархична структура',
    'LBL_LINE' => 'Диаграма тип "Line"',
    'LBL_FUNNEL' => 'Диаграма тип "Funnel"',
    'LBL_HORIZ_GBAR' => 'Хоризонтална лента (групирани)',
    'LBL_VERT_GBAR' => 'Вертикална лента (групирани)',
    ...
    'LBL_SERVER_ERROR' => 'Нямате достъп до тази справка поради грешка на сървъра.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Планираният доклад "{0} (ID: {1})" беше деактивиран неочаквано. Обърнете се към вашия администратор за повече информация.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Шаблони',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Няма шаблони',
    ...
    'LBL_REPORTS_FOCUS_DRAWER_DASHBOARD' => 'Чекмедже Фокус на отчети',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Графика',
    'LBL_REPORT_TABLE' => 'Таблица',
    'LBL_REPORT_FILTERS' => 'Филтри',
    'LBL_REPORT_DATA_TABLE' => 'Таблица с данни',
    'LBL_REPORT_MINIMIZE' => 'Разшири/минимизирай',
    'LBL_REPORT_EXPAND' => 'Покажи повече',
    'LBL_EXPORT_AS' => 'Експортирай като',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Този тип файл е оптимизиран за отпечатване и споделяне и не може да се редактира лесно. Включени са графики и таблици на справката.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Този тип файл включва данни, отделени със запетая, и може да се отвори в приложение за електронни таблици. Той съдържа сурови данни, но не включва диаграми и таблици на справки.',
    'LBL_EXPORT_PDF' => 'Генериране на PDF',
    'LBL_EXPORT_CSV' => 'Генериране на CSV',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF файлът е генериран успешно!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV файлът е генериран успешно!',
    'LBL_DATA_TABLE' => 'Таблица с данни',
    'LBL_COLLAPSE_ALL' => 'Скрий всички',
    'LBL_EXPAND_ALL' => 'Покажи всички',
    'LBL_TOTAL_COUNT' => 'Общ брой',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Нямате разрешение да видите един или повече филтри за изпълнение',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Тази справка е била модифицирана след последното обновяване.',
    'LBL_EXPORT_FAILED' => 'Този доклад е твърде голям за експорт. За да намалите размера на доклада, моля, ограничете данните от съответните модули или използвайте филтри, за да намалите резултатите.',
    'LBL_SELECT_ALL' => 'Избери всички',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Таблицата с данни е прекалено голяма, за да се зареди.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Променете настройките на филтрите, за да намалите резултатите или експортирайте настоящите резултати като CSV файл.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Голяма таблица с данни. Променете настройките на филтрите, за да намалите резултатите или изберете някоя от опциите по-долу.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Можете да запазите пълното множество от данни като CSV файл или да разглеждате пълното множество от данни в този панел като опростена таблица.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Изглед като опростена таблица',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Променете настройките на филтрите, за да намалите резултатите.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Голяма таблица с данни. Променете настройките на филтрите, за да намалите резултатите или изберете опцията по-долу.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Можете да видите пълния набор от резултати в този панел като опростена таблица.',
    'LBL_EXPORT_AS_CSV' => 'Експортиране в CSV формат',
    'LBL_FILTER_VIEW' => 'Филтриран изглед',
    'LBL_TABLE_VIEW' => 'Табличен изглед',
    'LBL_CHART_VIEW' => 'Изглед като графика',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Вертикално разделен изглед',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Хоризонтално разделен изглед',
    'LBL_SHOWING' => 'Показване',
    'LBL_ONE_VIEW_REQUIRED' => 'Моля, изберете поне един изглед',
    'LBL_RC_NO_CHART' => 'Справките за редове и колони не поддържат диаграми',
    'LBL_LINE_CHART_INVALID' => 'Линейната диаграма изисква две полета за групиране. Дефинирайте друго поле за групиране или използвайте друг тип диаграма.',

    'LBL_TEMPLATE' => 'Шаблон',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Вашата селекция съдържа шаблони за отчети, които не могат да бъдат изтрити масово. Премахнете избора на шаблони, за да продължите.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Вашият избор съдържа шаблони за отчети, които не могат да се актуализират масово. Премахнете избора на шаблони, за да продължите.',
];
