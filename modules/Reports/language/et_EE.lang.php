...
$mod_strings = [
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Värskenda aruande tulemusi',
    ...
    'LBL_COPY_AS' => 'Kopeeri kui',
    'LBL_CURRENT_REPORT_TYPE' => 'Praegune aruande tüüp',
// report_name
    ...
    'LBL_HORIZ_BAR' => 'Horisontaalriba (virnastatud)',
    'LBL_VERT_BAR' => 'Vertikaalriba (virnastatud)',
    'LBL_PIE' => 'Pie',
    'LBL_DONUT' => 'Rõngas',
    'LBL_TREEMAP' => 'Puukaart',
    'LBL_LINE' => 'Line',
    'LBL_FUNNEL' => 'Funnel',
    'LBL_HORIZ_GBAR' => 'Horisontaalriba (grupeeritud)',
    'LBL_VERT_GBAR' => 'Vertikaalriba (grupeeritud)',
    ...
    'LBL_SERVER_ERROR' => 'Te ei pääse sellele aruandele juurde serveri tõrke tõttu.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Kavandatud aruanne "{0} (ID: {1})" on ootamatult deaktiveeritud. Palun võtke lisainfo saamiseks ühendust oma administraatoriga.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Mallid',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Malle pole',
    ...
    'LBL_REPORT_FILTERS' => 'Filtrid',
    'LBL_REPORT_DATA_TABLE' => 'Andmete tabel',
    'LBL_REPORT_MINIMIZE' => 'Laienda/minimeeri',
    'LBL_REPORT_EXPAND' => 'Laienda',
    'LBL_EXPORT_AS' => 'Ekspordi kui',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'See failitüüp on optimeeritud printimiseks ja jagamiseks ning seda ei saa lihtsalt redigeerida. Kaasas on aruannete diagrammid ja tabelid.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'See failitüüp sisaldab komadega eraldatud andmeid ja seda saab avada arvutustabelirakenduses. See sisaldab algandmeid, kuid ei sisalda aruande diagramme ega tabeleid.',
    'LBL_EXPORT_PDF' => 'PDF-i loomine',
    'LBL_EXPORT_CSV' => 'CSV loomine',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF-i loomine õnnestus!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV loomine õnnestus!',
    'LBL_DATA_TABLE' => 'Andmete tabel',
    'LBL_COLLAPSE_ALL' => 'Ahenda kõik',
    'LBL_EXPAND_ALL' => 'Laienda kõik',
    'LBL_TOTAL_COUNT' => 'Koguarv',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Teil pole luba ühe või mitme käitusaja filtri vaatamiseks',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Seda aruannet on alates viimasest värskendamisest muudetud.',
    'LBL_EXPORT_FAILED' => 'Aruanne on eksportimiseks liiga suur. Aruande suuruse vähendamiseks piirake seotud moodulitest saadavaid andmeid või kasutage tulemuste kitsendamiseks filtreid.',
    'LBL_SELECT_ALL' => 'Vali kõik',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Andmete tabel on töötlemiseks liiga suur.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Kohandage tulemuste vähendamiseks filtreid või eksportige praegused tulemused CSV-failina.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Suur andmete tabel. Kohandage tulemuste vähendamiseks filtreid või valige alljärgnevalt valik.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Teil on võimalik salvestada täielik tulemustekogu CSV-failina või kuvada täielik tulemustekogu lihtsustatud tabelina sellel paneelil.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Kuva lihtsustatud tabel',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Tulemuste vähendamiseks kohandage filtreid.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Suur andmete tabel. Kohandage tulemuste vähendamiseks filtreid või valige alljärgnev suvand.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Selles paneelis seatud täielikku tulemust saate vaadata lihtsustatud tabelina.',
    'LBL_EXPORT_AS_CSV' => 'Ekspordi CSV-na',
    'LBL_FILTER_VIEW' => 'Filtrivaade',
    'LBL_TABLE_VIEW' => 'Tabelivaade',
    'LBL_CHART_VIEW' => 'Diagrammivaade',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Vertikaalne tükeldatud vaade',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Horisontaalne tükeldatud vaade',
    'LBL_SHOWING' => 'Kuvamine',
    'LBL_ONE_VIEW_REQUIRED' => 'Peab valima vähemalt ühe vaate',
    'LBL_RC_NO_CHART' => 'Ridade ja veergude aruanded diagramme ei toeta',
    'LBL_LINE_CHART_INVALID' => 'Joondiagrammi jaoks on vaja kahte rühmitamisvälja. Määratlege mõni muu rühmitamisväli või kasutage mõnda muud diagrammitüüpi.',

    'LBL_TEMPLATE' => 'Mall',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Teie valik sisaldab aruandemalle, mida ei saa massiliselt kustutada. Jätkamiseks tühistage mallide valik.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Teie valik sisaldab aruandemalle, mida ei saa massiliselt värskendada. Jätkamiseks tühistage mallide valik.',
];
