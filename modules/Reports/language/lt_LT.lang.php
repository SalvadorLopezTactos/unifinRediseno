...
$mod_strings = [
    ...
    'LBL_REVENUELINEITEMS' => 'Pajamų linijos prekės',
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Atnaujinti ataskaitos rezultatus',
    ...
    'LBL_COPY_AS' => 'Kopijuoti kaip',
    'LBL_CURRENT_REPORT_TYPE' => 'Dabartinis ataskaitos tipas',
// report_name
    ...
    'LBL_DUPLICATE_BUTTON_LABEL' => 'Dublikatas',
    ...
    'LBL_HORIZ_BAR' => 'Horizontali juosta (sudurtinė)',
    'LBL_VERT_BAR' => 'Vertikali juosta (sudurtinė)',
    'LBL_PIE' => 'Skritulinė diagrama',
    'LBL_DONUT' => '„Donut“',
    'LBL_TREEMAP' => 'Medžių žemėlapis',
    'LBL_LINE' => 'Skritulinė diagrama',
    'LBL_FUNNEL' => 'Piltuvėlio diagrama',
    'LBL_HORIZ_GBAR' => 'Horizontali juosta (sugrupuota)',
    'LBL_VERT_GBAR' => 'Vertikali juosta (sugrupuota)',
    ...
    'LBL_SERVER_ERROR' => 'Negalite pasiekti šios ataskaitos dėl serverio klaidos.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Suplanuota ataskaita „{0} (ID: {1})“ netikėtai buvo sulaikyta. Norėdami sužinoti daugiau, kreipkitės į savo administratorių.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Šablonai',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Ne šablonai',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Grafikas',
    'LBL_REPORT_TABLE' => 'Lentelė',
    'LBL_REPORT_FILTERS' => 'Filtrai',
    'LBL_REPORT_DATA_TABLE' => 'Duomenų lentelė',
    'LBL_REPORT_MINIMIZE' => 'Išplėsti / sumažinti',
    'LBL_REPORT_EXPAND' => 'Išplėsti',
    'LBL_EXPORT_AS' => 'Eksportuoti kaip',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Šis failo tipas yra optimizuotas spausdinti ir bendrinti, todėl jo negalima lengvai redaguoti. Pridedamos ataskaitų diagramos ir lentelės.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Šiame failo tipe yra kableliais atskirtų duomenų ir jį galima atidaryti naudojant skaičiuoklės programą. Jame yra neapdorotų duomenų, bet neįtraukiamos ataskaitų diagramos ir lentelės.',
    'LBL_EXPORT_PDF' => 'Generuojamas PDF',
    'LBL_EXPORT_CSV' => 'Generuojamas CSV',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF sėkmingai sugeneruotas!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV sėkmingai sugeneruotas!',
    'LBL_DATA_TABLE' => 'Duomenų lentelė',
    'LBL_COLLAPSE_ALL' => 'Viską sutraukti',
    'LBL_EXPAND_ALL' => 'Viską išplėsti',
    'LBL_TOTAL_COUNT' => 'Bendras kiekis',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Neturite leidimo peržiūrėti vieno ar daugiau vykdymo laiko filtrų',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Ši ataskaita pasiekitė po paskutinio atnaujinimo.',
    'LBL_EXPORT_FAILED' => 'Ataskaita yra per didelė, kad ją būtų galima eksportuoti. Norėdami sumažinti ataskaitos dydį, apribokite susijusių modulių duomenis arba naudokite filtrus rezultatams susiaurinti.',
    'LBL_SELECT_ALL' => 'Pasirinkti viską',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Duomenų lentelė yra per didelė, kad ją būtų galima įkelti.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Pritaikykite filtrus, kad sumažintumėte rezultatus, arba eksportuokite esamus rezultatus kaip CSV failą.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Didelė duomenų lentelė. Pritaikykite filtrus, kad sumažintumėte rezultatus, arba pasirinkite toliau pateiktą parinktį.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Visą rezultatų rinkinį galite išsaugoti kaip CSV failą arba peržiūrėti visą rezultatų rinkinį šiame skydelyje kaip supaprastintą lentelę.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Peržiūrėti supaprastintą lentelę',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Nustatykite filtrus, kad sumažintumėte rezultatų skaičių.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Didelė duomenų lentelė. Nustatykite filtrus, kad sumažintumėte rezultatų skaičių, arba pasirinkite toliau pateiktą parinktį.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Visą rezultatų rinkinį galite peržiūrėti šiame skydelyje kaip supaprastintą lentelę.',
    'LBL_EXPORT_AS_CSV' => 'Eksportuoti kaip CSV',
    'LBL_FILTER_VIEW' => 'Filtruotas rodmuo',
    'LBL_TABLE_VIEW' => 'Lentelės rodmuo',
    'LBL_CHART_VIEW' => 'Diagramos rodmuo',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Vertikalus padalytas rodmuo',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Horizontalus padalytas rodmuo',
    'LBL_SHOWING' => 'Rodoma',
    'LBL_ONE_VIEW_REQUIRED' => 'Turi būti pasirinktas bent vienas vaizdas',
    'LBL_RC_NO_CHART' => 'Eilučių ir stulpelių ataskaitos nepalaiko diagramų',
    'LBL_LINE_CHART_INVALID' => 'Linijinei diagramai reikalingi du sugrupuoti laukai. Apibrėžkite kitą lauką pagal grupes arba naudokite kitą diagramos tipą.',

    'LBL_TEMPLATE' => 'Šablonas',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Jūsų pasirinkime yra ataskaitų šablonų, kurių negalima masiškai ištrinti. Norėdami tęsti, panaikinkite šablonų pasirinkimą.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Jūsų pasirinkime yra ataskaitų šablonų, kurių negalima masiškai atnaujinti. Norėdami tęsti, panaikinkite šablonų pasirinkimą.',
];
