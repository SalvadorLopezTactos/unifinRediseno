...
$mod_strings = [
    ...
    'LBL_REVENUELINEITEMS' => 'Bevétel sorok tételek',
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Jelentéseredmények frissítése',
    ...
    'LBL_COPY_AS' => 'Másolás mint',
    'LBL_CURRENT_REPORT_TYPE' => 'Jelenlegi jelentés típusa',
// report_name
    ...
    'LBL_DUPLICATE_BUTTON_LABEL' => 'Kettőzés',
    ...
    'LBL_HORIZ_BAR' => 'Vízszintes sáv (halmozott)',
    'LBL_VERT_BAR' => 'Függőleges sáv (halmozott)',
    'LBL_PIE' => 'kör',
    'LBL_DONUT' => 'Fánk',
    'LBL_TREEMAP' => 'Treemap',
    'LBL_LINE' => 'Vonal',
    'LBL_FUNNEL' => 'Tölcsér',
    'LBL_HORIZ_GBAR' => 'Vízszintes sáv (csoportokba rendezett)',
    'LBL_VERT_GBAR' => 'Függőleges sáv (csoportokba rendezett)',
    ...
    'LBL_SERVER_ERROR' => 'Szerverhiba miatt Ön nem fér hozzá ehhez az oldalhoz.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'A(z) "{0} (ID: {1})" beütemezett jelentést váratlanul letiltották. További tájékoztatás ügyében vegye fel a kapcsolatot az adminisztrátorral.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Sablonok',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Nem sablonok',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Diagram',
    'LBL_REPORT_TABLE' => 'Táblázat',
    'LBL_REPORT_FILTERS' => 'Szűrők',
    'LBL_REPORT_DATA_TABLE' => 'Adattábla',
    'LBL_REPORT_MINIMIZE' => 'Kinyitás/összecsukás',
    'LBL_REPORT_EXPAND' => 'Kibővít',
    'LBL_EXPORT_AS' => 'Exportálás másként',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Ez a fájltípus nyomtatásra és megosztásra van optimalizálva és nem könnyű módosítani. Tartalmazza a jelentésdiagramokat és táblázatokat.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Ez a fájltípus vesszők által elválasztott adatokat tartalmaz, amelyeket táblázatkelező alkalmazásban tud megnyitni. Tartalmazza a nyers adatokat, de kihagyja a jelentésdiagramokat és táblázatokat.',
    'LBL_EXPORT_PDF' => 'PDF létrehozása',
    'LBL_EXPORT_CSV' => 'CSV létrehozása',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF létrehozása sikeres!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV létrehozása sikeres!',
    'LBL_DATA_TABLE' => 'Adattábla',
    'LBL_COLLAPSE_ALL' => 'Az összes becsukása',
    'LBL_EXPAND_ALL' => 'Az összes kibontása',
    'LBL_TOTAL_COUNT' => 'Teljes darabszám',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Nincs engedélye egy vagy több futó szűrő megtekintéséhez',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'A jelentés módosult az utolsó frissítés óta.',
    'LBL_EXPORT_FAILED' => 'A jelentés túl nagy az exportáláshoz. A jelentés méretének csökkentése érdekében kérjük, korlátozza a kapcsolódó modulokból származó adatok mennyiségét, vagy használjon szűrőket az eredmények szűkítése érdekében.',
    'LBL_SELECT_ALL' => 'Mindent kijelöl',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Az adattábla túl nagy a betöltéshez.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Módosítsa a szűrőket az eredmények számának csökkentése érdekében, vagy exportálja ki a jelenlegi eredményeket egy CSV fájlba.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Nagy adattábla. Módosítsa a szűrőket az eredmények számának csökkentése érdekében, vagy válasszon az alábbi lehetőségek közül.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Elmentheti a teljes eredménykészletet egy CSV-fájlba, vagy megtekintheti a teljes eredménykészletet ezen a panelen egy egyszerűsített táblázatban.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Egyszerűsített táblázat megtekintése',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Állítsa be a szűrőket az eredmények számának csökkentése érdekében.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Nagy adattábla. Módosítsa a szűrőket az eredmények számának csökkentése érdekében, vagy válasszon egy lehetőséget az alábbiak közül.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Ezen a panelen a teljes eredményhalmazt egyszerűsített táblázatként tekintheti meg.',
    'LBL_EXPORT_AS_CSV' => 'Exportálás CSV-fájlba',
    'LBL_FILTER_VIEW' => 'Szűrőnézet',
    'LBL_TABLE_VIEW' => 'Táblázat nézet',
    'LBL_CHART_VIEW' => 'Diagramnézet',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Függőleges megosztás nézet',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Vízszintes megosztás nézet',
    'LBL_SHOWING' => 'Mutatás',
    'LBL_ONE_VIEW_REQUIRED' => 'Legalább egy nézetet ki kell választania',
    'LBL_RC_NO_CHART' => 'A sor- és oszlopjelentések nem támogatják a diagramokat',
    'LBL_LINE_CHART_INVALID' => 'A vonaldiagramhoz két csoportosítási szempontú mezőre van szükség. Definiáljon másik csoportosítási szempontú mezőt, vagy használjon másik diagramtípust.',

    'LBL_TEMPLATE' => 'Sablon',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'A kijelölés jelentéssablonokat tartalmaz, amit nem lehet csoportosan törölni. Törölje a sablonok kijelölését a folytatáshoz.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'A kijelölés jelentéssablonokat tartalmaz, amit nem lehet csoportosan frissíteni. Törölje a sablonok kijelölését a folytatáshoz.',
];
