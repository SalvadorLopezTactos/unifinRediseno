...
$mod_strings = [
    ...
    'LBL_REVENUELINEITEMS' => 'פריטי שורה של הכנסה',
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'רענון תוצאת הדוח',
    ...
    'LBL_COPY_AS' => 'העתק/י כ-',
    'LBL_CURRENT_REPORT_TYPE' => 'סוג הדוח הנוכחי',
// report_name
    'LBL_WAS_SAVED' => 'נשמר',
    ...
    'LBL_HORIZ_BAR' => 'סרגל אופקי (בערימה)',
    'LBL_VERT_BAR' => 'סרגל אנכי (בערימה)',
    'LBL_PIE' => 'פאי',
    'LBL_DONUT' => 'טבעת',
    'LBL_TREEMAP' => 'Treemap',
    'LBL_LINE' => 'שורה',
    'LBL_FUNNEL' => 'משפך',
    'LBL_HORIZ_GBAR' => 'סרגל אופקי (מקובץ)',
    'LBL_VERT_GBAR' => 'סרגל אנכי (מקובץ)',
    ...
    'LBL_SERVER_ERROR' => 'אין באפשרותך לגשת לדוח זה עקב שגיאת שרת.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'הדוח המתוכנן "{0} (מזהה: {1})" הושבת באופן בלתי צפוי. אנא צור קשר עם מנהל המערכת לקבלת מידע נוסף.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'תבניות',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'לא תבניות',
    ...
    'LBL_REPORTS_FOCUS_DRAWER_DASHBOARD' => 'מגירת פוקוס דוחות',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'תרשים',
    'LBL_REPORT_TABLE' => 'טבלה',
    'LBL_REPORT_FILTERS' => 'מסננים',
    'LBL_REPORT_DATA_TABLE' => 'טבלת נתונים',
    'LBL_REPORT_MINIMIZE' => 'הרחבה/צמצום',
    'LBL_REPORT_EXPAND' => 'הרחבה',
    'LBL_EXPORT_AS' => 'ייצוא כ-',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'סוג קובץ זה ממוטב להדפסה ולשיתוף ולא ניתן לערוך אותו בקלות. התרשימים והטבלאות של הדוח כלולים בו.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'סוג קובץ זה כולל נתונים המופרדים בפסיק וניתן לפתוח אותו באפליקציה לגיליונות אלקטרוניים. הוא כולל נתונים גולמיים, ללא טבלאות ותרשימים מן הדוח.',
    'LBL_EXPORT_PDF' => 'המערכת יוצרת קובץ PDF',
    'LBL_EXPORT_CSV' => 'המערכת יוצרת קובץ CSV',
    'LBL_EXPORT_PDF_SUCCESS' => 'קובץ ה-PDF נוצר בהצלחה!',
    'LBL_EXPORT_CSV_SUCCESS' => 'קובץ ה-CSV נוצר בהצלחה!',
    'LBL_DATA_TABLE' => 'טבלת נתונים',
    'LBL_COLLAPSE_ALL' => 'כווץ/י הכול',
    'LBL_EXPAND_ALL' => 'הרחב/י הכול',
    'LBL_TOTAL_COUNT' => 'ספירה כוללת',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'אין לך הרשאת צפייה במסנן אחד או יותר של זמן ריצה',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'הדוח עבר שינוי מאז הרענון האחרון.',
    'LBL_EXPORT_FAILED' => 'הדוח גדול מדי לייצוא. כדי להקטין את הדוח, נא להגביל את הנתונים מהמודולים הקשורים, או להשתמש במסננים לצמצום התוצאות.',
    'LBL_SELECT_ALL' => 'בחר הכול',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'טבלת הנתונים גדולה מדי לטעינה.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'אפשר לכוונן את המסננים כדי לצמצם את התוצאות או לייצא את התוצאות הנוכחיות כקובץ CSV.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'טבלת הנתונים גדולה. אפשר לכוונן את המסננים כדי לצמצם תוצאות או לבחור אפשרות למטה.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'אפשר לשמור את אוסף התוצאות המלא כקובץ CSV או לעיין באוסף התוצאות המלא בפאנל זה, בתור טבלה מפושטת.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'הצג טבלה מפושטת',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'אפשר לכוונן את המסננים כדי להקטין את מספר התוצאות.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'טבלת הנתונים גדולה. אפשר לכוונן את המסננים כדי להקטין את מספר התוצאות או לבחור באפשרות למטה.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'ניתן להציג את ערכת התוצאות המלאה בפאנל זה כטבלה פשוטה.',
    'LBL_EXPORT_AS_CSV' => 'ייצוא כ-CSV',
    'LBL_FILTER_VIEW' => 'סינון תצוגה',
    'LBL_TABLE_VIEW' => 'תצוגת טבלה',
    'LBL_CHART_VIEW' => 'תצוגת תרשים',
    'LBL_VERTICAL_SPLIT_VIEW' => 'תצוגת פיצול אנכי',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'תצוגת פיצול אופקי',
    'LBL_SHOWING' => 'מציג',
    'LBL_ONE_VIEW_REQUIRED' => 'חובה לבחור תצוגה אחת לפחות',
    'LBL_RC_NO_CHART' => 'דוחות של שורות ועמודות אינם תומכים בתרשימים',
    'LBL_LINE_CHART_INVALID' => 'תרשים קו צריך שני שדות &#39;מקובץ לפי&#39;. הגדר עוד שדה &#39;מקובץ לפי&#39;, או השתמש בסוג תרשים אחר.',

    'LBL_TEMPLATE' => 'תבנית',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'הפריטים שנבחרו כוללים תבניות של דוחות, שאותן אי אפשר למחוק במחיקה המונית. כדי להמשיך, יש לבטל בחירה בתבניות.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'הפריטים שנבחרו כוללים תבניות של דוחות, שאותן אי אפשר לעדכן בעדכון המוני. כדי להמשיך, יש לבטל בחירה בתבניות.',
];
