...
$mod_strings = [
    ...
    'LBL_REVENUELINEITEMS' => 'Elemente linie de venit',
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Actualizați rezultatele raportului',
    ...
    'LBL_COPY_AS' => 'Copiere ca',
    'LBL_CURRENT_REPORT_TYPE' => 'Tip de raport curent',
// report_name
    ...
    'LBL_HORIZ_BAR' => 'Bară orizontală (suprapusă)',
    'LBL_VERT_BAR' => 'Bară verticală (suprapusă)',
    'LBL_PIE' => 'Placinta',
    'LBL_DONUT' => 'Radial',
    'LBL_TREEMAP' => 'Arbore',
    'LBL_LINE' => 'Kinie',
    'LBL_FUNNEL' => 'Palnie',
    'LBL_HORIZ_GBAR' => 'Bară orizontală (grupată)',
    'LBL_VERT_GBAR' => 'Bară verticală (grupată)',
    ...
    'LBL_SERVER_ERROR' => 'Nu puteți accesa acest raport din cauza unei erori de server.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Raportul programat "{0} (ID: {1})" a fost dezactivat pe neașteptate. Luați legătura cu administratorul dumneavoastră pentru mai multe informații.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Șabloane',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Fără șabloane',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Diagramă',
    'LBL_REPORT_TABLE' => 'Tabel',
    'LBL_REPORT_FILTERS' => 'Filtre',
    'LBL_REPORT_DATA_TABLE' => 'Tabel de date',
    'LBL_REPORT_MINIMIZE' => 'Extindere/Minimizare',
    'LBL_REPORT_EXPAND' => 'Extindere',
    'LBL_EXPORT_AS' => 'Exportare ca',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Acest tip de fișier este optimizat pentru imprimare și partajare și nu poate fi editat cu ușurință. Diagramele și tabelele raportului sunt incluse.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Acest tip de fișier conține date separate prin virgulă și poate fi deschis într-o aplicație de foi de calcul. Acesta include date brute, dar nu include graficele și tabelele raportului.',
    'LBL_EXPORT_PDF' => 'Se generează PDF-ul',
    'LBL_EXPORT_CSV' => 'Se generează CSV-ul',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF generat cu succes!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV generat cu succes!',
    'LBL_DATA_TABLE' => 'Tabel de date',
    'LBL_COLLAPSE_ALL' => 'Restrângeți totul',
    'LBL_EXPAND_ALL' => 'Extindeți totul',
    'LBL_TOTAL_COUNT' => 'Număr total',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Nu aveți permisiuni pentru a vizualiza unul sau mai multe filtre de execuție',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Acest raport a fost modificat de la ultima reîmprospătare.',
    'LBL_EXPORT_FAILED' => 'Raportul este prea mare pentru a putea fi exportat. Pentru a reduce mărimea raportului, vă rugăm să limitați datele din modulele aferente sau să utilizați filtre pentru a restrânge rezultatele.',
    'LBL_SELECT_ALL' => 'Selectează tot',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Tabelul de date este prea mare pentru a putea fi încărcat.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Ajustați filtrele pentru a reduce rezultatele sau exportați rezultatele curente ca fișier CSV.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Tabel de date mare. Ajustați filtrele pentru a reduce rezultatele sau alegeți o opțiune de mai jos.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Puteți salva setul complet de rezultate ca fișier CSV sau puteți vizualiza setul complet de rezultate în acest panou ca tabel simplificat.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Vizualizare ca tabel simplificat',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Ajustați filtrele pentru a reduce rezultatele.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Tabel de date mare. Ajustați filtrele pentru a reduce rezultatele sau alegeți opțiunea de mai jos.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Puteți vizualiza setul complet de rezultate în acest panou sub forma unui tabel simplificat.',
    'LBL_EXPORT_AS_CSV' => 'Exportare ca CSV',
    'LBL_FILTER_VIEW' => 'Vizualizare cu filtre',
    'LBL_TABLE_VIEW' => 'Vizualizare ca tabel',
    'LBL_CHART_VIEW' => 'Vizualizare ca diagramă',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Vizualizare împărțită pe verticală',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Vizualizare împărțită pe orizontală',
    'LBL_SHOWING' => 'Afișare',
    'LBL_ONE_VIEW_REQUIRED' => 'Selectați cel puțin o vizualizare',
    'LBL_RC_NO_CHART' => 'Rapoartele privind rândurile și coloanele nu acceptă diagrame',
    'LBL_LINE_CHART_INVALID' => 'O diagramă linie necesită două câmpuri de grupare. Definiți un alt câmp de grupare sau utilizați un alt tip de diagramă.',

    'LBL_TEMPLATE' => 'Șablon',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Selecția dvs. conține șabloane de raport, care nu pot fi șterse în masă. Deselectați șabloanele pentru a continua.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Selecția dvs. conține șabloane de raport, care nu pot fi actualizate în masă. Deselectați șabloanele pentru a continua.',
];
