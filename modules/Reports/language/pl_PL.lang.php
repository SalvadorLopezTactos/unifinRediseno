...
$mod_strings = [
    ...
    'LBL_REVENUELINEITEMS' => 'Pozycje przychodu',
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Odśwież wyniki raportu',
    ...
    'LBL_COPY_AS' => 'Kopiuj jako',
    'LBL_CURRENT_REPORT_TYPE' => 'Bieżący typ raportu',
// report_name
    ...
    'LBL_HORIZ_BAR' => 'Wykres słupkowy poziomy (łączny)',
    'LBL_VERT_BAR' => 'Wykres słupkowy pionowy (łączny)',
    'LBL_PIE' => 'Wykres kołowy',
    'LBL_DONUT' => 'Pierścień',
    'LBL_TREEMAP' => 'Mapa drzewa',
    'LBL_LINE' => 'Wykres liniowy',
    'LBL_FUNNEL' => 'Lejek',
    'LBL_HORIZ_GBAR' => 'Wykres słupkowy poziomy (zgrupowany)',
    'LBL_VERT_GBAR' => 'Wykres słupkowy pionowy (zgrupowany)',
    ...
    'LBL_SERVER_ERROR' => 'Nie możesz uzyskać dostępu do tego raportu ze względu na błąd serwera.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Zaplanowany raport „{0} (ID: {1})” został nieoczekiwanie dezaktywowany. Skontaktuj się ze swoim administratorem, aby uzyskać więcej informacji.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Szablony',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Nieoparte na szablonach',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Wykres',
    'LBL_REPORT_TABLE' => 'Tabela',
    'LBL_REPORT_FILTERS' => 'Filtry',
    'LBL_REPORT_DATA_TABLE' => 'Tabela danych',
    'LBL_REPORT_MINIMIZE' => 'Rozwiń/minimalizuj',
    'LBL_REPORT_EXPAND' => 'Rozwiń',
    'LBL_EXPORT_AS' => 'Eksportuj jako',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Ten typ pliku jest zoptymalizowany pod kątem drukowania i udostępniania. Nie można go łatwo edytować. Zawiera wykresy i tabele raportu.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Ten typ pliku zawiera dane rozdzielane przecinkami. Można go otwierać w aplikacjach do obsługi arkuszy kalkulacyjnych. Zawiera nieprzetworzone dane, ale bez wykresów i tabel raportu.',
    'LBL_EXPORT_PDF' => 'Generowanie pliku PDF',
    'LBL_EXPORT_CSV' => 'Generowanie pliku CSV',
    'LBL_EXPORT_PDF_SUCCESS' => 'Pomyślnie wygenerowano plik PDF.',
    'LBL_EXPORT_CSV_SUCCESS' => 'Pomyślnie wygenerowano plik CSV.',
    'LBL_DATA_TABLE' => 'Tabela danych',
    'LBL_COLLAPSE_ALL' => 'Zwiń wszystko',
    'LBL_EXPAND_ALL' => 'Rozwiń wszystko',
    'LBL_TOTAL_COUNT' => 'Łączna liczba',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'Nie masz uprawnień do przeglądania co najmniej jednego filtra w czasie rzeczywistym',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'Ten raport został zmodyfikowany od ostatniego odświeżenia.',
    'LBL_EXPORT_FAILED' => 'Raport jest zbyt duży. Aby zmniejszyć wielkość raportu, zmniejsz liczbę danych pobieranych z powiązanych modułów lub użyj filtrów, aby zmniejszyć liczbę wyników.',
    'LBL_SELECT_ALL' => 'Zaznacz wszystko',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Nie można załadować tabeli danych. Tabela jest zbyt duża.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Dostosuj filtry, aby zmniejszyć liczbę wyników lub wyeksportuj bieżące wyniki jako plik CSV.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Tabela danych jest duża. Dostosuj filtry, aby zmniejszyć liczbę wyników lub wybierz opcję poniżej.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Można zapisać pełną listę wyników w pliku CSV lub wyświetlić ją w tym panelu w postaci tabeli uproszczonej.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Wyświetl tabelę uproszczoną',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Dostosuj filtry, aby zmniejszyć liczbę wyników.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Tabela danych jest duża. Dostosuj filtry, aby zmniejszyć liczbę wyników lub wybierz opcję poniżej.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Można wyświetlić pełną listę wyników w tym panelu w postaci tabeli uproszczonej.',
    'LBL_EXPORT_AS_CSV' => 'Eksportuj do pliku CSV',
    'LBL_FILTER_VIEW' => 'Widok filtra',
    'LBL_TABLE_VIEW' => 'Widok tabeli',
    'LBL_CHART_VIEW' => 'Widok wykresu',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Widok podziału pionowego',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Widok podziału poziomego',
    'LBL_SHOWING' => 'Pokazywane',
    'LBL_ONE_VIEW_REQUIRED' => 'Musisz wybrać co najmniej jeden widok',
    'LBL_RC_NO_CHART' => 'Raporty z wierszami i kolumnami nie obsługują wykresów',
    'LBL_LINE_CHART_INVALID' => 'Wykres liniowy wymaga dwóch pól grupowania. Zdefiniuj inne pole grupowania lub użyj innego rodzaju wykresu.',

    'LBL_TEMPLATE' => 'Szablon',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Wybór obejmuje szablony raportów, których nie można usunąć masowo. Usuń zaznaczenie szablonów, aby kontynuować.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Wybór obejmuje szablony raportów, których nie można zaktualizować masowo. Usuń zaznaczenie szablonów, aby kontynuować.',
];
