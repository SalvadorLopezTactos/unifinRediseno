...
$mod_strings = [
    ...
    'LBL_REVENUELINEITEMS' => 'Доходы по продуктам',
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Обновить результаты отчета',
    ...
    'LBL_COPY_AS' => 'Копировать как',
    'LBL_CURRENT_REPORT_TYPE' => 'Текущий тип отчета',
// report_name
    ...
    'LBL_DUPLICATE_BUTTON_LABEL' => 'Дубликат',
    ...
    'LBL_HORIZ_BAR' => 'Горизонтальная линейчатая диаграмма (с накоплением)',
    'LBL_VERT_BAR' => 'Вертикальная линейчатая диаграмма (с накоплением)',
    'LBL_PIE' => 'Круговая диаграмма',
    'LBL_DONUT' => 'Кольцевая',
    'LBL_TREEMAP' => 'Древовидная карта',
    'LBL_LINE' => 'Линия',
    'LBL_FUNNEL' => 'Воронка',
    'LBL_HORIZ_GBAR' => 'Горизонтальная линейчатая диаграмма (сгруппированная)',
    'LBL_VERT_GBAR' => 'Вертикальная линейчатая диаграмма (сгруппированная)',
    ...
    'LBL_SERVER_ERROR' => 'Вы не можете получить доступ к этому отчету из-за ошибки сервера.',
    ...
    'ERR_REPORT_DEACTIVATED' => 'Запланированный отчет "{0} (идентификатор: {1})" был неожиданно деактивирован. Для получения подробных сведений обратитесь к администратору.',
    ...
    'LBL_FILTER_TEMPLATE_REPORTS' => 'Шаблоны',
    'LBL_FILTER_NON_TEMPLATE_REPORTS' => 'Не шаблоны',
    ...
    'LBL_REPORTS_FOCUS_DRAWER_DASHBOARD' => 'Фокусная панель для отчетов',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Диаграмма',
    'LBL_REPORT_TABLE' => 'Таблица',
    'LBL_REPORT_FILTERS' => 'Фильтры',
    'LBL_REPORT_DATA_TABLE' => 'Таблица данных',
    'LBL_REPORT_MINIMIZE' => 'Развернуть/свернуть',
    'LBL_REPORT_EXPAND' => 'Развернуть',
    'LBL_EXPORT_AS' => 'Экспортировать как',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'Этот тип файла оптимизирован для печати и обмена, и его невозможно легко редактировать. Диаграммы и таблицы отчета включены.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'Этот тип файла содержит данные, разделенные запятыми, и может быть открыт в приложении для работы с электронными таблицами. Он содержит необработанные данные, но не содержит диаграмм и таблиц отчета.',
    'LBL_EXPORT_PDF' => 'Создание PDF',
    'LBL_EXPORT_CSV' => 'Generating CSV',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF успешно создан!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV успешно создан!',
    'LBL_DATA_TABLE' => 'Таблица данных',
    'LBL_COLLAPSE_ALL' => 'Свернуть все',
    'LBL_EXPAND_ALL' => 'Развернуть все',
    'LBL_TOTAL_COUNT' => 'Общее количество',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'У вас нет разрешений на просмотр одного или нескольких фильтров среды выполнения',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'С момента последнего обновления этот отчет был изменен.',
    'LBL_EXPORT_FAILED' => 'Отчет слишком большой для экспорта. Для уменьшения размера отчета ограничьте данные из связанных модулей или используйте фильтры, чтобы сузить результаты.',
    'LBL_SELECT_ALL' => 'Выбрать все',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Таблица данных является слишком большой для загрузки.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Настройте фильтры, чтобы уменьшить количество результатов, или экспортируйте текущие результаты в виде CSV-файла.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Большая таблица данных. Настройте фильтры, чтобы уменьшить количество результатов, или выберите опцию ниже.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'Вы можете сохранить полный набор результатов в виде CSV-файла или просмотреть полный набор результатов на данной панели в виде упрощенной таблицы.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'Просмотреть упрощенную таблицу',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Измените фильтры, чтобы сократить число результатов.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Большая таблица данных. Настройте фильтры, чтобы уменьшить количество результатов, или выберите опцию ниже.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'Полный набор результатов можно просмотреть на этой панели в виде упрощенной таблицы.',
    'LBL_EXPORT_AS_CSV' => 'Экспортировать как CSV',
    'LBL_FILTER_VIEW' => 'Представление с фильтрацией',
    'LBL_TABLE_VIEW' => 'Представление в виде таблицы',
    'LBL_CHART_VIEW' => 'Представление в виде диаграммы',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Представление с вертикальным разделением',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Представление с горизонтальным разделением',
    'LBL_SHOWING' => 'Отображается',
    'LBL_ONE_VIEW_REQUIRED' => 'Необходимо выбрать минимум одно представление',
    'LBL_RC_NO_CHART' => 'В отчетах, состоящих из строк и столбцов, не поддерживаются диаграммы',
    'LBL_LINE_CHART_INVALID' => 'Для линейной диаграммы требуется два поля с группировкой. Определите другое поле для группировки или используйте другой тип диаграммы.',

    'LBL_TEMPLATE' => 'Шаблон',
    'LBL_UNSELECT_DELETE_TEMPLATES' => 'Ваш выбор содержит шаблоны отчетов, для которых невозможно массовое удаление. Пожалуйста, отмените выбор шаблонов, чтобы продолжить.',
    'LBL_UNSELECT_UPDATE_TEMPLATES' => 'Ваш выбор содержит шаблоны отчетов, для которых невозможно массовое обновление. Пожалуйста, отмените выбор шаблонов, чтобы продолжить.',
];
