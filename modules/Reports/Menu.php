...
$module_menu = [
    ...
    ['index.php?module=Reports&report_module=&action=index&page=report&Create+Custom+Report=Create+Custom+Report', $mod_strings['LBL_CREATE_REPORT'], 'CreateReport', 'Reports'],
    ...
    */
    ...
    ['index.php?module=ReportMaker&action=index&return_module=ReportMaker&return_action=index', $ent_mod_strings['LNK_ADVANCED_REPORTING'], 'ReportMaker'],
];

if (!(ACLController::checkAccess('Reports', 'edit', true))) {
    $module_menu = [
        ['index.php?module=Reports&favorite=1&action=index', $mod_strings['LBL_FAVORITE_REPORTS'], 'FavoriteReports', 'Reports'],
        ['index.php?module=Reports&action=index', $mod_strings['LBL_ALL_REPORTS'], 'Reports', 'Reports'],
        ['index.php?module=ReportMaker&action=index&return_module=ReportMaker&return_action=index', $ent_mod_strings['LNK_ADVANCED_REPORTING'], 'ReportMaker', 'Reports'],
    ];
}
