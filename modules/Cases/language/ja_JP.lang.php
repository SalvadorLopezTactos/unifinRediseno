...
$mod_strings = [
    ...
    'LBL_CLAIM_AND_CLOSE' => 'ケースアクションボタン',
    'LBL_ACTION_CLAIM' => 'アクション 請求',
    'LBL_ACTION_CLOSE' => 'アクション 閉じる',
    'LBL_ACTION_UNASSIGN' => 'アクション 割り当て解除',
    'LBL_CLAIM_BUTTON_TEXT' => '請求',
    'LBL_CLOSE_BUTTON_TEXT' => '閉じる',
    'LBL_UNASSIGN_BUTTON_TEXT' => '割り当て解除',
...
2. 新しいレコードを確定し、前のページに戻るには「保存」をクリックします。',
    ...
    'LBL_ESCALATED_CASES' => 'エスカレーションされたケース',
];
