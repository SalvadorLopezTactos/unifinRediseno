...
$mod_strings = [
    ...
    'LBL_CLAIM_AND_CLOSE' => 'Кнопка действий при обращении',
    'LBL_ACTION_CLAIM' => 'Утверждение действия',
    'LBL_ACTION_CLOSE' => 'Закрытие действия',
    'LBL_ACTION_UNASSIGN' => 'Отмена назначения действия',
    'LBL_CLAIM_BUTTON_TEXT' => 'Подтвердить',
    'LBL_CLOSE_BUTTON_TEXT' => 'Закрыть',
    'LBL_UNASSIGN_BUTTON_TEXT' => 'Отменить назначение',
...
2. Нажмите "Сохранить", чтобы завершить создание новой записи и вернуться на предыдущую страницу.',
    ...
    'LBL_ESCALATED_CASES' => 'Обращения, в отношении которых выполнена эскалация',
];
