...
$mod_strings = [
    ...
    'LBL_CLAIM_AND_CLOSE' => 'Κουμπί ενέργειας περίπτωσης',
    'LBL_ACTION_CLAIM' => 'Διεκδίκηση ενέργειας',
    'LBL_ACTION_CLOSE' => 'Κλείσιμο ενέργειας',
    'LBL_ACTION_UNASSIGN' => 'Αναίρεση εκχώρησης ενέργειας',
    'LBL_CLAIM_BUTTON_TEXT' => 'Αξίωση',
    'LBL_CLOSE_BUTTON_TEXT' => 'Κλείσιμο',
    'LBL_UNASSIGN_BUTTON_TEXT' => 'Αναίρεση εκχώρησης',
...
2. Κάντε κλικ στην επιλογή "Αποθήκευση" για να οριστικοποιήσετε τη νέα εγγραφή και να επιστρέψετε στην προηγούμενη σελίδα.',
    ...
    'LBL_ESCALATED_CASES' => 'Κλιμακούμενες υποθέσεις',
];
