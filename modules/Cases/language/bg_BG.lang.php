...
$mod_strings = [
    ...
    'LBL_CLAIM_AND_CLOSE' => 'Бутон Действие по казус',
    'LBL_ACTION_CLAIM' => 'Искане за действие',
    'LBL_ACTION_CLOSE' => 'Затваряне на действие',
    'LBL_ACTION_UNASSIGN' => 'Отмяна на задаване на действие',
    'LBL_CLAIM_BUTTON_TEXT' => 'Предявяване на претенция',
    'LBL_CLOSE_BUTTON_TEXT' => 'Затвори',
    'LBL_UNASSIGN_BUTTON_TEXT' => 'Отмяна на присвояването',
...
2. Натиснете "Съхрани", за да запазите новия запис и да се върнете на предишната страница.',
    ...
    'LBL_ESCALATED_CASES' => 'Пренасочени към по-високо ниво казуси',
];
