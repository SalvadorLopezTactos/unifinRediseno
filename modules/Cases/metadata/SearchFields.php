...
$searchFields['Cases'] =
    [
        ...
        'status' => ['query_type' => 'default', 'options' => 'case_status_dom', 'template_var' => 'STATUS_OPTIONS'],
        'priority' => ['query_type' => 'default', 'options' => 'case_priority_dom', 'template_var' => 'PRIORITY_OPTIONS', 'options_add_blank' => true],
        'case_number' => ['query_type' => 'default', 'operator' => 'in'],
