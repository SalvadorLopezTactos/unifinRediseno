...
//ABOUT page
    ...
    'LBL_LICENSE_TYPE_INVALID' => 'סוג רישיון לא חוקי',
    'LBL_AND' => 'and',
    'LBL_ARE' => 'הם',
    ...
    'LBL_DASHBOARD_FILTERS' => 'מסנני לוח מחוונים',
    'LBL_NO_DASHBOARD_FILTER' => 'אין לך מסנני לוח מחוונים.',
    'LBL_ADD_FILTER' => 'הוסף מסנן',
    'LBL_SELECT_AVAILABLE_FILTERS' => 'בחר מסנני זמן ריצה זמינים, להוספה למסנן זה של לוח מחוונים.',
    'LBL_EDIT_FILTERS' => 'עריכת מסננים',
    'LBL_ONE_GROUP_REQUIRED' => 'מסנני לוח מחוונים לא יכולים להיות ריקים. נא לבחור מסנן זמן ריצה או להסיר את הקבוצה של מסנני לוח המחוונים לפני השמירה.',
    'LBL_NO_ALTER_FILTERS' => 'נא להמתין לטעינה מלאה של החלוניות לפני השימוש במסנני לוח המחוונים.',
    'LBL_NO_EMPTY_GROUPS' => 'נא להסיר את המסנן הריק של לוח המחוונים או להוסיף לו מסנן זמן ריצה.',
    'LBL_NO_PERMISSION_TO_FILTER' => 'אין לך הרשאה להשתמש במסנן זה.',
    'LBL_DASHBOARD_DASHLETS_INCOMPATIBLE' => 'התכונה לא זמינה עם החלוניות הנוכחיות.',
];
