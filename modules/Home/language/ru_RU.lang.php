...
$mod_strings = [
    ...
    'LBL_DASHLET_ADD' => 'Добавить раздел',
...
//ABOUT page
    ...
    'LBL_LICENSE_TYPE_INVALID' => 'Недопустимый тип лицензии',
    'LBL_AND' => 'и',
    'LBL_ARE' => 'являются',
    ...
    'LBL_DASHBOARD_FILTERS' => 'Фильтры информационной панели',
    'LBL_NO_DASHBOARD_FILTER' => 'У вас отсутствуют фильтры информационной панели.',
    'LBL_ADD_FILTER' => 'Добавить фильтр',
    'LBL_SELECT_AVAILABLE_FILTERS' => 'Выберите доступные фильтры среды выполнения для добавления их в этот фильтр информационной панели.',
    'LBL_EDIT_FILTERS' => 'Изменить фильтры',
    'LBL_ONE_GROUP_REQUIRED' => 'Фильтры информационной панели не могут быть пустыми. Выберите фильтр среды выполнения или удалите группу фильтров информационной панели перед сохранением.',
    'LBL_NO_ALTER_FILTERS' => 'Пожалуйста, дождитесь полной загрузки разделов, прежде чем использовать фильтры информационной панели.',
    'LBL_NO_EMPTY_GROUPS' => 'Удалите пустой фильтр информационной панели или добавьте к нему фильтр среды выполнения.',
    'LBL_NO_PERMISSION_TO_FILTER' => 'У вас нет прав на использование этого фильтра.',
    'LBL_DASHBOARD_DASHLETS_INCOMPATIBLE' => 'Функция недоступна с текущими дашлетами.',
];
