...
$mod_strings = [
    ...
    'LBL_DASHLET_ADD' => 'Lägg till dashlet',
...
//ABOUT page
    ...
    'LBL_LICENSE_TYPE_INVALID' => 'Ogiltig licenstyp',
    'LBL_AND' => 'and',
    'LBL_ARE' => 'är',
    ...
    'LBL_DASHBOARD_FILTERS' => 'Filter på instrumentpanelen',
    'LBL_NO_DASHBOARD_FILTER' => 'Du har inga filter på instrumentpanelen.',
    'LBL_ADD_FILTER' => 'Lägg till filter',
    'LBL_SELECT_AVAILABLE_FILTERS' => 'Välj tillgängliga filter för körningstid att lägga till i detta filter på instrumentpanelen.',
    'LBL_EDIT_FILTERS' => 'Redigera filter',
    'LBL_ONE_GROUP_REQUIRED' => 'Filter på instrumentpanelen får inte vara tomma. Välj ett filter för körningstid eller ta bort filtergruppen på instrumentpanelen innan du sparar.',
    'LBL_NO_ALTER_FILTERS' => 'Vänta tills dina dashlets har lästs in innan du använder filtren på instrumentpanelen.',
    'LBL_NO_EMPTY_GROUPS' => 'Ta bort det tomma filtret på instrumentpanelen eller lägg till ett filter för körningstid i detta filter.',
    'LBL_NO_PERMISSION_TO_FILTER' => 'Du har inte behörighet att använda detta filter.',
    'LBL_DASHBOARD_DASHLETS_INCOMPATIBLE' => 'Funktionen är inte tillgänglig med aktuella dashlets.',
];
