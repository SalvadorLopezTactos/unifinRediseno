...
$mod_strings = array (
  ...
  'LBL_NO_ACCESS' => 'アクセス権がありません。システム管理者にお問い合わせください。',
...
//ABOUT page
  ...
  'LBL_MOST_MEETING_HELD' => '{{count}} 会議が開かれた',
    ...
    'LBL_PORTAL_TOUR_RECORDS_PAGE' => 'ダッシュボードは最近更新されたレコードのスナップショットを表示します。',
    ...
    'LBL_PORTAL_TOUR_RECORDS_GLOBAL_SEARCH' => '名前か数値によりすべての使用可能なモジュールのレコードを検索します。',
