...
//ABOUT page
    ...
    'LBL_DASHBOARD_FILTERS' => 'ダッシュボードフィルター',
    'LBL_NO_DASHBOARD_FILTER' => 'ダッシュボードフィルターがありません。',
    'LBL_ADD_FILTER' => 'フィルターを追加',
    'LBL_SELECT_AVAILABLE_FILTERS' => '使用可能なランタイムフィルターを選択すると、このダッシュボードフィルターに追加できます。',
    'LBL_EDIT_FILTERS' => 'フィルターを編集',
    'LBL_ONE_GROUP_REQUIRED' => 'ダッシュボードフィルターを空にすることはできません。保存する前に、ランタイムフィルターを選択するか、ダッシュボードフィルターグループを削除してください。',
    'LBL_NO_ALTER_FILTERS' => 'ダッシュボードフィルターを使用する前に、ダッシュレットが完全に読み込まれるまでお待ちください。',
    'LBL_NO_EMPTY_GROUPS' => '空のダッシュボードフィルターを削除するか、ランタイムフィルターを追加してください。',
    'LBL_NO_PERMISSION_TO_FILTER' => 'このフィルターを使用する権限がありません。',
    'LBL_DASHBOARD_DASHLETS_INCOMPATIBLE' => '現在のダッシュレットでは使用できない機能。',
];
