...
//ABOUT page
    ...
    'LBL_LICENSE_TYPE_INVALID' => 'Неприпустимий тип ліцензії',
    'LBL_AND' => 'та',
    'LBL_ARE' => 'є',
    ...
    'LBL_DASHBOARD_FILTERS' => 'Фільтри інформаційної панелі',
    'LBL_NO_DASHBOARD_FILTER' => 'У вас немає фільтрів інформаційної панелі.',
    'LBL_ADD_FILTER' => 'Додати фільтр',
    'LBL_SELECT_AVAILABLE_FILTERS' => 'Виберіть доступні фільтри часу виконання, які потрібно додати до цього фільтра інформаційної панелі.',
    'LBL_EDIT_FILTERS' => 'Редагувати фільтри',
    'LBL_ONE_GROUP_REQUIRED' => 'Фільтри інформаційної панелі не можуть бути порожніми. Виберіть фільтр часу виконання або видаліть групу фільтрів інформаційної панелі перед збереженням.',
    'LBL_NO_ALTER_FILTERS' => 'Перш ніж використовувати фільтри інформаційної панелі, зачекайте, доки розділи повністю завантажаться.',
    'LBL_NO_EMPTY_GROUPS' => 'Видаліть порожній фільтр інформаційної панелі або додайте до нього фільтр часу виконання.',
    'LBL_NO_PERMISSION_TO_FILTER' => 'У вас немає дозволу на використання цього фільтра.',
    'LBL_DASHBOARD_DASHLETS_INCOMPATIBLE' => 'Функція недоступна для поточних міні-панелей.',
];
