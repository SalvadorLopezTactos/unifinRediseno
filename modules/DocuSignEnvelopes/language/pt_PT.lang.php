...
$mod_strings = [
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Timeline do Envelope do DocuSign',
    ...
    'LBL_ENVELOPE_TEMPLATE_ERROR' => 'O modelo DocuSign não pode ser aplicado',
    ...
    'LBL_RECIPIENT_ROLE_MISSING_ERROR' => 'Seleccione uma função para cada destinatário',
    
    'LBL_DOWNLOAD' => 'Descarregar',
    'LBL_OPEN_DRAFT' => 'Abrir Rascunho',
    'LBL_DOCUSING_NO_ATTACHMENT' => 'Documentos sem ficheiro não podem ser enviados para o DocuSign.',
    'LBL_START_SIGN_PROMPT' => 'Clique no botão "Mais" para iniciar o processo de assinatura',
    'LBL_NO_DOC_SELECTED' => 'Seleccione os documentos primeiro',
    'LBL_SELECT_RECIPIENTS' => 'Seleccionar destinatário signatário',
    'LBL_DOCUSIGN_EXCLUDE_DOC' => 'Excluir',
    'LBL_DOCUSIGN_MISSING_APP' => 'É necessário instalar a aplicação DocuSign para obter uma melhor experiência.',
];
