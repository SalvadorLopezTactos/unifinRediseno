...
$mod_strings = [
    ...
    'LBL_CLOUD_DRIVE_ID' => 'Αναγνωριστικό μονάδας',
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Χρονολόγιο φακέλου DocuSign',
    ...
    'LBL_BUTTON_SEND_WITH_TEMPLATE' => 'Αποστολή με πρότυπο',
    ...
    'LBL_ENVELOPE_TEMPLATE_ERROR' => 'Δεν είναι δυνατή η εφαρμογή του προτύπου DocuSign',
    ...
    'LBL_SEARCH_BY_TEMPLATE_NAME' => 'Αναζήτηση με βάση το όνομα προτύπου',
    'LBL_ENVELOPE_NAME' => 'Όνομα φακέλου',
    'LBL_ENVELOPE_NAME_EMPTY' => 'Το όνομα του φακέλου δεν μπορεί να είναι κενό',

    'LBL_FAILED_FETCH_RECIPIENTS' => 'Απέτυχε η λήψη πιθανών παραληπτών!',
    'LBL_FAILED_FETCH_TEMPLATES' => 'Αποτυχία λήψης προτύπων!',
    'LBL_RECIPIENT_ROLE_MISSING_ERROR' => 'Επιλέξτε έναν ρόλο για κάθε παραλήπτη',
    
    'LBL_DOWNLOAD' => 'Λήψη',
    'LBL_OPEN_DRAFT' => 'Άνοιγμα πρόχειρου',
    'LBL_DOCUSING_NO_ATTACHMENT' => 'Έγγραφα χωρίς αρχείο δεν μπορούν να σταλούν στο DocuSign.',
    'LBL_START_SIGN_PROMPT' => 'Κάντε κλικ στο κουμπί Συν για να ξεκινήσετε τη διαδικασία υπογραφής',
    'LBL_NO_DOC_SELECTED' => 'Επιλέξτε πρώτα έγγραφα',
    'LBL_SELECT_RECIPIENTS' => 'Επιλογή παραλήπτη υπογράφοντος',
    'LBL_DOCUSIGN_EXCLUDE_DOC' => 'Αποκλεισμός',
    'LBL_DOCUSIGN_MISSING_APP' => 'Πρέπει να εγκαταστήσετε την εφαρμογή DocuSign για καλύτερη εμπειρία.',
];
