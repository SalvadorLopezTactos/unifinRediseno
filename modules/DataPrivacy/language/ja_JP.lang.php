...
$mod_strings = array(
    ...
    'LBL_LIST_ASSIGNED_TO_NAME' => 'アサインされたユーザ',
    ...
    'LBL_DATA_PRIVACY_RECORD_DASHBOARD' => 'データプライバシーレコードダッシュボード',
    ...
    // record view
    'LBL_HELP_RECORD' => 'データプライバシーモジュールは、組織のプライバシー手続きをサポートするために、同意および件名要求を含めてプライバシーアクティビティを追跡します。プライバシー要求に対する同意を追跡したりアクションを取ったりするために、個々のレコード (取引先担当者など) に関連するデータプライバシーレコードを作成してください。必要なアクションが完了したら、データプライバシーマネージャ役割のユーザは「完了」または「拒否」をクリックしてステータスを更新できます。
