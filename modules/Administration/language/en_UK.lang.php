...
$mod_strings = [
    ...
    'LBL_CONFIG_TABS_DESC_DETAILED' => 'Drag and drop modules to set them as available in the navigation bar or hidden. <br>
        The Number of the Pinned Modules field determines how many of the available modules are shown when the navigation
...
If your system environment prohibits your system from communicating to the licence validation server through the internet, you should proceed with the <a href="javascript:void(0)" onclick="toggleDisplay(&#39;mainbody&#39;);toggleDisplay(&#39;manualbody&#39;);">Manual Validation</a> steps. ',
    ...
    'LBL_MODULE_LOADER_LICENSE_WARNING' => 'The ability to <a href="{0}">upload</a> custom file packages is not '
        . 'available for {1}. To see which licence types include this Module Loader functionality, refer to the '
        . '<a href="{2}">Licence Types Matrix</a> documentation.',
...
Any integrations that rely on this platform will stop working.',
    ...
    'LBL_MAPS_ADD_NEW_MODULE_TO_GEOCODE' => 'Add new a module for geocoding',
    ...
    'LBL_MAPS_AUTOPOPULATE_CITY_CODE' => 'Autopopulate city and state based on postcode',
    'LBL_MAPS_UNIT_TYPE_TITLE' => 'Measuremenet Unit',
    'LBL_MAPS_UNIT_TYPE_MILES' => 'Miles',
    'LBL_MAPS_UNIT_TYPE_KM' => 'Kilometres',
    'LBL_MAPS_UNIT_PLACEHOLDER' => 'Choose measuremenet unit',
    'LBL_MAPS_NO_ENABLED_MODULES' => 'There are no enabled modules. Please visit the connectors page.',
    ...
    'LBL_PORTALTHEME_BANNER_BACKGROUND_COLOR' => 'Background Colour',
    ...
    'LBL_PORTALTHEME_BUTTON_COLOR' => 'Button Colour',
    'LBL_PORTALTHEME_TEXT_LINK_COLOR' => 'Text Link Colour',
    ...
    'LBL_DRI_CUSTOMER_JOURNEY_SETTINGS_DESC' => 'Setup for the Sugar Automate package',
    ...
    'TPL_ACTIVITY_TIMELINE_SETTINGS_LIMIT_LABEL' => 'Choose up to eight modules to show in this timeline',
    'TPL_ACTIVITY_TIMELINE_SETTINGS_LIMIT_ALERT' => 'A maximum of eight modules are available for this timeline. Please uncheck a module to add another one.',
];
