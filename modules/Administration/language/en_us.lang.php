...
3) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
    ...
    'LBL_HINT_SECTION_DESCRIPTION' => 'Configure settings for Hint',

    'LBL_HINT_CONFIG' => 'Hint Configuration',
    'LBL_HINT_CONFIG_NAME' => 'Hint Configuration',
    'LBL_HINT_CONFIG_SAVED' => 'Hint configuration settings have been saved.',
    ...
    'LBL_HINT_UNINSTALL_DESCRIPTION' => 'Uninstall Hint, including disabling notifications from Hint Insights.',
