...
3) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
    ...
    'LBL_CSP_SETTING_HELP_TEXT_CONTENT' => 'This setting represents the \'default-src\' Content Security Policy (CSP) directive used by web browsers to control which resources are allowed to load on a web page. For more information on acceptable field values and formats, refer to the <a href={{linkToDocumentation}} target="_blank">System</a> documentation. Once the CSP settings are updated, users will need to refresh their browser for the changes to take effect.',
