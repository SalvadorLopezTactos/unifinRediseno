...
<form name="RepairDatabaseForm" method="post" action="?module=Administration">
    ...
    <textarea name="sql" rows="24" cols="150" id="repairsql" disabled>{$qry_str|escape:'html':'UTF-8'}</textarea>
    <br/>
    <input type="submit" class="button" value="{$MOD.LBL_REPAIR_DATABASE_EXECUTE}"/>
</form>
