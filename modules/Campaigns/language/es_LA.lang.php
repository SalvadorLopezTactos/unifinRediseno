...
$mod_strings = [
    ...
    'LBL_INBOUND_EMAIL_SETTINGS' => 'Configuración del Correo Entrante',
    'LBL_SYSTEM_EMAIL_SETTINGS' => 'Configuración de Correo Electrónico del Sistema',
    //newsletter wizard
    ...
    'LBL_LEAD_REDIRECT_REQUEST_TYPE' => 'Redirigir Tipo de Solicitud',
    'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => 'Determina de qué manera se realizará la redirección.<br><br>GET: Redirige usando una solicitud GET, donde cualquier parámetro se enviará a través de la URL de Redirección<br><br>POST: Redirige mediante una solicitud POST, donde cualquier parámetro se enviará a través del cuerpo de la solicitud',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => 'Incluir Resultados del Formulario en Redirección',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE_HELP' => 'Determina si los valores del formulario resultantes se enviarán como parámetros junto con la solicitud a la URL de Redirección',
