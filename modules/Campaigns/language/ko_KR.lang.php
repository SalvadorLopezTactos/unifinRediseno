...
$mod_strings = [
    ...
    'LBL_LEAD_REDIRECT_REQUEST_TYPE' => '요청 유형 리디렉션',
    'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => '리디렉션 실행 방식을 정합니다.<br><br>GET: GET 요청을 사용한 리디렉션은 리디렉션 URL을 통해 여하한 패러미터가 전송됩니다<br><br>POST: POST 요청을 사용한 리디렉션은 리퀘스트 본문을 통해 여하한 패러미터가 전송됩니다',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => '리디렉션에 폼 결과 포함',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE_HELP' => '리디렉션 URL에 대한 요청과 함께 결과 폼 값이 패러미터로 전송될지 여부를 결정합니다',
