...
$mod_strings = [
    ...
    'LBL_LEAD_REDIRECT_REQUEST_TYPE' => 'Pārvirzīšanas pieprasījuma veids',
    'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => 'Nosaka, kā pārvirzīšana tiks veikta.<br><br>GET: pārvirza, izmantojot GET pieprasījumu, ar jebkādiem parametriem, kas tiek nosūtīti, izmantojot pārvirzīšanas URL<br><br>POST: pārvirza, izmantojot POST pieprasījumu, ar jebkādiem parametriem, kas tiek nosūtīti, izmantojot pieprasījuma tekstu',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => 'Iekļaut veidlapas rezultātus pārvirzīšanā',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE_HELP' => 'Nosaka, vai iegūtās veidlapas vērtības tiks nosūtītas kā parametri kopā ar pieprasījumu uz pārvirzīšanas URL',
