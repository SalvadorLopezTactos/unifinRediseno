...
$mod_strings = [
    ...
    'LBL_INBOUND_EMAIL_SETTINGS' => 'Definições de E-mail de Entrada',
    'LBL_SYSTEM_EMAIL_SETTINGS' => 'Definições de E-mail do Sistema',
    //newsletter wizard
    ...
    'LBL_LEAD_REDIRECT_REQUEST_TYPE' => 'Tipo de pedido de redireccionamento',
    'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => 'Determina a forma como o redireccionamento será executado.<br><br>GET: redirecciona usando um pedido GET, com todos os parâmetros enviados através do URL de Redireccionamento<br><br>POST: redirecciona usando um pedido POST, com todos os parâmetros enviados através do corpo do pedido',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => 'Incluir resultados do formulário no Redireccionamento',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE_HELP' => 'Determina se os valores do formulário resultantes serão enviados como parâmetros juntamente com o pedido para o URL de Redireccionamento',
