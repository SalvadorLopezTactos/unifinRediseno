...
$mod_strings = [
    ...
    'LBL_SYSTEM_EMAIL_SETTINGS' => 'Järjestelmän sähköpostiasetukset',
    //newsletter wizard
    ...
    'LBL_LEAD_REDIRECT_REQUEST_TYPE' => 'Pyyntötyypin uudelleenohjaus',
    'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => 'Määrittää uudelleenohjauksen tavan.<br><br>GET: Ohjaa uudelleen GET-pyynnöllä. Parametrit lähetetään uudelleenohjauksen URL-osoitteen kautta<br>.<br>POST: Ohjaa uudelleen POST-pyynnöllä. Parametrit lähetetään pyynnön kuvauksen kautta.',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => 'Sisällytä lomakkeet tulokset uudelleenohjaukseen',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE_HELP' => 'Määrittää, lähetetäänkö tuloksena olevat lomakkeen arvot parametreina pyynnön mukana uudelleenohjauksen URL-osoitteeseen.',
