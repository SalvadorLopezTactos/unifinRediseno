...
$mod_strings = [
    ...
    'LBL_LEAD_REDIRECT_REQUEST_TYPE' => 'Препращане на тип заявка',
    'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => 'Определя как ще бъде извършено препращането.<br><br>GET: Препраща с помощта на заявка GET, като всички параметри се изпращат чрез URL адреса за препращан е<br><br>POST: Препраща с помощта на заявка POST, като всички параметри се изпращат чрез съдържанието на заявката',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => 'Включи Формиране на резултати в Препращане',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE_HELP' => 'Определя дали получените като резултати формирани стойности ще бъдат изпратени като параметри заедно със заявката към URL адреса за препращане',
