...
$mod_strings = [
    ...
    'LBL_INBOUND_EMAIL_SETTINGS' => 'Įeinančio el. pašto parametrai',
    'LBL_SYSTEM_EMAIL_SETTINGS' => 'Sistemos el. pašto nustatymai',
    //newsletter wizard
    ...
    'LBL_LEAD_REDIRECT_REQUEST_TYPE' => 'Peradresavimo užklausos tipas',
    'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => 'Nurodo, kaip bus atliktas peradresavimas.<br><br>GET: peradresuoja naudojant GET užklausą, o bet kokie parametrai siunčiami per peradresavimo URL.<br><br>POST: peradresuoja naudojant POST užklausą, siunčiant bet kokius parametrus per užklausos instituciją',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => 'Įtraukite formos rezultatus į peradresavimą',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE_HELP' => 'Nustato, ar gautos formos reikšmės bus siunčiamos kaip parametrai kartu su užklausa peradresavimo URL',
