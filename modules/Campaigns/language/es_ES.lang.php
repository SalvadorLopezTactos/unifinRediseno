...
$mod_strings = [
    ...
    'LBL_LEAD_REDIRECT_REQUEST_TYPE' => 'Tipo de solicitud de redirección',
    'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => 'Determina cómo se realizará la redirección.<br><br>RECIBIR: Redirige con una solicitud RECIBIR, con el envío de cualquier parámetro a través de la URL de redirección<br><br>PUBLICAR: Redirige con una solicitud PUBLICAR, con el envío de cualquier parámetro a través del cuerpo de solicitud',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => 'Incluye los resultados del formulario en la redirección',
