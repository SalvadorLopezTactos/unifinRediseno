...
$mod_strings = [
    ...
    'LBL_LEAD_REDIRECT_REQUEST_TYPE' => 'İstek Türünü Yönlendir',
    'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => 'Yönlendirmenin nasıl gerçekleştirileceğini belirler.<br><br>AL: Herhangi bir parametrenin Yönlendirme URL&#39;si aracılığıyla gönderilecek şekilde bir AL isteği kullanarak yönlendirir<br><br>YAYINLA: Herhangi bir parametrenin istek gövdesi aracılığıyla gönderilecek şekilde bir YAYINLA isteği kullanarak yönlendiriri',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => 'Yönlendirmeye Form Sonuçlarını Dahil Et',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE_HELP' => 'Ortaya çıkan form değerlerinin, Yönlendirme URL&#39;sine yapılan istekle birlikte parametre olarak gönderilip gönderilmeyeceğini belirler',
