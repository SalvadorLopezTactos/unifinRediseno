...
$mod_strings = [
    ...
    'LBL_INBOUND_EMAIL_SETTINGS' => 'インバウンドEメール設定',
    'LBL_SYSTEM_EMAIL_SETTINGS' => 'システムEメール設定',
    //newsletter wizard
    ...
    'LBL_LEAD_REDIRECT_REQUEST_TYPE' => 'リダイレクトリクエストタイプ',
    'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => 'リダイレクトの実行方法を決定します。<br><br>GET：GET リクエストを使用してリダイレクトし、パラメータはリダイレクト URL により送信されます。<br><br>POST：POST リクエストを使用してリダイレクトし、パラメータはリクエスト本体により送信されます。',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => 'フォームの結果をリダイレクトに含める',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE_HELP' => '結果として得られたフォームの値を、リクエストとともにパラメータとしてリダイレクト URL へ送信するかどうかを決定します',
