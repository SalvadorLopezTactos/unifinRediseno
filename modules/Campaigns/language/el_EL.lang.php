...
$mod_strings = [
    ...
    'LBL_LEAD_REDIRECT_REQUEST_TYPE' => 'Τύπος Αιτήματος Ανακατεύθυνσης',
    'LBL_LEAD_REDIRECT_REQUEST_TYPE_HELP' => 'Καθορίζει τον τρόπο με τον οποίο θα εκτελεστεί η ανακατεύθυνση.<br><br>GET: Ανακατευθύνει χρησιμοποιώντας αίτημα GET, με τυχόν παραμέτρους που αποστέλλονται μέσω της διεύθυνσης URL ανακατεύθυνσης<br><br>POST: Ανακατευθύνει χρησιμοποιώντας αίτημα POST, με οποιεσδήποτε παραμέτρους αποστέλλονται μέσω του κυρίως μέρους του αιτήματος',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE' => 'Συμπεριλάβετε τα αποτελέσματα της Φόρμας στην Ανακατεύθυνση',
    'LBL_LEAD_REDIRECT_REQUEST_PARAMS_INCLUDE_HELP' => 'Καθορίζει εάν οι τιμές της φόρμας που προκύπτουν θα σταλούν ως παράμετροι μαζί με το αίτημα στη διεύθυνση URL ανακατεύθυνσης',
