...
$mod_strings = array (
    // Dashboard Names
    'LBL_MEETINGS_LIST_DASHBOARD' => '会議リストのダッシュボード',
    'LBL_MEETINGS_RECORD_DASHBOARD' => '会議レコードのダッシュボード',
  ...
  'LBL_ACCOUNT_NAME' => '取引先',
    ...
    'LBL_ERROR_LAUNCH_MEETING_GENERAL' => 'この会議を開始するのにエラーがありました。管理者にお問い合わせください。',
    'LBL_EXTERNAL_MEETING_NO_URL' => 'ミーティングが作成されたときは、{{meetingType}} を起動するリンクが適切に生成されませんでした。システム管理者にお問い合わください。',
  ...
  //For export labels
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => '{{plural_module_name}}モジュールは、「スケジュール」、「開催」、または「キャンセル」の状態であってもよい記録を満たすもので構成されています。次の24時間以内にスケジュールされている今後会議の開始日が青でハイライト表示されます。延滞会議は開始日が赤で強調表示されます。この{{plural_module_name}}リストビューからインライン編集会議情報を表示することができます。追加のアクションは、各会議の行の最後にあるメニューでご利用いただけます。開催されているようにそれをマークするために、「閉じる」をすべてのスケジュールされた会議の行のメニューから選択することができます。Sugarのユーザ、連絡先、およびリードが会議招待として追加するのも可能です。 {{plural_module_name}} {{plural_module_name}}モジュール、カレンダーモジュール、インポートだけでなく、関連モジュールのレコード上の（サイドカーモジュール用）計画された活動ダッシュレット（レガシーモジュール用）のアクティビティサブパネル経由（例えばコンタクトから作成することができ、自動的に両方のレコードとの関係を作成するアカウントなど）でも可能です。',

    // Record View Help Text
    'LBL_HELP_RECORD' => '{{plural_module_name}}モジュールは、組織内のユーザによって記録された{{meetings_singular_module}}レコードで構成されます。 {{plural_module_name}}は「スケジュール」、「開催」、または「キャンセル」の状態であってもよいです。Sugarユーザならびに{contacts_module}}と{{leads_module}}が招待として追加してもよいです。 - 個々のフィールドまたは[編集]ボタンをクリックして、このレコードのフィールドを編集。 - 表示または左下のペインに「データビュー」を切り替えることで、サブパネル内の他のレコードへのリンクを変更します。 - 作成し、左下のペインに「アクティビティストリーム」を切り替えて、アクティビティストリームのビューのユーザのコメントやレコードの変更履歴を表示します。 - レコード名の右にあるアイコンを使用してこのレコードをフォローもしくはお気に入りにします。 - 追加のアクションは[編集]ボタンの右にあるドロップダウンの操作]メニューで利用できます。',

    // Create View Help Text
    'LBL_HELP_CREATE' => '{{plural_module_name}} モジュールは、組織内のユーザによって記録された{{meetings_module}} レコードで構成されます。 {{plural_module_name}} は「スケジュール」、「開催」、または「キャンセル」状態の可能性があります。Sugarユーザだけでなく、{{contacts_module}} と{{leads_module}} を参加者として追加できます。
