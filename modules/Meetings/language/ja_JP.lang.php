...
$mod_strings = [
    ...
    'LBL_LEAD_GUESTS' => 'リードゲスト',
    'LBL_CONTACT_GUESTS' => '連絡先ゲスト',
    'LBL_MEETINGS_FOCUS_DRAWER_DASHBOARD' => 'ミーティング フォーカス ドロワ',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'ミーティングのタイムライン',
    ...
    'LBL_AVAILABLE_MEETINGS' => '利用可能なミーティング',
    ...
    'LBL_RSET' => 'RSet',
    'LBL_EVENT_TYPE' => 'イベントタイプ',
    'LBL_ICAL_UID' => 'iCal UID',
    'LBL_ORIGINAL_DATE' => '定期的なイベントの元の開始日',
