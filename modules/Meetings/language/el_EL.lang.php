...
$mod_strings = [
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Χρονολόγιο συσκέψεων',
    ...
    'LBL_AVAILABLE_MEETINGS' => 'Διαθέσιμες συσκέψεις',
    ...
    'LBL_RECURRING_LIMIT_ERROR' => 'Δεν είναι δυνατός ο προγραμματισμός αυτής της επαναλαμβανόμενης Συνάντησης, καθώς υπερβαίνει τη μέγιστη επιτρεπόμενη επανάληψη $limit.',
    ...
    'LBL_RSET' => 'RSet',
    'LBL_EVENT_TYPE' => 'Τύπος συμβάντος',
    'LBL_ICAL_UID' => 'iCal UID',
    'LBL_ORIGINAL_DATE' => 'Αρχική ημέρα έναρξης επαναλαμβανόμενου συμβάντος',
...
3. Κάντε κλικ στην επιλογή "Αποθήκευση" για να οριστικοποιήσετε τη νέα εγγραφή και να επιστρέψετε στην προηγούμενη σελίδα.',
    ...
    // Sugar Automate
    'LBL_IS_CUSTOMER_JOURNEY_ACTIVITY' => 'Είναι συνάντηση Smart Guide',
    'LBL_PARENT_MEETING_OF_TASK_REL' => 'Θυγατρικές εργασίες',
    'LBL_PARENT_MEETING_OF_CALL_REL' => 'Θυγατρικές κλήσεις',
    'LBL_PARENT_MEETING_OF_MEETING_REL' => 'Θυγατρικές συναντήσεις',
];
