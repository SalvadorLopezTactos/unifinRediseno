...
$mod_strings = [
    ...
    'LBL_LEAD_GUESTS' => 'Предварительные контакты-гости',
    'LBL_CONTACT_GUESTS' => 'Контакты-гости',
    'LBL_MEETINGS_FOCUS_DRAWER_DASHBOARD' => 'Фокусная панель для встреч',
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Временная шкала встречи',
    ...
    'LBL_AVAILABLE_MEETINGS' => 'Доступные встречи',
...
3. Нажмите "Сохранить", чтобы завершить создание новой записи и вернуться на предыдущую страницу.',
    ...
    // Sugar Automate
    'LBL_IS_CUSTOMER_JOURNEY_ACTIVITY' => 'Является собранием Умного руководства',
    'LBL_PARENT_MEETING_OF_TASK_REL' => 'Дочерние задачи',
    'LBL_PARENT_MEETING_OF_CALL_REL' => 'Дочерние звонки',
    'LBL_PARENT_MEETING_OF_MEETING_REL' => 'Дочерние встречи',
];
