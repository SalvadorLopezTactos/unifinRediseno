...
$mod_strings = [
    ...
    'LBL_TPL_QUOTE_SERVICES_NAME' => '見積もり（サービスに関する）',
    'LBL_TPL_QUOTE_SERVICES_DESCRIPTION' => 'このテンプレートは、サービスインフォメーションを含めた見積もりをPDFで印刷するために使用します。',
    'LBL_TPL_QUOTE_SERVICES_TEMPLATE_NAME' => 'サービス見積もり',
