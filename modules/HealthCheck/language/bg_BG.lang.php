...
$mod_strings = [
    ...
    'LBL_SCAN_304_LOG' => 'Неизвестни файлове: %s%s - %s не е МВ модул',
    'LBL_SCAN_305_LOG' => 'Некоректни дефиниции на променливи - ключ %s, име %s в модул %s',
    'LBL_SCAN_306_LOG' => 'Некоректни дефиниции на променливи - свързано поле %s в модул %s има празен „модул"',
    'LBL_SCAN_307_LOG' => 'Некоректни дефиниции на променливи - връзка %s в модул %s се позовава на невалидна взаимовръзка',
    ...
    'LBL_SCAN_314_LOG' => "Некоректни дефиниции на променливи - мултиенум поле '%s' със списък с опции '%s' ключовете съдържат несъвместими знаци - '{%s}' в модул %s",
    ...
    'LBL_SCAN_520_LOG' => 'Допълнителна логика (logic hook) after_ui_frame е открита %s',
    'LBL_SCAN_521_LOG' => 'Допълнителна логика (logic hook) after_ui_footer е открита %s',
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_518_LOG' => 'Открит е customCode %s в %s, файл %s',
    ...
    'LBL_SCAN_413_LOG' => 'Открит е неизвестен клас уиджет: %s за %s, модул %s във файл %s',
    ...
    'LBL_SCAN_418_LOG' => 'Открит е подпанел с връзка към несъществуващ модул: %s в %s файл',
    'LBL_SCAN_419_LOG' => 'Некоректни дефиниции на променливи - ключ %s, име %s в модул %s',
    'LBL_SCAN_420_LOG' => 'Некоректни дефиниции на променливи - свързано поле %s в модул %s има празен „модул"',
    'LBL_SCAN_421_LOG' => 'Некоректни дефиниции на променливи - връзка %s в модул %s се позовава на невалидна взаимовръзка',
    ...
    'LBL_SCAN_423_LOG' => 'Некоректни подполета на дефиниции на променливи - %s се позовава на некоректно подполе %s. Намерено в модул %s',
    ...
    'LBL_SCAN_526_LOG' => "Некоректни дефиниции на променливи - мултиенум поле '%s' с ключове на списък с опции '%s' съдържа несъвместими знаци - '{%s}' в модул %s",
    ...
    'LBL_SCAN_563_LOG' => 'Използване на несъвместимо персонализиране на монолог: %s',
    'LBL_SCAN_564_LOG' => 'Използване на остаряла DBAL функционалност: %s',
    'LBL_SCAN_565_LOG' => 'Използване на остаряла характеристика за конфигуриране $sugar_config[&#39;passwordHash&#39;]. След въвеждане на версия 13.3 тя вече няма да се поддържа: %s',
    'LBL_SCAN_566_LOG' => 'Използване на неподдържана характеристика за конфигуриране $sugar_config[&#39;passwordHash&#39;]: %s',
    'LBL_SCAN_567_LOG' => 'Използване на премахнат компонент на Zend Framework: %s',
    'LBL_SCAN_568_LOG' => 'Използване на отхвърлен компонент на Zend Framework: %s',
    ...
    'LBL_SCAN_587_LOG' => 'Подмножество от променливи LESS ще бъде отхвърлено от 13.1 и няма да се поддържа в 14.0. Използване на отхвърлени променливи LESS, открити в: %s',
    ...
    'LBL_SCAN_507_LOG' => 'Некоректни подполета на дефиниции на променливи - %s се позовава на некоректно подполе %s. Намерено в модул %s',
    ...
    'LBL_SCAN_304_TITLE' => 'Неизвестни файлове: %s%s - %s не е МВ модул',
    'LBL_SCAN_305_TITLE' => 'Некоректни дефиниции на променливи - ключ %s, име %s в модул %s',
    'LBL_SCAN_306_TITLE' => 'Некоректни дефиниции на променливи - свързано поле %s в модул %s`има празен „модул"',
    'LBL_SCAN_307_TITLE' => 'Некоректни дефиниции на променливи - връзка %s в модул %s се позовава на невалидна взаимовръзка',
    ...
    'LBL_SCAN_520_TITLE' => 'Допълнителна логика (logic hook) after_ui_frame е открита %s',
    'LBL_SCAN_521_TITLE' => 'Допълнителна логика (logic hook) after_ui_footer е открита в %s',
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_518_TITLE' => 'Открит е customCode %s в %s, файл %s',
    ...
    'LBL_SCAN_413_TITLE' => 'Открит е неизвестен клас уиджет: %s за %s, модул %s във файл %s',
    ...
    'LBL_SCAN_418_TITLE' => 'Открит е подпанел с връзка към несъществуващ модул: %s в %s файл',
    'LBL_SCAN_419_TITLE' => 'Некоректни дефиниции на променливи - ключ %s, име %s в модул %s',
    'LBL_SCAN_420_TITLE' => 'Некоректни дефиниции на променливи - свързано поле %s в модул %s има празен „модул"',
    'LBL_SCAN_421_TITLE' => 'Некоректни дефиниции на променливи - връзка %s в модул %s се позовава на невалидна взаимовръзка',
    ...
    'LBL_SCAN_423_TITLE' => 'Некоректни подполета на дефиниции на променливи - %s се позовава на некоректно подполе %s. Намерено в модул %s',
    ...
    'LBL_SCAN_507_TITLE' => 'Некоректни подполета на дефиниции на променливи - %s се позовава на некоректно подполе %s в модул %s',
    ...
    'LBL_SCAN_526_TITLE' => "Некоректни дефиниции на променливи - мултиенум поле '%s' с ключове на списък с опции '%s' съдържа несъвместими знаци - '{%s}' в модул %s",
    ...
    'LBL_SCAN_567_TITLE' => 'Използване на премахнат компонент на Zend Framework',
    'LBL_SCAN_568_TITLE' => 'Използване на отхвърлен компонент на Zend Framework',
    ...
    'LBL_SCAN_587_TITLE' => 'Открити са отхвърлени LESS color променливи.',
    ...
    'LBL_SCAN_304_DESCR' => 'Открити са неизвестни файлове (%s%s), които не са мигрирани в Sugar7. Модулът (%s) ще продължи да бъде достъпен, но ще бъде изпълняван в режим на съвместимост в Sugar7. ',
    'LBL_SCAN_305_DESCR' => 'Открити са некоректни дефиниции на променливи (%s: %s) в модул %s и не са мигрирани в Sugar7. Персонализацията ще продължи да бъде достъпна, но ще бъде изпълнявана в режим на съвместимост в Sugar7. ',
    'LBL_SCAN_306_DESCR' => 'Открити бяха некоректни дефиниции на променливи, които не са мигрирани в Sugar7. Свързано поле (%s) в модул %s има празен „модул". Персонализацията ще продължи да бъде достъпна, но ще бъде изпълнява в режим на съвместимост в Sugar7. ',
    'LBL_SCAN_307_DESCR' => 'Открити бяха некоректни дефиниции на променливи и не бяха мигрирани в Sugar7. Връзката (%s) в модул %s се позовава по невалидна взаимовръзка. Персонализацията ще продължи да бъде достъпна, но ще бъде изпълнява в режим на съвместимост в Sugar7. ',
    ...
    'LBL_SCAN_310_DESCR' => 'Открити са неизвестни файлове (%s) за разглеждане, които не са мигрирани в Sugar7. Модулът (%s) ще продължи да бъде достъпен, но ще бъде изпълняван в режим на съвместимост в Sugar7.',
...
//    'LBL_SCAN_405_DESCR' => 'Package detected which has been blacklisted as not supported in Sugar 7',
    ...
    'LBL_SCAN_517_DESCR' => 'Открит е пакет, който е в черния списък, тъй като не се поддържа в Sugar 7',
