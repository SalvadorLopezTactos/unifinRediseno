...
$mod_strings = [
    ...
    'LBL_SCAN_304_LOG' => 'Ficheiros desconhecidos: %s%s - %s não é módulo MB',
    'LBL_SCAN_305_LOG' => 'Vardefs incorrectas — chave %s, nome %s no módulo %s',
    'LBL_SCAN_306_LOG' => 'Vardefs incorrectas — o campo relacionado %s no módulo %s tem "módulo" vazio',
    'LBL_SCAN_307_LOG' => 'Vardefs incorrectas - link %s no módulo %s refere-se a relacionamento inválido',
...
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_413_LOG' => 'Classe de widget desconhecida detectada: %s para %s, módulo %s no ficheiro %s',
    ...
    'LBL_SCAN_419_LOG' => 'Vardefs incorrectas — chave %s, nome %s no módulo %s',
    'LBL_SCAN_420_LOG' => 'Vardefs incorrectas — o campo relacionado %s no módulo %s tem "módulo" vazio',
    'LBL_SCAN_421_LOG' => 'Vardefs incorrectas - link %s no módulo %s refere-se a relacionamento inválido',
    ...
    'LBL_SCAN_423_LOG' => 'Subcampos de vardefs incorrectos — %s refere-se a subcampo incorrecto %s. Localizado no módulo %s',
    ...
    'LBL_SCAN_563_LOG' => 'Utilização de personalização de Monólogo incompatível: %s',
    'LBL_SCAN_564_LOG' => 'Utilização de funcionalidade DBAL desatualizada: %s',
    'LBL_SCAN_565_LOG' => 'Utilização da propriedade de configuração obsoleta $sugar_config[&#39;passwordHash&#39;]. A partir da versão 13.3, deixará de ser suportada: %s',
    'LBL_SCAN_566_LOG' => 'Utilização de propriedade de configuração não suportada $sugar_config[&#39;passwordHash&#39;]: %s',
    'LBL_SCAN_567_LOG' => 'Utilização do componente Zend Framework removido: %s',
    'LBL_SCAN_568_LOG' => 'Utilização do componente Zend Framework preterido: %s',
    ...
    'LBL_SCAN_587_LOG' => 'Um subconjunto de variáveis LESS será descontinuado a partir da versão 13.1 e não terá suporte na versão 14.0. Uso de variáveis LESS descontinuadas detectado em: %s',
    ...
    'LBL_SCAN_507_LOG' => 'Subcampos de vardefs incorrectos — %s refere-se a subcampo incorrecto %s. Localizado no módulo %s',
    ...
    'LBL_SCAN_304_TITLE' => 'Ficheiros desconhecidos: %s%s - %s não é módulo MB',
    'LBL_SCAN_305_TITLE' => 'Vardefs incorrectas — chave %s, nome %s no módulo %s',
    'LBL_SCAN_306_TITLE' => 'Vardefs incorrectas — o campo relacionado %s no módulo %s tem "módulo" vazio',
    'LBL_SCAN_307_TITLE' => 'Vardefs incorrectas - link %s no módulo %s refere-se a relacionamento inválido',
...
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_413_TITLE' => 'Classe de widget desconhecida detectada: %s para %s, módulo %s no ficheiro %s',
    ...
    'LBL_SCAN_419_TITLE' => 'Vardefs incorrectas — chave %s, nome %s no módulo %s',
    'LBL_SCAN_420_TITLE' => 'Vardefs incorrectas — o campo relacionado %s no módulo %s tem "módulo" vazio',
    'LBL_SCAN_421_TITLE' => 'Vardefs incorrectas - link %s no módulo %s refere-se a relacionamento inválido',
    'LBL_SCAN_422_TITLE' => 'O módulo %s tem a definição de outro módulo',
    'LBL_SCAN_525_TITLE' => 'Função HTML de um vardef em %s',
    'LBL_SCAN_423_TITLE' => 'Subcampos de vardefs incorrectos — %s refere-se a subcampo incorrecto %s. Localizado no módulo %s',
    ...
    'LBL_SCAN_507_TITLE' => 'Subcampos de vardefs incorrectos — %s refere-se a subcampo incorrecto %s no módulo %s',
    ...
    'LBL_SCAN_567_TITLE' => 'Utilização do componente Zend Framework removido',
    'LBL_SCAN_568_TITLE' => 'Utilização do componente Zend Framework preterido',
    ...
    'LBL_SCAN_587_TITLE' => 'Detectadas variáveis de cor LESS descontinuadas.',
    ...
    'LBL_SCAN_304_DESCR' => 'Ficheiros desconhecidos (%s%s) foram detectados e não foram migrados para o Sugar7. Este módulo (%s) irá continuar disponível mas será executado em Modo de Compatibilidade Retroactiva no Sugar7. ',
    'LBL_SCAN_305_DESCR' => 'Vardefs incorrectas (%s: %s) foram detectadas no módulo %s e não foram migradas para o Sugar7. Esta personalização irá continuar disponível mas será executada em Modo de Compatibilidade Retroactiva no Sugar7. ',
    'LBL_SCAN_306_DESCR' => 'Foram detectadas vardefs incorrectas e não foram migradas para o Sugar7. O campo relacionado (%s) no módulo %s tem um "módulo" vazio. Esta configuração irá continuar disponível mas irá ser executada em Modo de Compatibilidade Retroactiva no Sugar7. ',
    'LBL_SCAN_307_DESCR' => 'Foram detectadas vardefs incorrectas e não foram migradas para o Sugar7. O link (%s) no módulo %s refere-se a um relacionamento inválido. Esta configuração irá continuar disponível mas irá ser executada em Modo de Compatibilidade Retroactiva no Sugar7. ',
...
//    'LBL_SCAN_405_DESCR' => 'Package detected which has been blacklisted as not supported in Sugar 7',
    ...
    'LBL_SCAN_517_DESCR' => 'Detectado um pacote que foi colocado em lista de recusa como não suportado em Sugar7',
    ...
    'LBL_SCAN_540_DESCR' => 'O pacote detectado encontra-se catalogado na lista de recusa como não sendo suportado pela versão Sugar alvo. Estes pacotes necessitam ser desinstalados E apagados antes da actualização. Tenha em atenção que a desinstalação destes pacotes irá remover tabelas e dados gerados pelo pacote e pela utilização dos módulos do pacote.',
