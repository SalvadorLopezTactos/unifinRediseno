...
$mod_strings = [
    ...
    'LBL_SCAN_304_LOG' => 'File sconosciuti: %s%s - %s non è un modulo MB',
    'LBL_SCAN_305_LOG' => 'Vardef errati - chiave %s, nome %s nel modulo %s',
    'LBL_SCAN_306_LOG' => 'Vardef errati - il campo correlato %s nel modulo %s ha un `modulo` vuoto',
    'LBL_SCAN_307_LOG' => 'Vardef errati - il collegamento %s nel modulo %s si riferisce a una relazione non valida',
    ...
    'LBL_SCAN_520_LOG' => 'Hook logico after_ui_frame rilevato in %s',
    'LBL_SCAN_521_LOG' => 'Hook logico after_ui_footer rilevato in %s',
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_518_LOG' => 'Trovato customCode %s in %s, file %s',
    ...
    'LBL_SCAN_413_LOG' => 'Rilevata widget class sconosciuta: %s per %s, modulo %s nel file %s',
    ...
    'LBL_SCAN_418_LOG' => 'Trovato sottopannello con collegamento a un modulo inesistente: %s nel file %s',
    'LBL_SCAN_419_LOG' => 'Vardef errati - chiave %s, nome %s nel modulo %s',
    'LBL_SCAN_420_LOG' => 'Vardef errati - il campo correlato %s nel modulo %s ha un `modulo` vuoto',
    'LBL_SCAN_421_LOG' => 'Vardef errati - il collegamento %s nel modulo %s si riferisce a una relazione non valida',
    'LBL_SCAN_422_LOG' => 'Il modulo %s ha la definizione di un altro modulo %s nel file %s',
    'LBL_SCAN_525_LOG' => 'Funzione HTML Vardef in %s',
    'LBL_SCAN_423_LOG' => 'Sottocampi vardef errati - %s si riferisce al sottocampo %s errato. Si trovano nel modulo %s',
    ...
    'LBL_SCAN_567_LOG' => 'Utilizzo del componente Zend Framework rimosso: %s',
    'LBL_SCAN_568_LOG' => 'Utilizzo del componente Zend Framework deprecato: %s',
    ...
    'LBL_SCAN_587_LOG' => 'Un sottoinsieme di variabili LESS sarà obsoleto a partire dalla versione 13.1 e non sarà supportato nella versione 14.0. Utilizzo di variabili LESS obsolete rilevato in: %s',
    ...
    'LBL_SCAN_507_LOG' => 'Sottocampi vardef errati - %s si riferisce al sottocampo %s errato. Si trovano nel modulo %s',
    ...
    'LBL_SCAN_304_TITLE' => 'File sconosciuti: %s%s - %s non è un modulo MB',
    'LBL_SCAN_305_TITLE' => 'Vardef errati - chiave %s, nome %s nel modulo %s',
    'LBL_SCAN_306_TITLE' => 'Vardef errati - il campo correlato %s nel modulo %s ha un `modulo` vuoto',
    'LBL_SCAN_307_TITLE' => 'Vardef errati - il collegamento %s nel modulo %s si riferisce a una relazione non valida',
    ...
    'LBL_SCAN_520_TITLE' => 'Hook logico after_ui_frame rilevato in %s',
    'LBL_SCAN_521_TITLE' => 'Hook logico after_ui_footer rilevato in %s',
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_518_TITLE' => 'Trovato customCode %s in %s, file %s',
    ...
    'LBL_SCAN_413_TITLE' => 'Rilevata widget class sconosciuta: %s per %s, modulo %s nel file %s',
    ...
    'LBL_SCAN_418_TITLE' => 'Trovato sottopannello con collegamento a un modulo inesistente: %s nel file %s',
    'LBL_SCAN_419_TITLE' => 'Vardef errati - chiave %s, nome %s nel modulo %s',
    'LBL_SCAN_420_TITLE' => 'Vardef errati - il campo correlato %s nel modulo %s ha un `modulo` vuoto',
    'LBL_SCAN_421_TITLE' => 'Vardef errati - il collegamento %s nel modulo %s si riferisce a una relazione non valida',
    'LBL_SCAN_422_TITLE' => 'Il modulo %s ha la definzione di un altro modulo',
    'LBL_SCAN_525_TITLE' => 'Funzione HTML Vardef in %s',
    'LBL_SCAN_423_TITLE' => 'Sottocampi vardef errati - %s si riferisce al sottocampo %s errato. Si trovano nel modulo %s',
    ...
    'LBL_SCAN_507_TITLE' => 'Sottocampi vardef errati - %s si riferisce al sottocampo %s errato nel modulo %s',
    ...
    'LBL_SCAN_567_TITLE' => 'Utilizzo del componente Zend Framework rimosso',
    'LBL_SCAN_568_TITLE' => 'Utilizzo del componente Zend Framework deprecato',
    ...
    'LBL_SCAN_587_TITLE' => 'Rilevate variabili di colore LESS obsolete.',
    ...
    'LBL_SCAN_304_DESCR' => 'Sono stati rilevati dei file sconosciuti (%s%s) e non sono stati migrati in Sugar 7. Questo modulo (%s) continuerà a essere disponibile ma verrà eseguito in Sugar 7 nella modalità compatibile con la versione precedente. ',
    'LBL_SCAN_305_DESCR' => 'Sono stati rilevati dei vardef errati (%s: %s) nel modulo %s e non sono stati migrati in Sugar 7. Questa personalizzazione continuerà a essere disponibile ma verrà eseguita in Sugar 7 nella modalità compatibile con la versione precedente. ',
    'LBL_SCAN_306_DESCR' => 'Sono stati rilevati dei vardef errati e non sono stati migrati in Sugar7. Il campo correlato (%s) nel modulo %s ha un `modulo` vuoto. Questa personalizzazione continuerà a essere disponibile ma verrà eseguita in Sugar 7 nella modalità compatibile con la versione precedente. ',
    'LBL_SCAN_307_DESCR' => 'Sono stati rilevati dei vardef errati e non sono stati migrati in Sugar7. Il collegamento (%s) nel modulo %s si riferisce a una relazione non valida. Questa personalizzazione continuerà a essere disponibile ma verrà eseguita in Sugar 7 nella modalità compatibile con la versione precedente. ',
    ...
    'LBL_SCAN_310_DESCR' => 'Sono stati rilevati file di visualizzazione sconosciuti (%s) e non sono stati migrati in Sugar 7. Questo modulo (%s) continuerà a essere disponibile ma verrà eseguito in Sugar 7 nella modalità compatibile con la versione precedente.',
