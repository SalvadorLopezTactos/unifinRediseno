...
$mod_strings = [
    ...
    'LBL_SCAN_102_LOG' => '%s에는 확장자가 있습니다: %s',
    ...
    'LBL_SCAN_302_LOG' => '알 수 없는 파일 보기가 있음 - %s은(는) MB 모듈이 아닙니다.',
    'LBL_SCAN_303_LOG' => '빈 양식이 아닌 파일 %s - %s는 MB 모듈이 아닙니다',
    'LBL_SCAN_304_LOG' => '알 수 없는 파일: %s%s - %s는 MB 모듈이 아닙니다.',
    'LBL_SCAN_305_LOG' => '잘못된 vardefs - 키 %s, 이름 %s(모듈 %s)',
    'LBL_SCAN_306_LOG' => '잘못된 vardefs - 관련 필드 %s(%s 모듈)에 빈 `모듈`이 있습니다.',
    'LBL_SCAN_307_LOG' => '잘못된 vardefs - %s 링크(%s 모듈)가 잘못된 관계를 참조합니다.',
    ...
    'LBL_SCAN_314_LOG' => "잘못된 vardefs - multienum 필드 '%s'(옵션 목록 '%s' 키)는 호환되지 않는 문자를 포함합니다 - '{%s}'(모듈 %s)",
    ...
    'LBL_SCAN_520_LOG' => '%s에서 after_ui_frame 로직 후크가 감지되었습니다.',
    'LBL_SCAN_521_LOG' => '%s에서 after_ui_footer 로직 후크가 감지되었습니다.',
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_518_LOG' => '사용자 지정 코드 %s을(를) %s 내부 파일 %s에서 찾음',
    ...
    'LBL_SCAN_413_LOG' => '알 수 없는 위젯 클래스가 감지되었습니다: %s(%s에 대해), 모듈 %s(%s 파일 내)',
    'LBL_SCAN_414_LOG' => 'CRYS-36에 의해 처리되는 알 수 없는 필드이며, 따라서 여기에서 더 이상 확인할 수 없습니다',
    'LBL_SCAN_415_LOG' => '%s의 잘못된 후크(Bad hook) 파일: %s',
    'LBL_SCAN_523_LOG' => '후크 파일 %s 함수 %s의 by-ref 매개 변수',
    'LBL_SCAN_417_LOG' => '호환되지 않는 모듈 %s',
    'LBL_SCAN_418_LOG' => '존재하지 않는 모듈: %s에 대한 링크가 있는 하위 패널을 %s 파일에서 찾음',
    'LBL_SCAN_419_LOG' => '잘못된 vardefs - 키 %s, 이름 %s(모듈 %s)',
    'LBL_SCAN_420_LOG' => '잘못된 vardefs - 관련 필드 %s(%s 모듈)에 빈 `모듈`이 있습니다.',
    'LBL_SCAN_421_LOG' => '잘못된 vardefs - %s 링크(%s 모듈)가 잘못된 관계를 참조합니다.',
    'LBL_SCAN_422_LOG' => '모듈 %s에 파일 %s에 있는 다른 모듈 %s의 정의가 있습니다.',
    'LBL_SCAN_525_LOG' => '%s에서의 Vardef HTML 함수',
    'LBL_SCAN_423_LOG' => '잘못된 vardefs 하위 필드 - %s이(가) 잘못된 하위 필드 %s을 (를) 참조합니다. 모듈 %s에 있습니다.',
    ...
    'LBL_SCAN_526_LOG' => "잘못된 vardefs - multienum 필드 '%s'(옵션 목록 '%s' 키)에 호환되지 않는 문자가 있습니다. '%s'(모듈 %s)",
    'LBL_SCAN_527_LOG' => 'bean %s에 있는 표 이름은 %s/vardefs.php에서 테이블 속성과 일치하지 않습니다',
    'LBL_SCAN_528_LOG' => '필드 %s(모듈 %s)에 올바르지 않은 display_default 값이 있습니다.',
    'LBL_SCAN_529_LOG' => '%s: %s(%s 파일, %s 라인)',
    ...
    'LBL_SCAN_563_LOG' => '호환되지 않는 Monolog 사용자 지정 사용: %s',
    'LBL_SCAN_564_LOG' => '오래된 DBAL 기능 사용: %s',
    'LBL_SCAN_565_LOG' => '구성 속성 $sugar_config[&#39;passwordHash&#39;]는 더 이상 사용되지 않을 예정입니다. 버전 13.3부터는 지원되지 않습니다. %s',
    'LBL_SCAN_566_LOG' => '지원되지 않는 구성 속성 $sugar_config[&#39;passwordHash&#39;] 사용: %s',
    'LBL_SCAN_567_LOG' => '제거된 Zend 프레임워크 구성 요소 사용: %s',
    'LBL_SCAN_568_LOG' => '더 이상 사용되지 않는 Zend 프레임워크 구성 요소 사용: %s',
    ...
    'LBL_SCAN_587_LOG' => 'LESS 변수의 하위 집합은 13.1부터 사용되지 않으며 14.0에서는 지원되지 않습니다. 더 이상 사용되지 않는 LESS 변수 사용이 감지됨: %s',
    ...
    'LBL_SCAN_505_LOG' => '%s 유형 변경(%s 필드): %s에서 %s(으)로',
    'LBL_SCAN_506_LOG' => '%s 의 $this 러한 사용',
    'LBL_SCAN_507_LOG' => '잘못된 vardefs 하위 필드 - %s이(가) 잘못된 하위 필드 %s을 (를) 참조합니다. 모듈 %s에 있습니다.',
    ...
    'LBL_SCAN_102_TITLE' => '%s에는 확장자가 있습니다: %s',
    ...
    'LBL_SCAN_302_TITLE' => '알 수 없는 파일 보기가 있음 - %s은(는) MB 모듈이 아닙니다.',
    'LBL_SCAN_303_TITLE' => '빈 양식이 아닌 파일 %s - %s는 MB 모듈이 아닙니다',
    'LBL_SCAN_304_TITLE' => '알 수 없는 파일: %s%s - %s는 MB 모듈이 아닙니다.',
    'LBL_SCAN_305_TITLE' => '잘못된 vardefs - 키 %s, 이름 %s(모듈 %s)',
    'LBL_SCAN_306_TITLE' => '잘못된 vardefs - 관련 필드 %s(%s 모듈)에 빈 `모듈`이 있습니다.',
    'LBL_SCAN_307_TITLE' => '잘못된 vardefs - %s 링크(%s 모듈)가 잘못된 관계를 참조합니다.',
    ...
    'LBL_SCAN_520_TITLE' => '%s에서 after_ui_frame 로직 후크가 감지되었습니다.',
    'LBL_SCAN_521_TITLE' => '%s에서 after_ui_footer 로직 후크가 감지되었습니다.',
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_518_TITLE' => '사용자 지정 코드 %s을(를) %s 내부 파일 %s에서 찾음',
    ...
    'LBL_SCAN_413_TITLE' => '알 수 없는 위젯 클래스가 감지되었습니다: %s(%s에 대해), 모듈 %s(%s 파일 내)',
    'LBL_SCAN_414_TITLE' => 'CRYS-36에 의해 처리되는 알 수 없는 필드이며, 따라서 여기에서 더 이상 확인할 수 없습니다',
    'LBL_SCAN_415_TITLE' => '%s의 잘못된 후크(Bad hook) 파일: %s',
    'LBL_SCAN_523_TITLE' => '후크 파일 %s 함수 %s의 by-ref 매개 변수',
    'LBL_SCAN_417_TITLE' => '호환되지 않는 모듈 %s',
    'LBL_SCAN_418_TITLE' => '존재하지 않는 모듈: %s에 대한 링크가 있는 하위 패널을 %s 파일에서 찾음',
    'LBL_SCAN_419_TITLE' => '잘못된 vardefs - 키 %s, 이름 %s(모듈 %s)',
    'LBL_SCAN_420_TITLE' => '잘못된 vardefs - 관련 필드 %s(%s 모듈)에 빈 `모듈`이 있습니다.',
    'LBL_SCAN_421_TITLE' => '잘못된 vardefs - %s 링크(%s 모듈)가 잘못된 관계를 참조합니다.',
    'LBL_SCAN_422_TITLE' => '%s 모듈에는 다른 모듈의 정의가 있습니다',
    'LBL_SCAN_525_TITLE' => '%s에서의 Vardef HTML 함수',
    'LBL_SCAN_423_TITLE' => '잘못된 vardefs 하위 필드 - %s이(가) 잘못된 하위 필드 %s을 (를) 참조합니다. 모듈 %s에 있습니다.',
    ...
    'LBL_SCAN_505_TITLE' => '%s 유형 변경(%s 필드): %s에서 %s(으)로',
    'LBL_SCAN_506_TITLE' => '%s 의 $this 러한 사용',
    'LBL_SCAN_507_TITLE' => '잘못된 vardefs 하위 필드 - %s이(가) 잘못된 하위 필드 %s(모듈 %s)을(를) 참조합니다.',
    ...
    'LBL_SCAN_526_TITLE' => "잘못된 vardefs - multienum 필드 '%s'(옵션 목록 '%s' 키)에 호환되지 않는 문자가 있습니다. '%s'(모듈 %s)",
    'LBL_SCAN_528_TITLE' => '필드 %s(모듈 %s)에 올바르지 않은 display_default 값이 있습니다.',
    'LBL_SCAN_529_TITLE' => '%s: %s(%s 파일, %s 라인)',
    ...
    'LBL_SCAN_567_TITLE' => '제거된 Zend 프레임워크 구성 요소 사용',
    'LBL_SCAN_568_TITLE' => '더 이상 사용되지 않는 Zend 프레임워크 구성 요소 사용',
    ...
    'LBL_SCAN_587_TITLE' => '더 이상 사용되지 않는 LESS 색상 변수가 감지되었습니다.',
    ...
    'LBL_SCAN_301_DESCR' => '특정 사용자 지정이 감지되었지만 Sugar7로 마이그레이션되지 않았습니다. 이 모듈(%s)은 계속 사용할 수 있지만 Sugar7의 이전 버전과의 호환성 모드로 실행됩니다.',
    ...
    'LBL_SCAN_304_DESCR' => '알 수 없는 파일(%s%s)이 감지되었지만 Sugar7로 마이그레이션되지 않았습니다.  이 모듈(%s)은 계속 사용할 수 있지만 Sugar7의 이전 버전과의 호환성 모드로 실행됩니다.',
    'LBL_SCAN_305_DESCR' => '잘못된 vardefs(%s: %s)가 모듈 %s에서 감지되었으며 Sugar7로 마이그레이션되지 않았습니다.이 사용자 지정은 계속 사용할 수 있지만 Sugar7의 이전 버전과의 호환성 모드에서 실행될 예정입니다.',
    'LBL_SCAN_306_DESCR' => '잘못된 vardefs가 발견되었지만 Sugar7로 마이그레이션되지 않았습니다.  관련 필드 %s(모듈 %s)에 빈 `모듈`이 있습니다.) 이 사용자 지정은 계속 사용할 수 있지만 Sugar7의 이전 버전과의 호환성 모드에서 실행될 예정입니다.',
    'LBL_SCAN_307_DESCR' => '잘못된 vardefs가 발견되었지만 Sugar7로 마이그레이션되지 않았습니다. 링크(%s)(모듈 %s)는 잘못된 관계를 참조합니다.  이 사용자 지정은 계속 사용할 수 있지만 Sugar7의 이전 버전과의 호환성 모드에서 실행됩니다.',
    'LBL_SCAN_308_DESCR' => '특정 사용자 지정이 감지되었지만 Sugar7로 마이그레이션되지 않았습니다. 이 모듈(%s)은 계속 사용할 수 있지만 Sugar7의 이전 버전과의 호환성 모드로 실행됩니다.',
    ...
    'LBL_SCAN_311_DESCR' => '특정 사용자 지정이 감지되었지만 Sugar7로 마이그레이션되지 않았습니다. 이 모듈(%s)은 계속 사용할 수 있지만 Sugar7의 이전 버전과의 호환성 모드로 실행됩니다.',
...
//    'LBL_SCAN_405_DESCR' => 'Package detected which has been blacklisted as not supported in Sugar 7',
    ...
    'LBL_SCAN_517_DESCR' => 'Sugar 7에서 지원되지 않는 거부 목록으로 감지된 패키지입니다',
    ...
    'LBL_SCAN_540_DESCR' => '대상 Sugar 버전에서 지원되지 않도록 거부 목록에 오른 패키지를 감지했습니다.  이 패키지를 업그레이드 전 설치 및 삭제해야 합니다.  이 패키지를 삭제하면 패키지 및 패키지의 모듈 사용에 의해 생성된 테이블 및 데이터가 삭제되니 유의하십시오.',
    ...
    'LBL_SCAN_577_LOG' => "데이터 정렬 '%s'이(가) '%s' 문자 집합과 호환되지 않습니다.",
    'LBL_SCAN_577_DESCR' => "지역 설정에서 다른 데이터 정렬을 선택하거나 'dbconfigoption.collation' 구성을 제거하여 기본 데이터 정렬을 사용하십시오.",

    'LBL_SCAN_578_TITLE' => '임시 데이터베이스 테이블을 제거할 수 없음: %s',
    'LBL_SCAN_578_LOG' => '임시 데이터베이스 테이블을 제거할 수 없음: %s',
