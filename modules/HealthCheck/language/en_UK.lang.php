...
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_563_LOG' => 'Use of incompatible Monologue customization: %s',
    ...
    'LBL_SCAN_587_LOG' => 'A subset of LESS variables will be deprecated as of 13.1, and will not be supported in 14.0. Use of deprecated LESS variables detected in: %s',
...
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_507_TITLE' => 'Bad vardefs subfields - %s refers to bad subfield %s in module %s',
    ...
    'LBL_SCAN_587_TITLE' => 'Deprecated LESS colour variables detected.',
    ...
    'LBL_SCAN_307_DESCR' => 'Bad vardefs were detected and were not migrated to Sugar7. The link (%s) in module %s refers to an invalid relationship.  This customization will continue to be available but it will be run in Backwards Compatibility Mode on Sugar7. ',
