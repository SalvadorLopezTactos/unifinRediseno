...
$mod_strings = [
    ...
    'LBL_SCAN_304_LOG' => 'Nezināmi faili: %s%s - %s nav MB modulis',
    'LBL_SCAN_305_LOG' => 'Nepareizas mainīgo definīcijas - atslēga %s, nosaukums %s modulī %s',
    'LBL_SCAN_306_LOG' => 'Nepareizas mainīgo definīcijas — saistītajā laukā %s modulī %s ir tukšs "modulis"',
    'LBL_SCAN_307_LOG' => 'Nepareizas mainīgo definīcijas — saite %s modulī %s attiecas uz nederīgām relācijām',
    ...
    'LBL_SCAN_314_LOG' => "Nepareizas mainīgo definīcijas — multienum lauks '%s' ar opciju saraksta '%s' atslēgām satur nesaderīgas rakstzīmes — '{%s}' modulī %s",
    ...
    'LBL_SCAN_520_LOG' => 'Logic hook after_ui_frame noteikts %s',
    'LBL_SCAN_521_LOG' => 'Logic hook after_ui_footer noteikts %s',
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_518_LOG' => 'Atrasts customCode %s %s, fails %s',
    ...
    'LBL_SCAN_413_LOG' => 'Nezināma logrīku klase noteikta: %s priekš %s, modulis %s failā %s',
    ...
    'LBL_SCAN_418_LOG' => 'Atrasts apakšpanelis ar saiti uz neeksistējošu moduli: %s %s fails',
    'LBL_SCAN_419_LOG' => 'Nepareizas mainīgo definīcijas - atslēga %s, nosaukums %s modulī %s',
    'LBL_SCAN_420_LOG' => 'Nepareizas mainīgo definīcijas — saistītajā laukā %s modulī %s ir tukšs "modulis"',
    'LBL_SCAN_421_LOG' => 'Nepareizas mainīgo definīcijas — saite %s modulī %s attiecas uz nederīgām relācijām',
    'LBL_SCAN_422_LOG' => 'Moduļa %s failā %s ir cita moduļa %s definīcija',
    'LBL_SCAN_525_LOG' => 'Mainīgo definīciju HTML funkcija %s',
    'LBL_SCAN_423_LOG' => 'Nepareizu mainīgo definīciju apakšlauki — %s attiecas uz nepareizu apakšlauku %s. Atrodas modulī %s',
    ...
    'LBL_SCAN_526_LOG' => "Nepareizas mainīgo definīcijas — multienum lauks '%s' ar opciju saraksta '%s' atslēgām satur nesaderīgas rakstzīmes — '%s' modulī %s",
    ...
    'LBL_SCAN_563_LOG' => 'Nesaderīgas monologa pielāgošanas izmantošana: %s',
    'LBL_SCAN_564_LOG' => 'Novecojušas DBAL funkcionalitātes izmantošana: %s',
    'LBL_SCAN_565_LOG' => 'Tiek izmantots novecojis konfigurācijas parametrs $sugar_config[&#39;passwordHash&#39;]. Sākot ar versiju 13.3, tas netiks atbalstīts: %s',
    'LBL_SCAN_566_LOG' => 'Tiek izmantots novecojis konfigurācijas parametrs $sugar_config[&#39;passwordHash&#39;]: %s',
    'LBL_SCAN_567_LOG' => 'Noņemtā Zend Framework komponenta izmantošana: %s',
    'LBL_SCAN_568_LOG' => 'Novecojušā Zend Framework komponenta izmantošana: %s',
    ...
    'LBL_SCAN_587_LOG' => 'LESS mainīgo apakškopa tiks pārtraukta no 13.1, un tā netiks atbalstīta versijā 14.0. Konstatēta novecojušu LESS mainīgo izmantošana: %s',
    ...
    'LBL_SCAN_507_LOG' => 'Nepareizu mainīgo definīciju apakšlauki — %s attiecas uz nepareizu apakšlauku %s. Atrodas modulī %s',
    ...
    'LBL_SCAN_304_TITLE' => 'Nezināmi faili: %s%s - %s nav MB modulis',
    'LBL_SCAN_305_TITLE' => 'Nepareizas mainīgo definīcijas - atslēga %s, nosaukums %s modulī %s',
    'LBL_SCAN_306_TITLE' => 'Nepareizas mainīgo definīcijas — saistītajā laukā %s modulī %s ir tukšs "modulis"',
    'LBL_SCAN_307_TITLE' => 'Nepareizas mainīgo definīcijas — saite %s modulī %s attiecas uz nederīgām relācijām',
    ...
    'LBL_SCAN_520_TITLE' => 'Logic hook after_ui_frame noteikts %s',
    'LBL_SCAN_521_TITLE' => 'Logic hook after_ui_footer noteikts %s',
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_518_TITLE' => 'Atrasts customCode %s %s, fails %s',
    ...
    'LBL_SCAN_413_TITLE' => 'Nezināma logrīku klase noteikta: %s priekš %s, modulis %s failā %s',
    ...
    'LBL_SCAN_418_TITLE' => 'Atrasts apakšpanelis ar saiti uz neeksistējošu moduli: %s %s fails',
    'LBL_SCAN_419_TITLE' => 'Nepareizas mainīgo definīcijas - atslēga %s, nosaukums %s modulī %s',
    'LBL_SCAN_420_TITLE' => 'Nepareizas mainīgo definīcijas — saistītajā laukā %s modulī %s ir tukšs "modulis"',
    'LBL_SCAN_421_TITLE' => 'Nepareizas mainīgo definīcijas — saite %s modulī %s attiecas uz nederīgām relācijām',
    'LBL_SCAN_422_TITLE' => 'Modulī %s ir cita moduļa definīcija',
    'LBL_SCAN_525_TITLE' => 'Mainīgo definīciju HTML funkcija %s',
    'LBL_SCAN_423_TITLE' => 'Nepareizu mainīgo definīciju apakšlauki — %s attiecas uz nepareizu apakšlauku %s. Atrodas modulī %s',
    ...
    'LBL_SCAN_507_TITLE' => 'Nepareizu mainīgo definīciju apakšlauki — %s attiecas uz nepareizu apakšlauku %s modulī %s',
    ...
    'LBL_SCAN_526_TITLE' => "Nepareizas mainīgo definīcijas — multienum lauks '%s' ar opciju saraksta '%s' atslēgām satur nesaderīgas rakstzīmes — '%s' modulī %s",
    ...
    'LBL_SCAN_567_TITLE' => 'Noņemtā Zend Framework komponenta izmantošana',
    'LBL_SCAN_568_TITLE' => 'Novecojušā Zend Framework komponenta izmantošana',
    ...
    'LBL_SCAN_587_TITLE' => 'Konstatēti novecojuši LESS krāsu mainīgie.',
    ...
    'LBL_SCAN_304_DESCR' => 'Nezināmi faili (%s%s) tika noteikti un netika atjaunināti uz Sugar7. Šis modulis (%s) joprojām būs pieejams, taču Sugar7 tas darbosies iepriekšējās versijas savietojamības režīmā. ',
    'LBL_SCAN_305_DESCR' => 'Nepareizas mainīgo definīcijas (%s%s) tika noteiktas modulī %s un netika atjauninātas uz Sugar7. Šis pielāgojums joprojām būs pieejams, taču Sugar7 tas darbosies iepriekšējās versijas savietojamības režīmā. ',
    'LBL_SCAN_306_DESCR' => 'Nepareizas mainīgo definīcijas tika noteiktas un netika atjauninātas uz Sugar7. Saistītajam laukam (%s) modulī %s ir tukšs `modulis`).  Šis pielāgojums joprojām būs pieejams, taču Sugar7 tas darbosies iepriekšējās versijas savietojamības režīmā. ',
    'LBL_SCAN_307_DESCR' => 'Nepareizas mainīgo definīcijas tika noteiktas un netika atjauninātas uz Sugar7. Saite (%s) modulī %s attiecas uz nederīgu relāciju. Šis pielāgojums joprojām būs pieejams, taču Sugar7 tas darbosies iepriekšējās versijas savietojamības režīmā. ',
...
//    'LBL_SCAN_405_DESCR' => 'Package detected which has been blacklisted as not supported in Sugar 7',
    ...
    'LBL_SCAN_517_DESCR' => 'Ir atklāta pakotne, kas Sugar 7 ir atzīmēta kā noraidīta',
    ...
    'LBL_SCAN_540_DESCR' => 'Ir atklāta pakotne, ko mērķa Sugar versija noraida. Pirms atjaunināšanas šīs pakotnes ir jāatinstalē UN jāizdzēš. Jāņem vērā, ka šo pakotņu atinstalēšanas rezultātā tiks dzēstas pakotnes veidotās tabulas un dati, kā arī pakotnes moduļu lietojums.',
