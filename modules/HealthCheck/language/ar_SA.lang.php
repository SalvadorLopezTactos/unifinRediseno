...
$mod_strings = [
    ...
    'LBL_SCAN_520_LOG' => 'تم اكتشاف أداة الإضافة المنطقية after_ui_frame في %s',
    'LBL_SCAN_521_LOG' => 'تم اكتشاف أداة الإضافة المنطقية after_ui_footer في %s',
//    'LBL_SCAN_405_LOG' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_518_LOG' => 'تم العثور على الرمز المخصص %s في %s، الملف %s',
    ...
    'LBL_SCAN_413_LOG' => 'تم اكتشاف فئة عنصر واجهة مستخدم غير معروفة: %s لـ %s، الوحدة %s في الملف %s',
    ...
    'LBL_SCAN_418_LOG' => 'تم العثور على لوحة فرعية مع ارتباط إلى وحدة غير موجودة: %s في الملف %s',
    ...
    'LBL_SCAN_563_LOG' => 'استخدام تخصيص Monolog غير المتوافق: %s',
    'LBL_SCAN_564_LOG' => 'استخدام وظيفة DBAL القديمة: %s',
    'LBL_SCAN_565_LOG' => 'استخدم خاصية التكوين المهملة $sugar_config[&#39;passwordHash&#39;]. من الإصدار 13.3 لن تكون مدعومة: %s',
    'LBL_SCAN_566_LOG' => 'استخدم خاصية التكوين غير المدعومة $sugar_config[&#39;passwordHash&#39;]: %s',
    'LBL_SCAN_567_LOG' => 'استخدام مكون Zend Framework الذي تمت إزالته: %s',
    'LBL_SCAN_568_LOG' => 'استخدام مكون Zend Framework المهمل: %s',
    ...
    'LBL_SCAN_587_LOG' => 'سيتم إهمال مجموعة فرعية من متغيرات LESS اعتبارًا من 13.1، ولن يتم دعمها في 14.0. تم اكتشاف استخدام متغيرات LESS المهملة في: %s',
    ...
    'LBL_SCAN_520_TITLE' => 'تم اكتشاف أداة الإضافة المنطقية after_ui_frame في %s',
    'LBL_SCAN_521_TITLE' => 'تم اكتشاف أداة الإضافة المنطقية after_ui_footer في %s',
//    'LBL_SCAN_405_TITLE' => 'Incompatible Integration - %s %s',
    ...
    'LBL_SCAN_518_TITLE' => 'تم العثور على الرمز المخصص %s في %s، الملف %s',
    ...
    'LBL_SCAN_413_TITLE' => 'تم اكتشاف فئة عنصر واجهة مستخدم غير معروفة: %s لـ %s، الوحدة %s في الملف %s',
    ...
    'LBL_SCAN_418_TITLE' => 'تم العثور على لوحة فرعية مع ارتباط لوحدة غير موجودة: %s في الملف %s',
    ...
    'LBL_SCAN_507_TITLE' => 'حقول فرعية سيئة لتعريفات متغيرة - %s يشير إلى حقل فرعي سيئ %s في الوحدة %s',
    ...
    'LBL_SCAN_567_TITLE' => 'استخدام مكون Zend Framework الذي تمت إزالته',
    'LBL_SCAN_568_TITLE' => 'استخدام مكون Zend Framework المهمل',
    ...
    'LBL_SCAN_587_TITLE' => 'تم اكتشاف متغيرات ألوان LESS المهملة.',
    ...
    'LBL_SCAN_304_DESCR' => 'تم اكتشاف ملفات غير معروفة (%s%s) ولم يتم ترحيلها إلى Sugar7.  سيستمر توفر هذه الوحدة (%s) إلا أنها ستعمل في وضع التوافق مع الإصدارات السابقة في Sugar7. ',
