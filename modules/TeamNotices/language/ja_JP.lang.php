...
$mod_strings = array (
  ...
  'LBL_TEAM_NOTICE_WIRELESS' => 'SugarCRMアプリケーションの新しいモバイルビューは便利性と機動性との間で妥協することがなくなりました。<br />機能:<br />* 編集/詳細/一覧/関連したレコードへのビューと共に、従業員一覧表示/お気に入りの保存/アイテムの履歴参照できるようになりました。<br />* BlackberryやiPhoneといった任意のPDA/スマートフォンからSugarCRMのデータを参照することができます。<br />* リッチなHTMLクライアントは標準のWebブラウザによりSugarCRMのデータをきれいに表示します。<br />* 新しい検索機能により情報を素早く探すことができます。',
