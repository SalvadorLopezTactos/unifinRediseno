...
$mod_strings = [
    ...
    'LBL_REVISIONS_FOR_DOC' => 'Revisões para documento relacionado',

    'LBL_RECORD_SAVED_SUCCESS' => 'Você criou com êxito {{moduleSingularLower}} <a href="#{{buildRoute model=this}}">{{revision}}</a>.', // use when a model is available
