...
$mod_strings = [
    ...
    'LBL_REVISIONS_FOR_DOC' => 'Revisões para o documento relacionado',

    'LBL_RECORD_SAVED_SUCCESS' => '{{moduleSingularLower}} <a href="#{{buildRoute model=this}}">{{revision}}</a> foi criado com êxito.', // use when a model is available
