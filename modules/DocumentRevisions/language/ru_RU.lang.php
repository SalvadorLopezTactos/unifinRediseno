...
$mod_strings = [
    ...
    'LBL_REVISIONS_FOR_DOC' => 'Редакции для связанного документа',

    'LBL_RECORD_SAVED_SUCCESS' => 'Вы успешно создали {{moduleSingularLower}} <a href="#{{buildRoute model=this}}">{{revision}}</a>.', // use when a model is available
