...
$mod_strings = [
    ...
    'LBL_REVISIONS_FOR_DOC' => 'Révisions pour le document connexe',

    'LBL_RECORD_SAVED_SUCCESS' => 'Vous avez créé {{moduleSingularLower}}<a href="#{{buildRoute model=this}}">{{revision}}</a>.', // use when a model is available
