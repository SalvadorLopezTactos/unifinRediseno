...
$mod_strings = [
    ...
    'LBL_REVISIONS_FOR_DOC' => 'Revizija za povezani dokument',

    'LBL_RECORD_SAVED_SUCCESS' => 'Uspešno ste kreirali {{moduleSingularLower}} <a href="#{{buildRoute model=this}}">{{revision}}</a>.', // use when a model is available
