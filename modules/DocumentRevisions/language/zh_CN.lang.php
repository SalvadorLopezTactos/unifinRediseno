...
$mod_strings = [
    ...
    'LBL_REVISIONS_FOR_DOC' => '相关文档的修订',

    'LBL_RECORD_SAVED_SUCCESS' => '您已成功创建 {{moduleSingularLower}} <a href="#{{buildRoute model=this}}">{{revision}}</a>。', // use when a model is available
