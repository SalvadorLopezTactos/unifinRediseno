...
$mod_strings = [
    ...
    'LBL_REVISIONS_FOR_DOC' => 'Revisions del document relacionat',

    'LBL_RECORD_SAVED_SUCCESS' => 'Heu creat correctament el {{moduleSingularLower}} <a href="#{{buildRoute model=this}}">{{revision}}</a>.', // use when a model is available
