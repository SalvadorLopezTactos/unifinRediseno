...
$mod_strings = [
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'Oppgraderingspakken er ikke kompatibel med denne versjonen av Sugar: %s',
    ...
    'ERROR_UW_CONFIG_DB' => 'Feil ved lagring av %s config var til db (nøkkel %sverdi %s).',
