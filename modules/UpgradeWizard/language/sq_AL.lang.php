...
$mod_strings = [
    ...
    'ERROR_HT_NO_WRITE' => 'Nuk mund të shkruhet në dosje: %s',
    'ERROR_MANIFEST_TYPE' => 'Dosja e manifestuar duhet të përcaktoj llojin e paketit.',
    'ERROR_PACKAGE_TYPE' => 'Dosja manifest përcakton një lloj të panjohur pakete: %s',
    'ERROR_VERSION_INCOMPATIBLE' => 'Paketa e përditësimit nuk është e përputhshme me këtë version të Sugar: %s',
    ...
    'ERROR_UW_CONFIG_DB' => 'Gabim gjatë ruajtjes %s konfigurimi i var në db (çelësi %s, vlera %s).',
