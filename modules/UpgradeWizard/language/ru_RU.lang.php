...
$mod_strings = [
    ...
    'ERROR_HT_NO_WRITE' => 'Не удалось записать в файл: %s',
    'ERROR_MANIFEST_TYPE' => 'В Manifest-файле должен быть указан тип пакета',
    'ERROR_PACKAGE_TYPE' => 'В Manifest-файле указан неизвестный тип пакета: %s',
    'ERROR_VERSION_INCOMPATIBLE' => 'Пакет обновления не совместим с данной версией Sugar: %s',
