...
$mod_strings = [
    ...
    'ERROR_PACKAGE_TYPE' => 'El fitxer de manifest especifica un tipus de paquet no reconegut: %s',
    'ERROR_VERSION_INCOMPATIBLE' => 'El paquet d&#39;actualització no és compatible amb aquesta versió de Sugar: %s',
