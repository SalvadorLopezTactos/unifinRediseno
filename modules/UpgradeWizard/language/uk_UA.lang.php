...
$mod_strings = [
    ...
    'ERROR_PACKAGE_TYPE' => 'У Manifest-файлі вказано невідомий тип пакета: %s',
    'ERROR_VERSION_INCOMPATIBLE' => 'Пакет оновлення не сумісний з цією версією Sugar: %s',
    ...
    'ERROR_UW_CONFIG_DB' => 'Помилка збереження %s config var до бази даних (ключ %s, значення %s).',
