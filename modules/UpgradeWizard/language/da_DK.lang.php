...
$mod_strings = [
    ...
    'ERROR_HT_NO_WRITE' => 'Der kan ikke skrives til filen: %s',
    ...
    'ERROR_VERSION_INCOMPATIBLE' => 'Opgraderingspakken er ikke kompatibel med denne version af Sugar: %s',
    ...
    'ERROR_UW_CONFIG_DB' => 'Der opstod en fejl, under lagring af %s config var i db (key %s, value %s).',
