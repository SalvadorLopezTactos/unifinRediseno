...
$mod_strings = [
    ...
    'ERROR_HT_NO_WRITE' => '파일에 쓸 수 없음: %s',
    'ERROR_MANIFEST_TYPE' => '현재 파일이 반드시 패키지형식을 지정해야합니다.',
    'ERROR_PACKAGE_TYPE' => '매니페스트 파일은 인식할 수 없는 패키지 유형을 지정합니다: %s',
    'ERROR_VERSION_INCOMPATIBLE' => '업그레이드 패키지는 이 버전의 Sugar과 호환되지 않습니다. %s',
    'ERROR_FLAVOR_INCOMPATIBLE' => '전송된 파일은 Sugar의 프로페셔널, 엔터프라이즈, 얼티메이트 에디션에 적용할 수 없습니다.%s',

    'ERROR_UW_CONFIG_DB' => '%s 구성 변수를 db에 저장하는 동안 오류가 발생했습니다(키 %s, 값 %s).',
