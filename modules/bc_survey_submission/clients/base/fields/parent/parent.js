({
        ...
        if (self.module == 'bc_survey_submission')
        {
            ...
            App.api.call('GET', url, {}, {
                success: function (result) {
                    ...
                    if (result)
                    {
                        self.model.attributes.parent_id = result['parent_id'];
                        self.model.attributes.parent_name = result['parent_name'];
                ...
                success: function (result) {
                    ...
                    if (result)
                    {
                        ...
                        if (_.contains(allowedTpls, self.tplName)) {
                            ...
                            self.checkAcl('access', self.model.get('parent_type'));
    ...
    setValue: function (model) {
        ...
        if (app.acl.hasAccessToModel(this.action, this.model, this.name)) {
            if (module) {
                this.model.set('parent_type', module, {
                    silent: silent
                });
            }
            if (!_.isUndefined(model.id)) {
                ...
                this.model.set('parent_name', value, {
                    silent: silent
                });
            }
        }
