...
$mod_strings = array (
    ...
    'LBL_SELECTED_REVISION_FILENAME' => 'ชื่อไฟล์ของรุ่นที่เลือก',
    'LBL_FILE_URL' => 'URL ของไฟล์',
    'LBL_REVISIONS_PANEL' => 'รายละเอียดของรุ่น',
    'LBL_REVISIONS_SUBPANEL' => 'รุ่น',
    ...
    'LBL_THEREVISIONS_SUBPANEL_TITLE' => 'การจอง',
    'LBL_DOCUMENT_INFORMATION' => 'ภาพรวม',
    'LBL_DOC_ID' => 'ID ที่มาเอกสาร',
    'LBL_DOC_TYPE' => 'ที่มา',
    'LBL_LIST_DOC_TYPE' => 'ที่มา',
    'LBL_DOC_TYPE_POPUP' => 'เลือกที่มาที่จะใช้ในการอัปโหลดเอกสาร<br>และตำแหน่งที่สามารถใช้งานเอกสารได้',
    'LBL_DOC_URL' => 'URL ที่มาเอกสาร',
    'LBL_SEARCH_EXTERNAL_DOCUMENT' => 'ชื่อไฟล์',
    'LBL_EXTERNAL_DOCUMENT_NOTE' => 'ไฟล์ที่แก้ไขล่าสุด 20 รายการจะปรากฏตามลำดับจากใหม่ไปหาเก่าในรายการด้านล่าง ใช้การค้นหาเพื่อหาไฟล์อื่นๆ',
    'LBL_LIST_EXT_DOCUMENT_NAME' => 'ชื่อไฟล์',
    'ERR_INVALID_EXTERNAL_API_ACCESS' => 'ผู้ใช้พยายามเข้าถึง API ภายนอกที่ไม่ถูกต้อง ({0})',
    'ERR_INVALID_EXTERNAL_API_LOGIN' => 'การตรวจสอบล็อกอินล้มเหลวสำหรับ API ภายนอก ({0})',
    ...
    'LBL_PLIS_SUBPANEL_TITLE' => 'ซื้อสินค้าในไลน์',
);
