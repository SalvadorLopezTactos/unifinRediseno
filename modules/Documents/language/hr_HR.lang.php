...
$mod_strings = array (
    ...
    'LBL_SELECTED_REVISION_FILENAME' => 'Naziv datoteke odabrane revizije',
    'LBL_FILE_URL' => 'URL datoteke',
    'LBL_REVISIONS_PANEL' => 'Detalji o reviziji',
    ...
    'LBL_DOCUMENT_INFORMATION' => 'Pregled',
    'LBL_DOC_ID' => 'ID izvora dokumenta',
    'LBL_DOC_TYPE' => 'Izvor',
    'LBL_LIST_DOC_TYPE' => 'Izvor',
    'LBL_DOC_TYPE_POPUP' => 'Odaberite izvor na koji će se ovaj dokument učitati<br> i s kojeg će biti dostupan.',
    'LBL_DOC_URL' => 'URL izvora dokumenta',
    'LBL_SEARCH_EXTERNAL_DOCUMENT' => 'Naziv datoteke',
    'LBL_EXTERNAL_DOCUMENT_NOTE' => 'Prvih 20 posljednje izmijenjenih datoteka prikazuju se u silaznom redoslijedu na popisu u nastavku. Upotrijebite opciju pretraživanja da biste pronašli ostale datoteke.',
    'LBL_LIST_EXT_DOCUMENT_NAME' => 'Naziv datoteke',
    'ERR_INVALID_EXTERNAL_API_ACCESS' => 'Korisnik je pokušao pristupiti neispravnom vanjskom API-ju ({0})',
    'ERR_INVALID_EXTERNAL_API_LOGIN' => 'Provjera prijave nije uspjela za vanjski API ({0})',
