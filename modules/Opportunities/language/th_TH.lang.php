...
- แก้ไขฟิลด์ของบันทึกนี้โดยคลิกที่ฟิลด์แต่ละตัวหรือคลิกที่ปุ่มแก้ไข
- ดูหรือแก้ไขลิงก์ไปยังระเบียนอื่นในแถบย่อยโดยการสลับแถบล่างซ้ายเป็น "มุมมองข้อมูล"
- จัดทำและดูความคิดเห็นผู้ใช้และประวัติการเปลี่ยนบันทึกใน {{activitystream_singular_module}} โดยสลับแถบล่างซ้ายเป็น "สตรีมกิจกรรม"
...
- การดำเนินการอื่น ๆ จะอยู่ในเมนูการดำเนินการแบบดรอปดาวน์ด้านขวาของปุ่มแก้ไข',
    ...
    'LBL_HELP_CREATE' => 'โมดูล {{plural_module_name}} ให้คุณสามารถติดตามการขายแต่ละรายการได้จากต้นจนจบ บันทึก {{module_name}} แต่ละรายการจะแสดงทัศนวิสัยของการขาย และรวมถึงข้อมูลการขายที่เกี่ยวข้อง พร้อมด้วยบันทึกสำคัญต่าง ๆ ที่เกี่ยวข้องด้วย เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น 
...
2. คลิก "บันทึก" เพื่อสิ้นสุดการสร้างบันทึกใหม่ และกลับสู่เพจก่อนหน้า',
