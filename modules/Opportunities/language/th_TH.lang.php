...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'โมดูล {{plural_module_name}} ช่วยให้คุณติดตามการขายแต่ละรายการตั้งแต่ต้นจนเสร็จสิ้น ระเบียน {{module_name}} แต่ละรายการจะแสดงถึงการขายในเชิงคาดการณ์และข้อมูลการขายที่เกี่ยวข้อง ตลอดจนระเบียนสำคัญอื่นๆ เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น ตามปกติ {{module_name}} จะเข้าสู่ขั้นตอนต่างๆ หลายขั้นตอนจนกระทั่งมีการทำเครื่องหมายว่า "ปิดโดยได้รับการขาย" หรือ "ปิดโดยไม่ได้รับการขาย" คุณสามารถใช้ประโยชน์จาก {{plural_module_name}} เพิ่มเติมโดยใช้โมดูล {{forecasts_singular_module}} ของ Sugar เพื่อทำความเข้าใจและคาดการณ์แนวโน้มการขาย ตลอดจนโฟกัสการทำงานเพื่อให้ได้โควตาการขาย',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'โมดูล {{plural_module_name}} ช่วยให้คุณติดตามการขายแต่ละรายการและบรรทัดรายการของการขายเหล่านั้นตั้งแต่ต้นจนเสร็จสิ้น ระเบียน {{module_name}} แต่ละรายการจะแสดงถึงการขายเชิงคาดการณ์และประกอบด้วยข้อมูลการขายที่เกี่ยวข้อง ตลอดจนระเบียนสำคัญอื่นๆ เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น
...
- การดำเนินการอื่นๆ ที่ใช้ได้อยู่ในเมนูการดำเนินการแบบดรอปดาวน์ทางขวาของปุ่มแก้ไข',
    ...
    'LBL_HELP_CREATE' => 'โมดูล {{plural_module_name}} ช่วยให้คุณสามารถติดตามการขายแต่ละรายการ และบรรทัดรายการของการขายเหล่านั้นตั้งแต่ต้นจนเสร็จสิ้น ระเบียน {{module_name}} แต่ละรายการจะแสดงถึงการขายเชิงคาดการณ์ และมีข้อมูลการขายที่เกี่ยวข้อง ตลอดจนเชื่อมโยงกับระเบียนสำคัญอื่นๆ เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น
