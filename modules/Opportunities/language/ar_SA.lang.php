...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'وحدة {{plural_module_name}} تتيح لك تتبع المبيعات الفردية من البداية إلى النهاية. كل سجل {{module_name}} يمثل عملية بيع متوقعة، ويتضمن بيانات البيع ذات الصلة وكذلك المرتبطة بالسجلات المهمة الأخرى مثل {{quotes_module}}، و{{contacts_module}}، وغير ذلك. ستتقدم {{module_name}} بشكل نموذجي من خلال مراحل مبيعات متعددة حتى يتم وضع علامة "أرباح مقفلة" أو "خسائر مقفلة". يمكن تعزيز {{plural_module_name}} عن طريق استخدام وحدة {{forecasts_singular_module}} الخاصة بـ Sugar لفهم وتوقع مسارات المبيعات بالإضافة إلى تركيز العمل على تحقيق الحصص النسبية للمبيعات.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'تتيح وحدة {{plural_module_name}} تتبع المبيعات الفردية والبنود التي تنتمي إلى هذه المبيعات من البداية غلى النهاية. كل سجل {{module_name}} يمثل عملية بيع متوقعة ويتضمن بيانات البيع ذات الصلة وكذلك المتعلقة بالسجلات المهمة الأخرى مثل {{quotes_module}}، و{{contacts_module}}، وغير ذلك.
- قم بتحرير حقول السجل عن طريق النقر فوق حقل فردي أو الزر تحرير.
- قم بعرض أو تعديل الارتباطات بالسجلات الأخرى في اللوحات الفرعية عن طريق تبديل الجزء السفلي الأيسر إلى "عرض البيانات".
- قم بإعداد وعرض تعليقات المستخدم وتسجيل سجل التغيير في {{activitystream_singular_module}} عن طريق تبديل الجزء السفلي الايسر إلى "سير النشاط الكلي".
- قم بمتابعة أو تفضيل هذا السجل باستخدام الأيقونات الموجودة على يمين اسم السجل.
- تتوفر الإجراءات الإضافية في قائمة الإجراءات المنسدلة على يمين زر تحرير.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'تتيح وحدة {{plural_module_name}} تتبع المبيعات الفردية والبنود التي تنتمي إلى هذه المبيعات من البداية غلى النهاية. كل سجل {{module_name}} يمثل عملية بيع متوقعة ويتضمن بيانات البيع ذات الصلة وكذلك المتعلقة بالسجلات المهمة الأخرى مثل {{quotes_module}}، و{{contacts_module}}، وغير ذلك.
لإنشاء {{module_name}}:
1. تقديم القيم للحقول على النحو المطلوب.
 - الحقول بعلامات "مطلوب" يجب إكمالها قبل الحفظ.
 - انقر فوق "إظهار المزيد" لعرض حقول إضافية عند الضرورة.
