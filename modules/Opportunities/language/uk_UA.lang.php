...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі від початку і до самого кінця. Кожен запис {{module_name}} є потенційною угодою та містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, таких як {{quotes_module}}, {{contacts_module}} і т. д. Модуль {{module_name}} зазвичай проходить кілька стадій продажу, доки не набуде статусу "Виграний продаж" або "Втрачений продаж". Користь від застосування модуля {{plural_module_name}} можна збільшити, використовуючи модуль {{forecasts_singular_module}} системи Sugar для розуміння та прогнозування тенденцій продажів, а також для зосередження роботи на досягненні встановлених квот.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі та продукти, що відносяться до них, від початку і до самого кінця. Кожен запис {{module_name}} є потенційною угодою та містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, таких як {{quotes_module}}, {{contacts_module}} і т. д.

- Щоб відредагувати поле запису, клацніть потрібне поле або натисніть кнопку "Редагувати".
...
- Щоб підписатися на даний запис або додати його до вподобань, використовуйте піктограми праворуч від імені запису.
- Додаткові можливості доступні в розкривному меню "Дії" праворуч від кнопки "Редагувати".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'За допомогою модуля {{plural_module_name}} можна відстежувати окремі продажі та продукти, що відносяться до них, від початку і до самого кінця. Кожен запис {{module_name}} є потенційною угодою та містить необхідні дані про продаж, а також дані, що стосуються інших важливих записів, таких як {{quotes_module}}, {{contacts_module}} і т. д.
...
2. Натисніть кнопку "Зберегти", щоб завершити створення нового запису і повернутися до попередньої сторінку.',
