...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} дає змогу відстежувати окремі продажі від початку до кінця. Кожен запис {{module_name}} є потенційним продажем і містить відповідні дані про продаж, а також стосується інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. Кожен модуль {{module_name}} проходить кілька стадій процесу продажу, доки його не буде позначено як «Успішно закрито» або «Втрачено». Ефективність модуля {{plural_module_name}} можна збільшити, використовуючи модуль {{forecasts_singular_module}} системи Sugar для розуміння та прогнозування тенденцій продажів, а також зосередження роботи на досягненні квот продажу.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модуль {{plural_module_name}} дає змогу відстежувати окремі продажі та позиції, які відносяться до цих продажів, від початку до кінця. Кожен запис {{module_name}} є потенційним продажем і містить відповідні дані про продаж, а також стосується інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. 

- Щоб редагувати поля цього запису, натисніть потрібне поле або кнопку «Редагувати». 
- Щоб переглянути або змінити посилання на інші записи на субпанелях, переключіть ліву нижню панель у режим «Перегляд даних». 
- Щоб залишати та переглядати коментарі користувачів, а також журнал змін запису в модулі {{activitystream_singular_module}}, переключіть ліву нижню панель у режим «Потік активності». 
...
- Додаткові дії доступні в розкривному меню «Дії» праворуч від кнопки «Редагувати».',
    ...
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} дає змогу відстежувати окремі продажі та позиції, які відносяться до цих продажів, від початку до кінця. Кожен запис {{module_name}} є потенційним продажем і містить відповідні дані про продаж, а також стосується інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. 
