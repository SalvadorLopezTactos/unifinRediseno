...
$mod_strings = [
    ...
    'LBL_OPPORTUNITIES_MULTI_LINE_DASHBOARD' => 'Фокусна панель потенційних угод — Консоль',
...
//END DON'T CONVERT
    ...
    'LBL_COMMIT_STAGE_FORECAST' => 'Стадія прогнозу',
    'LBL_WORKSHEET' => 'Таблиця',
    'LBL_PURCHASED_LINE_ITEMS' => 'Куплені продукти',

    // KPI Metrics
    'LBL_ORGANIZE' => 'Упорядкувати',
    'LBL_CREATE_NEW' => 'Створити новий',
    'LBL_MANAGE' => 'Керувати',
    'LBL_SEE_DETAILS' => 'Переглянути деталі',
    'LBL_HIDE_NEW' => 'Приховати',
    ...
    'LBL_CLOSED_WON_RLIS' => '# успішно закритих позицій доходів по продуктам',
    ...
    'LBL_CASCADE_RLI_EDIT' => 'Оновити відкриті позиції статті доходів',
    'LBL_CASCADE_RLI_CREATE' => 'Установити загальні позиції статті доходів',
    ...
    'LBL_TOP_10_OPP' => 'Топ 10 відкритих угод',
    'LBL_DASHLET_MY_ACTIVE_OPP' => 'Розділ: Мої активні угоди',
    'LBL_MY_ACTIVE_OPP' => 'Мої активні угоди',
    ...
    'LBL_TAB_OPPORTUNITY' => 'Огляд модуля {{module}}',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} дає змогу відстежувати окремі продажі від початку до кінця. Кожен запис {{module_name}} відображає потенційний продаж і містить відповідні відомості про продаж, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. {{module_name}} зазвичай проходить через декілька етапів продажу, доки його не буде позначено як «Закрито (успішний)» або «Закрито (втрачений)». {{plural_module_name}} можна використовувати ще ефективніше завдяки модулю Sugar {{forecasts_singular_module}}, що допомагає зрозуміти й передбачати тенденції продажів, а також зосереджувати роботу на досягненні встановлених квот продажів.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модуль {{plural_module_name}} дає змогу відстежувати окремі продажі та позиції цих продажів від початку до кінця. Кожен запис {{module_name}} відображає потенційну операцію продажу та містить відповідні відомості про продаж, а також дані щодо інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо.

- Щоб змінити поля цього запису, натисніть на окреме поле або кнопку «Редагувати».
- Щоб переглянути або змінити посилання на інші записи в підпанелях, перемкніть ліву нижню панель у режим «Перегляд даних». 
- Щоб залишити або переглянути коментарі користувачів, а також історію змін запису в {{activitystream_singular_module}}, перемкніть нижню ліву панель у режим «Стрічка активності». 
- Щоб стежити за цим записом або додати його до обраного, скористайтеся піктограмами праворуч від назви запису. 
- Додаткові дії доступні в розкривному меню дій праворуч від кнопки «Редагувати».',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} дає змогу відстежувати окремі продажі та позиції цих продажів від початку до кінця. Кожен запис {{module_name}} відображає потенційну операцію продажу та містить відповідні відомості про продаж, а також дані щодо інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо.
...
2. Натисніть «Зберегти», щоб завершити створення нового запису й повернутися на попередню сторінку.',
...
// END ENT/ULT
    ...
    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Часова шкала можливості',

    'LBL_CASCADE_SERVICE_WARNING' => ' не можна встановити для будь-якої із загальних позицій статті доходів, оскільки вони не є послугами. Продовжити створення?',
    'LBL_CASCADE_DURATION_WARNING' => ' не можна встановити для будь-якої з цих позицій статті доходів, оскільки їх тривалість заблоковано. Продовжити створення?',

    // AI Predict
    'LBL_AI_OPPORTUNITY_CLOSE_PREDICTION_NAME' => 'Передбачення щодо закриття угоди',
    'LBL_AI_OPPORTUNITY_CLOSE_PREDICTION_DESC' => 'Переглянути докладні відомості про певну угоду',
    'LBL_AI_WINRATE' => 'Частка реалізованих операцій з продажу',
    'LBL_AI_WONOPP' => 'Успішно укладені угоди',
    'LBL_AI_CLOSINGTIME' => 'Час закриття угоди',
    'LBL_AI_CLOSEDOPP' => 'Закриті угоди',
    'LBL_AI_LEADTIMESPAN' => 'Час між укладанням угоди та її закриттям',
];
