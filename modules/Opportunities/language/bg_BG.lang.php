...
$mod_strings = [
    ...
    'LBL_OPPORTUNITIES_MULTI_LINE_DASHBOARD' => 'Табло Фокус възможности - Конзола',
...
//END DON'T CONVERT
    ...
    'LBL_COMMIT_STAGE_FORECAST' => 'Етап на прогноза',
    'LBL_WORKSHEET' => 'План',
    ...
    'LBL_TOP_10_OPP' => 'Топ 10 отворени възможности',
    'LBL_DASHLET_MY_ACTIVE_OPP' => 'Компонент от таблото: Моите активни възможности',
    'LBL_MY_ACTIVE_OPP' => 'Моите активни възможности',
    ...
    'LBL_TAB_OPPORTUNITY' => '{{module}} Преглед',
...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модулът {{plural_module_name}} Ви позволява да следите отделни продажби от начало до край. Всеки запис на {{module_name}} представя очаквана продажба и включва съответните данни за продажбата, както и във връзка с други важни записи като {{quotes_module}}, {{contacts_module}} и т.н. Един модул {{module_name}} обикновено ще премине през няколко етапа на продажбата, докато бъде отбелязан като „Затворен спечелен" или „Затворен загубен". {{plural_module_name}} може дори да се използва по-нататък с помощта на модула {{forecasts_singular_module}} на Sugar, за да се разберат и прогнозират тенденциите в продажбите, както и да се фокусира работата за постигане на квоти за продажби.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модулът {{plural_module_name}} Ви позволява да следите отделни продажби и позиции, принадлежащи на тези продажби, от начало до край. Всеки запис на {{module_name}} представя потенциална продажба и включва съответните данни на продажба, както и връзки към други важни записи като {{quotes_module}}, {{contacts_module}} и т. н.

- Редактирайте полетата на този запис като щракнете върху отделно поле или върху бутона „Редактирай".
...
- Правете и разглеждайте потребителски коментари и записвайте хронологията на промените в {{activitystream_singular_module}} чрез превключване на долния ляв панел към „Поток на активностите".
- Следвайте този запис или го включете в предпочитани чрез иконите вдясно на името на записа.
- Допълнителни действия са налични в падащото меню „Действия" отдясно на бутона „Редактирай".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} Ви позволява да проследявате отделни продажби и позиции от тези продажби от началото до края. Всеки запис на {{module_name}} представя потенциална продажба и съдържа съответните данни за продажбата, както и връзки към други важни данни като {{quotes_module}}, {{contacts_module}} и т.н.

За създаване на {{module_name}}:
1. Въведете стойности в полетата съгласно Вашите предпочитания.
...
2. Щракнете върху „Запис", за да финализирате новия запис и да се върнете към предишната страница.',
...
// END ENT/ULT
    ...
    'LBL_AI_WINRATE' => 'Процент спечелени',
    'LBL_AI_WONOPP' => 'Спечелени възможности',
    'LBL_AI_CLOSINGTIME' => 'Време на затваряне',
    'LBL_AI_CLOSEDOPP' => 'Затворени възможности',
    'LBL_AI_LEADTIMESPAN' => 'Време между създаването на възможност и затворени като спечелени',
];
