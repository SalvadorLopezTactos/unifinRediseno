...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модулът {{plural_module_name}} ви позволява да следите отделните продажби от началото до края. Всеки запис в {{module_name}} представя потенциална продажба и включва съответни данни за продажбата, както и връзката към други важни записи, като {{quotes_module}}, {{contacts_module}} и др. Един {{module_name}} обичайно преминава през няколко етапа на продажба, докато бъде маркиран като "Затворен реализиран" или "Затворен загубен". {{plural_module_name}} може да бъде използван и допълнително с помощта на модула {{forecasts_singular_module}} на Sugar, за да разберете и прогнозирате тенденциите в продажбите, както и да насочите работата към постигане на квоти за продажби.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модулът {{plural_module_name}} ви позволява да следите отделни продажби и елементите на редовете, принадлежащи към тези продажби, от началото до края. Всеки запис в {{module_name}} представя потенциална продажба и включва съответни данни за продажбата, както и връзката към други важни записи, като {{quotes_module}}, {{contacts_module}} и др.

- Редактирате полетата на този запис с щракване върху отделно поле и бутона "Редактиране".
- Разглеждате или модифицирате връзки към други записи в подпанели, като превключите долния ляв панел на "Изглед на данни".
- Правите и разглеждате потребителски коментари и записвате хронологично промените в {{activitystream_singular_module}}, като превключите долния ляв панел на "Поток на дейности".
- Следвате или предпочитате този запис с помощта на иконите вдясно на името на записа.
- Допълнителни действия са налични в падащото меню "Действия" вдясно на бутона "Редактиране".',
...
1. Дайте стойности за полетата, както желаете.
 - Полетата, маркирани като "Задължително", трябва да бъдат попълнени преди записване.
 - Щракнете върху "Покажи още", за да се покажат допълнителни полета, ако е необходимо.
