...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модулът {{plural_module_name}} ви позволява да следите отделните продажби от начало до край. Всеки запис на {{module_name}} представлява потенциална продажба и включва съответните данни за продажбата, както и онези, свързани с други важни записи като {{quotes_module}} {{contacts_module}}, и др. {{module_name}} обикновено преминава през няколко Етапа на продажбата докато не бъде маркиран като "Спечелен" или "Загубен". {{plural_module_name}} може да бъде разширен още с помощта на модула {{forecasts_singular_module}}ing на Sugar, за да бъдат разбрани и предсказани тенденциите в продажбите, както и за фокусиране на работата за постигане на квотите за продажбите.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модулът {{plural_module_name}} дава възможност за проследяване на всяка продажба и оферираните продукти, асоциирани с продажбите. Всеки запис в модула {{module_name}} представлява потенциална продажба и включва съответните данни за продажбата, отнасящи се до други важни записи като {{quotes_module}}, {{contacts_module}} и други.

- Редактирайте полетата на този запис като щракнете върху конкретно поле или използвате бутона „Редактирай“.
- Разгледайте или модифицирайте връзките с други записи в системата като за целта визуализирате панела „Данни“ долу в ляво.
...
- Можете да извършвате допълнителни действия със записа като използвате падащото меню в дясно на бутона „Редактирай“.',
    ...
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} дава възможност за проследяване на отделните продажби и оферираните продукти, асоциирани с тях от началото до края. Всеки запис в модула {{module_name}} представлява потенциална продажба и включва данни за съответната продажба, както и за други важни записи като {{quotes_module}}, {{contacts_module}} и други.
