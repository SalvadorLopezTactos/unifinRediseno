...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модулът {{plural_module_name}} ви позволява да следите отделни продажби от начало до край. Всеки запис {{module_name}} представлява очаквана продажба и включва съответните данни за продажбата, както и във връзка с други важни записи като {{quotes_module}}, {{contacts_module}} и т.н. Един {{module_name}} обикновено ще премине през няколко етапа на продажбата, докато бъде отбелязан или като „Затворен спечелен", или като „Затворен загубен". {{plural_module_name}} може дори да се използва по-нататък с помощта на модула {{forecasts_singular_module}} на Sugar, за да се определят и прогнозират тенденциите в продажбите, както и да се фокусира работата за постигане на квоти на продажби.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модулът {{plural_module_name}} ви позволява да следите отделни продажби и позиции, принадлежащи на тези продажби, от начало до край. Всеки запис {{module_name}} представлява потенциална продажба и включва съответните данни на продажба, както и връзки към други важни записи като {{quotes_module}}, {{contacts_module}} и т. н..

- Редактирайте полетата на този запис като щракнете върху отделно поле или върху бутона „Редактирай".
- Разглеждайте или модифицирайте връзки към други записи в подпанелите чрез чрез превключване на долния ляв панел към „Изглед на данни".
...
- Допълнителни действия са налични в падащото меню „Действия" отдясно на бутона „Редактирай".',
    ...
    'LBL_HELP_CREATE' => 'Модулът {{plural_module_name}} ви позволява да проследявате отделни продажби и позиции от тези продажби от началото до края. Всеки запис {{module_name}} представлява потенциална продажба и съдържа съответните данни за продажбата, както и връзки към други важни данни като {{quotes_module}}, {{contacts_module}} и т. н.
