...
// BEGIN ENT/ULT
    ...
    'LBL_HELP_RECORD' => 'Модулът {{plural_module_name}} ви позволява да следите индивидуални продажби и позиции от линия, които принадлежат към тези продажби, от начало до край. Всеки запис {{module_name}} представлява перспективан продажба и включва съответни данни за продажбата както и връзка към други важни записи като {{quotes_module}}, {{contacts_module}} и др.
...
- Правете и разглеждайте потребителски коментари и записвайте хронология на промените в {{activitystream_singular_module}} като превключите долния ляв екран на „Поток на активност".
