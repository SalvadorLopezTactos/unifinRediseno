...
// BEGIN ENT/ULT
    ...
    'LBL_HELP_RECORD' => 'Модулът {{plural_module_name}} ви позволява да следите индивидуални продажби и елементите на линията, принадлежащи към тези продажби, от начало до край. Всеки запис на {{module_name}} представлява перспективна продажба и включва съответни данни за продажба, както и връзка към други важни записи, като {{quotes_module}}, {{contacts_module}} и др.

- Редактирайте полетата на този запис, като щракнете върху отделно поле или върху бутона „Редактиране“.
- Разглеждайте или модифицирайте връзки към други записи в подпанелите, като превключите долния ляв панел към „Изглед на данни“.
- Правете и разглеждайте потребителски коментари и хронология на промени в записи в {{activitystream_singular_module}}, като превключите долния ляв панел към „Поток на дейности“.
- Следвайте или отбележете като предпочитан този запис с помощта на иконите отдясно на името на записа.
