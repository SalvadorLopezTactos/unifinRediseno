...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} позволяет отслеживать отдельные продажи от начала до конца. Каждая запись {{module_name}} представляет предполагаемую продажу и включает соответствующие данные о продаже, а также данные, связанные с другими важными записями, такими как {{quotes_module}}, {{contacts_module}}, и т.д. Один {{module_name}} проходит через несколько Этапов продаж, пока он не будет помечен как «Закрытая состоявшаяся продажа» или «Закрыто без успеха». Модуль {{plural_module_name}} может использоваться еще шире, если использовать модуль Sugar {{forecasts_singular_module}} в целях понимания и прогнозирования тенденции продаж, а также фокусировки на работе по достижению квот продаж.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модуль {{plural_module_name}} позволяет отслеживать отдельные продажи и позиции, относящиеся к этим продажам, от начала до конца. Каждая запись {{module_name}} представляет собой потенциальную сделку и включает в себя соответствующие данные о продаже, а также данные, относящиеся к другим важным записям, таким как {{quotes_module}}, {{contacts_module}} и т. д.

- Для изменения полей этой записи щелкните отдельное поле или кнопку Редактировать.
- Просмотрите или измените ссылки на другие записи в подпанелях, переключив нижнюю левую панель в режим «Просмотр данных».
- Создавайте и просматривайте комментарии пользователей и записывайте историю изменений в {{activitystream_singular_module}}, переключая нижнюю левую панель в режим «Мероприятия».
- Подпишитесь на эту запись или добавьте ее в избранное, используя значки справа от названия записи.
- Дополнительные действия доступны в раскрывающемся меню действий справа от кнопки Редактировать.',
