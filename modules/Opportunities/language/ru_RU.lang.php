...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} позволяет отслеживать отдельные продажи от их начала и до самого конца. Каждая запись {{module_name}} представляет собой потенциальную сделку и содержит необходимые данные о продаже, а также данные, касающиеся других важных записей, таких как {{quotes_module}}, {{contacts_module}} и т. д. Модуль {{module_name}} обычно проходит несколько стадий продажи до тех пор, пока не приобретет статус "Выигранная продажа" или "Потерянная продажа". Пользу от применения модуля {{plural_module_name}} можно увеличить, используя модуль {{forecasts_singular_module}} системы Sugar для понимания и прогнозирования тенденций продаж и сосредоточения работы на достижении установленных квот.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модуль {{plural_module_name}} позволяет отслеживать отдельные продажи и относящиеся к ним продукты от их начала и до самого конца. Каждая запись {{module_name}} представляет собой потенциальную сделку и содержит необходимые данные о продаже, а также данные, касающиеся других важных записей, таких как {{quotes_module}}, {{contacts_module}} и т. д.

- Чтобы отредактировать поле записи, щелкните нужное поле или нажмите кнопку "Редактировать".
- Чтобы просмотреть или изменить ссылки на другие записи на субпанели, переключите левую нижнюю панель в режим "Просмотр данных".
- Чтобы оставить и просмотреть пользовательские комментарии или записать журнал изменений в {{activitystream_singular_module}}, переключите левую нижнюю панель в режим "Лента активности".
...
- Дополнительные возможности доступны в раскрывающемся меню "Действия" справа от кнопки "Редактировать".',
    ...
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} позволяет отслеживать отдельные продажи и относящиеся к ним продукты от их начала и до самого конца. Каждая запись {{module_name}} представляет собой потенциальную сделку и содержит необходимые данные о продаже, а также данные, касающиеся других важных записей, таких как {{quotes_module}}, {{contacts_module}} и т. д.

Чтобы создать {{module_name}}, выполните следующие действия:
