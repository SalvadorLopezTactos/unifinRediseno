...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחר מכירות בודדות מהתחלה ועד הסוף. כל רשומה של {{module_name}} מייצגת מכירה צפויה וכוללת מידע רלוונטי לגבי המכירה כמו גם לגבי רשומות חשובות אחרות כגון {{quotes_module}}‏, {{contacts_module}} וכו&#39;. לרוב, פריט {{module_name}} יעבור מספר שלבי מכירה עד שיסומן כ"נסגר בהצלחה" או "נסגר ואבד". ניתן למנף את {{plural_module_name}} אף יותר על ידי שימוש במודול {{forecasts_singular_module}} של Sugar כדי להבין ולחזות מגמות מכירה וכדי למקד את העבודה בהשגת מיכסות מכירה.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחר מכירות בודדות ופריטי שורה השייכים למכירות אלה מהתחלה ועד הסוף. כל רשומה של {{module_name}} מייצגת מכירה צפויה וכוללת מידע רלוונטי לגבי המכירה כמו גם לגבי רשומות חשובות אחרות כגון {{quotes_module}}‏, {{contacts_module}} וכו&#39;. 

- ערוך את השדות של רשומה זו על ידי לחיצה על שדה כלשהו או על כפתור &#39;ערוך&#39;.
- הצג או שנה קישורים לרשומות אחרות בלוחות המשנה על ידי החלפת המצב של החלונית השמאלית התחתונה ל&#39;תצוגת נתונים&#39;.
- צור והצג הערות משתמש ותעד את היסטוריית השינויים ב{{activitystream_singular_module}} על ידי החלפת המצב של החלונית השמאלית התחתונה ל&#39;זרם פעילות&#39;.
- עקוב אחר רשומה זו או הוסף אותה למועדפים באמצעות הסמלים מימין לשם הרשומה.
- פעולות נוספות זמינות בתפריט הנפתח &#39;פעולות&#39; מימין לכפתור &#39;ערוך&#39;.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'המודול {{plural_module_name}} מאפשר לך לעקוב אחר מכירות בודדות ופריטי שורה השייכים למכירות אלה מהתחלה ועד הסוף. כל רשומה של {{module_name}} מייצגת מכירה צפויה וכוללת מידע רלוונטי לגבי המכירה כמו גם לגבי רשומות חשובות אחרות כגון {{quotes_module}}‏, {{contacts_module}} וכו&#39;.

כדי ליצור {{module_name}}:
1. הזן ערכים בשדות, לפי הצורך.
 - חובה למלא שדות המסומנים כ&#39;נדרש&#39; בטרם שמירה.
 - לחץ על &#39;הצג עוד&#39; כדי לחשוף שדות נוספים, במידת הצורך.
2. לחץ על &#39;שמור&#39; כדי להשלים את יצירת הרשומה החדשה וחזור לדף הקודם.',
