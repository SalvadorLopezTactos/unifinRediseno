...
υπόδειγμά σας θα πρέπει να διαμορφωθεί για την αποστολή email μέσω του Admin > Email Settings για να είναι εφικτή η αποστολή ειδοποιήσεων.',
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Η ενότητα {{plural_module_name}} σάς δίνει τη δυνατότητα να παρακολουθείτε μεμονωμένες πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια πιθανή πώληση και συμπεριλαμβάνει δεδομένα σχετικά με την πώληση, καθώς και σχετικά με άλλες σημαντικές εγγραφές, όπως {{quotes_module}}, {{contacts_module}}, κλπ. Μια {{module_name}} συνήθως θα διέλθει μέσα από διάφορα στάδια πώλησης μέχρι που να χαρακτηριστεί είτες ως «Κλειστή, επιτεύχθηκε» ή «Κλειστή, απέτυχε». Η {{plural_module_name}} μπορεί να ενισχυθεί ακόμη περισσότερο με τη χρησιμοποίηση της ενότητας {{forecasts_singular_module}} του Sugar για να γίνουν κατανοητές και να προβλεφθούν οι τάσεις πωλήσεων, καθώς και για να επικεντρωθεί επιπλέον προσπάθεια στην επίτευξη ποσοστώσεων πωλήσεων.',
...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού Ενεργειών στα δεξιά του πλήκτρου Τροποποιήσεων.',
    ...
    'LBL_HELP_CREATE' => 'Η ενότητα {{plural_module_name}} σάς δίνει τη δυνατότητα να παρακολουθείτε τις μεμονωμένες πωλήσεις και τα στοιχεία γραμμής που ανήκουν στην εν λόγω πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια πώληση υποψήφιους και να περιλαμβάνει σχετική πώληση δεδομένα καθώς και σχετικά με άλλα σημαντικά αρχεία, όπως {{quotes_module}}, {{contacts_module}}, κλπ. 

Για να δημιουργήσετε μια {{module_name}}: 
1. Καταχωρήστε τις επιθυμητές τιμές των πεδίων. 
-Τα πεδία "Απαιτείται" πρέπει να συμπληρωθούν πριν από την αποθήκευση. 
-Κάντε κλικ στο κουμπί "Εμφάνιση περισσότερων» για να εμφανίσετε πρόσθετα πεδία εάν είναι απαραίτητο. 
