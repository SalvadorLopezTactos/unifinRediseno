...
$mod_strings = [
    ...
    'LBL_OPPORTUNITIES_MULTI_LINE_DASHBOARD' => 'Συρτάρι εστίασης ευκαιριών - Κονσόλα',
...
//END DON'T CONVERT
    ...
    'LBL_COMMIT_STAGE_FORECAST' => 'Στάδιο Πρόβλεψης',
    ...
    'LBL_SEE_DETAILS' => 'Προβολή Λεπτομερειών',
    'LBL_HIDE_NEW' => 'Απόκρυψη',
    ...
    'LBL_TOP_10_OPP' => 'Κορυφαίες 10 ανοιχτές ευκαιρίες',
    'LBL_DASHLET_MY_ACTIVE_OPP' => 'Πίνακας στοιχείων: Οι ενεργές ευκαιρίες μου',
    'LBL_MY_ACTIVE_OPP' => 'Οι ενεργές ευκαιρίες μου',
    ...
    'LBL_TAB_OPPORTUNITY' => '{{module}} Αναθεώρηση',
...
υπόδειγμά σας θα πρέπει να διαμορφωθεί για την αποστολή email μέσω του Admin > Email Settings για να είναι εφικτή η αποστολή ειδοποιήσεων.',
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Η ενότητα {{plural_module_name}} σάς επιτρέπει να παρακολουθείτε μεμονωμένες πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια μελλοντική πώληση και περιλαμβάνει σχετικά δεδομένα πώλησης, καθώς και σχετικά με άλλες σημαντικές εγγραφές, όπως {{quotes_module}}, {{contacts_module}} κ.λπ. Μια {{module_name}} θα προχωρήσει συνήθως σε διάφορα Στάδια πωλήσεων μέχρι να επισημανθεί είτε ως "Κλειστή κερδισμένη" είτε ως "Κλειστή χαμένη". Η {{plural_module_name}} μπορεί να αξιοποιηθεί ακόμη περισσότερο με τη χρήση της ενότητας {{forecasts_singular_module}}ing του Sugar για την κατανόηση και την πρόβλεψη των τάσεων των πωλήσεων, καθώς και την εστίαση των εργασιών για την επίτευξη ποσοστώσεων πωλήσεων.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Η ενότητα {{plural_module_name}} σάς επιτρέπει να παρακολουθείτε μεμονωμένες πωλήσεις και τα στοιχεία γραμμής που ανήκουν σε αυτές τις πωλήσεις από την αρχή ως το τέλος. Κάθε εγγραφή {{module_name}} αναπαριστά μια ενδεχόμενη πώληση και περιλαμβάνει σχετικά δεδομένα πωλήσεων, ενώ σχετίζεται και με άλλες σημαντικές εγγραφές όπως οι {{quotes_module}}, {{contacts_module}}, κ.λπ.

- Επεξεργαστείτε τα πεδία αυτής της εγγραφής κάνοντας κλικ σε ένα πεδίο ή στο κουμπί Επεξεργασία.
- Προβάλετε ή τροποποιήστε συνδέσμους προς άλλες εγγραφές στους υποπίνακες με μετάβαση του πίνακα κάτω αριστερά σε "Προβολή δεδομένων".
- Δημιουργήστε και προβάλετε σχόλια χρηστών και καταγράψτε ιστορικό αλλαγών στο {{activitystream_singular_module}} με μετάβαση του πίνακα κάτω αριστερά σε "Ροή δραστηριοτήτων".
- Ακολουθήστε ή ορίστε ως αγαπημένη αυτή την εγγραφή χρησιμοποιώντας τα εικονίδια στα δεξιά του ονόματος της εγγραφής.
- Πρόσθετες ενέργειες είναι διαθέσιμες στο πτυσσόμενο μενού Ενέργειες στα δεξιά του κουμπιού Επεξεργασία.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Η ενότητα {{plural_module_name}} σάς επιτρέπει να παρακολουθείτε μεμονωμένες πωλήσεις και τα στοιχεία γραμμής που ανήκουν σε αυτές τις πωλήσεις από την αρχή ως το τέλος. Κάθε εγγραφή {{module_name}} αναπαριστά μια ενδεχόμενη πώληση και περιλαμβάνει σχετικά δεδομένα πωλήσεων, ενώ σχετίζεται και με άλλες σημαντικές εγγραφές όπως οι {{quotes_module}}, {{contacts_module}}, κ.λπ.

Για να δημιουργήσετε μια ενότητα {{module_name}}:
1. Παρέχετε τιμές για τα πεδία, όπως επιθυμείτε.
 - Τα πεδία με επισήμανση "Απαιτείται" πρέπει να συμπληρωθούν πριν από την αποθήκευση.
 - Κάντε κλικ στην "Εμφάνιση περισσότερων" για να εκθέσετε πρόσθετα πεδία αν χρειαστεί.
2. Κάντε κλικ στην "Αποθήκευση" για να ολοκληρώσετε τη νέα εγγραφή και να επιστρέψετε στην προηγούμενη σελίδα.',
...
// END ENT/ULT
    ...
    'LBL_AI_WINRATE' => 'Ποσοστό κερδισμένων πωλήσεων',
    'LBL_AI_WONOPP' => 'Ευκαιρίες κερδισμένων πωλήσεων',
    'LBL_AI_CLOSINGTIME' => 'Ώρα κλεισίματος',
    'LBL_AI_CLOSEDOPP' => 'Κλειστές ευκαιρίες',
    'LBL_AI_LEADTIMESPAN' => 'Χρόνος μεταξύ δημιουργίας ευκαιριών και κλεισίματος κερδισμένων πωλήσεων',
];
