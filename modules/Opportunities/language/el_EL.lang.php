...
υπόδειγμά σας θα πρέπει να διαμορφωθεί για την αποστολή email μέσω του Admin > Email Settings για να είναι εφικτή η αποστολή ειδοποιήσεων.',
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Η μονάδα {{plural_module_name}} σας επιτρέπει να παρακολουθείτε ξεχωριστές πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια προοπτική πώλησης και περιλαμβάνει δεδομένα σχετικά με την πώληση καθώς και σχετικά με άλλα σημαντικά αρχεία όπως {{quotes_module}}, {{contacts_module}}, κλπ. Μία {{module_name}} συνήθως θα προχωρήσει μέσα από διάφορα στάδια πωλήσεων, έως ότου επισημανθεί είτε ως «Έκλεισε Κερδισμένη» είτε ως «Έκλεισε Χαμένη». Η {{plural_module_name}} μπορεί να ενισχυθεί ακόμη περισσότερο, χρησιμοποιώντας τη λειτουργική μονάδα {{forecasts_singular_module}}ing του Sugar για να κατανοήσετε και να προβλέψετε τάσεις πωλήσεων, και na επικεντρωθείτε στην επίτευξη ποσοστώσεων πωλήσεων.',
 ...
 - Τροποποιήστε τα πεδία της εγγραφής κάνοντας κλικ σε ένα ξεχωριστό πεδίο ή στο πλήκτρο Τροποποίηση. 
- Εμφανίστε ή τροποποιήστε συνδέσμους σε άλλα αρχεία στους υποπίνακες εναλλάσσοντας το κάτω αριστερό παράθυρο σε "Απεικόνιση Δεδομένων". 
- Αλληλεπιδράστε με τα σχόλια των χρηστών και καταγράψτε το ιστορικό αλλαγών των εγγραφών {{activitystream_singular_module}} μέσω εναλλαγής του κάτω αριστερού παραθύρου στο "Ροή Δραστηριοτήτων". 
- Ακολουθήστε ή δώστε την έγκρισή σας στη συγκεκριμένη εγγραφή χρησιμοποιώντας τα εικονίδια στα δεξιά του ονόματος της εγγραφής.
 - Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού "Ενέργειες", δεξιά από το κουμπί "Επεξεργασία".',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Η μονάδα {{plural_module_name}} σας επιτρέπει να παρακολουθείτε ξεχωριστές πωλήσεις από την αρχή μέχρι το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια προοπτική πώλησης και περιλαμβάνει δεδομένα σχετικά με την πώληση καθώς και σχετικά με άλλα σημαντικά αρχεία όπως {{quotes_module}}, {{contacts_module}}, κλπ.
