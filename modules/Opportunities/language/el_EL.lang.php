...
υπόδειγμά σας θα πρέπει να διαμορφωθεί για την αποστολή email μέσω του Admin > Email Settings για να είναι εφικτή η αποστολή ειδοποιήσεων.',
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Η ενότητα {{plural_module_name}} σάς επιτρέπει να παρακολουθείτε μεμονωμένες πωλήσεις από την αρχή ως το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια μελλοντική πώληση και περιλαμβάνει σχετικά δεδομένα πώλησης, καθώς και άλλα σημαντικά αρχεία, όπως τα {{quotes_module}}, {{contacts_module}} κ.λπ. Ένα {{module_name}} συνήθως εξελίσσεται μέσα από διάφορα Στάδια πωλήσεων μέχρι να επισημανθεί είτε ως "Κλειστό κερδισμένο" είτε ως "Κλειστό χαμένο". Το {{plural_module_name}} μπορεί να αξιοποιηθεί ακόμη περισσότερο, χρησιμοποιώντας την ενότητα {{forecasts_singular_module}} της Sugar για κατανόηση και πρόβλεψη των τάσεων των πωλήσεων, καθώς και επικέντρωση της εργασίας στην επίτευξη ποσοστώσεων πωλήσεων.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Η ενότητα {{plural_module_name}} σάς επιτρέπει να παρακολουθείτε μεμονωμένες πωλήσεις και τα αντικείμενα σειράς που ανήκουν σε αυτές τις πωλήσεις από την αρχή ως το τέλος. Κάθε εγγραφή {{module_name}} αναπαριστά μια μελλοντική πώληση και περιλαμβάνει σχετικά στοιχεία πωλήσεων, καθώς και δεδομένα σχετικά με άλλες σημαντικά αρχεία, όπως τα {{quotes_module}}, {{contacts_module}}, κ.λπ.

- Επεξεργαστείτε το πεδίο αυτής της εγγραφής, πατώντας σε ένα μεμονωμένο πεδίο ή στο κουμπί Επεξεργασία.
- Προβάλετε ή τροποποιήστε συνδέσμους προς άλλες εγγταφές στους υποπίνακες, με εναλλαγή του πίνακα κάτω αριστερά σε "Προβολή δεδομένων".
- Δημιουργήστε και προβάλετε σχόλια χρήστη και καταγράψτε ιστορικό αλλαγών στο {{activitystream_singular_module}}, με εναλλαγή του πίνακα κάτω αριστερά σε "Ροή δραστηριότητας".
- Ακολουθήστε ή προσθέστε στα αγαπημένα αυτή την εγγραφή, χρησιμοποιώντας τα εικονίδια στα δεξιά του ονόματα της εγγραφής.
- Πρόσθετες ενέργειες είναι διαθέσιμες στο πτυσσόμενο μενού Ενέργειες στα δεξιά του κουμπιού Επεξεργασία.',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Η ενότητα {{plural_module_name}} σάς επιτρέπει να παρακολουθείτε μεμονωμένες πωλήσεις και τα στοιχεία σειράς που ανήκουν σε αυτές τις πωλήσεις από την αρχή ως το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια μελλοντική πώληση και περιλαμβάνει δεδομένα πώλησης, καθώς και δεδομένα σχετικά με άλλα σημαντικά αρχεία, όπως τα {{quotes_module}}, {{contacts_module}}, κ.λπ. 

Για να δημιουργήσετε ένα {{module_name}}: 
1. Καταχωρίστε τιμές για τα πεδία, αναλόγα με τις προτιμήσεις σας. 
- Τα πεδία με σήμανση "Απαιτείται" πρέπει να συμπληρωθούν πριν από την αποθήκευση. 
