...
$mod_strings = [
    ...
    'LBL_DIALOUT_ON_DESC' => '사용자가 전화번호를 클릭하여 사용자의 기본 컴퓨터 전화 통합(CTI) 소프트웨어를 사용하여 전화를 걸 수 있습니다.',
    'LBL_DIALOUT_ON' => '클릭 투 콜 활성화',
    'LBL_DIALOUT_TITLE' => '발신 전화',
...
SugarPDF 지원 폰트:
<ul>
<li>TrueTypeUnicode (UTF-8 유니코드)</li>
...
<br>
PDF에 글꼴을 포함하지 않도록 선택하면 생성된 PDF 파일의 용량이 작아지지만 독자의 시스템에 해당 글꼴이 없는 경우 대체 글꼴이 사용됩니다.
<br><br>
SugarCRM에 PDF 글꼴을 추가하려면 <a href="http://www.tcpdf.org" target="_blank" rel="nofollow noopener noreferrer">TCPDF 웹사이트</a>의 "DOCS" 섹션에 있는 TCPDF 글꼴 문서의 1단계와 2단계를 따라야 합니다.
<br><br>pfm2afm 및 ttf2ufm 유틸리티는 <a href="http://www.tcpdf.org" target="_blank" rel="nofollow noopener noreferrer">TCPDF 웹사이트</a>의 "DOWNLOAD" 섹션에서 내려받을 수 있는 TCPDF 패키지의 fonts/utils에 있습니다.
<br><br>2단계에서 생성된 미터 파일과 아래의 귀하의 글꼴 파일을 불러오십시오.
BSOFR
    ,
...
// Password settings
    'ERR_MIN_LENGTH_GREATER_THAN_MAX' => '최대 길이는 최소 길이보다 길어야 합니다',
    'ERR_MIN_LENGTH_NEGATIVE' => '최소 길이는 양수여야 합니다',
    'ERR_MAX_LENGTH_NEGATIVE' => '최대 길이는 양수여야 합니다',
    ...
    'LBL_DOC_MERGE_REGION_CONFIG' => '문서 병합 영역 구성',
    'LBL_DOC_MERGE_REGION' => '지역',
];
