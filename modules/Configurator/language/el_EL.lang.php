...
$mod_strings = [
    ...
    'FREEZE_FIRST_COLUMN' => 'Να επιτρέπεται το πάγωμα στήλης',
    'FREEZE_FIRST_COLUMN_HELP' => 'Ενεργοποιήστε αυτήν τη ρύθμιση για να επιτρέψετε στους χρήστες να παγώσουν την πρώτη στήλη σε ' .
        'ποικιλία προβολών λίστας, συμπεριλαμβανομένων των προβολών λίστας λειτουργικών μονάδων, των υποπλαισίων, των dashlet και των κονσολών.',
    /*'EXPORT'=>'Export',
    ...
    'CURRENT_LOGO_DARK' => 'Λογότυπο Τρέχουσας Σκουρόχρωμης Λειτουργίας:',
    'CURRENT_LOGO_HELP' => 'Αυτό το λογότυπο εμφανίζεται στην αριστερή γωνία του υποσέλιδου της εφαρμογής Sugar.',
    'CURRENT_LOGO_DARK_HELP' => 'Αυτό το λογότυπο εμφανίζεται στην αριστερή γωνία του υποσέλιδου όταν η εφαρμογή Sugar βρίσκεται σε σκουρόχρωμη λειτουργία, σύμφωνα με τις προτιμήσεις εμφάνισης του χρήστη.',
    ...
    'NEW_LOGO_DARK' => 'Επιλέξτε Λογότυπο Σκουρόχρωμης Λειτουργίας:',
...
// Wizard
    ...
    'LBL_WIZARD_FINISH' => 'Πατήστε <b>Συνέχεια</b> να διαμορφώσετε τις ρυθμίσεις χρήστη σας.<br/><br />Για να διαμορφώσετε πρόσθετες ρυθμίσεις του συστήματος, πατήστε στην επιλογή <a href="#Administration" target="_blank">εδώ</a>.',
    ...
    'LBL_LOGO_DARK' => 'Λογότυπο Σκουρόχρωμης Λειτουργίας',
...
// Password settings
    ...
    'LBL_DOC_MERGE_REGION_CONFIG' => 'Διαμόρφωση περιοχής συγχώνευσης εγγράφων',
    'LBL_DOC_MERGE_REGION' => 'Περιοχή',
];
