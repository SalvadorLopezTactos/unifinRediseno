...
$mod_strings = [
    ...
    'LBL_DIALOUT_ON_DESC' => 'Käyttäjät voivat napsauttaa puhelinnumeroa tai soittaa siihen oletuksena käyttämällään CTI-ohjelmistolla.',
    'LBL_DIALOUT_ON' => 'Salli puhelunapin käyttö',
    'LBL_DIALOUT_TITLE' => 'Lähtevä puhelu',
...
SugarPDF:ssä tuetut kirjasimet:
<ul>
...
<br>
Jos et halua sisällyttää kirjasinta PDF-tiedostoon, luodun PDF-tiedoston koko on pienempi, mutta korvaava kirjasin otetaan käyttöön, jos kirjasinta ei ole saatavilla lukijasi järjestelmässä.
<br><br>
PDF-kirjasimen lisääminen SugarCRM-ohjelmaan edellyttää vaiheiden 1 ja 2 suorittamista TCPDF-kirjasimet-dokumentaatiossa, joka löytyy <a href="http://www.tcpdf.org" target="_blank" rel="nofollow noopener noreferrer">TCPDF-sivuston</a> "DOCS"-osiosta.
<br><br>pfm2afm- ja ttf2ufm- ohjelmat löytyvät TCPDF-paketin kohdasta fonts/utils. Ne voi ladata <a href="http://www.tcpdf.org" target="_blank" rel="nofollow noopener noreferrer">TCPDF-sivuston</a> "LATAA"-osiosta
<br><br>Lataa metriikkatiedosto, joka on luotu vaiheessa 2 sekä kirjasintiedosto (alla).
BSOFR
    ,
...
// Password settings
    'ERR_MIN_LENGTH_GREATER_THAN_MAX' => 'Enimmäispituuden pitää olla suurempi kuin vähimmäispituuden',
    'ERR_MIN_LENGTH_NEGATIVE' => 'Vähimmäispituuden pitää olla suurempi kuin 0',
    'ERR_MAX_LENGTH_NEGATIVE' => 'Enimmäispituuden pitää olla suurempi kuin 0',
    ...
    'LBL_DOC_MERGE_REGION_CONFIG' => 'Asiakirjan yhdistämisalueen määritys',
    'LBL_DOC_MERGE_REGION' => 'Alue',
];
