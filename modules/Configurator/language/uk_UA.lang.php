...
$mod_strings = [
    ...
    'FREEZE_FIRST_COLUMN' => 'Дозволити закріплення стовпців',
    'FREEZE_FIRST_COLUMN_HELP' => 'Увімкніть цей параметр, щоб дозволити користувачам закріплювати перший стовпець у різних ' .
        'подань списків, включно з поданням списків модулів, підпанелями, дашлетами й консолями.',
    /*'EXPORT'=>'Export',
    ...
    'LBL_DIALOUT_ON_DESC' => 'Дає користувачам можливість натискати на номери телефонів і телефонувати за ними, використовуючи стандартне програмне забезпечення для комп’ютерної телефонії (CTI).',
    'LBL_DIALOUT_ON' => 'Увімкнути функцію виклику одним натисканням',
    'LBL_DIALOUT_TITLE' => 'Вихідні виклики',
    ...
    'CURRENT_LOGO_DARK' => 'Поточний логотип темного режиму:',
    'CURRENT_LOGO_HELP' => 'Даний логотип відображається в лівому верхньому кутку додатка Sugar.',
    'CURRENT_LOGO_DARK_HELP' => 'Цей логотип відображається в лівому куті нижнього колонтитула, коли в додатку Sugar активовано темний режим відповідно до вибраних користувачем налаштувань оформлення.',
    ...
    'NEW_LOGO_DARK' => 'Виберіть логотип темного режиму:',
...
Шрифти, підтримувані у SugarPDF :
<ul>
...
<br>
Якщо ви не вбудуєте свій шрифт у PDF, створений файл PDF буде світлішим, проте буде використовуватися заміна, якщо шрифт недоступний у системі вашого пристрою зчитування.
<br><br>
Щоб додати шрифт PDF до SugarCRM, потрібно виконати кроки 1 і 2, вказані у документації «Шрифти TCPDF», доступній у розділі «ДОК-ТИ» на веб-сторінці <a href="http://www.tcpdf.org" target="_blank" rel="nofollow noopener noreferrer">TCPDF</a>.
<br><br>Утиліти pfm2afm та ttf2ufm доступні в шрифтах/утилітах у пакеті TCPDF, який можна завантажити у розділі «ЗАВАНТАЖИТИ» на веб-сторінці <a href="http://www.tcpdf.org" target="_blank" rel="nofollow noopener noreferrer">TCPDF</a>.
<br><br>Завантажте метричний файл, створений під час кроку 2, і файл зі шрифтом нижче.
BSOFR
    ,
...
// Wizard
    ...
    'LBL_WIZARD_FINISH' => 'Натисніть <b>Продовжити</b> для налаштування параметрів користувача.<br/><br /> Для налаштування додаткових параметрів системи натисніть <a href="#Administration" target="_blank">тут</a>.',
    ...
    'LBL_LOGO_DARK' => 'Логотип темного режиму',
...
// Password settings
    'ERR_MIN_LENGTH_GREATER_THAN_MAX' => 'Максимальна довжина має перевищувати мінімальну',
    'ERR_MIN_LENGTH_NEGATIVE' => 'Мінімальна довжина має бути додатною величиною',
    'ERR_MAX_LENGTH_NEGATIVE' => 'Максимальна довжина має бути додатною величиною',
    ...
    'LBL_DOC_MERGE_REGION_CONFIG' => 'Конфігурація регіону для процесу злиття документів',
    'LBL_DOC_MERGE_REGION' => 'Регіон',
];
