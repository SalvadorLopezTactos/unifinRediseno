...
$mod_strings = [
    ...
    'LBL_RECURRING_LIMIT_ERROR' => '반복되는 전화상담은 허용된 반복 $limit 제한을 초과하므로 예정될 수 없습니다.',
    'LBL_RECURRENCE' => '반복',
    ...
    'LBL_RSET' => 'R세트',
    'LBL_EVENT_TYPE' => '이벤트 유형',
    'LBL_ICAL_UID' => 'iCal UID',
    'LBL_ORIGINAL_DATE' => '반복되는 이벤트의 원래 시작일',
...
3. “저장하기”를 클릭하여 새 기록을 완성하고 이전 페이지로 돌아갑니다.',
    ...
    // Sugar Automate
    'LBL_IS_CUSTOMER_JOURNEY_ACTIVITY' => 'Smart Guide 통화입니다',
    'LBL_PARENT_CALL_OF_TASK_REL' => '하위 업무',
    'LBL_PARENT_CALL_OF_MEETING_REL' => '하위 회의',
    'LBL_PARENT_CALL_OF_CALL_REL' => '하위 통화',

    'TPL_ACTIVITY_TIMELINE_DASHLET' => '통화 타임라인',
];
