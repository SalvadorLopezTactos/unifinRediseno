...
$mod_strings = [
    // Dashboard Names
    'LBL_CALLS_LIST_DASHBOARD' => 'Информационная панель списка звонков',
    'LBL_CALLS_RECORD_DASHBOARD' => 'Информационная панель записей звонков',
    'LBL_CALLS_FOCUS_DRAWER_DASHBOARD' => 'Фокусная панель для звонков',
    ...
    'LBL_GUEST_CALLS' => 'Мои звонки в качестве гостя',
    'LBL_GUEST_SCHEDULED_CALLS' => 'Запланированные звонки в качестве гостя',
    'LBL_AVAILABLE_CALLS' => 'Доступные звонки',
    ...
    'LBL_CONNECT_CONTACT_ID' => 'Идентификатор контакта Amazon Connect',
    ...
    'LBL_RSET' => 'RSet',
    'LBL_EVENT_TYPE' => 'Тип события',
    'LBL_ICAL_UID' => 'iCal UID',
    'LBL_ORIGINAL_DATE' => 'Исходный день возникновения повторяющегося события',
...
3. Нажмите "Сохранить", чтобы завершить создание новой записи и вернуться на предыдущую страницу.',
    ...
    // Sugar Automate
    'LBL_IS_CUSTOMER_JOURNEY_ACTIVITY' => 'Является звонком умного руководства',
    'LBL_PARENT_CALL_OF_TASK_REL' => 'Дочерние задачи',
    'LBL_PARENT_CALL_OF_MEETING_REL' => 'Дочерние встречи',
    'LBL_PARENT_CALL_OF_CALL_REL' => 'Дочерние звонки',

    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Временная шкала звонка',
];
