...
$mod_strings = [
    ...
    'LBL_AVAILABLE_CALLS' => 'Διαθέσιμες κλήσεις',
    ...
    'LBL_RECURRING_LIMIT_ERROR' => 'Δεν είναι δυνατός ο προγραμματισμός αυτής της επαναλαμβανόμενης κλήσης, καθώς υπερβαίνει τη μέγιστη επιτρεπόμενη επανάληψη $limit.',
...
3. Κάντε κλικ στην επιλογή "Αποθήκευση" για να οριστικοποιήσετε τη νέα εγγραφή και να επιστρέψετε στην προηγούμενη σελίδα.',
    ...
    // Sugar Automate
    'LBL_IS_CUSTOMER_JOURNEY_ACTIVITY' => 'Είναι κλήση Smart Guide',
    'LBL_PARENT_CALL_OF_TASK_REL' => 'Θυγατρικές εργασίες',
    'LBL_PARENT_CALL_OF_MEETING_REL' => 'Θυγατρικές συναντήσεις',
    'LBL_PARENT_CALL_OF_CALL_REL' => 'Θυγατρικές κλήσεις',

    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Χρονολόγιο κλήσεων',
];
