...
$mod_strings = [
    ...
    'LNK_IMPORT_CALLS' => 'Importo thirrje',
    ...
    'LBL_ADD_BUTTON' => 'Shto',
    'LBL_DEFAULT_SUBPANEL_TITLE' => 'Thirrjet',
    'LBL_LOG_CALL' => 'Thirrje identifikuese',
    ...
    'LBL_AVAILABLE_CALLS' => 'Telefonatat e disponueshme',
    ...
    'LBL_NO_ACCESS' => 'Nuk ke qasje për të krijuar $module',
    ...
    'LBL_CALENDAR_RECURRENCE_ID' => 'ID-ja e përsëritjes së thirrjes. Data fillimit të thirrjes fillestare',
    ...
    'LBL_RECURRING_LIMIT_ERROR' => 'Thirrja e përsëritur nuk mund të programohet pasi tejkalon përsëritjen maksimale të lejuar të $limit.',
    ...
    'LBL_CREATE_MODULE' => 'Thirrje identifikuese',
    ...
    'LBL_RSET' => 'RSet',
    'LBL_EVENT_TYPE' => 'Lloji i ngjarjes',
    'LBL_ICAL_UID' => 'UID iCal',
    'LBL_ORIGINAL_DATE' => 'Dita fillestare e fillimit të ngjarjes së përsëritur',
...
3. Kliko "Ruaj" për të finalizuar regjistrimin e ri dhe për t&#39;u kthyer në faqen e mëparshme.',
    ...
    // Sugar Automate
    'LBL_IS_CUSTOMER_JOURNEY_ACTIVITY' => 'Është telefonatë e udhëzuesit inteligjent',
    'LBL_PARENT_CALL_OF_TASK_REL' => 'Detyrat për fëmijë',
    'LBL_PARENT_CALL_OF_MEETING_REL' => 'Mbledhjet për fëmijë',
    'LBL_PARENT_CALL_OF_CALL_REL' => 'Telefonatat për fëmijë',

    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Vija kohore e telefonatës',
];
