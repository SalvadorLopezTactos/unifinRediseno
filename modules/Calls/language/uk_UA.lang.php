...
$mod_strings = [
    ...
    'LBL_AVAILABLE_CALLS' => 'Доступні дзвінки',
    ...
    'LBL_CALENDAR_RECURRENCE_ID' => 'ID повторення дзвінка. Дата першого дзвінка',
    ...
    'LBL_RSET' => 'RSet',
    'LBL_EVENT_TYPE' => 'Тип події',
    'LBL_ICAL_UID' => 'UID (унікальний ІД) iCal',
    'LBL_ORIGINAL_DATE' => 'Початковий день виникнення повторюваної події',
    ...
    // Help Text
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} складається із дзвінків, які можуть перебувати в статусі "Запланований", "Відбувся" або "Скасований". Дати майбутніх дзвінків, запланованих на наступні 24 години, позначені синім. Дати прострочених дзвінків позначені червоним.

 За допомогою подання списку {{plural_module_name}} можна переглядати та редагувати інформацію про дзвінки. Додаткові дії доступні в меню в кінці рядка кожного дзвінка. Виберіть "Закрити" в меню в рядку будь-якого запланованого дзвінка, щоб змінити його статус на "Відбувся".

Користувачів Sugar, Контакти та Попередні контакти можна додати як запрошених. {{plural_module_name}} можна створити за допомогою модуля {{plural_module_name}}, модуля Календар, імпорту, а також через субпанель активностей (для модулів попередніх версій) або через інформаційну панель Заплановані активності (для модулів Sidecar) на сторінках пов&#39;язаних записів модуля (наприклад, Контакти, Контрагенти і т.д.), який автоматично створює зв&#39;язок між обома записами.',
...
3. Натисніть "Зберегти", щоб завершити створення нового запису й повернутися до попередньої сторінки.',
    ...
    // Sugar Automate
    'LBL_IS_CUSTOMER_JOURNEY_ACTIVITY' => 'Є викликом Smart Guide',
    'LBL_PARENT_CALL_OF_TASK_REL' => 'Дочірні завдання',
    'LBL_PARENT_CALL_OF_MEETING_REL' => 'Дочірні зустрічі',
    'LBL_PARENT_CALL_OF_CALL_REL' => 'Дочірні виклики',

    'TPL_ACTIVITY_TIMELINE_DASHLET' => 'Часова шкала дзвінків',
];
