...
$mod_strings = [
    ...
    'LBL_PIPELINE_CONFIG_NO_DATA' => 'Ingen data tillgänglig. Välj minst en modul från panelen ovan!',
    ...
    'LBL_PIPELINE_RECORDS_PER_COLUMN' => 'Plattor som visas per kolumn',
    'LBL_PIPELINE_CONFIG_UPDATED' => 'Pipeline-konfiguration uppdaterad',
    'LBL_PIPELINE_CONFIG_FAILED_UPDATE' => 'Misslyckades uppdatera pipeline-konfiguration',
    'LBL_PIPELINE_TILE_PREVIEW' => 'Bricka förhandsvisning',
    'LBL_PIPELINE_HEADER_VALUES' => 'Dra och släpp för att ange tillgängliga kolumner och deras ordning',
    'LBL_PIPELINE_HEADER_AVAILABLE_VALUES' => 'Tillgängliga värden',
    'LBL_PIPELINE_HEADER_HIDDEN_VALUES' => 'Dolda värden',
    'LBL_PIPELINE_COLUMN_COLOR' => 'Kolumnfärger',
