...
$mod_strings = [
    ...
    'LBL_PIPELINE_CONFIG_NO_DATA' => 'Δεν υπάρχουν διαθέσιμα δεδομένα. Επιλέξτε τουλάχιστον μία ενότητα από τον πίνακα παραπάνω!',
    ...
    'LBL_PIPELINE_RECORDS_PER_COLUMN' => 'Πλακάκια που εμφανίζονται ανά στήλη',
    'LBL_PIPELINE_CONFIG_UPDATED' => 'Ενημερώθηκε το config της διαδρομής',
    'LBL_PIPELINE_CONFIG_FAILED_UPDATE' => 'Αποτυχία ενημέρωσης του config της διαδρομής',
    'LBL_PIPELINE_TILE_PREVIEW' => 'Προιεπισκόπιση πλακιδίου',
    'LBL_PIPELINE_HEADER_VALUES' => 'Μεταφέρετε και αποθέστε για να ορίσετε τις διαθέσιμες στήλες και τη σειρά τους',
    'LBL_PIPELINE_HEADER_AVAILABLE_VALUES' => 'Διαθέσιμες τιμές',
    'LBL_PIPELINE_HEADER_HIDDEN_VALUES' => 'Κρυμμένες τιμές',
    'LBL_PIPELINE_COLUMN_COLOR' => 'Χρώματα στήλης',
