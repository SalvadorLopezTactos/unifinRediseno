...
$mod_strings = [
    ...
    'LBL_PIPELINE_CONFIG_NO_DATA' => 'Mevcut veri yok. Lütfen yukarıdaki panelden en az bir modül seçin!',
    ...
    'LBL_PIPELINE_RECORDS_PER_COLUMN' => 'Sütun başına görüntülenen pencereler',
    'LBL_PIPELINE_CONFIG_UPDATED' => 'Satış olasılığı yapılandırması güncellendi',
    'LBL_PIPELINE_CONFIG_FAILED_UPDATE' => 'Sayış olasılığı yapılandırması güncellenemedi',
    'LBL_PIPELINE_TILE_PREVIEW' => 'Kutucuk Önizleme',
    'LBL_PIPELINE_HEADER_VALUES' => 'Kullanılabilir sütunları ve bunların sırasını belirlemek için sürükleyip bırakın',
    'LBL_PIPELINE_HEADER_AVAILABLE_VALUES' => 'Mevcut Değerler',
    'LBL_PIPELINE_HEADER_HIDDEN_VALUES' => 'Gizli Değerler',
    'LBL_PIPELINE_COLUMN_COLOR' => 'Kolon Renkleri',
