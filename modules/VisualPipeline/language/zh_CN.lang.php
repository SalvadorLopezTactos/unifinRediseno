...
$mod_strings = [
    ...
    'LBL_PIPELINE_CONFIG_NO_DATA' => '无可用数据。请从以上面板中至少选择一个模块！',
    ...
    'LBL_PIPELINE_RECORDS_PER_COLUMN' => '每列显示的平铺',
    'LBL_PIPELINE_CONFIG_UPDATED' => '管道配置已更新',
    'LBL_PIPELINE_CONFIG_FAILED_UPDATE' => '未能更新管道配置',
    'LBL_PIPELINE_TILE_PREVIEW' => '平铺预览',
    'LBL_PIPELINE_HEADER_VALUES' => '拖放以设置可用列及其顺序',
    'LBL_PIPELINE_HEADER_AVAILABLE_VALUES' => '可用值',
    'LBL_PIPELINE_HEADER_HIDDEN_VALUES' => '隐藏值',
    'LBL_PIPELINE_COLUMN_COLOR' => '列的颜色',
