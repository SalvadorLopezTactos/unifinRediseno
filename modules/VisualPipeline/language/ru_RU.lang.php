...
$mod_strings = [
    ...
    'LBL_PIPELINE_CONFIG_NO_DATA' => 'Нет доступных данных. Выберите хотя бы один модуль на панели сверху.',
    ...
    'LBL_PIPELINE_RECORDS_PER_COLUMN' => 'Отображаемые в столбце плитки',
    'LBL_PIPELINE_CONFIG_UPDATED' => 'Конфигурация воронки продаж обновлена',
    'LBL_PIPELINE_CONFIG_FAILED_UPDATE' => 'Ошибка при обновлении конфигурации воронки продаж',
    'LBL_PIPELINE_TILE_PREVIEW' => 'Предварительный просмотр мозаики',
    'LBL_PIPELINE_HEADER_VALUES' => 'Перетащите, чтобы задать доступные столбцы и их порядок',
    'LBL_PIPELINE_HEADER_AVAILABLE_VALUES' => 'Доступные значения',
    'LBL_PIPELINE_HEADER_HIDDEN_VALUES' => 'Скрытые значения',
    'LBL_PIPELINE_COLUMN_COLOR' => 'Цвета столбцов',
