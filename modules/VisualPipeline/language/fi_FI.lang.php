...
$mod_strings = [
    ...
    'LBL_PIPELINE_CONFIG_NO_DATA' => 'Tietoa ei saatavilla. Valitse yllä olevasta paneelista vähintään yksi moduuli.',
    ...
    'LBL_PIPELINE_RECORDS_PER_COLUMN' => 'Näytetyt ruudut sarakekohtaisesti',
    'LBL_PIPELINE_CONFIG_UPDATED' => 'Myyntikanavan konfiguraatio päivitetty',
    'LBL_PIPELINE_CONFIG_FAILED_UPDATE' => 'Myyntikanavan konfiguraation päivitys ei onnistunut',
    'LBL_PIPELINE_TILE_PREVIEW' => 'Ruudun esikatselu',
    'LBL_PIPELINE_HEADER_VALUES' => 'Määritä käytettävissä olevat sarakkeet ja niiden järjestys vetämällä ja pudottamalla',
    'LBL_PIPELINE_HEADER_AVAILABLE_VALUES' => 'Käytettävissä olevat arvot',
    'LBL_PIPELINE_HEADER_HIDDEN_VALUES' => 'Piilotetut arvot',
    'LBL_PIPELINE_COLUMN_COLOR' => 'Sarakkeen värit',
