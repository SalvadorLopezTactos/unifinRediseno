...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Укажите, каким образом маркировать {{forecastByModule}}. <br><br>Обратите внимание, что после первой маркировки нельзя изменять настройки диапазона. Для обновленных версий настройки диапазона блокируются вместе с имеющимися данными прогноза.<br><br>Можно выбрать две или несколько категорий на основе диапазонов вероятности или создать категории, которые не базируются на вероятности. <br><br>Слева от пользовательских категорий имеются флажки. Установите их возле диапазонов, которые нужно включить в прогноз относительно использованной суммы и отправить руководителям. <br><br>Пользователь может вручную изменить статус включения/исключения и категорию {{forecastByModule}} со своего листа.',
