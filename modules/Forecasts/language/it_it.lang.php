...
$mod_strings = [
    ...
    'LBL_FORECASTS_RECORD_DASHBOARD' => 'Dashboard record previsioni',
    ...
    'LBL_METRIC_LABEL_QUOTA' => 'Quote',
    'LBL_METRIC_LABEL_COMMITMENT' => 'Impegno',
    'LBL_METRIC_LABEL_QUOTA_COVERAGE' => 'Copertura del budget',
    'LBL_METRIC_LABEL_GAP_QUOTA' => 'Divario rispetto al budget',
    'LBL_METRIC_LABEL_PCT_WON_QUOTA' => '% vinta del budget',
    'LBL_METRIC_LABEL_QUOTA_GAP_COVERAGE' => 'Copertura del divario rispetto al budget',
    'LBL_METRIC_LABEL_COMMITMENT_COVERAGE' => 'Copertura degli impegni',
    'LBL_METRIC_LABEL_GAP_COMMITMENT' => 'Divario rispetto agli impegni',
    'LBL_METRIC_LABEL_COMMITMENT_GAP_COVERAGE' => 'Copertura del divario rispetto agli impegni',
    'LBL_METRIC_LABEL_PCT_WON_COMMITMENT' => '% vinta degli impegni',
    'LBL_METRIC_LABEL_FORECAST_COVERAGE' => 'Copertura delle previsioni',
    'LBL_METRIC_LABEL_GAP_FORECAST' => 'Divario rispetto alla previsione',
    'LBL_METRIC_LABEL_FORECAST_GAP_COVERAGE' => 'Copertura del divario rispetto alla previsione',
    'LBL_METRIC_LABEL_PCT_WON_FORECAST' => '% vinta della previsione',
    ...
    'LBL_METRIC_HELP_QUOTA' => 'Budget',
    'LBL_METRIC_HELP_COMMITMENT' => 'Impegno probabile',
    'LBL_METRIC_HELP_QUOTA_COVERAGE' => '(Pipeline + Vinto + Perso)/Budget',
    'LBL_METRIC_HELP_GAP_QUOTA' => 'Budget – Vinto',
    'LBL_METRIC_HELP_PCT_WON_QUOTA' => 'Vinto/Budget',
    'LBL_METRIC_HELP_QUOTA_GAP_COVERAGE' => 'Pipeline/Divario rispetto al budget',
    'LBL_METRIC_HELP_COMMITMENT_COVERAGE' => '(Pipeline + Vinto + Perso)/Impegni',
    'LBL_METRIC_HELP_GAP_COMMITMENT' => 'Impegno probabile - Vinti',
    'LBL_METRIC_HELP_COMMITMENT_GAP_COVERAGE' => 'Pipeline / Divario rispetto al probabile impegno',
    'LBL_METRIC_HELP_PCT_WON_COMMITMENT' => 'Vinto/Impegno probabile',
    'LBL_METRIC_HELP_FORECAST_COVERAGE' => '(Pipeline + Vinto + Perso)/Previsione',
    'LBL_METRIC_HELP_GAP_FORECAST' => 'Previsione – Vinto (pipeline inclusa)',
    'LBL_METRIC_HELP_FORECAST_GAP_COVERAGE' => 'Pipeline/Divario rispetto alla previsione',
    'LBL_METRIC_HELP_PCT_WON_FORECAST' => 'Vinto/In previsione',
    ...
    'LBL_GRAPH_QUOTA_ALTTEXT' => 'Budget per %s',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configurare la modalità di categorizzazione {{forecastByModule}}. <br><br>Si noti che le impostazioni dell&#39;intervallo non possono essere modificate dopo il primo impegno. Per le istanze aggiornate, l&#39;impostazione Intervallo è bloccata con i dati di previsione esistenti.<br><br>È possibile selezionare due o più categorie in base agli intervalli di probabilità oppure creare delle categorie non basate sulla probabilità. <br><br>A sinistra delle categorie personalizzate sono presenti delle caselle di spunta; utilizzarle per decidere quali intervalli saranno inclusi nell&#39;importo della previsione impegnato e segnalato ai dirigenti. <br><br>Un utente può modificare lo stato di inclusione/esclusione e la categoria di {{forecastByModule}} manualmente dal foglio di lavoro.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_NAME' => 'Metriche della pipeline',
    'LBL_PIPELINE_METRICS_DASHLET_DESC' => 'Visualizza i dettagli delle metriche della pipeline',
    'LBL_PIPELINE_METRICS_DASHLET_METRICS_GUIDE' => 'Guida alle metriche della pipeline',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS' => 'Metriche di visualizzazione',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_GUIDE' => 'Guida alle metriche',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_REQUIRED' => 'È necessario selezionare almeno una metrica da visualizzare nelle schede delle metriche',
