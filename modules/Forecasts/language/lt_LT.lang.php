...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Sukonfigūruokite, kaip norite suskirstyti {{forecastByModule}}. <br><br>Atminkite, kad intervalo parametrų po pirmojo užfiksavimo keisti negalima. Atnaujintų egzempliorių atveju intervalo parametras yra užrakintas, kai naudojami esami prognozės duomenys.<br><br>Galite pasirinkti dvi arba daugiau kategorijų pagal tikimybės intervalus arba kurti nepagrįstas tikimybe kategorijas. <br><br>Kairėje pasirinktinių kategorijų pusėje yra žymimieji langeliai; naudokite juos, norėdami nurodyti, kurie intervalai turi būti įtraukti į užfiksuotą prognozės sumą ir pateikti vadovams. <br><br>Vartotojas savo darbalapyje gali pats keisti būseną „Įtraukti / neįtraukti“ ir {{forecastByModule}} kategoriją.',
