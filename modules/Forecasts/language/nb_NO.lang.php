...
$mod_strings = [
    ...
    'LBL_TAB_COMMITMENT' => 'Forpliktelse',
    'LBL_CURRENT' => 'Nåværende',
    ...
    // API message labels
    'LBL_METRICS_API_NO_ACCESS' => 'Tilgang til statistikk-API krever Sugar Sell Premier',
    ...
    'LBL_FDR_FORECAST_HEADER' => 'Selgerprognose for <span class="sicon sicon-user mx-1"></span> {{name}}',
    ...
    //list view metrics
    'LBL_INCLUDED_PIPELINE' => 'Inkludert salgstrakt',
    'LBL_UPSIDE_PIPELINE' => 'Oppsidesalgstrakt',
    'LBL_EXCLUDED_PIPELINE' => 'Ekskludert salgstrakt',
    'LBL_WON' => 'Vunnet',
    'LBL_LOST' => 'Tapt',
    'LBL_ALL' => 'Alle',

    'LBL_METRIC_LABEL_QUOTA' => 'Kvote',
    'LBL_METRIC_LABEL_COMMITMENT' => 'Forpliktelse',
    'LBL_METRIC_LABEL_QUOTA_COVERAGE' => 'Kvotedekning',
    'LBL_METRIC_LABEL_GAP_QUOTA' => 'Gap til kvote',
    'LBL_METRIC_LABEL_PCT_WON_QUOTA' => '% vunnet av kvote',
    'LBL_METRIC_LABEL_QUOTA_GAP_COVERAGE' => 'Kvotegapdekning',
    'LBL_METRIC_LABEL_COMMITMENT_COVERAGE' => 'Forpliktelsesdekning',
    'LBL_METRIC_LABEL_GAP_COMMITMENT' => 'Gapforpliktelse',
    'LBL_METRIC_LABEL_COMMITMENT_GAP_COVERAGE' => 'Forpliktelsesgapdekning',
    'LBL_METRIC_LABEL_PCT_WON_COMMITMENT' => '% vunnet av forpliktelse',
    'LBL_METRIC_LABEL_FORECAST_COVERAGE' => 'Prognosedekning',
    'LBL_METRIC_LABEL_GAP_FORECAST' => 'Gap til prognose',
    'LBL_METRIC_LABEL_FORECAST_GAP_COVERAGE' => 'Prognosegapdekning',
    'LBL_METRIC_LABEL_PCT_WON_FORECAST' => '% vunnet av prognose',

    // Guide to Filters
    'LBL_FILTER_GUIDE_TITLE' => 'Guide til filtre',
    'LBL_HELP_MAIN_BODY' => 'Alle beregninger inkluderer bare muligheter som tilhører valgte bruker(e), tidsperiode og eventuelle tilleggsfiltre du har brukt',
    'LBL_FORECAST_HELP' => 'Muligheter som allerede er vunnet eller er i en inkludert {{{forecastStage}}}',
    'LBL_INCLUDED_PIPELINE_HELP' => 'Åpne muligheter med en {{{forecastStage}}} på {{{commitStageValue}}}',
    'LBL_INCLUDED_PIPELINE_HELP_CUSTOM_RANGE' => 'Åpne muligheter i en inkludert {{{forecastStage}}}',
    'LBL_UPSIDE_PIPELINE_HELP' => 'Åpne muligheter med en {{{forecastStage}}} på {{{commitStageValue}}}',
    'LBL_EXCLUDED_PIPELINE_HELP' => 'Åpne muligheter med en {{{forecastStage}}} på {{{commitStageValue}}}',
    'LBL_EXCLUDED_PIPELINE_HELP_CUSTOM_RANGE' => 'Åpne muligheter i en ekskludert {{{forecastStage}}}',
    'LBL_WON_HELP' => 'Muligheter som allerede er vunnet',
    'LBL_LOST_HELP' => 'Muligheter som allerede har gått tapt',
    'LBL_ALL_HELP' => 'Alle muligheter',

    'LBL_METRIC_HELP_QUOTA' => 'Kvote',
    'LBL_METRIC_HELP_COMMITMENT' => 'Sannsynlig forpliktelse',
    'LBL_METRIC_HELP_QUOTA_COVERAGE' => '(Pipeline + vunnet + tapt)/kvote',
    'LBL_METRIC_HELP_GAP_QUOTA' => 'Kvote – vunnet',
    'LBL_METRIC_HELP_PCT_WON_QUOTA' => 'Vunnet/kvote',
    'LBL_METRIC_HELP_QUOTA_GAP_COVERAGE' => 'Rørledning / gap til kvote',
    'LBL_METRIC_HELP_COMMITMENT_COVERAGE' => '(Pipeline + vunnet + tapt)/forpliktelse',
    'LBL_METRIC_HELP_GAP_COMMITMENT' => 'Sannsynlig forpliktelse - vunnet',
    'LBL_METRIC_HELP_COMMITMENT_GAP_COVERAGE' => 'Pipeline / gap til sannsynlig forpliktelse',
    'LBL_METRIC_HELP_PCT_WON_COMMITMENT' => 'Vunnet/sannsynlig forpliktelse',
    'LBL_METRIC_HELP_FORECAST_COVERAGE' => '(Pipeline + vunnet + tapt)/prognose',
    'LBL_METRIC_HELP_GAP_FORECAST' => 'Prognose – vunnet (inkludert pipeline)',
    'LBL_METRIC_HELP_FORECAST_GAP_COVERAGE' => 'Rørledning / gap til prognose',
    'LBL_METRIC_HELP_PCT_WON_FORECAST' => 'Vunnet/prognose',
    ...
    'LBL_COMMITMENT' => 'Forpliktelse',
    'LBL_TEAM_COMMITMENT' => 'Teamforpliktelse',
    'LBL_FORECASTED' => 'Prognostisert',
    'LBL_OPPORTUNITY_FORECAST' => 'Mulighetsprognose',
    'LBL_REVENUELINEITEM_FORECAST' => 'Prognose for inntektslinjeelement',
    'LBL_LAST_COMMITMENT' => 'Siste forpliktelse',
    'LBL_ADJUSTED_TOTAL' => 'Justert total',
    ...
    'LBL_COMMITTED_HISTORY_LIKELY_CHANGED' => 'Forpliktet (trolig) {{{direction}}} {{{from}}} til {{{to}}}',
    'LBL_COMMITTED_HISTORY_BEST_CHANGED' => 'Forpliktet (best) {{{direction}}} {{{from}}} til {{{to}}}',
    'LBL_COMMITTED_HISTORY_WORST_CHANGED' => 'Forpliktet (verst) {{{direction}}} {{{from}}} til {{{to}}}',
    'LBL_COMMITTED_HISTORY_LIKELY_SAME' => 'Forpliktet (trolig) forble det samme',
    'LBL_COMMITTED_HISTORY_BEST_SAME' => 'Forpliktet (Best) forble det samme',
    'LBL_COMMITTED_HISTORY_WORST_SAME' => 'Forpliktet (Verst) forble det samme',
    ...
    'LBL_SAVE_DRAFT' => 'Lagre',
    'LBL_CHANGES_BY' => 'Endringer ved {0}',
    'LBL_FORECAST_SETTINGS' => 'Prognoseinnstillinger',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurer hvordan du vil kategorisere {{forecastByModule}}. <br><br>Vær oppmerksom på at områdeinnstillingene ikke kan endres etter første lagring. For oppgraderte forekomster er Område-innstillingen låst sammen med eksisterende prognosedata.<br><br>Du kan velge to eller flere kategorier basert på sannsynlighetsområder eller opprette kategorier som ikke er basert på sannsynlighet. <br><br>Det finnes avmerkingsbokser til venstre for dine egendefinerte kategorier; Bruk disse til å bestemme hvilke områder som skal inkluderes i prognosebeløpet som er forpliktet og rapportert til ledere. <br><br>En bruker kan endre inkludere/ekskludere status og kategori for {{forecastByModule}} manuelt fra regnearket.',
    ...
    'LBL_OPEN_LIKELY' => 'Åpne sannsynlig',
    'LBL_OPEN_BEST' => 'Åpne beste',
    'LBL_OPEN_WORST' => 'Åpne verste',

    // Pipeline Metrics dashlet
    'LBL_PIPELINE_METRICS_DASHLET_NAME' => 'Pipelinemetrikk',
    'LBL_PIPELINE_METRICS_DASHLET_DESC' => 'Vis detaljer om pipelineberegninger',
    'LBL_PIPELINE_METRICS_DASHLET_METRICS_GUIDE' => 'Pipelinemetrikkveiledning',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS' => 'Skjermmetrikk',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_GUIDE' => 'Veiledning for beregninger',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_REQUIRED' => 'Må velge minst én beregning som skal vises på beregningsfaner',
    ...
    'LBL_SAVE_TOOLTIP' => 'Lagre endringer utført i regnearkspalter',
    'LBL_COMMIT_TOOLTIP_REP' => 'Lagre endringer hos oppføringer og send prognose til lederen',
    'LBL_COMMIT_TOOLTIP_MGR' => 'Send prognose til lederen og tildel kvote',

    'LBL_SAVE_LABEL_REP' => 'Lagre ',
    'LBL_SAVE_LABEL_MGR' => 'Lagre justerte verdier',
