...
$mod_strings = [
    ...
    'LBL_FORECASTS_RECORD_DASHBOARD' => 'Dashboard Voorspellingenrecord',
    ...
    'LBL_METRIC_LABEL_QUOTA_COVERAGE' => 'Quotadekking',
    'LBL_METRIC_LABEL_GAP_QUOTA' => 'Gat naar quota',
    'LBL_METRIC_LABEL_PCT_WON_QUOTA' => '% Quota gewonnen',
    'LBL_METRIC_LABEL_QUOTA_GAP_COVERAGE' => 'Gat quotadekking',
    'LBL_METRIC_LABEL_COMMITMENT_COVERAGE' => 'Dekking commitment',
    'LBL_METRIC_LABEL_GAP_COMMITMENT' => 'Gat naar commitment',
    'LBL_METRIC_LABEL_COMMITMENT_GAP_COVERAGE' => 'Dekking gat commitment',
    'LBL_METRIC_LABEL_PCT_WON_COMMITMENT' => '% Gewonnen van commitment',
    'LBL_METRIC_LABEL_FORECAST_COVERAGE' => 'Dekking prognose',
    'LBL_METRIC_LABEL_GAP_FORECAST' => 'Gat naar prognose',
    'LBL_METRIC_LABEL_FORECAST_GAP_COVERAGE' => 'Dekking gat prognose',
    'LBL_METRIC_LABEL_PCT_WON_FORECAST' => '% Gewonnen van prognose',
    ...
    'LBL_METRIC_HELP_COMMITMENT' => 'Waarschijnlijke commitment',
    'LBL_METRIC_HELP_QUOTA_COVERAGE' => '(Pijplijn + gewonnen + verloren)/quotum',
    'LBL_METRIC_HELP_GAP_QUOTA' => 'Quotum – Gewonnen',
    'LBL_METRIC_HELP_PCT_WON_QUOTA' => 'Gewonnen/quotum',
    'LBL_METRIC_HELP_QUOTA_GAP_COVERAGE' => 'Pijplijn / Gap to Quota',
    'LBL_METRIC_HELP_COMMITMENT_COVERAGE' => '(Pijplijn + gewonnen + verloren)/commitment',
    'LBL_METRIC_HELP_GAP_COMMITMENT' => 'Waarschijnlijke commitment - Gewonnen',
    'LBL_METRIC_HELP_COMMITMENT_GAP_COVERAGE' => 'Pijplijn / gat naar waarschijnlijke commitment',
    'LBL_METRIC_HELP_PCT_WON_COMMITMENT' => 'Gewonnen/waarschijnlijke commitment',
    'LBL_METRIC_HELP_FORECAST_COVERAGE' => '(Pijplijn + gewonnen + verloren)/prognose',
    'LBL_METRIC_HELP_GAP_FORECAST' => 'Prognose – Gewonnen (inclusief pijplijn)',
    'LBL_METRIC_HELP_FORECAST_GAP_COVERAGE' => 'Pijplijn / Gat naar prognose',
    'LBL_METRIC_HELP_PCT_WON_FORECAST' => 'Gewonnen/prognose',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configureer hoe u {{forecastByModule}} wilt categoriseren. <br><br>Houd er rekening mee dat de bereikinstellingen niet kunnen worden gewijzigd na de eerste bevestiging Voor geüpgradede exemplaren wordt de instelling Bereik vergrendeld met bestaande prognosegegevens.<br><br>U kunt twee of meer categorieën selecteren op basis van waarschijnlijkheidsbereik of categorieën maken die niet op waarschijnlijkheid zijn gebaseerd. <br><br>Er zijn selectievakjes aan de linkerkant van uw aangepaste categorieën; gebruik deze om te bepalen welke bereik wordt opgenomen in het geschatte bedrag dat is vastgelegd en dat wordt gerapporteerd aan managers. <br><br>Een gebruiker kan de status en de categorie {{forecastByModule}} handmatig insluiten/uitsluiten vanaf het werkblad.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_NAME' => 'Pijplijnstatistieken',
    'LBL_PIPELINE_METRICS_DASHLET_DESC' => 'Details pijplijnstatistieken weergeven',
    'LBL_PIPELINE_METRICS_DASHLET_METRICS_GUIDE' => 'Gids pijplijnstatistieken',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS' => 'Statistieken weergeven',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_GUIDE' => 'Gids over statistieken',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_REQUIRED' => 'U moet tenminste één statistiek selecteren om weer te geven op metrische tabbladen',
