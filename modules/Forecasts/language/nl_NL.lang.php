...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configureer hoe u {{forecastByModule}} wilt categoriseren. <br><br>Houd er rekening mee dat de bereikinstellingen na de eerste bevestiging niet meer kunnen worden gewijzigd. Bij bijgewerkte versies is de bereikinstelling vergrendeld in de bestaande voorspellingsgegevens.<br><br>Selecteer twee of meer categorieën op basis van waarschijnlijkheidsbereik of maak categorieën an die niet op waarschijnlijkheid zijn gebaseerd.<br><br>Er bevinden zich selectievakjes links van je aangepaste categorieën; gebruik deze om te beslissen welk bereik u wilt opnemen in de voorspellingsgegevens en aan managers wilt rapporteren. <br><br>Een gebruiker kan de status en categorie {{forecastByModule}} handmatig insluiten/uitsluiten vanuit het werkblad.',
