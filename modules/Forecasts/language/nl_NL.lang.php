...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configureer hoe u {{forecastByModule}} wilt indelen. <br><br>Houd er rekening mee at de Bereikinstellingen na de eerste keer niet meer kunnen worden gewijzigd. Voor nieuwe exemplaren is de Bereikinstelling vergrendeld in de huidige Voorspellingsgegevens.<br><br>U kunt twee of meer categorieën selecteren op basis van waarschijnlijkheid of u kunt categorieën aanmaken die niet zijn gebaseerd op waarschijnlijkheid. <br><br>Er bevinden zich selectievakjes links van uw aangepaste categorieën. Gebruik deze om te kiezen welk bereik u wilt opnemen in het Voorspellingsbedrag en aan managers wilt rapporteren. <br><br>Een gebruiker kan de status insluiten. uitsluiten en de categorie {{forecastByModule}} handmatig veranderen vanuit het werkblad.',
