...
$mod_strings = [
    ...
    'LBL_FORECASTS_RECORD_DASHBOARD' => 'Řídicí panel záznamů předpovědí',
    ...
    'LBL_METRIC_LABEL_QUOTA' => 'Kvóta',
    'LBL_METRIC_LABEL_COMMITMENT' => 'Závazek',
    'LBL_METRIC_LABEL_QUOTA_COVERAGE' => 'Pokrytí kvóty',
    'LBL_METRIC_LABEL_GAP_QUOTA' => 'Rozdíl vůči kvótě',
    'LBL_METRIC_LABEL_PCT_WON_QUOTA' => '% úspěšnosti kvóty',
    'LBL_METRIC_LABEL_QUOTA_GAP_COVERAGE' => 'Pokrytí rozdílu vůči kvótě',
    'LBL_METRIC_LABEL_COMMITMENT_COVERAGE' => 'Pokrytí závazků',
    'LBL_METRIC_LABEL_GAP_COMMITMENT' => 'Rozdíl vůči závazku',
    'LBL_METRIC_LABEL_COMMITMENT_GAP_COVERAGE' => 'Pokrytí rozdíl vůči závazku',
    'LBL_METRIC_LABEL_PCT_WON_COMMITMENT' => '% úspěšnosti závazku',
    'LBL_METRIC_LABEL_FORECAST_COVERAGE' => 'Pokrytí prognózy',
    'LBL_METRIC_LABEL_GAP_FORECAST' => 'Rozdíl vůči prognóze',
    'LBL_METRIC_LABEL_FORECAST_GAP_COVERAGE' => 'Pokrytí rozdílu vůči prognóze',
    'LBL_METRIC_LABEL_PCT_WON_FORECAST' => '% úspěšnosti prognózy',
    ...
    'LBL_METRIC_HELP_QUOTA' => 'Kvóta',
    'LBL_METRIC_HELP_COMMITMENT' => 'Pravděpodobný závazek',
    'LBL_METRIC_HELP_QUOTA_COVERAGE' => '(Obchodní plán + Úspěšné + Neúspěšné)/Kvóta',
    'LBL_METRIC_HELP_GAP_QUOTA' => 'Kvóta – Úspěšné',
    'LBL_METRIC_HELP_PCT_WON_QUOTA' => 'Úspěšné/Kvóta',
    'LBL_METRIC_HELP_QUOTA_GAP_COVERAGE' => 'Obchodní plán / Rozdíl vůči kvótě',
    'LBL_METRIC_HELP_COMMITMENT_COVERAGE' => '(Obchodní plán + Úspěšné + Neúspěšné)/Závazek',
    'LBL_METRIC_HELP_GAP_COMMITMENT' => 'Pravděpodobný závazek – Úspěšné',
    'LBL_METRIC_HELP_COMMITMENT_GAP_COVERAGE' => 'Obchodní plán / Rozdíl vůči pravděpodobnému závazku',
    'LBL_METRIC_HELP_PCT_WON_COMMITMENT' => 'Úspěšné / Pravděpodobný závazek',
    'LBL_METRIC_HELP_FORECAST_COVERAGE' => '(Obchodní plán + Úspěšné + Neúspěšné)/Prognóza',
    'LBL_METRIC_HELP_GAP_FORECAST' => 'Prognóza – Úspěšné (včetně Obchodního plánu)',
    'LBL_METRIC_HELP_FORECAST_GAP_COVERAGE' => 'Obchodní plán / Rozdíl vůči prognóze',
    'LBL_METRIC_HELP_PCT_WON_FORECAST' => 'Úspěšné/Prognóza',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Nastavte, jak chcete kategorizovat {{forecastByModule}}. <br><br>Upozorňujeme, že nastavení Rozsah nelze po prvním odevzdání měnit. U aktualizovaných instancí je nastavení Rozsah uzamčeno s existujícími daty prognózy.<br><br>Můžete vybrat dvě nebo více kategorií na základě pravděpodobnostních rozsahů nebo vytvořit kategorie, které nejsou založeny na pravděpodobnosti. <br><br>Vlevo od vlastních kategorií jsou zaškrtávací políčka; pomocí nich můžete rozhodnout, které rozsahy budou zahrnuty do částky prognózy odevzdané a hlášené manažerům. <br><br>Uživatel může ručně změnit stav zahrnutí/vyloučení a kategorii {{forecastByModule}} ze svého pracovního listu.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_NAME' => 'Metriky obchodního plánu',
    'LBL_PIPELINE_METRICS_DASHLET_DESC' => 'Zobrazit podrobnosti metrik obchodního plánu',
    'LBL_PIPELINE_METRICS_DASHLET_METRICS_GUIDE' => 'Průvodce metrikami obchodního plánu',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS' => 'Zobrazit metriky',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_GUIDE' => 'Průvodce metrikami',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_REQUIRED' => 'Je třeba vybrat alespoň jednu metriku, která se má zobrazit na kartách metrik',
