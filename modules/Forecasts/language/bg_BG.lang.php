...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Конфигурирайте категоризацията на {{forecastByModule}}. <br><br>Моля, обърнете внимание, че настройките за Обхват не могат да бъдат променяни след първото потвърждение. За актуализирани инсталации настройката за Обхват е заключена за съществуващите Прогнозни данни.<br><br>Можете да изберете две или повече категории въз основа на обхватите на вероятностите или да създадете категории, които не са основани на вероятности. <br><br>Има полета за отметки вляво от вашите потребителски категории; използвайте ги, за да решите кои обхвати да бъдат включени в заложената и докладвана на мениджърите Прогнозирана сума. <br><br>Потребителят може да промени статуса за включване/изключване и категорията на {{forecastByModule}} ръчно от плана си.',
