...
$mod_strings = [
    ...
    'LBL_FORECASTS_RECORD_DASHBOARD' => 'Табло със запис на прогнозите',
    ...
    'LBL_METRIC_LABEL_QUOTA' => 'Цел за приходи',
    'LBL_METRIC_LABEL_COMMITMENT' => 'Ангажимент',
    'LBL_METRIC_LABEL_QUOTA_COVERAGE' => 'Обхват на квотата',
    'LBL_METRIC_LABEL_GAP_QUOTA' => 'Недостиг до квотата',
    'LBL_METRIC_LABEL_PCT_WON_QUOTA' => '% спечелено от квотата',
    'LBL_METRIC_LABEL_QUOTA_GAP_COVERAGE' => 'Покриване на недостига до квотата',
    'LBL_METRIC_LABEL_COMMITMENT_COVERAGE' => 'Покриване на ангажимент',
    'LBL_METRIC_LABEL_GAP_COMMITMENT' => 'Недостиг до ангажимент',
    'LBL_METRIC_LABEL_COMMITMENT_GAP_COVERAGE' => 'Покриване на недостига до ангажимента',
    'LBL_METRIC_LABEL_PCT_WON_COMMITMENT' => '% спечелено до ангажимент',
    'LBL_METRIC_LABEL_FORECAST_COVERAGE' => 'Покритие на прогнозата',
    'LBL_METRIC_LABEL_GAP_FORECAST' => 'Недостиг до прогнозата',
    'LBL_METRIC_LABEL_FORECAST_GAP_COVERAGE' => 'Покриване на недостига до прогнозата',
    'LBL_METRIC_LABEL_PCT_WON_FORECAST' => '% Спечелено от прогнозата',
    ...
    'LBL_METRIC_HELP_COMMITMENT' => 'Вероятен ангажимент',
    'LBL_METRIC_HELP_QUOTA_COVERAGE' => '(Канал + Спечелени + Загубени)/Квота',
    'LBL_METRIC_HELP_GAP_QUOTA' => 'Квота - спечелени',
    'LBL_METRIC_HELP_PCT_WON_QUOTA' => 'Спечелено/квота',
    'LBL_METRIC_HELP_QUOTA_GAP_COVERAGE' => 'Канал / Недостиг до квота',
    'LBL_METRIC_HELP_COMMITMENT_COVERAGE' => '(Канал + Спечелени + Загубени)/Ангажимент',
    'LBL_METRIC_HELP_GAP_COMMITMENT' => 'Вероятен ангажимент - Спечелени',
    'LBL_METRIC_HELP_COMMITMENT_GAP_COVERAGE' => 'Канал / Недостиг до вероятен ангажимент',
    'LBL_METRIC_HELP_PCT_WON_COMMITMENT' => 'Спечелени/Вероятен ангажимент',
    'LBL_METRIC_HELP_FORECAST_COVERAGE' => '(Канал + Спечелени + Загубени)/Прогноза',
    'LBL_METRIC_HELP_GAP_FORECAST' => 'Прогноза - Спечелени (Включен канал)',
    'LBL_METRIC_HELP_FORECAST_GAP_COVERAGE' => 'Канал / Недостиг до прогнозата',
    'LBL_METRIC_HELP_PCT_WON_FORECAST' => 'Спечелени/Прогноза',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Конфигурирайте начина, по който искате да категоризирате {{forecastByModule}}. <br><br>Моля, обърнете внимание, че настройките на диапазона не могат да бъдат променени след първия ангажимент. За надстроени екземпляри настройката Диапазон е заключена със съществуващите данни на прогнозата.<br><br>Можете да изберете две или повече категории въз основа на вероятностни диапазони или да създадете категории, които не се основават на вероятност. <br><br>Отляво на Вашите персонализирани категории има квадратчета за отметка; използвайте ги, за да решите кои диапазони ще бъдат включени в прогнозната сума, зададена и отчетена на мениджърите. <br><br>Потребителят може да промени статуса на включване/изключване и категорията на {{forecastByModule}} ръчно от своя работен лист.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_NAME' => 'Метрики на канала',
    'LBL_PIPELINE_METRICS_DASHLET_DESC' => 'Покажи подробности за метрики на канала',
    'LBL_PIPELINE_METRICS_DASHLET_METRICS_GUIDE' => 'Ръководство на метрики на канала',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS' => 'Показване на метрики',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_GUIDE' => 'Насока за метрики',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_REQUIRED' => 'Трябва да изберете поне една метрика, която да се показва в метричните раздели',
