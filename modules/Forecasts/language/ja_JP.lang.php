...
$mod_strings = [
    ...
    'LBL_METRIC_LABEL_QUOTA' => 'ノルマ',
    'LBL_METRIC_LABEL_COMMITMENT' => 'コミットメント',
    'LBL_METRIC_LABEL_QUOTA_COVERAGE' => 'ノルマの対象範囲',
    'LBL_METRIC_LABEL_GAP_QUOTA' => 'ノルマとのギャップ',
    'LBL_METRIC_LABEL_PCT_WON_QUOTA' => 'ノルマの達成率（%）',
    'LBL_METRIC_LABEL_QUOTA_GAP_COVERAGE' => 'ノルマのギャップの対象範囲',
    'LBL_METRIC_LABEL_COMMITMENT_COVERAGE' => 'コミットメントの対象範囲',
    'LBL_METRIC_LABEL_GAP_COMMITMENT' => 'コミットメントとのギャップ',
    'LBL_METRIC_LABEL_COMMITMENT_GAP_COVERAGE' => 'コミットメントのギャップの対象範囲',
    'LBL_METRIC_LABEL_PCT_WON_COMMITMENT' => 'コミットメントの達成率（%）',
    'LBL_METRIC_LABEL_FORECAST_COVERAGE' => '予測対象範囲',
    'LBL_METRIC_LABEL_GAP_FORECAST' => '予測とのギャップ',
    'LBL_METRIC_LABEL_FORECAST_GAP_COVERAGE' => '予測のギャップの対象範囲',
    'LBL_METRIC_LABEL_PCT_WON_FORECAST' => '予測の達成率（%）',
    ...
    'LBL_METRIC_HELP_QUOTA' => 'ノルマ',
    'LBL_METRIC_HELP_COMMITMENT' => '可能性の高いコミットメント',
    'LBL_METRIC_HELP_QUOTA_COVERAGE' => '（パイプライン + 達成 + 未達成）/ノルマ',
    'LBL_METRIC_HELP_GAP_QUOTA' => 'ノルマ – 達成',
    'LBL_METRIC_HELP_PCT_WON_QUOTA' => '達成/ノルマ',
    'LBL_METRIC_HELP_QUOTA_GAP_COVERAGE' => 'パイプライン/ノルマとのギャップ',
    'LBL_METRIC_HELP_COMMITMENT_COVERAGE' => '（パイプライン + 達成 + 未達成）/コミットメント',
    'LBL_METRIC_HELP_GAP_COMMITMENT' => '可能性の高いコミットメント - 達成',
    'LBL_METRIC_HELP_COMMITMENT_GAP_COVERAGE' => 'パイプライン/可能性の高いコミットメントとのギャップ',
    'LBL_METRIC_HELP_PCT_WON_COMMITMENT' => '達成/可能性の高いコミットメント',
    'LBL_METRIC_HELP_FORECAST_COVERAGE' => '（パイプライン + 達成 + 未達成）/予測',
    'LBL_METRIC_HELP_GAP_FORECAST' => '予測 – 達成（パイプラインを含む）',
    'LBL_METRIC_HELP_FORECAST_GAP_COVERAGE' => 'パイプライン/予測とのギャップ',
    'LBL_METRIC_HELP_PCT_WON_FORECAST' => '達成/予測',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => '{{forecastByModule}}をどのように分類するかを設定します。<br><br>範囲の設定は最初のコミット以降は変更できませんのでご注意ください。アップグレードされたインスタンスの場合、範囲の設定は既存の予測データでロックされます。<br><br>確率の範囲に基づいて2つ以上のカテゴリを選択、または確率に基づかないカテゴリを作成できます。<br><br>カスタムカテゴリの左側にチェックボックスがあります。これらを使用すると、コミットされマネジャーに報告される予測金額内にどの範囲を含めるを決定できます。<br><br>ユーザーはワークシートから{{forecastByModule}}の含む/除くステータスとカテゴリを手動で変更できます。',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_NAME' => 'パイプラインの測定基準',
    'LBL_PIPELINE_METRICS_DASHLET_DESC' => 'パイプラインの測定基準の詳細を表示',
    'LBL_PIPELINE_METRICS_DASHLET_METRICS_GUIDE' => 'パイプラインの測定基準に関するガイド',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS' => '測定基準を表示',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_GUIDE' => '測定基準に関するガイド',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_REQUIRED' => '測定基準タブに表示する測定基準を少なくとも1つ選択する必要があります',
