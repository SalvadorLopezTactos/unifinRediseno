...
$mod_strings = [
    ...
    // API message labels
    'LBL_METRICS_API_NO_ACCESS' => '需要 Sugar Sell Premier 才能访问指标 API',
    ...
    'LBL_RU_TEAM_FORECAST_HEADER' => '<span class="sicon sicon-user-group mx-1"></span> 团队预测{{name}}',
    ...
    'LBL_FDR_FORECAST_HEADER' => '<span class="sicon sicon-user mx-1"></span> 的卖方预测{{name}}',
    ...
    //list view metrics
    'LBL_INCLUDED_PIPELINE' => '包含的流水线',
    'LBL_UPSIDE_PIPELINE' => '上部流水线',
    'LBL_EXCLUDED_PIPELINE' => '排除的流水线',
    'LBL_WON' => '谈成',
    'LBL_LOST' => '丢单',
    'LBL_ALL' => '全部',

    'LBL_METRIC_LABEL_QUOTA' => '配额',
    'LBL_METRIC_LABEL_COMMITMENT' => '承诺',
    'LBL_METRIC_LABEL_QUOTA_COVERAGE' => '配额覆盖范围',
    'LBL_METRIC_LABEL_GAP_QUOTA' => '与配额的差距',
    'LBL_METRIC_LABEL_PCT_WON_QUOTA' => '赢得的配额百分比',
    'LBL_METRIC_LABEL_QUOTA_GAP_COVERAGE' => '配额差距覆盖范围',
    'LBL_METRIC_LABEL_COMMITMENT_COVERAGE' => '承诺范围',
    'LBL_METRIC_LABEL_GAP_COMMITMENT' => '承诺差距',
    'LBL_METRIC_LABEL_COMMITMENT_GAP_COVERAGE' => '承诺差距覆盖范围',
    'LBL_METRIC_LABEL_PCT_WON_COMMITMENT' => '承诺赢得百分比',
    'LBL_METRIC_LABEL_FORECAST_COVERAGE' => '预测覆盖范围',
    'LBL_METRIC_LABEL_GAP_FORECAST' => '预测差距',
    'LBL_METRIC_LABEL_FORECAST_GAP_COVERAGE' => '预测差距覆盖范围',
    'LBL_METRIC_LABEL_PCT_WON_FORECAST' => '预测赢得百分比',

    // Guide to Filters
    'LBL_FILTER_GUIDE_TITLE' => '过滤器指南',
    'LBL_HELP_MAIN_BODY' => '所有指标仅包括属于所选用户的商业机会、时间段以及您应用的任何其他筛选条件',
    'LBL_FORECAST_HELP' => '已经谈成或包含在 {{{forecastStage}}} 中的商业机会',
    'LBL_INCLUDED_PIPELINE_HELP' => '打开具有 {{{commitStageValue}}} 的 {{{forecastStage}}} 商业机会',
    'LBL_INCLUDED_PIPELINE_HELP_CUSTOM_RANGE' => '打开包含的 {{{forecastStage}}} 中商业机会',
    'LBL_UPSIDE_PIPELINE_HELP' => '打开具有 {{{commitStageValue}}} 的 {{{forecastStage}}} 商业机会',
    'LBL_EXCLUDED_PIPELINE_HELP' => '打开具有 {{{commitStageValue}}} 的 {{{forecastStage}}} 商业机会',
    'LBL_EXCLUDED_PIPELINE_HELP_CUSTOM_RANGE' => '打开排除的 {{{forecastStage}}} 中商业机会',
    'LBL_WON_HELP' => '已经谈成的商业机会',
    'LBL_LOST_HELP' => '已经丢单的商业机会',
    'LBL_ALL_HELP' => '全部商业机会',

    'LBL_METRIC_HELP_QUOTA' => '配额',
    'LBL_METRIC_HELP_COMMITMENT' => '可能的承诺',
    'LBL_METRIC_HELP_QUOTA_COVERAGE' => '（管道 + 赢得 + 流失）/配额',
    'LBL_METRIC_HELP_GAP_QUOTA' => '配额 – 赢得',
    'LBL_METRIC_HELP_PCT_WON_QUOTA' => '赢得/配额',
    'LBL_METRIC_HELP_QUOTA_GAP_COVERAGE' => '管道/配额差距',
    'LBL_METRIC_HELP_COMMITMENT_COVERAGE' => '（管道 + 赢得 + 流失）/承诺',
    'LBL_METRIC_HELP_GAP_COMMITMENT' => '可能的承诺 - 赢得',
    'LBL_METRIC_HELP_COMMITMENT_GAP_COVERAGE' => '管道/与可能承诺的差距',
    'LBL_METRIC_HELP_PCT_WON_COMMITMENT' => '赢得/可能的承诺',
    'LBL_METRIC_HELP_FORECAST_COVERAGE' => '（管道 + 赢得 + 流失）/预测',
    'LBL_METRIC_HELP_GAP_FORECAST' => '预测 – 赢得（包括管道）',
    'LBL_METRIC_HELP_FORECAST_GAP_COVERAGE' => '管道/预测差距',
    'LBL_METRIC_HELP_PCT_WON_FORECAST' => '赢得/预测',
    ...
    'LBL_FORECAST' => '销售预测',
    'LBL_COMMITMENT' => '提交',
    'LBL_TEAM_COMMITMENT' => '团队提交',
    'LBL_FORECASTED' => '预测',
    'LBL_OPPORTUNITY_FORECAST' => '预测中的商业机会',
    'LBL_REVENUELINEITEM_FORECAST' => '预测中的营收单项',
    'LBL_LAST_COMMITMENT' => '上次承诺',
    'LBL_ADJUSTED_TOTAL' => '调整后的总额',
    ...
    'LBL_COMMITTED_HISTORY_LIKELY_SAME' => '提交（可能）保持不变',
    'LBL_COMMITTED_HISTORY_BEST_SAME' => '提交（最佳）保持不变',
    'LBL_COMMITTED_HISTORY_WORST_SAME' => '提交（最差）保持不变',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => '配置您想要分类 {{forecastByModule}} 的方式。<br><br>请注意，“范围”设置在首次提交后无法更改。对于升级的实例，“范围”设置将锁定为现有预测数据。<br><br>您可以根据可能性范围选择两个或更多类别，或创建不基于可能性的类别。<br><br>自定义类别左侧有复选框；使用这些复选框来决定将哪些范围包含在提交并报告给经理的“预测”数量中。<br><br>用户可以从工作表中手动更改 {{forecastByModule}} 的包含/排除状态和类别。',
    ...
    'LBL_OPEN_LIKELY' => '打开可能',
    'LBL_OPEN_BEST' => '打开最佳',
    'LBL_OPEN_WORST' => '打开最差',

    // Pipeline Metrics dashlet
    'LBL_PIPELINE_METRICS_DASHLET_NAME' => '管道指标',
    'LBL_PIPELINE_METRICS_DASHLET_DESC' => '显示管道指标详细信息',
    'LBL_PIPELINE_METRICS_DASHLET_METRICS_GUIDE' => '管道指标指南',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS' => '显示指标',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_GUIDE' => '指标指南',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_REQUIRED' => '必须至少选择一个指标才能在指标选项卡上显示',
    ...
    'LBL_COMMIT_TOOLTIP_REP' => '保存对记录的更改并将预测提交给经理',
    'LBL_COMMIT_TOOLTIP_MGR' => '向经理提交预测并分配配额',

    'LBL_SAVE_LABEL_REP' => '保存 ',
    'LBL_SAVE_LABEL_MGR' => '保存调整后的值',
