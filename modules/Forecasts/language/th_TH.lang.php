...
$mod_strings = [
    ...
    'LBL_TAB_COMMITMENT' => 'การมอบหมาย',
    'LBL_CURRENT' => 'ปัจจุบัน',
    ...
    // API message labels
    'LBL_METRICS_API_NO_ACCESS' => 'เข้าถึงเมตริก API ที่ต้องใช้ Sugar Sell Premier',
    ...
    //list view metrics
    'LBL_INCLUDED_PIPELINE' => 'กระบวนการขายที่รวมไว้',
    'LBL_UPSIDE_PIPELINE' => 'กระบวนการขายที่เป็นไปได้',
    'LBL_EXCLUDED_PIPELINE' => 'กระบวนการขายที่แยกออก',
    'LBL_WON' => 'การขายสำเร็จ',
    'LBL_LOST' => 'การขายไม่สำเร็จ',
    'LBL_ALL' => 'ทั้งหมด',

    'LBL_METRIC_LABEL_QUOTA' => 'โควตา',
    'LBL_METRIC_LABEL_COMMITMENT' => 'คำมั่นสัญญา',
    'LBL_METRIC_LABEL_QUOTA_COVERAGE' => 'ขอบข่ายโควต้า',
    'LBL_METRIC_LABEL_GAP_QUOTA' => 'ช่องว่างถึงโควต้า',
    'LBL_METRIC_LABEL_PCT_WON_QUOTA' => '% การได้รับโควต้า',
    'LBL_METRIC_LABEL_QUOTA_GAP_COVERAGE' => 'ขอบข่ายช่องว่างโควต้า',
    'LBL_METRIC_LABEL_COMMITMENT_COVERAGE' => 'ขอบข่ายคำมั่นสัญญา',
    'LBL_METRIC_LABEL_GAP_COMMITMENT' => 'ช่องว่างคำมั่นสัญญา',
    'LBL_METRIC_LABEL_COMMITMENT_GAP_COVERAGE' => 'ขอบข่ายช่องว่างคำมั่นสัญญา',
    'LBL_METRIC_LABEL_PCT_WON_COMMITMENT' => '% ขายได้ด้วยคำมั่นสัญญา',
    'LBL_METRIC_LABEL_FORECAST_COVERAGE' => 'ขอบข่ายการพยากรณ์',
    'LBL_METRIC_LABEL_GAP_FORECAST' => 'ช่องว่างการพยากรณ์',
    'LBL_METRIC_LABEL_FORECAST_GAP_COVERAGE' => 'ขอบข่ายช่องว่างการพยากรณ์',
    'LBL_METRIC_LABEL_PCT_WON_FORECAST' => '% การพยากรณ์ที่ถูกต้อง',

    // Guide to Filters
    'LBL_FILTER_GUIDE_TITLE' => 'คู่มือการใช้ตัวกรอง',
    'LBL_HELP_MAIN_BODY' => 'เมตริกทั้งหมดจะมีโอกาสทางการขายที่เป็นของผู้ใช้ ระยะเวลา และตัวกรองเพิ่มเติมอื่น ๆ ที่คุณได้เลือกเอาไว้เท่านั้น',
    'LBL_FORECAST_HELP' => 'โอกาสทางการขายที่สำเร็จแล้ว หรือที่อยู่ใน {{{forecastStage}}} ที่รวมเอาไว้',
    'LBL_INCLUDED_PIPELINE_HELP' => 'เปิดการขายด้วย {{{forecastStage}}} ของ {{{commitStageValue}}}',
    'LBL_INCLUDED_PIPELINE_HELP_CUSTOM_RANGE' => 'เปิดโอกาสทางการขายใน {{{forecastStage}}} ที่รวมไว้',
    'LBL_UPSIDE_PIPELINE_HELP' => 'เปิดการขายด้วย {{{forecastStage}}} ของ {{{commitStageValue}}}',
    'LBL_EXCLUDED_PIPELINE_HELP' => 'เปิดการขายด้วย {{{forecastStage}}} ของ {{{commitStageValue}}}',
    'LBL_EXCLUDED_PIPELINE_HELP_CUSTOM_RANGE' => 'เปิดโอกาสทางการขายใน {{{forecastStage}}} ที่แยกไว้',
    'LBL_WON_HELP' => 'โอกาสทางการขายที่ขายสำเร็จแล้ว',
    'LBL_LOST_HELP' => 'โอกาสทางการขายที่ขายไม่สำเร็จ',
    'LBL_ALL_HELP' => 'โอกาสทางการขายทั้งหมด',

    'LBL_METRIC_HELP_QUOTA' => 'โควตา',
    'LBL_METRIC_HELP_COMMITMENT' => 'คำมั่นสัญญาที่น่าจะเป็นไปได้',
    'LBL_METRIC_HELP_QUOTA_COVERAGE' => '(กระบวนการขาย + ขายได้ + ขายไม่ได้)/ โควต้า',
    'LBL_METRIC_HELP_GAP_QUOTA' => 'โควต้า – ขายได้',
    'LBL_METRIC_HELP_PCT_WON_QUOTA' => 'ขายได้/โควต้า',
    'LBL_METRIC_HELP_QUOTA_GAP_COVERAGE' => 'กระบวนการขาย / ช่องว่างโควต้า',
    'LBL_METRIC_HELP_COMMITMENT_COVERAGE' => '(กระบวนการขาย + ขายได้ + ขายไม่ได้)/คำมั่นสัญญา',
    'LBL_METRIC_HELP_GAP_COMMITMENT' => 'คำมั่นสัญญาที่น่าจะเป็นไปได้ - ขายได้',
    'LBL_METRIC_HELP_COMMITMENT_GAP_COVERAGE' => 'กระบวนการขาย / ช่องว่างคำมั่นสัญญาที่น่าจะเป็นไปได้',
    'LBL_METRIC_HELP_PCT_WON_COMMITMENT' => 'ขายได้/คำมั่นสัญญาที่น่าจะเป็นไปได้',
    'LBL_METRIC_HELP_FORECAST_COVERAGE' => '(กระบวนการขาย + ขายได้ + ขายไม่ได้)/พยากรณ์',
    'LBL_METRIC_HELP_GAP_FORECAST' => 'พยากรณ์ – ขายได้ (รวมถึงกระบวนการขาย)',
    'LBL_METRIC_HELP_FORECAST_GAP_COVERAGE' => 'กระบวนการขาย / ช่องว่างการพยากรณ์',
    'LBL_METRIC_HELP_PCT_WON_FORECAST' => 'ขายได้/พยากรณ์',
    ...
    'LBL_OPPORTUNITY_FORECAST' => 'ประมาณการโอกาสทางการขาย',
    'LBL_REVENUELINEITEM_FORECAST' => 'ประมาณการรายการบรรทัดรายได้',
    'LBL_LAST_COMMITMENT' => 'คำมั่นก่อนหน้า',
    ...
    'LBL_FORECAST_SETTINGS' => 'การตั้งค่าประมาณการ',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'กำหนดค่าว่าคุณต้องการจัดหมวดหมู่อย่างไร {{forecastByModule}} <br><br>โปรดทราบว่าการตั้งค่าช่วงจะไม่สามารถเปลี่ยนแปลงได้หลังจากกระทำครั้งแรก สำหรับอินสแตนซ์ที่อัปเกรด การตั้งค่าช่วงจะถูกล็อกด้วยข้อมูลการคาดการณ์ที่มีอยู่<br><br>คุณสามารถเลือกหมวดหมู่ตั้งแต่สองหมวดหมู่ขึ้นไปตามช่วงความน่าจะเป็น หรือสร้างหมวดหมู่ที่ไม่อิงตามความน่าจะเป็น <br><br>มีช่องทำเครื่องหมายทางด้านซ้ายของหมวดหมู่ที่คุณกำหนดเอง ใช้ข้อมูลเหล่านี้เพื่อตัดสินใจว่าจะรวมช่วงใดไว้ในจำนวนการคาดการณ์ที่คอมมิตและรายงานต่อผู้จัดการ <br><br>ผู้ใช้สามารถเปลี่ยนสถานะรวม/ไม่รวมและหมวดหมู่ของ {{forecastByModule}} ได้ด้วยตนเองจากแผ่นงานของตน',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_NAME' => 'เมตริกกระบวนการขาย',
    'LBL_PIPELINE_METRICS_DASHLET_DESC' => 'แสดงรายละเอียดเมตริกกระบวนการขาย',
    'LBL_PIPELINE_METRICS_DASHLET_METRICS_GUIDE' => 'คู่มือเมตริกกระบวนการขาย',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS' => 'แสดงเมตริก',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_GUIDE' => 'คำแนะนำเกี่ยวกับเมตริก',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_REQUIRED' => 'ต้องเลือกเมตริกอย่างน้อย 1 รายการเพื่อแสดงบนแท็บเมตริก',
