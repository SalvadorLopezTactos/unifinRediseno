...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'กำหนดวิธีที่คุณต้องการจัดหมวดหมู่ {{forecastByModule}} <br><br>โปรดทราบว่าการตั้งค่าช่วงนั้นไม่สามารถเปลี่ยนแปลงได้หลังจากคอมมิตครั้งแรก สำหรับอินสแตนซ์ที่อัปเกรด การตั้งค่าช่วงจะถูกล็อคไว้กับข้อมูลประมาณการที่มีอยู่<br><br>คุณสามารถเลือกสองหมวดหมู่ขึ้นไปตามช่วงความเป็นไปได้ หรือสร้างหมวดหมู่ที่ไม่อ้างอิงความเป็นไปได้ <br><br>ทางซ้ายของหมวดหมู่ที่กำหนดเองจะมีช่องทำเครื่องหมายซึ่งสามารถใช้เลือกว่าจะรวมช่วงใดไว้ภายในจำนวนเงินประมาณการที่คอมมิตและรายงานแก่ผู้จัดการ<br><br>ผู้ใช้สามารถเปลี่ยนสถานะรวม/ไม่รวม และหมวดหมู่ของ {{forecastByModule}} ด้วยตนเองจากเวิร์กชีทของตนเอง',
