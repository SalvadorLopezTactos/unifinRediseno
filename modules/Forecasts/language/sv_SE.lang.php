...
$mod_strings = [
    ...
    'LBL_FORECASTS_RECORD_DASHBOARD' => 'Instrumentpanel för prognosposter',
    ...
    'LBL_METRIC_LABEL_QUOTA' => 'Kvot',
    'LBL_METRIC_LABEL_COMMITMENT' => 'Förpliktelse',
    'LBL_METRIC_LABEL_QUOTA_COVERAGE' => 'Kvotens täckning',
    'LBL_METRIC_LABEL_GAP_QUOTA' => 'Intervall till kvot',
    'LBL_METRIC_LABEL_PCT_WON_QUOTA' => '% vinst av kvot',
    'LBL_METRIC_LABEL_QUOTA_GAP_COVERAGE' => 'Kvotintervallets täckning',
    'LBL_METRIC_LABEL_COMMITMENT_COVERAGE' => 'Förpliktelsetäckning',
    'LBL_METRIC_LABEL_GAP_COMMITMENT' => 'Intervall till förpliktelse',
    'LBL_METRIC_LABEL_COMMITMENT_GAP_COVERAGE' => 'Täckning för förpliktelseintervall',
    'LBL_METRIC_LABEL_PCT_WON_COMMITMENT' => '% vinst av förpliktelse',
    'LBL_METRIC_LABEL_FORECAST_COVERAGE' => 'Prognostäckning',
    'LBL_METRIC_LABEL_GAP_FORECAST' => 'Intervall till prognos',
    'LBL_METRIC_LABEL_FORECAST_GAP_COVERAGE' => 'Täckning för prognosintervall',
    'LBL_METRIC_LABEL_PCT_WON_FORECAST' => '% vinst av prognos',
    ...
    'LBL_METRIC_HELP_QUOTA' => 'Kvot',
    'LBL_METRIC_HELP_COMMITMENT' => 'Trolig förpliktelse',
    'LBL_METRIC_HELP_QUOTA_COVERAGE' => '(Pipeline + vinst + förlust)/kvot',
    'LBL_METRIC_HELP_GAP_QUOTA' => 'Kvot – vinst',
    'LBL_METRIC_HELP_PCT_WON_QUOTA' => 'Vinst/kvot',
    'LBL_METRIC_HELP_QUOTA_GAP_COVERAGE' => 'Pipeline / intervall till kvot',
    'LBL_METRIC_HELP_COMMITMENT_COVERAGE' => '(Pipeline + vinst + förlust)/förpliktelse',
    'LBL_METRIC_HELP_GAP_COMMITMENT' => 'Trolig förpliktelse – vinst',
    'LBL_METRIC_HELP_COMMITMENT_GAP_COVERAGE' => 'Pipeline / intervall till trolig förpliktelse',
    'LBL_METRIC_HELP_PCT_WON_COMMITMENT' => 'Vinst/trolig förpliktelse',
    'LBL_METRIC_HELP_FORECAST_COVERAGE' => '(Pipeline + vinst + förlust)/prognos',
    'LBL_METRIC_HELP_GAP_FORECAST' => 'Prognos – vinst (omfattar pipeline)',
    'LBL_METRIC_HELP_FORECAST_GAP_COVERAGE' => 'Pipeline / intervall till prognos',
    'LBL_METRIC_HELP_PCT_WON_FORECAST' => 'Vinst/prognos',
    ...
    'LBL_GRAPH_QUOTA_ALTTEXT' => 'Offert för %s',
    'LBL_GRAPH_COMMIT_ALTTEXT' => 'Överlämnat belopp för %s',
    'LBL_GRAPH_OPPS_ALTTEXT' => 'Värde av möjligheter som stängts i %s',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurera hur du vill kategorisera {{forecastByModule}}. <br><br>Observera att det inte går att ändra intervallinställningarna i efterhand. För uppgraderade instanser är intervallinställningen låst med befintliga prognosdata.<br><br>Du kan välja två eller fler kategorier baserat på sannolikhetsintervall eller skapa kategorier som inte är baserade på sannolikhet. <br><br>Det finns kryssrutor till vänster om dina anpassade kategorier; Använd dessa för att bestämma vilka intervall du vill inkludera i det prognosbelopp som har avsatts och rapporterats till chefer. <br><br>En användare kan ändra inkluderings-/exkluderingsstatus och kategori för {{forecastByModule}} manuellt från kalkylbladet.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_DESC' => 'Visa uppgifter för pipeline-metrik',
    'LBL_PIPELINE_METRICS_DASHLET_METRICS_GUIDE' => 'Guide till pipeline-metrik',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS' => 'Visa metrik',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_GUIDE' => 'Guide till metrik',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_REQUIRED' => 'Måste välja minst ett mätvärde som ska visas i metrikflikar',
