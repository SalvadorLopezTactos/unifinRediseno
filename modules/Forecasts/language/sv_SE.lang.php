...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurera hur du vill kategorisera {{forecastByModule}}. <br><br>Observera att områdesinställningarna inte kan ändras efter det första utförandet. För uppgraderade instanser, är områdesinställningen låst med befintlig prognosdata.<br><br>Du kan välja två eller fler kategorier baserat på sannolikhetsområden eller skapa kategorier som inte baseras på sannolikhet. <br><br>Det finns kryssrutor till vänster om dina anpassade kategorier; använd dessa för att bestämma vilka områden som kommer att inkluderas inom prognosbeloppet som utförts och rapporterats till chefer. <br><br>En användare kan ändra inkludera/utesluta-statusen och kategori av {{forecastByModule}} manuellt från sina kalkylblad.',
