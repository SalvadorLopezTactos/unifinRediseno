...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'קבע תצורה לאופן שבו תרצה לסווג את {{forecastByModule}}.<br><br>לתשומת לבך, לא ניתן יהיה לשנות את הגדרות הטווח אחרי פעולת ההתחייבות הראשונה. עבור מופעים משודרגים, הגדרת הטווח נעולה עם נתוני התחזית הקיימים.<br><br>באפשרותך לבחור שתי קטגוריות או יותר על סמך טווחי ההסתברות או ליצור קטגוריות שאינן מבוססות על הסתברות. <br><br>תיבות הסימון נמצאות משמאל לקטגוריות שהתאמת אישית; השתמש בהן כדי להחליט אילו טווחים ייכללו בסכום התחזית שעליו התחייבת ושדווח למנהלים.<br><br>המשתמשים יוכלו לשנות את הסטטוס כלול/אל תכלול ואת הקטגוריה של {{forecastByModule}} באופן ידני מגיליון העבודה שלהם.',
