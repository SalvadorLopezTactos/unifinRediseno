...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'הגדר את אופן יצירת הקטגוריות המתאים לך עבור {{forecastByModule}}. <br><br>לתשומת לבך, לא ניתן לשנות את הגדרות הטווחים לאחר ההתחייבות הראשונה. עבור מופעים שעברו שדרוג, הגדרת הטווח נעולה עם נתוני התחזיות הקיימים. <br><br>באפשרותך לבחור שתי קטגוריות או יותר על סמך טווחי ההסתברות או ליצור קטגוריות שאינן מבוססות על הסתברות. <br><br>שים לב לתיבות הסימון משמאל לקטגוריות המותאמות; השתמש בהן כדי להחליט אילו טווחים ייכללו בסכום התחזית על פי ההתחייבות והדיווח למנהלים. <br><br>באפשרות המשתמש לשנות את הסטטוס כלול/לא כלול ואת הקטגוריה של {{forecastByModule}} באופן ידני מגיליון העבודה שלו.',
