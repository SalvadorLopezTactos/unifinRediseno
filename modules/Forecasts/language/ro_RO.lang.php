...
$mod_strings = [
    ...
    'LBL_FORECASTS_RECORD_DASHBOARD' => 'Tablou de bord Înregistrare Previziuni',
    ...
    'LBL_METRIC_LABEL_QUOTA' => 'Obiectiv',
    'LBL_METRIC_LABEL_COMMITMENT' => 'Confirmare',
    'LBL_METRIC_LABEL_QUOTA_COVERAGE' => 'Acoperire obiectiv',
    'LBL_METRIC_LABEL_GAP_QUOTA' => 'Diferență până la obiectiv',
    'LBL_METRIC_LABEL_PCT_WON_QUOTA' => '% câștigat din obiectiv',
    'LBL_METRIC_LABEL_QUOTA_GAP_COVERAGE' => 'Acoperire diferență până la obiectiv',
    'LBL_METRIC_LABEL_COMMITMENT_COVERAGE' => 'Acoperire angajament',
    'LBL_METRIC_LABEL_GAP_COMMITMENT' => 'Diferență până la angajament',
    'LBL_METRIC_LABEL_COMMITMENT_GAP_COVERAGE' => 'Acoperire diferență până la angajament',
    'LBL_METRIC_LABEL_PCT_WON_COMMITMENT' => '% câștigat din angajament',
    'LBL_METRIC_LABEL_FORECAST_COVERAGE' => 'Acoperire previziune',
    'LBL_METRIC_LABEL_GAP_FORECAST' => 'Diferență până la previziune',
    'LBL_METRIC_LABEL_FORECAST_GAP_COVERAGE' => 'Acoperire diferență până la previziune',
    'LBL_METRIC_LABEL_PCT_WON_FORECAST' => '% câștigat din previziune',
    ...
    'LBL_METRIC_HELP_QUOTA' => 'Obiectiv',
    'LBL_METRIC_HELP_COMMITMENT' => 'Angajament probabil',
    'LBL_METRIC_HELP_QUOTA_COVERAGE' => '(Pipeline + Câștigat + Pierdut)/Obiectiv',
    'LBL_METRIC_HELP_GAP_QUOTA' => 'Obiectiv – Câștigat',
    'LBL_METRIC_HELP_PCT_WON_QUOTA' => 'Câștigat/Obiectiv',
    'LBL_METRIC_HELP_QUOTA_GAP_COVERAGE' => 'Pipeline/Diferență până la obiectiv',
    'LBL_METRIC_HELP_COMMITMENT_COVERAGE' => '(Pipeline + Câștigat + Pierdut)/Angajament',
    'LBL_METRIC_HELP_GAP_COMMITMENT' => 'Angajament probabil - Câștigat',
    'LBL_METRIC_HELP_COMMITMENT_GAP_COVERAGE' => 'Pipeline/Diferență până la angajamentul probabil',
    'LBL_METRIC_HELP_PCT_WON_COMMITMENT' => 'Angajament câștigat/probabil',
    'LBL_METRIC_HELP_FORECAST_COVERAGE' => '(Pipeline + Câștigat + Pierdut)/Previziune',
    'LBL_METRIC_HELP_GAP_FORECAST' => 'Previziune - Câștigat (pipeline inclus)',
    'LBL_METRIC_HELP_FORECAST_GAP_COVERAGE' => 'Pipeline/Diferență până la previziune',
    'LBL_METRIC_HELP_PCT_WON_FORECAST' => 'Câștigat/Previziune',
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Configurați modul în care doriți să clasificați {{forecastByModule}}. <br><br>Rețineți, setările pentru Interval nu pot fi modificate după prima asumare. Pentru instanțele actualizate, setarea Interval este blocată cu datele de Previziuni existente.<br><br>Puteți selecta două sau mai multe categorii pe baza intervalelor de probabilitate sau puteți crea categorii care nu se bazează pe probabilitate. <br><br>Există casete de selectare în stânga categoriilor personalizate; utilizați aceste casete pentru a decide ce intervale vor fi incluse în Suma asumată angajată și raportată managerilor. <br><br>Utilizatorul poate modifica manual starea de includere/excludere și categoria {{forecastByModule}}, din foaia lor de lucru.',
    ...
    'LBL_PIPELINE_METRICS_DASHLET_NAME' => 'Metrici pipeline',
    'LBL_PIPELINE_METRICS_DASHLET_DESC' => 'Afișare detalii privind metricile pentru pipeline',
    'LBL_PIPELINE_METRICS_DASHLET_METRICS_GUIDE' => 'Ghid pentru metrici pipeline',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS' => 'Afișare metrici',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_GUIDE' => 'Ghid privind metricile',
    'LBL_PIPELINE_METRICS_DASHLET_CONFIG_METRICS_REQUIRED' => 'Trebuie să selectați cel puțin o metrică pentru a fi afișată în filele pentru metrici',
