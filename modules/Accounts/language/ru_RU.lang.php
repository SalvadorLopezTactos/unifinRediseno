...
$mod_strings = [
    ...
    'LBL_PLI_SUBPANEL_TITLE' => 'Приобретенные продукты',
...
// External Users Subpanel
    ...
    // AI Predict
    'LBL_AI_ENTEREDACCT' => 'Введенные клиенты',
    'LBL_AI_CREATEDACCT' => 'Созданные клиенты',
    'LBL_AI_ACCTVELOCITY' => 'Возраст клиента (скорость клиента)',
    'LBL_AI_ACCTAGE' => 'Возраст клиентов',

    'LBL_TARGET_ACC' => 'Целевые контрагенты',
];
