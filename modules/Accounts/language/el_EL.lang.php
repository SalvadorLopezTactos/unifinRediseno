...
$mod_strings = [
    ...
    'LBL_PLI_SUBPANEL_TITLE' => 'Γραμμή Στοιχείων που Αγοράστηκαν',
...
// External Users Subpanel
    ...
    // AI Predict
    'LBL_AI_ENTEREDACCT' => 'Καταχωρισμένοι λογαριασμοί',
    'LBL_AI_CREATEDACCT' => 'Δημιουργημένοι λογαριασμοί',
    'LBL_AI_ACCTVELOCITY' => 'Παλαιότητα λογαριασμού (ταχύτητα λογαριασμού)',
    'LBL_AI_ACCTAGE' => 'Παλαιότητα λογαριασμών',

    'LBL_TARGET_ACC' => 'Λογαριασμοί-στόχοι',
];
