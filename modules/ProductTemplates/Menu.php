...
$module_menu = [
    ...
    ['index.php?module=Import&action=Step1&import_module=ProductTemplates&return_module=ProductTemplates&return_action=index', $mod_strings['LNK_IMPORT_PRODUCTS'], 'Import'],
