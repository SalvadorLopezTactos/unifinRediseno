...
$mod_strings = array (
    ...
    'LBL_KBSLOCALIZATIONS' => 'ローカライズ',
    'LBL_LOCALIZATIONS_SUBPANEL_TITLE' => 'ローカライズ',
    'LBL_KBSREVISIONS' => '版',
    'LBL_REVISIONS_SUBPANEL_TITLE' => '版',
    'LBL_LISTVIEW_FILTER_ALL' => 'すべての記事',
    'LBL_LISTVIEW_FILTER_MY' => '私の記事',
    'LBL_CREATE_LOCALIZATION_BUTTON_LABEL' => 'ローカライズの作成',
    'LBL_CREATE_REVISION_BUTTON_LABEL' => '改版の作成',
    'LBL_CANNOT_CREATE_LOCALIZATION' =>
        'すべての利用可能な言語にローカライズ版が存在するため、新しいローカライズを作成できません。',
    ...
    'EXCEPTION_VOTE_USEFULNESS_NOT_AUTHORIZED' => '{moduleName} が有用/有用でないを投票する権限がありません。アクセスが必要な場合は、管理者にお問い合わせください。',
