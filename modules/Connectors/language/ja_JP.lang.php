...
$mod_strings = array(
    ...
    'ERROR_NO_SEARCHDEFS_MAPPING' => 'エラー: モジュールとコネクタに１つも検索フィールドが定義されていません。システム管理者にお問い合わせください。',
    'ERROR_NO_FIELDS_MAPPED' => 'エラー: モジュールのそれぞれのエントリのモジュールフィールドに少なくとも１つのコネクタフィールドを関連付けなければいけません。',
    'ERROR_NO_DISPLAYABLE_MAPPED_FIELDS' => 'エラー: 結果に表示するモジュールフィールドが関連付けられていません。システム管理者にお問い合わせください。',
