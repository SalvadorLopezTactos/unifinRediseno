...
$connector_strings = [
    'LBL_LICENSING_INFO' => "Etapas para usar o conector DocuSign:
         <br> - Gerar uma chave de integração
         <br> - Habilitar o DocuSign Connect para envelopes
         (ou seja, o webhook usado pelo DocuSign para assinar um ponto de entrada do Sugar)
         <br> - Configurar um novo aplicativo no DocuSign e certificar-se de inserir o URI de redirecionamento e gerar uma chave secreta.
