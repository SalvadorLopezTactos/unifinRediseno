...
$connector_strings = [
    'LBL_LICENSING_INFO' => '<table border="0" cellspacing="1"><tr><td valign="top" width="35%" class="dataLabel">' .
        'Registrujte svoju Sugar instancu pomoću Dropbox -a kako biste omogućili konfiguraciju Dropbox naloga za korišćenje u okviru ' .
        'Sugar-a. </td></tr></table>',
    'client_id' => 'ID klijenta',
    'client_secret' => 'Tajni kôd klijenta',
];
