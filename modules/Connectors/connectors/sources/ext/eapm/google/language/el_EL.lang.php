...
$connector_strings = array(
    'LBL_LICENSING_INFO' => '<table border="0" cellspacing="1"><tr><td valign="top" width="35%" class="dataLabel">' .
        'Καταχωρήστε την περίπτωσή σας στο Sugar στην Google για να ενεργοποιήσετε τη διαμόρφωση των λογαριασμών Google για χρήση στο Sugar. ' .
        'Ανατρέξτε στο <a href="https://www.sugarcrm.com/crm/product_doc.php?edition={$flavor}&version={$version}&lang={$lang}&module=Connectors&route=Google" target=\'_blank\'>' .
