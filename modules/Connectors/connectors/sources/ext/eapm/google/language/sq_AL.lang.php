...
$connector_strings = array(
    'LBL_LICENSING_INFO' => '<table border="0" cellspacing="1"><tr><td valign="top" width="35%" class="dataLabel">' .
        'Regjistro instancën tënde të "Sugar" me "Google" për të mundësuar konfigurimin e llogarive të "Google" për përdorim në "Sugar". ' .
        'Referojuni <a href="https://www.sugarcrm.com/crm/product_doc.php?edition={$flavor}&version={$version}&lang={$lang}&module=Connectors&route=Google" target=\'_blank\'>' .
        '\' target=\'_blank\'>Dokumentacionit të bashkuesve</a> për informacion të mëtejshëm.</td></tr></table>',
