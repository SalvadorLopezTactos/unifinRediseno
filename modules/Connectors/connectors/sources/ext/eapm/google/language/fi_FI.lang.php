...
$connector_strings = array(
    'LBL_LICENSING_INFO' => '<table border="0" cellspacing="1"><tr><td valign="top" width="35%" class="dataLabel">' .
        'Rekisteröi käyttämäsi Sugar-instanssi Googlella, niin Google-tilejä voi määrittää käytettäväksi Sugarissa. ' .
        'Katso lisätietoja: <a href="https://www.sugarcrm.com/crm/product_doc.php?edition={$flavor}&version={$version}&lang={$lang}&module=Connectors&route=Google" target=\'_blank\'>' .
