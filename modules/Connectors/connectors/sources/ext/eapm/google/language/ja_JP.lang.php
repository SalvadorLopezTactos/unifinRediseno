...
$connector_strings = array(
    'LBL_LICENSING_INFO' => '<table border="0" cellspacing="1"><tr><td valign="top" width="35%" class="dataLabel">' .
        'Sugar内で使用するためのGoogleアカウント設定を有効にするには、GoogleでSugarインスタンスを登録してください。 ' .
        '<a href="https://www.sugarcrm.com/crm/product_doc.php?edition={$flavor}&version={$version}&lang={$lang}&module=Connectors&route=Google" target=\'_blank\'> を参照してください' .
