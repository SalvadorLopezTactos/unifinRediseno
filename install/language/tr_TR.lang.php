...
Rapor İşleme Tarihi ve Saati: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Şui kaydın yorum günlüğünde sizden bahsedildi: $record_name

Bu kaydı şu adreste inceleyebilirsiniz: <$record_url>
...
Yorumu görmek için lütfen Sugar\'a giriş yapın.',
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>Kısa süre önce $contact_user_pwd_last_changed adresinden hesap şifrenizi sıfırlayabilmek için talepte bulundunuz. </p><p>Şifrenizi sıfırlamak için şu bağlantıya tıklayın:</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
