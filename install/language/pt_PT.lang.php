...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'O Suporte da Base de dados não foi encontrado. Certifique-se de que possui os controladores necessários para um dos seguintes tipos de Base de dados suportados: MySQL, MS SQLServer, Oracle ou DB2. Poderá ser necessário anular comentários da extensão no ficheiro php.ini ou recompilar com o ficheiro binário correcto, dependendo da sua versão do PHP. Consulte o manual do PHP para obter mais informações sobre como activar o Suporte da Base de dados.',
...
Pode rever este registo em: <$record_url>
