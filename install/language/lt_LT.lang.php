...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Duomenų bazės palaikymas nerastas.  Įsitikinkite, kad turite reikiamas tvarkykles vienam iš šių palaikomų duomenų bazių tipų: „MySQL“, „MS SQLServer“, „Oracle“ arba DB2.  Priklausomai nuo PHP versijos, jums gali tekti panaikinti plėtinio komentarą php.ini faile arba iš naujo sukompiluoti tinkamą dvejetainį failą.  Daugiau informacijos apie tai, kaip įjungti duomenų bazės palaikymą, rasite PHP vadove.',
...
Ataskaitos vykdymo data ir laikas: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Jūs buvote paminėtas šio įrašo komentarų žurnale: $record_name

Šį įrašą galite peržiūrėti adresu: <$record_url>

Prisijunkite prie „Sugar“, kad peržiūrėtumėte komentarą.',
    ],
