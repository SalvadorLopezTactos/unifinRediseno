...
$mod_strings = [
    ...
    'ERR_DB_OCI8_VERSION' => 'Din version af Oracle (%s) er ikke understøttet af Sugar. Du skal installere en version, der er kompatibel med Sugar. Se venligst kompatibilitets matrixen i udgivelsesnoterne for understøttede Oracle-versioner.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databasesupport blev ikke fundet.  Sørg for, at du har de nødvendige drivere til en af de følgende understøttede databasetyper: MySQL, MS SQLServer, Oracle eller DB2.  Det kan være nødvendigt at fjerne udvidelsen i php.ini-filen eller genkompilere med den rigtige binære fil, afhængigt af din version af PHP.  Se din PHP-manual for at få flere oplysninger om, hvordan du aktiverer databaseunderstøttelse.',
...
Rapportens kørselsdato og -tid: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Du er blevet nævnt i følgende posts kommentarlog: $record_name

Du kan gennemgå denne post på: <$record_url>
