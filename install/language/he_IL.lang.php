...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'לא נמצאה תמיכה במסד נתונים.  נא לוודא שיש לך מנהלי ההתקנים הדרושים לאחד מהסוגים הנתמכים הבאים של מסדי נתונים: MySQL, MS SQLServer, Oracle או DB2.  ייתכן שיהיה צורך להוציא את הסיומת ממעמד של הערה בקובץ php.ini או לבצע הידור מחדש עם הקובץ הבינארי המתאים, בהתאם לגרסת ה-PHP שלך.  במדריך ה-PHP אפשר למצוא מידע נוסף המסביר איך לאפשר תמיכה במסדי נתונים.',
    ...
    'ERR_SI_NO_CONFIG' => 'לא כללת את config_si.php בספרייה הראשית, או שלא הגדרת את $sugar_config_si ב-config.php',
...
התאריך והשעה של הפקת הדוח: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'הוזכרת ביומן ההערות של הרשומה הבאה: $record_name

אפשר לעיין ברשומה כאן: <$record_url>

כדי לצפות בהערה, יש להיכנס אל Sugar.',
    ],
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>לאחרונה, ביקשת ב-$contact_user_pwd_last_changed את האפשרות לאפס את סיסמת החשבון שלך. </p><p>כדי לאפס את סיסמתך, נא ללחוץ על הקישור למטה:</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
