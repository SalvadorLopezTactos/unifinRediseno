...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No s\'ha trobat suport de bases de dades.  Assegureu-vos que teniu els controladors necessaris per a un dels següents tipus de bases de dades compatibles: MySQL, MS SQLServer, Oracle o DB2.  És possible que hàgiu de descomentar l\'extensió al fitxer php.ini o recompilar amb el fitxer binari adequat, depenent de la vostra versió de PHP.  Consulteu el vostre manual de PHP per obtenir més informació sobre com habilitar el suport de bases de dades.',
...
Data i hora d\'execució de l\'informe: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Se us ha esmentat al registre de comentaris del registre següent: $record_name

Podeu revisar aquest registre a: <$record_url>

Si us plau, inicieu sessió a Sugar per veure el comentari.',
    ],
