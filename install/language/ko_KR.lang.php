...
$mod_strings = [
    ...
    'ERR_DB_IBM_DB2_VERSION' => '귀하의 DB2(%s)버전은 Sugar에서 지원되지 않습니다.  Sugar 애플리케이션과 호환되는 버전을 설치해야 합니다.  지원되는 DB2 버전은 릴리스 노트의 호환성 매트릭스를 참조하십시오.',
    ...
    'ERR_DB_OCI8_VERSION' => '사용 중인 Oracle(%s) 버전은 Sugar에서 지원하지 않습니다.  Sugar 애플리케이션과 호환되는 버전을 설치해야 합니다.  지원되는 Oracle 버전은 릴리스 노트의 호환성 매트릭스를 참조하십시오.',
    ...
    'ERR_DB_MYSQL_VERSION' => '귀하의 MySQL 버전(%s)은 Sugar에서 지원되지 않습니다.  Sugar 애플리케이션과 호환되는 버전을 설치해야 합니다.  지원되는 MySQL 버전은 릴리스 노트의 호환성 매트릭스를 참조하십시오.',
...
<$decline_link>',
    ...
    'scheduled_report_email' => [
        'name' => '보고서 일정 이메일',
        'subject' => '예정된 보고서: $report_time 기준 $report_name',
...
보고서 실행 날짜 및 시간: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            '당신은 다음 레코드의 코멘트 로그에 언급되었습니다: $record_name

이 레코드는 <$record_url>에서 검토할 수 있습니다.

댓글을 보려면 Sugar에 로그인하세요.',
    ],
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>최근에 $contact_user_pwd_last_changed에 계정 암호를 재설정할 수 있도록 요청했습니다.</p><p>비밀번호를 재설정하려면 아래 링크를 클릭하십시오.</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
            '
최근에 $contact_user_pwd_last_changed에 계정 비밀번호를 재설정할 수 있도록 요청하셨습니다.

암호를 재설정하려면 아래 링크를 클릭하십시오.
