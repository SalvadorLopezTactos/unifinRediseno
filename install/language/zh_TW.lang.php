...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '未找到資料庫支援。 請確保您具有以下受支援的資料庫類型之一所需的驅動程式：MySQL、MS SQLServer、Oracle 或 DB2。 您可能需要取消註解 php.ini 檔案中的副檔名，或使用正確的二進位檔案重新編譯，具體取決於您的 PHP 版本。 有關如何啟用資料庫支援的更多資訊，請參閱您的 PHP 手冊。',
...
報告開始日期與時間: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            '以下記錄的評論記錄中提到了您：$record_name

您可以在以下位置檢閱該記錄：<$record_url>
