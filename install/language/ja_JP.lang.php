...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'データベースサポートが見つかりませんでした。対応しているデータベースタイプ（MySQL、MS SQLServer、Oracle、またはDB2）のいずれかに必要なドライバがあることを確認してください。PHPのバージョンによっては、php.iniファイルの拡張子のコメントの解除、または正しいバイナリファイルによる再コンパイルが必要になる場合があります。データベースサポートを有効にする方法に関する詳細については、PHPマニュアルをご覧ください。',
...
レポート実行日時：$report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'あなたは次のレコードのコメントログでメンションされています：$record_name

この記録は、 <$record_url> で確認できます

コメントを表示するには、Sugarにログインしてください。',
    ],
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>あなたは、$contact_user_pwd_last_changed でアカウントパスワードのリセットを依頼しました。</p><p>パスワードをリセットするには、以下のリンクをクリックしてしてください：</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
