...
Pārskata izpildes datums un laiks: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Jūs tikāt pieminēts šī ieraksta komentāru žurnālā: $record_name

Jūs varat pārskatīt šo ierakstu: <$record_url>

Lūdzu, piesakieties Sugar, lai apskatītu komentāru.',
    ],
