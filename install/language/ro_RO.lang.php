...
$mod_strings = [
    ...
    'ERR_DB_IBM_DB2_VERSION' => 'Versiunea dvs. de DB2 (%s) nu este suportată de Sugar.  Va trebui să instalați o versiune compatibilă cu aplicația Sugar.  Vă rugăm să consultați matricea de compatibilitate din notele de lansare pentru versiunile DB2 acceptate.',
    ...
    'ERR_DB_OCI8_VERSION' => 'Versiunea dvs. de Oracle (%s) nu este suportată de Sugar.  Va trebui să instalați o versiune compatibilă cu aplicația Sugar.  Consultați Matricea de compatibilitate din notele de lansare pentru versiunile Oracle acceptate.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Suportul pentru baze de date nu a fost găsit. Asigurați-vă că aveți driverele necesare pentru unul dintre următoarele tipuri de baze de date acceptate: MySQL, MS SQLServer, Oracle sau DB2. Poate fi necesar să scoateți extensia din fișierul php.ini sau să recompilați cu fișierul binar corect, în funcție de versiunea dvs. PHP. Consultați manualul PHP pentru mai multe informații despre cum să activați suportul bazei de date.',
    ...
    'ERR_DB_MYSQL_VERSION' => 'Versiunea dvs. MySQL (%s) nu este suportată de Sugar.  Va trebui să instalați o versiune compatibilă cu aplicația Sugar.  Vă rugăm să consultați Matricea de compatibilitate din notele de lansare pentru versiunile MySQL acceptate.',
...
Data și ora raportului: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Ați fost menționat în jurnalul de comentarii al următoarei înregistrări: $record_name

Puteți revizui această înregistrare la: <$record_url>

Vă rugăm să vă conectați la Sugar pentru a vedea comentariul.',
    ],
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>Ați solicitat recent pe $contact_user_pwd_last_changed pentru a vă putea reseta parola contului. </p><p>Faceți clic pe linkul de mai jos pentru a vă reseta parola:</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
            '
Ați solicitat recent pe $contact_user_pwd_last_changed pentru a vă putea reseta parola contului.
