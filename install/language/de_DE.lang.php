...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Keine Datenbankunterstützung gefunden. Stellen Sie sicher, dass Sie über die erforderlichen Treiber für einen der folgenden unterstützten Datenbanktypen verfügen: MySQL, MS SQLServer, Oracle oder DB2. Abhängig von Ihrer PHP-Version müssen Sie möglicherweise die Erweiterung in der Datei php.ini auskommentieren oder mit der richtigen Binärdatei neu kompilieren. Bitte suchen Sie in Ihrem PHP-Handbuch nach weiteren Informationen darüber, wie Sie die Datenbankunterstützung aktivieren können.',
...
Sie können diesen Datensatz einsehen unter: <$record_url>

Bitte melden Sie sich bei Sugar an, um den Kommentar zu sehen.',
    ],
