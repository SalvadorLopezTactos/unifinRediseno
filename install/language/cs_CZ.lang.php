...
$mod_strings = [
    ...
    'ERR_DB_OCI8_VERSION' => 'Vaše verze systému Oracle (%s) není systémem SugarCRM podporována. Je třeba nainstalovat verzi, která je kompatibilní se systémem SugarCRM. Prosíme, použijte „matici kompatibility” v Poznámkách k vydání ke zjištění podporovaných verzí systému Oracle.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Podpora databáze nebyla nalezena. Ujistěte se, že máte potřebné ovladače pro jeden z následujících podporovaných typů databáze: MySQL, MS SQLServer, Oracle nebo DB2. Možná budete muset odkomentovat příponu v souboru php.ini nebo znovu zkompilovat se správným binárním souborem, v závislosti na vaší verzi PHP. Další informace o tom, jak povolit podporu databáze, naleznete v příručce PHP.',
...
Tento záznam si můžete prohlédnout na adrese: <$record_url>
...
Chcete-li si komentář přečíst, přihlaste se prosím do systému Sugar.',
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>Nedávno jste v $contact_user_pwd_last_changed požádal(a) o možnost obnovit heslo k účtu.</p><p>Chcete-li heslo obnovit, klikněte na níže uvedený odkaz:</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
