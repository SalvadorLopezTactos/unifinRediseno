...
<p>Se adjunta un informe generado automáticamente que se ha programado para usted.<br></p>
...
Fecha y hora de ejecución del informe: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Se le ha mencionado en el registro de comentarios del siguiente registro: $record_name

Puede revisar este registro en: <$record_url>
