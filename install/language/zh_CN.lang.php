...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '未找到数据库支持。请确保您具有以下受支持的数据库类型之一所需的驱动程序：MySQL、MS SQLServer、Oracle 或 DB2。您可能需要在 php.ini 文件中取消对扩展名的注释，或使用正确的二进制文件重新编译，具体取决于您的 PHP 版本。有关如何启用数据库支持的更多信息，请参阅您的 PHP 手册。',
...
报表运行报告和时间：$report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            '在以下记录的评论日志中提到了您： $record_name

您可以在以下位置查看此记录： <$record_url>
...
请登录 Sugar 查看评论。',
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>您最近通过 $contact_user_pwd_last_changed 申请重置账户密码。</p><p>点击下面的链接重置密码：</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
            '
