...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'O suporte ao banco de dados não foi encontrado. Verifique se você tem os drivers necessários para um dos seguintes tipos de banco de dados compatíveis: MySQL, MS SQLServer, Oracle ou DB2.  Você pode precisar descomentar a extensão no arquivo php.ini ou recompilar com o arquivo binário correto, dependendo da versão do PHP.  Consulte o Manual do PHP para ver mais informações sobre como ativar o suporte a banco de dados.',
...
Data e hora de geração do relatório: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Você foi mencionado no registro de comentários do registro a seguir: $record_name

Você pode analisar esse registro em: <$record_url>
