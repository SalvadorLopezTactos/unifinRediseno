...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Tietokantatukea ei löytynyt.  Varmista, että käytössäsi on tarvittavat ohjaimet jollekin seuraavista tuetuista tietokantatyypeistä: MySQL, MS SQLServer, Oracle tai DB2.  Sinun pitää ehkä poistaa kommenttimerkintä lisäosan edestä php.ini-tidostossa, tai kääntää uudelleen oikealla binääritiedostolla, PHP-versiostasi riippuen.  Katso lisätietoja tietokantatuen käyttöönotosta PHP-oppaasta.',
...
Voit tarkastella tietuetta kohteessa: <$record_url>

Kirjaudu Sugariin lukeaksesi kommentin.',
    ],
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>Pyysit äskettäin kohteessa $contact_user_pwd_last_changed tilisi salasanan vaihtoa. </p><p>Vaihda salasanasi napsauttamalla alla olevaa linkkiä:</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
