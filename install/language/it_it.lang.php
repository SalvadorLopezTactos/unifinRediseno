...
$mod_strings = [
    ...
    'ERR_DB_OCI8_VERSION' => 'La tua versione di Oracle (%s) non è supportata da Sugar. Dovrai installare una versione compatibile con l\'applicazione Sugar. Consulta la matrice di compatibilità nelle note di rilascio per le versioni Oracle supportate.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Il supporto del database non è stato trovato. Assicurarsi di disporre dei driver necessari per uno dei seguenti tipi di database supportati: MySQL, MS SQLServer, Oracle o DB2. Potrebbe essere necessario rimuovere il commento dall\'estensione del file php.ini o ricompilarlo con il file binario corretto, a seconda della versione di PHP. Consultare il manuale PHP per ulteriori informazioni su come abilitare il supporto database.',
...
Data e ora di esecuzione del report: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Sei stato menzionato nel registro dei commenti del seguente record: $record_name

Puoi rivedere questo record su: <$record_url>
