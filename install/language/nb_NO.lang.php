...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databasestøtte ble ikke funnet.  Påse at du har de nødvendige driverne for en av følgende støttede databasetyper: MySQL, MS SQLServer, Oracle eller DB2.  Du må kanskje fjerne kommentarer i utvidelsen i php.ini-filen, eller kompilere på nytt med riktig binærfil, avhengig av din versjon av PHP.  Se PHP-håndboken for mer informasjon om hvordan du aktiverer Databasestøtte.',
...
Dato og klokkeslett for rapportkjøring: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Du har blitt nevnt i kommentarloggen til følgende post: $record_name

Du kan gå gjennom denne posten på: <$record_url>

Logg inn på Sugar for å se kommentaren.',
    ],
