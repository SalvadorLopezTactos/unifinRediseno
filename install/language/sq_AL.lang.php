...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Mbështetja e bazës së të dhënave nuk u gjet. Sigurohu që ke njësitë e nevojshme për një nga llojet e mëposhtme të bazave të të dhënave të mbështetura: MySQL, MS SQLServer, Oracle ose DB2. Mund të jetë e nevojshme që të heqësh shtesën në skedarin php.ini ose ta ripërpilosh me skedarin e duhur binar, në varësi të versionit tënd të PHP. Referoju manualit të PHP për më shumë informacion mbi mënyrën e aktivizimit të mbështetjes së bazës së të dhënave.',
    ...
    'ERR_SI_NO_CONFIG' => 'Nuk ke përfshirë config_si.php në rrënjën e dokumentit ose nuk ke përcaktuar $sugar_config_si në config.php',
...
Data dhe ora e ekzekutimit të raportit: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Je përmendur në evidencën në vijim të komenteve të regjistrit: $record_name

Mund të rishikosh regjistrin në: <$record_url>
...
Identifikohu në Sugar për të parë komentin.',
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>Ke kërkuar së fundmi në $contact_user_pwd_last_changed të rivendosësh fjalëkalimin e llogarisë tënde. </p><p>Kliko në lidhjen e mëposhtme për të rivendosur fjalëkalimin:</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
            '
Ke kërkuar së fundmi në $contact_user_pwd_last_changed të rivendosësh fjalëkalimin e llogarisë tënde.

Kliko në lidhjen e mëposhtme për të rivendosur fjalëkalimin:
