...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'لم يتم العثور على دعم قاعدة البيانات. الرجاء التأكد من امتلاكك ملفات التعريف الضرورية لأحد أنواع قواعد البيانات المدعومة التالية: MySQL أو MS SQLServer أو Oracle أو DB2. قد تحتاج إلى إلغاء ربط الامتداد في ملف php.ini أو إعادة تكوينه باستخدام الملف الثنائي الصحيح، بحسب إصدار PHP لديك. الرجاء الرجوع إلى دليل PHP لمزيد من المعلومات بشأن كيفية تمكين "دعم قاعدة البيانات".',
...
تاريخ ووقت تشغيل التقرير: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'تمت الإشارة إليك في سجل التعليقات الخاص بالسجل التالي: $record_name

يمكنك مراجعة هذا السجل في: <$record_url>

يرجى تسجيل الدخول إلى Sugar لعرض التعليق.',
    ],
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>طلبت مؤخرًا في $contact_user_pwd_last_changed أن تتمكن من إعادة ضبط كلمة مرور حسابك. </p><p>انقر على الارتباط أدناه لإعادة ضبط كلمة المرور الخاصة بك:</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
            '
