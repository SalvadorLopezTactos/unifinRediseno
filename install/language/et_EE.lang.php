...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Andmebaasituge ei leitud. Veenduge, et teil oleksid olemas vajalikud draiverid ühele järgmistest toetatud andmebaasitüüpidest: MySQL, MS SQLServer, Oracle või DB2. Olenevalt teie PHP versioonist võib olla vaja php.ini-failis laiend lahti kommenteerida või õige kahendfailiga uuesti kompileerida. Lisateavet andmebaasitoe lubamise kohta leiate oma PHP juhendist.',
...
Kirjet on teil võimalik vaadata: <$record_url>

Kommentaari nägemiseks logige sisse Sugarisse.',
    ],
