...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'La prise en charge de la base de données n\'a pas été trouvée. Assurez-vous de disposer des pilotes nécessaires pour l’un des types de base de données pris en charge suivants : MySQL, MS SQLServer, Oracle, ou DB2. Vous devrez peut-être décommenter l’extension dans le fichier php.ini ou recompiler avec le bon fichier binaire, selon votre version de PHP. Veuillez vous référer à votre manuel PHP pour plus d’informations sur la façon d’activer la prise en charge des bases de données.',
...
Vous pouvez consulter cet enregistrement à l\'adresse suivante <$record_url>
...
Veuillez vous connecter à Sugar pour voir le commentaire.',
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>Vous avez récemment demandé sur $contact_user_pwd_last_changed de pouvoir réinitialiser le mot de passe de votre compte. </p><p>Cliquez sur le lien ci-dessous pour réinitialiser votre mot de passe :</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
            '
