...
$mod_strings = [
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Adatbázis-támogatás nem található. Győződjön meg arról, hogy rendelkezik a szükséges illesztőprogramokkal a következő támogatott adatbázistípusok egyikéhez: MySQL, MS SQLServer, Oracle vagy DB2.  Előfordulhat, hogy törölnie kell a kiterjesztést a php.ini fájlban, vagy újra kell fordítania a megfelelő bináris fájllal a PHP verziójától függően.  Kérjük, olvassa el a PHP kézikönyvét az adatbázis-támogatás engedélyezésével kapcsolatos további információkért.',
...
Jelentés futtatásának dátuma és ideje: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Megemlítették Önt a következő bejegyzés megjegyzésnaplójában: $record_name

Megtekintheti a jelentést itt: <$record_url>

Kérjük, jelentekzzen be a Sugar alkalamzásba a megjegyzs megtekintéséhez.',
    ],
