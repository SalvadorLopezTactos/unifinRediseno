...
$mod_strings = [
    ...
    'ERR_DB_OCI8_VERSION' => 'Вашата версия на Oracle (%s) не се поддържа от Sugar. Трябва да инсталирате версия, която е съвместима с приложението Sugar. Моля, консултирайте се с матрицата за съвместимост за поддържаните версии на Oracle в „Бележки за версията".',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Не беше открита „Поддръжка на база данни".  Моля, уверете се, че имате необходимите драйвери за един от следните поддържани типове бази данни: MySQL, MS SQLServer, Oracle или DB2.  Може да се наложи да отмените коментара на разширението на файла php.ini или да компилирате повторно с правилния двоичен файл според Вашата версия на PHP.  Моля, направете справка в ръководството си за РНР за повече информация за това как да активирате „Поддръжка на база данни".',
...
Можете да прегледате този запис на: <$record_url>
