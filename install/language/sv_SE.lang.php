...
$mod_strings = [
    ...
    'ERR_DB_OCI8_VERSION' => 'Din version av Oracle (%s) stöds ej av Sugar. Du måste installera en version som är kompatibel med Sugar-applikationen. Se Compatibility Matrix i Publicerade anteckningar för Oracle-versioner som stöds.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databasstöd hittades inte. Se till att du har de nödvändiga drivrutinerna för en av följande databasversioner som stöds: MySQL, MS SQLServer, Oracle eller DB2. Du kan behöva avkommentera tillägget i php.ini-filen eller rekompilera med rätt binär fil, beroende på din PHP-version. Mer information om hur du aktiverar databasstöd finns i din PHP-manual.',
...
Rapportens löpdatum och -tid: $report_time',
    ...
    'comment_log_mention_email' => [
        ...
        'txt_body' =>
            'Du har blivit omnämnd i kommentarsloggen i följande post: $record_name

Du kan granska den här posten på: <$record_url>

Logga in till Sugar för att se kommentaren.',
    ],
    ...
    'advanced_password_forgot_password_email' => [
        ...
        'body' => '<div><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\" width="550" align=\"\&quot;\&quot;center\&quot;\&quot;\"><tbody><tr><td colspan=\"2\"><p>Du begärde nyligen på $contact_user_pwd_last_changed att kunna återställa lösenordet till ditt konto. </p><p>Klicka på länken nedan för att återställa ditt lösenord:</p><p> <a href="$contact_user_link_guid">$contact_user_link_guid</a> </p> </td> </tr><tr><td colspan=\"2\"></td> </tr> </tbody></table> </div>',
        'txt_body' =>
