...
$dictionary['lev_Backlog']['fields']['ri_sin_solicitud_c']['related_fields'][0] = 'currency_id';
$dictionary['lev_Backlog']['fields']['ri_sin_solicitud_c']['related_fields'][1] = 'base_rate';
