...
$dictionary['lev_Backlog']['fields']['ri_final_comprometida_c']['related_fields'][0] = 'currency_id';
$dictionary['lev_Backlog']['fields']['ri_final_comprometida_c']['related_fields'][1] = 'base_rate';
