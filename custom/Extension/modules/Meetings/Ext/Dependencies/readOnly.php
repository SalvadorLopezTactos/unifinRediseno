    ...
    (
        ...
        (
            ...
            (
                ...
                'value' => 'or(equal($status,"Held"),equal($status,"Not Held"),contains($description,"Cita registrada automaticamente por CRM ya que ha sido asignado como acompaniante."))',
            ),
        ),
        array
        (
