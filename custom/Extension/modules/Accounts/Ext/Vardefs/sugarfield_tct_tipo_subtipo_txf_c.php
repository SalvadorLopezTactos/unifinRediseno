...
$dictionary['Account']['fields']['tct_tipo_subtipo_txf_c']['formula'] = 'ifElse(equal($tipo_registro_c,"4"),"PERSONA",ifElse(equal($tipo_registro_c,"5"),"PROVEEDOR",strToUpper(concat(getDropdownValue("tipo_registro_list",$tipo_registro_c)," ",getDropdownValue("subtipo_cuenta_list",$subtipo_cuenta_c)))))';
