...
$dictionary['Account']['fields']['name']['formula']='ifElse(equal($tipodepersona_c,"Persona Moral"),$razonsocial_c,concat($primernombre_c," ",$segundonombre_c,ifElse(equal($segundonombre_c,""),""," "),$apellidopaterno_c,ifElse(equal($apellidomaterno_c,""),""," "),$apellidomaterno_c))';
