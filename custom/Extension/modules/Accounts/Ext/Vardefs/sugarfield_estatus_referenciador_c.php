...
$dictionary['Account']['fields']['estatus_referenciador_c']['dependency'] = 'and(or(equal($tipo_registro_cuenta_c,"5"),equal($esproveedor_c,true)),equal($es_referenciador_c,true))';
