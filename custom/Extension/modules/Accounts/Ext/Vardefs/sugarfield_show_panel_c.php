...
$dictionary['Account']['fields']['show_panel_c']['formula']='ifElse(or(equal($tipo_registro_cuenta_c,"1"),equal($tipo_registro_cuenta_c,"2"),equal($tipo_registro_cuenta_c,"3"),equal($tipo_registro_cuenta_c,"5")),true,false)';
