...
$dictionary['Account']['fields']['show_panel_c']['formula']='ifElse(or(equal($tipo_registro_c,"Lead"),equal($tipo_registro_c,"Prospecto"),equal($tipo_registro_c,"Cliente"),equal($tipo_registro_c,"Proveedor")),true,false)';
