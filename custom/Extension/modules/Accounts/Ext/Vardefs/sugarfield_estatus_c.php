...
$dictionary['Account']['fields']['estatus_c']['visibility_grid']['values']['Prospecto'][3] = 'En Proceso';
$dictionary['Account']['fields']['estatus_c']['visibility_grid']['values']['Cliente'][0] = 'Integracion de Expediente';
$dictionary['Account']['fields']['estatus_c']['visibility_grid']['values']['Cliente'][1] = 'Con Linea';
$dictionary['Account']['fields']['estatus_c']['full_text_search']['boost'] = 1;
