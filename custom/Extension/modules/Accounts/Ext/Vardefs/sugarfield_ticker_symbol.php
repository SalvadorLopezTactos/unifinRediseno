...
$dictionary['Account']['fields']['ticker_symbol']['full_text_search']['enabled'] = true;
$dictionary['Account']['fields']['ticker_symbol']['full_text_search']['searchable'] = true;
$dictionary['Account']['fields']['ticker_symbol']['full_text_search']['boost'] = 1;
