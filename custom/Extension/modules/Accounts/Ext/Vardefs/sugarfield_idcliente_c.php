...
$dictionary['Account']['fields']['idcliente_c']['dependency'] = 'or(equal($tipo_registro_c,"3"),equal($tipo_registro_c,"5"),equal($tipo_registro_c,"4"),equal($estatus_c,"Interesado"))';
