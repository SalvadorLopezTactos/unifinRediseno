...
$dictionary['Account']['fields']['website']['full_text_search']['enabled'] = true;
$dictionary['Account']['fields']['website']['full_text_search']['searchable'] = false;
$dictionary['Account']['fields']['website']['full_text_search']['boost'] = 1;
...
$dictionary['Account']['fields']['website']['dependency'] = 'equal($estatus_c,"Interesado")';
