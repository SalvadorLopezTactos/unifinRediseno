...
$dictionary['Account']['fields']['tct_cpld_pregunta6_mon_c']['related_fields'][0] = 'currency_id';
$dictionary['Account']['fields']['tct_cpld_pregunta6_mon_c']['related_fields'][1] = 'base_rate';
