            ...
            'actions' => array(
                    array(
                            ...
                            'params' => array(
                                    ...
                                    'value' => 'and(or(equal($tipo_registro_c,"Cliente"),equal($subtipo_cuenta_c,"Integracion de Expediente")),or(equal($tipodepersona_c,"Persona Fisica"),equal($tipodepersona_c,"Persona Fisica con Actividad Empresarial")))',
            ...
            'actions' => array(
                    array(
                            ...
                            'params' => array(
                                    ...
                                    'value' => 'and(or(equal($tipo_registro_c,"Cliente"),equal($subtipo_cuenta_c,"Integracion de Expediente")),equal($tipodepersona_c,"Persona Moral"))',
                            ),
                    ),
            ),
    );
