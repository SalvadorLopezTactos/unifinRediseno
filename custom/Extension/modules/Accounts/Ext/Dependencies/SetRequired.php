            ...
            'actions' => array(
                    array(
                            ...
                            'params' => array(
                                ...
                                'value' => 'not(or(equal($tipodepersona_c,"Persona Moral"),equal($tipo_registro_c,"Persona"),equal($tipo_registro_c,"Lead"),equal($subtipo_cuenta_c,"Contactado"),equal($subtipo_cuenta_c,"Interesado")))',
                            ),
                    ),
            ),
    );
            ...
            'actions' => array(
                    array(
                            ...
                            'params' => array(
                                    ...
                                    'value' => 'or(and(not(equal($tipo_registro_c,"Lead"),equal($tipo_registro_c,"Persona")),not(equal($subtipo_cuenta_c,"Contactado"),equal($tipo_registro_c,"Cliente"))))',
                            ),
                    ),
            ),
    );
    ...
    'actions' => array(
        array(
            ...
            'params' => array(
                'target' => 'sectoreconomico_c',
                'label' => 'sectoreconomico_c_label',
                'value' => 'not(or(equal($tipo_registro_c,"Lead"),equal($subtipo_cuenta_c,"Contactado"),equal($tipo_registro_c,"Proveedor")))',
            ),
        ),
    ),
);
