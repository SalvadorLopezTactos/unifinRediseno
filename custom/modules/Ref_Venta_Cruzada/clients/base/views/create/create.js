({
	...
	producto_repetido: function (fields, errors, callback) {
		...
		app.api.call("read", app.api.buildURL("Accounts/" + this.model.get('accounts_ref_venta_cruzada_1accounts_ida') + "/link/accounts_ref_venta_cruzada_1", null, null,null), null, {
