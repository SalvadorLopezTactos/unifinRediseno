...
class Validate_Email
{
    public function existsEmail($bean = null, $event = null, $args = null)
    {
        ...
        if($db->getRowCount($queryResultEmail) > 0 && $id_po != $bean->id) throw new SugarApiExceptionInvalidParameter('No se puede guardar el registro. El correo electrónico '.$email.' ya existe en Público Objetivo, favor de corregir'); 
    }
}
