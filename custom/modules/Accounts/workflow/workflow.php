...
class Accounts_workflow {
 ...
 (isset($focus->estatus_c) && $focus->estatus_c ==  stripslashes('No Interesado'))){ 
	...
	if (!isset($triggeredWorkflows['c274a4be_17a3_11ef_9ad8_b6b41b25c921'])){
		$triggeredWorkflows['c274a4be_17a3_11ef_9ad8_b6b41b25c921'] = true;
	    unset($alertshell_array);
		$action_meta_array['Accounts0_action0']['trigger_id'] = 'c274a4be_17a3_11ef_9ad8_b6b41b25c921';
	$action_meta_array['Accounts0_action0']['action_id'] = '161c7f1f-0aee-47f9-5414-558ae285e632';
 	...
 	$action_meta_array['Accounts0_action1']['trigger_id'] = 'c274a4be_17a3_11ef_9ad8_b6b41b25c921';
