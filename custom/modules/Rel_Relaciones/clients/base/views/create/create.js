                                         ...
                                         if (data[4].contents.deudor_factor_c==true){
                                           ...
                                           /* if (data[3].contents.records.length>0){
                                            ...
                                            if (necesarios!="") {
                                                ...
                                                level: "error",
                                                title: "Hace falta completar la siguiente información en la <b>Cuenta</b>"+ '<a href="#Accounts/' + this.model.get("account_id1_c")  +'" target= "_blank"> ' + this.model.get('relacion_c') + '  </a>' + 'para una relación de Producto Uniclick:<br> ' + necesarios,
                                                autoClose: false
                                                    });
