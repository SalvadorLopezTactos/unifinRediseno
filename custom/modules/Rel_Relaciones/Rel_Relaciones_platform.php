    ...
    public function set_audit_user_platform($bean = null, $event = null, $args = null){
        ...
        if(in_array($plataforma,$plataformas_array)){
            ...
            if($id_user!=""){
                ...
                $sqlInsert="INSERT INTO `rel_relaciones_audit` (`id`,`parent_id`,`date_created`,`created_by`,`field_name`,`data_type`,`before_value_string`,`after_value_string`,`before_value_text`,`after_value_text`,`event_id`,`date_updated`)
