...
WHERE op_rel.account_id = '{$accountId}' AND op_cstm.tipo_producto_c = '{$prouctId}' AND  op_cstm.negocio_c='{$negocio}' AND op_cstm.producto_financiero_c = '{$producto}' AND op_rel.deleted = 0";
