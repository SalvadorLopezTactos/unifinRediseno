 ...
 * PLACE ANY CUSTOMIZATIONS IN QPRO_Encuestas
 */


class QPRO_Encuestas_sugar extends Basic {
    public $new_schema = true;
    public $module_dir = 'QPRO_Encuestas';
    public $object_name = 'QPRO_Encuestas';
    public $table_name = 'qpro_encuestas';
