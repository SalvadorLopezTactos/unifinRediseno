...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Модуль {{plural_module_name}} дозволяє відстежувати індивідуальні продажі від самого початку й до кінця. Кожен запис {{module_name}} є потенційним продажем і містить відповідні відомості щодо продажу, а також дані, що стосуються інших важливих записів, як-от {{quotes_module}}, {{contacts_module}} тощо. {{module_name}} зазвичай проходить через декілька етапів продажу, поки не буде позначений як «Успішно закритий» або «Втрачений і закритий». Користь від {{plural_module_name}} можна збільшити, використовуючи модуль Sugar {{forecasts_singular_module}}, щоб розуміти й передбачити тенденції продаж, а також зосередити роботу на досягненні встановлених квот продаж.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Модуль {{plural_module_name}} дає змогу відстежувати окремі продажі та продукти, яких ці продажі стосуються, від початку до кінця. Кожен запис {{module_name}} відображає потенційну операцію продажу та включає відповідні дані про продаж, а також дані щодо інших важливих записів на кшталт {{quotes_module}}, {{contacts_module}} тощо.

- Змінити поля цього запису можна, натиснувши окреме поле або кнопку «Редагувати».
- Перегляд або зміна посилань на інші записи в підпанелях здійснюється шляхом перемикання лівої нижньої панелі на «Перегляд даних».
- Взаємодія з коментарями користувачів і перегляд історії змін запису в {{activitystream_singular_module}} виконується за допомогою перемикання нижньої лівої панелі на «Стрічку активності».
- Підпишіться на цей запис чи додайте його у вибране за допомогою піктограм праворуч від назви запису.
- Додаткові дії доступні в розкривному меню дій праворуч від кнопки «Редагувати».',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'Модуль {{plural_module_name}} дає змогу відстежувати окремі продажі та продукти, яких ці продажі стосуються, від початку до кінця. Кожен запис {{module_name}} відображає потенційну операцію продажу та включає відповідні дані про продаж, а також дані щодо інших важливих записів на кшталт {{quotes_module}}, {{contacts_module}} тощо.

Щоб створити {{module_name}}:
1. Введіть значення у потрібних полях.
 - Поля, позначені як обов’язкові, потрібно заповнити перед збереженням.
 - Натисніть «Докладно», щоб за потреби відобразити додаткові поля.
