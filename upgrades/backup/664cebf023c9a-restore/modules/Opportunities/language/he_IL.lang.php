...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'המודול {{plural_module_name}} מאפשר לעקוב אחר מכירות פרטניות, מההתחלה עד הסוף. כל רשומה של {{module_name}} מייצגת מכירה פוטנציאלית, וכוללת נתונים רלוונטיים למכירה ולרשומות חשובות אחרות, למשל {{quotes_module}}, {{contacts_module}} ועוד. בדרך כלל, ההתקדמות של {{module_name}} נעשית בכמה שלבי מכירה, עד לסימון בתור "נסגר הושג" או "נסגר הופסד". אפשר למנף עוד יותר את {{plural_module_name}} עם השימוש במודול {{forecasts_singular_module}} של Sugar, על מנת להבין ולחזות מגמות במכירות, כמו גם למקד את העבודה בהגשמה של מיכסות מכירה.',
...
- הצג או שנה קישורים לרשומות אחרות בתתי הלוחות על ידי שינוי מצב החלונית בפינה התחתונה ל"תצוגת נתונים".
- צור והצג הערות משתמשים ותעד את היסטוריית השינויים ב-{{activitystream_singular_module}} על-ידי שינוי מצב החלונית בפינה התחתונה ל"זרימת פעילות".
- עקוב אחר רשומה זו או סמן אותה כמועדפת באמצעות הסמלים לצד שמה.
