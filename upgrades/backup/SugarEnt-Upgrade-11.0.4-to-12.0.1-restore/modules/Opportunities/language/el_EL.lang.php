...
υπόδειγμά σας θα πρέπει να διαμορφωθεί για την αποστολή email μέσω του Admin > Email Settings για να είναι εφικτή η αποστολή ειδοποιήσεων.',
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Η μονάδα {{plural_module_name}} σάς επιτρέπει να παρακολουθείτε μεμονωμένες πωλήσεις από την αρχή έως το τέλος. Κάθε εγγραφή {{module_name}} αντιπροσωπεύει μια προοπτική πώλησης και περιλαμβάνει δεδομένα σχετικά με την πώληση καθώς και σχετικά με άλλα σημαντικά αρχεία όπως {{quotes_module}}, {{contacts_module}}, κ.λπ. Μία μονάδα {{module_name}} συνήθως θα προχωρήσει μέσα από διάφορα στάδια πωλήσεων, έως ότου επισημανθεί είτε ως «Έκλεισε Κερδισμένη» είτε ως «Έκλεισε Χαμένη». Η μονάδα {{plural_module_name}} μπορεί να ενισχυθεί ακόμη περισσότερο, χρησιμοποιώντας τη λειτουργική μονάδα {{forecasts_singular_module}} του Sugar για να κατανοήσετε και να προβλέψετε τάσεις πωλήσεων, και να επικεντρωθείτε στην επίτευξη ποσοστώσεων πωλήσεων.',
