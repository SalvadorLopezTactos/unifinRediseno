...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'โมดูล {{plural_module_name}} ให้คุณสามารถติดตามการขายแต่ละรายการได้จากต้นจนจบ ระเบียน {{module_name}} แต่ละรายการจะแสดงทัศนวิสัยของการขาย และรวมถึงข้อมูลการขายที่เกี่ยวข้อง พร้อมด้วยระเบียนสำคัญต่าง ๆ ที่เกี่ยวข้องด้วย เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น {{module_name}} มักจะดำเนินการผ่านขั้นตอนการขายหลากหลายขั้นตอนจนกว่ามันจะได้รับการทำเครื่องหมายว่า "ปิดการขายสำเร็จ" หรือ "ปิดการขายไม่สำเร็จ" {{plural_module_name}} สามารถเพิ่มพลังการขายมีมากขึ้นไปอีกโดยการใช้โมดูล {{forecasts_singular_module}} ของ Sugar เพื่อทำความเข้าใจ และพยากรณ์เทรนด์การขาย พร้อมทั้งมุ่งเน้นไปยังโควต้าการขายที่ประสบความสำเร็จ',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'โมดูล {{plural_module_name}} ให้คุณสามารถติดตามการขายแต่ละรายการได้จากต้นจนจบ ระเบียน {{module_name}} แต่ละรายการจะแสดงทัศนวิสัยของการขาย และรวมถึงข้อมูลการขายที่เกี่ยวข้อง พร้อมด้วยบันทึกสำคัญต่าง ๆ ที่เกี่ยวข้องด้วย เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น 

- แก้ไขฟิลด์ของระเบียนนี้โดยคลิกที่ฟิลด์แต่ละตัวหรือคลิกที่ปุ่มแก้ไข
- ดูหรือแก้ไขลิงก์ไปยังระเบียนอื่นในแถบย่อยโดยการสลับแถบล่างซ้ายเป็น "มุมมองข้อมูล"
- จัดทำและดูความคิดเห็นผู้ใช้และประวัติการเปลี่ยนระเบียนใน {{activitystream_singular_module}} โดยสลับแถบล่างซ้ายเป็น "สตรีมกิจกรรม"
- ติดตามหรื่อกำหนดบันทึกนี้เป็นรายการโปรดโดยใช้ไอคอนด้านขวาของชื่อบันทึก
- การดำเนินการอื่น ๆ จะอยู่ในเมนูการดำเนินการแบบดรอปดาวน์ด้านขวาของปุ่มแก้ไข',

    // Create View Help Text
    'LBL_HELP_CREATE' => 'โมดูล {{plural_module_name}} ให้คุณสามารถติดตามการขายแต่ละรายการได้จากต้นจนจบ ระเบียน {{module_name}} แต่ละรายการจะแสดงทัศนวิสัยของการขาย และรวมถึงข้อมูลการขายที่เกี่ยวข้อง พร้อมด้วยบันทึกสำคัญต่าง ๆ ที่เกี่ยวข้องด้วย เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น 
...
1. ระบุค่าสำหรับฟิลด์ตามที่ต้องการ
 ...
 - คลิก "แสดงเพิ่มเติม" เพื่อแสดงฟิลด์อื่น ๆ หากจำเป็น
