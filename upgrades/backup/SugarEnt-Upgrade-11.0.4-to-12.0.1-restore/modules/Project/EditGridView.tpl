    ...
    {if $SELECTED_VIEW == 6}
        <script type="text/javascript">
			Calendar.setup ({literal}{{/literal}
                inputField : "view_filter_date_start", ifFormat : '{$CALENDAR_DATEFORMAT|escape:javascript}', showsTime : false, button : "view_filter_date_start", singleClick : true, step : 1, weekNumbers:false{literal}}{/literal});
			Calendar.setup ({literal}{{/literal}
                inputField : "view_filter_date_finish", ifFormat : '{$CALENDAR_DATEFORMAT|escape:javascript}', showsTime : false, button : "view_filter_date_finish", singleClick : true, step : 1, weekNumbers:false{literal}}{/literal});
        </script>
    {/if}
