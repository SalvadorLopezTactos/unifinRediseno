...
if (isset($_POST['campaign_id']) && !empty($_POST['campaign_id'])) {
	    ...
	    if(isset($camp_data) && $camp_data != null ){
            ...
            // when these options were available should default to a 'GET'
            // request
    ...
    if ($useRedirect) {
        ...
        // URL. WTL forms generated prior to when these options were available
        // should default to sending the parameters. Otherwise, use the form
        // configuration to determine this
