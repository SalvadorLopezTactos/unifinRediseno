...
ProcessESImport = new function()
{
     ...
     */
    this.recordsPerImport   = {/literal}{$RECORDTHRESHOLD|escape:javascript}{literal};
    ...
    this.submit = function()
    {
        ...
        YAHOO.util.Connect.asyncRequest('POST', 'index.php',
            {
                success: function(o) {
                    ...
                    var locationStr = "index.php?module=Import&action=Last"
                        ...
                        + "&type={/literal}{$TYPE|escape:url}{literal}"
                        + "&import_module={/literal}{$IMPORT_MODULE|escape:url}{literal}"
                    ...
                    {
                        YAHOO.SUGAR.MessageBox.updateProgress(1,'{/literal}{$MOD.LBL_IMPORT_COMPLETED|escape:javascript}{literal}');
        ...
        if(this.totalRecordCount == 0 )
            displayMessg = "{/literal}{$MOD.LBL_IMPORT_RECORDS|escape:javascript}{literal} ";
        else
            displayMessg = "{/literal}{$MOD.LBL_IMPORT_RECORDS|escape:javascript}{literal} " + ((this.offsetStart * this.recordsPerImport) + 1)
                            + " {/literal}{$MOD.LBL_IMPORT_RECORDS_TO|escape:javascript}{literal} " + Math.min(((this.offsetStart+1) * this.recordsPerImport),this.totalRecordCount)
                            + " {/literal}{$MOD.LBL_IMPORT_RECORDS_OF|escape:javascript}{literal} " + this.totalRecordCount;
    ...
    this.showErrorMessage = function(errorMessage)
    {
        ...
        YAHOO.SUGAR.MessageBox.show({
            type:  "alert",
            title: '{/literal}{$MOD.LBL_IMPORT_ERROR|escape:javascript}{literal}',
            msg:   errorMessage,
            fn: function() { }
        });
    }
    ...
    this.begin = function()
    {
        datestarted = '{/literal}{$MOD.LBL_IMPORT_STARTED|escape:javascript}{literal} ' +
                YAHOO.util.Date.format('{/literal}{$datetimeformat}{literal}');
        YAHOO.SUGAR.MessageBox.show({
            title: '{/literal}{$STEP4_TITLE|escape:javascript}{literal}',
            msg: datestarted,
            width: 500,
            type: "progress",
            closable:false,
