...
/**
 * Generated from protobuf message <code>sugarcrm.apis.iam.provider.v1alpha.SamlProvider</code>
 */
class SamlProvider extends \Google\Protobuf\Internal\Message
{
    /**
     * srn:cloud:idp::1234567890:provider:saml
     *
     ...
     * SAML Configuration
     *
     * Generated from protobuf field <code>.sugarcrm.apis.iam.provider.v1alpha.SamlConfig config = 2;</code>
     */
    private $config = null;
    /**
     * Attribute mappings
     ...
     *     @type string $name
     *           srn:cloud:idp::1234567890:provider:saml
     *     @type \Sugarcrm\Apis\Iam\Provider\V1alpha\SamlConfig $config
     *           SAML Configuration
     ...
     *
     * Generated from protobuf field <code>.sugarcrm.apis.iam.provider.v1alpha.SamlConfig config = 2;</code>
     * @return \Sugarcrm\Apis\Iam\Provider\V1alpha\SamlConfig
     */
     ...
     *
     * Generated from protobuf field <code>.sugarcrm.apis.iam.provider.v1alpha.SamlConfig config = 2;</code>
     * @param \Sugarcrm\Apis\Iam\Provider\V1alpha\SamlConfig $var
     * @return $this
     */
    public function setConfig($var)
    {
        GPBUtil::checkMessage($var, \Sugarcrm\Apis\Iam\Provider\V1alpha\SamlConfig::class);
        $this->config = $var;
