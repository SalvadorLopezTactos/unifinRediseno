...
if (!function_exists('getSubgroupForTarget')) {
    ...
    function getSubgroupForTarget($subGroup, $target)
    {
        ...
        switch ($subGroup) {
            case 'bootstrap':
                return [
                    'jssource/src/build/grp-bootstrap.min.js' => $target,
            ...
            case 'bootstrap_core':
                return [
                    'jssource/src/build/bootstrap.min.js' => $target,
                ];
...
$js_groupings = [
    ...
    $sugar_grp_jquery = array_merge(
        getSubgroupForTarget('jquery_core', 'include/javascript/sugar_grp1_jquery.js'),
    ...
    $sugar_grp_sidecar = array_merge(
        ...
        [
            'jssource/src/build/grp-sidecar.min.js' => 'include/javascript/sugar_sidecar.min.js',
            ...
            //recurring events
            'include/javascript/sugar7/plugins/RecurringEvents.js' => 'include/javascript/sugar_sidecar.min.js',
            ...
            'include/javascript/sugar7/plugins/FilterOperatorManager.js' => 'include/javascript/sugar_sidecar.min.js',
            'include/javascript/sugar7/plugins/DashboardFilters.js' => 'include/javascript/sugar_sidecar.min.js',
            'include/javascript/sugar7/plugins/DashboardFiltersVisibility.js' => 'include/javascript/sugar_sidecar.min.js',
            'include/javascript/sugar7/filter-operators/DateOperator.js' => 'include/javascript/sugar_sidecar.min.js',
            'include/javascript/sugar7/filter-operators/BetweenOperator.js' => 'include/javascript/sugar_sidecar.min.js',
            'include/javascript/sugar7/filter-operators/EnumOperator.js' => 'include/javascript/sugar_sidecar.min.js',
            'include/javascript/sugar7/filter-operators/EmptyOperator.js' => 'include/javascript/sugar_sidecar.min.js',
            'include/javascript/sugar7/filter-operators/DefaultOperator.js' => 'include/javascript/sugar_sidecar.min.js',
            'include/javascript/sugar7/filter-operators/BoolOperator.js' => 'include/javascript/sugar_sidecar.min.js',
            'include/javascript/sugar7/filter-operators/RelateOperator.js' => 'include/javascript/sugar_sidecar.min.js',
            'include/javascript/sugar7/filter-operators/UsernameOperator.js' => 'include/javascript/sugar_sidecar.min.js',
            ...
            'include/javascript/sugar7/plugins/RowEditable.js' => 'include/javascript/sugar_sidecar.min.js',
        ]
    ),
    ...
    $sugar_grp_calendar = [
        ...
        'include/javascript/kendo/agendaView.js' => 'include/javascript/sugar_grp_calendar.js',
