...
<html {$langHeader}>
<head>
<script type="text/javascript" src="modules/InboundEmail/InboundEmail.js?v={ldelim}VERSION_MARK{rdelim}"></script>
<script type="text/javascript" src="include/javascript/sugar_3.js?v={ldelim}VERSION_MARK{rdelim}"></script>
<script type="text/javascript" src="cache/include/javascript/sugar_grp1_yui.js?v={ldelim}VERSION_MARK{rdelim}"></script>
<script type="text/javascript" src="include/SugarFields/Teamset/Teamset.js?v={ldelim}VERSION_MARK{rdelim}"></script>
{$languageStrings}
<script type="text/javascript" src="cache/include/javascript/sugar_grp1_yui.js??v={ldelim}VERSION_MARK{rdelim}"></script>
<script type="text/javascript" src="cache/include/javascript/sugar_grp1.js??v={ldelim}VERSION_MARK{rdelim}"></script>
