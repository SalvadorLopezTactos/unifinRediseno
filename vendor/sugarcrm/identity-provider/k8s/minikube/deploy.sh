...
if ! kubectl --namespace=iam exec ${HYDRA_POD} -- /go/bin/hydra clients get srn:cloud:iam:eu:2000000001:app:crm:99711b76-bb31-11e8-8df0-985aeb8a5c2a ;
then
    kubectl --namespace=iam exec -i ${HYDRA_POD} -- /go/bin/hydra clients create --skip-tls-verify --id srn:cloud:iam:eu:2000000001:app:crm:99711b76-bb31-11e8-8df0-985aeb8a5c2a --name srn:cloud:iam:eu:2000000001:app:crm:99711b76-bb31-11e8-8df0-985aeb8a5c2a --secret mangoOIDCClientSecret --grant-types authorization_code,refresh_token,client_credentials,implicit,urn:ietf:params:oauth:grant-type:jwt-bearer --response-types token,code,id_token --allowed-scopes openid,offline,hydra.keys.get,hydra,https://apis.sugarcrm.com/auth/iam.password,idp.auth.password,https://apis.sugarcrm.com/auth/crm,profile,email,address,phone  --callbacks "http://login.sugarcrm.local/consumer,http://localhost/consumer,http://behat-tests-mango-oidc.idm-ns-localhost/?module=Users&action=OAuth2CodeExchange"
fi

if ! kubectl --namespace=iam exec ${HYDRA_POD} -- /go/bin/hydra clients get srn:cloud:iam:eu:2000000001:app:native:806bfb76-ee57-43ea-9022-aa91e6b6c617 ;
then
    kubectl --namespace=iam exec -i ${HYDRA_POD} -- /go/bin/hydra clients create --skip-tls-verify --id srn:cloud:iam:eu:2000000001:app:native:806bfb76-ee57-43ea-9022-aa91e6b6c617 --name srn:cloud:iam:eu:2000000001:app:native:806bfb76-ee57-43ea-9022-aa91e6b6c617 --secret NativeOIDCClientSecret --grant-types authorization_code,refresh_token,client_credentials,implicit,urn:ietf:params:oauth:grant-type:jwt-bearer --response-types token,code,id_token --allowed-scopes openid,offline,hydra.keys.get,hydra,https://apis.sugarcrm.com/auth/iam.password,idp.auth.password,https://apis.sugarcrm.com/auth/crm,profile,email,address,phone  --callbacks "http://login.sugarcrm.local/consumer,http://localhost/consumer,http://behat-tests-mango-oidc.idm-ns-localhost/?module=Users&action=OAuth2CodeExchange"
fi
...
then
    ...
    kubectl --namespace=iam exec ${HYDRA_POD} -- /go/bin/hydra policies create --skip-tls-verify --actions get --allow --id mangoOIDCKeySet --resources "rn:hydra:keys:mangoOIDCKeySet:private" --subjects "srn:cloud:iam:eu:2000000001:app:crm:99711b76-bb31-11e8-8df0-985aeb8a5c2a"
    kubectl --namespace=iam exec ${HYDRA_POD} -- /go/bin/hydra policies create --skip-tls-verify --actions get --allow --id mangoOIDCKeySet --resources "rn:hydra:keys:mangoOIDCKeySet:public" --subjects "srn:cloud:iam:eu:2000000001:app:crm:99711b76-bb31-11e8-8df0-985aeb8a5c2a"

    kubectl --namespace=iam exec ${HYDRA_POD} -- /go/bin/hydra policies create --skip-tls-verify --actions get --allow --id mangoOIDCKeySet --resources "rn:hydra:keys:hydra.consent.response:private" --subjects "srn:cloud:iam:eu:2000000001:app:crm:99711b76-bb31-11e8-8df0-985aeb8a5c2a"
    kubectl --namespace=iam exec ${HYDRA_POD} -- /go/bin/hydra policies create --skip-tls-verify --actions get --allow --id mangoOIDCKeySet --resources "rn:hydra:keys:hydra.consent.response:public" --subjects "srn:cloud:iam:eu:2000000001:app:crm:99711b76-bb31-11e8-8df0-985aeb8a5c2a"
    kubectl --namespace=iam exec ${HYDRA_POD} -- /go/bin/hydra policies create --skip-tls-verify --actions get --allow --id mangoOIDCKeySet --resources "rn:hydra:keys:hydra.consent.challenge:public" --subjects "srn:cloud:iam:eu:2000000001:app:crm:99711b76-bb31-11e8-8df0-985aeb8a5c2a"
fi
