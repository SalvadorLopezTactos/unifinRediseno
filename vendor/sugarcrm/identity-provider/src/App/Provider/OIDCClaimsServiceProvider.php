...
/**
 * Class OIDCClaimsServiceProvider
 * @package Sugarcrm\IdentityProvider\App\Provider
 */
class OIDCClaimsServiceProvider implements ServiceProviderInterface
{
    /**
     * @param Container $app
     */
    ...
    {
        $app['OIDCClaimsService'] = function ($app) {
            return new StandardClaimsService($app);
        };
    }
}
