...
Feature: Login
  ...
  Scenario: Existed user logged in more than allowed and requested to change password
    Given I am on "/"
    Then I login as "sally" with password "sally" to tenant "2000000006"
    ...
    Then I do logout
    And I should see a "#tenant_hint" element
    Then I login as "sally" with password "sally-new-pass" to tenant "2000000006"
    And I should see "You are logged in as sally"
    Then I do logout
    And I should see a "#tenant_hint" element
  ...
  Scenario: Existing user tries to login and logout with logout cookie
    Given I am on "/"
    And I login as "max" with password "max" to tenant "2000000008"
  ...
  Scenario: User tries to set new password
    ...
    Then I should see logo with "alt" = "Local, LDAP Test Tenant for Login Service"
