...
class XTemplate
{
    ...
    */
    ...
    var $blocks = [];                                /* unparsed blocks */
    var $parsed_blocks = [];                    /* parsed blocks */
    var $block_parse_order = [];            /* block parsing order for recursive parsing (sometimes reverse:) */
    var $sub_blocks = [];                        /* store sub-block names for fast resetting */
    var $VARS = [];                                    /* variables array */
    ...
    var $NULL_STRING = ["" => ""];                /* null string for unassigned vars */
    var $NULL_BLOCK = ["" => ""];    /* null string for unassigned blocks */
    var $mainblock = "";
    var $ERROR = "";
