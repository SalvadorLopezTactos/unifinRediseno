...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Support de base de données introuvable.  Vérifiez que vous avez les pilotes nécessaires pour l’un des Types de base de données pris en charge suivants : MySQL, MS SQLServer, Oracle ou DB2.  Vous devrez décommenter l’extension dans le fichier php.ini, ou recompiler le bon fichier binaire, selon votre version de PHP.  Veuillez vous référer au manuel PHP pour plus d’informations sur la façon d’activer le Support de base de données.',
