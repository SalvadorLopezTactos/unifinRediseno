...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Не е намерено: Автоматизираните задачи на Sugar ще работят с ограничена функционалност. Услугата Архивиране на имейла няма да се изпълнява.',
