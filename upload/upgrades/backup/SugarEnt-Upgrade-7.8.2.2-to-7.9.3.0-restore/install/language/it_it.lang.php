...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Non trovato: lo schedulatore di Sugar sarà eseguito con funzionalità limitata. Il servizio di archiviazione email non sarà eseguito.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Supporto database non trovato.  Verificare di disporre dei driver necessari per uno dei seguenti tipi di database supportati: MySQL, MS SQL Server, Oracle o DB2.  Potrebbe essere necessario decommentare l&#39;estensione nel file php.ini o ricompilarla con il file in binario corretto, a seconda della versione di PHP.  Consultare il manuale di PHP per ulteriori informazioni su come attivare il supporto database.',
