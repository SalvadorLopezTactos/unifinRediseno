...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Databas stöd hittades inte.  Vänligen kontrollera att du har nödvändiga drivrutiner för en av följande stödda databastyper: MySQL, MS SQLServer, Oracle eller DB2.  Du kan behöva avkommentera tillägget i php.ini-filen, eller kompilera om med rätt binära fil, beroende på PHP-version.  Se din PHP Manual för mer information om hur du aktiverar databasstöd.',
