...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Asistenţa pentru baza de date nu a fost găsită.  Asiguraţi-vă că aveţi driverele necesare pentru unul dintre următoarele tipuri de baze de date acceptate: MySQL, MS SQLServer, Oracle sau DB2.  Va trebui să anulaţi comentariul extensiei în fişierul php.ini sau să compeltaţi din nou cu fişierul binar corect, în funcţie de versiunea dvs. de PHP.  Consultaţi Manualul PHP pentru mai multe informaţii despre cum să activaţi asistenţa pentru baza de date.',
