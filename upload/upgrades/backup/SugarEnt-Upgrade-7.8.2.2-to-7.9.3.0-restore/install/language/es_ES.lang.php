...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'No encontrado: El planificador de Sugar funcionará de forma limitada. El servicio de archivo de correos electrónicos no funcionará.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No se ha encontrado el soporte de la base de datos. Asegúrese de que tiene los controladores necesarios para alguno de los siguientes tipos de bases de datos compatibles: MySQL, MS SQLServer, Oracle o DB2. Podría tener que quitar la marca de comentario de la extensión en el archivo php.ini o recompilar con el archivo binario correcto, según su versión de PHP. Consulte su manual de PHP para más información sobre cómo habilitar el soporte de la base de datos.',
