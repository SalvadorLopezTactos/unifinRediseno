...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Não encontrado: O agendador Sugar será executado com funcionalidade limitada. O serviço de arquivamento de e-mails não será executado.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Não foi encontrado suporte ao banco de dados.  Certifique-se de que você tem os drivers necessários para um dos seguintes tipos de banco de dados suportados: MySQL, MS SQLServer, Oracle ou DB2.  Talvez seja necessário remover os comentários da extensão no arquivo php.ini ou recompilar o arquivo binário relacionado, dependendo da sua versão do PHP.  Consulte o manual do PHP para obter mais informações sobre como habilitar o suporte ao banco de dados.',
