...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Veri Tabanı Desteği bulunamadı. Lütfen Desteklenen şu Veri Tabanı Türlerinden biri için gerekli sürücülerinizin olduğundan emin olun: MySQL, MS SQLServer, Oracle, veya DB2. PHP sürümünüze bağlı olarak php.ini dosyasında uzantı açıklamasını kaldırmanız veya doğru ikili dosyayla yeniden derlemeniz gerekebilir. Veri Tabanı Desteğinin nasıl etkinleştirileceği hakkında daha fazla bilgi için lütfen PHP Kılavuzunuza bakın.',
