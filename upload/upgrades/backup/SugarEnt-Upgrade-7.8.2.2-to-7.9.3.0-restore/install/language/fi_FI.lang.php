...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Tietokantatukea ei löytynyt. Varmista, että sinulla on jonkin seuraavan tuetun tietokannan tarvittavat ohjaimet: MySQL, MS SQLServer, Oracle tai DB2. Tarvittaessa poista loppuliite kommentista php.ini-tiedostossa tai käännä se uudelleen käyttäen oikeaa binääritiedostoa PHP:n versiosta riippuen. Katso listätietoa tietokantatuen käyttöön ottamisesta PHP-oppaasta.',
