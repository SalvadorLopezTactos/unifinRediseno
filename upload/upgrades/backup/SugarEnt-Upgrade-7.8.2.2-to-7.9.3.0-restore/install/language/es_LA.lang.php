...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'No se encontró el Soporte de la Base de Datos. Asegúrese de que tiene los controladores necesarios para alguno de los siguientes tipos de Bases de Datos soportados MySQL, MS SQLServer, Oracle, o DB2. Podría tener que descomentar la extensión en el archivo php.ini o recompilar con el archivo binario correcto, según su versión de PHP. Consulte su manual de PHP para más información sobre cómo habilitar el Soporte de la Base de Datos.',
