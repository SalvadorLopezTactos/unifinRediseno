...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => '未找到資料庫支援。請確保您已安裝支援以下任一資料庫所需的驅動程式：MySQL、MS SQLServer、Oracle 或 DB2。您可能需要移除 php.ini 文件中有關擴展的註釋，或使用正確的二進製文件進行編譯，具體視您的 PHP 版本而定。更多關於如何啟用資料庫支援的資訊，請參考您的 PHP 手冊。',
