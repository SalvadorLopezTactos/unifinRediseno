...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Podpora databázy sa nenašla. Uistite sa, že máte potrebné ovládače pre jeden z nasledujúcich typov databázy: MySQL, MS SQLServer, Oracle alebo DB. V závislosti od vašej verzie PHP možno budete musieť povoliť rozšírenie v súbore php.ini alebo ho prekompilovať správnym binárnym súborom. Informácie o povolení podpory databázy nájdete v príručke k PHP.',
    ...
    'ERR_DB_OCI8_DB_NAME_INVALID'       => "Názov databázy môže obsahovať len alfanumerické znaky a symboly '#', '_', ':', '.', '/' or '$'",
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_WELCOME_2'						=> 'Inštalačnú dokumentáciu nájdete na stránke <a href="http://www.sugarcrm.com/crm/installation" target="_blank">Sugar Wiki</a>. <BR><BR> Pomoc vám môžu poskytnúť aj členovia Sugar Community na <a href="http://www.sugarcrm.com/forums/" target="_blank">Fórach Sugar</a>.',
...
<br><br>Bežne nesprávna konfigurácia nastane, keď direktíva <b>session.save_path</b> nesmeruje k platnému adresáru.<br><br>Opravte<a target=_new href='http://us2.php.net/manual/en/ref.session.php'> PHP konfiguráciu</a> v súbore php.ini umiestnenom tu nižšie.",
	...
	'LBL_MINIMUM_PHP_VERSION' => 'Minimálna verzia PHP je 5.3.0.',
	'LBL_YOUR_PHP_VERSION' => '(Vaša aktuálna verzia php je ',
	'LBL_RECOMMENDED_PHP_VERSION' =>'Odporúčaná verzia php je 5.3.x)',
