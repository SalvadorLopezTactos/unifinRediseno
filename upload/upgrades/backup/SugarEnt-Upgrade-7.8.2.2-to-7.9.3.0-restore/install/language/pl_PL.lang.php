...
$mod_strings = array(
	...
	'ERR_CHECKSYS_CURL'					=> 'Nie znaleziono: kreator harmonogramu Sugar będzie działać z ograniczoną funkcjonalnością. Usługa archiwizacji wiadomości e-mail nie będzie działać.',
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Sterowniki do obsługi bazy danych nie zostały znalezione. Upewnij się, że masz niezbędne sterowniki dla jednego z następujących obsługiwanych typów baz danych: MySQL, MS SQLServer, Oracle lub DB2. Może będziesz musiał usunąć znaczniki komentarza rozszerzenia w pliku php.ini lub ponownie skompilować z odpowiednim plikiem binarnym, w zależności od wersji PHP.  Więcej informacji na temat włączania obsługi bazy danych dostępnych jest w podręczniku PHP.',
