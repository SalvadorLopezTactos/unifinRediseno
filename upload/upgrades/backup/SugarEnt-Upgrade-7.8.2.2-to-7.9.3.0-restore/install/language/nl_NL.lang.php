...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'Database-ondersteuning niet gevonden. Zorg ervoor dat u de nodige drivers voor een van de volgende ondersteunde databasetypes heeft: MySQL, MS SQLServer, Oracle of DB2. Mogelijk moet u de extensie van het php.ini bestand verwijderen of opnieuw opstellen met het juiste binaire bestand. Dit is afhankelijk van uw versie van PHP. Raadpleeg uw PHP handleiding voor meer informatie over het inschakelen van database-ondersteuning.',
