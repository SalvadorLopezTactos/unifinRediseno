...
$mod_strings = array(
    ...
    'LBL_CHECKSYS_DB_SUPPORT_NOT_AVAILABLE' => 'دعم قاعدة البيانات غير متوفر. يرجى التأكد من توفر برامج التشغيل اللازمة لأحد أنواع قاعدة البيانات المدعومة التالية: MySQL أو MS SQLServer أو Oracle أو DB2. قد تحتاج إلى إلغاء التعليق على الامتداد الموجود في ملف php.ini أو إعادة التجميع مع ملف ثنائي صحيح وفقًا لإصدار PHP. يرجى الرجوع إلى دليل PHP لمزيد من المعلومات حول كيفية تمكين دعم قاعدة البيانات.',
