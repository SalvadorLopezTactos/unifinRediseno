...
$mod_strings = array (
	...
	'LBL_LIST_NAME' => 'Nimi',
    'LBL_LIST_DAYS' => 'päevi',
	'LBL_LIST_ASSIGNED_USER_ID' => 'Määratud kasutajale',
    ...
    'LBL_LIST_OVERDUE_TASKS' => 'Tähtaja ületanud ülesanded',
	...
	'LBL_ACCOUNT_SUBPANEL_TITLE' => 'Kontod',
	'LBL_OPPORTUNITY_SUBPANEL_TITLE' => 'Müügivõimalused',
	'LBL_QUOTE_SUBPANEL_TITLE' => 'Pakkumused',

    // quick create label
    'LBL_NEW_FORM_TITLE' => 'Uus projekt',

	'CONTACT_REMOVE_PROJECT_CONFIRM' => 'Kas olete kindel, et soovite selle kontakti projektist eemaldada?',

	'LNK_NEW_PROJECT'	=> 'Loo projekt',
	'LNK_PROJECT_LIST'	=> 'Vaata projektide loendit',
    ...
    'LBL_RESOURCE_NAMES_WIDGET' => 'ressurss',
    'LBL_EDIT_PROJECT_TASKS_TITLE'=> 'Muuda projektiülesandeid',
    'LBL_VIEW_GANTT_TITLE' => 'Gantti vaade',
    
    'LBL_INSERT_BUTTON' => 'Lisa ridu',
    'LBL_INDENT_BUTTON' => 'Taane',
    'LBL_OUTDENT_BUTTON' => 'Taane vasakule',
    ...
    'LBL_MARK_AS_MILESTONE_BUTTON' => 'Märgi verstapostina',
    'LBL_UNMARK_AS_MILESTONE_BUTTON' => 'Tühista märkimine verstapostina',
    'LBL_HIDE_OPTIONAL_COLUMNS_BUTTON' => 'Peida valikulised veerud',
    'LBL_SHOW_OPTIONAL_COLUMNS_BUTTON' => 'Kuva valikulised veerud',
    'LBL_VIEW_TASK_DETAILS_BUTTON' => 'Vaata ülesande üksikasju',
    'LBL_RECALCULATE_DATES_BUTTON' => 'Arvuta kuupäevad ümber',    
    'LBL_EXPORT_TO_PDF' => 'Ekspordi PDF-i',
    ...
    'LBL_FILTER_MILESTONES' => 'Verstapostid',  
    'LBL_FILTER_RESOURCE' => 'Ressurssi kasutavad ülesanded',    
    'LBL_FILTER_DATE_RANGE' => 'Kuupäevavahemiku ülesanded', 
    'LBL_FILTER_VIEW' => 'Vaata',
    'LBL_LIST_FILTER_VIEW' => 'Vaata:',
    'LBL_FILTER_DATE_RANGE_START' => 'Ülesanded, mis algavad või lõppevad hiljem', 
    'LBL_FILTER_DATE_RANGE_FINISH' => 'Ja enne', 
    'LBL_FILTER_MY_TASKS' => 'Minu ülesanded',    
    'LBL_FILTER_MY_OVERDUE_TASKS' => 'Minu tähtaja ületanud ülesanded',    
...
/*
  ...
  */   
    ...
    'ERR_TASK_NAME_FOR_ROW' => 'Ülesande nimi rea puhul ',
    'ERR_IS_EMPTY' => ' ei saa olla tühi.',   
    'ERR_PERCENT_COMPLETE' => '% lõpetatud peab olema väärtus vahemikus 0 kuni 100.',   
    'ERR_DURATION' => 'Kestus peab olema täisarv.',
    'ERR_DATE' => 'Määratud kuupäev langeb puhkepäevale, valides esimese sobiva tööpäeva.',
    'ERR_FINISH_DATE' => 'Lõppkuupäev ei tohi olla enne alguskuupäeva.',
    'ERR_PREDECESSORS_INPUT' => 'Väljale Eelkäijad sisestatud väärtused peavad olema kujul 1 või 1,2',
    'ERR_PREDECESSORS_OUT_OF_RANGE' => 'Väljal Eelkäija määratud väärtus on suurem kui ridade arv.',   
    'ERR_PREDECESSOR_CYCLE_FAIL' => 'Määratud eelkäija põhjustab sõltuvuse tsükli.',
    'ERR_PREDECESSOR_IS_PARENT_OR_CHILD_FAIL' => 'Määratud eelkäija on emaülesanne või alamülesanne.', 
    'ERR_TASK_VIEW_DETAILS' => 'Te ei saa vaadata veel salvestamata ülesande üksikasju.',
    'NTC_DELETE_TASK_AND_SUBTASKS' => 'Kas oled kindel, et soovite selle ülesande ja kõik selle alamülesanded kustutada?',
    'NTC_NO_ACTIVE_PROJECTS' => 'Teil pole aktiivseid projekte ega projekti ülesandeid.',
    'NTC_ASSIGN_RIGHT_TEAM' => 'Veenduge, et kõik projekti ressursid on selle meeskonna liikmed.',
       
    'LBL_RESOURCE_NAME' => 'Nimi',
    'LBL_RESOURCE_TYPE' => 'Tüüp',
    
    'LBL_GRID_ONLY' => 'Ruudustik',
    'LBL_GANTT_ONLY' => 'Gantt',
    'LBL_GRID_GANTT' => 'Ruudustik/Gantt',
	...
	'LBL_INSERTROWS' => 'Lisa ridu' /*for 508 compliance fix*/,
	'LBL_PROJECT_INFORMATION' => 'Ülevaade',
