...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Andmeformaatide loend',
  ...
  'LBL_LIST_LIST_ORDER_X' => 'X-tellimus',
  'LBL_LIST_VISIBLE' => 'Nähtav?',
  'LBL_LIST_EXPORTABLE' => 'Eksporditav?',
  'LBL_LIST_HEADER' => 'Kas kuvada päis?',
  'LBL_NAME' => 'Andmeformaadi nimi:',
  'LBL_DESCRIPTION' => 'Kirjeldus:',
  'LBL_TYPE' => 'Tüüp:',
  'LBL_PARENT_DATASET' => 'Vanemandmeformaat:',
  ...
  'LBL_PRESPACE_X' => 'Tühikueelne pool:',
  ...
  'LNK_LIST_DATASET' => 'Andmeformaatide loend',
  ...
  'LBL_MODIFY_HEAD_HEADER' => 'Lisa/redigeeri päise atribuute:',
  'LBL_MODIFY_BODY' => 'Muuda keha atribuute:',
  'LBL_MODIFY_BODY_HEADER' => 'Lisa/redigeeri keha atribuute:',
  
  'LBL_BG_COLOR' => 'Tausta värv:',
  'LBL_WRAP' => 'Murra teksti:',
  ...
  'LBL_HIDE_COLUMN' => 'Peida veerg aruandes:',
  
  'LBL_FINISHED_BUTTON' => 'Lõpetatud',
  'CONFIRM_LAYOUT_DISABLE' => 'Kohandatud paigutuse lubamine eemaldab kõik olemasolevad kohandatud paigutuse atribuudid',
  'LBL_LEFT' => 'Vasak',
  'LBL_RIGHT' => 'Parem',
  'LBL_EDIT_LAYOUT' => 'Muuda paigutust' /*for 508 compliance fix*/,
  'LBL_INVALID_QUERY' => 'Kehtetu päring',
);
