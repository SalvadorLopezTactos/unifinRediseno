...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurer hvordan du vil kategorisere {{forecastByModule}}.<br><br>Merk at områdeinnstillinger ikke kan endres etter første bekreftelse. For oppgraderte innstanser er områdeinnstillingen låst sammen med eksisterende prognosedata.<br><br>Du kan velge to eller flere kategorier basert på sannsynlighetsområder eller opprette kategorier som ikke er basert på sannsynlighet.<br><br>Det er avmerkingsbokser til venstre for dine tilpassede kategorier; bruk disse for å bestemme hvilke områder som skal inkluderes i prognosebeløpet som bekreftes og rapporteres til ledere.<br><br>En bruker kan endre statusen inkluder/ekskluder og kategorien {{forecastByModule}} manuelt fra regnearket.',
