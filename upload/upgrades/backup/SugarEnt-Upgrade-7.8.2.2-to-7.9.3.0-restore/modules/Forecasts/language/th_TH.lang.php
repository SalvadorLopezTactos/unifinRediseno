...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'กำหนดค่าว่าคุณต้องการจัดหมวดหมู่ {{forecastByModule}} อย่างไร <br><br>โปรดทราบว่าการตั้งค่าช่วงจะไม่สามารถเปลี่ยนแปลงได้หลังจากการคอมมิตครั้งแรก สำหรับอินสแตนซ์ที่อัปเกรด การตั้งค่าช่วงจะถูกล็อคกับข้อมูลประมาณการที่มีอยู่<br><br>คุณสามารถเลือกหมวดหมู่สองหมวดหมู่ขึ้นไปโดยอ้างอิงช่วงความน่าจะเป็น หรือสร้างหมวดหมู่ที่ไม่ได้อ้างอิงความน่าจะเป็น <br><br>มีช่องทำเครื่องหมายทางซ้ายของหมวดหมู่ที่กำหนดเอง ใช้ช่องทำเครื่องหมายนี้เพื่อเลือกว่าจะรวมช่วงใดภายในจำนวนเงินประมาณการที่คอมมิตและรายงานกับผู้จัดการ <br><br>ผู้ใช้สามารถเปลี่ยนสถานะรวม/ไม่รวม และหมวดหมู่ของ {{forecastByModule}} ด้วยตนเองจากเวิร์กชีทของตน',
