...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'קבע כיצד ברצונך לסווג את {{forecastByModule}}. <br><br>שים לב שלא ניתן לשנות את הגדרות &#39;טווח&#39; לאחר ההתחייבות הראשונה. עבור מופעים משודרגים, ההגדרה &#39;טווח&#39; נעולה עם נתוני &#39;תחזית&#39; קיימים.<br><br>תוכל לבחור קטגוריה אחת או יותר המבוססת על טווחי הסתברות, או ליצור קטגוריות שאינן מבוססות על הסתברות. <br><br>לצד הקטגוריות המותאמות אישית שלך יש תיבות סימון; השתמש בהן כדי לקבוע אילו טווחים ייכללו בסכום &#39;תחזית&#39; מחויב וידווחו למנהלים. <br><br>משתמש יכול לשנות את הסטטוס של כלילה/אי-כלילה ואת הקטגוריה של {{forecastByModule}} באופן ידני מתוך גליון העבודה שלו.',
