...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Konfigurera hur Du vill kategorisera {{forecastByModule}}. <br><br>Vänligen notera att inställningsområdet inte kan ändras efter ett första försök. Vid uppgraderingar är området låst med existerande tidigare data.<br><br>Du kan välja två eller fler kategorier beroende på möjliga områden eller skapade kategorier, som inte baseras på sannolikhet. <br><br>Det finns kryssrutor till vänster om vanliga kategorier; använd dessa för att besluta vilka områden som ska inkluderas inom tidigare datamängder som förts in och rapporterats till ledningen. <br><br>En använder kan ändra inkluderings-/exkluderingsstatus och kategori för {{forecastByModule}} manuellt från sin egen sida.',
