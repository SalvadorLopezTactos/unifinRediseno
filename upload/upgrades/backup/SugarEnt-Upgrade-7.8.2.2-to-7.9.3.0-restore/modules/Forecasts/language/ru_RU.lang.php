...
$mod_strings = array (
    ...
    'LBL_FORECASTS_CONFIG_HELP_RANGES' => 'Настройте классификацию {{forecastByModule}}. <br><br>Обратите внимание, что настройки диапазона нельзя изменить после их применения. Для обновленных экземпляров настройки диапазона заблокированы с использованием существующих данных прогноза. <br><br>Можно выбрать две или более категорий на основе диапазонов вероятности или создать категории, которые не основаны на вероятности. <br><br>Слева от пользовательских категорий есть флажки; используйте их для выбора диапазонов, которые будут включены в значение прогноза, которое применяется и сообщается менеджерам. <br><br>Пользователи могут вручную изменять статус включения/исключения и категорию {{forecastByModule}} с листа.',
