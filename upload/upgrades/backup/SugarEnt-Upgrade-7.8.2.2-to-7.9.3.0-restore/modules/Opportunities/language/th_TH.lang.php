...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'โมดูล {{plural_module_name}} ช่วยให้คุณติดตามการขายแต่ละรายการและบรรทัดรายการของการขายเหล่านั้นตั้งแต่ต้นจนเสร็จสิ้น ระเบียน {{module_name}} แต่ละรายการจะแสดงถึงส่วนหัวสำหรับกลุ่มของ {{revenuelineitems_module}} ตลอดจนเชื่อมโยงกับระเบียนสำคัญอื่นๆ เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น {{revenuelineitems_singular_module}} แต่ละรายการเป็นการขายเชิงคาดการณ์ของผลิตภัณฑ์หนึ่งๆ และมีข้อมูลการขายที่เกี่ยวข้อง ตามปกติ {{revenuelineitems_singular_module}} แต่ละรายการจะเข้าสู่ขั้นตอนการขายหลายขั้นตอนจนกระทั่งมีการทำเครื่องหมายเป็น "ปิดโดยได้รับการขาย" หรือ "ปิดโดยไม่ได้รับการขาย" ระเบียน {{module_name}} จะแสดงถึงจำนวนเงินและวันที่ปิดที่คาดหมายของ {{revenuelineitems_module}} คุณสามารถใช้ประโยชน์จาก {{plural_module_name}} และ {{revenuelineitems_module}} เพิ่มเติมโดยใช้โมดูล {{forecasts_singular_module}} ของ Sugar เพื่อทำความเข้าใจและคาดการณ์แนวโน้มการขาย ตลอดจนโฟกัสการทำงานเพื่อให้ได้โควตาการขาย',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'โมดูล {{plural_module_name}} ช่วยให้คุณติดตามการขายแต่ละรายการและบรรทัดรายการของการขายเหล่านั้นตั้งแต่ต้นจนเสร็จสิ้น ระเบียน {{module_name}} แต่ละรายการจะแสดงถึงส่วนหัวสำหรับกลุ่มของ {{revenuelineitems_module}} ตลอดจนเชื่อมโยงกับระเบียนสำคัญอื่นๆ เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น

- แก้ไขฟิลด์ของระเบียนด้วยการคลิกแต่ละฟิลด์หรือคลิกที่ปุ่มแก้ไข
- ดูหรือแก้ไขลิงก์ไปยังระเบียนอื่นในแผงข้อมูลย่อย รวมถึง {{revenuelineitems_module}} โดยสลับแผงด้านซ้ายล่างเป็น "มุมมองข้อมูล"
...
- การดำเนินการอื่นๆ ที่ใช้ได้อยู่ในเมนูการดำเนินการแบบดรอปดาวน์ทางขวาของปุ่มแก้ไข',
    ...
    'LBL_HELP_CREATE' => 'โมดูล {{plural_module_name}} ช่วยให้คุณสามารถติดตามการขายแต่ละรายการ และบรรทัดรายการที่อยู่ในการขายเหล่านั้นตั้งแต่ต้นจนเสร็จสิ้น ระเบียน {{module_name}} แต่ละรายการจะแสดงส่วนหัวของกลุ่ม {{revenuelineitems_module}} ตลอดจนเกี่ยวข้องกับระเบียนสำคัญอื่นๆ เช่น {{quotes_module}}, {{contacts_module}} เป็นต้น
...
2. คลิก "บันทึก" เพื่อสิ้นสุดการสร้างระเบียนใหม่และกลับสู่เพจก่อนหน้า
3. หลังจากบันทึก ให้ใช้แผงข้อมูลย่อย {{revenuelineitems_module}} เพื่อเพิ่มบรรทัดรายการใน {{module_name}}',
