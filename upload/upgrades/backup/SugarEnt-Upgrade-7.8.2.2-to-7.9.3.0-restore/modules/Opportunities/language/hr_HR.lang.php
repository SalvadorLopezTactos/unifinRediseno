...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modul {{plural_module_name}} omogućuje vam praćenje pojedinačnih prodaja i stavki koje pripadaju tim prodajama od početka do kraja. Svaki zapis o modulu {{module_name}} predstavlja zaglavlje za grupu modula {{revenuelineitems_module}} kao i u vezi s ostalim važnim zapisima poput modula {{quotes_module}}, {{contacts_module}} itd. Svaki modul {{revenuelineitems_singular_module}} potencijalna je prodaja određenog proizvoda i uključuje važne podatke o prodaji. Svaki modul {{revenuelineitems_singular_module}} obično napreduje kroz nekoliko faza prodaje dok ne dobije oznaku „Zatvoreno kao uspjelo” ili „Zatvoreno kao neuspjelo”. Zapis o modulu {{module_name}} označava iznos i očekivani datum zatvaranja svojeg modula {{revenuelineitems_module}}. Moduli {{plural_module_name}} i {{revenuelineitems_module}} mogu se dodatno iskoristiti upotrebom Sugarovog modula {{forecasts_singular_module}} u svrhu razumijevanja i predviđanja trendova prodaje, kao i usmjeravanja posla prema postizanju prodajnih kvota.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modul {{plural_module_name}} omogućuje vam praćenje pojedinačnih prodaja i stavki koje pripadaju tim prodajama od početka do kraja. Svaki zapis o modulu {{module_name}} predstavlja zaglavlje za grupu modula {{revenuelineitems_module}} kao i u vezi s ostalim važnim zapisima poput modula {{quotes_module}}, {{contacts_module}} itd.

- Uredite polja ovog zapisa tako da kliknete na pojedino polje ili gumb Uredi.
- Pogledajte ili izmijenite poveznice na ostale zapise u podpločama, uključujući modul {{revenuelineitems_module}}, tako da prebacite donje lijevo okno na „Prikaz podataka”.
...
- Dodatne radnje dostupne su u padajućem izborniku Radnje koji se nalazi desno od gumba Uredi.',
    ...
    'LBL_HELP_CREATE' => 'Modul {{plural_module_name}} omogućuje vam praćenje pojedinačnih prodaja i stavki koje pripadaju tim prodajama od početka do kraja. Svaki zapis o modulu {{module_name}} predstavlja zaglavlje za grupu modula {{revenuelineitems_module}} kao i u vezi s ostalim važnim zapisima poput modula {{quotes_module}}, {{contacts_module}} itd.
