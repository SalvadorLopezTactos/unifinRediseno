...
// BEGIN ENT/ULT
    ...
    // List View Help Text
    'LBL_HELP_RECORDS' => 'Modul {{plural_module_name}} vám umožňuje sledovať jednotlivé položky predaja a krivky prislúchajúce týmto predajom od začiatku do konca. Každý záznam {{module_name}} predstavuje záhlavie pre skupinu {{revenuelineitems_module}}, ako aj súvisiace s inými dôležitými záznamami {{quotes_module}}, {{contacts_module}} a pod. Každý {{revenuelineitems_singular_module}} je potenciálnym predajom konkrétneho produktu a zahrnuje relevantné údaje predaja. Každý {{revenuelineitems_singular_module}} štandardne prejde niekoľkými fázami predaja a na záver sa označí buď stavom "Uzatvorené/získané", alebo "Uzatvorené/nezískané". Záznam {{module_name}} odráža sumu a predpokladaný dátum uzávierky modulu {{revenuelineitems_module}}. {{plural_module_name}} a {{revenuelineitems_module}} možno využiť ešte viac použitím modulu {{forecasts_singular_module}} aplikácie Sugar, vďaka čomu možno porozumieť trendom predaja a predpovedať ich, ako aj zamerať sa na prácu s cieľom dosiahnuť kvóty predaja.',

    // Record View Help Text
    'LBL_HELP_RECORD' => 'Modul {{plural_module_name}} vám umožňuje sledovať jednotlivé predaje a položky prislúchajúce k týmto predajom od začiatku až do konca. Každý záznam {{module_name}} predstavuje záhlavie pre skupinu {{revenuelineitems_module}}, ako aj súvisiace s dôležitými záznamami, ako napr. {{quotes_module}}, {{contacts_module}} a pod. 

– Polia tohto záznamu upravíte kliknutím na jednotlivé polia alebo stlačením tlačidla Upraviť.
– Prepojenia na ďalšie záznamy v podpaneloch vrátane {{revenuelineitems_module}} možno zobraziť alebo upraviť prepnutím ľavého spodného panela na „Zobrazenie údajov“.
...
– Ďalšie akcie sú k dispozícii v rozbaľovacej ponuke Akcie nachádzajúcej sa na pravej strane od tlačidla Upraviť.',
    ...
    'LBL_HELP_CREATE' => 'Modul {{plural_module_name}} vám umožňuje sledovať jednotlivé predaje a položky patriace k týmto predajom od začiatku až do konca. Každý záznam {{module_name}} predstavuje záhlavie pre skupinu {{revenuelineitems_module}}, ako aj súvisiace s inými dôležitými záznamami {{quotes_module}}, {{contacts_module}} a pod. 
...
3. Po uložení použite podpanel {{revenuelineitems_module}} a pridajte položky do modulu {{module_name}}.',
