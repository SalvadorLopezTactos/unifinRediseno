...
'help'=>array(
    ...
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.'
    ,
        'defaultquickcreate'=>'Ala <b>Paigutus</b> sisaldab välju, mida kuvatakse praegu vormis <b>Kiirgeneraator</b>.<br><br>Vorm Kiirgeneraator kuvatakse mooduli puhul alampaneelidel nupu Loo klõpsamisel.<br/><br/><b>Tööriistakast</b> sisaldab suvandit <b>Prügikast</b> ning välju ja paigutuselemente, mida saab paigutusse lisada.<br><br>Muutke paigutust, pukseerides elemente ja välju suvandite <b>Tööriistakast</b> ja <b>Paigutus</b> vahel ning paigutuses endas.<br><br>Välja eemaldamiseks paigutusest lohistage väli kohta <b>Prügikast</b>. Väli on seejärel suvandis Tööriistakast paigutusse lisamiseks saadaval.'
    . '<br/><br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_dependent.png"/>Viitab väljale Sõltuv, mis valemi väärtusest olenevalt võib olla nähtav või mitte.<br/><!--not_in_theme!--><img src="themes/default/images/SugarLogic/icon_calculated.png" /> Viitab väljale Arvutatud, mille väärtus arvutatakse valemi põhjal automaatselt.'
    ,
...
',
    ...
    'studioWizard'=>array(
        ...
        'labelsBtn' => 'Klõpsake nuppu <b>Salvesta</b> oma kohandatud siltide salvestamiseks.'	,
...
'LBL_CONFIRM_FIELD_DELETE'=>"Selle kohandatud välja kustutamine kustutab nii kohandatud välja kui ka kõik andmebaasis kohandatud väljaga seotud andmed. Välja ei kuvata enam üheski mooduli paigutuses."
        ...
        . "\n\nKas soovite jätkata?",
'LBL_CONFIRM_RELATIONSHIP_DELETE'=>'Kas olete kindel, et soovite selle seose kustutada?<br>Märkus: selle toimingu täitmiseks võib kuluda mitu minutit.',
...
,
'LBL_POPHELP_CALCULATED'=>"Looge valem sellel väljal oleva väärtuse määratlemiseks.<br>"
   . "Seda välja värskendama määratud tegevust sisaldavad töövoo definitsioonid enam tegevust ei täida.<br>"
   . "Valemeid kasutavaid välju ei arvutata reaalajas "
   . "Sugari iseteenindusportaalis või "
   . "Mobile'i redigeerimisvaate paigutustes.",

'LBL_POPHELP_DEPENDENT'=>"Looge valem, määratlemaks, kas see väli on paigutustes nähtav.<br/>"
        . "Sõltuvad väljad järgivad sõltuvuse valemit brauseripõhises mobiilivaates, <br/>"
        . "kuid ei järgi valemit omarakendustes, nagu Sugar Mobile iPhone'i puhul. <br/>"
        . "Need ei järgi valemit Sugari iseteenindusportaalis.",
'LBL_POPHELP_GLOBAL_SEARCH'=>'Valige selle välja kasutamine kirjete otsimisel sellel moodulil globaalse otsinguga.',
