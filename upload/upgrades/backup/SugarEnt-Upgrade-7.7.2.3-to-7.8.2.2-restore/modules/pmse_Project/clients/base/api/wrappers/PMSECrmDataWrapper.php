...
//        $res->success = true;
    ...
    public function clearAccordingProcessDefinitions($args)
    {
        ...
        try {
            ...
            $get_projID_query = "select id from pmse_project where id = " . $this->db->quoted($res->targetProcess);
...
//            $projId = $row['prj_id'];
            ...
            $get_proID_query = "select id from pmse_bpmn_process where prj_id = " . $this->db->quoted($projId);
...
//            $proId = $row['pro_id'];
            ...
            $get_actIds = "select id from pmse_bpm_activity_definition where pro_id = " . $this->db->quoted($proId);
...
//                    $activity[$row['act_id']] = $row['act_script_type'];
            ...
            foreach ($activity as $actId => $actType) {
                ...
                $update_activity = sprintf(
                    ...
                    $this->db->quoted($res->newModule),
                    $this->db->quoted($cleanActivityFiels),
                    $this->db->quoted($proId),
                    $this->db->quoted($actId)
                );
