...
$mod_strings = array (
  ...
  'LBL_CONVERT_BACK_TO_DUPLICATES' => '会到查重',
  'LBL_CONVERT_BUTTON_LABEL' => '转换目标',
  'LBL_CONVERT_COPY' => '复制数据',
  'LBL_CONVERT_CREATE_NEW' => '新建 {{moduleName}}',
  'LBL_CONVERT_DELETE' => '删除',
  'LBL_CONVERT_DUPLICATES_FOUND' => '{{duplicateCount}} 发现重复记录',
  'LBL_CONVERT_EDIT' => '编辑',
  'LBL_CONVERT_EDIT_LAYOUT' => '编辑换化布局',
  'LBL_CONVERT_FINDING_DUPLICATES' => '查重',
  'LBL_CONVERT_IGNORE_DUPLICATES' => '忽略重复数据，新建',
  ...
  'LBL_CONVERT_SWITCH_TO_SEARCH' => '查询',
  ...
  'LBL_FAX_PHONE' => '传真:',
  'LBL_FILTER_LEADS_REPORTS' => '潜在客户报告',
  'LBL_FIRST_NAME' => '名:',
  'LBL_FULL_NAME' => '姓名:',
...
After confirming each required and desired module, click the Save and Convert button at the top to finalize the conversion.',
  'LBL_HELP_CONVERT_TITLE' => '转换 a {{module_name}}',
