...
- Additional actions are available in the dropdown Actions menu to the right of the Edit button.',
  'LBL_HELP_RECORDS' => 'מודול {{plural_module_name}} מכיל לקוחות פוטנציאליים אשר עשויים במוצר או שירות שהארגון שלך מספק. כאשר {{module_name}} מוגדר למכירות {{opportunities_singular_module}}, {{plural_module_name}} יכול להיות מומר ל {{contacts_module}}, {{opportunities_module}}, ו {{accounts_module}}. יש מספר דרכים  {{plural_module_name}} בשוגר. למשל באמצעות מודול {{plural_module_name}} , שכפול, ייבוא {{plural_module_name}}, וכולי. כאשר רשומת {{module_name}} נוצרת, ניתן לצפות ולערוך מידע אשר חודר ל {{module_name}} באמצעות תצוגת רשומות {{plural_module_name}}.',
