...
class SidecarMetaDataUpgrader
{
    ...
    /**
     * Add quick-create files to the list
     */
    protected function setQuickCreateFiles()
    {
        ...
        foreach ($DCActions as $module) {
            ...
            $sidecarMetadataPath = 'modules/' . $module . '/clients/base/menus/quick-create/quick-create.php';
            ...
            $file = $this->getUpgradeFileParams(
                'modules/' . $module . '/clients/base/menus/quick-create/quick-create.php',
    ...
    protected function getViewTypeFromFilename($filename, $client, $type, $fullname)
    {
        ...
        if (strpos($filename, 'quick-create') !== false) {
            return 'quick-create';
        }
