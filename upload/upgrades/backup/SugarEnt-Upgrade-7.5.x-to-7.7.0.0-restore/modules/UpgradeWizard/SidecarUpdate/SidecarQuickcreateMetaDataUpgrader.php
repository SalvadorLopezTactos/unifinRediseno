...
class SidecarQuickcreateMetaDataUpgrader extends SidecarAbstractMetaDataUpgrader
{
    ...
    public function upgradeCheck()
    {
        ...
        if ($this->filename === 'quickcreatedefs.php') {
            // old quick-create defs file, rejecting it.
            return false;
        }
        ...
        $hasVisibleProperty = !empty($viewdefs[$this->module]['base']['menu']['quick-create']) &&
            !empty($viewdefs[$this->module]['base']['menu']['quick-create']['layout']) &&
            isset($viewdefs[$this->module]['base']['menu']['quick-create']['visible']);

        $qcVisibleMatch = $hasVisibleProperty &&
            $viewdefs[$this->module]['base']['menu']['quick-create']['visible'] == $this->isDCEnabled;

        $qcOrderMatch = $hasVisibleProperty &&
            isset($viewdefs[$this->module]['base']['menu']['quick-create']['order']) &&
            $viewdefs[$this->module]['base']['menu']['quick-create']['order'] === $this->order;
    ...
    public function setLegacyViewdefs()
    {
        ...
        if (file_exists("custom/{$this->fullpath}")) {
            ...
            $viewdefs[$this->module]['base']['menu']['quick-create'] = array(
                'layout' => 'create',
    ...
    public function convertLegacyViewDefsToSidecar()
    {
        ...
        $this->sidecarViewdefs = $this->legacyViewdefs[$this->getNormalizedModuleName()]['base']['menu']['quick-create'];
    }
    ...
    {
        return $this->handleSaveArray("viewdefs['{$this->getNormalizedModuleName()}']['base']['menu']['quick-create']",
