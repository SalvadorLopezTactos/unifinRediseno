...
- Additional actions are available in the dropdown Actions menu to the right of the Edit button.',
  'LBL_HELP_RECORDS' => 'מודול {{plural_module_name}} מכיל חברות אשר הארגון שלך בקשר עמם ובאופן כללי מכיר את אופן הניהול הקשר של הארגון שלך עם כל לקוח. ניתן ליצור  {{plural_module_name}} בצורות שונות בשוגר. למשל באמצעות מודול {{plural_module_name}}, שכפול, ייבוא {{plural_module_name}}, וכו. לאחר יצירת {{module_name}}, באפשרותך לצפות ולערוך מידע לתוך ה{{module_name}} באמצעות {{plural_module_name}} תצוגת רשומה. ניתן לקשר כל רשומה {{module_name}} לרשומות שוגר אחרות כגון {{contacts_module}}, {{meetings_module}}, {{cases_module}}, {{opportunities_module}}, ורבים אחרים ככל שהקשר עם הלקוח מתפתח.',
