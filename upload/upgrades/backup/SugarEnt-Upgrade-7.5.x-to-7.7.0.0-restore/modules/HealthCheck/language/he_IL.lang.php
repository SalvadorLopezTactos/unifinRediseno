...
$mod_strings = array (
  ...
  'LBL_SCAN_401_LOG' => 'נמצאו קבצי ספק גלולים, עבוד קבצים הועברו לספק: %s',
  ...
  'LBL_SCAN_403_LOG' => 'נמצאו קבצי שוגר ספציפיים עבור: %s',
  'LBL_SCAN_403_TITLE' => 'נמצאו קבצי שוגר ספציפיים עבור: %s',
  ...
  'LBL_SCAN_521_DESCR' => 'קישור לוגי זה אינו נתמך יותר בשוגר 7',
  ...
  'LBL_SCAN_530_TITLE' => 'חסר קובץ מותאם: %s',
