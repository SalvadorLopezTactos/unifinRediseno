...
$mod_strings = array (
  ...
  'LBL_HELP_RECORDS' => 'מודול {{plural_module_name}} מכיל אנשים אשר הארגון שלך בקשר עמם. רשומות {{module_name}}  על פי רוב קשורות לרשומת {{accounts_singular_module}}, ו {{plural_module_name}} מרובה עשוי להיות מקושר ל {{accounts_singular_module}} יחיד. ניתן ליצור {{plural_module_name}} במספר דרכים בשוגר. למשל מודול {{plural_module_name}}, ייבוא {{plural_module_name}}, המרת {{leads_module}} ל {{plural_module_name}}, וכו. לאחר שרשומת {{module_name}} נוצרה, באפשרותך לצפות ולערוך מידע של {{module_name}} באמצעות תצוגת רשומה {{plural_module_name}}. כל רשומת {{module_name}} עשויה להיות מקושרת לרשומת שוגר אחרת כגון {{meetings_module}}, {{cases_module}}, {{opportunities_module}}, ורבים אחרים, כך שרשומת{{module_name}} היא צינור לצפיה והמשך הקשר עם הלקוח.',
