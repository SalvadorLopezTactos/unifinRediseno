...
- Additional actions are available in the dropdown Actions menu to the right of the Edit button.',
  'LBL_HELP_RECORDS' => '{{module_name}} מורכב מאוסף אנשים או ארגונים שברצונך לכלול או להוציא משיווק המוני {{campaigns_singular_module}}. {{plural_module_name}} יכול להכיל כל מספר וקומבינציה של מטרות, {{contacts_module}}, {{leads_module}}, משתמשים, ו{{accounts_module}}. ניתן לקבץ מטרות ל{{module_name}} בהתאמה לפי קריטריון משותף. למשל גיל, מיקום גאוגרפי וכולי. {{plural_module_name}} משמש בשיווק מייל המוני {{campaigns_module}} אשר ניתן להגדרה במודול {{campaigns_module}}.',
