...
$mod_strings = array (
  ...
  'LBL_BASIC' => 'Gelen Posta Kurulumu',
  ...
  'LBL_CURRENCY_SIG_DIGITS' => 'Para birimi etkin rakam sayısı',
  ...
  'LBL_EMAIL_LINK_TYPE_HELP' => '<b>Sugar Mail İstemcisi:</b> Sugar uygulamasındaki e-posta istemcisini kullanarak e-posta gönderin.<br>Bu opsiyon yalnızca, sistem e-posta ayarları Sistem Yöneticisi tarafından doğru ayarlandıysa mevcuttur.<br><b>Harici Mail İstemci:</b> E-Posta, Sugar uygulaması dışındaki Microsoft Outlook gibi bir istemci tarafından gönderilecektir.',
  ...
  'LBL_FIND_OPTIMUM_MSG' => '<br>Optimum bağlantı değişkenleri bulunuyor.',
  ...
  'LBL_FOUND_OPTIMUM_MSG' => '<br> Optimum ayarlar bulundu. Posta Kutunuza ayarları uygulamak için aşağıdaki butona basın.',
  ...
  'LBL_MARK_READ_DESC' => 'Posta sunucusundaki mesajları okundu olarak işaretleyip içeri al; silme.',
  'LBL_MARK_READ_NO' => 'E-Posta veri yüklenmesinden sonra silindi olarak işaretlendi',
  'LBL_MARK_READ_YES' => 'Veri yüklemesinden sonra sunucuda kalan E-Posta',
  ...
  'LBL_MAX_TAB_DESCRIPTION' => 'Navigasyon çubuğunda görüntülenecek maksimum modül sayısını belirtiniz. Görüntülenecek Modüllerin sayısı tarayıcınız genişliğine bağlıdır. Görüntülenmeyen modüller Daha Fazlası menüsünde gösterilecek.',
  'LBL_MESSENGER_ID' => 'IM İsmi',
  'LBL_MESSENGER_TYPE' => 'IM Tipi',
  'LBL_MISSING_DEFAULT_OUTBOUND_SMTP_SETTINGS' => 'Yönetim henüz Varsayılan Giden E-Posta Hesabı yapılandırmamış. Test E-Postası gönderemezsiniz.',
  ...
  'LBL_ONLY' => 'Yalnızca',
  'LBL_ONLY_SINCE' => 'Yalnızca son kontrol sonrasındaki verileri yükle',
  'LBL_ONLY_SINCE_DESC' => 'POP3 kullanırken, PHP, Yeni ve Okunmamış mesajları birbirinden ayıramamaktadır. Bu seçeneği işaretleyerek, son defa e-posta hesabının kontrol edilmesi sonrasındaki mesajların taranmasını sağlayın. Eğer e-posta sunucunuz IMAP desteklemiyorsa, bu seçenek performansı önemli ölçüde arttırabilir.This will significantly improve performance if your mail server cannot support IMAP.',
  ...
  'LBL_REASS_CONFIRM_REASSIGN' => 'Bu kullanıcının tüm kayıtlarını yeniden atamak mı istiyorsunuz?',
  ...
  'LBL_REASS_FAILED_SAVE' => 'Kaydetme işleminde başarısızlık',
  ...
  'LBL_REASS_RECORDS_FROM' => 'kayıtların kaynağı:',
  ...
  'LBL_REASS_TEAMS_GOOD_MSG' => 'Gönderilen kulanıcı, Gelen kullanıcının takımlarının hepsine erişebilmektedir. Eşleştirme gerekmemektedir. 5 saniye içinde sonraki sayfaya yönlendireceksiniz.',
  'LBL_REASS_TEAM_NO_CHANGE' => '-- Değişiklik yok --',
  'LBL_REASS_TEAM_SET_TO' => 've takımların değiştirildiği değer:',
  ...
  'LBL_REASS_VERBOSE_OUTPUT' => 'Detaylı Çıktı',
  ...
  'LBL_REMINDER_TEXT' => 'Telefon araması veya toplantılar için varsayılan hatırlatıcıyı belirleyin. Açılır-liste hatırlatıcıları Sugar kullanan bütün davetliler için çalışacaktır. E-Posta hatırlatıcıları bütün davetlilere gönderilmektedir.',
  ...
  'LBL_SAVED_SEARCH' => 'Kaydedilmiş  Arama & Yerleşim',
  'LBL_SEARCH_FORM_TITLE' => 'Kullanıcı Arama',
  'LBL_SEARCH_URL' => 'Lokasyon Ara',
  ...
  'LBL_SMTP_SERVER_HELP' => 'Bu SMTP Mail Sunucusu giden posta için kullanılabilir. Bu E-Posta sunucusunu kullanmak için, E-Posta hesabınızın kullanıcı ismi ve şifresini girin.',
  'LBL_SSL' => 'SSL Kullan',
  'LBL_SSL_DESC' => 'Posta sunucusuna bağlanırken Secure Socket Layer (SSL) kullan.',
  'LBL_STATE' => 'Eyalet',
  'LBL_STATUS' => 'Durum',
  ...
  'LBL_WIZARD_FINISH12' => 'Uygulamayı sistem yöneticisi veya son kullanıcısı olarak kullanmaya başlamanız için size yardım edecek eğitim materyallerini ve dökümanları bul.',
  ...
  'LBL_WIZARD_FINISH19' => 'Forumlar, Sugar Topluluğu içinde ve  SugarCRM Uygulama Geliştiricileri ile ilgilendikleri alanlarda bilgi alışverişi yapmak üzere bulunmaktadır.',
  'LBL_WIZARD_FINISH2' => 'Kullanmaya Başlayın',
  'LBL_WIZARD_FINISH2DESC' => 'Doğruca uygulamanın Ana Sayfasına git',
  'LBL_WIZARD_FINISH3' => 'Verileri Yükle',
  ...
  'LBL_WIZARD_FINISH_TITLE' => 'Sugar ürününü kullanmaya hazırsınız!',
  'LBL_WIZARD_LOCALE' => 'Bölgeniz',
  'LBL_WIZARD_LOCALE_DESC' => 'Sugar içinde tarih, para birimi ve isimlerin nasıl göründüğünü belirleyen zaman dilimini belirtiniz.',
  ...
  'LBL_WIZARD_WELCOME' => 'Sugar ürününü kullanmak için gerekli birkaç temel ayarı yapılandırmak için <b>İleri</b> seçeneğine tıklayın.',
  'LBL_WIZARD_WELCOME_NOSMTP' => 'Sugar ürününü kullanmak için gerekli birkaç temel ayarı yapılandırmak için <b>İleri</b> seçeneğine tıklayın.',
