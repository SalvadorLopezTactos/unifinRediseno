...
- Additional actions are available in the dropdown Actions menu to the right of the Edit button.',
  'LBL_HELP_RECORDS' => 'מודול {{module_name}} מורכב מאנשים אשר הנם מטרות שלא הוסמכו ויש לך מידע כלשהו לגביהם אבל שלא הוסמכו {{leads_singular_module}}. מידע (כגון שם או מייל) לגבי {{plural_module_name}} אלו בדרך כלל מושג מכרטיסי ביקור שהתקבלו בנסיבות שונות. {{plural_module_name}} הם רשומות נפרדות אשר אינן מקושרות ל {{contacts_module}}, {{leads_module}}, {{accounts_module}}, או {{opportunities_module}}. ניתן ליצור {{plural_module_name}} בדרכים שונות. למשל באמצעות מודול {{plural_module_name}}, ייבוא {{plural_module_name}}, וכולי. כאשר נוצרת רשומת {{module_name}}, ניתן לצפות ולערוך מידע חודר ל {{module_name}} באמצעות תצוגת רשומות {{plural_module_name}}.',
