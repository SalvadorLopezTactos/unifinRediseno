...
$mod_strings = array (
  ...
  'LBL_CALCULATED_LINE_ITEM_AMOUNT' => 'Υπολογισμός Ποσού Γραμμή Στοιχείων Εσόδων',
  ...
  'LBL_CONVERT_INVALID_RLI_PRODUCT' => 'Η Γραμμή Στοιχείων Εσόδων χρειάζεται ένα Προϊόν από τον Κατάλογο Προϊόντων, πριν παραχθεί η Προσφορά.',
  ...
  'LBL_CONVERT_TO_QUOTE_INFO_MESSAGE' => 'Παραγμένη Προσφορά Από Γραμμή Στοιχείων Εσόδων',
  'LBL_COST_PRICE' => 'Κόστος:',
  'LBL_COST_USDOLLAR' => 'Κόστος Δολλαρίου',
  'LBL_CREATED_USER' => 'Δημιουργημένος Χρήστης',
  ...
  'LBL_DEFAULT_SUBPANEL_TITLE' => 'Γραμμή Στοιχείων Εσόδου',
...
- Πρόσθετες ενέργειες είναι διαθέσιμες στο αναπτυσσόμενο μενού "Ενέργειες", δεξιά από το κουμπί "Επεξεργασία".',
  ...
  'LBL_MODIFIED_USER' => 'Τροποποιημένος Χρήστης',
  'LBL_MODULE_NAME' => 'Γραμμή Στοιχείων Εσόδων',
  'LBL_MODULE_NAME_SINGULAR' => 'Γραμμή Στοιχείων Εσόδων',
  'LBL_MODULE_TITLE' => 'Γραμμή Στοιχείων Εσόδων: Αρχή',
  'LBL_NAME' => 'Γραμμή Στοιχείων Εσόδων',
  'LBL_NEW_FORM_TITLE' => 'Δημιουργία Γραμμής Στοιχείων Εσόδων',
  ...
  'LBL_SEARCH_FORM_TITLE' => 'Γραμμή Στοιχείων Εσόδων, Αναζήτηση',
  ...
  'LBL_WEIGHT' => 'Βάρος:',
  'LNK_IMPORT_REVENUELINEITEMS' => 'Εισαγωγή Στοιχείων Γραμμή Εσόδων',
  'LNK_NEW_REVENUELINEITEM' => 'Δημιουργία Γραμμής Στοιχείων Εσόδων',
  'LNK_REVENUELINEITEM_LIST' => 'Προβολή Γραμμής Στοιχείων Εσόδου',
