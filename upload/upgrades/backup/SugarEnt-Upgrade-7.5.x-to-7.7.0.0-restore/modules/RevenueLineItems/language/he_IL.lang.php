...
- Additional actions are available in the dropdown Actions menu to the right of the Edit button.',
  'LBL_HELP_RECORDS' => 'מודול {{plural_module_name}} מורכב משורות פריטים של עסקים אשר כלולים ברשומת {{opportunities_singular_module}} ובמעקב במשך מחזור המכירה. רשומת  {{opportunities_singular_module}} משמשת ככותרת לרשומות {{module_name}}. זה מאפשר גרעון בעבודה {{opportunities_module}} ו {{forecasts_singular_module}} משום שכל שורת פריט ב{{opportunities_singular_module}} יכולה להיות בעלת שלב מכירות משלה והסתברות משלה וכן כלולה ב{{forecasts_singular_module}} {{worksheet_module}} של משתמש. כל {{module_name}} יכול להיות רלוונטי למוצר מהקטלוג של ארגונך. בדרך זו הנתונים של המוצר יופיעו גם ב{{module_name}}.',
