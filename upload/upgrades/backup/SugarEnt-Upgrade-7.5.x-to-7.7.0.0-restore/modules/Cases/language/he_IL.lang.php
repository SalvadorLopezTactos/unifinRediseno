...
- Additional actions are available in the dropdown Actions menu to the right of the Edit button.',
  'LBL_HELP_RECORDS' => 'מודול {{plural_module_name}} למעקב וניהול בעיות הקשורות למוצר או שירות המדוחחים לארגונך על ידי לקוחות. {{plural_module_name}} על פי רוב קשורים לרשומת {{accounts_singular_module}}, ומספר {{plural_module_name}} עשויים להיות מקושרים ל {{accounts_singular_module}} יחיד. ניתן ליצור  {{plural_module_name}} במספר דכרים. למשל באמצעות מודול {{plural_module_name}}, ייבוא {{plural_module_name}}, או בהמרה ממייל. כאשר {{module_name}} נוצר, ניתן לצפות ולערוך מידע מ {{module_name}} תצוגת רשומות באמצעות {{module_name}}. ניתן לקשר כל רשומת {{module_name}} לרשומות אחרות כגון {{calls_module}}, {{contacts_module}}, {{bugs_module}}, ורבים אחרים.',
