...
$mod_strings = array (
  ...
  'LBL_HELP_RECORDS' => '{{plural_module_name}} modulen inneholder {{opportunities_singular_module}} poster for å bygge {{module_name}} {{worksheet_module}}&#39;s og forutsi salget. Brukere kan arbeide mot salgsbudsjett på individ, team, og salgsorganisasjon nivå. Før brukerne kan få tilgang til {{plural_module_name}}-modulen for å begynne å bygge {{module_name}} {{worksheet_module}}&#39;s, en bruker med administratortilgang må konfigurere {{plural_module_name}} modulen med organisasjonens ønskede tidsperioder, Ranges, og scenarier. Salgsrepresentanter bruker {{plural_module_name}} modulen for å jobbe med sine tildelte {{opportunities_module}} ettersom de gjeldende tidsperiode utvikler seg. Disse brukerne vil forplikte totale forutsigelser for sine personlige salg basert på {{opportunities_module}} de forventer å lukke. Salgssjefer arbeider med sine egne {{opportunities_singular_module}} poster på samme måte som andre salgsrepresentanter. I tillegg rapporterer de samlet sine forpliktelser {{module_name}} beløp for å forutsi deres totale teams salg og jobb mot lagets budsjett for hver tidsperiode. Ytterligere innsikt tilbys av elementene i den utvidede Intelligence ruten inkludert analyse for et individs {{opportunities_module}} regneark og analyse for en leders teams regneark.',
