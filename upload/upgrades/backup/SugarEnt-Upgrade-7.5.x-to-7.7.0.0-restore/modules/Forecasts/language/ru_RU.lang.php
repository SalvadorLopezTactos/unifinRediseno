...
$mod_strings = array (
  ...
  'LBL_HELP_RECORDS' => '{{plural_module_name}} Модуль содержит {{opportunities_singular_module}} записи для построения {{module_name}} {{worksheet_module}} и прогнозирования продаж. Пользователи могут выставлять квоты на уровне одного пользователя, команды и, в целом, организации. Прежде, чем пользователи смогут начать работу в данном модуле {{plural_module_name}} {{module_name}} {{worksheet_module}}, пользователь с правами администратора должен настроить {{plural_module_name}} модуль с учетом временных периодов, диапазонов и сценариев, с которыми будет работать организация.

Продавцы используют {{plural_module_name}} модуль для работы с открытыми сделками {{opportunities_module}} в пределах текущего временного периода. Эти пользователи будут делать свои собственные прогнозы по продажам {{opportunities_module}}, которые они планируют закрыть. Руководители продаж имеют дело с собственными {{opportunities_singular_module}} записями по аналогии с продавцами. В дополнение, они агрегируют суммы продаж своих подчиненных {{module_name}}, чтобы спрогнозировать общую сумму продаж и устанавливают квоты на команды на каждый временной период. Дополнительная информация доступна на расширенной панели Intelligence Pane, включая анализ рабочего листа каждого пользователя {{opportunities_module}} и анализ рабочих листов команды.',
