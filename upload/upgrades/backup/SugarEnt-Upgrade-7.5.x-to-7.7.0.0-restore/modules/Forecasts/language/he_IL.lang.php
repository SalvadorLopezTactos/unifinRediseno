...
$mod_strings = array (
  ...
  'LBL_HELP_RECORDS' => 'מודול {{plural_module_name}} משלב רשומות {{opportunities_singular_module}} לבניית {{module_name}} {{worksheet_module}}ים ולצפות מכירות. משתמשים יכולים לקדם הצעות מחיר אשר יובילו למכירות ברמת היחיד, הצוות והארגון. לפני שמתמשים יכולים לגשת למודול {{plural_module_name}} לבניית {{module_name}} {{worksheet_module}}ים, משתמש אדמין צריך להגדיר את מודול  {{plural_module_name}} ,עם תקופות הזמן הטווחים והתרחישים שהארגון קובע.

נציגי מכירות משתמשים במודול {{plural_module_name}} כדי לעבוד עם {{opportunities_module}} כהתקדמות בתקופת הזמן הנוכחית. משתמשים אלה יתחייבו לתחזית המכירות האישית שלהם בהתבסס על {{opportunities_module}} שצפו לסגור. מנהלי מכירות עובדים עם רשומות {{opportunities_singular_module}} משלהם באופן דומה לנציגי המכירות. בנוסף, הם יכולים לצפות את היקף המכירות של הצוות שלהם ולקדם את היעדים של הצוות. בנוסף ניתן לבצע אנליזה של גליון עבודה {{opportunities_module}} של יחידים ושל מנהלי צוות.',
