...
$mod_strings = array (
  ...
  'LBL_HELP_RECORDS' => 'Il modulo {{plural_module_name}} incorpora records {{opportunities_singular_module}} per costruire {{module_name}}ing {{worksheet_module}}s e vendite previste. Gli utenti possono lavorare sul budget di vendita a livello individuale, di gruppo e di vendita. Prima che gli utenti possano accedere al modulo {{plural_module_name}} per iniziare a costruire {{module_name}}ing {{worksheet_module}}s, un utente con accesso di amministratore deve configurare il modulo {{plural_module_name}} con gli Archi Temporali, Intervalli e Scenari desiderati dall´organizzazione.

I rappresentanti delle vendite usano il modulo {{plural_module_name}} per lavorare con le {{opportunities_module}} a loro assegnate in base all´avanzamento dell´arco temporale corrente. Questi utenti definiranno le previsioni totali per le loro vendite personali basate sulle {{opportunities_module}} che prevedono di chiudere. I responsabili delle vendite lavoreranno con le proprie {{opportunities_singular_module}} in modo simile agli altri responsabili delle vendite. In aggiunta, essi aggregano gli importi forniti da {{module_name}} per prevedere le vendite totali del proprio gruppo di vendita e lavorare sul budget del gruppo per ciascun arco temporale. Ulteriori elementi sono offerti espandendo il Pannello Intelligente, che include l´analisi delle matrici delle {{opportunities_module}} dei singoli e analisi delle matrici dei responsabili dei gruppi.',
