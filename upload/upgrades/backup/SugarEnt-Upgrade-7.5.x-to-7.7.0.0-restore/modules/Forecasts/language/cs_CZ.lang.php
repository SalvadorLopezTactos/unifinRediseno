...
$mod_strings = array (
  ...
  'LBL_HELP_RECORDS' => 'Modul Předpovědi využívá záznamy obchodů k sestavení předpovědních listů a předpovědi prodejů. Uživatelé mohou pracovat s prodejními kvótami na individuální, týmové nebo organizační úrovni. Než mohou uživatelé vstoupit do modulu předpovědí, aby začali sestavovat předpovědní listy, uživatel s administrátorským přístupem musí nastavit v modulu předpovědí požadovaná časová období, rozsahy a scénáře. Obchodní zástupci používají modul předpovědí k práci s jejich přidělenými obchody v průběhu aktuálního období. Tito uživatelé potvrzují celkové předpovědi jejich osobních prodejů na základě obchodů, které předpokládají, že uzavřou. Obchodní manažeři pracují s jejich vlastními záznamy obchodů podobně jako ostatní obchodní zástupci. Navíc shrnují předpovědi, které odeslali jejich podřízení, k odhadu celkového prodeje jejich týmu a porovnávají je s kvótou jejich týmu na každé období. Další informace jsou dodány elementy Intelligence Pane, včetně analýzy listu obchodu jednotlivce a analýzy listů týmu manažera.',
