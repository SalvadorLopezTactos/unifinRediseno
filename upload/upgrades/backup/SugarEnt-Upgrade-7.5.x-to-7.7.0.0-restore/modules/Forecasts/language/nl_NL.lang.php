...
$mod_strings = array (
  ...
  'LBL_HELP_RECORDS' => 'De {{plural_module_name}} module sluit {{opportunities_singular_module}} records in, om daarmee {{module_name}}ing {{worksheet_module}}s op te bouwen en verkopen te voorspellen. Gebruikers kunnen werken naar verkoopquota op het individuele niveau, op teamniveau en op organisatieniveau. Voordat gebruikers toegang hebben tot de {{plural_module_name}} module om {{module_name}}ing {{worksheet_module}}s op te bouwen, zal een gebruiker met administrator rechten de {{plural_module_name}} module configureren met de gewenste perioden, bereiken en scenario&#39;s.

Verkoopmedewerkers gebruiken de {{plural_module_name}} module om aan de toegewezen {{opportunities_module}} te werken gedurende de lopende periode. Deze gebruikers commiteren persoonlijke verkoopprognoses gebaseerd op de {{opportunities_module}} die ze verwachten te sluiten. Verkoopmanagers werken vergelijkbaar aan de eigen {{opportunities_singular_module}} records. Zij aggregeren de gecommiteerde {{module_name}} volumes van hun ondergeschikten naar een quota voor het gehele team voor elke periode, waarnaar elke periode gewerkt wordt. Extra inzichten worden geboden door de elementen van het uitbreidbare Intelligence Pane, inclusief analyses voor individuele {{opportunities_module}}werkbladen en analyses voor werkbladen van teams.',
