...
$mod_strings = array (
  ...
  'LBL_HELP_RECORDS' => 'Модулът {{plural_module_name}} използва въведените записи за {{opportunities_module}} за генериране на прогнози за очаквани продажби. В SugarCRM системата могат да бъдат поставени  квоти за продажби на ниво търговски представител, екип или организация ,  изпълнението на които квоти да се следи през модул {{plural_module_name}}. Първоначално потребител с административни права трябва да конфигурира модул {{plural_module_name}}  като дефинира времевите интервали на отчитане, сценарии и обхвати.

Търговските представители използват модул{{plural_module_name}}в хода на водените от тях търговски преговори. В рамките на дефинираните времеви периоди, те изпращат прогнози за техните персонални продажби на база на Възможностите, които очакват да превърнат в търговски сделки. Търговските мениджъри работят със своите записи за {{opportunities_module}} в системата по аналогичен начин, като в допълнение те обединяват изпратените прогнози от страна на своите подчинение. Така те получават информация за очакваните суми на продажби и процента на изпълнение на поставените квоти за текущия времеви период. Секцията „Анализи“ предоставя допълнителни опции за анализ на прогнозите.',
