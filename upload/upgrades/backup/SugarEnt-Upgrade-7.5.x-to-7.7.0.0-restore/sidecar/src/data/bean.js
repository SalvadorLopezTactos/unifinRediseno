...
(function(app) {
    ...
    app.augment('Bean', Backbone.Model.extend({
                ...
                $files,
                {
                    success: function(data) {
                        ...
                        if (rspField) {
                            ...
                            if (callbacks.error) {
                                var error = new SUGAR.Api.HttpError({xhr: data.xhr});
        ...
        /**
         * Sets default attributes hash of key/val properties we want ignored when
         * checking if the model "has changed"
         * @param attributes
         */
        setDefaultAttributes: function(attributes) {
            this._defaultAttributes = attributes ? app.utils.deepCopy(attributes) : {};
        },
        /**
         * Sets a default attribute key/val we want ignored when checking if the
         * model "has changed"
         * @param key the key
         * @param value the value
         */
        setDefaultAttribute: function(key, value) {
            this._defaultAttributes = this._defaultAttributes || {};
            this._defaultAttributes[key] = value;
        },
        /**
         * Removes a single default attribute
         * @param key the key
         */
        removeDefaultAttribute: function(key) {
            if (this._defaultAttributes) {
                delete this._defaultAttributes[key];
            }
        },
        /**
         * Gets a single default attribute
         * @return {Object}
         */
        getDefaultAttribute: function(key) {
            return this._defaultAttributes ? this._defaultAttributes[key] : null;
        },
        /**
        ...
        getDefaultAttributes: function() {
            return this._defaultAttributes ? this._defaultAttributes : {};
        }
    }), false);
