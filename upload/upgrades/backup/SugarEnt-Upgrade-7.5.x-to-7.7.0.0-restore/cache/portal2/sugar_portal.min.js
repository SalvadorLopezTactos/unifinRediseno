...
(function(app){app.events.on("app:sync",function(){var _countries={};var _registerCountryFunctions=function(){app.metadata=_.extend(app.metadata,{getCountry:function(id){return this.getCountries()[id];},getCountries:function(){return _countries.countries||{};},getState:function(id){return this.getStates()[id];},getStates:function(){return _countries.states||{};},getMunicipality:function(id){return this.getMunicipalities()[id];},getMunicipalities:function(){return _countries.municipalities||{};},getCity:function(id){return this.getCities()[id];},getCities:function(){return _countries.cities||{};},getPostalCode:function(postalcode){return this.getPostalCodes()[postalcode];},getPostalCodes:function(){return _countries.postalcodes||{};},getColonia:function(id){return this.getColonias()[id];},getColonias:function(){return _countries.colonias||{};},getCountriesSelector:function(template){var countries={};_.each(this.getCountries(),function(country,id){countries[id]=template(country);});return countries;},});};var types=["countries","states","municipalities","cities","postalcodes","colonias"];var params={module_filter:"",platform:app.config.platform,type_filter:types.join(",")};var url=app.api.buildURL("metadata","read",null,params);app.api.call('read',url,null,{success:function(metadata){_countries.countries=metadata.countries;_countries.states=metadata.states;_countries.municipalities=metadata.municipalities;_countries.cities=metadata.cities;_countries.postalcodes=metadata.postalcodes;_countries.colonias=metadata.colonias;_registerCountryFunctions();},error:function(error){console.log(error);}});});})(SUGAR.App);
/* End of File custom/include/javascript/voodoo.js */
