...
function smarty_function_sugar_button($params, $smarty)
{
   ...
   if(!is_array($type)) {
   	  ...
   	  switch(strtoupper($type)) {
			...
			case "SUBPANELSAVE":
                if($view == 'QuickCreate' || (isset($_REQUEST['target_action']) && strtolower($_REQUEST['target_action']) == 'quick-create')) $view =  "form_SubpanelQuickCreate_{$module}";
