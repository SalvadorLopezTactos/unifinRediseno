...
$app_list_strings = array (
  ...
  array (
    'chronological' => 'Дата, где за основу год',
  ),
  'fts_type' => 
  array (
  ...
  array (
    ...
    'Prospects' => 'Адресат',
    'Quotes' => 'Коммерческое предложение',
    'RevenueLineItems' => 'Продукт продажи',
    'Tasks' => 'Задача',
  ),
  ...
  array (
    'group' => 'Продукты продажи группы',
    'user' => 'Мои продукты продажи',
  ),
  'tselect_type_dom' => 
  array (
    0 => '0 часов',
...
$app_strings = array (
  ...
  'LBL_DASHLET_COMPANY_INFO' => 'D&B: импортировать и обогатить',
  'LBL_DASHLET_COMPANY_INFO_DESC' => 'Обогатить существующий контрагент данными D&B. Требуется D&B подписка.',
  ...
  'LBL_DNB_BAL_PARAM_STATES' => 'Штаты',
  ...
  'LBL_DNB_FAMILY_TREE' => 'D&B: Семейное дерево компаний',
  'LBL_DNB_FAMILY_TREE_BACK' => 'Вернуться к семейному дереву компаний D&B',
  'LBL_DNB_FAMILY_TREE_DESC' => 'Семейное дерево компаний из D&B. Требуется D&B подписка.',
  'LBL_DNB_FAMILY_TREE_LOADING' => 'Загружается семейное дерево компаний из D&B',
  ...
  'LBL_DNB_STREET_ADDRESS_LINE_TEXT' => 'Текст адресной строки',
...
- Дополнительные действия доступны в выпадающем меню Действий справа от кнопки Редактировать.',
  ...
  'LBL_REQUEST_TIMEOUT_TITLE' => 'Истекло время ожидяниа запроса',
