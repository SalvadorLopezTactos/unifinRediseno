...
$app_strings = array (
  ...
  'LBL_CONTEXTUAL_SHORTCUTS' => '文本快捷键',
  'LBL_CONTRACTS' => '合同',
  'LBL_COPYRIGHT' => '版权所有©2004-2014 SugarCRM的公司保留所有权利。',
  ...
  'LBL_DASHLET_ATTACHMENTS_DESCRIPTION' => '注释和附件所属的纪录',
  ...
  'LBL_DELETE_FILTER_CONFIRMATION' => '这个过滤器将从所有视图中删除；可能包括dashlets的配置数据.你确定你要删除这个过滤器吗?',
  ...
  'LBL_DNB_LAST_UPD_DATE_DESC' => '当主体的纪录被一次更新是在D＆B的系统日期',
  'LBL_DNB_LAT' => '纬度',
  ...
  'LBL_GLOBAL_SEARCH_MODULE_FILTER' => '全局搜索模块过滤器',
...
- 编辑按钮的右边的下拉列表提供更多选择',
  ...
  'LBL_OFFLINE_CLEAR_DB_PROMPT' => '您是否希望删除本地保存所有记录？',
  ...
  'LBL_SHORTCUT_FILTER_ADD' => '添加新条件至过滤器',
  'LBL_SHORTCUT_FILTER_CLOSE' => '关闭过滤器',
  'LBL_SHORTCUT_FILTER_CREATE' => '创建新列表过滤器',
  'LBL_SHORTCUT_FILTER_DELETE' => '删除过滤器',
  'LBL_SHORTCUT_FILTER_EDIT' => '编辑当前列表过滤器',
  'LBL_SHORTCUT_FILTER_REMOVE' => '移除过滤器的最后一个条件',
  'LBL_SHORTCUT_FILTER_RESET' => '重置过滤器',
  'LBL_SHORTCUT_FILTER_SAVE' => '保存过滤器',
  'LBL_SHORTCUT_FILTER_SEARCH' => '关注列表过滤器字段',
  'LBL_SHORTCUT_FILTER_SHOW' => '打开列表过滤器菜单',
  'LBL_SHORTCUT_FOLLOW_RECORD' => '关注记录',
  'LBL_SHORTCUT_FUNCTION' => '功能',
  'LBL_SHORTCUT_HELP' => '显示快捷键帮助页',
  'LBL_SHORTCUT_KEYS_HELP_ABOUT' => 'SugarCRM让用户可以使用键盘快捷键完成任务以提高效率。右侧的表格描述了可用快捷键的键位及功能。',
  ...
  'LBL_TOUR_FULL_TOUR' => '全程向导',
  'LBL_TOUR_INTRO' => '欢迎使用Sugar 7. 请点击箭头来浏览快速向导。',
  'LBL_TOUR_LIST_ACTIVTYSTREAMLIST_TOGGLE' => '选择看或活动记录表',
  'LBL_TOUR_LIST_FILTER1' => '过滤器栏让搜索这个模块',
  'LBL_TOUR_LIST_FILTER2' => '选择预定义过滤器或创建新',
  ...
  'TPL_DELETE_FILTER_SUCCESS' => '成功删除过滤器{{name}}.',
  'TPL_FILTER_SAVE' => '成功创建过滤器{{name}}.',
