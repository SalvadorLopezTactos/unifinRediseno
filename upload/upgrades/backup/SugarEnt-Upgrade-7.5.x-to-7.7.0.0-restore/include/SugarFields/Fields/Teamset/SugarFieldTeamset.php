...
class SugarFieldTeamset extends SugarFieldBase {
    ...
    function initialize() {
		...
		if((isset($_REQUEST['action']) && $_REQUEST['action'] == 'SubpanelCreates') || preg_match('/quick-create/i', $formName)) {
		   $this->view->action_type = 'quick-create';
		} else {
		...
		} else if($this->view->action_type == 'quick-create') {
