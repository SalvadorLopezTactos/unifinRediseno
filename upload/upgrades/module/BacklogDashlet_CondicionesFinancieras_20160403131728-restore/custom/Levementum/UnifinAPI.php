...
class UnifinAPI
{
            ...
            $fields = array(
                "oClienteCompleto" => array(
                    "oPersona" => array(
                        ...
                        "_IdPaisNacionalidad" => intval($objecto->pais_nacimiento_c) == 0 ? null : intval($objecto->pais_nacimiento_c),
                        "_ClntEstadoNacimiento" => intval($objecto->estado_nacimiento_c) == 0 ? null : intval($objecto->estado_nacimiento_c),
    ...
    public function getDirecciones($relatedId, $currentDireccion = null)
    {
        ...
        try {
            ...
            $fields = array(
                "oPersona" => array(
                    ...
                    "_IdPaisNacionalidad" => intval($object->pais_nacimiento_c) == 0 ? null : intval($object->pais_nacimiento_c),
                    "_ClntEstadoNacimiento" => intval($object->estado_nacimiento_c) == 0 ? null : intval($object->estado_nacimiento_c),
        ...
        try {
            ...
            *
            ...
            if($opportunidad['es_multiactivo_c']==1){
                ...
                switch ($lista[0]) {
                    case "AUTOS":
                        $idActivoPrincipal = 9984;
                        $indexActivoPrincipal = "000400010002";
                        $nombreActivoPrincipal = "AUTOS";
                        break;
                    case "CAMIONES":
                        $idActivoPrincipal = 32393;
                        $indexActivoPrincipal = "000400010005";
                        $nombreActivoPrincipal = "CAMIONES";
                        break;
                    case "BARCOS":
                        $idActivoPrincipal = 35463;
                        $indexActivoPrincipal = "000400050001";
                        $nombreActivoPrincipal = "BARCOS";
                        break;
                    case "OTROS":
                        ...
                        break;
                    case "MAQUINARIA":
                        $idActivoPrincipal = 8655; //1357;
                        $indexActivoPrincipal = "0003";
                        $nombreActivoPrincipal = "MAQUINARIA";
                        break;
                    case "EQUIPO":
                        $idActivoPrincipal = 6951;
                        $indexActivoPrincipal = "00020007";
                        $nombreActivoPrincipal = "EQUIPO";
                        break;
                    case "EQUIPO DE TRANSPORTE":
                        $idActivoPrincipal = 8742;
                        $indexActivoPrincipal = "0004";
                        $nombreActivoPrincipal = "TRANSPORTE";
                        break;
                    case "MOTOS":
                        $idActivoPrincipal = 8760;
                        $indexActivoPrincipal = "000400010013";
                        $nombreActivoPrincipal = "MOTOS";
                        break;
                    case "AVIONES":
                        $idActivoPrincipal = 36286;
                        $indexActivoPrincipal = "0004000200010006";
                        $nombreActivoPrincipal = "AVIONES";
                        break;
                    case "EQUIPO DE COMPUTO":
                        $idActivoPrincipal = 966;
                        $indexActivoPrincipal = "0002001200020045";
                        $nombreActivoPrincipal = "EQUIPO DE COMPUTO";
                        break;
                }
            ...
            if($opportunidad['tipo_producto_c']=="FACTORAJE") {
                ...
                $fields['comentariosFactoraje'] = $opportunidad['f_comentarios_generales_c'];
                ...
                $fields['carteraDescontar'] = $opportunidad['cartera_descontar_c'];
...
SQL;
            ...
            foreach ($objeto->condiciones_financieras as $Condicion ) {
                $GLOBALS['log']->fatal(__CLASS__ . "->" . __FUNCTION__ . " <".$current_user->user_name."> : CVV - Plazo minimo: " . print_r($Condicion['plazo_minimo'], true));
                $GLOBALS['log']->fatal(__CLASS__ . "->" . __FUNCTION__ . " <".$current_user->user_name."> : CVV - Plazo maximo: " . print_r($Condicion['plazo_maximo'], true));
                switch ($Condicion['idactivo']) {
                    ...
                    case '000400010013':
                        $idUnicsActivo=65085;
                        break;
                    case '0004000200010006':
                        $idUnicsActivo=19738;
                        break;
                    case '0002001200020045':
                        $idUnicsActivo=14731;
                        break;
                    default:
                        $idUnicsActivo=50000;
                ...
                $GLOBALS['log']->fatal(__CLASS__ . "->" . __FUNCTION__ . " <".$current_user->user_name."> : CVV - Consecutivo que se asignara: " . print_r($activo_previo[$Condicion['idactivo']], true));
                ...
                $cond=array(
                    ...
                    "CnfnPlazoMin"=>intval($Condicion['plazo_minimo']),
                    "CnfnPlazoMax"=>intval($Condicion['plazo_maximo']),
            ...
            $GLOBALS['log']->fatal(__CLASS__ . "->" . __FUNCTION__ . " <".$current_user->user_name."> : MHE -- JSON " . print_r($fields, true));
            $time_start = microtime(true);
