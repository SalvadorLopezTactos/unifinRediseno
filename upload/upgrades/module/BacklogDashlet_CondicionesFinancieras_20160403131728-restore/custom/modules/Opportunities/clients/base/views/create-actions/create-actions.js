({
	...
	_render: function() {
        ...
        this.model.on("change:tipo_producto_c", _.bind(function(){
            /*if(this.multiProducto!=1){
                if(this.productoUsuario != this.model.get('tipo_producto_c')){
                    this.model.set('tipo_producto_c',this.productoUsuario);
                    app.alert.show("Multi", {
                        level: "error",
                        title: "No esta habilitado para generar este tipo de operaciones.",
                        autoClose: false
                    });
                }
             ...
             * @author Carlos Zaragoza Ortiz
             * @version 1
             * @description Oculta campos o los muestra dependiendo si el tipo de producto es Factoraje o no lo es.
             * */
             // CVV - 28/03/2016 - Se reemplazan los campos de activos por el control de condiciones financieras
             /*
            if(this.model.get('tipo_producto_c') != '4'){
    ...
    validaActivoIndex: function(fields, errors, callback){
        ...
        this.model.set('id_activo_c', "9985");
        this.model.set('index_activo_c', "0004000100020001");
        callback(null,fields,errors)
    },
